...
ActiveRecord::Schema.define(version: 2025_10_11_130403) do
  ...
  create_table "alerts", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "watch_id"
    t.string "watch_type"
    t.datetime "created_at"
  ...
  create_table "api_queries", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.string "type"
    t.text "query"
  ...
  create_table "collaborations", charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "log_lines", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "run_id"
    t.string "stream"
    t.text "text"
    t.datetime "created_at"
  ...
  create_table "organizations_users", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  create_table "scrapers", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
