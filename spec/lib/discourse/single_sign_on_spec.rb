...
sso = Discourse::SingleSignOn.parse("sso=bm9uY2U9aGVsbG8%3D%0A&sig=51fb49b2c69a9953e7e5cf7e11661915836eb242d26fbc1f3d8638117d0dd561", secret)
    ...
    it "should be able to generate a url correctly encoded" do
      ...
      sso.to_url("https://discuss.morph.io/session/sso_login").should == "https://discuss.morph.io/session/sso_login?sso=bm9uY2U9YWJjZCZuYW1lPU1hdHRoZXcrTGFuZGF1ZXImZW1haWw9bWF0dGhl%0AdyU0MG9hZi5vcmcuYXU%3D%0A&sig=d710f9621b50d5f24d305718e09f7fe97a1f60201de7f589002854514af542bb"
      Base64.decode64(CGI.unescape("bm9uY2U9YWJjZCZuYW1lPU1hdHRoZXcrTGFuZGF1ZXImZW1haWw9bWF0dGhl%0AdyU0MG9hZi5vcmcuYXU%3D%0A")).should == "nonce=abcd&name=Matthew+Landauer&email=matthew%40oaf.org.au"
    end
  end
end
