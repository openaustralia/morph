...
* Add an image - you can use the standard logo at `app/assets/images/logo.png`
...
Also, a private key for the GitHub app is needed. This can be generated by clicking the "Generate a private key" button and needs to be immediately downloaded. Save it to `config/morph-github-app.private-key.pem`.
