class Run < ActiveRecord::Base
  ...
  def go_with_logging
    ...
    status = Morph::DockerRunner.compile_and_run(repo_path: repo_path, data_path: data_path, env_variables: env_variables, container_name: docker_container_name) do |on|
