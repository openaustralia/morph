class Run < ActiveRecord::Base
  ...
  def go_with_logging
    ...
    if owner.buildpacks && language == :ruby
      Run.go_with_logging_with_buildpacks(self) do |s,c|
        yield s,c
      end
    else
      Run.go_with_logging_original(self) do |s,c|
        yield s,c
      end
    end
  ...
  def self.go_with_logging_original(run)
  ...
  def self.go_with_logging_with_buildpacks(run)
