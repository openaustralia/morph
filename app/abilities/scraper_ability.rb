...
class ScraperAbility
  ...
  def initialize(owner)
    ...
    can %i[index show running], Scraper, private: false
    ...
    can %i[index show running edit data], Scraper, owner_id: owner.id
    ...
    if owner.is_a?(User)
      owner.organizations.each do |org|
        can %i[index show running edit data], Scraper, owner_id: org.id
