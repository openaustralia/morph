...
# :include: ../README.rdoc
#
# source://actionmailer-7.1.5.2/lib/action_mailer/gem_version.rb:3
module ActionMailer
  extend ::ActiveSupport::Autoload

  class << self
    # source://actionmailer-7.1.5.2/lib/action_mailer/deprecator.rb:4
    def deprecator; end

    # source://actionmailer-7.1.5.2/lib/action_mailer.rb:61
    def eager_load!; end

    # Returns the currently loaded version of Action Mailer as a +Gem::Version+.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/gem_version.rb:5
    def gem_version; end

    # Returns the currently loaded version of Action Mailer as a
    # +Gem::Version+.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/version.rb:8
    def version; end
  end
end
...
#
# source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:476
class ActionMailer::Base < ::AbstractController::Base
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:644
  def initialize; end
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:761
  def attachments; end
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:502
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/queued_delivery.rb:9
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/queued_delivery.rb:8
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:19
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:18
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:685
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:53
  ...
  # for the same header.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:723
  ...
  #   end
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:870
  def mail(headers = T.unsafe(nil), &block); end

  # Returns the name of the mailer object.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:678
  def mailer_name; end
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:95
  def params; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:93
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:16
  def perform_deliveries; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:16
  def perform_deliveries=(val); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:25
  def preview_interceptors; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:14
  def preview_paths; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:650
  def process(method_name, *args); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:15
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:22
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:1071
  def _protected_ivars; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:947
  def apply_defaults(headers); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:967
  def assign_headers_to_message(message, headers); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:973
  def collect_responses(headers, &block); end

  # @yield [collector]
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:983
  def collect_responses_from_block(headers); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:997
  def collect_responses_from_templates(headers); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:990
  def collect_responses_from_text(headers); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:957
  def compute_default(value); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:1040
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:937
  def default_i18n_subject(interpolations = T.unsafe(nil)); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:1010
  def each_template(paths, name, &block); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:1053
  def insert_part(container, response, charset); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:1067
  def instrument_name; end

  # This and #instrument_name is for caching instrument
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:1060
  ...
  # used.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:915
  def set_content_type(m, user_content_type, class_default); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:1019
  ...
  class << self
    ...
    # source://actionmailer-7.1.5.2/lib/action_mailer/form_builder.rb:18
    ...
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:570
    ...
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:582
    ...
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:597
    ...
    # If the name is a blank string, it returns just the address.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:607
    def email_address_with_name(address, name); end
    ...
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:574
    ...
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:547
    def register_interceptor(interceptor); end

    # Register one or more Interceptors which will be called before mail is sent.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:521
    ...
    # If a string or symbol is passed in it will be camelized and constantized.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:533
    def register_observer(observer); end

    # Register one or more Observers which will be notified when mail is delivered.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:511
    ...
    # @return [Boolean]
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:943
    ...
    # If a string or symbol is passed in it will be camelized and constantized.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:554
    def unregister_interceptor(interceptor); end

    # Unregister one or more previously registered Interceptors.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:526
    ...
    # If a string or symbol is passed in it will be camelized and constantized.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:540
    def unregister_observer(observer); end

    # Unregister one or more previously registered Observers.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:516
    def unregister_observers(*observers); end

    private

    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:628
    def method_missing(method_name, *args); end

    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:558
    def observer_class_for(value); end

    # @return [Boolean]
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:637
    def respond_to_missing?(method, include_all = T.unsafe(nil)); end

    # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:615
    def set_payload_for_mail(payload, mail); end
  end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:0
...
# source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:769
class ActionMailer::Base::LateAttachmentsProxy < ::SimpleDelegator
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:771
  def []=(_name, _content); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:770
  def inline; end
  ...
  # @raise [RuntimeError]
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:774
  def _raise_error; end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:664
class ActionMailer::Base::NullMail
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:665
  def body; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:666
  def header; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:672
  def method_missing(*args); end

  # @return [Boolean]
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:668
  def respond_to?(string, include_all = T.unsafe(nil)); end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/base.rb:498
ActionMailer::Base::PROTECTED_IVARS = T.let(T.unsafe(nil), Array)

# source://actionmailer-7.1.5.2/lib/action_mailer/callbacks.rb:4
...
# source://actionmailer-7.1.5.2/lib/action_mailer/callbacks.rb:12
module ActionMailer::Callbacks::ClassMethods
  # Defines a callback that will get called right after the
  # message's delivery method is finished.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/callbacks.rb:21
  def after_deliver(*filters, &blk); end

  # Defines a callback that will get called around the message's deliver method.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/callbacks.rb:26
  def around_deliver(*filters, &blk); end

  # Defines a callback that will get called right before the
  # message is sent to the delivery method.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/callbacks.rb:15
  def before_deliver(*filters, &blk); end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/collector.rb:8
class ActionMailer::Collector
  include ::AbstractController::Collector

  # @return [Collector] a new instance of Collector
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/collector.rb:12
  def initialize(context, &block); end

  # @raise [ArgumentError]
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/collector.rb:18
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/collector.rb:25
  def custom(mime, options = T.unsafe(nil)); end

  # Returns the value of attribute responses.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/collector.rb:10
  def responses; end
end
...
#
# source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:10
module ActionMailer::DeliveryMethods
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:80
...
#
# source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:42
module ActionMailer::DeliveryMethods::ClassMethods
  ...
  #     arguments: %w[ -i ]
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:52
  def add_delivery_method(symbol, klass, default_options = T.unsafe(nil)); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:44
  def deliveries(&block); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:44
  def deliveries=(arg); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/delivery_methods.rb:58
...
#
# source://actionmailer-7.1.5.2/lib/action_mailer/form_builder.rb:14
module ActionMailer::FormBuilder
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/form_builder.rb:33
...
# source://actionmailer-7.1.5.2/lib/action_mailer/form_builder.rb:21
module ActionMailer::FormBuilder::ClassMethods
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/form_builder.rb:27
...
#
# source://actionmailer-7.1.5.2/lib/action_mailer/inline_preview_interceptor.rb:17
class ActionMailer::InlinePreviewInterceptor
  include ::Base64

  # @return [InlinePreviewInterceptor] a new instance of InlinePreviewInterceptor
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/inline_preview_interceptor.rb:26
  def initialize(message); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/inline_preview_interceptor.rb:30
  def transform!; end

  private

  # source://actionmailer-7.1.5.2/lib/action_mailer/inline_preview_interceptor.rb:51
  def data_url(part); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/inline_preview_interceptor.rb:55
  def find_part(cid); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/inline_preview_interceptor.rb:47
  def html_part; end

  # Returns the value of attribute message.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/inline_preview_interceptor.rb:45
  def message; end

  class << self
    # source://actionmailer-7.1.5.2/lib/action_mailer/inline_preview_interceptor.rb:22
    def previewing_email(message); end
  end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/inline_preview_interceptor.rb:18
...
#
# source://actionmailer-7.1.5.2/lib/action_mailer/log_subscriber.rb:11
class ActionMailer::LogSubscriber < ::ActiveSupport::LogSubscriber
  # An email was delivered.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/log_subscriber.rb:12
  def deliver(event); end

  # Use the logger configured for ActionMailer::Base.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/log_subscriber.rb:38
  def logger; end

  # An email was generated.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/log_subscriber.rb:28
...
#
# source://actionmailer-7.1.5.2/lib/action_mailer/mail_delivery_job.rb:13
class ActionMailer::MailDeliveryJob < ::ActiveJob::Base
  # source://actionmailer-7.1.5.2/lib/action_mailer/mail_delivery_job.rb:21
  def perform(mailer, mail_method, delivery_method, args:, kwargs: T.unsafe(nil), params: T.unsafe(nil)); end

  private

  # source://actionmailer-7.1.5.2/lib/action_mailer/mail_delivery_job.rb:40
  def handle_exception_with_mailer_class(exception); end

  # "Deserialize" the mailer class name by hand in case another argument
  # (like a Global ID reference) raised DeserializationError.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/mail_delivery_job.rb:34
...
# attachments list.
#
# source://actionmailer-7.1.5.2/lib/action_mailer/mail_helper.rb:9
module ActionMailer::MailHelper
  # Access the message attachments list.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/mail_helper.rb:53
  def attachments; end
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/mail_helper.rb:22
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/mail_helper.rb:65
  def format_paragraph(text, len = T.unsafe(nil), indent = T.unsafe(nil)); end

  # Access the mailer instance.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/mail_helper.rb:43
  def mailer; end

  # Access the message instance.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/mail_helper.rb:48
  def message; end
end
...
#
# source://actionmailer-7.1.5.2/lib/action_mailer/message_delivery.rb:19
class ActionMailer::MessageDelivery
  # @return [MessageDelivery] a new instance of MessageDelivery
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/message_delivery.rb:20
  def initialize(mailer_class, action, *args); end

  # Method calls are delegated to the Mail::Message that's ready to deliver.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/message_delivery.rb:31
  def __getobj__; end

  # Unused except for delegator internals (dup, marshalling).
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/message_delivery.rb:36
  ...
  #   end
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/message_delivery.rb:102
  ...
  #   end
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/message_delivery.rb:75
  def deliver_later!(options = T.unsafe(nil)); end
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/message_delivery.rb:123
  def deliver_now; end
  ...
  #   Notifier.welcome(User.first).deliver_now!
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/message_delivery.rb:111
  def deliver_now!; end

  # Returns the resulting Mail::Message
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/message_delivery.rb:41
  def message; end
  ...
  # @return [Boolean]
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/message_delivery.rb:46
  def processed?; end

  private

  # source://actionmailer-7.1.5.2/lib/action_mailer/message_delivery.rb:140
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/message_delivery.rb:134
  def processed_mailer; end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:7
class ActionMailer::NonInferrableMailerError < ::StandardError
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:8
...
#
# source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:89
...
# source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:100
module ActionMailer::Parameterized::ClassMethods
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:106
  def with(params); end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:111
class ActionMailer::Parameterized::Mailer
  # @return [Mailer] a new instance of Mailer
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:112
  def initialize(mailer, params); end

  private

  # source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:117
  def method_missing(method_name, *args); end

  # @return [Boolean]
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:126
  def respond_to_missing?(method, include_all = T.unsafe(nil)); end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:131
class ActionMailer::Parameterized::MessageDelivery < ::ActionMailer::MessageDelivery
  # @return [MessageDelivery] a new instance of MessageDelivery
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:132
  def initialize(mailer_class, action, params, *args); end

  private

  # source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:146
  def enqueue_delivery(delivery_method, options = T.unsafe(nil)); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/parameterized.rb:139
  def processed_mailer; end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:93
class ActionMailer::Preview
  extend ::ActiveSupport::DescendantsTracker

  # @return [Preview] a new instance of Preview
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:98
  def initialize(params = T.unsafe(nil)); end

  # Returns the value of attribute params.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:96
  def params; end

  class << self
    # Returns all mailer preview classes.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:104
    def all; end
    ...
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:112
    ...
    # @return [Boolean]
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:125
    def email_exists?(email); end

    # Returns all of the available email previews.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:120
    def emails; end
    ...
    # @return [Boolean]
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:130
    def exists?(preview); end

    # Find a mailer preview by its underscored class name.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:135
    def find(preview); end

    # Returns the underscored name of the mailer preview without the suffix.
    #
    # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:140
    def preview_name; end

    private

    # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:159
    def inform_preview_interceptors(message); end

    # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:145
    def load_previews; end

    # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:151
    def preview_paths; end

    # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:155
    def show_previews; end
  end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:6
module ActionMailer::Previews
  extend ::ActiveSupport::Concern

  mixes_in_class_methods ::ActionMailer::Previews::ClassMethods

  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:28
  def preview_path; end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:36
module ActionMailer::Previews::ClassMethods
  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:45
  def preview_path; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:37
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:66
  def register_preview_interceptor(interceptor); end

  # Register one or more Interceptors which will be called before mail is previewed.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:54
  ...
  # string is passed in it will be constantized.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:77
  def unregister_preview_interceptor(interceptor); end

  # Unregister one or more previously registered Interceptors.
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:59
  def unregister_preview_interceptors(*interceptors); end

  private

  # source://actionmailer-7.1.5.2/lib/action_mailer/preview.rb:82
  def interceptor_class_for(interceptor); end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/queued_delivery.rb:4
...
# source://actionmailer-7.1.5.2/lib/action_mailer/railtie.rb:9
...
#
# source://actionmailer-7.1.5.2/lib/action_mailer/rescuable.rb:10
module ActionMailer::Rescuable
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/rescuable.rb:20
  def handle_exceptions; end

  private

  # source://actionmailer-7.1.5.2/lib/action_mailer/rescuable.rb:27
...
# source://actionmailer-7.1.5.2/lib/action_mailer/rescuable.rb:0
module ActionMailer::Rescuable::ClassMethods
  # source://actionmailer-7.1.5.2/lib/action_mailer/rescuable.rb:15
  def handle_exception(exception); end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:15
class ActionMailer::TestCase < ::ActiveSupport::TestCase
  ...
  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:41
...
# source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:32
module ActionMailer::TestCase::Behavior
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:82
  def read_fixture(action); end

  private

  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:115
  def charset; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:119
  def encode(subject); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:87
  def initialize_test_deliveries; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:104
  def restore_delivery_method; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:94
  def restore_test_deliveries; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:99
  def set_delivery_method(method); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:109
...
# source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:48
module ActionMailer::TestCase::Behavior::ClassMethods
  # @raise [NonInferrableMailerError]
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:68
  def determine_default_mailer(name); end

  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:60
  def mailer_class; end

  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:49
  def tests(mailer); end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:16
module ActionMailer::TestCase::ClearTestDeliveries
  extend ::ActiveSupport::Concern

  private

  # source://actionmailer-7.1.5.2/lib/action_mailer/test_case.rb:25
...
#
# source://actionmailer-7.1.5.2/lib/action_mailer/test_helper.rb:9
module ActionMailer::TestHelper
  ...
  #   end
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/test_helper.rb:35
  ...
  #   end
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/test_helper.rb:157
  ...
  #   end
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/test_helper.rb:91
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/test_helper.rb:63
  ...
  #   end
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/test_helper.rb:211
  ...
  #   end
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/test_helper.rb:269
  ...
  #
  # source://actionmailer-7.1.5.2/lib/action_mailer/test_helper.rb:251
  def deliver_enqueued_emails(queue: T.unsafe(nil), at: T.unsafe(nil), &block); end

  private

  # source://actionmailer-7.1.5.2/lib/action_mailer/test_helper.rb:278
  def delivery_job_filter(job); end
end

# source://actionmailer-7.1.5.2/lib/action_mailer/gem_version.rb:9
module ActionMailer::VERSION; end

# source://actionmailer-7.1.5.2/lib/action_mailer/gem_version.rb:10
ActionMailer::VERSION::MAJOR = T.let(T.unsafe(nil), Integer)

# source://actionmailer-7.1.5.2/lib/action_mailer/gem_version.rb:11
ActionMailer::VERSION::MINOR = T.let(T.unsafe(nil), Integer)

# source://actionmailer-7.1.5.2/lib/action_mailer/gem_version.rb:13
ActionMailer::VERSION::PRE = T.let(T.unsafe(nil), String)

# source://actionmailer-7.1.5.2/lib/action_mailer/gem_version.rb:15
ActionMailer::VERSION::STRING = T.let(T.unsafe(nil), String)

# source://actionmailer-7.1.5.2/lib/action_mailer/gem_version.rb:12
