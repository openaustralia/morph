...
# source://actionmailer-7.0.8.7/lib/action_mailer/gem_version.rb:3
module ActionMailer
  extend ::ActiveSupport::Autoload

  class << self
    # source://actionmailer-7.0.8.7/lib/action_mailer.rb:56
    def eager_load!; end

    # Returns the currently loaded version of Action Mailer as a <tt>Gem::Version</tt>.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/gem_version.rb:5
    def gem_version; end

    # Returns the currently loaded version of Action Mailer as a
    # <tt>Gem::Version</tt>.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/version.rb:8
    def version; end
  end
end
...
#
# source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:466
class ActionMailer::Base < ::AbstractController::Base
  ...
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:632
  def initialize; end
  ...
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:749
  def attachments; end
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:490
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:15
  def deliver_later_queue_name; end

  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:15
  def deliver_later_queue_name=(val); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:489
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:18
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:17
  ...
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:673
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:51
  ...
  # for the same header.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:711
  ...
  #   end
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:858
  def mail(headers = T.unsafe(nil), &block); end

  # Returns the name of the mailer object.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:666
  def mailer_name; end
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/parameterized.rb:91
  def params; end
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:14
  def perform_deliveries; end

  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:14
  def perform_deliveries=(val); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:25
  def preview_interceptors; end

  # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:14
  def preview_path; end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:638
  def process(method_name, *args); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:13
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:22
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:1059
  def _protected_ivars; end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:935
  def apply_defaults(headers); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:955
  def assign_headers_to_message(message, headers); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:961
  def collect_responses(headers, &block); end

  # @yield [collector]
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:971
  def collect_responses_from_block(headers); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:985
  def collect_responses_from_templates(headers); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:978
  def collect_responses_from_text(headers); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:945
  def compute_default(value); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:1028
  ...
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:925
  def default_i18n_subject(interpolations = T.unsafe(nil)); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:998
  def each_template(paths, name, &block); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:1041
  def insert_part(container, response, charset); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:1055
  def instrument_name; end

  # This and #instrument_name is for caching instrument
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:1048
  ...
  # used.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:903
  def set_content_type(m, user_content_type, class_default); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:1007
  ...
  class << self
    ...
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:558
    ...
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:570
    ...
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:585
    ...
    # If the name is a blank string, it returns just the address.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:595
    def email_address_with_name(address, name); end
    ...
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:562
    ...
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:535
    def register_interceptor(interceptor); end

    # Register one or more Interceptors which will be called before mail is sent.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:509
    ...
    # If a string or symbol is passed in it will be camelized and constantized.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:521
    def register_observer(observer); end

    # Register one or more Observers which will be notified when mail is delivered.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:499
    ...
    # @return [Boolean]
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:931
    ...
    # If a string or symbol is passed in it will be camelized and constantized.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:542
    def unregister_interceptor(interceptor); end

    # Unregister one or more previously registered Interceptors.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:514
    ...
    # If a string or symbol is passed in it will be camelized and constantized.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:528
    def unregister_observer(observer); end

    # Unregister one or more previously registered Observers.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:504
    def unregister_observers(*observers); end

    private

    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:616
    def method_missing(method_name, *args); end

    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:546
    def observer_class_for(value); end

    # @return [Boolean]
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:625
    def respond_to_missing?(method, include_all = T.unsafe(nil)); end

    # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:603
    def set_payload_for_mail(payload, mail); end
  end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:0
...
# source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:757
class ActionMailer::Base::LateAttachmentsProxy < ::SimpleDelegator
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:759
  def []=(_name, _content); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:758
  def inline; end
  ...
  # @raise [RuntimeError]
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:762
  def _raise_error; end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:652
class ActionMailer::Base::NullMail
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:653
  def body; end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:654
  def header; end

  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:660
  def method_missing(*args); end

  # @return [Boolean]
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:656
  def respond_to?(string, include_all = T.unsafe(nil)); end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/base.rb:485
ActionMailer::Base::PROTECTED_IVARS = T.let(T.unsafe(nil), Array)

# source://actionmailer-7.0.8.7/lib/action_mailer/collector.rb:8
class ActionMailer::Collector
  include ::AbstractController::Collector

  # @return [Collector] a new instance of Collector
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/collector.rb:12
  def initialize(context, &block); end

  # @raise [ArgumentError]
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/collector.rb:18
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/collector.rb:25
  def custom(mime, options = T.unsafe(nil)); end

  # Returns the value of attribute responses.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/collector.rb:10
  def responses; end
end
...
#
# source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:8
module ActionMailer::DeliveryMethods
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:78
...
#
# source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:40
module ActionMailer::DeliveryMethods::ClassMethods
  ...
  #     arguments: '-i'
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:50
  def add_delivery_method(symbol, klass, default_options = T.unsafe(nil)); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:42
  def deliveries(*_arg0, &_arg1); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:42
  def deliveries=(arg); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/delivery_methods.rb:56
...
#
# source://actionmailer-7.0.8.7/lib/action_mailer/inline_preview_interceptor.rb:15
class ActionMailer::InlinePreviewInterceptor
  include ::Base64

  # @return [InlinePreviewInterceptor] a new instance of InlinePreviewInterceptor
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/inline_preview_interceptor.rb:24
  def initialize(message); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/inline_preview_interceptor.rb:28
  def transform!; end

  private

  # source://actionmailer-7.0.8.7/lib/action_mailer/inline_preview_interceptor.rb:49
  def data_url(part); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/inline_preview_interceptor.rb:53
  def find_part(cid); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/inline_preview_interceptor.rb:45
  def html_part; end

  # Returns the value of attribute message.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/inline_preview_interceptor.rb:43
  def message; end

  class << self
    # source://actionmailer-7.0.8.7/lib/action_mailer/inline_preview_interceptor.rb:20
    def previewing_email(message); end
  end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/inline_preview_interceptor.rb:16
ActionMailer::InlinePreviewInterceptor::PATTERN = T.let(T.unsafe(nil), Regexp)

# Implements the ActiveSupport::LogSubscriber for logging notifications when
# email is delivered or received.
#
# source://actionmailer-7.0.8.7/lib/action_mailer/log_subscriber.rb:9
class ActionMailer::LogSubscriber < ::ActiveSupport::LogSubscriber
  # An email was delivered.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/log_subscriber.rb:10
  def deliver(event); end

  # Use the logger configured for ActionMailer::Base.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/log_subscriber.rb:33
  def logger; end

  # An email was generated.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/log_subscriber.rb:24
...
#
# source://actionmailer-7.0.8.7/lib/action_mailer/mail_delivery_job.rb:11
class ActionMailer::MailDeliveryJob < ::ActiveJob::Base
  # source://actionmailer-7.0.8.7/lib/action_mailer/mail_delivery_job.rb:16
  def perform(mailer, mail_method, delivery_method, args:, kwargs: T.unsafe(nil), params: T.unsafe(nil)); end

  private

  # source://actionmailer-7.0.8.7/lib/action_mailer/mail_delivery_job.rb:35
  def handle_exception_with_mailer_class(exception); end

  # "Deserialize" the mailer class name by hand in case another argument
  # (like a Global ID reference) raised DeserializationError.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/mail_delivery_job.rb:29
...
# attachments list.
#
# source://actionmailer-7.0.8.7/lib/action_mailer/mail_helper.rb:7
module ActionMailer::MailHelper
  # Access the message attachments list.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/mail_helper.rb:51
  def attachments; end
  ...
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/mail_helper.rb:20
  ...
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/mail_helper.rb:63
  def format_paragraph(text, len = T.unsafe(nil), indent = T.unsafe(nil)); end

  # Access the mailer instance.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/mail_helper.rb:41
  def mailer; end

  # Access the message instance.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/mail_helper.rb:46
  def message; end
end
...
#
# source://actionmailer-7.0.8.7/lib/action_mailer/message_delivery.rb:17
class ActionMailer::MessageDelivery
  # @return [MessageDelivery] a new instance of MessageDelivery
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/message_delivery.rb:18
  def initialize(mailer_class, action, *args); end

  # Method calls are delegated to the Mail::Message that's ready to deliver.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/message_delivery.rb:29
  def __getobj__; end

  # Unused except for delegator internals (dup, marshalling).
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/message_delivery.rb:34
  ...
  #   end
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/message_delivery.rb:98
  ...
  #   end
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/message_delivery.rb:72
  def deliver_later!(options = T.unsafe(nil)); end
  ...
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/message_delivery.rb:117
  def deliver_now; end
  ...
  #   Notifier.welcome(User.first).deliver_now!
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/message_delivery.rb:107
  def deliver_now!; end

  # Returns the resulting Mail::Message
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/message_delivery.rb:39
  def message; end
  ...
  # @return [Boolean]
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/message_delivery.rb:44
  def processed?; end

  private

  # source://actionmailer-7.0.8.7/lib/action_mailer/message_delivery.rb:132
  def enqueue_delivery(delivery_method, options = T.unsafe(nil)); end

  # Returns the processed Mailer instance. We keep this instance
  # on hand so we can delegate exception handling to it.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/message_delivery.rb:126
  def processed_mailer; end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:7
class ActionMailer::NonInferrableMailerError < ::StandardError
  ...
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:8
...
#
# source://actionmailer-7.0.8.7/lib/action_mailer/parameterized.rb:87
...
# source://actionmailer-7.0.8.7/lib/action_mailer/parameterized.rb:94
module ActionMailer::Parameterized::ClassMethods
  ...
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/parameterized.rb:100
  def with(params); end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/parameterized.rb:105
class ActionMailer::Parameterized::Mailer
  # @return [Mailer] a new instance of Mailer
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/parameterized.rb:106
  def initialize(mailer, params); end

  private

  # source://actionmailer-7.0.8.7/lib/action_mailer/parameterized.rb:111
  def method_missing(method_name, *args); end

  # @return [Boolean]
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/parameterized.rb:120
  def respond_to_missing?(method, include_all = T.unsafe(nil)); end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/parameterized.rb:125
class ActionMailer::Parameterized::MessageDelivery < ::ActionMailer::MessageDelivery
  # @return [MessageDelivery] a new instance of MessageDelivery
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/parameterized.rb:126
  def initialize(mailer_class, action, params, *args); end

  private

  # source://actionmailer-7.0.8.7/lib/action_mailer/parameterized.rb:140
  def enqueue_delivery(delivery_method, options = T.unsafe(nil)); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/parameterized.rb:133
  def processed_mailer; end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:69
class ActionMailer::Preview
  extend ::ActiveSupport::DescendantsTracker

  # @return [Preview] a new instance of Preview
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:74
  def initialize(params = T.unsafe(nil)); end

  # Returns the value of attribute params.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:72
  def params; end

  class << self
    # Returns all mailer preview classes.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:80
    def all; end
    ...
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:88
    ...
    # @return [Boolean]
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:101
    def email_exists?(email); end

    # Returns all of the available email previews.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:96
    def emails; end
    ...
    # @return [Boolean]
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:106
    def exists?(preview); end

    # Find a mailer preview by its underscored class name.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:111
    def find(preview); end

    # Returns the underscored name of the mailer preview without the suffix.
    #
    # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:116
    def preview_name; end

    private

    # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:135
    def inform_preview_interceptors(message); end

    # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:121
    def load_previews; end

    # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:127
    def preview_path; end

    # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:131
    def show_previews; end
  end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:6
...
# source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:28
module ActionMailer::Previews::ClassMethods
  # Register an Interceptor which will be called before mail is previewed.
  # Either a class or a string can be passed in as the Interceptor. If a
  # string is passed in it will be constantized.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:42
  def register_preview_interceptor(interceptor); end

  # Register one or more Interceptors which will be called before mail is previewed.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:30
  ...
  # string is passed in it will be constantized.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:53
  def unregister_preview_interceptor(interceptor); end

  # Unregister one or more previously registered Interceptors.
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:35
  def unregister_preview_interceptors(*interceptors); end

  private

  # source://actionmailer-7.0.8.7/lib/action_mailer/preview.rb:58
  def interceptor_class_for(interceptor); end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/railtie.rb:9
...
#
# source://actionmailer-7.0.8.7/lib/action_mailer/rescuable.rb:8
module ActionMailer::Rescuable
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/rescuable.rb:18
  def handle_exceptions; end

  private

  # source://actionmailer-7.0.8.7/lib/action_mailer/rescuable.rb:25
...
# source://actionmailer-7.0.8.7/lib/action_mailer/rescuable.rb:0
module ActionMailer::Rescuable::ClassMethods
  # source://actionmailer-7.0.8.7/lib/action_mailer/rescuable.rb:13
  def handle_exception(exception); end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:15
class ActionMailer::TestCase < ::ActiveSupport::TestCase
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:41
...
# source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:32
module ActionMailer::TestCase::Behavior
  ...
  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:106
  def charset; end

  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:110
  def encode(subject); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:78
  def initialize_test_deliveries; end

  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:114
  def read_fixture(action); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:95
  def restore_delivery_method; end

  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:85
  def restore_test_deliveries; end

  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:90
  def set_delivery_method(method); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:100
...
# source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:48
module ActionMailer::TestCase::Behavior::ClassMethods
  # @raise [NonInferrableMailerError]
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:68
  def determine_default_mailer(name); end

  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:60
  def mailer_class; end

  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:49
  def tests(mailer); end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:16
module ActionMailer::TestCase::ClearTestDeliveries
  extend ::ActiveSupport::Concern

  private

  # source://actionmailer-7.0.8.7/lib/action_mailer/test_case.rb:25
...
#
# source://actionmailer-7.0.8.7/lib/action_mailer/test_helper.rb:8
module ActionMailer::TestHelper
  ...
  #   end
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/test_helper.rb:34
  ...
  #   end
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/test_helper.rb:126
  ...
  #   end
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/test_helper.rb:92
  ...
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/test_helper.rb:64
  ...
  #   end
  #
  # source://actionmailer-7.0.8.7/lib/action_mailer/test_helper.rb:150
  def assert_no_enqueued_emails(&block); end

  private

  # source://actionmailer-7.0.8.7/lib/action_mailer/test_helper.rb:155
  def delivery_job_filter(job); end
end

# source://actionmailer-7.0.8.7/lib/action_mailer/gem_version.rb:9
module ActionMailer::VERSION; end

# source://actionmailer-7.0.8.7/lib/action_mailer/gem_version.rb:10
ActionMailer::VERSION::MAJOR = T.let(T.unsafe(nil), Integer)

# source://actionmailer-7.0.8.7/lib/action_mailer/gem_version.rb:11
ActionMailer::VERSION::MINOR = T.let(T.unsafe(nil), Integer)

# source://actionmailer-7.0.8.7/lib/action_mailer/gem_version.rb:13
ActionMailer::VERSION::PRE = T.let(T.unsafe(nil), String)

# source://actionmailer-7.0.8.7/lib/action_mailer/gem_version.rb:15
ActionMailer::VERSION::STRING = T.let(T.unsafe(nil), String)

# source://actionmailer-7.0.8.7/lib/action_mailer/gem_version.rb:12
