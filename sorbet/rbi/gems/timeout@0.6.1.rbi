...
# source://timeout-0.6.1/lib/timeout.rb:21
module Timeout
  private

  # See Timeout.timeout
  #
  # source://timeout-0.6.1/lib/timeout.rb:311
  ...
  class << self
    ...
    # @raise [ArgumentError]
    #
    # source://timeout-0.6.1/lib/timeout.rb:278
...
#
# source://timeout-0.6.1/lib/timeout.rb:33
class Timeout::Error < ::RuntimeError
  class << self
    # source://timeout-0.6.1/lib/timeout.rb:34
...
class Timeout::Request
  ...
  # @return [Boolean]
  #
  # source://timeout-0.6.1/lib/timeout.rb:157
  def done?; end

  # @return [Boolean]
  #
  # source://timeout-0.6.1/lib/timeout.rb:163
  def expired?(now); end

  # source://timeout-0.6.1/lib/timeout.rb:177
  def finished; end

  # Only called by the timeout thread, so does not need Sync.synchronize
  #
  # source://timeout-0.6.1/lib/timeout.rb:168
  def interrupt; end
end

# source://timeout-0.6.1/lib/timeout.rb:56
class Timeout::State
  # @return [State] a new instance of State
  #
  # source://timeout-0.6.1/lib/timeout.rb:57
  def initialize; end

  # source://timeout-0.6.1/lib/timeout.rb:134
  def add_request(request); end

  # source://timeout-0.6.1/lib/timeout.rb:83
  def create_timeout_thread; end

  # source://timeout-0.6.1/lib/timeout.rb:120
  ...
  class << self
    ...
    #
    # source://timeout-0.6.1/lib/timeout.rb:78
    def instance; end
  end
end

# source://timeout-0.6.1/lib/timeout.rb:76
Timeout::State::GLOBAL_STATE = T.let(T.unsafe(nil), Timeout::State)

# source://timeout-0.6.1/lib/timeout.rb:185
module Timeout::Sync
  class << self
    ...
    #
    # source://timeout-0.6.1/lib/timeout.rb:188
...
# The version
#
# source://timeout-0.6.1/lib/timeout.rb:23
