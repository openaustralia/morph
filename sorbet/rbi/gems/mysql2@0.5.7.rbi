...
#
# source://mysql2-0.5.7/lib/mysql2/version.rb:1
module Mysql2; end

# source://mysql2-0.5.7/lib/mysql2/client.rb:2
class Mysql2::Client
  # @raise [Mysql2::Error]
  # @return [Client] a new instance of Client
  #
  # source://mysql2-0.5.7/lib/mysql2/client.rb:21
  ...
  # path is provide.
  #
  # source://mysql2-0.5.7/lib/mysql2/client.rb:123
  def find_default_ca_path; end

  # source://mysql2-0.5.7/lib/mysql2/client.rb:159
  def info; end
  ...
  #
  # source://mysql2-0.5.7/lib/mysql2/client.rb:134
  def parse_connect_attrs(conn_attrs); end

  # source://mysql2-0.5.7/lib/mysql2/client.rb:106
  def parse_flags_array(flags, initial = T.unsafe(nil)); end

  # source://mysql2-0.5.7/lib/mysql2/client.rb:95
  ...
  # source://mysql2-0.5.7/lib/mysql2/client.rb:150
  def query_info; end
  ...
  #
  # source://mysql2-0.5.7/lib/mysql2/client.rb:3
  def query_options; end

  # source://mysql2-0.5.7/lib/mysql2/client.rb:144
  ...
  # source://mysql2-0.5.7/lib/mysql2/client.rb:165
  ...
  class << self
    # source://mysql2-0.5.7/lib/mysql2/client.rb:5
    ...
    # source://mysql2-0.5.7/lib/mysql2/client.rb:181
...
# source://mysql2-0.5.7/lib/mysql2/error.rb:2
class Mysql2::Error < ::StandardError
  # @return [Error] a new instance of Error
  #
  # source://mysql2-0.5.7/lib/mysql2/error.rb:53
  ...
  #
  # source://mysql2-0.5.7/lib/mysql2/error.rb:47
  def errno; end
  ...
  #
  # source://mysql2-0.5.7/lib/mysql2/error.rb:93
  def clean_message(message); end

  class << self
    # source://mysql2-0.5.7/lib/mysql2/error.rb:61
    def new_with_args(msg, server_version, error_number, sql_state); end
  end
end

# source://mysql2-0.5.7/lib/mysql2/error.rb:12
Mysql2::Error::CODES = T.let(T.unsafe(nil), Hash)

# source://mysql2-0.5.7/lib/mysql2/error.rb:9
class Mysql2::Error::ConnectionError < ::Mysql2::Error; end

# source://mysql2-0.5.7/lib/mysql2/error.rb:3
Mysql2::Error::ENCODE_OPTS = T.let(T.unsafe(nil), Hash)

# source://mysql2-0.5.7/lib/mysql2/error.rb:10
class Mysql2::Error::TimeoutError < ::Mysql2::Error; end

# source://mysql2-0.5.7/lib/mysql2/field.rb:2
...
# source://mysql2-0.5.7/lib/mysql2/result.rb:2
class Mysql2::Result
  include ::Enumerable
  ...
  #
  # source://mysql2-0.5.7/lib/mysql2/result.rb:3
  def server_flags; end

  def size; end
end

# source://mysql2-0.5.7/lib/mysql2/statement.rb:2
class Mysql2::Statement
  ...
  # source://mysql2-0.5.7/lib/mysql2/statement.rb:3
...
# source://mysql2-0.5.7/lib/mysql2.rb:62
module Mysql2::Util
  class << self
    # Rekey a string-keyed hash with equivalent symbols.
    #
    # source://mysql2-0.5.7/lib/mysql2.rb:66
    def key_hash_as_symbols(hash); end
  end
end

# source://mysql2-0.5.7/lib/mysql2.rb:81
Mysql2::Util::TIMEOUT_ERROR_CLASS = Timeout::ExitException

# source://mysql2-0.5.7/lib/mysql2.rb:86
Mysql2::Util::TIMEOUT_ERROR_NEVER = T.let(T.unsafe(nil), Hash)

# source://mysql2-0.5.7/lib/mysql2/version.rb:2
