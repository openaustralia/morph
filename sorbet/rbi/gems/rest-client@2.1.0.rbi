...
#
# source://rest-client-2.1.0/lib/restclient/version.rb:1
module RestClient
  class << self
...
# source://rest-client-2.1.0/lib/restclient/abstract_response.rb:6
module RestClient::AbstractResponse
  # HTTP status code
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:30
  def code; end
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:92
  def cookie_jar; end
  ...
  # @see #cookie_jar
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:78
  def cookies; end

  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:138
  def description; end

  # Returns the value of attribute duration.
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:8
  def duration; end
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:150
  def follow_get_redirection(&block); end

  # Follow a redirection response by making a new HTTP request to the
  # redirection target.
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:144
  def follow_redirection(&block); end

  # A hash of the headers, beautified with symbols and underscores.
  # e.g. "Content-type" will become :content_type.
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:40
  def headers; end

  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:34
  def history; end

  # @raise [NotImplementedError]
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:10
  def inspect; end

  # Logger from the request, potentially nil.
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:15
  def log; end

  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:19
  ...
  # The raw headers.
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:45
  def raw_headers; end
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:52
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:113
  ...
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:133
  def to_i; end
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:202
  def _follow_redirection(new_args, &block); end

  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:236
  def check_max_redirects; end

  # @raise [klass]
  #
  # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:242
  ...
  class << self
    ...
    # @return [Hash]
    #
    # source://rest-client-2.1.0/lib/restclient/abstract_response.rb:179
    def beautify_headers(headers); end
  end
end

# source://rest-client-2.1.0/lib/restclient/exceptions.rb:178
class RestClient::Accepted < ::RestClient::RequestFailed
  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:179
...
#
# source://rest-client-2.1.0/lib/restclient/exceptions.rb:109
class RestClient::Exception < ::RuntimeError
  # @return [Exception] a new instance of Exception
  #
  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:114
  def initialize(response = T.unsafe(nil), initial_response_code = T.unsafe(nil)); end

  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:145
  def default_message; end

  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:133
  def http_body; end

  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:120
  def http_code; end

  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:129
  def http_headers; end

  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:141
  def message; end
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:112
  def message=(_arg0); end

  # Returns the value of attribute original_exception.
  #
  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:111
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:110
  def response; end
  ...
  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:137
  def to_s; end
end

# Compatibility
#
# source://rest-client-2.1.0/lib/restclient/exceptions.rb:151
...
#
# source://rest-client-2.1.0/lib/restclient/exceptions.rb:171
module RestClient::Exceptions; end

# Map http status codes to the corresponding exception class
#
# source://rest-client-2.1.0/lib/restclient/exceptions.rb:173
...
# ruby 2.0 or greater).
#
# source://rest-client-2.1.0/lib/restclient/exceptions.rb:212
class RestClient::Exceptions::OpenTimeout < ::RestClient::Exceptions::Timeout
  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:213
  def default_message; end
end
...
# ruby 2.0 or greater).
#
# source://rest-client-2.1.0/lib/restclient/exceptions.rb:220
class RestClient::Exceptions::ReadTimeout < ::RestClient::Exceptions::Timeout
  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:221
  def default_message; end
end
...
#
# source://rest-client-2.1.0/lib/restclient/exceptions.rb:202
class RestClient::Exceptions::Timeout < ::RestClient::RequestTimeout
  # @return [Timeout] a new instance of Timeout
  #
  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:203
...
#
# source://rest-client-2.1.0/lib/restclient/params_array.rb:13
class RestClient::ParamsArray
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/params_array.rb:31
  def initialize(array); end

  # source://rest-client-2.1.0/lib/restclient/params_array.rb:35
  def each(*args, &blk); end

  # @return [Boolean]
  #
  # source://rest-client-2.1.0/lib/restclient/params_array.rb:39
  def empty?; end

  private

  # source://rest-client-2.1.0/lib/restclient/params_array.rb:45
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/params_array.rb:54
...
# source://rest-client-2.1.0/lib/restclient/payload.rb:13
...
# source://rest-client-2.1.0/lib/restclient/payload.rb:59
...
# source://rest-client-2.1.0/lib/restclient/payload.rb:141
class RestClient::Payload::Multipart < ::RestClient::Payload::Base
  # source://rest-client-2.1.0/lib/restclient/payload.rb:201
  def boundary; end

  # source://rest-client-2.1.0/lib/restclient/payload.rb:144
  def build_stream(params); end

  # source://rest-client-2.1.0/lib/restclient/payload.rb:229
  def close; end

  # source://rest-client-2.1.0/lib/restclient/payload.rb:181
  def create_file_field(s, k, v); end

  # source://rest-client-2.1.0/lib/restclient/payload.rb:174
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/payload.rb:221
  def handle_key(key); end

  # source://rest-client-2.1.0/lib/restclient/payload.rb:225
  def headers; end

  # source://rest-client-2.1.0/lib/restclient/payload.rb:196
  def mime_for(path); end
end

# source://rest-client-2.1.0/lib/restclient/payload.rb:142
RestClient::Payload::Multipart::EOL = T.let(T.unsafe(nil), String)

# source://rest-client-2.1.0/lib/restclient/payload.rb:111
class RestClient::Payload::Streamed < ::RestClient::Payload::Base
  # source://rest-client-2.1.0/lib/restclient/payload.rb:112
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/payload.rb:116
  def length; end
...
# source://rest-client-2.1.0/lib/restclient/payload.rb:130
class RestClient::Payload::UrlEncoded < ::RestClient::Payload::Base
  # source://rest-client-2.1.0/lib/restclient/payload.rb:131
  def build_stream(params = T.unsafe(nil)); end

  # source://rest-client-2.1.0/lib/restclient/payload.rb:136
  def headers; end
end
...
# source://rest-client-2.1.0/lib/restclient/platform.rb:4
module RestClient::Platform
  class << self
    # source://rest-client-2.1.0/lib/restclient/platform.rb:32
    def architecture; end

    # source://rest-client-2.1.0/lib/restclient/platform.rb:45
    ...
    # @return [Boolean]
    #
    # source://rest-client-2.1.0/lib/restclient/platform.rb:27
    def jruby?; end
    ...
    # @return [Boolean]
    #
    # source://rest-client-2.1.0/lib/restclient/platform.rb:9
    def mac_mri?; end

    # source://rest-client-2.1.0/lib/restclient/platform.rb:36
    ...
    # @return [Boolean]
    #
    # source://rest-client-2.1.0/lib/restclient/platform.rb:17
    def windows?; end
  end
end
...
#
# source://rest-client-2.1.0/lib/restclient/raw_response.rb:12
class RestClient::RawResponse
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/raw_response.rb:26
  def initialize(tempfile, net_http_res, request, start_time = T.unsafe(nil)); end

  # source://rest-client-2.1.0/lib/restclient/raw_response.rb:39
  def body; end

  # Returns the value of attribute end_time.
  #
  # source://rest-client-2.1.0/lib/restclient/raw_response.rb:16
  def end_time; end
  ...
  # source://rest-client-2.1.0/lib/restclient/raw_response.rb:18
  def inspect; end
  ...
  # source://rest-client-2.1.0/lib/restclient/raw_response.rb:44
  def size; end
  ...
  # source://rest-client-2.1.0/lib/restclient/raw_response.rb:35
  def to_s; end
end
...
#
# source://rest-client-2.1.0/lib/restclient/request.rb:52
class RestClient::Request
  # @return [Request] a new instance of Request
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:73
  def initialize(args); end

  # Returns the value of attribute args.
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:54
  def args; end

  # @return [HTTP::CookieJar]
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:251
  def cookie_jar; end
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:240
  def cookies; end
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:586
  def default_headers; end

  # source://rest-client-2.1.0/lib/restclient/request.rb:160
  ...
  # source://rest-client-2.1.0/lib/restclient/request.rb:69
  def inspect; end

  # Default to the global logger if there's not a request-specific one
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:536
  def log; end

  # source://rest-client-2.1.0/lib/restclient/request.rb:540
  def log_request; end
  ...
  # @see Request#cookie_jar
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:262
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:388
  ...
  # source://rest-client-2.1.0/lib/restclient/request.rb:468
  def net_http_do_request(http, req, body = T.unsafe(nil), &block); end

  # source://rest-client-2.1.0/lib/restclient/request.rb:448
  def net_http_object(hostname, port); end

  # source://rest-client-2.1.0/lib/restclient/request.rb:464
  ...
  # @return [String]
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:487
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:319
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:200
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:430
  def proxy_uri; end
  ...
  # source://rest-client-2.1.0/lib/restclient/request.rb:521
  def redacted_uri; end

  # source://rest-client-2.1.0/lib/restclient/request.rb:531
  def redacted_url; end

  # An array of previous redirection responses
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:60
  ...
  # source://rest-client-2.1.0/lib/restclient/request.rb:173
  def ssl_ca_file; end
  ...
  # https://github.com/rest-client/rest-client/issues/599
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:558
  ...
  # @return [Boolean]
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:182
  def use_ssl?; end
  ...
  # SSL-related options
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:169
  def verify_ssl; end

  private

  # source://rest-client-2.1.0/lib/restclient/request.rb:788
  ...
  # @return [String]
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:861
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:646
  ...
  # @return [URI]
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:605
  def parse_url_with_auth!(url); end

  # source://rest-client-2.1.0/lib/restclient/request.rb:841
  def parser; end

  # source://rest-client-2.1.0/lib/restclient/request.rb:621
  def print_verify_callback_warnings; end

  # @param res The Net::HTTP response object
  # @param start_time [Time] Time of request start
  #
  # source://rest-client-2.1.0/lib/restclient/request.rb:821
  def process_result(res, start_time, tempfile = T.unsafe(nil), &block); end

  # source://rest-client-2.1.0/lib/restclient/request.rb:782
  def setup_credentials(req); end

  # source://rest-client-2.1.0/lib/restclient/request.rb:651
  ...
  class << self
    ...
    #
    # source://rest-client-2.1.0/lib/restclient/request.rb:501
    def default_ssl_cert_store; end

    # source://rest-client-2.1.0/lib/restclient/request.rb:62
    def execute(args, &block); end
  end
end

# source://rest-client-2.1.0/lib/restclient/request.rb:66
...
#
# source://rest-client-2.1.0/lib/restclient/exceptions.rb:155
class RestClient::RequestFailed < ::RestClient::ExceptionWithResponse
  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:157
  def default_message; end

  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:161
  def to_s; end
end
...
#
# source://rest-client-2.1.0/lib/restclient/resource.rb:36
class RestClient::Resource
  # @return [Resource] a new instance of Resource
  #
  # source://rest-client-2.1.0/lib/restclient/resource.rb:39
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/resource.rb:160
  def [](suburl, &new_block); end

  # Returns the value of attribute block.
  #
  # source://rest-client-2.1.0/lib/restclient/resource.rb:37
  def block; end

  # source://rest-client-2.1.0/lib/restclient/resource.rb:168
  def concat_urls(url, suburl); end

  # source://rest-client-2.1.0/lib/restclient/resource.rb:97
  def delete(additional_headers = T.unsafe(nil), &block); end

  # source://rest-client-2.1.0/lib/restclient/resource.rb:49
  def get(additional_headers = T.unsafe(nil), &block); end

  # source://rest-client-2.1.0/lib/restclient/resource.rb:58
  def head(additional_headers = T.unsafe(nil), &block); end

  # source://rest-client-2.1.0/lib/restclient/resource.rb:118
  def headers; end

  # source://rest-client-2.1.0/lib/restclient/resource.rb:130
  def log; end

  # source://rest-client-2.1.0/lib/restclient/resource.rb:126
  def open_timeout; end
  ...
  # source://rest-client-2.1.0/lib/restclient/resource.rb:114
  def password; end

  # source://rest-client-2.1.0/lib/restclient/resource.rb:87
  def patch(payload, additional_headers = T.unsafe(nil), &block); end

  # source://rest-client-2.1.0/lib/restclient/resource.rb:67
  def post(payload, additional_headers = T.unsafe(nil), &block); end

  # source://rest-client-2.1.0/lib/restclient/resource.rb:77
  def put(payload, additional_headers = T.unsafe(nil), &block); end

  # source://rest-client-2.1.0/lib/restclient/resource.rb:122
  def read_timeout; end

  # source://rest-client-2.1.0/lib/restclient/resource.rb:106
  def to_s; end
  ...
  # source://rest-client-2.1.0/lib/restclient/resource.rb:110
  def user; end
end
...
#
# source://rest-client-2.1.0/lib/restclient/response.rb:5
class RestClient::Response < ::String
  ...
  # @return [String]
  #
  # source://rest-client-2.1.0/lib/restclient/response.rb:16
  def body; end

  # source://rest-client-2.1.0/lib/restclient/response.rb:37
  def inspect; end
  ...
  # @return [String]
  #
  # source://rest-client-2.1.0/lib/restclient/response.rb:26
  def to_s; end
  ...
  # @return [String]
  #
  # source://rest-client-2.1.0/lib/restclient/response.rb:33
  def to_str; end

  private

  # source://rest-client-2.1.0/lib/restclient/response.rb:81
  ...
  class << self
    ...
    # @param start_time [Time]
    #
    # source://rest-client-2.1.0/lib/restclient/response.rb:49
    ...
    # if possible.
    #
    # source://rest-client-2.1.0/lib/restclient/response.rb:60
...
# source://rest-client-2.1.0/lib/restclient/exceptions.rb:238
class RestClient::SSLCertificateNotVerified < ::RestClient::Exception
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:239
...
#
# source://rest-client-2.1.0/lib/restclient/exceptions.rb:231
class RestClient::ServerBrokeConnection < ::RestClient::Exception
  ...
  #
  # source://rest-client-2.1.0/lib/restclient/exceptions.rb:232
  def initialize(message = T.unsafe(nil)); end
end
...
#
# source://rest-client-2.1.0/lib/restclient/utils.rb:5
module RestClient::Utils
  class << self
    ...
    #
    # source://rest-client-2.1.0/lib/restclient/utils.rb:75
    ...
    #
    # source://rest-client-2.1.0/lib/restclient/utils.rb:56
    ...
    # @todo remove this method when dropping support for Ruby 2.0
    #
    # source://rest-client-2.1.0/lib/restclient/utils.rb:112
    ...
    # @since 2.0.0
    #
    # source://rest-client-2.1.0/lib/restclient/utils.rb:206
    ...
    #
    # source://rest-client-2.1.0/lib/restclient/utils.rb:270
    ...
    #
    # source://rest-client-2.1.0/lib/restclient/utils.rb:225
    ...
    #   found.
    #
    # source://rest-client-2.1.0/lib/restclient/utils.rb:25
...
# source://rest-client-2.1.0/lib/restclient/windows.rb:2
