...
#
# source://drb-2.2.3/lib/drb/eq.rb:2
module DRb
  private
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1882
  def config; end
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1839
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1984
  ...
  # See #current_server.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1893
  def front; end
  ...
  # @return [Boolean]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1872
  def here?(uri); end
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1938
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1930
  def install_id_conv(idconv); end

  # source://drb-2.2.3/lib/drb/drb.rb:1944
  def mutex; end
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1826
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1962
  def regist_server(server); end

  # Removes +server+ from the list of registered servers.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1971
  ...
  # See DRbServer::new.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1818
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1851
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1919
  def thread; end
  ...
  # See #current_server.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1910
  def to_id(obj); end
  ...
  # See #current_server.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1902
  def to_obj(ref); end
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1860
  def uri; end
...
# by users.
#
# source://drb-2.2.3/lib/drb/drb.rb:382
...
# the local server.
#
# source://drb-2.2.3/lib/drb/drb.rb:546
class DRb::DRbArray
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:551
  def initialize(ary); end

  # source://drb-2.2.3/lib/drb/drb.rb:570
  def _dump(lv); end

  class << self
    # source://drb-2.2.3/lib/drb/drb.rb:566
    def _load(s); end
  end
end
...
#
# source://drb-2.2.3/lib/drb/drb.rb:1284
class DRb::DRbConn
  # @return [DRbConn] a new instance of DRbConn
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1345
  def initialize(remote_uri); end

  # @return [Boolean]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1361
  def alive?; end

  # source://drb-2.2.3/lib/drb/drb.rb:1356
  def close; end

  # source://drb-2.2.3/lib/drb/drb.rb:1351
  def send_message(ref, msg_id, arg, block); end

  # source://drb-2.2.3/lib/drb/drb.rb:1349
  def uri; end

  class << self
    # source://drb-2.2.3/lib/drb/drb.rb:1287
    def make_pool; end

    # source://drb-2.2.3/lib/drb/drb.rb:1325
    def open(remote_uri); end

    # source://drb-2.2.3/lib/drb/drb.rb:1320
    def stop_pool; end
  end
end
...
#
# source://drb-2.2.3/lib/drb/drb.rb:393
class DRb::DRbIdConv
  ...
  # object space.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:407
  def to_id(obj); end
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:399
  def to_obj(ref); end
end
...
# normal use.
#
# source://drb-2.2.3/lib/drb/drb.rb:584
class DRb::DRbMessage
  # @return [DRbMessage] a new instance of DRbMessage
  #
  # source://drb-2.2.3/lib/drb/drb.rb:585
  def initialize(config); end

  # source://drb-2.2.3/lib/drb/drb.rb:590
  def dump(obj, error = T.unsafe(nil)); end

  # @raise [DRbConnError]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:607
  def load(soc); end

  # source://drb-2.2.3/lib/drb/drb.rb:667
  def recv_reply(stream); end

  # @raise [DRbConnError]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:647
  def recv_request(stream); end

  # source://drb-2.2.3/lib/drb/drb.rb:661
  def send_reply(stream, succ, result); end

  # source://drb-2.2.3/lib/drb/drb.rb:633
  def send_request(stream, ref, msg_id, arg, b); end

  private

  # source://drb-2.2.3/lib/drb/drb.rb:674
  def make_proxy(obj, error = T.unsafe(nil)); end
end

# source://drb-2.2.3/lib/drb/eq.rb:3
class DRb::DRbObject
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1117
  def initialize(obj, uri = T.unsafe(nil)); end

  # source://drb-2.2.3/lib/drb/eq.rb:4
  def ==(other); end

  # Get the reference of the object, if local.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1143
  def __drbref; end

  # Get the URI of the remote object.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1138
  def __drburi; end
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1108
  def _dump(lv); end

  # source://drb-2.2.3/lib/drb/eq.rb:4
  def eql?(other); end

  # source://drb-2.2.3/lib/drb/eq.rb:9
  def hash; end

  # source://drb-2.2.3/lib/drb/drb.rb:1163
  def method_missing(msg_id, *a, &b); end

  # source://drb-2.2.3/lib/drb/drb.rb:1215
  def pretty_print(q); end

  # source://drb-2.2.3/lib/drb/drb.rb:1219
  ...
  # @return [Boolean]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1151
...
# drb distribution.
#
# source://drb-2.2.3/lib/drb/drb.rb:749
module DRb::DRbProtocol
  private

  # Add a new protocol to the DRbProtocol module.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:752
  def add_protocol(prot); end

  # source://drb-2.2.3/lib/drb/drb.rb:830
  ...
  # @raise [DRbBadURI]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:764
  ...
  # @raise [DRbBadURI]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:792
  ...
  # @raise [DRbBadURI]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:813
...
#
# source://drb-2.2.3/lib/drb/drb.rb:1378
class DRb::DRbServer
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1479
  ...
  # @return [Boolean]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1534
  def alive?; end
  ...
  # @raise [ArgumentError]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1622
  def check_insecure_method(obj, msg_id); end

  # The configuration of this DRbServer
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1521
  def config; end
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1518
  def front; end
  ...
  # @return [Boolean]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1539
  def here?(uri); end

  # Stop this server.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1544
  def stop_service; end
  ...
  # session.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1512
  def thread; end

  # Convert a local object to a dRuby reference.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1561
  def to_id(obj); end

  # Convert a dRuby reference to the local object it refers to.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1554
  def to_obj(ref); end

  # The URI of this DRbServer.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1505
  def uri; end
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1531
  def verbose; end
  ...
  # In verbose mode, failed calls are logged to stdout.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1526
  def verbose=(v); end
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1608
  def any_to_s(obj); end

  # source://drb-2.2.3/lib/drb/drb.rb:1746
  ...
  # @return [Boolean]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1602
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1764
  def main_loop; end

  # Starts the DRb main loop in a new thread.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1583
  def run; end

  # source://drb-2.2.3/lib/drb/drb.rb:1568
  def shutdown; end
  ...
  class << self
    ...
    #
    # source://drb-2.2.3/lib/drb/drb.rb:1403
    ...
    #
    # source://drb-2.2.3/lib/drb/drb.rb:1389
    ...
    #
    # source://drb-2.2.3/lib/drb/drb.rb:1410
    ...
    #
    # source://drb-2.2.3/lib/drb/drb.rb:1396
    def default_load_limit(sz); end

    # source://drb-2.2.3/lib/drb/drb.rb:1426
    def make_config(hash = T.unsafe(nil)); end

    # Get the default value of the :verbose option.
    #
    # source://drb-2.2.3/lib/drb/drb.rb:1422
    def verbose; end
    ...
    #
    # source://drb-2.2.3/lib/drb/drb.rb:1417
    def verbose=(on); end
  end
end

# source://drb-2.2.3/lib/drb/drb.rb:1652
class DRb::DRbServer::InvokeMethod
  # @return [InvokeMethod] a new instance of InvokeMethod
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1653
  def initialize(drb_server, client); end

  # source://drb-2.2.3/lib/drb/drb.rb:1658
  def perform; end

  private

  # source://drb-2.2.3/lib/drb/drb.rb:1704
  def block_yield(x); end

  # source://drb-2.2.3/lib/drb/drb.rb:1695
  def check_insecure_method; end

  # source://drb-2.2.3/lib/drb/drb.rb:1687
  def init_with_client; end

  # source://drb-2.2.3/lib/drb/drb.rb:1711
  def perform_with_block; end

  # source://drb-2.2.3/lib/drb/drb.rb:1731
  def perform_without_block; end

  # source://drb-2.2.3/lib/drb/drb.rb:1699
...
#
# source://drb-2.2.3/lib/drb/drb.rb:843
class DRb::DRbTCPSocket
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:931
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:999
  def accept; end
  ...
  # @return [Boolean]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1029
  def alive?; end
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:981
  def close; end

  # Get the address of our TCP peer (the other end of the socket
  # we are bound to.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:946
  def peeraddr; end

  # On the client side, receive a reply from the server.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:969
  def recv_reply; end

  # On the server side, receive a request from the client.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:959
  def recv_request; end

  # On the server side, send a reply to the client.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:964
  def send_reply(succ, result); end

  # On the client side, send a request to the server.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:954
  def send_request(ref, msg_id, arg, b); end

  # source://drb-2.2.3/lib/drb/drb.rb:1038
  def set_sockopt(soc); end

  # Graceful shutdown
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1024
  def shutdown; end

  # Get the socket.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:951
  def stream; end

  # Get the URI that we are connected to.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:942
  def uri; end

  private

  # source://drb-2.2.3/lib/drb/drb.rb:1014
  def accept_or_shutdown; end

  # source://drb-2.2.3/lib/drb/drb.rb:990
  def close_shutdown_pipe; end

  class << self
    # Returns the hostname of this server
    #
    # source://drb-2.2.3/lib/drb/drb.rb:873
    ...
    # URI protocols.
    #
    # source://drb-2.2.3/lib/drb/drb.rb:866
    def open(uri, config); end

    # Open a server listening for connections at +uri+ using
    # configuration +config+.
    #
    # source://drb-2.2.3/lib/drb/drb.rb:904
    ...
    #
    # source://drb-2.2.3/lib/drb/drb.rb:889
    def open_server_inaddr_any(host, port); end

    # source://drb-2.2.3/lib/drb/drb.rb:846
    def parse_uri(uri); end

    # Parse +uri+ into a [uri, option] pair.
    #
    # source://drb-2.2.3/lib/drb/drb.rb:921
...
# option is optional.
#
# source://drb-2.2.3/lib/drb/unix.rb:16
class DRb::DRbUNIXSocket < ::DRb::DRbTCPSocket
  # @return [DRbUNIXSocket] a new instance of DRbUNIXSocket
  #
  # source://drb-2.2.3/lib/drb/unix.rb:62
  def initialize(uri, soc, config = T.unsafe(nil), server_mode = T.unsafe(nil)); end

  # source://drb-2.2.3/lib/drb/unix.rb:105
  def accept; end

  # source://drb-2.2.3/lib/drb/unix.rb:95
  def close; end

  # source://drb-2.2.3/lib/drb/unix.rb:111
  def set_sockopt(soc); end

  class << self
    # source://drb-2.2.3/lib/drb/unix.rb:28
    def open(uri, config); end

    # source://drb-2.2.3/lib/drb/unix.rb:34
    def open_server(uri, config); end

    # :stopdoc:
    #
    # source://drb-2.2.3/lib/drb/unix.rb:17
    def parse_uri(uri); end

    # source://drb-2.2.3/lib/drb/unix.rb:72
    def temp_server; end

    # source://drb-2.2.3/lib/drb/unix.rb:57
    def uri_option(uri, config); end
  end
end
...
#
# source://drb-2.2.3/lib/drb/unix.rb:70
DRb::DRbUNIXSocket::Max_try = T.let(T.unsafe(nil), Integer)

# source://drb-2.2.3/lib/drb/drb.rb:1049
class DRb::DRbURIOption
  # @return [DRbURIOption] a new instance of DRbURIOption
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1050
  def initialize(option); end

  # source://drb-2.2.3/lib/drb/drb.rb:1056
  def ==(other); end

  # source://drb-2.2.3/lib/drb/drb.rb:1056
  def eql?(other); end

  # source://drb-2.2.3/lib/drb/drb.rb:1061
  def hash; end

  # Returns the value of attribute option.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1053
  def option; end

  # source://drb-2.2.3/lib/drb/drb.rb:1054
  def to_s; end
end
...
#
# source://drb-2.2.3/lib/drb/drb.rb:418
module DRb::DRbUndumped
  # @raise [TypeError]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:419
  def _dump(dummy); end
end
...
# attribute.
#
# source://drb-2.2.3/lib/drb/drb.rb:485
class DRb::DRbUnknown
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:493
  def initialize(err, buf); end

  # source://drb-2.2.3/lib/drb/drb.rb:522
  def _dump(lv); end

  # Buffer contained the marshalled, unknown object.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:512
  def buf; end

  # Create a DRbUnknownError exception containing this object.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:536
  def exception; end
  ...
  # constants.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:509
  def name; end
  ...
  #
  # source://drb-2.2.3/lib/drb/drb.rb:531
  def reload; end

  class << self
    # source://drb-2.2.3/lib/drb/drb.rb:514
    def _load(s); end
  end
end
...
#
# source://drb-2.2.3/lib/drb/drb.rb:438
class DRb::DRbUnknownError < ::DRb::DRbError
  # Create a new DRbUnknownError for the DRb::DRbUnknown object +unknown+
  #
  # @return [DRbUnknownError] a new instance of DRbUnknownError
  #
  # source://drb-2.2.3/lib/drb/drb.rb:441
  def initialize(unknown); end

  # source://drb-2.2.3/lib/drb/drb.rb:453
  def _dump(lv); end

  # Get the wrapped DRb::DRbUnknown object.
  #
  # source://drb-2.2.3/lib/drb/drb.rb:447
  def unknown; end

  class << self
    # source://drb-2.2.3/lib/drb/drb.rb:449
    def _load(s); end
  end
end

# source://drb-2.2.3/lib/drb/drb.rb:1227
class DRb::ThreadObject
  include ::MonitorMixin

  # @return [ThreadObject] a new instance of ThreadObject
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1230
  def initialize(&blk); end

  # source://drb-2.2.3/lib/drb/drb.rb:1265
  def _execute; end

  # @return [Boolean]
  #
  # source://drb-2.2.3/lib/drb/drb.rb:1241
  def alive?; end

  # source://drb-2.2.3/lib/drb/drb.rb:1245
  def kill; end

  # source://drb-2.2.3/lib/drb/drb.rb:1250
  def method_missing(msg, *arg, &blk); end
end

# source://drb-2.2.3/lib/drb/version.rb:2
DRb::VERSION = T.let(T.unsafe(nil), String)

# source://drb-2.2.3/lib/drb/drb.rb:1993
DRbIdConv = DRb::DRbIdConv

# :stopdoc:
#
# source://drb-2.2.3/lib/drb/drb.rb:1991
DRbObject = DRb::DRbObject

# source://drb-2.2.3/lib/drb/drb.rb:1992
