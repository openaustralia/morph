...
#
# source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:6
module Rack
  class << self
...
# source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:7
module Rack::Test
  class << self
    ...
    # @return [Boolean]
    #
    # source://rack-test-2.2.0/lib/rack/test.rb:375
...
#
# source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:10
class Rack::Test::Cookie
  include ::Rack::Utils

  # @return [Cookie] a new instance of Cookie
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:23
  def initialize(raw, uri = T.unsafe(nil), default_host = T.unsafe(nil)); end

  # Order cookies by name, path, and domain.
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:106
  def <=>(other); end

  # The explicit or implicit domain for the cookie.
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:59
  def domain; end
  ...
  # @return [Boolean]
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:54
  def empty?; end
  ...
  # @return [Boolean]
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:86
  def expired?; end

  # A Time value for when the cookie expires, if the expires option is set.
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:81
  def expires; end
  ...
  # @return [Boolean]
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:71
  def http_only?; end
  ...
  # @return [Boolean]
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:101
  def matches?(uri); end

  # The name of the cookie, will be a string
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:14
  def name; end

  # The explicit or implicit path for the cookie.
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:76
  def path; end

  # The raw string for the cookie, without options. Will generally be in
  # name=value format is name and value are provided.
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:21
  def raw; end
  ...
  # @return [Boolean]
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:49
  ...
  # @return [Boolean]
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:65
  def secure?; end

  # A hash of cookie options, including the cookie value, but excluding the cookie name.
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:111
  def to_h; end
  ...
  # @return [Boolean]
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:91
  def valid?(uri); end

  # The value of the cookie, will be a string or nil if there is no value.
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:17
  def value; end
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test/cookie_jar.rb:125
  def default_uri; end
end
...
#   end
#
# source://rack-test-2.2.0/lib/rack/test/methods.rb:24
module Rack::Test::Methods
  extend ::Forwardable

  # Private accessor to avoid uninitialized instance variable warning in Ruby 2.*
  #
  # source://rack-test-2.2.0/lib/rack/test/methods.rb:90
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test/methods.rb:40
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test/methods.rb:55
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test/methods.rb:29
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test/methods.rb:61
...
#
# source://rack-test-2.2.0/lib/rack/test.rb:39
...
#
# source://rack-test-2.2.0/lib/rack/test.rb:53
class Rack::Test::Session
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:198
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:123
  def clear_cookies; end

  # The Rack::Test::CookieJar for the cookies for the current session.
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:67
  def cookie_jar; end
  ...
  #   custom_request "LINK", "/"
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:160
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:70
  def default_host; end

  # source://rack-test-2.2.0/lib/rack/test.rb:111
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:185
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:209
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:173
  ...
  # @raise [Error]
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:134
  ...
  # @raise [Error]
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:141
  ...
  #   request "/"
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:150
  ...
  # exiting the block.
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:240
  def restore_state; end

  # Set a cookie in the current cookie jar.
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:128
  ...
  # @yield [@last_response]
  #
  # source://rack-test-2.2.0/lib/rack/test.rb:357
  def process_request(uri, env); end

  class << self
    # source://rack-test-2.2.0/lib/rack/test.rb:57
    def new(app, default_host = T.unsafe(nil)); end
  end
end

# source://rack-test-2.2.0/lib/rack/test.rb:279
...
#
# source://rack-test-2.2.0/lib/rack/test/uploaded_file.rb:14
class Rack::Test::UploadedFile
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test/uploaded_file.rb:31
  ...
  # buffer.
  #
  # source://rack-test-2.2.0/lib/rack/test/uploaded_file.rb:60
  def append_to(buffer); end

  # The content type of the "uploaded" file
  #
  # source://rack-test-2.2.0/lib/rack/test/uploaded_file.rb:22
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test/uploaded_file.rb:46
  def local_path; end

  # Delegate all methods not handled to the tempfile.
  #
  # source://rack-test-2.2.0/lib/rack/test/uploaded_file.rb:52
  def method_missing(method_name, *args, &block); end

  # The filename, *not* including the path, of the "uploaded" file
  #
  # source://rack-test-2.2.0/lib/rack/test/uploaded_file.rb:16
  ...
  # The tempfile
  #
  # source://rack-test-2.2.0/lib/rack/test/uploaded_file.rb:19
  def tempfile; end
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test/uploaded_file.rb:86
  ...
  # @raise [ArgumentError]
  #
  # source://rack-test-2.2.0/lib/rack/test/uploaded_file.rb:78
  def initialize_from_stringio(stringio); end

  # @return [Boolean]
  #
  # source://rack-test-2.2.0/lib/rack/test/uploaded_file.rb:71
  def respond_to_missing?(method_name, include_private = T.unsafe(nil)); end
end

# source://rack-test-2.2.0/lib/rack/test/utils.rb:5
module Rack::Test::Utils
  ...
  # @raise [ArgumentError]
  #
  # source://rack-test-2.2.0/lib/rack/test/utils.rb:34
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test/utils.rb:11
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test/utils.rb:121
  ...
  #
  # source://rack-test-2.2.0/lib/rack/test/utils.rb:62
  def normalize_multipart_params(params, first = T.unsafe(nil)); end
end

# source://rack-test-2.2.0/lib/rack/test/version.rb:3
