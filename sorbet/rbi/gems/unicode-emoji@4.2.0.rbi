...
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:3
module Unicode; end

# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:4
module Unicode::Emoji
  class << self
    # Returns ordered list of Emoji, categorized in a three-level deep Hash structure
    #
    # source://unicode-emoji-4.2.0/lib/unicode/emoji.rb:80
    ...
    #
    # source://unicode-emoji-4.2.0/lib/unicode/emoji.rb:68
    def properties(char); end

    private

    # source://unicode-emoji-4.2.0/lib/unicode/emoji.rb:88
...
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:32
Unicode::Emoji::CANCEL_TAG = T.let(T.unsafe(nil), Integer)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:8
Unicode::Emoji::CLDR_VERSION = T.let(T.unsafe(nil), String)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:9
...
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/lazy_constants.rb:8
...
# (Emoji version of this gem might be more recent than Ruby's Emoji version)
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/lazy_constants.rb:21
...
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/lazy_constants.rb:42
Unicode::Emoji::EMOJI_KEYCAPS = T.let(T.unsafe(nil), Array)

# Combining Enclosing Keycap character
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:38
...
# (Emoji version of this gem might be more recent than Ruby's Emoji version)
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/lazy_constants.rb:31
...
# (Emoji version of this gem might be more recent than Ruby's Emoji version)
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/lazy_constants.rb:26
...
# (Emoji version of this gem might be more recent than Ruby's Emoji version)
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/lazy_constants.rb:13
Unicode::Emoji::EMOJI_PRESENTATION = T.let(T.unsafe(nil), Array)

# First codepoint of tag-based subdivision flags
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:29
...
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:23
Unicode::Emoji::EMOJI_VARIATION_SELECTOR = T.let(T.unsafe(nil), Integer)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:6
...
# (Emoji version of this gem might be more recent than Ruby's Emoji version)
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/lazy_constants.rb:36
...
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/lazy_constants.rb:39
Unicode::Emoji::EXTENDED_PICTOGRAPHIC_NO_EMOJI = T.let(T.unsafe(nil), Array)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/index.rb:11
Unicode::Emoji::INDEX = T.let(T.unsafe(nil), Hash)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:10
...
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/list.rb:6
Unicode::Emoji::LIST = T.let(T.unsafe(nil), Hash)

# Sometimes, categories change, we issue a warning in these cases
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/list.rb:9
...
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:13
Unicode::Emoji::PROPERTY_NAMES = T.let(T.unsafe(nil), Hash)

# The list RGI tag sequence flags
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/lazy_constants.rb:51
Unicode::Emoji::RECOMMENDED_SUBDIVISION_FLAGS = T.let(T.unsafe(nil), Array)

# The list of fully-qualified RGI Emoji ZWJ sequences
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/lazy_constants.rb:54
Unicode::Emoji::RECOMMENDED_ZWJ_SEQUENCES = T.let(T.unsafe(nil), Array)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex.rb:6
Unicode::Emoji::REGEX = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_basic.rb:6
Unicode::Emoji::REGEX_BASIC = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_emoji_keycap.rb:6
Unicode::Emoji::REGEX_EMOJI_KEYCAP = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_include_mqe.rb:6
Unicode::Emoji::REGEX_INCLUDE_MQE = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_include_mqe_uqe.rb:6
Unicode::Emoji::REGEX_INCLUDE_MQE_UQE = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_include_text.rb:6
Unicode::Emoji::REGEX_INCLUDE_TEXT = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_picto.rb:6
Unicode::Emoji::REGEX_PICTO = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_picto_no_emoji.rb:6
Unicode::Emoji::REGEX_PICTO_NO_EMOJI = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_possible.rb:6
Unicode::Emoji::REGEX_POSSIBLE = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_prop_component.rb:6
Unicode::Emoji::REGEX_PROP_COMPONENT = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_prop_emoji.rb:6
Unicode::Emoji::REGEX_PROP_EMOJI = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_prop_modifier.rb:6
Unicode::Emoji::REGEX_PROP_MODIFIER = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_prop_modifier_base.rb:6
Unicode::Emoji::REGEX_PROP_MODIFIER_BASE = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_prop_presentation.rb:6
Unicode::Emoji::REGEX_PROP_PRESENTATION = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_text.rb:6
Unicode::Emoji::REGEX_TEXT = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_text_presentation.rb:6
Unicode::Emoji::REGEX_TEXT_PRESENTATION = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_valid.rb:6
Unicode::Emoji::REGEX_VALID = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_valid_include_text.rb:6
Unicode::Emoji::REGEX_VALID_INCLUDE_TEXT = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_well_formed.rb:6
Unicode::Emoji::REGEX_WELL_FORMED = T.let(T.unsafe(nil), Regexp)

# source://unicode-emoji-4.2.0/lib/unicode/emoji/generated/regex_well_formed_include_text.rb:6
Unicode::Emoji::REGEX_WELL_FORMED_INCLUDE_TEXT = T.let(T.unsafe(nil), Regexp)

# Two regional indicators make up a region
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:44
Unicode::Emoji::REGIONAL_INDICATORS = T.let(T.unsafe(nil), Array)

# Tags characters allowed in tag-based subdivision flags
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:35
...
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/lazy_constants.rb:16
...
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:48
...
#
# source://unicode-emoji-4.2.0/lib/unicode/emoji/constants.rb:41
