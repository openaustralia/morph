...
# source://inherited_resources-1.13.1/lib/inherited_resources/engine.rb:1
module InheritedResources
  class << self
    # Change the flash keys used by FlashResponder.
    #
    # source://inherited_resources-1.13.1/lib/inherited_resources.rb:23
    def flash_keys=(array); end
  end
end

# source://inherited_resources-1.13.1/lib/inherited_resources.rb:9
InheritedResources::ACTIONS = T.let(T.unsafe(nil), Array)

# Holds all default actions for InheritedResouces.
#
# source://inherited_resources-1.13.1/lib/inherited_resources/actions.rb:3
module InheritedResources::Actions
  # POST /resources
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/actions.rb:30
  def create(options = T.unsafe(nil), &block); end

  # DELETE /resources/1
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/actions.rb:54
  def destroy(options = T.unsafe(nil), &block); end

  # GET /resources/1/edit
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/actions.rb:24
  def edit(options = T.unsafe(nil), &block); end

  # GET /resources
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/actions.rb:6
  def index(options = T.unsafe(nil), &block); end

  # GET /resources/new
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/actions.rb:18
  def new(options = T.unsafe(nil), &block); end

  # GET /resources/1
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/actions.rb:12
  def show(options = T.unsafe(nil), &block); end

  # PUT /resources/1
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/actions.rb:42
...
#
# source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:8
module InheritedResources::BaseHelpers
  ...
  # current resource).
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:128
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:114
  ...
  # instance variable.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:51
  ...
  #   end
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:22
  def collection; end
  ...
  #   end
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:65
  ...
  #   end
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:88
  ...
  # @return [Boolean]
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:121
  def parent?; end
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:43
  def resource; end
  ...
  #   end
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:77
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:281
  def apply_scopes_if_available(target_object); end

  # getting role for mass-asignment
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:372
  def as_role; end

  # extract attributes from params
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:354
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:172
  def end_of_association_chain; end

  # Get collection ivar based on the current resource controller.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:232
  def get_collection_ivar; end

  # Get resource ivar based on the current resource controller.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:216
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:197
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:205
  def method_for_association_chain; end

  # Returns the appropriated method to build the resource.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:190
  def method_for_build; end

  # Returns finder method for instantiate resource by params[:id]
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:210
  ...
  #    end
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:341
  def permitted_params; end

  # Fast accessor to resource_collection_name
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:156
  def resource_collection_name; end

  # Fast accessor to resource_instance_name
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:162
  def resource_instance_name; end

  # memoize the extraction of attributes from params
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:314
  def resource_params; end

  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:318
  def resource_params_method_name; end

  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:166
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:257
  ...
  # @return [Boolean]
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:367
  def role_given?; end

  # Set collection ivar based on the current resource controller.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:242
  def set_collection_ivar(collection); end

  # Set resource ivar based on the current resource controller.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:226
  def set_resource_ivar(resource); end

  # URL to redirect to when redirect implies collection url.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:302
  def smart_collection_url; end

  # URL to redirect to when redirect implies resource url.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:293
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:288
  def symbols_for_association_chain; end

  # Adds the given object to association chain.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:150
  def with_chain(object); end

  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:380
  def without_protection; end

  # @return [Boolean]
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/base_helpers.rb:376
...
#
# source://inherited_resources-1.13.1/lib/inherited_resources/belongs_to_helpers.rb:50
module InheritedResources::BelongsToHelpers
  protected

  # source://inherited_resources-1.13.1/lib/inherited_resources/belongs_to_helpers.rb:60
  def parent; end
  ...
  # @return [Boolean]
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/belongs_to_helpers.rb:56
  def parent?; end

  # source://inherited_resources-1.13.1/lib/inherited_resources/belongs_to_helpers.rb:64
  def parent_type; end
  ...
  # association chain.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/belongs_to_helpers.rb:73
  def evaluate_parent(parent_symbol, parent_config, chain = T.unsafe(nil)); end

  # source://inherited_resources-1.13.1/lib/inherited_resources/belongs_to_helpers.rb:78
  def get_parent_ivar(instance_name); end

  # source://inherited_resources-1.13.1/lib/inherited_resources/belongs_to_helpers.rb:83
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/belongs_to_helpers.rb:107
  def symbols_for_association_chain; end
end

# An object from BlankSlate simply discards all messages sent to it.
#
# source://inherited_resources-1.13.1/lib/inherited_resources/blank_slate.rb:3
class InheritedResources::BlankSlate
  # source://inherited_resources-1.13.1/lib/inherited_resources/blank_slate.rb:8
  def method_missing(*args); end
end

# source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:2
module InheritedResources::ClassMethods
  ...
  # @raise [ArgumentError]
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:74
  ...
  # @raise [ArgumentError]
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:141
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:268
  ...
  # @raise [ArgumentError]
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:37
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:244
  def optional_belongs_to(*symbols, &block); end

  # A quick method to declare polymorphic belongs to.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:228
  def polymorphic_belongs_to(*symbols, &block); end

  # A quick method to declare singleton belongs to.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:236
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:286
  def with_role(role); end

  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:290
  def without_protection(flag); end

  private

  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:304
  def acts_as_polymorphic!; end

  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:311
  def acts_as_shallow!; end

  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:296
  def acts_as_singleton!; end

  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:395
  def create_custom_action(resource_or_collection, action); end

  # Hook called on inheritance.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:407
  def inherited(base); end

  # Initialize resources class accessors and set their default values.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/class_methods.rb:318
...
#   end
#
# source://inherited_resources-1.13.1/lib/inherited_resources/dsl.rb:10
module InheritedResources::DSL
  class << self
    # @private
    #
    # source://inherited_resources-1.13.1/lib/inherited_resources/dsl.rb:11
...
#
# source://inherited_resources-1.13.1/lib/inherited_resources/polymorphic_helpers.rb:97
module InheritedResources::PolymorphicHelpers
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/polymorphic_helpers.rb:121
  def parent; end
  ...
  # @return [Boolean]
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/polymorphic_helpers.rb:130
  def parent?; end

  # source://inherited_resources-1.13.1/lib/inherited_resources/polymorphic_helpers.rb:114
  def parent_class; end

  # Returns the parent type. A Comments class can have :task, :file, :note
  # as parent types.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/polymorphic_helpers.rb:104
  def parent_type; end
  ...
  # params are missing.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/polymorphic_helpers.rb:148
  def symbols_for_association_chain; end
end

# source://inherited_resources-1.13.1/lib/inherited_resources/engine.rb:2
class InheritedResources::Railtie < ::Rails::Engine; end

# source://inherited_resources-1.13.1/lib/inherited_resources/responder.rb:2
...
#
# source://inherited_resources-1.13.1/lib/inherited_resources/shallow_helpers.rb:15
module InheritedResources::ShallowHelpers
  private

  # source://inherited_resources-1.13.1/lib/inherited_resources/shallow_helpers.rb:35
  def load_parents(instance, parent_symbols); end

  # source://inherited_resources-1.13.1/lib/inherited_resources/shallow_helpers.rb:18
  def symbols_for_association_chain; end
end
...
#
# source://inherited_resources-1.13.1/lib/inherited_resources/singleton_helpers.rb:37
module InheritedResources::SingletonHelpers
  protected

  # Singleton methods does not deal with collections.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/singleton_helpers.rb:43
  def collection; end
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/singleton_helpers.rb:75
  def resource; end
  ...
  # Returns the appropriated method to build the resource.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/singleton_helpers.rb:83
  def method_for_association_build; end

  # Sets the method_for_association_chain to nil. See <tt>resource</tt>
  # above for more information.
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/singleton_helpers.rb:90
  def method_for_association_chain; end
end
...
#
# source://inherited_resources-1.13.1/lib/inherited_resources/url_helpers.rb:34
module InheritedResources::UrlHelpers
  ...
  #
  # source://inherited_resources-1.13.1/lib/inherited_resources/url_helpers.rb:46
  def create_resources_url_helpers!; end

  # source://inherited_resources-1.13.1/lib/inherited_resources/url_helpers.rb:228
  def define_helper_method(prefix, name, suffix, segments); end

  # source://inherited_resources-1.13.1/lib/inherited_resources/url_helpers.rb:194
  def define_params_helper(prefix, name, singleton, polymorphic, parent_index, ivars); end

  # source://inherited_resources-1.13.1/lib/inherited_resources/url_helpers.rb:169
  def generate_url_and_path_helpers(prefix, name, resource_segments, resource_ivars); end

  # source://inherited_resources-1.13.1/lib/inherited_resources/url_helpers.rb:141
  def handle_shallow_resource(prefix, name, segments, ivars); end
end

# source://inherited_resources-1.13.1/lib/inherited_resources/version.rb:2
