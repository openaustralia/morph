...
#
# source://net-smtp-0.5.1/lib/net/smtp.rb:194
class Net::SMTP < ::Net::Protocol
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:248
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:414
  def address; end
  ...
  # @return [Boolean]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:329
  ...
  # @return [Boolean]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:301
  def capable?(key); end

  # Returns supported authentication methods on this server.
  # You cannot get valid value before opening SMTP session.
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:337
  ...
  # @return [Boolean]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:323
  ...
  # @return [Boolean]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:317
  ...
  # @return [Boolean]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:311
  ...
  # @return [Boolean]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:296
  ...
  #   }
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:958
  ...
  #   end
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:450
  def debug_output=(arg); end

  # Disables SMTP/TLS for this object.  Must be called before the
  # connection is established to have any effect.
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:364
  def disable_ssl; end

  # Disables SMTP/TLS (STARTTLS) for this object.  Must be called
  # before the connection is established to have any effect.
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:408
  ...
  # source://net-smtp-0.5.1/lib/net/smtp.rb:907
  def ehlo(domain); end
  ...
  # @raise [ArgumentError]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:353
  ...
  # @raise [ArgumentError]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:390
  ...
  # @raise [ArgumentError]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:399
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:289
  def esmtp; end
  ...
  # @raise [IOError]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:655
  def finish; end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:989
  def get_response(reqline); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:903
  def helo(domain); end

  # Provide human-readable stringification of class state.
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:278
  def inspect; end

  # +from_addr+ is +String+ or +Net::SMTP::Address+
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:912
  ...
  # @raise [IOError]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:849
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:422
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:417
  def port; end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:985
  def quit; end

  # +to_addr+ is +String+ or +Net::SMTP::Address+
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:930
  def rcptto(to_addr); end

  # @raise [ArgumentError]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:921
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:427
  def read_timeout; end

  # Set the number of seconds to wait until timing-out a read(2)
  # call.
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:431
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:895
  def rset; end
  ...
  # @raise [IOError]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:794
  ...
  # @return [Boolean]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:344
  def ssl?; end

  # Hash for additional SSLContext parameters.
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:275
  ...
  # @raise [ArgumentError]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:622
  ...
  # @return [Boolean]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:553
  def started?; end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:899
  def starttls; end
  ...
  # @return [Boolean]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:374
  def starttls?; end
  ...
  # @return [Boolean]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:379
  ...
  # @return [Boolean]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:384
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:272
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:269
  def tls_verify; end
  ...
  # source://net-smtp-0.5.1/lib/net/smtp.rb:748
  def any_require_smtputf8(addresses); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:880
  def check_auth_args(type, *args, **kwargs); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:1040
  def check_continue(res); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:1034
  def check_response(res); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:1024
  def critical; end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:731
  def do_finish; end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:719
  def do_helo(helo_domain); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:666
  def do_start(helo_domain, user, secret, authtype); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:1004
  def getok(reqline); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:1125
  def logging(msg); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:714
  def new_internet_message_io(s); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:1014
  def recv_response; end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:740
  def requires_smtputf8(address); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:697
  def ssl_socket(socket, context); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:662
  def tcp_socket(address, port); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:701
  def tlsconnect(s, context); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:997
  def validate_line(line); end

  class << self
    # The default SMTP port number, 25.
    #
    # source://net-smtp-0.5.1/lib/net/smtp.rb:198
    def default_port; end

    # source://net-smtp-0.5.1/lib/net/smtp.rb:216
    def default_ssl_context(ssl_context_params = T.unsafe(nil)); end

    # The default SMTPS port number, 465.
    #
    # source://net-smtp-0.5.1/lib/net/smtp.rb:208
    def default_ssl_port; end

    # The default mail submission port number, 587.
    #
    # source://net-smtp-0.5.1/lib/net/smtp.rb:203
    ...
    # @raise [ArgumentError]
    #
    # source://net-smtp-0.5.1/lib/net/smtp.rb:539
...
#
# source://net-smtp-0.5.1/lib/net/smtp.rb:1130
class Net::SMTP::Address
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:1141
  def initialize(address, *args, **kw_args); end

  # mail address [String]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:1132
  def address; end

  # parameters [Array<String>]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:1134
  def parameters; end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:1152
  def to_s; end
end

# source://net-smtp-0.5.1/lib/net/smtp/auth_cram_md5.rb:9
class Net::SMTP::AuthCramMD5 < ::Net::SMTP::Authenticator
  # source://net-smtp-0.5.1/lib/net/smtp/auth_cram_md5.rb:12
  def auth(user, secret); end

  # CRAM-MD5: [RFC2195]
  #
  # source://net-smtp-0.5.1/lib/net/smtp/auth_cram_md5.rb:22
  def cram_md5_response(secret, challenge); end

  # source://net-smtp-0.5.1/lib/net/smtp/auth_cram_md5.rb:29
  def cram_secret(secret, mask); end

  # source://net-smtp-0.5.1/lib/net/smtp/auth_cram_md5.rb:38
  def digest_class; end
end

# source://net-smtp-0.5.1/lib/net/smtp/auth_cram_md5.rb:27
Net::SMTP::AuthCramMD5::CRAM_BUFSIZE = T.let(T.unsafe(nil), Integer)

# source://net-smtp-0.5.1/lib/net/smtp/auth_cram_md5.rb:18
Net::SMTP::AuthCramMD5::IMASK = T.let(T.unsafe(nil), Integer)

# source://net-smtp-0.5.1/lib/net/smtp/auth_cram_md5.rb:19
Net::SMTP::AuthCramMD5::OMASK = T.let(T.unsafe(nil), Integer)

# source://net-smtp-0.5.1/lib/net/smtp/auth_login.rb:2
class Net::SMTP::AuthLogin < ::Net::SMTP::Authenticator
  # source://net-smtp-0.5.1/lib/net/smtp/auth_login.rb:5
  def auth(user, secret); end
end

# source://net-smtp-0.5.1/lib/net/smtp/auth_plain.rb:2
class Net::SMTP::AuthPlain < ::Net::SMTP::Authenticator
  # source://net-smtp-0.5.1/lib/net/smtp/auth_plain.rb:5
  def auth(user, secret); end
end

# source://net-smtp-0.5.1/lib/net/smtp/auth_xoauth2.rb:2
class Net::SMTP::AuthXoauth2 < ::Net::SMTP::Authenticator
  # source://net-smtp-0.5.1/lib/net/smtp/auth_xoauth2.rb:5
  def auth(user, secret); end

  private

  # source://net-smtp-0.5.1/lib/net/smtp/auth_xoauth2.rb:13
  def xoauth2_string(user, secret); end
end

# source://net-smtp-0.5.1/lib/net/smtp/authenticator.rb:3
class Net::SMTP::Authenticator
  # @return [Authenticator] a new instance of Authenticator
  #
  # source://net-smtp-0.5.1/lib/net/smtp/authenticator.rb:29
  def initialize(smtp); end

  # @param str [String]
  # @return [String] Base64 encoded string
  #
  # source://net-smtp-0.5.1/lib/net/smtp/authenticator.rb:51
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp/authenticator.rb:35
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp/authenticator.rb:43
  def finish(arg); end

  # Returns the value of attribute smtp.
  #
  # source://net-smtp-0.5.1/lib/net/smtp/authenticator.rb:27
  def smtp; end

  class << self
    # source://net-smtp-0.5.1/lib/net/smtp/authenticator.rb:13
    def auth_class(type); end

    # source://net-smtp-0.5.1/lib/net/smtp/authenticator.rb:4
    def auth_classes; end

    # source://net-smtp-0.5.1/lib/net/smtp/authenticator.rb:8
    def auth_type(type); end

    # source://net-smtp-0.5.1/lib/net/smtp/authenticator.rb:18
...
#
# source://net-smtp-0.5.1/lib/net/smtp.rb:1050
class Net::SMTP::Response
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:1059
  ...
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:1102
  def capabilities; end
  ...
  # @return [Boolean]
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:1077
  def success?; end
  ...
  class << self
    ...
    # readable reply text
    #
    # source://net-smtp-0.5.1/lib/net/smtp.rb:1053
    def parse(str); end
  end
end

# source://net-smtp-0.5.1/lib/net/smtp.rb:195
Net::SMTP::VERSION = T.let(T.unsafe(nil), String)

# source://net-smtp-0.5.1/lib/net/smtp.rb:49
...
#
# source://net-smtp-0.5.1/lib/net/smtp.rb:27
module Net::SMTPError
  # source://net-smtp-0.5.1/lib/net/smtp.rb:33
  def initialize(response, message: T.unsafe(nil)); end

  # source://net-smtp-0.5.1/lib/net/smtp.rb:43
  def message; end

  # This *class* is a module for backward compatibility.
  # In later release, this module becomes a class.
  #
  # source://net-smtp-0.5.1/lib/net/smtp.rb:31
  def response; end
end

# source://net-smtp-0.5.1/lib/net/smtp.rb:64
class Net::SMTPFatalError < ::Net::ProtoFatalError
  include ::Net::SMTPError
end

# source://net-smtp-0.5.1/lib/net/smtp.rb:54
...
# class SMTP
#
# source://net-smtp-0.5.1/lib/net/smtp.rb:1158
Net::SMTPSession = Net::SMTP

# source://net-smtp-0.5.1/lib/net/smtp.rb:59
class Net::SMTPSyntaxError < ::Net::ProtoSyntaxError
  include ::Net::SMTPError
end

# source://net-smtp-0.5.1/lib/net/smtp.rb:69
class Net::SMTPUnknownError < ::Net::ProtoUnknownError
  include ::Net::SMTPError
end

# source://net-smtp-0.5.1/lib/net/smtp.rb:74
