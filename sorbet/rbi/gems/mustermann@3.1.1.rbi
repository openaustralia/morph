...
#
# source://mustermann-3.1.1/lib/mustermann/error.rb:2
module Mustermann
  class << self
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann.rb:89
    def [](name); end

    # source://mustermann-3.1.1/lib/mustermann.rb:120
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann.rb:62
    def new(*input, type: T.unsafe(nil), operator: T.unsafe(nil), **options); end

    # source://mustermann-3.1.1/lib/mustermann.rb:115
    def normalized_type(type); end

    # source://mustermann-3.1.1/lib/mustermann.rb:110
    def register(name, type); end

    # @return [LoadError, nil]
    #
    # source://mustermann-3.1.1/lib/mustermann.rb:101
...
#
# source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:9
class Mustermann::AST::Compiler < ::Mustermann::AST::Translator
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:151
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:126
  def encoded(char, uri_decode: T.unsafe(nil), space_matches_plus: T.unsafe(nil), **options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:69
  def error_class; end
  ...
  class << self
    ...
    # @return [Regexp] corresponding regular expression.
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:142
...
#
# source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:38
class Mustermann::AST::Compiler::Capture < ::Mustermann::AST::Compiler::NodeTranslator
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:49
  def pattern(capture: T.unsafe(nil), **options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:42
  def translate(**options); end

  private

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:68
  def default(**options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:64
  def from_array(array, **options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:63
  def from_hash(hash, **options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:67
  def from_nil(**options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:66
  def from_string(string, **options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:65
  def from_symbol(symbol, **options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:61
  def qualified(string, greedy: T.unsafe(nil), **options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:62
  def with_lookahead(string, lookahead: T.unsafe(nil), **options); end
end

# source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:0
...
# source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:72
class Mustermann::AST::Compiler::Splat < ::Mustermann::AST::Compiler::Capture
  # splats are always non-greedy
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:76
  def pattern(**options); end
end

# source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:82
class Mustermann::AST::Compiler::Variable < ::Mustermann::AST::Compiler::Capture
  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:113
  def default(allow_reserved: T.unsafe(nil), **options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:103
  def parametric(string); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:94
  def pattern(parametric: T.unsafe(nil), separator: T.unsafe(nil), **options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:108
  def qualified(string, **options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:118
  def register_param(parametric: T.unsafe(nil), split_params: T.unsafe(nil), separator: T.unsafe(nil), **options); end

  # source://mustermann-3.1.1/lib/mustermann/ast/compiler.rb:86
  def translate(**options); end
end
...
#
# source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:11
class Mustermann::AST::Expander < ::Mustermann::AST::Translator
  # add a tree for expansion
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:79
  def add(ast); end

  # Creates the product of two of our secret internal data structures.
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:140
  ...
  # @raise [error_class]
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:118
  def error_for(values); end

  # @see Mustermann::AST::Translator#expand
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:125
  def escape(string, *args, **options); end

  # @see Mustermann::Pattern#expand
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:94
  def expand(values); end

  # @return [Boolean]
  # @see Mustermann::Pattern#expandable?
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:104
  def expandable?(values); end

  # @see Mustermann::Expander#with_rest
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:112
  def expandable_keys(keys); end

  # helper method for captures
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:60
  def for_capture(node, **options); end

  # all the known keys
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:73
  def keys; end

  # maps sorted key list to sprintf patterns and filters
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:67
  def mappings; end

  # Turns a sprintf pattern into our secret internal data structure.
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:134
  def pattern(string = T.unsafe(nil), *keys, **filters); end

  # helper method for getting a capture's pattern.
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:88
  def pattern_for(node, **options); end
end

# source://mustermann-3.1.1/lib/mustermann/ast/expander.rb:0
...
# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:5
class Mustermann::AST::Node
  # @return [Node] a new instance of Node
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:43
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:65
  def each_leaf(&block); end

  # @return [Boolean]
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:49
  def is_a?(type); end

  # @return [Integer] length of the substring
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:78
  def length; end

  # @return [Integer] minimum size for a node
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:84
  def min_size; end

  # Double dispatch helper for reading from the buffer into the payload.
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:56
  def parse; end

  # Returns the value of attribute payload.
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:7
  def payload; end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:90
  def type; end
  ...
  class << self
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:12
    def [](name); end

    # @param name [Symbol] of the node
    # @return [String] qualified name of factory for the node
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:29
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:38
    def parse(payload = T.unsafe(nil), **options, &block); end

    # Turns a class name into a node identifier.
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:22
    def type; end
  end
end

# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:97
class Mustermann::AST::Node::Capture < ::Mustermann::AST::Node
  # @see Mustermann::AST::Compiler::Capture#default
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:98
  def constraint; end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:106
  def convert; end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:110
  def parse; end

  # @see Mustermann::AST::Compiler::Capture#qualified
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:102
  def qualifier; end
...
# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:122
class Mustermann::AST::Node::Char < ::Mustermann::AST::Node
  # @return [Integer] minimum size for a node
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:123
  def min_size; end
end

# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:137
class Mustermann::AST::Node::Composition < ::Mustermann::AST::Node
  # @return [Composition] a new instance of Composition
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:138
  def initialize(payload = T.unsafe(nil), **options); end
end

# AST node for template expressions.
#
# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:131
class Mustermann::AST::Node::Expression < ::Mustermann::AST::Node
  # Returns the value of attribute operator.
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:132
  def operator; end
...
# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:144
class Mustermann::AST::Node::Group < ::Mustermann::AST::Node::Composition; end

# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:197
...
# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:152
class Mustermann::AST::Node::Optional < ::Mustermann::AST::Node; end

# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:156
class Mustermann::AST::Node::Or < ::Mustermann::AST::Node; end

# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:161
class Mustermann::AST::Node::Root < ::Mustermann::AST::Node
  # Returns the value of attribute pattern.
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:162
  def pattern; end
  ...
  class << self
    ...
    # @see Mustermann::AST::Node.parse
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:168
    def parse(string, &block); end
  end
end

# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:179
class Mustermann::AST::Node::Separator < ::Mustermann::AST::Node
  # @return [Integer] minimum size for a node
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:180
  def min_size; end
end

# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:188
class Mustermann::AST::Node::Splat < ::Mustermann::AST::Node::Capture
  # @see Mustermann::AST::Node::Capture#name
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:189
  def name; end
end

# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:148
class Mustermann::AST::Node::Union < ::Mustermann::AST::Node::Composition; end

# AST node for template variables.
#
# source://mustermann-3.1.1/lib/mustermann/ast/node.rb:204
class Mustermann::AST::Node::Variable < ::Mustermann::AST::Node::Capture
  # Returns the value of attribute explode.
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/node.rb:205
  def explode; end
...
#
# source://mustermann-3.1.1/lib/mustermann/ast/param_scanner.rb:10
class Mustermann::AST::ParamScanner < ::Mustermann::AST::Translator
  class << self
    # source://mustermann-3.1.1/lib/mustermann/ast/param_scanner.rb:11
    def scan_params(ast); end
  end
end

# source://mustermann-3.1.1/lib/mustermann/ast/param_scanner.rb:0
...
#
# source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:11
class Mustermann::AST::Parser
  extend ::Forwardable

  # @return [Parser] a new instance of Parser
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:48
  def initialize(pattern: T.unsafe(nil), **options); end

  # Returns the value of attribute buffer.
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:42
  def buffer; end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:79
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:140
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:99
  ...
  # @return [Mustermann::AST::Node]
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:67
  def node(type, *args, **options, &block); end

  # @param string [String] to be parsed
  # @return [Mustermann::AST::Node] parse tree for string
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:55
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:86
  def read; end

  # Reads an argument string of the format arg1,args2,key:value
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:171
  ...
  #   buffer.rest # => "ba<r>"
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:153
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:209
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:190
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:111
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:127
  def scan(regexp); end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:227
  ...
  class << self
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:25
    def on(*chars, &block); end

    # @param string [String] to be parsed
    # @return [Mustermann::AST::Node] parse tree for string
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:15
    ...
    # @see Mustermann::Sinatra
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/parser.rb:35
...
# @abstract
#
# source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:18
class Mustermann::AST::Pattern < ::Mustermann::RegexpBased
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:106
  def expand(behavior = T.unsafe(nil), values = T.unsafe(nil)); end

  # @see Mustermann::Pattern#map_param
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:123
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:88
  def to_ast; end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:117
  ...
  # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:79
  def compile(**options); end

  # source://RUBY_ROOT/forwardable.rb:226
  def generate_templates(*args, &block); end

  # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:129
  ...
  class << self
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:46
    def boundaries; end

    # @api private
    # @return [#compile] compiler object for pattern
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:39
    def compiler; end
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:74
    def param_scanner; end

    # @api private
    # @return [#parse] parser object for pattern
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:30
    def parser; end
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:67
    def template_generator; end

    # @api private
    # @return [#transform] transformer object for pattern
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:53
    def transformer; end

    # @api private
    # @return [#validate] validation object for pattern
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/pattern.rb:60
    def validation; end
  end
end
...
# @see Mustermann::AST::Pattern#to_templates
#
# source://mustermann-3.1.1/lib/mustermann/ast/template_generator.rb:10
class Mustermann::AST::TemplateGenerator < ::Mustermann::AST::Translator
  class << self
    # source://mustermann-3.1.1/lib/mustermann/ast/template_generator.rb:11
    def generate_templates(ast); end
  end
end

# source://mustermann-3.1.1/lib/mustermann/ast/template_generator.rb:0
...
#
# source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:8
class Mustermann::AST::Transformer < ::Mustermann::AST::Translator
  class << self
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:15
...
#
# source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:105
class Mustermann::AST::Transformer::ArrayTransform < ::Mustermann::AST::Transformer::NodeTranslator
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:142
  ...
  # @return [Boolean]
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:166
  def expect_lookahead?(element); end

  # helper method for deciding where to put an element for now
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:173
  ...
  # @return [Boolean]
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:149
  def lookahead?(element, in_lookahead = T.unsafe(nil)); end

  # buffer for potential look ahead
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:116
  ...
  # @return [Boolean]
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:159
  def lookahead_payload?(payload, in_lookahead); end

  # the new array
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:110
  def payload; end

  # handle a single element from the array
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:129
  def track(element); end

  # transform the array
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:122
  def translate; end
end

# URI expression transformations depending on operator
#
# source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:76
class Mustermann::AST::Transformer::ExpressionTransform < ::Mustermann::AST::Transformer::NodeTranslator
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:93
  def translate; end
end

# source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:84
Mustermann::AST::Transformer::ExpressionTransform::OPERATORS = T.let(T.unsafe(nil), Hash)

# source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:80
...
#
# source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:30
class Mustermann::AST::Transformer::GroupTransformer < ::Mustermann::AST::Transformer::NodeTranslator
  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:48
  def group(elements); end

  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:55
  def split_payload; end

  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:34
  def translate; end

  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:42
  def union; end
end

# source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:0
...
#
# source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:64
class Mustermann::AST::Transformer::RootTransformer < ::Mustermann::AST::Transformer::GroupTransformer
  # source://mustermann-3.1.1/lib/mustermann/ast/transformer.rb:68
  def union; end
end
...
# @abstract
#
# source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:12
class Mustermann::AST::Translator
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:107
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:123
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:115
  ...
  class << self
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:97
    def create(&block); end

    # maps types to translations
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:53
    def dispatch_table; end

    # some magic sauce so {NodeTranslator}s know whom to talk to for {#register}
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:59
    def inherited(subclass); end

    # DSL-ish method for specifying the exception class to use.
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:68
    def raises(error); end

    # DSL method for defining single method translations.
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:74
...
#
# source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:20
class Mustermann::AST::Translator::NodeTranslator
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:32
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:42
  def t(*args, **options, &block); end

  # Returns the value of attribute translator.
  #
  # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:38
  def translator; end

  class << self
    # @param types [Array<Symbol, Class>] list of types to register for.
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:21
    def register(*types); end
  end
end

# source://mustermann-3.1.1/lib/mustermann/ast/translator.rb:14
...
class Mustermann::AST::Validation < ::Mustermann::AST::Translator
  ...
  class << self
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann/ast/validation.rb:17
    def validate(ast); end
  end
end

# source://mustermann-3.1.1/lib/mustermann/ast/validation.rb:0
...
#
# source://mustermann-3.1.1/lib/mustermann/caster.rb:17
class Mustermann::Caster
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/caster.rb:18
...
# @see Mustermann::Pattern#^
#
# source://mustermann-3.1.1/lib/mustermann/composite.rb:7
class Mustermann::Composite < ::Mustermann::Pattern
  # @return [Composite] a new instance of Composite
  #
  # source://mustermann-3.1.1/lib/mustermann/composite.rb:27
  def initialize(patterns, operator: T.unsafe(nil), **options); end

  # @see Mustermann::Pattern#==
  #
  # source://mustermann-3.1.1/lib/mustermann/composite.rb:33
  def ==(pattern); end

  # @see Mustermann::Pattern#===
  #
  # source://mustermann-3.1.1/lib/mustermann/composite.rb:48
  def ===(string); end

  # @return [Boolean]
  # @see Mustermann::Pattern#eql?
  #
  # source://mustermann-3.1.1/lib/mustermann/composite.rb:38
  def eql?(pattern); end
  ...
  # @see Mustermann::Expander
  #
  # source://mustermann-3.1.1/lib/mustermann/composite.rb:69
  def expand(behavior = T.unsafe(nil), values = T.unsafe(nil)); end

  # @see Mustermann::Pattern#hash
  #
  # source://mustermann-3.1.1/lib/mustermann/composite.rb:43
  def hash; end

  # source://mustermann-3.1.1/lib/mustermann/composite.rb:87
  def inspect; end

  # @see Mustermann::Pattern#match
  #
  # source://mustermann-3.1.1/lib/mustermann/composite.rb:58
  def match(string); end

  # Returns the value of attribute operator.
  #
  # source://mustermann-3.1.1/lib/mustermann/composite.rb:8
  def operator; end

  # @see Mustermann::Pattern#params
  #
  # source://mustermann-3.1.1/lib/mustermann/composite.rb:53
  ...
  # @return [Boolean]
  #
  # source://mustermann-3.1.1/lib/mustermann/composite.rb:63
  def respond_to_special?(method); end

  # source://mustermann-3.1.1/lib/mustermann/composite.rb:92
  def simple_inspect; end

  # @return [String] the string representation of the pattern
  #
  # source://mustermann-3.1.1/lib/mustermann/composite.rb:82
  def to_s; end
  ...
  # @return [Array<String>] list of URI templates
  #
  # source://mustermann-3.1.1/lib/mustermann/composite.rb:76
  def to_templates; end

  private

  # source://mustermann-3.1.1/lib/mustermann/composite.rb:105
  def patterns_from(pattern, **options); end

  # source://mustermann-3.1.1/lib/mustermann/composite.rb:98
  def with_matching(string, method); end

  class << self
    # @return [Mustermann::Pattern] a new composite pattern
    #
    # source://mustermann-3.1.1/lib/mustermann/composite.rb:18
    def new(*patterns, **options); end

    # @return [Boolean]
    # @see Mustermann::Pattern.supported?
    #
    # source://mustermann-3.1.1/lib/mustermann/composite.rb:12
...
# @see Mustermann::Pattern#+
#
# source://mustermann-3.1.1/lib/mustermann/concat.rb:7
class Mustermann::Concat < ::Mustermann::Composite
  # Should not be used directly.
  #
  # @return [Concat] a new instance of Concat
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:43
  def initialize(*_arg0, **_arg1); end

  # @see Mustermann::Pattern#===
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:55
  def ===(string); end
  ...
  # @see Mustermann::Expander
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:90
  def expand(behavior = T.unsafe(nil), values = T.unsafe(nil)); end

  # @see Mustermann::Pattern#match
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:60
  def match(string); end

  # @return [Symbol] always :+
  # @see Mustermann::Composite#operator
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:50
  def operator; end

  # @see Mustermann::Pattern#params
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:66
  def params(string); end

  # @see Mustermann::Pattern#peek_match
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:77
  def peek_match(string); end

  # @see Mustermann::Pattern#peek_params
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:85
  def peek_params(string); end

  # @see Mustermann::Pattern#peek_size
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:72
  def peek_size(string); end

  # @return [Boolean]
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:103
  def respond_to_special?(method); end
  ...
  # @return [Array<String>] list of URI templates
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:97
  def to_templates; end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:129
  def combined_ast; end

  # used to generate results for various methods by scanning through an input string
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:110
...
#
# source://mustermann-3.1.1/lib/mustermann/concat.rb:8
module Mustermann::Concat::Native
  # @see Mustermann::Pattern#+
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:11
  def +(other); end

  # source://mustermann-3.1.1/lib/mustermann/concat.rb:23
  def look_ahead(other); end

  private

  # source://mustermann-3.1.1/lib/mustermann/concat.rb:29
  def native_concat(other); end

  # @return [Boolean]
  #
  # source://mustermann-3.1.1/lib/mustermann/concat.rb:34
  def native_concat?(other); end
end
...
# @api private
#
# source://mustermann-3.1.1/lib/mustermann.rb:13
...
# @see #fetch
#
# source://mustermann-3.1.1/lib/mustermann/equality_map.rb:18
class Mustermann::EqualityMap
  # @return [EqualityMap] a new instance of EqualityMap
  #
  # source://mustermann-3.1.1/lib/mustermann/equality_map.rb:25
  def initialize; end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/equality_map.rb:33
  def fetch(key); end

  # Returns the value of attribute map.
  #
  # source://mustermann-3.1.1/lib/mustermann/equality_map.rb:19
  def map; end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/equality_map.rb:60
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/equality_map.rb:49
  def track(key, object); end

  class << self
    # source://mustermann-3.1.1/lib/mustermann/equality_map.rb:21
    def new; end
  end
end
...
#
# source://mustermann-3.1.1/lib/mustermann/error.rb:4
class Mustermann::Error < ::StandardError; end

# Raised if anything goes wrong while expanding a {Pattern}.
#
# source://mustermann-3.1.1/lib/mustermann/error.rb:7
...
#
# source://mustermann-3.1.1/lib/mustermann/expander.rb:15
class Mustermann::Expander
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/expander.rb:21
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/expander.rb:43
  def <<(*patterns); end

  # @see Object#==
  #
  # source://mustermann-3.1.1/lib/mustermann/expander.rb:158
  def ==(other); end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/expander.rb:16
  ...
  # @return [Mustermann::Expander] the expander
  #
  # source://mustermann-3.1.1/lib/mustermann/expander.rb:115
  def cast(*types, &block); end

  # @return [Boolean]
  # @see Object#eql?
  #
  # source://mustermann-3.1.1/lib/mustermann/expander.rb:164
  def eql?(other); end
  ...
  # @return [String] expanded string
  #
  # source://mustermann-3.1.1/lib/mustermann/expander.rb:145
  def expand(behavior = T.unsafe(nil), values = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://mustermann-3.1.1/lib/mustermann/expander.rb:174
  def expandable?(values); end

  # @see Object#hash
  #
  # source://mustermann-3.1.1/lib/mustermann/expander.rb:170
  def hash; end
  ...
  # source://mustermann-3.1.1/lib/mustermann/expander.rb:195
  ...
  # source://mustermann-3.1.1/lib/mustermann/expander.rb:201
  def map_values(values); end

  # source://mustermann-3.1.1/lib/mustermann/expander.rb:191
  def slice(hash, keys); end

  # source://mustermann-3.1.1/lib/mustermann/expander.rb:185
  def split_values(values); end

  # @yield [expand(:raise, slice(values, expandable)), slice(values, non_expandable)]
  #
  # source://mustermann-3.1.1/lib/mustermann/expander.rb:180
...
#
# source://mustermann-3.1.1/lib/mustermann/identity.rb:14
class Mustermann::Identity < ::Mustermann::Pattern
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/identity.rb:21
  def ===(string); end
  ...
  # @see Mustermann::Expander
  #
  # source://mustermann-3.1.1/lib/mustermann/identity.rb:68
  def expand(behavior = T.unsafe(nil), values = T.unsafe(nil)); end

  # @param string [String] The string to match against
  # @return [Integer, nil] the number of characters that match
  #
  # source://mustermann-3.1.1/lib/mustermann/identity.rb:28
  def peek_size(string); end

  # Generates an AST so it's compatible with {Mustermann::AST::Pattern}.
  # Not used internally by {Mustermann::Identity}.
  #
  # source://mustermann-3.1.1/lib/mustermann/identity.rb:52
  def to_ast; end
  ...
  # @see Mustermann::Pattern#to_templates
  #
  # source://mustermann-3.1.1/lib/mustermann/identity.rb:45
  def to_templates; end
end

# Raised if anything goes wrong while parsing a {Pattern}.
#
# source://mustermann-3.1.1/lib/mustermann/error.rb:6
...
# @abstract
#
# source://mustermann-3.1.1/lib/mustermann/pattern.rb:10
class Mustermann::Pattern
  ...
  # @see Mustermann.new
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:75
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:315
  def &(other); end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:336
  def +(other); end
  ...
  # @return [true, false]
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:119
  def ==(other); end
  ...
  # @see http://ruby-doc.org/core-2.0/Regexp.html#method-i-3D-3D-3D Regexp#===
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:106
  def ===(string); end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:98
  def =~(string); end
  ...
  # @return [Boolean]
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:391
  ...
  # @return [true, false]
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:126
  def eql?(other); end
  ...
  # @see Mustermann::Expander
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:240
  def expand(behavior = T.unsafe(nil), values = T.unsafe(nil)); end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:112
  def hash; end

  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:366
  def inspect; end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:91
  def match(string); end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:153
  def peek(string); end
  ...
  # @see #peek_params
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:168
  def peek_match(string); end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:185
  def peek_params(string); end
  ...
  # @return [Integer, nil] the number of characters that match
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:139
  def peek_size(string); end

  # @return [Boolean]
  # @see Object#respond_to?
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:353
  def respond_to?(method, *args); end

  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:371
  def simple_inspect; end
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:346
  def to_proc; end

  # @return [String] the string representation of the pattern
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:82
  def to_s; end
  ...
  # @return [Array<String>] list of URI templates
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:279
  def to_templates; end

  # Returns the value of attribute uri_decode.
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:63
  def uri_decode; end
  ...
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:377
  def map_param(key, value); end

  # @return [Boolean]
  # @see #respond_to?
  #
  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:361
  def respond_to_special?(method); end

  # source://mustermann-3.1.1/lib/mustermann/pattern.rb:382
  ...
  class << self
    ...
    # @see #initialize
    #
    # source://mustermann-3.1.1/lib/mustermann/pattern.rb:50
    ...
    # @overload supported_options
    #
    # source://mustermann-3.1.1/lib/mustermann/pattern.rb:24
    def supported_options(*list); end
  end
end

# source://mustermann-3.1.1/lib/mustermann/pattern.rb:388
...
# @see Mustermann::Pattern
#
# source://mustermann-3.1.1/lib/mustermann/regexp_based.rb:10
class Mustermann::RegexpBased < ::Mustermann::Pattern
  ...
  # @see Mustermann.new
  #
  # source://mustermann-3.1.1/lib/mustermann/regexp_based.rb:17
  ...
  # @see #peek_params
  #
  # source://mustermann-3.1.1/lib/mustermann/regexp_based.rb:35
  def peek_match(string); end

  # @param string [String] The string to match against
  # @return [Integer, nil] the number of characters that match
  #
  # source://mustermann-3.1.1/lib/mustermann/regexp_based.rb:27
  def peek_size(string); end

  # @return [Regexp] regular expression equivalent to the pattern.
  #
  # source://mustermann-3.1.1/lib/mustermann/regexp_based.rb:11
  def regexp; end
  ...
  # @raise [NotImplementedError]
  #
  # source://mustermann-3.1.1/lib/mustermann/regexp_based.rb:42
  def compile(**options); end
end
...
#
# source://mustermann-3.1.1/lib/mustermann/regular.rb:14
class Mustermann::Regular < ::Mustermann::RegexpBased
  ...
  # @see Mustermann.new
  #
  # source://mustermann-3.1.1/lib/mustermann/regular.rb:22
  ...
  # @raise [CompileError]
  #
  # source://mustermann-3.1.1/lib/mustermann/regular.rb:38
  def check_anchors(scanner); end

  # source://mustermann-3.1.1/lib/mustermann/regular.rb:29
  def compile(**options); end

  # @return [Boolean]
  #
  # source://mustermann-3.1.1/lib/mustermann/regular.rb:44
...
# @see http://ruby-doc.org/core-2.0/MatchData.html MatchData
#
# source://mustermann-3.1.1/lib/mustermann/simple_match.rb:5
class Mustermann::SimpleMatch
  # @api private
  # @return [SimpleMatch] a new instance of SimpleMatch
  #
  # source://mustermann-3.1.1/lib/mustermann/simple_match.rb:7
  def initialize(string = T.unsafe(nil), names: T.unsafe(nil), captures: T.unsafe(nil)); end

  # source://mustermann-3.1.1/lib/mustermann/simple_match.rb:38
  def +(other); end

  # @return [nil] imitates MatchData interface
  #
  # source://mustermann-3.1.1/lib/mustermann/simple_match.rb:29
  def [](*args); end

  # @return [Array<String>] empty array for imitating MatchData interface
  #
  # source://mustermann-3.1.1/lib/mustermann/simple_match.rb:24
  def captures; end

  # @return [String] string representation
  #
  # source://mustermann-3.1.1/lib/mustermann/simple_match.rb:45
  def inspect; end

  # @return [Array<String>] empty array for imitating MatchData interface
  #
  # source://mustermann-3.1.1/lib/mustermann/simple_match.rb:19
  def names; end

  # @return [String] the string that was matched against
  #
  # source://mustermann-3.1.1/lib/mustermann/simple_match.rb:14
  def to_s; end
end
...
#
# source://mustermann-3.1.1/lib/mustermann/sinatra/parser.rb:5
class Mustermann::Sinatra < ::Mustermann::AST::Pattern
  ...
  #
  # source://mustermann-3.1.1/lib/mustermann/sinatra.rb:76
  def safe_string; end
  ...
  # @see Mustermann::Pattern#|
  #
  # source://mustermann-3.1.1/lib/mustermann/sinatra.rb:59
  def |(other); end

  private

  # source://mustermann-3.1.1/lib/mustermann/sinatra.rb:81
  def native_concat(other); end
  ...
  class << self
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann/sinatra.rb:29
    ...
    #
    # source://mustermann-3.1.1/lib/mustermann/sinatra.rb:37
...
#
# source://mustermann-3.1.1/lib/mustermann/sinatra/parser.rb:6
...
# @see #safe_string
#
# source://mustermann-3.1.1/lib/mustermann/sinatra/safe_renderer.rb:8
Mustermann::Sinatra::SafeRenderer = T.let(T.unsafe(nil), T.untyped)

# Tries to translate objects to Sinatra patterns.
#
# source://mustermann-3.1.1/lib/mustermann/sinatra/try_convert.rb:8
class Mustermann::Sinatra::TryConvert < ::Mustermann::AST::Translator
  # @return [TryConvert] a new instance of TryConvert
  #
  # source://mustermann-3.1.1/lib/mustermann/sinatra/try_convert.rb:18
  def initialize(options); end

  # @return [Mustermann::Sinatra]
  #
  # source://mustermann-3.1.1/lib/mustermann/sinatra/try_convert.rb:24
  def new(input, escape = T.unsafe(nil)); end

  # Expected options for the resulting pattern.
  #
  # source://mustermann-3.1.1/lib/mustermann/sinatra/try_convert.rb:15
  def options; end

  # @return [true, false] whether or not expected pattern should have uri_decode option set
  #
  # source://mustermann-3.1.1/lib/mustermann/sinatra/try_convert.rb:31
  def uri_decode; end

  class << self
    # @return [Mustermann::Sinatra, nil]
    #
    # source://mustermann-3.1.1/lib/mustermann/sinatra/try_convert.rb:9
    def convert(input, **options); end
  end
end

# source://mustermann-3.1.1/lib/mustermann/sinatra/try_convert.rb:0
