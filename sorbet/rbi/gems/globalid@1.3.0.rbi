...
# source://globalid-1.3.0/lib/global_id/global_id.rb:7
class GlobalID
  extend ::ActiveSupport::Autoload

  # @return [GlobalID] a new instance of GlobalID
  #
  # source://globalid-1.3.0/lib/global_id/global_id.rb:48
  def initialize(gid, options = T.unsafe(nil)); end

  # source://globalid-1.3.0/lib/global_id/global_id.rb:67
  def ==(other); end

  # source://globalid-1.3.0/lib/global_id/global_id.rb:46
  def app(*_arg0, &_arg1); end

  # source://globalid-1.3.0/lib/global_id/global_id.rb:80
  ...
  # source://globalid-1.3.0/lib/global_id/global_id.rb:52
  def find(options = T.unsafe(nil)); end

  # source://globalid-1.3.0/lib/global_id/global_id.rb:72
  def hash; end

  # source://globalid-1.3.0/lib/global_id/global_id.rb:56
  def model_class; end
  ...
  # source://globalid-1.3.0/lib/global_id/global_id.rb:76
  def to_param; end
  ...
  #
  # source://globalid-1.3.0/lib/global_id/global_id.rb:45
  def uri; end

  class << self
    # Returns the value of attribute app.
    #
    # source://globalid-1.3.0/lib/global_id/global_id.rb:9
    def app; end

    # source://globalid-1.3.0/lib/global_id/global_id.rb:31
    def app=(app); end

    # source://globalid-1.3.0/lib/global_id/global_id.rb:11
    def create(model, options = T.unsafe(nil)); end

    # source://globalid-1.3.0/lib/global_id/global_id.rb:35
    def default_locator(default_locator); end

    # source://globalid-1.3.0/lib/global_id.rb:20
    def deprecator; end

    # source://globalid-1.3.0/lib/global_id.rb:15
    def eager_load!; end

    # source://globalid-1.3.0/lib/global_id/global_id.rb:21
    def find(gid, options = T.unsafe(nil)); end

    # source://globalid-1.3.0/lib/global_id/global_id.rb:25
    def parse(gid, options = T.unsafe(nil)); end

    private

    # source://globalid-1.3.0/lib/global_id/global_id.rb:40
...
#
# source://globalid-1.3.0/lib/global_id/identification.rb:28
module GlobalID::Identification
  ...
  #
  # source://globalid-1.3.0/lib/global_id/identification.rb:37
  ...
  #
  # source://globalid-1.3.0/lib/global_id/identification.rb:46
  ...
  #   => #<Person:0x007fae94bf6298 @id="1">
  #
  # source://globalid-1.3.0/lib/global_id/identification.rb:107
  ...
  #
  # source://globalid-1.3.0/lib/global_id/identification.rb:116
...
# source://globalid-1.3.0/lib/global_id/locator.rb:4
module GlobalID::Locator
  class << self
    # The default locator used when no app-specific locator is found.
    #
    # source://globalid-1.3.0/lib/global_id/locator.rb:9
    ...
    #
    # source://globalid-1.3.0/lib/global_id/locator.rb:23
    ...
    #
    # source://globalid-1.3.0/lib/global_id/locator.rb:63
    ...
    #   modules match, +nil+ is returned.
    #
    # source://globalid-1.3.0/lib/global_id/locator.rb:106
    ...
    #   modules match, +nil+ is returned.
    #
    # source://globalid-1.3.0/lib/global_id/locator.rb:84
    ...
    # @raise [ArgumentError]
    #
    # source://globalid-1.3.0/lib/global_id/locator.rb:130
    ...
    # @return [Boolean]
    #
    # source://globalid-1.3.0/lib/global_id/locator.rb:143
    def find_allowed?(model_class, only = T.unsafe(nil)); end

    # source://globalid-1.3.0/lib/global_id/locator.rb:139
    def locator_for(gid); end

    # source://globalid-1.3.0/lib/global_id/locator.rb:151
    def normalize_app(app); end

    # source://globalid-1.3.0/lib/global_id/locator.rb:147
    def parse_allowed(gids, only = T.unsafe(nil)); end
  end
end

# source://globalid-1.3.0/lib/global_id/locator.rb:159
class GlobalID::Locator::BaseLocator
  # source://globalid-1.3.0/lib/global_id/locator.rb:160
  def locate(gid, options = T.unsafe(nil)); end

  # source://globalid-1.3.0/lib/global_id/locator.rb:168
  def locate_many(gids, options = T.unsafe(nil)); end

  private

  # source://globalid-1.3.0/lib/global_id/locator.rb:192
  def find_records(model_class, ids, options); end

  # @return [Boolean]
  #
  # source://globalid-1.3.0/lib/global_id/locator.rb:202
  def model_id_is_valid?(gid); end

  # source://globalid-1.3.0/lib/global_id/locator.rb:206
  def primary_key(model_class); end
end

# source://globalid-1.3.0/lib/global_id/locator.rb:232
class GlobalID::Locator::BlockLocator
  # @return [BlockLocator] a new instance of BlockLocator
  #
  # source://globalid-1.3.0/lib/global_id/locator.rb:233
  def initialize(block); end

  # source://globalid-1.3.0/lib/global_id/locator.rb:237
  def locate(gid, options = T.unsafe(nil)); end

  # source://globalid-1.3.0/lib/global_id/locator.rb:241
  def locate_many(gids, options = T.unsafe(nil)); end
end

# source://globalid-1.3.0/lib/global_id/locator.rb:5
class GlobalID::Locator::InvalidModelIdError < ::StandardError; end

# source://globalid-1.3.0/lib/global_id/locator.rb:211
class GlobalID::Locator::UnscopedLocator < ::GlobalID::Locator::BaseLocator
  # source://globalid-1.3.0/lib/global_id/locator.rb:212
  def locate(gid, options = T.unsafe(nil)); end

  private

  # source://globalid-1.3.0/lib/global_id/locator.rb:217
  def find_records(model_class, ids, options); end

  # source://globalid-1.3.0/lib/global_id/locator.rb:221
  def unscoped(model_class); end
end

# source://globalid-1.3.0/lib/global_id/railtie.rb:12
class GlobalID::Railtie < ::Rails::Railtie; end

# source://globalid-1.3.0/lib/global_id/verifier.rb:4
class GlobalID::Verifier < ::ActiveSupport::MessageVerifier
  private

  # source://globalid-1.3.0/lib/global_id/verifier.rb:10
  def decode(data, **_arg1); end

  # source://globalid-1.3.0/lib/global_id/verifier.rb:6
  def encode(data, **_arg1); end
end

# source://globalid-1.3.0/lib/global_id/signed_global_id.rb:4
class SignedGlobalID < ::GlobalID
  # @return [SignedGlobalID] a new instance of SignedGlobalID
  #
  # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:59
  def initialize(gid, options = T.unsafe(nil)); end

  # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:71
  def ==(other); end

  # Returns the value of attribute expires_at.
  #
  # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:57
  def expires_at; end

  # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:75
  def inspect; end
  ...
  # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:66
  def to_param; end
  ...
  # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:80
  def pick_expiration(options); end

  class << self
    # Returns the value of attribute expires_in.
    #
    # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:8
    def expires_in; end
    ...
    # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:10
    def parse(sgid, options = T.unsafe(nil)); end

    # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:24
    ...
    #
    # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:16
    ...
    # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:50
    def raise_if_expired(expires_at); end

    # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:29
    def verify(sgid, options); end

    # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:40
    def verify_with_legacy_self_validated_metadata(sgid, options); end

    # source://globalid-1.3.0/lib/global_id/signed_global_id.rb:34
    def verify_with_verifier_validated_metadata(sgid, options); end
  end
end

# source://globalid-1.3.0/lib/global_id/signed_global_id.rb:5
class SignedGlobalID::ExpiredMessage < ::StandardError; end

# source://globalid-1.3.0/lib/global_id/uri/gid.rb:6
module URI
  include ::URI::RFC2396_REGEXP
  extend ::URI::Escape
end

# source://globalid-1.3.0/lib/global_id/uri/gid.rb:27
...
#
# source://globalid-1.3.0/lib/global_id/uri/gid.rb:32
class URI::GID::MissingModelIdError < ::URI::InvalidComponentError; end

# source://globalid-1.3.0/lib/global_id/uri/gid.rb:39
