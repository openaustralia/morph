...
# source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/version.rb:1
module PryStackExplorer
  class << self
    ...
    #
    # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer.rb:109
    ...
    #
    # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer.rb:93
    ...
    #
    # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer.rb:35
    ...
    #   the current thread.
    #
    # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer.rb:19
    def frame_hash; end

    # @return [PryStackExplorer::FrameManager] The currently active frame manager
    #
    # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer.rb:101
    ...
    #
    # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer.rb:27
    ...
    #
    # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer.rb:60
    ...
    # @param _pry_ [Pry] The Pry instance associated with the frame managers.
    #
    # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer.rb:72
    ...
    #
    # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer.rb:46
    def push_helper(fm, options = T.unsafe(nil)); end
  end
end

# source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/commands.rb:133
PryStackExplorer::Commands = T.let(T.unsafe(nil), Pry::CommandSet)

# source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/commands.rb:2
module PryStackExplorer::FrameHelpers
  private

  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/commands.rb:115
  def find_frame_by_block(up_or_down); end

  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/commands.rb:100
  def find_frame_by_object_regex(class_regex, method_regex, up_or_down); end

  # Regexp.new(args[0])
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/commands.rb:88
  ...
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/commands.rb:28
  ...
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/commands.rb:48
  ...
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/commands.rb:69
...
#
# source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/frame_manager.rb:6
class PryStackExplorer::FrameManager
  include ::Enumerable

  # @return [FrameManager] a new instance of FrameManager
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/frame_manager.rb:27
  def initialize(bindings, _pry_); end

  # @return [Fixnum] The index of the active frame (binding) in the call-stack.
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/frame_manager.rb:14
  ...
  #   the call-stack.
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/frame_manager.rb:11
  def bindings; end
  ...
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/frame_manager.rb:71
  def change_frame_to(index, run_whereami = T.unsafe(nil)); end

  # @return [Binding] The currently active frame
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/frame_manager.rb:48
  def current_frame; end

  # Iterate over all frames
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/frame_manager.rb:37
  def each(&block); end

  # @return [Array] The backtrace of the Pry instance before the
  #   FrameManager took over.
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/frame_manager.rb:25
  def prior_backtrace; end

  # @return [Binding] The binding of the Pry instance before the
  #   FrameManager took over.
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/frame_manager.rb:21
  def prior_binding; end

  # Ensure the Pry instance's active binding is the frame manager's
  # active binding.
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/frame_manager.rb:43
  ...
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/frame_manager.rb:55
  def set_binding_index_safely(index); end

  # @return [Hash] A hash for user defined data
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/frame_manager.rb:17
  def user; end
end

# source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/commands.rb:342
PryStackExplorer::LOCATION_LAMBDA = T.let(T.unsafe(nil), Proc)

# source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/version.rb:2
PryStackExplorer::VERSION = T.let(T.unsafe(nil), String)

# source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/when_started_hook.rb:2
class PryStackExplorer::WhenStartedHook
  include ::Pry::Helpers::BaseHelpers

  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/when_started_hook.rb:23
  def call(target, options, _pry_); end

  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/when_started_hook.rb:5
  ...
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/when_started_hook.rb:84
  ...
  # @return [Boolean]
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/when_started_hook.rb:76
  ...
  # @return [Boolean]
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/when_started_hook.rb:70
  def pry_method_frame?(binding); end

  # remove pry-nav / pry-debugger / pry-byebug frames
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/when_started_hook.rb:64
  def remove_debugger_frames(bindings); end

  # remove internal frames related to setting up the session
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/when_started_hook.rb:48
  def remove_internal_frames(bindings); end

  # @return [Boolean]
  #
  # source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer/when_started_hook.rb:92
  def valid_call_stack?(bindings); end
end

# source://pry-stack_explorer-0.6.3/lib/pry-stack_explorer.rb:14
SE = PryStackExplorer
