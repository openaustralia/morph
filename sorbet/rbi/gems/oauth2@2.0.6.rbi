...
#
# source://oauth2-2.0.6/lib/oauth2/version.rb:3
module OAuth2; end

# source://oauth2-2.0.6/lib/oauth2/access_token.rb:4
class OAuth2::AccessToken
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:53
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:85
  def [](key); end

  # Returns the value of attribute client.
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:9
  def client; end
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:174
  ...
  # @return [Boolean]
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:99
  def expired?; end
  ...
  # @return [Boolean]
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:92
  def expires?; end
  ...
  # @see AccessToken#request
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:146
  def get(path, opts = T.unsafe(nil), &block); end

  # Get the headers hash (includes Authorization token)
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:179
  def headers; end

  # Returns the value of attribute options.
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:10
  def options; end
  ...
  # @see AccessToken#request
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:167
  ...
  # @see AccessToken#request
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:153
  ...
  # @see AccessToken#request
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:160
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:107
  ...
  #   @see Client#request
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:138
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:128
  def to_hash; end
  ...
  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:185
  def configure_authentication!(opts); end

  # source://oauth2-2.0.6/lib/oauth2/access_token.rb:206
  ...
  class << self
    ...
    #
    # source://oauth2-2.0.6/lib/oauth2/access_token.rb:19
    ...
    # @return [AccessToken] the initialized AccessToken
    #
    # source://oauth2-2.0.6/lib/oauth2/access_token.rb:34
    def from_kvform(client, kvform); end
  end
end

# source://oauth2-2.0.6/lib/oauth2/access_token.rb:5
OAuth2::AccessToken::TOKEN_KEYS_STR = T.let(T.unsafe(nil), Array)

# source://oauth2-2.0.6/lib/oauth2/access_token.rb:6
OAuth2::AccessToken::TOKEN_KEYS_SYM = T.let(T.unsafe(nil), Array)

# source://oauth2-2.0.6/lib/oauth2/access_token.rb:7
OAuth2::AccessToken::TOKEN_KEY_LOOKUP = T.let(T.unsafe(nil), Array)

# source://oauth2-2.0.6/lib/oauth2/authenticator.rb:6
class OAuth2::Authenticator
  # @return [Authenticator] a new instance of Authenticator
  #
  # source://oauth2-2.0.6/lib/oauth2/authenticator.rb:9
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/authenticator.rb:24
  def apply(params); end

  # Returns the value of attribute id.
  #
  # source://oauth2-2.0.6/lib/oauth2/authenticator.rb:7
  def id; end
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/authenticator.rb:64
  def apply_basic_auth(params); end

  # When using schemes that don't require the client_secret to be passed i.e TLS Client Auth,
  # we don't want to send the secret
  #
  # source://oauth2-2.0.6/lib/oauth2/authenticator.rb:56
  def apply_client_id(params); end

  # Adds client_id and client_secret request parameters if they are not
  # already set.
  #
  # source://oauth2-2.0.6/lib/oauth2/authenticator.rb:47
  def apply_params_auth(params); end

  # @see https://datatracker.ietf.org/doc/html/rfc2617#section-2
  #
  # source://oauth2-2.0.6/lib/oauth2/authenticator.rb:71
  def basic_auth_header; end

  class << self
    # source://oauth2-2.0.6/lib/oauth2/authenticator.rb:39
...
#
# source://oauth2-2.0.6/lib/oauth2/client.rb:11
class OAuth2::Client
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:38
  def initialize(client_id, client_secret, options = T.unsafe(nil), &block); end

  # source://oauth2-2.0.6/lib/oauth2/client.rb:228
  def assertion; end
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:203
  def auth_code; end
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:85
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:224
  def client_credentials; end

  # The Faraday connection object
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:69
  def connection; end
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:16
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:210
  def implicit; end

  # Returns the value of attribute options.
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:15
  def options; end
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:217
  def password; end
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:248
  ...
  # @yield [req] @see Faraday::Connection#run_request
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:113
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:63
  def site=(value); end
  ...
  # @param params [Hash] additional query parameters
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:93
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:281
  ...
  # @return [AccessToken] the initialized AccessToken
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:315
  ...
  # @return [AccessToken] the initialized AccessToken
  #
  # source://oauth2-2.0.6/lib/oauth2/client.rb:324
  def build_access_token_legacy_extract(response, access_token_opts, extract_access_token); end

  # source://oauth2-2.0.6/lib/oauth2/client.rb:258
  def execute_request(verb, url, opts = T.unsafe(nil)); end

  # source://oauth2-2.0.6/lib/oauth2/client.rb:330
  def oauth_debug_logging(builder); end

  # source://oauth2-2.0.6/lib/oauth2/client.rb:298
  def parse_response(response, access_token_opts); end

  # source://oauth2-2.0.6/lib/oauth2/client.rb:285
  def parse_response_with_legacy_extract(response, access_token_opts, extract_access_token); end
end

# source://oauth2-2.0.6/lib/oauth2/client.rb:12
OAuth2::Client::RESERVED_PARAM_KEYS = T.let(T.unsafe(nil), Array)

# source://oauth2-2.0.6/lib/oauth2/client.rb:7
class OAuth2::ConnectionError < ::Faraday::ConnectionFailed; end

# source://oauth2-2.0.6/lib/oauth2/error.rb:4
class OAuth2::Error < ::StandardError
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/error.rb:10
  def initialize(response); end

  # Returns the value of attribute body.
  #
  # source://oauth2-2.0.6/lib/oauth2/error.rb:5
  def body; end
  ...
  # source://oauth2-2.0.6/lib/oauth2/error.rb:32
  def error_message(response_body, opts = T.unsafe(nil)); end

  # source://oauth2-2.0.6/lib/oauth2/error.rb:49
  def parse_error_description(code, description); end
end

# OAuth2::Response class
#
# source://oauth2-2.0.6/lib/oauth2/response.rb:9
class OAuth2::Response
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/response.rb:51
  def initialize(response, parse: T.unsafe(nil), snaky: T.unsafe(nil), **options); end

  # The HTTP response body
  #
  # source://oauth2-2.0.6/lib/oauth2/response.rb:70
  def body; end

  # Attempts to determine the content type of the response.
  #
  # source://oauth2-2.0.6/lib/oauth2/response.rb:99
  def content_type; end

  # The HTTP response headers
  #
  # source://oauth2-2.0.6/lib/oauth2/response.rb:60
  def headers; end

  # Returns the value of attribute options.
  #
  # source://oauth2-2.0.6/lib/oauth2/response.rb:15
  def options; end
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/response.rb:78
  def parsed; end
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/response.rb:121
  def parser; end

  # Returns the value of attribute response.
  #
  # source://oauth2-2.0.6/lib/oauth2/response.rb:14
  def response; end

  # The HTTP response status code
  #
  # source://oauth2-2.0.6/lib/oauth2/response.rb:65
  def status; end
  ...
  class << self
    ...
    #
    # source://oauth2-2.0.6/lib/oauth2/response.rb:35
    def register_parser(key, mime_types, &block); end
  end
end

# source://oauth2-2.0.6/lib/oauth2/response.rb:10
...
#
# source://oauth2-2.0.6/lib/oauth2/snaky_hash.rb:6
class OAuth2::SnakyHash < ::Hashie::Mash::Rash; end

# source://oauth2-2.0.6/lib/oauth2/strategy/base.rb:4
...
#
# source://oauth2-2.0.6/lib/oauth2/strategy/assertion.rb:35
class OAuth2::Strategy::Assertion < ::OAuth2::Strategy::Base
  # Not used for this strategy
  #
  # @raise [NotImplementedError]
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/assertion.rb:36
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/assertion.rb:79
  ...
  # @raise [ArgumentError]
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/assertion.rb:95
  def build_assertion(claims, encoding_opts); end

  # source://oauth2-2.0.6/lib/oauth2/strategy/assertion.rb:88
...
# @see http://datatracker.ietf.org/doc/html/draft-ietf-oauth-v2-15#section-4.1
#
# source://oauth2-2.0.6/lib/oauth2/strategy/auth_code.rb:11
class OAuth2::Strategy::AuthCode < ::OAuth2::Strategy::Base
  # The required query parameters for the authorize URL
  #
  # @param params [Hash] additional query parameters
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/auth_code.rb:12
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/auth_code.rb:19
  def authorize_url(params = T.unsafe(nil)); end
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/auth_code.rb:30
  ...
  # @raise [ArgumentError]
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/auth_code.rb:42
  def assert_valid_params(params); end
end

# source://oauth2-2.0.6/lib/oauth2/strategy/base.rb:5
class OAuth2::Strategy::Base
  # @return [Base] a new instance of Base
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/base.rb:6
...
# @see http://datatracker.ietf.org/doc/html/draft-ietf-oauth-v2-15#section-4.4
#
# source://oauth2-2.0.6/lib/oauth2/strategy/client_credentials.rb:11
class OAuth2::Strategy::ClientCredentials < ::OAuth2::Strategy::Base
  # Not used for this strategy
  #
  # @raise [NotImplementedError]
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/client_credentials.rb:12
  def authorize_url; end
  ...
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/client_credentials.rb:20
...
# @see http://datatracker.ietf.org/doc/html/draft-ietf-oauth-v2-26#section-4.2
#
# source://oauth2-2.0.6/lib/oauth2/strategy/implicit.rb:11
class OAuth2::Strategy::Implicit < ::OAuth2::Strategy::Base
  # The required query parameters for the authorize URL
  #
  # @param params [Hash] additional query parameters
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/implicit.rb:12
  def authorize_params(params = T.unsafe(nil)); end
  ...
  # @param params [Hash] additional query parameters for the URL
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/implicit.rb:19
  def authorize_url(params = T.unsafe(nil)); end
  ...
  # @raise [NotImplementedError]
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/implicit.rb:27
  ...
  # @raise [ArgumentError]
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/implicit.rb:33
  def assert_valid_params(params); end
end
...
# @see http://datatracker.ietf.org/doc/html/draft-ietf-oauth-v2-15#section-4.3
#
# source://oauth2-2.0.6/lib/oauth2/strategy/password.rb:11
class OAuth2::Strategy::Password < ::OAuth2::Strategy::Base
  # Not used for this strategy
  #
  # @raise [NotImplementedError]
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/password.rb:12
  def authorize_url; end
  ...
  # @param params [Hash] additional params
  #
  # source://oauth2-2.0.6/lib/oauth2/strategy/password.rb:21
  def get_token(username, password, params = T.unsafe(nil), opts = T.unsafe(nil)); end
end

# source://oauth2-2.0.6/lib/oauth2/client.rb:8
class OAuth2::TimeoutError < ::Faraday::TimeoutError; end

# source://oauth2-2.0.6/lib/oauth2/version.rb:4
module OAuth2::Version
  extend ::VersionGem::Basic
  extend ::VersionGem::Api
end

# source://oauth2-2.0.6/lib/oauth2/version.rb:5
