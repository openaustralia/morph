...
# source://puma-5.6.9/lib/puma/detect.rb:7
module Puma
  class << self
    # @return [Boolean]
    #
    # source://puma-5.6.9/lib/puma.rb:44
    def abstract_unix_socket?; end

    # @return [Boolean]
    # @version 5.0.0
    #
    # source://puma-5.6.9/lib/puma/detect.rb:39
    def forkable?; end

    # @return [Boolean]
    #
    # source://puma-5.6.9/lib/puma/detect.rb:21
    def jruby?; end

    # @return [Boolean]
    # @version 5.0.0
    #
    # source://puma-5.6.9/lib/puma/detect.rb:34
    def mri?; end

    # @return [Boolean]
    #
    # source://puma-5.6.9/lib/puma/detect.rb:25
    def osx?; end

    # Thread name is new in Ruby 2.3
    #
    # source://puma-5.6.9/lib/puma.rb:75
    def set_thread_name(name); end

    # @return [Boolean]
    #
    # source://puma-5.6.9/lib/puma.rb:40
    def ssl?; end

    # source://puma-5.6.9/lib/puma.rb:64
    def stats; end

    # @version 5.0.0
    #
    # source://puma-5.6.9/lib/puma.rb:70
    def stats_hash; end

    # source://puma-5.6.9/lib/puma.rb:59
    def stats_object=(val); end

    # @return [Boolean]
    #
    # source://puma-5.6.9/lib/puma/detect.rb:29
    def windows?; end
  end
end

# source://puma-5.6.9/lib/puma/binder.rb:26
class Puma::Binder
  include ::Puma::Const

  # @return [Binder] a new instance of Binder
  #
  # source://puma-5.6.9/lib/puma/binder.rb:31
  def initialize(events, conf = T.unsafe(nil)); end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/binder.rb:67
  def activated_sockets; end

  # source://puma-5.6.9/lib/puma/binder.rb:360
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/binder.rb:100
  def create_activated_fds(env_hash); end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/binder.rb:87
  def create_inherited_fds(env_hash); end

  # source://puma-5.6.9/lib/puma/binder.rb:72
  def env(sock); end
  ...
  # source://puma-5.6.9/lib/puma/binder.rb:391
  def inherit_ssl_listener(fd, ctx); end

  # source://puma-5.6.9/lib/puma/binder.rb:353
  def inherit_tcp_listener(host, port, fd); end

  # source://puma-5.6.9/lib/puma/binder.rb:446
  ...
  #
  # source://puma-5.6.9/lib/puma/binder.rb:64
  def ios; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/binder.rb:70
  def ios=(_arg0); end
  ...
  # source://puma-5.6.9/lib/puma/binder.rb:309
  def localhost_authority; end

  # source://puma-5.6.9/lib/puma/binder.rb:313
  def localhost_authority_context; end

  # source://puma-5.6.9/lib/puma/binder.rb:155
  ...
  # source://puma-5.6.9/lib/puma/binder.rb:468
  def redirects_for_restart; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/binder.rb:475
  ...
  #
  # source://puma-5.6.9/lib/puma/binder.rb:128
  ...
  # source://puma-5.6.9/lib/puma/binder.rb:490
  def loc_addr_str(io); end

  # source://puma-5.6.9/lib/puma/binder.rb:484
  def loopback_addresses; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/binder.rb:500
  def socket_activation_fd(int); end
end

# source://puma-5.6.9/lib/puma/binder.rb:29
...
#
# source://puma-5.6.9/lib/puma/client.rb:41
class Puma::Client
  include ::Puma::Const
  extend ::Forwardable
  ...
  #
  # source://puma-5.6.9/lib/puma/client.rb:71
  def initialize(io, env = T.unsafe(nil)); end

  # Returns the value of attribute body.
  #
  # source://puma-5.6.9/lib/puma/client.rb:107
  def body; end

  # For the hijack protocol (allows us to just put the Client object
  # into the env)
  #
  # source://puma-5.6.9/lib/puma/client.rb:129
  def call; end
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/client.rb:297
  def can_close?; end

  # source://puma-5.6.9/lib/puma/client.rb:186
  def close; end

  # source://RUBY_ROOT/forwardable.rb:226
  def closed?(*args, &block); end

  # source://puma-5.6.9/lib/puma/client.rb:258
  ...
  # source://puma-5.6.9/lib/puma/client.rb:302
  def expect_proxy_proto=(val); end

  # source://puma-5.6.9/lib/puma/client.rb:264
  ...
  # source://puma-5.6.9/lib/puma/client.rb:135
  def in_data_phase; end

  # source://puma-5.6.9/lib/puma/client.rb:123
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/client.rb:118
  def io_ok?; end

  # Returns the value of attribute listener.
  #
  # source://puma-5.6.9/lib/puma/client.rb:112
  def listener; end
  ...
  # source://puma-5.6.9/lib/puma/client.rb:281
  def peerip; end
  ...
  #
  # source://puma-5.6.9/lib/puma/client.rb:110
  ...
  # source://puma-5.6.9/lib/puma/client.rb:148
  def reset(fast_check = T.unsafe(nil)); end

  # source://puma-5.6.9/lib/puma/client.rb:139
  ...
  #
  # source://puma-5.6.9/lib/puma/client.rb:144
  def timeout; end

  # @raise [ConnectionError]
  #
  # source://puma-5.6.9/lib/puma/client.rb:269
  def timeout!; end
...
#
# source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:9
class Puma::Cluster < ::Puma::Runner
  # @return [Cluster] a new instance of Cluster
  #
  # source://puma-5.6.9/lib/puma/cluster.rb:20
  def initialize(cli, events); end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/cluster.rb:149
  def all_workers_booted?; end

  # source://puma-5.6.9/lib/puma/cluster.rb:153
  def check_workers; end

  # source://puma-5.6.9/lib/puma/cluster.rb:132
  def cull_start_index(diff); end

  # source://puma-5.6.9/lib/puma/cluster.rb:108
  def cull_workers; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/cluster.rb:276
  def fork_worker!; end

  # source://puma-5.6.9/lib/puma/cluster.rb:233
  def halt; end

  # source://puma-5.6.9/lib/puma/cluster.rb:142
  def next_worker_index; end

  # source://puma-5.6.9/lib/puma/cluster.rb:212
  def phased_restart; end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/cluster.rb:271
  def preload?; end

  # source://puma-5.6.9/lib/puma/cluster.rb:57
  def redirect_io; end

  # source://puma-5.6.9/lib/puma/cluster.rb:238
  def reload_worker_directory; end

  # source://puma-5.6.9/lib/puma/cluster.rb:207
  def restart; end

  # source://puma-5.6.9/lib/puma/cluster.rb:336
  def run; end

  # We do this in a separate method to keep the lambda scope
  # of the signals handlers as small as possible.
  #
  # source://puma-5.6.9/lib/puma/cluster.rb:285
  def setup_signals; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/cluster.rb:94
  def spawn_worker(idx, master); end

  # source://puma-5.6.9/lib/puma/cluster.rb:63
  def spawn_workers; end

  # source://puma-5.6.9/lib/puma/cluster.rb:45
  def start_phased_restart; end

  # Inside of a child process, this will return all zeroes, as @workers is only populated in
  # the master process.
  #
  # source://puma-5.6.9/lib/puma/cluster.rb:247
  def stats; end

  # source://puma-5.6.9/lib/puma/cluster.rb:221
  def stop; end

  # source://puma-5.6.9/lib/puma/cluster.rb:226
  def stop_blocked; end

  # source://puma-5.6.9/lib/puma/cluster.rb:30
  def stop_workers; end

  # source://puma-5.6.9/lib/puma/cluster.rb:185
  def worker(index, master); end

  # source://puma-5.6.9/lib/puma/cluster.rb:122
  def workers_to_cull(diff); end

  private

  # source://puma-5.6.9/lib/puma/cluster.rb:497
  def single_worker_warning; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/cluster.rb:532
  def timeout_workers; end

  # loops thru @workers, removing workers that exited, and calling
  # `#term` if needed
  #
  # source://puma-5.6.9/lib/puma/cluster.rb:508
...
#
# source://puma-5.6.9/lib/puma/cluster/worker.rb:11
class Puma::Cluster::Worker < ::Puma::Runner
  # @return [Worker] a new instance of Worker
  #
  # source://puma-5.6.9/lib/puma/cluster/worker.rb:14
  def initialize(index:, master:, launcher:, pipes:, server: T.unsafe(nil)); end

  # Returns the value of attribute index.
  #
  # source://puma-5.6.9/lib/puma/cluster/worker.rb:12
  def index; end
  ...
  # source://puma-5.6.9/lib/puma/cluster/worker.rb:28
  def run; end

  private

  # source://puma-5.6.9/lib/puma/cluster/worker.rb:149
...
#
# source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:10
class Puma::Cluster::WorkerHandle
  # @return [WorkerHandle] a new instance of WorkerHandle
  #
  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:11
  def initialize(idx, pid, phase, options); end

  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:38
  def boot!; end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:30
  def booted?; end

  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:88
  def hup; end

  # Returns the value of attribute index.
  #
  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:25
  def index; end

  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:83
  def kill; end
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:28
  def phase=(_arg0); end
  ...
  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:51
  def ping!(status); end

  # @see Puma::Cluster#check_workers
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:62
  ...
  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:70
  def term; end

  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:43
  def term!; end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:47
  def term?; end

  # source://puma-5.6.9/lib/puma/cluster/worker_handle.rb:34
  def uptime; end
end

# source://puma-5.6.9/lib/puma/configuration.rb:9
module Puma::ConfigDefault; end

# source://puma-5.6.9/lib/puma/configuration.rb:10
Puma::ConfigDefault::DefaultRackup = T.let(T.unsafe(nil), String)

# source://puma-5.6.9/lib/puma/configuration.rb:12
Puma::ConfigDefault::DefaultTCPHost = T.let(T.unsafe(nil), String)

# source://puma-5.6.9/lib/puma/configuration.rb:13
Puma::ConfigDefault::DefaultTCPPort = T.let(T.unsafe(nil), Integer)

# source://puma-5.6.9/lib/puma/configuration.rb:14
Puma::ConfigDefault::DefaultWorkerCheckInterval = T.let(T.unsafe(nil), Integer)

# source://puma-5.6.9/lib/puma/configuration.rb:16
Puma::ConfigDefault::DefaultWorkerShutdownTimeout = T.let(T.unsafe(nil), Integer)

# source://puma-5.6.9/lib/puma/configuration.rb:15
...
# configuration files.
#
# source://puma-5.6.9/lib/puma/configuration.rb:138
class Puma::Configuration
  include ::Puma::ConfigDefault

  # @return [Configuration] a new instance of Configuration
  #
  # source://puma-5.6.9/lib/puma/configuration.rb:141
  def initialize(user_options = T.unsafe(nil), default_options = T.unsafe(nil), &block); end

  # Load the specified rackup file, pull options from
  # the rackup file, and set @app.
  #
  # source://puma-5.6.9/lib/puma/configuration.rb:269
  def app; end
  ...
  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/configuration.rb:258
  def app_configured?; end

  # Call once all configuration (included from rackup files)
  # is loaded to flesh out any defaults
  #
  # source://puma-5.6.9/lib/puma/configuration.rb:239
  def clamp; end

  # source://puma-5.6.9/lib/puma/configuration.rb:224
  def config_files; end

  # source://puma-5.6.9/lib/puma/configuration.rb:161
  def configure; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/configuration.rb:185
  def default_max_threads; end

  # Return which environment we're running in
  #
  # source://puma-5.6.9/lib/puma/configuration.rb:282
  def environment; end

  # source://puma-5.6.9/lib/puma/configuration.rb:286
  def environment_str; end

  # source://puma-5.6.9/lib/puma/configuration.rb:305
  def final_options; end

  # source://puma-5.6.9/lib/puma/configuration.rb:175
  def flatten; end

  # source://puma-5.6.9/lib/puma/configuration.rb:179
  def flatten!; end

  # source://puma-5.6.9/lib/puma/configuration.rb:218
  def load; end

  # source://puma-5.6.9/lib/puma/configuration.rb:290
  def load_plugin(name); end

  # Returns the value of attribute options.
  #
  # source://puma-5.6.9/lib/puma/configuration.rb:159
  def options; end
  ...
  # source://puma-5.6.9/lib/puma/configuration.rb:189
  def puma_default_options; end

  # source://puma-5.6.9/lib/puma/configuration.rb:262
  def rackup; end

  # source://puma-5.6.9/lib/puma/configuration.rb:294
  def run_hooks(key, arg, events); end

  private

  # source://puma-5.6.9/lib/puma/configuration.rb:318
  def infer_tag; end

  # source://puma-5.6.9/lib/puma/configuration.rb:169
  def initialize_copy(other); end

  # source://puma-5.6.9/lib/puma/configuration.rb:345
  def load_rackup; end

  # Load and use the normal Rack builder if we can, otherwise
  # fallback to our minimal version.
  #
  # source://puma-5.6.9/lib/puma/configuration.rb:324
  def rack_builder; end

  class << self
    # source://puma-5.6.9/lib/puma/configuration.rb:363
    def random_token; end

    # source://puma-5.6.9/lib/puma/configuration.rb:309
    def temp_path; end
  end
end
...
#
# source://puma-5.6.9/lib/puma/configuration.rb:244
class Puma::Configuration::ConfigMiddleware
  # @return [ConfigMiddleware] a new instance of ConfigMiddleware
  #
  # source://puma-5.6.9/lib/puma/configuration.rb:245
  def initialize(config, app); end

  # source://puma-5.6.9/lib/puma/configuration.rb:250
  def call(env); end
end

# source://puma-5.6.9/lib/puma/client.rb:24
...
#
# source://puma-5.6.9/lib/puma/const.rb:250
...
# sending data back
#
# source://puma-5.6.9/lib/puma/const.rb:120
...
# +test/config+.
#
# source://puma-5.6.9/lib/puma/dsl.rb:35
class Puma::DSL
  include ::Puma::ConfigDefault

  # @return [DSL] a new instance of DSL
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:77
  def initialize(options, config); end

  # source://puma-5.6.9/lib/puma/dsl.rb:84
  def _load_from(path); end

  # source://puma-5.6.9/lib/puma/dsl.rb:93
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:167
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:610
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:145
  ...
  # @note Cluster mode only.
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:548
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:225
  def bind(url); end
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:256
  def bind_to_activated_sockets(bind = T.unsafe(nil)); end

  # Work around leaky apps that leave garbage in Thread locals
  # across requests.
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:283
  def clean_thread_locals(which = T.unsafe(nil)); end

  # source://puma-5.6.9/lib/puma/dsl.rb:230
  def clear_binds!; end

  # Show debugging info
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:376
  def debug; end

  # source://puma-5.6.9/lib/puma/dsl.rb:108
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:660
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:292
  def drain_on_shutdown(which = T.unsafe(nil)); end

  # source://puma-5.6.9/lib/puma/dsl.rb:397
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:303
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:737
  ...
  # @see Puma::Server.new
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:277
  ...
  # @see Puma::Server#graceful_shutdown
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:315
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:941
  def fork_worker(after_requests = T.unsafe(nil)); end

  # source://puma-5.6.9/lib/puma/dsl.rb:116
  def get(key, default = T.unsafe(nil)); end

  # source://puma-5.6.9/lib/puma/dsl.rb:112
  def inject(&blk); end
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:984
  def io_selector_backend(backend); end

  # Load additional configuration from a file
  # Files get loaded later via Configuration#load
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:194
  def load(file); end

  # source://puma-5.6.9/lib/puma/dsl.rb:414
  def log_formatter(&block); end

  # Enable request logging
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:370
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:958
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:635
  ...
  #   end
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:337
  ...
  # @note Cluster mode only.
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:563
  ...
  # @note Cluster mode only.
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:595
  ...
  # @note Cluster mode only.
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:580
  ...
  # This can be called multiple times to add several hooks.
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:649
  ...
  # @see Puma::Server.new
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:271
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:356
  def pidfile(path); end

  # Load the named plugin for use by this configuration
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:122
  def plugin(name); end
  ...
  #   port 9292
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:264
  ...
  # @note Cluster mode only.
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:670
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:704
  ...
  # @see Puma::Server
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:851
  ...
  #   quiet
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:364
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:393
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:386
  def rackup(path); end
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:720
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:348
  def restart_command(cmd); end

  # source://puma-5.6.9/lib/puma/dsl.rb:104
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:899
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:859
  ...
  # @note Cluster mode only.
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:530
  ...
  #   }
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:480
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:490
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:500
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:408
  ...
  #   tag ''
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:750
  def tag(string); end
  ...
  #   threads 5, 5
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:430
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:873
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:800
  ...
  # @see Puma::Cluster#check_workers
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:763
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:827
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:809
  ...
  # @see Puma::Cluster::Worker#ping_timeout
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:779
  ...
  # @see Puma::Cluster
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:512
  ...
  #
  # source://puma-5.6.9/lib/puma/dsl.rb:996
  ...
  class << self
    ...
    # @see ssl_bind
    #
    # source://puma-5.6.9/lib/puma/dsl.rb:41
...
# @version 5.0.0
#
# source://puma-5.6.9/lib/puma/error_logger.rb:9
class Puma::ErrorLogger
  include ::Puma::Const

  # @return [ErrorLogger] a new instance of ErrorLogger
  #
  # source://puma-5.6.9/lib/puma/error_logger.rb:16
  ...
  #
  # source://puma-5.6.9/lib/puma/error_logger.rb:45
  ...
  #   and before all remaining info.
  #
  # source://puma-5.6.9/lib/puma/error_logger.rb:33
  def info(options = T.unsafe(nil)); end

  # Returns the value of attribute ioerr.
  #
  # source://puma-5.6.9/lib/puma/error_logger.rb:12
  def ioerr; end

  # source://puma-5.6.9/lib/puma/error_logger.rb:71
  def request_dump(req); end

  # source://puma-5.6.9/lib/puma/error_logger.rb:87
  def request_headers(req); end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/error_logger.rb:92
  def request_parsed?(req); end

  # source://puma-5.6.9/lib/puma/error_logger.rb:76
  def request_title(req); end

  # source://puma-5.6.9/lib/puma/error_logger.rb:59
  def title(options = T.unsafe(nil)); end

  private

  # source://puma-5.6.9/lib/puma/error_logger.rb:98
  def log(str); end

  class << self
    # source://puma-5.6.9/lib/puma/error_logger.rb:22
    def stdio; end
  end
end

# source://puma-5.6.9/lib/puma/error_logger.rb:14
...
#
# source://puma-5.6.9/lib/puma/events.rb:13
class Puma::Events
  # Create an Events object that prints to +stdout+ and +stderr+.
  #
  # @return [Events] a new instance of Events
  #
  # source://puma-5.6.9/lib/puma/events.rb:28
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/events.rb:95
  def connection_error(error, req, text = T.unsafe(nil)); end

  # source://puma-5.6.9/lib/puma/events.rb:75
  def debug(str); end
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/events.rb:131
  def debug_error(error, req = T.unsafe(nil), text = T.unsafe(nil)); end

  # Write +str+ to +@stderr+
  #
  # source://puma-5.6.9/lib/puma/events.rb:81
  def error(str); end

  # Fire callbacks for the named hook
  #
  # source://puma-5.6.9/lib/puma/events.rb:44
  def fire(hook, *args); end

  # source://puma-5.6.9/lib/puma/events.rb:147
  def fire_on_booted!; end

  # source://puma-5.6.9/lib/puma/events.rb:151
  def fire_on_restart!; end

  # source://puma-5.6.9/lib/puma/events.rb:155
  def fire_on_stopped!; end

  # source://puma-5.6.9/lib/puma/events.rb:86
  def format(str); end

  # Returns the value of attribute formatter.
  #
  # source://puma-5.6.9/lib/puma/events.rb:40
  def formatter; end
  ...
  # Write +str+ to +@stdout+
  #
  # source://puma-5.6.9/lib/puma/events.rb:64
  def log(str); end

  # source://puma-5.6.9/lib/puma/events.rb:135
  def on_booted(&block); end

  # source://puma-5.6.9/lib/puma/events.rb:139
  def on_restart(&block); end

  # source://puma-5.6.9/lib/puma/events.rb:143
  ...
  # and +req+ the request.
  #
  # source://puma-5.6.9/lib/puma/events.rb:103
  def parse_error(error, req); end

  # Register a callback for a given hook
  #
  # source://puma-5.6.9/lib/puma/events.rb:50
  ...
  #
  # source://puma-5.6.9/lib/puma/events.rb:111
  def ssl_error(error, ssl_socket); end

  # Returns the value of attribute stderr.
  #
  # source://puma-5.6.9/lib/puma/events.rb:39
  def stderr; end
  ...
  # and +text+ additional info
  #
  # source://puma-5.6.9/lib/puma/events.rb:122
  def unknown_error(error, req = T.unsafe(nil), text = T.unsafe(nil)); end

  # source://puma-5.6.9/lib/puma/events.rb:71
  def write(str); end

  class << self
    # source://puma-5.6.9/lib/puma/events.rb:172
    def null; end

    # source://puma-5.6.9/lib/puma/events.rb:168
    def stdio; end

    # Returns an Events object which writes its status to 2 StringIO
    # objects.
    #
    # source://puma-5.6.9/lib/puma/events.rb:164
    def strings; end
  end
end

# source://puma-5.6.9/lib/puma/events.rb:159
Puma::Events::DEFAULT = T.let(T.unsafe(nil), Puma::Events)

# source://puma-5.6.9/lib/puma/events.rb:14
class Puma::Events::DefaultFormatter
  # source://puma-5.6.9/lib/puma/events.rb:15
  def call(str); end
end

# source://puma-5.6.9/lib/puma/events.rb:20
class Puma::Events::PidFormatter
  # source://puma-5.6.9/lib/puma/events.rb:21
  def call(str); end
end

# @version 5.2.1
#
# source://puma-5.6.9/lib/puma/detect.rb:9
Puma::HAS_FORK = T.let(T.unsafe(nil), TrueClass)

# at present, MiniSSL::Engine is only defined in extension code (puma_http11),
# not in minissl.rb
#
# source://puma-5.6.9/lib/puma.rb:26
Puma::HAS_SSL = T.let(T.unsafe(nil), TrueClass)

# source://puma-5.6.9/lib/puma.rb:28
...
#
# source://puma-5.6.9/lib/puma/const.rb:18
...
# source://puma-5.6.9/lib/puma/client.rb:26
class Puma::HttpParserError501 < ::IOError; end

# source://puma-5.6.9/lib/puma/io_buffer.rb:4
class Puma::IOBuffer < ::String
  # source://puma-5.6.9/lib/puma/io_buffer.rb:5
  def append(*args); end
...
# @version 5.2.0
#
# source://puma-5.6.9/lib/puma/detect.rb:19
...
#
# source://puma-5.6.9/lib/puma/json_serialization.rb:20
module Puma::JSONSerialization
  class << self
    # source://puma-5.6.9/lib/puma/json_serialization.rb:29
    def generate(value); end

    private

    # source://puma-5.6.9/lib/puma/json_serialization.rb:86
    def serialize_object_key(output, value); end

    # source://puma-5.6.9/lib/puma/json_serialization.rb:71
    def serialize_string(output, value); end

    # source://puma-5.6.9/lib/puma/json_serialization.rb:38
    def serialize_value(output, value); end
  end
end

# source://puma-5.6.9/lib/puma/json_serialization.rb:22
Puma::JSONSerialization::BACKSLASH = T.let(T.unsafe(nil), Regexp)

# source://puma-5.6.9/lib/puma/json_serialization.rb:24
Puma::JSONSerialization::CHAR_TO_ESCAPE = T.let(T.unsafe(nil), Regexp)

# As required by ECMA-404
#
# source://puma-5.6.9/lib/puma/json_serialization.rb:23
Puma::JSONSerialization::CONTROL_CHAR_TO_ESCAPE = T.let(T.unsafe(nil), Regexp)

# source://puma-5.6.9/lib/puma/json_serialization.rb:21
Puma::JSONSerialization::QUOTE = T.let(T.unsafe(nil), Regexp)

# source://puma-5.6.9/lib/puma/json_serialization.rb:26
...
# puma server.
#
# source://puma-5.6.9/lib/puma/launcher.rb:17
class Puma::Launcher
  ...
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:44
  def initialize(conf, launcher_args = T.unsafe(nil)); end

  # Returns the value of attribute binder.
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:102
  def binder; end

  # source://puma-5.6.9/lib/puma/launcher.rb:229
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:215
  def connected_ports; end

  # Delete the configured pidfile
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:130
  ...
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:136
  def halt; end
  ...
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:154
  def phased_restart; end

  # Begin a refork if supported
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:163
  def refork; end

  # Begin async restart of the server
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:148
  def restart; end

  # source://puma-5.6.9/lib/puma/launcher.rb:220
  ...
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:174
  def run; end

  # Return stats about the server
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:105
  def stats; end

  # Begin async shutdown of the server gracefully
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:142
  def stop; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:240
  def thread_status; end

  # Write a state file that can be used by pumactl to control
  # the server
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:111
  def write_state; end
  ...
  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:383
  def clustered?; end

  # source://puma-5.6.9/lib/puma/launcher.rb:414
  def environment; end

  # source://puma-5.6.9/lib/puma/launcher.rb:301
  def extra_runtime_deps_directories; end

  # source://puma-5.6.9/lib/puma/launcher.rb:294
  def files_to_require_after_prune; end

  # source://puma-5.6.9/lib/puma/launcher.rb:422
  def generate_restart_data; end

  # source://puma-5.6.9/lib/puma/launcher.rb:392
  ...
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:354
  def integrate_with_systemd; end

  # source://puma-5.6.9/lib/puma/launcher.rb:379
  def log(str); end

  # source://puma-5.6.9/lib/puma/launcher.rb:548
  def log_config; end

  # source://puma-5.6.9/lib/puma/launcher.rb:320
  def prune_bundler; end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:418
  def prune_bundler?; end

  # source://puma-5.6.9/lib/puma/launcher.rb:313
  def puma_wild_location; end

  # source://puma-5.6.9/lib/puma/launcher.rb:265
  def reload_worker_directory; end

  # source://puma-5.6.9/lib/puma/launcher.rb:375
  def require_paths_for_gem(gem_spec); end

  # source://puma-5.6.9/lib/puma/launcher.rb:531
  def require_rubygems_min_version!(min_version, feature); end

  # source://puma-5.6.9/lib/puma/launcher.rb:269
  def restart!; end

  # source://puma-5.6.9/lib/puma/launcher.rb:397
  def set_process_title; end

  # source://puma-5.6.9/lib/puma/launcher.rb:408
  def set_rack_environment; end

  # source://puma-5.6.9/lib/puma/launcher.rb:467
  def setup_signals; end

  # source://puma-5.6.9/lib/puma/launcher.rb:371
  def spec_for_gem(gem_name); end

  # source://puma-5.6.9/lib/puma/launcher.rb:402
  def title; end

  # @raise [UnsupportedOption]
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:387
  def unsupported(str); end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:539
  def with_unbundled_env; end

  # If configured, write the pid of the current process out
  # to a file.
  #
  # source://puma-5.6.9/lib/puma/launcher.rb:255
  def write_pid; end
end

# @deprecated 6.0.0
#
# source://puma-5.6.9/lib/puma/launcher.rb:19
Puma::Launcher::KEYS_NOT_TO_PERSIST_IN_STATE = T.let(T.unsafe(nil), Array)

# source://puma-5.6.9/lib/puma/minissl.rb:12
module Puma::MiniSSL
  class << self
    def check; end
  end
...
# source://puma-5.6.9/lib/puma/minissl.rb:204
class Puma::MiniSSL::Context
  # @return [Context] a new instance of Context
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:208
  def initialize; end

  # Returns the value of attribute ca.
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:241
  def ca; end

  # source://puma-5.6.9/lib/puma/minissl.rb:257
  def ca=(ca); end

  # Returns the value of attribute cert.
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:240
  def cert; end

  # source://puma-5.6.9/lib/puma/minissl.rb:252
  def cert=(cert); end

  # Returns the value of attribute cert_pem.
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:242
  def cert_pem; end

  # @raise [ArgumentError]
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:262
  def cert_pem=(cert_pem); end

  # source://puma-5.6.9/lib/puma/minissl.rb:272
  def check; end

  # @raise [ArgumentError]
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:217
  def check_file(file, desc); end

  # non-jruby Context properties
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:239
  def key; end

  # source://puma-5.6.9/lib/puma/minissl.rb:247
  def key=(key); end

  # Returns the value of attribute key_pem.
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:243
  def key_pem; end

  # @raise [ArgumentError]
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:267
  def key_pem=(key_pem); end

  # Returns the value of attribute no_tlsv1.
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:206
  def no_tlsv1; end
  ...
  # @raise [ArgumentError]
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:280
  ...
  # @raise [ArgumentError]
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:287
  def no_tlsv1_1=(tlsv1_1); end

  # Returns the value of attribute ssl_cipher_filter.
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:244
  ...
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:245
  ...
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:205
  def verify_mode; end
...
# source://puma-5.6.9/lib/puma/minissl/context_builder.rb:3
class Puma::MiniSSL::ContextBuilder
  # @return [ContextBuilder] a new instance of ContextBuilder
  #
  # source://puma-5.6.9/lib/puma/minissl/context_builder.rb:4
  def initialize(params, events); end

  # source://puma-5.6.9/lib/puma/minissl/context_builder.rb:9
  def context; end
  ...
  # Returns the value of attribute events.
  #
  # source://puma-5.6.9/lib/puma/minissl/context_builder.rb:78
  def events; end
...
# @version 5.0.0
#
# source://puma-5.6.9/lib/puma/minissl.rb:16
...
# source://puma-5.6.9/lib/puma/minissl.rb:324
class Puma::MiniSSL::Server
  # @return [Server] a new instance of Server
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:325
  def initialize(socket, ctx); end

  # source://puma-5.6.9/lib/puma/minissl.rb:331
  def accept; end

  # source://puma-5.6.9/lib/puma/minissl.rb:338
  def accept_nonblock; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:352
  def addr; end

  # source://puma-5.6.9/lib/puma/minissl.rb:356
  def close; end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:360
  def closed?; end

  # source://puma-5.6.9/lib/puma/minissl.rb:346
  def to_io; end
end

# source://puma-5.6.9/lib/puma/minissl.rb:20
class Puma::MiniSSL::Socket
  # @return [Socket] a new instance of Socket
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:21
  def initialize(socket, engine); end

  # source://puma-5.6.9/lib/puma/minissl.rb:117
  def <<(data); end

  # source://puma-5.6.9/lib/puma/minissl.rb:164
  def close; end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:32
  def closed?; end

  # source://puma-5.6.9/lib/puma/minissl.rb:74
  def engine_read_all; end

  # source://puma-5.6.9/lib/puma/minissl.rb:160
  def flush; end

  # source://puma-5.6.9/lib/puma/minissl.rb:180
  def peeraddr; end

  # source://puma-5.6.9/lib/puma/minissl.rb:185
  def peercert; end

  # source://puma-5.6.9/lib/puma/minissl.rb:82
  def read_nonblock(size, *_); end

  # source://puma-5.6.9/lib/puma/minissl.rb:57
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:45
  def ssl_version_state; end

  # source://puma-5.6.9/lib/puma/minissl.rb:117
  def syswrite(data); end

  # source://puma-5.6.9/lib/puma/minissl.rb:28
  def to_io; end
  ...
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:156
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/minissl.rb:52
  def bad_tlsv1_3?; end
end
...
class Puma::NullIO
  ...
  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/null_io.rb:57
  def closed?; end

  # source://puma-5.6.9/lib/puma/null_io.rb:16
  def each; end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/null_io.rb:35
  def eof?; end

  # source://puma-5.6.9/lib/puma/null_io.rb:52
  def flush; end

  # source://puma-5.6.9/lib/puma/null_io.rb:8
  def gets; end

  # source://puma-5.6.9/lib/puma/null_io.rb:46
  def puts(*ary); end

  # Mimics IO#read with no data.
  #
  # source://puma-5.6.9/lib/puma/null_io.rb:21
  def read(count = T.unsafe(nil), _buffer = T.unsafe(nil)); end

  # source://puma-5.6.9/lib/puma/null_io.rb:25
  def rewind; end

  # source://puma-5.6.9/lib/puma/null_io.rb:31
  def size; end

  # source://puma-5.6.9/lib/puma/null_io.rb:12
  def string; end

  # source://puma-5.6.9/lib/puma/null_io.rb:39
  def sync; end

  # source://puma-5.6.9/lib/puma/null_io.rb:43
  def sync=(v); end

  # source://puma-5.6.9/lib/puma/null_io.rb:49
  def write(*ary); end
end

# source://puma-5.6.9/lib/puma/plugin.rb:76
class Puma::Plugin
  # source://puma-5.6.9/lib/puma/plugin.rb:107
  def in_background(&blk); end

  class << self
    # source://puma-5.6.9/lib/puma/plugin.rb:97
    def create(&blk); end

    # source://puma-5.6.9/lib/puma/plugin.rb:90
...
#
# source://puma-5.6.9/lib/puma/plugin.rb:81
Puma::Plugin::CALLER_FILE = T.let(T.unsafe(nil), Regexp)

# source://puma-5.6.9/lib/puma/plugin.rb:6
class Puma::PluginLoader
  # @return [PluginLoader] a new instance of PluginLoader
  #
  # source://puma-5.6.9/lib/puma/plugin.rb:7
  def initialize; end

  # @raise [UnknownPlugin]
  #
  # source://puma-5.6.9/lib/puma/plugin.rb:11
  def create(name); end

  # source://puma-5.6.9/lib/puma/plugin.rb:21
  def fire_starts(launcher); end
end

# source://puma-5.6.9/lib/puma/plugin.rb:30
class Puma::PluginRegistry
  # @return [PluginRegistry] a new instance of PluginRegistry
  #
  # source://puma-5.6.9/lib/puma/plugin.rb:31
  def initialize; end

  # source://puma-5.6.9/lib/puma/plugin.rb:60
  def add_background(blk); end

  # @raise [UnknownPlugin]
  #
  # source://puma-5.6.9/lib/puma/plugin.rb:40
  def find(name); end

  # source://puma-5.6.9/lib/puma/plugin.rb:64
  def fire_background; end

  # source://puma-5.6.9/lib/puma/plugin.rb:36
  def register(name, cls); end
end

# source://puma-5.6.9/lib/puma/plugin.rb:74
Puma::Plugins = T.let(T.unsafe(nil), Puma::PluginRegistry)

# source://puma-5.6.9/lib/puma/rack/builder.rb:6
...
#
# source://puma-5.6.9/lib/puma/rack/builder.rb:154
class Puma::Rack::Builder
  # @return [Builder] a new instance of Builder
  #
  # source://puma-5.6.9/lib/puma/rack/builder.rb:176
  def initialize(default_app = T.unsafe(nil), &block); end

  # source://puma-5.6.9/lib/puma/rack/builder.rb:283
  def call(env); end
  ...
  #
  # source://puma-5.6.9/lib/puma/rack/builder.rb:270
  ...
  #   run Heartbeat
  #
  # source://puma-5.6.9/lib/puma/rack/builder.rb:234
  def run(app); end

  # source://puma-5.6.9/lib/puma/rack/builder.rb:275
  def to_app; end
  ...
  #
  # source://puma-5.6.9/lib/puma/rack/builder.rb:212
  ...
  #   run MyApp
  #
  # source://puma-5.6.9/lib/puma/rack/builder.rb:247
  def warmup(prc = T.unsafe(nil), &block); end

  private

  # source://puma-5.6.9/lib/puma/rack/builder.rb:289
  def generate_map(default_app, mapping); end

  class << self
    # source://puma-5.6.9/lib/puma/rack/builder.rb:189
    def app(default_app = T.unsafe(nil), &block); end

    # source://puma-5.6.9/lib/puma/rack/builder.rb:171
    def new_from_string(builder_script, file = T.unsafe(nil)); end

    # source://puma-5.6.9/lib/puma/rack/builder.rb:155
    def parse_file(config, opts = T.unsafe(nil)); end
  end
end

# source://puma-5.6.9/lib/puma/rack/builder.rb:7
class Puma::Rack::Options
  # source://puma-5.6.9/lib/puma/rack/builder.rb:101
  def handler_opts(options); end

  # source://puma-5.6.9/lib/puma/rack/builder.rb:8
  def parse!(args); end
end
...
#
# source://puma-5.6.9/lib/puma/reactor.rb:19
class Puma::Reactor
  ...
  #
  # source://puma-5.6.9/lib/puma/reactor.rb:23
  ...
  #
  # source://puma-5.6.9/lib/puma/reactor.rb:49
  def add(client); end

  # Run the internal select loop, using a background thread by default.
  #
  # source://puma-5.6.9/lib/puma/reactor.rb:35
  def run(background = T.unsafe(nil)); end

  # Shutdown the reactor, blocking until the background thread is finished.
  #
  # source://puma-5.6.9/lib/puma/reactor.rb:58
  def shutdown; end
...
# @version 5.0.3
#
# source://puma-5.6.9/lib/puma/request.rb:13
module Puma::Request
  include ::Puma::Const
  ...
  #
  # source://puma-5.6.9/lib/puma/request.rb:194
  ...
  #
  # source://puma-5.6.9/lib/puma/request.rb:32
  ...
  #
  # source://puma-5.6.9/lib/puma/request.rb:242
  ...
  # @raise [ConnectionError]
  #
  # source://puma-5.6.9/lib/puma/request.rb:207
  def fast_write(io, str); end

  # @param status [Integer] status from the app
  # @return [String] the text description from Puma::HTTP_STATUS_CODES
  #
  # source://puma-5.6.9/lib/puma/request.rb:231
  def fetch_status_code(status); end

  # @param header_key [#to_s]
  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/request.rb:303
  def illegal_header_key?(header_key); end

  # @param header_value [#to_s]
  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/request.rb:310
  ...
  # @version 5.0.3
  #
  # source://puma-5.6.9/lib/puma/request.rb:329
  ...
  # @version 5.0.3
  #
  # source://puma-5.6.9/lib/puma/request.rb:369
  ...
  # @version 5.0.3
  #
  # source://puma-5.6.9/lib/puma/request.rb:397
...
#
# source://puma-5.6.9/lib/puma/runner.rb:10
class Puma::Runner
  # @return [Runner] a new instance of Runner
  #
  # source://puma-5.6.9/lib/puma/runner.rb:11
  def initialize(cli, events); end

  # source://puma-5.6.9/lib/puma/runner.rb:160
  def app; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/runner.rb:77
  def close_control_listeners; end

  # source://puma-5.6.9/lib/puma/runner.rb:51
  def debug(str); end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/runner.rb:30
  def development?; end

  # source://puma-5.6.9/lib/puma/runner.rb:47
  def error(str); end

  # source://puma-5.6.9/lib/puma/runner.rb:143
  def load_and_bind; end

  # source://puma-5.6.9/lib/puma/runner.rb:38
  def log(str); end

  # source://puma-5.6.9/lib/puma/runner.rb:94
  def output_header(mode); end

  # source://puma-5.6.9/lib/puma/runner.rb:116
  def redirect_io; end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/runner.rb:112
  def redirected_io?; end

  # source://puma-5.6.9/lib/puma/runner.rb:82
  def ruby_engine; end

  # source://puma-5.6.9/lib/puma/runner.rb:55
  def start_control; end

  # source://puma-5.6.9/lib/puma/runner.rb:164
  def start_server; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/runner.rb:43
  def stop_control; end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/runner.rb:34
  def test?; end

  # source://puma-5.6.9/lib/puma/runner.rb:21
  def wakeup!; end

  private

  # source://puma-5.6.9/lib/puma/runner.rb:171
  def ensure_output_directory_exists(path, io_name); end
end

# For some HTTP status codes the client only expects headers.
#
# source://puma-5.6.9/lib/puma/const.rb:84
...
#
# source://puma-5.6.9/lib/puma/server.rb:32
class Puma::Server
  include ::Puma::Const
  ...
  # @return [Server] a new instance of Server
  #
  # source://puma-5.6.9/lib/puma/server.rb:74
  ...
  #
  # source://puma-5.6.9/lib/puma/server.rb:54
  def app; end
  ...
  #
  # source://puma-5.6.9/lib/puma/server.rb:45
  def auto_trim_time; end

  # @deprecated v6.0.0
  #
  # source://puma-5.6.9/lib/puma/server.rb:50
  def auto_trim_time=(_arg0); end

  # source://puma-5.6.9/lib/puma/server.rb:197
  def backlog; end

  # source://puma-5.6.9/lib/puma/server.rb:609
  def begin_restart(sync = T.unsafe(nil)); end

  # Returns the value of attribute binder.
  #
  # source://puma-5.6.9/lib/puma/server.rb:55
  def binder; end
  ...
  #
  # source://puma-5.6.9/lib/puma/server.rb:509
  def client_error(e, client); end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/server.rb:174
  ...
  # 1/0 == turn on/off
  #
  # source://puma-5.6.9/lib/puma/server.rb:146
  ...
  # Returns the value of attribute events.
  #
  # source://puma-5.6.9/lib/puma/server.rb:39
  def events; end
  ...
  #
  # source://puma-5.6.9/lib/puma/server.rb:552
  def graceful_shutdown; end

  # source://puma-5.6.9/lib/puma/server.rb:604
  def halt(sync = T.unsafe(nil)); end

  # source://puma-5.6.9/lib/puma/server.rb:389
  def handle_check; end

  # source://puma-5.6.9/lib/puma/server.rb:312
  def handle_servers; end

  # source://puma-5.6.9/lib/puma/server.rb:113
  ...
  #
  # source://puma-5.6.9/lib/puma/server.rb:42
  def log_writer; end

  # A fallback rack response if +@app+ raises as exception.
  #
  # source://puma-5.6.9/lib/puma/server.rb:531
  def lowlevel_error(e, env, status = T.unsafe(nil)); end

  # for #stats
  #
  # source://puma-5.6.9/lib/puma/server.rb:40
  def max_threads; end
  ...
  #
  # source://puma-5.6.9/lib/puma/server.rb:215
  ...
  #
  # source://puma-5.6.9/lib/puma/server.rb:417
  ...
  #
  # source://puma-5.6.9/lib/puma/server.rb:296
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/server.rb:41
  ...
  #
  # source://puma-5.6.9/lib/puma/server.rb:225
  def run(background = T.unsafe(nil), thread_name: T.unsafe(nil)); end

  # source://puma-5.6.9/lib/puma/server.rb:202
  def running; end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/server.rb:614
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/server.rb:625
  def stats; end

  # Stops the acceptor thread and then causes the worker threads to finish
  # off the request queue before finally exiting.
  #
  # source://puma-5.6.9/lib/puma/server.rb:599
  def stop(sync = T.unsafe(nil)); end

  # Returns the value of attribute thread.
  #
  # source://puma-5.6.9/lib/puma/server.rb:38
  def thread; end

  # source://puma-5.6.9/lib/puma/server.rb:155
  def uncork_socket(socket); end

  # Triggers a client timeout if the thread-pool shuts down
  # during execution of the provided block.
  #
  # source://puma-5.6.9/lib/puma/server.rb:500
  def with_force_shutdown(client, &block); end

  private

  # source://puma-5.6.9/lib/puma/server.rb:581
  def notify_safely(message); end

  class << self
    # source://puma-5.6.9/lib/puma/server.rb:119
    def current; end
    ...
    # @version 5.0.0
    #
    # source://puma-5.6.9/lib/puma/server.rb:131
    def closed_socket_supported?; end

    # @return [Boolean]
    # @version 5.0.0
    #
    # source://puma-5.6.9/lib/puma/server.rb:125
...
# @version 5.0.0
#
# source://puma-5.6.9/lib/puma/server.rb:620
Puma::Server::STAT_METHODS = T.let(T.unsafe(nil), Array)

# source://puma-5.6.9/lib/puma/server.rb:60
Puma::Server::ThreadLocalKey = T.let(T.unsafe(nil), Symbol)

# source://puma-5.6.9/lib/puma/server.rb:172
...
# that this inherits from.
#
# source://puma-5.6.9/lib/puma/single.rb:16
class Puma::Single < ::Puma::Runner
  # source://puma-5.6.9/lib/puma/single.rb:31
  def halt; end

  # source://puma-5.6.9/lib/puma/single.rb:23
  def restart; end

  # source://puma-5.6.9/lib/puma/single.rb:41
  def run; end

  # source://puma-5.6.9/lib/puma/single.rb:17
  def stats; end

  # source://puma-5.6.9/lib/puma/single.rb:27
  def stop; end

  # source://puma-5.6.9/lib/puma/single.rb:35
  def stop_blocked; end
end
...
# and processes it.
#
# source://puma-5.6.9/lib/puma/thread_pool.rb:17
class Puma::ThreadPool
  ...
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:32
  def initialize(name, min, max, *extra, &block); end

  # Add +work+ to the todo list for a Thread to pickup and process.
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:185
  def <<(work); end

  # source://puma-5.6.9/lib/puma/thread_pool.rb:327
  def auto_reap!(timeout = T.unsafe(nil)); end

  # source://puma-5.6.9/lib/puma/thread_pool.rb:322
  def auto_trim!(timeout = T.unsafe(nil)); end

  # How many objects have yet to be processed by the pool?
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:82
  def backlog; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:93
  def busy_threads; end

  # Returns the value of attribute clean_thread_locals.
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:71
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:72
  ...
  # source://puma-5.6.9/lib/puma/thread_pool.rb:87
  def pool_capacity; end

  # If there are dead threads in the pool make them go away while decreasing
  # spawned counter so that new healthy threads could be created again.
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:280
  def reap; end
  ...
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:350
  def shutdown(timeout = T.unsafe(nil)); end

  # Returns the value of attribute spawned.
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:70
  def spawned; end
  ...
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:268
  ...
  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:244
  ...
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:227
  ...
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:334
  def with_force_shutdown; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:178
  ...
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:101
  def spawn_thread; end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:162
  def trigger_out_of_band_hook; end

  class << self
    # source://puma-5.6.9/lib/puma/thread_pool.rb:74
    def clean_thread_locals; end
  end
end

# source://puma-5.6.9/lib/puma/thread_pool.rb:295
class Puma::ThreadPool::Automaton
  # @return [Automaton] a new instance of Automaton
  #
  # source://puma-5.6.9/lib/puma/thread_pool.rb:296
  def initialize(pool, timeout, thread_name, message); end

  # source://puma-5.6.9/lib/puma/thread_pool.rb:304
  def start!; end

  # source://puma-5.6.9/lib/puma/thread_pool.rb:316
  def stop; end
end

# source://puma-5.6.9/lib/puma/thread_pool.rb:18
...
#
# source://puma-5.6.9/lib/puma/thread_pool.rb:24
Puma::ThreadPool::SHUTDOWN_GRACE_TIME = T.let(T.unsafe(nil), Integer)

# source://puma-5.6.9/lib/puma/plugin.rb:4
class Puma::UnknownPlugin < ::RuntimeError; end

# source://puma-5.6.9/lib/puma/reactor.rb:6
class Puma::UnsupportedBackend < ::StandardError; end

# source://puma-5.6.9/lib/puma/const.rb:5
...
#
# source://puma-5.6.9/lib/puma/configuration.rb:48
class Puma::UserFileDefaultOptions
  # @return [UserFileDefaultOptions] a new instance of UserFileDefaultOptions
  #
  # source://puma-5.6.9/lib/puma/configuration.rb:49
  def initialize(user_options, default_options); end

  # source://puma-5.6.9/lib/puma/configuration.rb:57
  def [](key); end

  # source://puma-5.6.9/lib/puma/configuration.rb:61
  def []=(key, value); end

  # source://puma-5.6.9/lib/puma/configuration.rb:73
  def all_of(key); end

  # Returns the value of attribute default_options.
  #
  # source://puma-5.6.9/lib/puma/configuration.rb:55
  def default_options; end

  # source://puma-5.6.9/lib/puma/configuration.rb:65
  ...
  # source://puma-5.6.9/lib/puma/configuration.rb:97
  def final_options; end

  # source://puma-5.6.9/lib/puma/configuration.rb:89
...
# source://puma-5.6.9/lib/puma/util.rb:6
module Puma::Util
  private

  # source://puma-5.6.9/lib/puma/util.rb:24
  def escape(s, encoding = T.unsafe(nil)); end

  # @version 5.0.0
  #
  # source://puma-5.6.9/lib/puma/util.rb:43
  ...
  #
  # source://puma-5.6.9/lib/puma/util.rb:60
  def parse_query(qs, d = T.unsafe(nil), &unescaper); end

  # source://puma-5.6.9/lib/puma/util.rb:9
  def pipe; end
  ...
  #
  # source://puma-5.6.9/lib/puma/util.rb:16
  def purge_interrupt_queue; end

  # source://puma-5.6.9/lib/puma/util.rb:28
...
# source://puma-5.6.9/lib/puma/util.rb:53
Puma::Util::DEFAULT_SEP = T.let(T.unsafe(nil), Regexp)

# A case-insensitive Hash that preserves the original case of a
# header when set.
#
# source://puma-5.6.9/lib/puma/util.rb:85
class Puma::Util::HeaderHash < ::Hash
  # @return [HeaderHash] a new instance of HeaderHash
  #
  # source://puma-5.6.9/lib/puma/util.rb:90
  def initialize(hash = T.unsafe(nil)); end

  # source://puma-5.6.9/lib/puma/util.rb:109
  def [](k); end

  # source://puma-5.6.9/lib/puma/util.rb:113
  def []=(k, v); end

  # source://puma-5.6.9/lib/puma/util.rb:120
  def delete(k); end

  # source://puma-5.6.9/lib/puma/util.rb:96
  def each; end

  # @return [Boolean]
  #
  # source://puma-5.6.9/lib/puma/util.rb:127
  def has_key?(k); end
  ...
  # source://puma-5.6.9/lib/puma/util.rb:140
  def merge(other); end

  # source://puma-5.6.9/lib/puma/util.rb:135
  def merge!(other); end

  # source://puma-5.6.9/lib/puma/util.rb:145
  def replace(other); end

  # source://puma-5.6.9/lib/puma/util.rb:103
  def to_hash; end

  class << self
    # source://puma-5.6.9/lib/puma/util.rb:86
