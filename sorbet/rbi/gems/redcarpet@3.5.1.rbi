...
# source://redcarpet-3.5.1/lib/redcarpet/compat.rb:71
Markdown = RedcarpetCompat

# source://redcarpet-3.5.1/lib/redcarpet.rb:4
module Redcarpet; end

# source://redcarpet-3.5.1/lib/redcarpet.rb:7
class Redcarpet::Markdown
  def render(_arg0); end

  # Returns the value of attribute renderer.
  #
  # source://redcarpet-3.5.1/lib/redcarpet.rb:8
  def renderer; end
...
# source://redcarpet-3.5.1/lib/redcarpet.rb:11
...
#
# source://redcarpet-3.5.1/lib/redcarpet.rb:31
class Redcarpet::Render::Safe < ::Redcarpet::Render::HTML
  # @return [Safe] a new instance of Safe
  #
  # source://redcarpet-3.5.1/lib/redcarpet.rb:32
  def initialize(extensions = T.unsafe(nil)); end

  # source://redcarpet-3.5.1/lib/redcarpet.rb:39
  ...
  #
  # source://redcarpet-3.5.1/lib/redcarpet.rb:50
  def html_escape(string); end
end

# HTML + SmartyPants renderer
#
# source://redcarpet-3.5.1/lib/redcarpet.rb:21
...
#
# source://redcarpet-3.5.1/lib/redcarpet.rb:85
module Redcarpet::Render::SmartyPants
  ...
  class << self
    # source://redcarpet-3.5.1/lib/redcarpet.rb:87
    def render(text); end
  end
end
...
class RedcarpetCompat
  ...
  # source://redcarpet-3.5.1/lib/redcarpet/compat.rb:12
  ...
  #
  # source://redcarpet-3.5.1/lib/redcarpet/compat.rb:66
  def list_to_truthy_hash(list); end

  # Returns two hashes, the extensions and renderer options
  # given the extension list
  #
  # source://redcarpet-3.5.1/lib/redcarpet/compat.rb:59
  def parse_extensions_and_renderer_options(exts); end

  # source://redcarpet-3.5.1/lib/redcarpet/compat.rb:47
  def rename_extensions(exts); end
end

# source://redcarpet-3.5.1/lib/redcarpet/compat.rb:18
RedcarpetCompat::EXTENSION_MAP = T.let(T.unsafe(nil), Hash)

# source://redcarpet-3.5.1/lib/redcarpet/compat.rb:44
