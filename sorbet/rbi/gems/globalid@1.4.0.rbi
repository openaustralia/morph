...
# source://globalid-1.4.0/lib/global_id/version.rb:2
class GlobalID
  extend ::ActiveSupport::Autoload

  # @return [GlobalID] a new instance of GlobalID
  #
  # source://globalid-1.4.0/lib/global_id/global_id.rb:49
  def initialize(gid, options = T.unsafe(nil)); end

  # source://globalid-1.4.0/lib/global_id/global_id.rb:81
  def ==(other); end

  # source://globalid-1.4.0/lib/global_id/global_id.rb:47
  def app(*_arg0, &_arg1); end

  # source://globalid-1.4.0/lib/global_id/global_id.rb:94
  ...
  # source://globalid-1.4.0/lib/global_id/global_id.rb:53
  def find(options = T.unsafe(nil)); end

  # source://globalid-1.4.0/lib/global_id/global_id.rb:86
  def hash; end

  # source://globalid-1.4.0/lib/global_id/global_id.rb:57
  def model_class; end
  ...
  # source://globalid-1.4.0/lib/global_id/global_id.rb:90
  def to_param; end
  ...
  #
  # source://globalid-1.4.0/lib/global_id/global_id.rb:46
  def uri; end

  class << self
    # Returns the value of attribute app.
    #
    # source://globalid-1.4.0/lib/global_id/global_id.rb:10
    def app; end

    # source://globalid-1.4.0/lib/global_id/global_id.rb:32
    def app=(app); end

    # source://globalid-1.4.0/lib/global_id/global_id.rb:12
    def create(model, options = T.unsafe(nil)); end

    # source://globalid-1.4.0/lib/global_id/global_id.rb:36
    def default_locator(default_locator); end

    # source://globalid-1.4.0/lib/global_id.rb:22
    def deprecator; end

    # source://globalid-1.4.0/lib/global_id.rb:17
    def eager_load!; end

    # source://globalid-1.4.0/lib/global_id/global_id.rb:22
    def find(gid, options = T.unsafe(nil)); end

    # source://globalid-1.4.0/lib/global_id/global_id.rb:26
    def parse(gid, options = T.unsafe(nil)); end

    private

    # source://globalid-1.4.0/lib/global_id/global_id.rb:41
...
#
# source://globalid-1.4.0/lib/global_id/identification.rb:29
module GlobalID::Identification
  ...
  #
  # source://globalid-1.4.0/lib/global_id/identification.rb:38
  ...
  #
  # source://globalid-1.4.0/lib/global_id/identification.rb:47
  ...
  #   => #<Person:0x007fae94bf6298 @id="1">
  #
  # source://globalid-1.4.0/lib/global_id/identification.rb:108
  ...
  #
  # source://globalid-1.4.0/lib/global_id/identification.rb:117
...
# source://globalid-1.4.0/lib/global_id/locator.rb:5
module GlobalID::Locator
  class << self
    # The default locator used when no app-specific locator is found.
    #
    # source://globalid-1.4.0/lib/global_id/locator.rb:21
    ...
    #
    # source://globalid-1.4.0/lib/global_id/locator.rb:71
    ...
    #
    # source://globalid-1.4.0/lib/global_id/locator.rb:35
    ...
    #
    # source://globalid-1.4.0/lib/global_id/locator.rb:104
    ...
    #   modules match, +nil+ is returned.
    #
    # source://globalid-1.4.0/lib/global_id/locator.rb:147
    ...
    #   modules match, +nil+ is returned.
    #
    # source://globalid-1.4.0/lib/global_id/locator.rb:125
    def locate_signed(sgid, options = T.unsafe(nil)); end

    # source://globalid-1.4.0/lib/global_id/locator.rb:179
    ...
    # @raise [ArgumentError]
    #
    # source://globalid-1.4.0/lib/global_id/locator.rb:171
    def use(app, locator = T.unsafe(nil), &locator_block); end

    private

    # source://globalid-1.4.0/lib/global_id/locator.rb:188
    def fetch_record(gid, options); end

    # @return [Boolean]
    #
    # source://globalid-1.4.0/lib/global_id/locator.rb:184
    def find_allowed?(gid, only = T.unsafe(nil)); end

    # source://globalid-1.4.0/lib/global_id/locator.rb:198
    def normalize_app(app); end

    # source://globalid-1.4.0/lib/global_id/locator.rb:194
    def parse_allowed(gids, only = T.unsafe(nil)); end
  end
end

# source://globalid-1.4.0/lib/global_id/locator.rb:206
class GlobalID::Locator::BaseLocator
  # source://globalid-1.4.0/lib/global_id/locator.rb:211
  def locate(gid, options = T.unsafe(nil)); end

  # source://globalid-1.4.0/lib/global_id/locator.rb:219
  def locate_many(gids, options = T.unsafe(nil)); end

  # source://globalid-1.4.0/lib/global_id/locator.rb:207
  def model_class(gid); end

  private

  # source://globalid-1.4.0/lib/global_id/locator.rb:243
  def find_records(model_class, ids, options); end

  # @return [Boolean]
  #
  # source://globalid-1.4.0/lib/global_id/locator.rb:253
  def model_id_is_valid?(gid); end

  # source://globalid-1.4.0/lib/global_id/locator.rb:257
  def primary_key(model_class); end
end

# source://globalid-1.4.0/lib/global_id/locator.rb:283
class GlobalID::Locator::BlockLocator
  # @return [BlockLocator] a new instance of BlockLocator
  #
  # source://globalid-1.4.0/lib/global_id/locator.rb:284
  def initialize(block); end

  # source://globalid-1.4.0/lib/global_id/locator.rb:292
  def locate(gid, options = T.unsafe(nil)); end

  # source://globalid-1.4.0/lib/global_id/locator.rb:296
  def locate_many(gids, options = T.unsafe(nil)); end

  # source://globalid-1.4.0/lib/global_id/locator.rb:288
  def model_class(gid); end
end

# source://globalid-1.4.0/lib/global_id/locator.rb:7
class GlobalID::Locator::Error < ::StandardError; end

# source://globalid-1.4.0/lib/global_id/locator.rb:6
...
# retrying won't help.
#
# source://globalid-1.4.0/lib/global_id/locator.rb:12
...
#
# source://globalid-1.4.0/lib/global_id/locator.rb:17
class GlobalID::Locator::RecordUnavailable < ::GlobalID::Locator::Error; end

# source://globalid-1.4.0/lib/global_id/locator.rb:262
class GlobalID::Locator::UnscopedLocator < ::GlobalID::Locator::BaseLocator
  # source://globalid-1.4.0/lib/global_id/locator.rb:263
  def locate(gid, options = T.unsafe(nil)); end

  private

  # source://globalid-1.4.0/lib/global_id/locator.rb:268
  def find_records(model_class, ids, options); end

  # source://globalid-1.4.0/lib/global_id/locator.rb:272
...
#
# source://globalid-1.4.0/lib/global_id/railtie.rb:10
class GlobalID::Railtie < ::Rails::Railtie; end

# source://globalid-1.4.0/lib/global_id/version.rb:3
GlobalID::VERSION = T.let(T.unsafe(nil), String)

# source://globalid-1.4.0/lib/global_id/verifier.rb:5
class GlobalID::Verifier < ::ActiveSupport::MessageVerifier
  private

  # source://globalid-1.4.0/lib/global_id/verifier.rb:11
  def decode(data, **_arg1); end

  # source://globalid-1.4.0/lib/global_id/verifier.rb:7
  def encode(data, **_arg1); end
end

# source://globalid-1.4.0/lib/global_id/signed_global_id.rb:5
class SignedGlobalID < ::GlobalID
  # @return [SignedGlobalID] a new instance of SignedGlobalID
  #
  # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:60
  def initialize(gid, options = T.unsafe(nil)); end

  # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:72
  def ==(other); end

  # Returns the value of attribute expires_at.
  #
  # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:58
  def expires_at; end

  # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:76
  def inspect; end
  ...
  # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:67
  def to_param; end
  ...
  # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:81
  def pick_expiration(options); end

  class << self
    # Returns the value of attribute expires_in.
    #
    # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:9
    def expires_in; end
    ...
    # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:11
    def parse(sgid, options = T.unsafe(nil)); end

    # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:25
    ...
    #
    # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:17
    ...
    # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:51
    def raise_if_expired(expires_at); end

    # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:30
    def verify(sgid, options); end

    # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:41
    def verify_with_legacy_self_validated_metadata(sgid, options); end

    # source://globalid-1.4.0/lib/global_id/signed_global_id.rb:35
    def verify_with_verifier_validated_metadata(sgid, options); end
  end
end

# source://globalid-1.4.0/lib/global_id/signed_global_id.rb:6
class SignedGlobalID::ExpiredMessage < ::StandardError; end

# source://globalid-1.4.0/lib/global_id/uri/gid.rb:7
module URI
  include ::URI::RFC2396_REGEXP
  extend ::URI::Escape
end

# source://globalid-1.4.0/lib/global_id/uri/gid.rb:28
class URI::GID < ::URI::Generic
  ...
  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:111
  def deconstruct_keys(_keys); end

  # Returns the value of attribute model_id.
  #
  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:30
  def model_id; end
  ...
  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:106
  def to_s; end
  ...
  #
  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:122
  def query=(query); end

  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:133
  def set_params(params); end

  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:116
  def set_path(path); end

  # Ruby 2.1 or less uses #set_query to assign the query
  #
  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:128
  def set_query(query); end

  private

  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:140
  def check_host(host); end

  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:145
  def check_path(path); end

  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:150
  def check_scheme(scheme); end

  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:199
  def parse_query_params(query); end

  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:158
  def set_model_components(path, validate = T.unsafe(nil)); end

  # @raise [URI::InvalidComponentError]
  #
  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:178
  def validate_component(component); end

  # @raise [InvalidModelIdError]
  #
  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:192
  def validate_model_id(model_id_part); end

  # @raise [MissingModelIdError]
  #
  # source://globalid-1.4.0/lib/global_id/uri/gid.rb:185
  ...
  class << self
    ...
    #
    # source://globalid-1.4.0/lib/global_id/uri/gid.rb:92
    def build(args); end
    ...
    #
    # source://globalid-1.4.0/lib/global_id/uri/gid.rb:76
    ...
    #
    # source://globalid-1.4.0/lib/global_id/uri/gid.rb:68
    def parse(uri); end
    ...
    #
    # source://globalid-1.4.0/lib/global_id/uri/gid.rb:52
    def validate_app(app); end
  end
end

# source://globalid-1.4.0/lib/global_id/uri/gid.rb:138
URI::GID::COMPONENT = T.let(T.unsafe(nil), Array)

# source://globalid-1.4.0/lib/global_id/uri/gid.rb:38
URI::GID::COMPOSITE_MODEL_ID_DELIMITER = T.let(T.unsafe(nil), String)

# Maximum size of a model id segment
#
# source://globalid-1.4.0/lib/global_id/uri/gid.rb:37
URI::GID::COMPOSITE_MODEL_ID_MAX_SIZE = T.let(T.unsafe(nil), Integer)

# source://globalid-1.4.0/lib/global_id/uri/gid.rb:34
...
#
# source://globalid-1.4.0/lib/global_id/uri/gid.rb:33
class URI::GID::MissingModelIdError < ::URI::InvalidComponentError; end

# source://globalid-1.4.0/lib/global_id/uri/gid.rb:40
