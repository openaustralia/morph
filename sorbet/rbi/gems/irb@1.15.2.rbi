...
#
# source://irb-1.15.2/lib/irb/notifier.rb:11
module IRB::Notifier
  private
  ...
  # formatting.
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:31
...
#
# source://irb-1.15.2/lib/irb/notifier.rb:39
class IRB::Notifier::AbstractNotifier
  # Creates a new Notifier object
  #
  # @return [AbstractNotifier] a new instance of AbstractNotifier
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:41
  ...
  # @yield [@base_notifier]
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:99
  def exec_if; end
  ...
  # @return [Boolean]
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:53
  def notify?; end
  ...
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:82
  def pp(*objs); end
  ...
  # See OutputMethod#ppx for more detail.
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:92
  def ppx(prefix, *objs); end

  # The +prefix+ for this Notifier, which is appended to all objects being
  # inspected during output.
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:48
  def prefix; end

  # See OutputMethod#print for more detail.
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:58
  def print(*opts); end

  # See OutputMethod#printf for more detail.
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:68
  def printf(format, *opts); end

  # See OutputMethod#printn for more detail.
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:63
  def printn(*opts); end

  # See OutputMethod#puts for more detail.
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:73
  def puts(*objs); end
end
...
# #def_notifier.
#
# source://irb-1.15.2/lib/irb/notifier.rb:116
class IRB::Notifier::CompositeNotifier < ::IRB::Notifier::AbstractNotifier
  ...
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:117
  def initialize(prefix, base_notifier); end
  ...
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:133
  def def_notifier(level, prefix = T.unsafe(nil)); end

  # Returns the leveled notifier for this object
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:140
  def level; end
  ...
  # AbstractNotifier
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:157
  def level=(value); end
...
#
# source://irb-1.15.2/lib/irb/notifier.rb:175
class IRB::Notifier::LeveledNotifier < ::IRB::Notifier::AbstractNotifier
  ...
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:184
  ...
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:197
  def <=>(other); end

  # The current level of this notifier object
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:191
  def level; end
  ...
  # @return [Boolean]
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:203
  def notify?; end
end
...
#
# source://irb-1.15.2/lib/irb/notifier.rb:214
class IRB::Notifier::NoMsgNotifier < ::IRB::Notifier::LeveledNotifier
  ...
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:215
  def initialize; end
  ...
  # @return [Boolean]
  #
  # source://irb-1.15.2/lib/irb/notifier.rb:223
  def notify?; end
end
