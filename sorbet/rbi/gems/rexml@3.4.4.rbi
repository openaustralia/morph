...
#
# source://rexml-3.4.4/lib/rexml/attlistdecl.rb:18
class REXML::AttlistDecl < ::REXML::Child
  ...
  #
  # source://rexml-3.4.4/lib/rexml/attlistdecl.rb:29
  def initialize(source); end

  # Access the attlist attribute/value pairs.
  #  value = attlist_decl[ attribute_name ]
  #
  # source://rexml-3.4.4/lib/rexml/attlistdecl.rb:38
  def [](key); end

  # Iterate over the key/value pairs:
  #  attlist_decl.each { |attribute_name, attribute_value| ... }
  #
  # source://rexml-3.4.4/lib/rexml/attlistdecl.rb:50
  def each(&block); end

  # What is this?  Got me.
  #
  # source://rexml-3.4.4/lib/rexml/attlistdecl.rb:22
  ...
  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/attlistdecl.rb:44
  def include?(key); end

  # source://rexml-3.4.4/lib/rexml/attlistdecl.rb:59
  def node_type; end

  # Write out exactly what we got in.
  #
  # source://rexml-3.4.4/lib/rexml/attlistdecl.rb:55
...
#
# source://rexml-3.4.4/lib/rexml/attribute.rb:10
class REXML::Attribute
  ...
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:42
  def initialize(first, second = T.unsafe(nil), parent = T.unsafe(nil)); end

  # Returns true if other is an Attribute and has the same name and value,
  # false otherwise.
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:106
  def ==(other); end

  # Returns a copy of this attribute
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:161
  def clone; end

  # source://rexml-3.4.4/lib/rexml/attribute.rb:132
  def doctype; end

  # source://rexml-3.4.4/lib/rexml/attribute.rb:205
  def document; end

  # The element to which this attribute belongs
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:15
  def element; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:169
  def element=(element); end

  # Creates (and returns) a hash from both the name and value
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:111
  def hash; end

  # source://rexml-3.4.4/lib/rexml/attribute.rb:195
  def inspect; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:95
  def namespace(arg = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/attribute.rb:191
  def node_type; end

  # The normalized value of this attribute.  That is, the attribute with
  # entities intact.
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:155
  ...
  #  a.prefix                                   # -> ""
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:70
  def prefix; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:182
  def remove; end

  # Returns the attribute value, with entities replaced
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:137
  def to_s; end
  ...
  #  b.to_string     # -> "ns:x='y'"
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:121
  def to_string; end

  # Returns the UNNORMALIZED value of this attribute.  That is, entities
  # have been expanded to their values
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:146
  def value; end

  # Writes this attribute (EG, puts 'key="value"' to the output)
  #
  # source://rexml-3.4.4/lib/rexml/attribute.rb:187
  def write(output, indent = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/attribute.rb:201
  def xpath; end
end
...
#
# source://rexml-3.4.4/lib/rexml/element.rb:2131
class REXML::Attributes < ::Hash
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2150
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2516
  def <<(attribute); end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2175
  def [](name); end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2358
  def []=(name, value); end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2471
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2538
  ...
  #   ["att", "<"]
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2276
  def each; end
  ...
  #   [REXML::Attribute, att='&lt;']
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2243
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2302
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2564
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2214
  def length; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2426
  def namespaces; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2400
  def prefixes; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2196
  def to_a; end
end

# source://rexml-3.4.4/lib/rexml/cdata.rb:5
class REXML::CData < ::REXML::Text
  ...
  #
  # source://rexml-3.4.4/lib/rexml/cdata.rb:16
  ...
  #  d.to_s        # -> "Some text"
  #
  # source://rexml-3.4.4/lib/rexml/cdata.rb:26
  def clone; end
  ...
  #  c.to_s        # -> "Some text"
  #
  # source://rexml-3.4.4/lib/rexml/cdata.rb:35
  def to_s; end

  # source://rexml-3.4.4/lib/rexml/cdata.rb:39
  def value; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/cdata.rb:60
...
# class directly.
#
# source://rexml-3.4.4/lib/rexml/child.rb:9
class REXML::Child
  include ::REXML::Node
  ...
  #
  # source://rexml-3.4.4/lib/rexml/child.rb:18
  def initialize(parent = T.unsafe(nil)); end

  # This doesn't yet handle encodings
  #
  # source://rexml-3.4.4/lib/rexml/child.rb:90
  def bytes; end

  # Returns:: the document this child belongs to, or nil if this child
  # belongs to no document
  #
  # source://rexml-3.4.4/lib/rexml/child.rb:85
  def document; end

  # source://rexml-3.4.4/lib/rexml/node.rb:11
  ...
  #  # => <a><b/><c/></a>
  #
  # source://rexml-3.4.4/lib/rexml/child.rb:68
  def next_sibling=(other); end

  # The Parent of this object
  #
  # source://rexml-3.4.4/lib/rexml/child.rb:11
  def parent; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/child.rb:52
  def parent=(other); end

  # source://rexml-3.4.4/lib/rexml/node.rb:17
  ...
  #  # => <a><b/><c/></a>
  #
  # source://rexml-3.4.4/lib/rexml/child.rb:79
  ...
  # Returns:: self
  #
  # source://rexml-3.4.4/lib/rexml/child.rb:37
  def remove; end
  ...
  # Returns:: self
  #
  # source://rexml-3.4.4/lib/rexml/child.rb:29
  def replace_with(child); end
end

# Represents an XML comment; that is, text between \<!-- ... -->
#
# source://rexml-3.4.4/lib/rexml/comment.rb:7
class REXML::Comment < ::REXML::Child
  ...
  #
  # source://rexml-3.4.4/lib/rexml/comment.rb:24
  def initialize(first, second = T.unsafe(nil)); end

  # Compares this Comment to another; the contents of the comment are used
  # in the comparison.
  #
  # source://rexml-3.4.4/lib/rexml/comment.rb:63
  def <=>(other); end

  # Compares this Comment to another; the contents of the comment are used
  # in the comparison.
  #
  # source://rexml-3.4.4/lib/rexml/comment.rb:70
  def ==(other); end

  # source://rexml-3.4.4/lib/rexml/comment.rb:33
  def clone; end

  # source://rexml-3.4.4/lib/rexml/comment.rb:75
  def node_type; end

  # The content text
  #
  # source://rexml-3.4.4/lib/rexml/comment.rb:14
  def string; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/comment.rb:50
  def write(output, indent = T.unsafe(nil), transitive = T.unsafe(nil), ie_hack = T.unsafe(nil)); end
end

# source://rexml-3.4.4/lib/rexml/xpath_parser.rb:11
module REXML::DClonable; end

# This is an abstract class.  You never use this directly; it serves as a
# parent class for the specific declarations.
#
# source://rexml-3.4.4/lib/rexml/doctype.rb:238
class REXML::Declaration < ::REXML::Child
  # @return [Declaration] a new instance of Declaration
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:239
  def initialize(src); end

  # source://rexml-3.4.4/lib/rexml/doctype.rb:244
  def to_s; end

  # == DEPRECATED
  # See REXML::Formatters
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:251
...
#
# source://rexml-3.4.4/lib/rexml/doctype.rb:51
class REXML::DocType < ::REXML::Parent
  ...
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:80
  def initialize(first, parent = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/doctype.rb:181
  def add(child); end

  # source://rexml-3.4.4/lib/rexml/doctype.rb:125
  def attribute_of(element, attribute); end

  # source://rexml-3.4.4/lib/rexml/doctype.rb:115
  def attributes_of(element); end

  # source://rexml-3.4.4/lib/rexml/doctype.rb:135
  def clone; end

  # source://rexml-3.4.4/lib/rexml/doctype.rb:173
  def context; end

  # name is the name of the doctype
  # external_id is the referenced DTD, if given
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:66
  def entities; end

  # source://rexml-3.4.4/lib/rexml/doctype.rb:177
  def entity(name); end
  ...
  # source://rexml-3.4.4/lib/rexml/doctype.rb:111
  def node_type; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:225
  ...
  # Method contributed by Henrik Martensson
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:217
  def notations; end
  ...
  # Method contributed by Henrik Martensson
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:191
  def public; end
  ...
  # Method contributed by Henrik Martensson
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:203
  def system; end
  ...
  #   Ignored
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:149
  def write(output, indent = T.unsafe(nil), transitive = T.unsafe(nil), ie_hack = T.unsafe(nil)); end
end
...
#
# source://rexml-3.4.4/lib/rexml/document.rb:39
class REXML::Document < ::REXML::Element
  ...
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:92
  ...
  #   d.to_s # => "<foo/>"
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:174
  def <<(child); end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:213
  ...
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:124
  def clone; end
  ...
  #   d.doctype.class # => nil
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:245
  def doctype; end

  # source://rexml-3.4.4/lib/rexml/document.rb:448
  def document; end
  ...
  #   d.encoding # => "UTF-8"
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:294
  def encoding; end

  # Returns the value of attribute entity_expansion_count.
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:437
  ...
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:133
  ...
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:114
  def node_type; end

  # source://rexml-3.4.4/lib/rexml/document.rb:441
  ...
  #   d.root # => nil
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:229
  def root; end
  ...
  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:309
  def stand_alone?; end
  ...
  #   d.version # => "1.0"
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:279
  def version; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:369
  ...
  #   d.xml_decl.to_s  # => ""
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:262
  def xml_decl; end

  private

  # source://rexml-3.4.4/lib/rexml/document.rb:467
  ...
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:458
  def enable_cache; end

  # Returns the value of attribute namespaces_cache.
  #
  # source://rexml-3.4.4/lib/rexml/document.rb:454
  ...
  class << self
    # source://rexml-3.4.4/lib/rexml/document.rb:419
    def entity_expansion_limit; end

    # source://rexml-3.4.4/lib/rexml/document.rb:412
    def entity_expansion_limit=(val); end

    # source://rexml-3.4.4/lib/rexml/document.rb:433
    def entity_expansion_text_limit; end

    # source://rexml-3.4.4/lib/rexml/document.rb:426
    def entity_expansion_text_limit=(val); end

    # source://rexml-3.4.4/lib/rexml/document.rb:405
...
#
# source://rexml-3.4.4/lib/rexml/element.rb:271
class REXML::Element < ::REXML::Parent
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:319
  ...
  #   root[:nosuch] # => nil
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1238
  ...
  #   e['attr'] # => "VALUE"
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1336
  ...
  #   e.add_attributes(a)
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1367
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:725
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:648
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1139
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1279
  def attribute(name, namespace = T.unsafe(nil)); end

  # Mechanisms for accessing attributes and child elements of this
  # element.
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:278
  def attributes; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1411
  def cdatas; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:383
  def clone; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1432
  def comments; end

  # The context holds information about the processing environment, such as
  # whitespace handling.
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:281
  def context; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1386
  ...
  #   a.delete_element('//c') # => nil
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:771
  ...
  #   d.to_s # => "<a/>"
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:680
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:475
  def document; end
  ...
  #   <e/>
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:923
  ...
  #   <d id='1'/>
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:840
  ...
  #   <c> ... </>
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:897
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:942
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1045
  ...
  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1306
  ...
  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:787
  ...
  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:995
  def has_text?; end
  ...
  # See {Element Context}[../doc/rexml/context_rdoc.html].
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:512
  ...
  #   e.inspect # => "<foo bar='0' baz='1'> ... </>"
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:358
  def inspect; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1453
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:619
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:590
  def namespaces; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:956
  ...
  #   a.node_type # => :element
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1160
  def node_type; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:564
  def prefixes; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:972
  ...
  # sensitive.
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:532
  def raw; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:443
  def root; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:422
  def root_node; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1023
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1081
  def text=(text); end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1469
  def texts; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:489
  def whitespace; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1495
  def write(output = T.unsafe(nil), indent = T.unsafe(nil), transitive = T.unsafe(nil), ie_hack = T.unsafe(nil)); end
  ...
  #   e.xpath    # => "foo"
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1184
  def xpath; end

  private

  # source://rexml-3.4.4/lib/rexml/element.rb:1519
  def __to_xpath_helper(node); end

  # source://rexml-3.4.4/lib/rexml/element.rb:1511
  def calculate_namespaces; end

  # A private helper method
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1534
  def each_with_something(test, max = T.unsafe(nil), name = T.unsafe(nil)); end
end

# source://rexml-3.4.4/lib/rexml/doctype.rb:257
class REXML::ElementDecl < ::REXML::Declaration
  # @return [ElementDecl] a new instance of ElementDecl
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:258
  def initialize(src); end
end
...
#
# source://rexml-3.4.4/lib/rexml/element.rb:1589
class REXML::Elements
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1602
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1915
  ...
  #   eles[5, 'book'] # => nil
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1674
  ...
  #   eles.size # => 5
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1725
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1978
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1815
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1841
  ...
  #   <book category='web' cover='paperback'> ... </>
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1957
  ...
  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1745
  def empty?; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1763
  def index(element); end
  ...
  #   end # => 26
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2063
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:1617
  def parent; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2087
  def size; end
  ...
  #   elements.to_a('//c') # => [<c/>]
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2111
  ...
  #
  # source://rexml-3.4.4/lib/rexml/element.rb:2119
  def literalize(name); end
end

# source://rexml-3.4.4/lib/rexml/encoding.rb:4
module REXML::Encoding
  # source://rexml-3.4.4/lib/rexml/encoding.rb:26
  def decode(string); end

  # source://rexml-3.4.4/lib/rexml/encoding.rb:22
  def encode(string); end

  # ID ---> Encoding name
  #
  # source://rexml-3.4.4/lib/rexml/encoding.rb:6
  def encoding; end

  # source://rexml-3.4.4/lib/rexml/encoding.rb:7
  def encoding=(encoding); end

  private

  # source://rexml-3.4.4/lib/rexml/encoding.rb:31
  def find_encoding(name); end
end

# source://rexml-3.4.4/lib/rexml/entity.rb:7
class REXML::Entity < ::REXML::Child
  ...
  #
  # source://rexml-3.4.4/lib/rexml/entity.rb:34
  def initialize(stream, value = T.unsafe(nil), parent = T.unsafe(nil), reference = T.unsafe(nil)); end

  # Returns the value of attribute external.
  #
  # source://rexml-3.4.4/lib/rexml/entity.rb:23
  def external; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/entity.rb:86
  def normalized; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/entity.rb:120
  def to_s; end

  # Evaluates to the unnormalized value of this entity; that is, replacing
  # &ent; entities.
  #
  # source://rexml-3.4.4/lib/rexml/entity.rb:73
  ...
  #
  # source://rexml-3.4.4/lib/rexml/entity.rb:98
  def write(out, indent = T.unsafe(nil)); end

  class << self
    # source://rexml-3.4.4/lib/rexml/entity.rb:67
    def matches?(string); end
  end
end

# source://rexml-3.4.4/lib/rexml/doctype.rb:263
class REXML::ExternalEntity < ::REXML::Child
  # @return [ExternalEntity] a new instance of ExternalEntity
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:264
  def initialize(src); end

  # source://rexml-3.4.4/lib/rexml/doctype.rb:268
  def to_s; end

  # source://rexml-3.4.4/lib/rexml/doctype.rb:271
  def write(output, indent); end
end

# source://rexml-3.4.4/lib/rexml/formatters/default.rb:5
class REXML::Formatters::Default
  ...
  #
  # source://rexml-3.4.4/lib/rexml/formatters/default.rb:12
  ...
  #
  # source://rexml-3.4.4/lib/rexml/formatters/default.rb:23
  def write(node, output); end

  protected

  # source://rexml-3.4.4/lib/rexml/formatters/default.rb:98
  def write_cdata(node, output); end

  # source://rexml-3.4.4/lib/rexml/formatters/default.rb:92
  def write_comment(node, output); end

  # source://rexml-3.4.4/lib/rexml/formatters/default.rb:61
  def write_document(node, output); end

  # source://rexml-3.4.4/lib/rexml/formatters/default.rb:65
  def write_element(node, output); end

  # source://rexml-3.4.4/lib/rexml/formatters/default.rb:104
  def write_instruction(node, output); end

  # source://rexml-3.4.4/lib/rexml/formatters/default.rb:88
...
#
# source://rexml-3.4.4/lib/rexml/formatters/pretty.rb:10
class REXML::Formatters::Pretty < ::REXML::Formatters::Default
  ...
  #
  # source://rexml-3.4.4/lib/rexml/formatters/pretty.rb:30
  def initialize(indentation = T.unsafe(nil), ie_hack = T.unsafe(nil)); end

  # If compact is set to true, then the formatter will attempt to use as
  # little space as possible
  #
  # source://rexml-3.4.4/lib/rexml/formatters/pretty.rb:14
  def compact; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/formatters/pretty.rb:16
  def width; end
  ...
  # source://rexml-3.4.4/lib/rexml/formatters/pretty.rb:102
  def write_cdata(node, output); end

  # source://rexml-3.4.4/lib/rexml/formatters/pretty.rb:97
  def write_comment(node, output); end

  # source://rexml-3.4.4/lib/rexml/formatters/pretty.rb:107
  def write_document(node, output); end

  # source://rexml-3.4.4/lib/rexml/formatters/pretty.rb:39
  def write_element(node, output); end

  # source://rexml-3.4.4/lib/rexml/formatters/pretty.rb:88
  def write_text(node, output); end

  private

  # source://rexml-3.4.4/lib/rexml/formatters/pretty.rb:124
  def indent_text(string, level = T.unsafe(nil), style = T.unsafe(nil), indentfirstline = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/formatters/pretty.rb:129
...
# documentation
#
# source://rexml-3.4.4/lib/rexml/source.rb:221
class REXML::IOSource < ::REXML::Source
  # block_size has been deprecated
  #
  # @return [IOSource] a new instance of IOSource
  #
  # source://rexml-3.4.4/lib/rexml/source.rb:224
  def initialize(arg, block_size = T.unsafe(nil), encoding = T.unsafe(nil)); end

  # @return the current line in the source
  #
  # source://rexml-3.4.4/lib/rexml/source.rb:329
  def current_line; end

  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/source.rb:324
  def empty?; end

  # source://rexml-3.4.4/lib/rexml/source.rb:284
  def ensure_buffer; end

  # source://rexml-3.4.4/lib/rexml/source.rb:288
  def match(pattern, cons = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/source.rb:307
  def match?(pattern, cons = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/source.rb:245
  def read(term = T.unsafe(nil), min_bytes = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/source.rb:266
  def read_until(term); end

  private

  # source://rexml-3.4.4/lib/rexml/source.rb:376
  def encoding_updated; end

  # source://rexml-3.4.4/lib/rexml/source.rb:351
...
#
# source://rexml-3.4.4/lib/rexml/instruction.rb:9
class REXML::Instruction < ::REXML::Child
  ...
  #
  # source://rexml-3.4.4/lib/rexml/instruction.rb:25
  ...
  #
  # source://rexml-3.4.4/lib/rexml/instruction.rb:65
  def ==(other); end

  # source://rexml-3.4.4/lib/rexml/instruction.rb:44
  def clone; end

  # target is the "name" of the Instruction; IE, the "tag" in <?tag ...?>
  # content is everything else.
  #
  # source://rexml-3.4.4/lib/rexml/instruction.rb:15
  def content; end
  ...
  # source://rexml-3.4.4/lib/rexml/instruction.rb:75
  def inspect; end

  # source://rexml-3.4.4/lib/rexml/instruction.rb:71
  def node_type; end
  ...
  # See the rexml/formatters package
  #
  # source://rexml-3.4.4/lib/rexml/instruction.rb:51
  def write(writer, indent = T.unsafe(nil), transitive = T.unsafe(nil), ie_hack = T.unsafe(nil)); end
end

# source://rexml-3.4.4/lib/rexml/light/node.rb:5
...
# children.
#
# source://rexml-3.4.4/lib/rexml/light/node.rb:9
class REXML::Light::Node
  # Create a new element.
  #
  # @return [Node] a new instance of Node
  #
  # source://rexml-3.4.4/lib/rexml/light/node.rb:13
  ...
  #
  # source://rexml-3.4.4/lib/rexml/light/node.rb:114
  def <<(element); end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:90
  def =~(path); end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:78
  def [](reference, ns = T.unsafe(nil)); end

  # Doesn't handle namespaces yet
  #
  # source://rexml-3.4.4/lib/rexml/light/node.rb:95
  def []=(reference, ns, value = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:143
  def children; end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:36
  def each; end

  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/light/node.rb:139
  def has_name?(name, namespace = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:54
  def local_name; end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:59
  def local_name=(name_str); end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:40
  def name; end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:44
  def name=(name_str, ns = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:67
  def namespace(prefix = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:71
  def namespace=(namespace); end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:125
  def node_type; end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:147
  def parent; end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:50
  def parent=(node); end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:63
  def prefix(namespace = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:134
  def root; end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:28
  def size; end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:129
  def text=(foo); end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:151
  def to_s; end

  private

  # source://rexml-3.4.4/lib/rexml/light/node.rb:164
  def namespace_of(node, prefix = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:157
  def namesplit; end

  # source://rexml-3.4.4/lib/rexml/light/node.rb:176
  def prefix_of(node, namespace = T.unsafe(nil)); end
end

# source://rexml-3.4.4/lib/rexml/light/node.rb:10
REXML::Light::Node::NAMESPLIT = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/light/node.rb:11
REXML::Light::Node::PARENTS = T.let(T.unsafe(nil), Array)

# Adds named attributes to an object.
#
# source://rexml-3.4.4/lib/rexml/namespace.rb:7
module REXML::Namespace
  include ::REXML::XMLTokens

  # The name of the object, valid if set
  #
  # source://rexml-3.4.4/lib/rexml/namespace.rb:9
  def expanded_name; end

  # Fully expand the name, even if the prefix wasn't specified in the
  # source file.
  #
  # source://rexml-3.4.4/lib/rexml/namespace.rb:57
  ...
  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/namespace.rb:43
  ...
  #
  # source://rexml-3.4.4/lib/rexml/namespace.rb:17
  def name=(name); end

  # The expanded name of the object, valid if name is set
  #
  # source://rexml-3.4.4/lib/rexml/namespace.rb:11
  def prefix; end
...
# source://rexml-3.4.4/lib/rexml/namespace.rb:13
REXML::Namespace::NAME_WITHOUT_NAMESPACE = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/doctype.rb:276
class REXML::NotationDecl < ::REXML::Child
  # @return [NotationDecl] a new instance of NotationDecl
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:278
  ...
  # Method contributed by Henrik Martensson
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:302
  def name; end

  # Returns the value of attribute public.
  #
  # source://rexml-3.4.4/lib/rexml/doctype.rb:277
  def public; end
  ...
  # source://rexml-3.4.4/lib/rexml/doctype.rb:286
  def to_s; end

  # source://rexml-3.4.4/lib/rexml/doctype.rb:295
  def write(output, indent = T.unsafe(nil)); end
end

# source://rexml-3.4.4/lib/rexml/output.rb:5
class REXML::Output
  include ::REXML::Encoding

  # @return [Output] a new instance of Output
  #
  # source://rexml-3.4.4/lib/rexml/output.rb:10
  def initialize(real_IO, encd = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/output.rb:22
  def <<(content); end

  # Returns the value of attribute encoding.
  #
  # source://rexml-3.4.4/lib/rexml/output.rb:8
  def encoding; end

  # source://rexml-3.4.4/lib/rexml/output.rb:26
  def to_s; end
end
...
# object.
#
# source://rexml-3.4.4/lib/rexml/parent.rb:8
class REXML::Parent < ::REXML::Child
  ...
  #
  # source://rexml-3.4.4/lib/rexml/parent.rb:13
  def initialize(parent = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/parent.rb:18
  def <<(object); end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/parent.rb:57
  def [](index); end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/parent.rb:70
  def []=(*args); end

  # source://rexml-3.4.4/lib/rexml/parent.rb:18
  def add(object); end

  # source://rexml-3.4.4/lib/rexml/parent.rb:115
  def children; end

  # Deeply clones this object.  This creates a complete duplicate of this
  # Parent, including all descendants.
  #
  # source://rexml-3.4.4/lib/rexml/parent.rb:148
  def deep_clone; end

  # source://rexml-3.4.4/lib/rexml/parent.rb:32
  def delete(object); end

  # source://rexml-3.4.4/lib/rexml/parent.rb:47
  def delete_at(index); end

  # source://rexml-3.4.4/lib/rexml/parent.rb:43
  def delete_if(&block); end

  # source://rexml-3.4.4/lib/rexml/parent.rb:39
  def each(&block); end

  # source://rexml-3.4.4/lib/rexml/parent.rb:39
  def each_child(&block); end

  # source://rexml-3.4.4/lib/rexml/parent.rb:51
  ...
  #
  # source://rexml-3.4.4/lib/rexml/parent.rb:123
  def index(child); end
  ...
  # @return the parent (self)
  #
  # source://rexml-3.4.4/lib/rexml/parent.rb:102
  ...
  # @return the parent (self)
  #
  # source://rexml-3.4.4/lib/rexml/parent.rb:82
  def insert_before(child1, child2); end

  # @return the number of children of this parent
  #
  # source://rexml-3.4.4/lib/rexml/parent.rb:130
  def length; end

  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/parent.rb:162
  def parent?; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/parent.rb:140
  ...
  # source://rexml-3.4.4/lib/rexml/parent.rb:27
  def unshift(object); end
end

# source://rexml-3.4.4/lib/rexml/parseexception.rb:3
class REXML::ParseException < ::RuntimeError
  # @return [ParseException] a new instance of ParseException
  #
  # source://rexml-3.4.4/lib/rexml/parseexception.rb:6
  def initialize(message, source = T.unsafe(nil), parser = T.unsafe(nil), exception = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/parseexception.rb:49
  def context; end

  # Returns the value of attribute continued_exception.
  #
  # source://rexml-3.4.4/lib/rexml/parseexception.rb:4
  ...
  # source://rexml-3.4.4/lib/rexml/parseexception.rb:44
  def line; end
  ...
  # source://rexml-3.4.4/lib/rexml/parseexception.rb:39
  def position; end
  ...
  # source://rexml-3.4.4/lib/rexml/parseexception.rb:13
  def to_s; end
end
...
#
# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:57
class REXML::Parsers::BaseParser
  # @return [BaseParser] a new instance of BaseParser
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:164
  def initialize(source); end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:175
  ...
  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:210
  def empty?; end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:537
  def entity(reference, entities); end

  # Returns the value of attribute entity_expansion_count.
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:180
  def entity_expansion_count; end
  ...
  # @param value the value to set the attribute entity_expansion_limit to.
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:181
  def entity_expansion_limit=(_arg0); end
  ...
  # @param value the value to set the attribute entity_expansion_text_limit to.
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:182
  def entity_expansion_text_limit=(_arg0); end
  ...
  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:215
  def has_next?; end

  # Escapes all possible entities
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:548
  ...
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:231
  def peek(depth = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:200
  def position; end

  # Returns the next event.  This is a +PullEvent+ object.
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:246
  def pull; end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:189
  def reset; end

  # Returns the value of attribute source.
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:179
  def source; end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:184
  def stream=(source); end

  # Unescapes all possible entities
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:564
  def unnormalize(string, entities = T.unsafe(nil), filter = T.unsafe(nil)); end

  # Push an event back on the head of the stream.  This method
  # has (theoretically) infinite depth.
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:221
  def unshift(token); end

  private

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:613
  def add_namespace(prefix, uri); end

  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:646
  def need_source_encoding_update?(xml_declaration_encoding); end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:652
  def normalize_xml_declaration_encoding(xml_declaration_encoding); end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:849
  def parse_attribute_value_with_equal(name); end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:868
  def parse_attributes(prefixes); end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:669
  def parse_id(base_error_message, accept_external_id:, accept_public_id:); end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:697
  def parse_id_invalid_details(accept_external_id:, accept_public_id:); end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:656
  def parse_name(base_error_message); end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:628
  def pop_namespaces_restore; end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:735
  def process_comment; end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:747
  def process_instruction; end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:256
  def pull_event; end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:622
  def push_namespaces_restore; end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:639
  def record_entity_expansion(delta = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:831
  def scan_quote; end

  # source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:769
  def xml_declaration; end
end

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:130
REXML::Parsers::BaseParser::EXTERNAL_ID_PUBLIC = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:131
REXML::Parsers::BaseParser::EXTERNAL_ID_SYSTEM = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:132
REXML::Parsers::BaseParser::PUBLIC_ID = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:143
module REXML::Parsers::BaseParser::Private; end

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:148
REXML::Parsers::BaseParser::Private::ATTLISTDECL_END = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:153
REXML::Parsers::BaseParser::Private::CARRIAGE_RETURN_NEWLINE_PATTERN = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:154
REXML::Parsers::BaseParser::Private::CHARACTER_REFERENCES = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:146
REXML::Parsers::BaseParser::Private::CLOSE_PATTERN = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:155
REXML::Parsers::BaseParser::Private::DEFAULT_ENTITIES_PATTERNS = T.let(T.unsafe(nil), Hash)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:152
REXML::Parsers::BaseParser::Private::ENTITYDECL_PATTERN = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:147
REXML::Parsers::BaseParser::Private::EQUAL_PATTERN = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:150
REXML::Parsers::BaseParser::Private::GEDECL_PATTERN = T.let(T.unsafe(nil), String)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:149
REXML::Parsers::BaseParser::Private::NAME_PATTERN = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:151
REXML::Parsers::BaseParser::Private::PEDECL_PATTERN = T.let(T.unsafe(nil), String)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:144
REXML::Parsers::BaseParser::Private::PEREFERENCE_PATTERN = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:145
REXML::Parsers::BaseParser::Private::TAG_PATTERN = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:160
REXML::Parsers::BaseParser::Private::XML_PREFIXED_NAMESPACE = T.let(T.unsafe(nil), String)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:66
REXML::Parsers::BaseParser::QNAME = T.let(T.unsafe(nil), Regexp)

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:65
REXML::Parsers::BaseParser::QNAME_STR = T.let(T.unsafe(nil), String)

# source://rexml-3.4.4/lib/rexml/parsers/streamparser.rb:6
class REXML::Parsers::StreamParser
  # @return [StreamParser] a new instance of StreamParser
  #
  # source://rexml-3.4.4/lib/rexml/parsers/streamparser.rb:7
  def initialize(source, listener); end

  # source://rexml-3.4.4/lib/rexml/parsers/streamparser.rb:13
  def add_listener(listener); end

  # source://rexml-3.4.4/lib/rexml/parsers/streamparser.rb:17
  def entity_expansion_count; end

  # source://rexml-3.4.4/lib/rexml/parsers/streamparser.rb:21
  def entity_expansion_limit=(limit); end

  # source://rexml-3.4.4/lib/rexml/parsers/streamparser.rb:25
  def entity_expansion_text_limit=(limit); end

  # source://rexml-3.4.4/lib/rexml/parsers/streamparser.rb:29
  def parse; end
end

# source://rexml-3.4.4/lib/rexml/parsers/baseparser.rb:28
module REXML::Parsers::StringScannerCaptures; end

# source://rexml-3.4.4/lib/rexml/parsers/treeparser.rb:7
class REXML::Parsers::TreeParser
  # @return [TreeParser] a new instance of TreeParser
  #
  # source://rexml-3.4.4/lib/rexml/parsers/treeparser.rb:8
  def initialize(source, build_context = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/parsers/treeparser.rb:13
  def add_listener(listener); end

  # source://rexml-3.4.4/lib/rexml/parsers/treeparser.rb:17
  def parse; end
end
...
#
# source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:12
class REXML::Parsers::XPathParser
  include ::REXML::XMLTokens

  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:42
  def abbreviate(path_or_parsed); end

  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:132
  def expand(path_or_parsed); end

  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:16
  def namespaces=(namespaces); end

  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:21
  def parse(path); end

  # For backward compatibility
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:174
  def preciate_to_string(parsed, &block); end

  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:36
  ...
  # | MultiplicativeExpr
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:505
  def AdditiveExpr(path, parsed); end

  # | AndExpr S 'and' S EqualityExpr
  # | EqualityExpr
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:438
  def AndExpr(path, parsed); end

  # | EqualityExpr ('=' | '!=')  RelationalExpr
  # | RelationalExpr
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:457
  def EqualityExpr(path, parsed); end

  # | FilterExpr Predicate
  # | PrimaryExpr
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:608
  def FilterExpr(path, parsed); end

  # | FUNCTION_NAME '(' ( expr ( ',' expr )* )? ')'
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:663
  ...
  #  | '//' RelativeLocationPath
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:243
  def LocationPath(path, parsed); end

  # | MultiplicativeExpr ('*' | S ('div' | 'mod') S) UnaryExpr
  # | UnaryExpr
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:528
  def MultiplicativeExpr(path, parsed); end

  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:343
  def NodeTest(path, parsed); end

  # | OrExpr S 'or' S AndExpr
  # | AndExpr
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:419
  def OrExpr(path, parsed); end

  # | LocationPath
  # | FilterExpr ('/' | '//') RelativeLocationPath
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:590
  def PathExpr(path, parsed); end

  # Filters the supplied nodeset on the predicate(s)
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:395
  def Predicate(path, parsed); end

  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:626
  def PrimaryExpr(path, parsed); end

  # | RelationalExpr ('<' | '>' | '<=' | '>=') AdditiveExpr
  # | AdditiveExpr
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:480
  def RelationalExpr(path, parsed); end

  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:267
  def RelativeLocationPath(path, parsed); end

  # | '-' UnaryExpr
  # | UnionExpr
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:553
  def UnaryExpr(path, parsed); end

  # | UnionExpr '|' PathExpr
  # | PathExpr
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:571
  def UnionExpr(path, parsed); end

  # get_group( '[foo]bar' ) -> ['bar', '[foo]']
  #
  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:676
  def get_group(string); end

  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:694
  def parse_args(string); end

  # source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:224
  def quote_literal(literal); end
end

# source://rexml-3.4.4/lib/rexml/parsers/xpathparser.rb:339
...
#
# source://rexml-3.4.4/lib/rexml/source.rb:61
class REXML::Source
  include ::REXML::Encoding
  ...
  #
  # source://rexml-3.4.4/lib/rexml/source.rb:88
  def initialize(arg, encoding = T.unsafe(nil)); end

  # The current buffer (what we're going to read next)
  #
  # source://rexml-3.4.4/lib/rexml/source.rb:101
  def buffer; end

  # source://rexml-3.4.4/lib/rexml/source.rb:111
  def buffer_encoding=(encoding); end

  # @return the current line in the source
  #
  # source://rexml-3.4.4/lib/rexml/source.rb:180
  def current_line; end

  # source://rexml-3.4.4/lib/rexml/source.rb:105
  def drop_parsed_content; end

  # @return [Boolean] true if the Source is exhausted
  #
  # source://rexml-3.4.4/lib/rexml/source.rb:175
  def empty?; end

  # Returns the value of attribute encoding.
  #
  # source://rexml-3.4.4/lib/rexml/source.rb:65
  def encoding; end

  # Inherited from Encoding
  # Overridden to support optimized en/decoding
  #
  # source://rexml-3.4.4/lib/rexml/source.rb:117
  def encoding=(enc); end

  # source://rexml-3.4.4/lib/rexml/source.rb:135
  def ensure_buffer; end

  # The line number of the last consumed text
  #
  # source://rexml-3.4.4/lib/rexml/source.rb:64
  def line; end

  # source://rexml-3.4.4/lib/rexml/source.rb:138
  def match(pattern, cons = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/source.rb:146
  def match?(pattern, cons = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/source.rb:166
  def peek_byte; end

  # source://rexml-3.4.4/lib/rexml/source.rb:158
  def position; end

  # source://rexml-3.4.4/lib/rexml/source.rb:162
  def position=(pos); end

  # source://rexml-3.4.4/lib/rexml/source.rb:122
  def read(term = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/source.rb:125
  def read_until(term); end

  # source://rexml-3.4.4/lib/rexml/source.rb:170
  def scan_byte; end

  # source://rexml-3.4.4/lib/rexml/source.rb:154
  def skip_spaces; end

  private

  # source://rexml-3.4.4/lib/rexml/source.rb:189
  def detect_encoding; end

  # source://rexml-3.4.4/lib/rexml/source.rb:207
  def encoding_updated; end
end

# source://rexml-3.4.4/lib/rexml/source.rb:67
module REXML::Source::Private; end

# source://rexml-3.4.4/lib/rexml/source.rb:70
REXML::Source::Private::PRE_DEFINED_TERM_PATTERNS = T.let(T.unsafe(nil), Hash)

# source://rexml-3.4.4/lib/rexml/source.rb:69
REXML::Source::Private::SCANNER_RESET_SIZE = T.let(T.unsafe(nil), Integer)

# source://rexml-3.4.4/lib/rexml/source.rb:68
REXML::Source::Private::SPACES_PATTERN = T.let(T.unsafe(nil), Regexp)

# Represents text nodes in an XML document
#
# source://rexml-3.4.4/lib/rexml/text.rb:11
class REXML::Text < ::REXML::Child
  ...
  #
  # source://rexml-3.4.4/lib/rexml/text.rb:79
  ...
  # 'text << "XXX" << "YYY"'.
  #
  # source://rexml-3.4.4/lib/rexml/text.rb:189
  def <<(to_append); end

  # +other+ a String or a Text
  # +returns+ the result of (to_s <=> arg.to_s)
  #
  # source://rexml-3.4.4/lib/rexml/text.rb:198
  def <=>(other); end

  # source://rexml-3.4.4/lib/rexml/text.rb:179
  def clone; end

  # source://rexml-3.4.4/lib/rexml/text.rb:202
  def doctype; end

  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/text.rb:174
  def empty?; end

  # source://rexml-3.4.4/lib/rexml/text.rb:271
  def indent_text(string, level = T.unsafe(nil), style = T.unsafe(nil), indentfirstline = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/text.rb:225
  def inspect; end

  # source://rexml-3.4.4/lib/rexml/text.rb:170
  def node_type; end

  # source://rexml-3.4.4/lib/rexml/text.rb:110
  def parent=(parent); end

  # If +raw+ is true, then REXML leaves the value alone
  #
  # source://rexml-3.4.4/lib/rexml/text.rb:21
  def raw; end
  ...
  #   u.to_s   #-> "sean russell"
  #
  # source://rexml-3.4.4/lib/rexml/text.rb:220
  def to_s; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/text.rb:242
  def value; end
  ...
  #   e[0].value = "<a>"    # <a>&lt;a&gt;</a>
  #
  # source://rexml-3.4.4/lib/rexml/text.rb:254
  def value=(val); end

  # source://rexml-3.4.4/lib/rexml/text.rb:260
  def wrap(string, width, addnewline = T.unsafe(nil)); end

  # == DEPRECATED
  # See REXML::Formatters
  #
  # source://rexml-3.4.4/lib/rexml/text.rb:288
  def write(writer, indent = T.unsafe(nil), transitive = T.unsafe(nil), ie_hack = T.unsafe(nil)); end
  ...
  #   puts ascOut
  #
  # source://rexml-3.4.4/lib/rexml/text.rb:318
  def write_with_substitution(out, input); end

  # FIXME
  # This probably won't work properly
  #
  # source://rexml-3.4.4/lib/rexml/text.rb:300
  def xpath; end

  private

  # source://rexml-3.4.4/lib/rexml/text.rb:331
  def clear_cache; end

  class << self
    # source://rexml-3.4.4/lib/rexml/text.rb:116
    def check(string, pattern, doctype = T.unsafe(nil)); end

    # source://rexml-3.4.4/lib/rexml/text.rb:401
    def expand(ref, doctype, filter); end

    # source://rexml-3.4.4/lib/rexml/text.rb:363
    def normalize(input, doctype = T.unsafe(nil), entity_filter = T.unsafe(nil)); end

    # source://rexml-3.4.4/lib/rexml/text.rb:337
    def read_with_substitution(input, illegal = T.unsafe(nil)); end

    # source://rexml-3.4.4/lib/rexml/text.rb:387
...
# source://rexml-3.4.4/lib/rexml/undefinednamespaceexception.rb:4
class REXML::UndefinedNamespaceException < ::REXML::ParseException
  # @return [UndefinedNamespaceException] a new instance of UndefinedNamespaceException
  #
  # source://rexml-3.4.4/lib/rexml/undefinednamespaceexception.rb:5
  def initialize(prefix, source, parser); end
end

# source://rexml-3.4.4/lib/rexml/validation/validationexception.rb:4
class REXML::Validation::ValidationException < ::RuntimeError
  # @return [ValidationException] a new instance of ValidationException
  #
  # source://rexml-3.4.4/lib/rexml/validation/validationexception.rb:5
  def initialize(msg); end
end

# NEEDS DOCUMENTATION
#
# source://rexml-3.4.4/lib/rexml/xmldecl.rb:8
class REXML::XMLDecl < ::REXML::Child
  include ::REXML::Encoding

  # @return [XMLDecl] a new instance of XMLDecl
  #
  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:20
  def initialize(version = T.unsafe(nil), encoding = T.unsafe(nil), standalone = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:56
  def ==(other); end

  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:39
  def clone; end

  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:102
  def dowrite; end

  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:76
  def encoding=(enc); end

  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:106
  def inspect; end

  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:69
  def node_type; end

  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:98
  def nowrite; end
  ...
  #
  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:17
  def stand_alone?; end
  ...
  #   Ignored
  #
  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:49
  def write(writer, indent = T.unsafe(nil), transitive = T.unsafe(nil), ie_hack = T.unsafe(nil)); end

  # Returns the value of attribute writeencoding.
  #
  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:18
  ...
  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:63
  def xmldecl(version, encoding, standalone); end

  private

  # source://rexml-3.4.4/lib/rexml/xmldecl.rb:111
  def content(enc); end

  class << self
    # source://rexml-3.4.4/lib/rexml/xmldecl.rb:92
    def default; end
  end
end
...
# @private
#
# source://rexml-3.4.4/lib/rexml/xpath_parser.rb:965
class REXML::XPathNode
  # @return [XPathNode] a new instance of XPathNode
  #
  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:967
  def initialize(node, context = T.unsafe(nil)); end

  # Returns the value of attribute context.
  #
  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:966
  def context; end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:976
  def position; end
...
# back while you still can!
#
# source://rexml-3.4.4/lib/rexml/xpath_parser.rb:54
class REXML::XPathParser
  include ::REXML::XMLTokens

  # @return [XPathParser] a new instance of XPathParser
  #
  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:60
  def initialize(strict: T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:107
  ...
  #
  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:116
  def first(path_stack, node); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:97
  def get_first(path, node); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:153
  def match(path_stack, node); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:69
  def namespaces=(namespaces = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:79
  def parse(path, node); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:102
  def predicate(path, node); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:74
  def variables=(vars = T.unsafe(nil)); end

  private

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:781
  def child(nodeset); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:922
  def compare(a, operator, b); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:687
  def descendant(nodeset, include_self); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:698
  def descendant_recursive(raw_node, new_nodeset, new_nodes, include_self); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:944
  def each_unnode(nodeset); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:646
  def enter(tag, *args); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:821
  def equality_relational_compare(set1, op, set2); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:596
  def evaluate_predicate(expression, nodesets); end

  # Expr takes a stack of path elements and a set of nodes (either a Parent
  # or an Array and returns an Array of matching nodes
  #
  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:186
  def expr(path_stack, nodeset, context = T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:587
  def filter_nodeset(nodeset); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:754
  def following(node); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:765
  ...
  #
  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:174
  def get_namespace(node, prefix); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:651
  def leave(tag, *args); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:771
  def next_sibling_node(node); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:488
  def node_test(path_stack, nodesets, any_type: T.unsafe(nil)); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:808
  def norm(b); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:896
  ...
  #
  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:717
  def preceding(node); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:739
  ...
  #
  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:664
  def sort(array_of_nodes, order); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:452
  def step(path_stack, any_type: T.unsafe(nil), order: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:165
  def strict?; end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:639
  def trace(*args); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:956
  def unnode(nodeset); end

  # source://rexml-3.4.4/lib/rexml/xpath_parser.rb:883
