...
#
# source://faraday-retry-2.0.0/lib/faraday/retriable_response.rb:6
class Faraday::RetriableResponse < ::Faraday::Error; end

# Middleware main module.
#
# source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:4
...
#
# source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:17
class Faraday::Retry::Middleware < ::Faraday::Middleware
  ...
  #
  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:122
  ...
  #
  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:180
  def build_exception_matcher(exceptions); end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:128
  def calculate_sleep_amount(retries, env); end

  # @param env [Faraday::Env]
  #
  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:142
  def call(env); end
  ...
  #
  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:217
  def calculate_rate_limit_reset(env); end

  # MDN spec for Retry-After header:
  # https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Retry-After
  #
  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:223
  def calculate_retry_after(env); end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:227
  def calculate_retry_interval(retries); end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:238
  def parse_retry_header(env, header); end

  # @return [Boolean]
  #
  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:201
  def retry_request?(env, exception); end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:206
  def rewind_files(body); end
end

# source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:18
Faraday::Retry::Middleware::DEFAULT_EXCEPTIONS = T.let(T.unsafe(nil), Array)

# source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:22
...
#
# source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:29
class Faraday::Retry::Middleware::Options < ::Faraday::Options
  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:57
  def backoff_factor; end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:61
  def exceptions; end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:45
  def interval; end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:53
  def interval_randomness; end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:41
  def max; end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:49
  def max_interval; end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:65
  def methods; end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:73
  def retry_block; end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:69
  def retry_if; end

  # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:77
  def retry_statuses; end

  class << self
    # source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:33
    def from(value); end
  end
end

# source://faraday-retry-2.0.0/lib/faraday/retry/middleware.rb:31
Faraday::Retry::Middleware::Options::DEFAULT_CHECK = T.let(T.unsafe(nil), Proc)

# source://faraday-retry-2.0.0/lib/faraday/retry/version.rb:5
