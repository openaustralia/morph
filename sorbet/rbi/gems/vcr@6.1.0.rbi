...
#
# source://vcr-6.1.0/lib/vcr/util/logger.rb:1
module VCR
  ...
  #
  # source://vcr-6.1.0/lib/vcr.rb:234
  def configure; end
  ...
  #
  # source://vcr-6.1.0/lib/vcr.rb:256
  ...
  #   no current cassette.
  #
  # source://vcr-6.1.0/lib/vcr.rb:48
  ...
  #
  # source://vcr-6.1.0/lib/vcr.rb:159
  def eject_cassette(options = T.unsafe(nil)); end

  # @private
  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr.rb:408
  def fibers_available?; end

  # @private
  #
  # source://vcr-6.1.0/lib/vcr.rb:345
  ...
  # @return [void]
  #
  # source://vcr-6.1.0/lib/vcr.rb:290
  ...
  # @see #turned_on
  #
  # source://vcr-6.1.0/lib/vcr.rb:327
  def turn_on!; end
  ...
  # @see #turned_on
  #
  # source://vcr-6.1.0/lib/vcr.rb:270
  ...
  # @see #turned_on?
  #
  # source://vcr-6.1.0/lib/vcr.rb:311
  ...
  # @see #turned_off
  #
  # source://vcr-6.1.0/lib/vcr.rb:337
  def turned_on?; end

  # @private
  #
  # source://vcr-6.1.0/lib/vcr.rb:403
  ...
  #   been inserted.
  #
  # source://vcr-6.1.0/lib/vcr.rb:184
  ...
  #   end
  #
  # source://vcr-6.1.0/lib/vcr.rb:213
  ...
  #
  # source://vcr-6.1.0/lib/vcr/version.rb:11
  def version; end

  private

  # source://vcr-6.1.0/lib/vcr.rb:448
  def context_cassettes; end

  # source://vcr-6.1.0/lib/vcr.rb:427
  def context_value(name); end

  # source://vcr-6.1.0/lib/vcr.rb:413
  def current_context; end

  # source://vcr-6.1.0/lib/vcr.rb:435
  def dup_context(context); end

  # source://vcr-6.1.0/lib/vcr.rb:417
  def get_context(thread_key, fiber_key = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr.rb:444
  def ignore_cassettes?; end

  # source://vcr-6.1.0/lib/vcr.rb:452
  def initialize_fibers; end

  # source://vcr-6.1.0/lib/vcr.rb:461
  def initialize_ivars; end

  # source://vcr-6.1.0/lib/vcr.rb:431
  def set_context_value(name, value); end

  class << self
    # @private
    #
    # source://vcr-6.1.0/lib/vcr/deprecations.rb:10
...
#
# source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:2
class VCR::Cassette
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:75
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:41
  def erb; end
  ...
  #   to be recorded.
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:32
  def record_on_error; end

  # @return [Boolean] Whether or not the cassette is recording.
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:137
  def recording?; end

  # @private
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:84
  def run_failed!; end

  # @private
  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:89
  def run_failed?; end

  # @return [Hash] The hash that will be serialized when the cassette is written to disk.
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:146
  def serializable_hash; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:94
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:51
  def tags; end

  private

  # source://vcr-6.1.0/lib/vcr/cassette.rb:174
  def assert_valid_options!; end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:201
  def assign_tags; end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:312
  def deserialized_hash; end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:187
  def extract_options; end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:288
  def interactions_to_record; end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:304
  def invoke_hook(type, interactions); end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:325
  def log_prefix; end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:270
  def merged_interactions; end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:209
  def previously_recorded_interactions; end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:227
  def raise_error_unless_valid_record_mode; end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:266
  def raw_cassette_bytes; end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:329
  def request_summary(request); end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:262
  def should_assert_no_unused_interactions?; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:233
  def should_re_record?(record_mode); end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:258
  def should_remove_matching_existing_interactions?; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette.rb:254
  def should_stub_requests?; end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:223
  def storage_key; end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:283
  def up_to_date_interactions(interactions); end

  # source://vcr-6.1.0/lib/vcr/cassette.rb:296
  def write_recorded_interactions_to_disk; end

  class << self
    # @private
    #
    # source://vcr-6.1.0/lib/vcr/deprecations.rb:17
    def const_missing(const); end
  end
end
...
# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/erb_renderer.rb:6
class VCR::Cassette::ERBRenderer
  # @return [ERBRenderer] a new instance of ERBRenderer
  #
  # source://vcr-6.1.0/lib/vcr/cassette/erb_renderer.rb:7
  def initialize(raw_template, erb, cassette_name = T.unsafe(nil)); end

  # source://vcr-6.1.0/lib/vcr/cassette/erb_renderer.rb:11
  def render; end

  private

  # source://vcr-6.1.0/lib/vcr/cassette/erb_renderer.rb:52
  def binding_for_variables; end

  # source://vcr-6.1.0/lib/vcr/cassette/erb_renderer.rb:34
  def erb_variables; end

  # @raise [Errors::MissingERBVariableError]
  #
  # source://vcr-6.1.0/lib/vcr/cassette/erb_renderer.rb:21
  def handle_name_error(e); end

  # source://vcr-6.1.0/lib/vcr/cassette/erb_renderer.rb:38
  def template; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette/erb_renderer.rb:30
  def use_erb?; end

  # source://vcr-6.1.0/lib/vcr/cassette/erb_renderer.rb:48
  def variables_object; end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers.rb:49
module VCR::Cassette::EncodingErrorHandling
  # source://vcr-6.1.0/lib/vcr/cassette/serializers.rb:50
  def handle_encoding_errors; end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:4
class VCR::Cassette::HTTPInteractionList
  include ::VCR::Logger::Mixin

  # @return [HTTPInteractionList] a new instance of HTTPInteractionList
  #
  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:18
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:16
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:65
  def assert_no_unused_interactions!; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:48
  def has_interaction_matching?(request); end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:54
  ...
  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:58
  ...
  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:31
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:79
  def has_unused_interactions?; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:96
  def interaction_matches_request?(request, interaction); end

  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:107
  def log_prefix; end

  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:87
  def matching_interaction_index_for(request); end

  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:91
  def matching_used_interaction_for(request); end

  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:83
  def request_summary(request); end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:8
module VCR::Cassette::HTTPInteractionList::NullList
  extend ::VCR::Cassette::HTTPInteractionList::NullList

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:11
  def has_interaction_matching?(*a); end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:12
  def has_used_interaction_matching?(*a); end

  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:13
  def remaining_unused_interaction_count(*a); end

  # source://vcr-6.1.0/lib/vcr/cassette/http_interaction_list.rb:10
  def response_for(*a); end
end

# Keeps track of the cassette persisters in a hash-like object.
#
# source://vcr-6.1.0/lib/vcr/cassette/persisters.rb:4
class VCR::Cassette::Persisters
  # @private
  # @return [Persisters] a new instance of Persisters
  #
  # source://vcr-6.1.0/lib/vcr/cassette/persisters.rb:8
  def initialize; end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/persisters.rb:17
  def [](name); end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/persisters.rb:31
  def []=(name, value); end
end

# The only built-in cassette persister. Persists cassettes to the file system.
#
# source://vcr-6.1.0/lib/vcr/cassette/persisters/file_system.rb:7
module VCR::Cassette::Persisters::FileSystem
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/persisters/file_system.rb:23
  def [](file_name); end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/persisters/file_system.rb:33
  def []=(file_name, content); end

  # @private
  #
  # source://vcr-6.1.0/lib/vcr/cassette/persisters/file_system.rb:41
  def absolute_path_to_file(file_name); end

  # @private
  #
  # source://vcr-6.1.0/lib/vcr/cassette/persisters/file_system.rb:11
  def storage_location; end

  # @private
  #
  # source://vcr-6.1.0/lib/vcr/cassette/persisters/file_system.rb:14
  def storage_location=(dir); end

  private

  # source://vcr-6.1.0/lib/vcr/cassette/persisters/file_system.rb:47
  def absolute_path_for(path); end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/cassette/persisters/file_system.rb:63
  def downcase_cassette_names?; end

  # source://vcr-6.1.0/lib/vcr/cassette/persisters/file_system.rb:51
  def sanitized_file_name_from(file_name); end
end

# Keeps track of the cassette serializers in a hash-like object.
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers.rb:4
class VCR::Cassette::Serializers
  # @private
  # @return [Serializers] a new instance of Serializers
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers.rb:12
  def initialize; end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers.rb:21
  def [](name); end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers.rb:39
  def []=(name, value); end
end
...
# @see YAML
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/compressed.rb:15
module VCR::Cassette::Serializers::Compressed
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/compressed.rb:38
  ...
  # @return [String] "zz"
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/compressed.rb:21
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/compressed.rb:29
...
# @see YAML
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/json.rb:11
module VCR::Cassette::Serializers::JSON
  ...
  # @return [Hash] the deserialized object
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/json.rb:44
  def deserialize(string); end
  ...
  # @return [String] "json"
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/json.rb:26
  def file_extension; end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/json.rb:34
  def serialize(hash); end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/json.rb:17
VCR::Cassette::Serializers::JSON::ENCODING_ERRORS = T.let(T.unsafe(nil), Array)

# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/json.rb:21
...
# @see YAML
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/psych.rb:11
module VCR::Cassette::Serializers::Psych
  ...
  # @return [Hash] the deserialized object
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/psych.rb:45
  def deserialize(string); end
  ...
  # @return [String] "yml"
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/psych.rb:25
  def file_extension; end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/psych.rb:33
  def serialize(hash); end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/psych.rb:17
VCR::Cassette::Serializers::Psych::ENCODING_ERRORS = T.let(T.unsafe(nil), Array)

# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/psych.rb:20
...
# @see YAML
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/syck.rb:11
module VCR::Cassette::Serializers::Syck
  ...
  # @return [Hash] the deserialized object
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/syck.rb:43
  def deserialize(string); end
  ...
  # @return [String] "yml"
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/syck.rb:25
  def file_extension; end
  ...
  # @return [String] the YAML string
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/syck.rb:33
  def serialize(hash); end

  private

  # source://vcr-6.1.0/lib/vcr/cassette/serializers/syck.rb:53
  def using_syck; end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/syck.rb:17
VCR::Cassette::Serializers::Syck::ENCODING_ERRORS = T.let(T.unsafe(nil), Array)

# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/syck.rb:20
...
# @see Syck
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/yaml.rb:13
module VCR::Cassette::Serializers::YAML
  ...
  # @return [Hash] the deserialized object
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/yaml.rb:47
  def deserialize(string); end
  ...
  # @return [String] "yml"
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/yaml.rb:27
  def file_extension; end
  ...
  # @return [String] the YAML string
  #
  # source://vcr-6.1.0/lib/vcr/cassette/serializers/yaml.rb:35
  def serialize(hash); end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/yaml.rb:19
VCR::Cassette::Serializers::YAML::ENCODING_ERRORS = T.let(T.unsafe(nil), Array)

# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers/yaml.rb:22
VCR::Cassette::Serializers::YAML::SYNTAX_ERRORS = T.let(T.unsafe(nil), Array)

# @private
#
# source://vcr-6.1.0/lib/vcr/cassette/serializers.rb:59
module VCR::Cassette::SyntaxErrorHandling
  # source://vcr-6.1.0/lib/vcr/cassette/serializers.rb:60
...
#
# source://vcr-6.1.0/lib/vcr/cassette.rb:17
...
class VCR::Configuration
  ...
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:490
  def initialize; end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:366
  ...
  # @overload allow_http_connections_when_no_cassette=
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:129
  def allow_http_connections_when_no_cassette=(_arg0); end

  # @private (documented above)
  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:131
  ...
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:395
  ...
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:325
  ...
  # @yieldparam cassette [(optional) VCR::Cassette] The current cassette.
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:297
  ...
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:15
  ...
  # @return [void]
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:30
  ...
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:269
  def cassette_persisters; end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:253
  def cassette_serializers; end

  # Configures RSpec to use a VCR cassette for any example
  # tagged with `:vcr`.
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:418
  ...
  # @overload debug_logger=
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:440
  def debug_logger; end

  # @private (documented above)
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:442
  ...
  # @overload default_cassette_options=
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:46
  def default_cassette_options; end

  # Sets the default options that apply to every cassette.
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:49
  ...
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:225
  ...
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:65
  ...
  # @see #ignore_request
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:75
  ...
  # @see #ignore_request
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:94
  ...
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:112
  ...
  # @private
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:454
  def logger; end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:484
  ...
  # @overload query_parser=
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:151
  ...
  #   equivalent
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:198
  def register_request_matcher(name, &block); end

  # @deprecated Use #hook_into instead.
  # @see #hook_into
  #
  # source://vcr-6.1.0/lib/vcr/deprecations.rb:26
  ...
  # @see #ignore_hosts
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:84
  ...
  # @overload uri_parser=
  #
  # source://vcr-6.1.0/lib/vcr/configuration.rb:177
  def uri_parser; end
  ...
  # source://vcr-6.1.0/lib/vcr/configuration.rb:528
  def create_fiber_for(fiber_errors, hook_declaration, proc); end

  # source://vcr-6.1.0/lib/vcr/configuration.rb:510
  def load_library_hook(hook); end

  # source://vcr-6.1.0/lib/vcr/configuration.rb:581
  def log_prefix; end

  # source://vcr-6.1.0/lib/vcr/configuration.rb:563
  def register_built_in_hooks; end

  # source://vcr-6.1.0/lib/vcr/configuration.rb:558
  def request_filter_from(object); end

  # source://vcr-6.1.0/lib/vcr/configuration.rb:518
  def resume_fiber(fiber, fiber_errors, response, hook_declaration); end

  # source://vcr-6.1.0/lib/vcr/configuration.rb:547
  def start_new_fiber_for(request, fibers, fiber_errors, hook_declaration, proc); end

  # source://vcr-6.1.0/lib/vcr/configuration.rb:553
  def tag_filter_from(tag); end
end

# source://vcr-6.1.0/lib/vcr/configuration.rb:0
module VCR::Configuration::DefinedHooks
  # source://vcr-6.1.0/lib/vcr/util/hooks.rb:55
...
#
# source://vcr-6.1.0/lib/vcr/test_frameworks/cucumber.rb:3
class VCR::CucumberTags
  # @private
  # @return [CucumberTags] a new instance of CucumberTags
  #
  # source://vcr-6.1.0/lib/vcr/test_frameworks/cucumber.rb:19
  ...
  #
  # source://vcr-6.1.0/lib/vcr/test_frameworks/cucumber.rb:30
  ...
  class << self
    # @private
    #
    # source://vcr-6.1.0/lib/vcr/test_frameworks/cucumber.rb:11
    def add_tag(tag); end

    # @private
    #
    # source://vcr-6.1.0/lib/vcr/test_frameworks/cucumber.rb:6
    def tags; end
  end
end
...
# @private
#
# source://vcr-6.1.0/lib/vcr/test_frameworks/cucumber.rb:84
class VCR::CucumberTags::ScenarioNameBuilder
  # @return [ScenarioNameBuilder] a new instance of ScenarioNameBuilder
  #
  # source://vcr-6.1.0/lib/vcr/test_frameworks/cucumber.rb:85
  def initialize(test_case); end

  # source://vcr-6.1.0/lib/vcr/test_frameworks/cucumber.rb:90
  def cassette_name; end

  # source://vcr-6.1.0/lib/vcr/test_frameworks/cucumber.rb:100
  def examples_table(*_arg0); end

  # source://vcr-6.1.0/lib/vcr/test_frameworks/cucumber.rb:103
  def examples_table_row(row); end

  # source://vcr-6.1.0/lib/vcr/test_frameworks/cucumber.rb:94
...
# @private
#
# source://vcr-6.1.0/lib/vcr/deprecations.rb:33
module VCR::Deprecations; end

# source://vcr-6.1.0/lib/vcr/deprecations.rb:34
module VCR::Deprecations::Middleware; end

# @private
#
# source://vcr-6.1.0/lib/vcr/deprecations.rb:36
module VCR::Deprecations::Middleware::Faraday
  # source://vcr-6.1.0/lib/vcr/deprecations.rb:37
  def initialize(*args); end
end

# Namespace for VCR errors.
#
# source://vcr-6.1.0/lib/vcr/errors.rb:3
...
#
# source://vcr-6.1.0/lib/vcr/errors.rb:36
...
# @see VCR#turned_off
#
# source://vcr-6.1.0/lib/vcr/errors.rb:10
...
#
# source://vcr-6.1.0/lib/vcr/errors.rb:26
...
#
# source://vcr-6.1.0/lib/vcr/errors.rb:21
...
# @see VCR::Configuration#around_http_request
#
# source://vcr-6.1.0/lib/vcr/errors.rb:41
...
# @see VCR#use_cassette
#
# source://vcr-6.1.0/lib/vcr/errors.rb:15
...
#
# source://vcr-6.1.0/lib/vcr/errors.rb:64
class VCR::Errors::UnhandledHTTPRequestError < ::VCR::Errors::Error
  ...
  #
  # source://vcr-6.1.0/lib/vcr/errors.rb:70
  def initialize(request); end

  # The HTTP request.
  #
  # source://vcr-6.1.0/lib/vcr/errors.rb:65
  def request; end

  private

  # source://vcr-6.1.0/lib/vcr/errors.rb:136
  def cassettes_description; end

  # source://vcr-6.1.0/lib/vcr/errors.rb:148
  def cassettes_list; end

  # source://vcr-6.1.0/lib/vcr/errors.rb:81
  def construct_message; end

  # source://vcr-6.1.0/lib/vcr/errors.rb:90
  def current_cassettes; end

  # source://vcr-6.1.0/lib/vcr/errors.rb:118
  def current_matchers; end

  # source://vcr-6.1.0/lib/vcr/errors.rb:183
  def format_bullet_point(lines, index); end

  # source://vcr-6.1.0/lib/vcr/errors.rb:189
  def format_foot_note(url, index); end

  # source://vcr-6.1.0/lib/vcr/errors.rb:128
  def formatted_headers; end

  # source://vcr-6.1.0/lib/vcr/errors.rb:168
  def formatted_suggestions; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/errors.rb:295
  def has_used_interaction_matching?; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/errors.rb:114
  def match_request_on_body?; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/errors.rb:110
  def match_request_on_headers?; end

  # source://vcr-6.1.0/lib/vcr/errors.rb:299
  def match_requests_on_suggestion; end

  # source://vcr-6.1.0/lib/vcr/errors.rb:277
  def no_cassette_suggestions; end

  # source://vcr-6.1.0/lib/vcr/errors.rb:283
  def record_mode_suggestion; end

  # source://vcr-6.1.0/lib/vcr/errors.rb:77
  def relish_version_slug; end

  # source://vcr-6.1.0/lib/vcr/errors.rb:94
  def request_description; end

  # source://vcr-6.1.0/lib/vcr/errors.rb:259
  def suggestion_for(key); end

  # source://vcr-6.1.0/lib/vcr/errors.rb:266
  def suggestions; end
end

# List of suggestions for how to configure VCR to handle the request.
#
# source://vcr-6.1.0/lib/vcr/errors.rb:194
...
#
# source://vcr-6.1.0/lib/vcr/errors.rb:46
...
#
# source://vcr-6.1.0/lib/vcr/errors.rb:29
...
#
# source://vcr-6.1.0/lib/vcr/errors.rb:52
...
class VCR::HTTPInteraction < ::Struct
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:512
  def to_hash; end
  ...
  class << self
    ...
    #
    # source://vcr-6.1.0/lib/vcr/structs.rb:524
...
#
# source://vcr-6.1.0/lib/vcr/structs.rb:538
class VCR::HTTPInteraction::HookAware
  # @return [HookAware] a new instance of HookAware
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:539
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:563
  ...
  # @see #ignored?
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:548
  def ignore!; end

  # @return [Boolean] whether or not this HTTP interaction should be ignored.
  # @see #ignore!
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:554
  def ignored?; end

  private

  # source://vcr-6.1.0/lib/vcr/structs.rb:584
  def filter_hash!(hash, text, replacement_text); end

  # source://vcr-6.1.0/lib/vcr/structs.rb:571
  def filter_object!(object, text, replacement_text); end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/util/hooks.rb:5
module VCR::Hooks
  include ::VCR::VariableArgsBlockCaller

  mixes_in_class_methods ::VCR::Hooks::ClassMethods

  # source://vcr-6.1.0/lib/vcr/util/hooks.rb:34
  def clear_hooks; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/util/hooks.rb:44
  def has_hooks_for?(hook_type); end

  # source://vcr-6.1.0/lib/vcr/util/hooks.rb:38
  def hooks; end

  # source://vcr-6.1.0/lib/vcr/util/hooks.rb:28
  def invoke_hook(hook_type, *args); end

  class << self
    # @private
    #
    # source://vcr-6.1.0/lib/vcr/util/hooks.rb:19
...
# @private
#
# source://vcr-6.1.0/lib/vcr/util/hooks.rb:49
module VCR::Hooks::ClassMethods
  # source://vcr-6.1.0/lib/vcr/util/hooks.rb:50
  def define_hook(hook_type, prepend = T.unsafe(nil)); end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/util/hooks.rb:9
class VCR::Hooks::FilteredHook < ::Struct
  include ::VCR::VariableArgsBlockCaller

  # source://vcr-6.1.0/lib/vcr/util/hooks.rb:12
...
# @private
#
# source://vcr-6.1.0/lib/vcr/util/internet_connection.rb:26
module VCR::InternetConnection
  extend ::VCR::InternetConnection

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/util/internet_connection.rb:31
  def available?; end
end

# source://vcr-6.1.0/lib/vcr/util/internet_connection.rb:29
VCR::InternetConnection::EXAMPLE_HOST = T.let(T.unsafe(nil), String)

# @private
#
# source://vcr-6.1.0/lib/vcr/library_hooks.rb:3
class VCR::LibraryHooks
  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/library_hooks.rb:6
  def disabled?(hook); end

  # Returns the value of attribute exclusive_hook.
  #
  # source://vcr-6.1.0/lib/vcr/library_hooks.rb:4
...
class VCR::LinkedCassette < ::SimpleDelegator
  ...
  #
  # source://vcr-6.1.0/lib/vcr/linked_cassette.rb:62
  def eject(*args); end

  # @return [Boolean] true
  #
  # source://vcr-6.1.0/lib/vcr/linked_cassette.rb:68
  def linked?; end
  ...
  class << self
    ...
    #
    # source://vcr-6.1.0/lib/vcr/linked_cassette.rb:57
...
#
# source://vcr-6.1.0/lib/vcr/linked_cassette.rb:8
...
# @private
#
# source://vcr-6.1.0/lib/vcr/util/logger.rb:4
class VCR::Logger
  # @return [Logger] a new instance of Logger
  #
  # source://vcr-6.1.0/lib/vcr/util/logger.rb:5
  def initialize(stream); end

  # source://vcr-6.1.0/lib/vcr/util/logger.rb:9
  def log(message, log_prefix, indentation_level = T.unsafe(nil)); end

  # source://vcr-6.1.0/lib/vcr/util/logger.rb:15
  def request_summary(request, request_matchers); end

  # source://vcr-6.1.0/lib/vcr/util/logger.rb:22
...
# @private
#
# source://vcr-6.1.0/lib/vcr/util/logger.rb:45
module VCR::Logger::Mixin
  # source://vcr-6.1.0/lib/vcr/util/logger.rb:46
  def log(message, indentation_level = T.unsafe(nil)); end

  # source://vcr-6.1.0/lib/vcr/util/logger.rb:50
  def request_summary(*args); end

  # source://vcr-6.1.0/lib/vcr/util/logger.rb:54
...
# @private
#
# source://vcr-6.1.0/lib/vcr/util/logger.rb:34
module VCR::Logger::Null
  private

  # source://vcr-6.1.0/lib/vcr/util/logger.rb:37
  def log(*_arg0); end

  # source://vcr-6.1.0/lib/vcr/util/logger.rb:38
  def request_summary(*_arg0); end

  # source://vcr-6.1.0/lib/vcr/util/logger.rb:39
...
class VCR::Middleware::CassetteArguments
  ...
  #
  # source://vcr-6.1.0/lib/vcr/middleware/rack.rb:16
  ...
  #
  # source://vcr-6.1.0/lib/vcr/middleware/rack.rb:25
...
#
# source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:15
class VCR::Middleware::Faraday
  ...
  #
  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:21
  ...
  #
  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:29
  def call(env); end

  # Close any persistent connections.
  #
  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:35
  def close; end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:40
class VCR::Middleware::Faraday::RequestHandler < ::VCR::RequestHandler
  # @return [RequestHandler] a new instance of RequestHandler
  #
  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:42
  def initialize(app, env); end

  # Returns the value of attribute app.
  #
  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:41
  def app; end
  ...
  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:47
  def handle; end
  ...
  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:59
  def delay_finishing?; end

  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:120
  def invoke_after_request_hook(response); end

  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:92
  def on_ignored_request; end

  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:110
  def on_recordable_request; end

  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:98
  def on_stubbed_by_vcr_request; end

  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:71
  def raw_body_from(body); end

  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:79
  def response_for(response); end

  # source://vcr-6.1.0/lib/vcr/middleware/faraday.rb:63
  def vcr_request; end
end
...
#
# source://vcr-6.1.0/lib/vcr/middleware/rack.rb:43
class VCR::Middleware::Rack
  ...
  #
  # source://vcr-6.1.0/lib/vcr/middleware/rack.rb:53
  ...
  #
  # source://vcr-6.1.0/lib/vcr/middleware/rack.rb:62
  def call(env); end

  private

  # source://vcr-6.1.0/lib/vcr/middleware/rack.rb:72
  def cassette_arguments(env); end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/structs.rb:7
module VCR::Normalizers; end

# @private
#
# source://vcr-6.1.0/lib/vcr/structs.rb:9
module VCR::Normalizers::Body
  mixes_in_class_methods ::VCR::Normalizers::Body::ClassMethods

  # source://vcr-6.1.0/lib/vcr/structs.rb:61
  def initialize(*args); end

  private

  # source://vcr-6.1.0/lib/vcr/structs.rb:92
  def base_body_hash(body); end

  # source://vcr-6.1.0/lib/vcr/structs.rb:78
  def serializable_body; end

  class << self
    # @private
    #
    # source://vcr-6.1.0/lib/vcr/structs.rb:10
    def included(klass); end
  end
end
...
# @private
#
# source://vcr-6.1.0/lib/vcr/structs.rb:15
module VCR::Normalizers::Body::ClassMethods
  # source://vcr-6.1.0/lib/vcr/structs.rb:16
  def body_from(hash_or_string); end

  # source://vcr-6.1.0/lib/vcr/structs.rb:29
  def force_encode_string(string, encoding); end

  # source://vcr-6.1.0/lib/vcr/structs.rb:34
  def try_encode_string(string, encoding); end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/structs.rb:103
module VCR::Normalizers::Header
  # source://vcr-6.1.0/lib/vcr/structs.rb:104
  def initialize(*args); end

  private

  # source://vcr-6.1.0/lib/vcr/structs.rb:153
  def convert_to_raw_strings(array); end

  # source://vcr-6.1.0/lib/vcr/structs.rb:146
  def delete_header(key); end

  # source://vcr-6.1.0/lib/vcr/structs.rb:139
  def edit_header(key, value = T.unsafe(nil)); end

  # source://vcr-6.1.0/lib/vcr/structs.rb:134
  def get_header(key); end

  # source://vcr-6.1.0/lib/vcr/structs.rb:129
  def header_key(key); end

  # source://vcr-6.1.0/lib/vcr/structs.rb:111
  def normalize_headers; end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/util/internet_connection.rb:8
module VCR::Ping
  private

  # source://vcr-6.1.0/lib/vcr/util/internet_connection.rb:9
...
#
# source://vcr-6.1.0/lib/vcr.rb:35
module VCR::RSpec; end

# @private
#
# source://vcr-6.1.0/lib/vcr/test_frameworks/rspec.rb:5
module VCR::RSpec::Metadata
  extend ::VCR::RSpec::Metadata

  # source://vcr-6.1.0/lib/vcr/test_frameworks/rspec.rb:30
  def configure!; end

  # source://vcr-6.1.0/lib/vcr/test_frameworks/rspec.rb:8
...
#
# source://vcr-6.1.0/lib/vcr/structs.rb:176
class VCR::Request < ::Struct
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:180
  def initialize(*args); end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:228
  def method(*args); end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:223
  def parsed_uri; end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:197
  def to_hash; end

  private

  # source://vcr-6.1.0/lib/vcr/structs.rb:315
  ...
  class << self
    ...
    #
    # source://vcr-6.1.0/lib/vcr/structs.rb:210
    def from_hash(hash); end
  end
end
...
class VCR::Request::FiberAware
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:306
  def to_proc; end
end

# Decorates a {Request} with its current type.
#
# source://vcr-6.1.0/lib/vcr/structs.rb:235
class VCR::Request::Typed
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:240
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:277
  def real?; end

  # @return [Boolean] whether or not this request will be recorded.
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:266
  def recordable?; end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:285
  def stubbed?; end
  ...
  # @see #stubbed?
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:253
  def stubbed_by_vcr?; end

  # @return [Symbol] One of `:ignored`, `:stubbed`, `:recordable` or `:unhandled`.
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:236
  def type; end

  # @return [Boolean] whether or not VCR knows how to handle this request.
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:271
  def unhandled?; end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/request_handler.rb:3
class VCR::RequestHandler
  include ::VCR::Logger::Mixin

  # source://vcr-6.1.0/lib/vcr/request_handler.rb:6
  def handle; end
  ...
  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/request_handler.rb:62
  def disabled?; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/request_handler.rb:54
  def externally_stubbed?; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/request_handler.rb:66
  def has_response_stub?(consume_stub); end

  # source://vcr-6.1.0/lib/vcr/request_handler.rb:49
  def invoke_after_request_hook(vcr_response); end

  # source://vcr-6.1.0/lib/vcr/request_handler.rb:43
  def invoke_before_request_hook; end

  # source://vcr-6.1.0/lib/vcr/request_handler.rb:78
  def library_name; end

  # source://vcr-6.1.0/lib/vcr/request_handler.rb:110
  def log_prefix; end

  # Subclasses can implement these
  #
  # source://vcr-6.1.0/lib/vcr/request_handler.rb:84
  def on_externally_stubbed_request; end

  # source://vcr-6.1.0/lib/vcr/request_handler.rb:87
  def on_ignored_request; end

  # source://vcr-6.1.0/lib/vcr/request_handler.rb:93
  def on_recordable_request; end

  # source://vcr-6.1.0/lib/vcr/request_handler.rb:90
  def on_stubbed_by_vcr_request; end

  # @raise [VCR::Errors::UnhandledHTTPRequestError]
  #
  # source://vcr-6.1.0/lib/vcr/request_handler.rb:96
  def on_unhandled_request; end

  # source://vcr-6.1.0/lib/vcr/request_handler.rb:100
  def request_summary; end

  # source://vcr-6.1.0/lib/vcr/request_handler.rb:33
  def request_type(consume_stub = T.unsafe(nil)); end

  # source://vcr-6.1.0/lib/vcr/request_handler.rb:29
  def set_typed_request_for_after_hook(request_type); end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/request_handler.rb:58
  def should_ignore?; end

  # source://vcr-6.1.0/lib/vcr/request_handler.rb:74
  def stubbed_response; end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/request_ignorer.rb:6
class VCR::RequestIgnorer
  ...
  #
  # source://vcr-6.1.0/lib/vcr/request_ignorer.rb:13
  def initialize; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/request_ignorer.rb:40
  def ignore?(request); end

  # source://vcr-6.1.0/lib/vcr/request_ignorer.rb:32
  def ignore_hosts(*hosts); end

  # source://vcr-6.1.0/lib/vcr/request_ignorer.rb:20
  def ignore_localhost=(value); end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/request_ignorer.rb:28
  def localhost_ignored?; end

  # source://vcr-6.1.0/lib/vcr/request_ignorer.rb:36
  def unignore_hosts(*hosts); end

  private

  # source://vcr-6.1.0/lib/vcr/request_ignorer.rb:46
  def ignored_hosts; end
end

# source://vcr-6.1.0/lib/vcr/request_ignorer.rb:0
module VCR::RequestIgnorer::DefinedHooks
  # source://vcr-6.1.0/lib/vcr/util/hooks.rb:55
  def ignore_request(*filters, &hook); end
end

# source://vcr-6.1.0/lib/vcr/request_ignorer.rb:11
VCR::RequestIgnorer::LOCALHOST_ALIASES = T.let(T.unsafe(nil), Array)

# Keeps track of the different request matchers.
#
# source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:5
class VCR::RequestMatcherRegistry
  # @private
  # @return [RequestMatcherRegistry] a new instance of RequestMatcherRegistry
  #
  # source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:49
  def initialize; end

  # @private
  #
  # source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:64
  def [](matcher); end

  # @private
  #
  # source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:55
  ...
  #
  # source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:91
  ...
  # source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:105
  def raise_unregistered_matcher_error(name); end

  # source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:111
  def register_built_ins; end

  # source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:132
  def try_to_register_body_as_json; end

  # source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:98
...
#
# source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:9
VCR::RequestMatcherRegistry::DEFAULT_MATCHERS = T.let(T.unsafe(nil), Array)

# @private
#
# source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:12
class VCR::RequestMatcherRegistry::Matcher < ::Struct
  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:13
  def matches?(request_1, request_2); end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:19
class VCR::RequestMatcherRegistry::URIWithoutParamsMatcher < ::Struct
  # source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:39
  def call(request_1, request_2); end

  # source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:20
  def partial_uri_from(request); end

  # source://vcr-6.1.0/lib/vcr/request_matcher_registry.rb:43
  def to_proc; end
end
...
#
# source://vcr-6.1.0/lib/vcr/structs.rb:331
class VCR::Response < ::Struct
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:335
  def initialize(*args); end
  ...
  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:382
  def compressed?; end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:377
  ...
  # @return self
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:396
  def decompress; end
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:410
  def recompress; end
  ...
  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:387
  ...
  class << self
    ...
    #   is not a known encoding.
    #
    # source://vcr-6.1.0/lib/vcr/structs.rb:449
    ...
    #
    # source://vcr-6.1.0/lib/vcr/structs.rb:360
    def from_hash(hash); end
  end
end

# source://vcr-6.1.0/lib/vcr/structs.rb:440
...
#
# source://vcr-6.1.0/lib/vcr/structs.rb:480
class VCR::ResponseStatus < ::Struct
  ...
  #
  # source://vcr-6.1.0/lib/vcr/structs.rb:481
  def to_hash; end
  ...
  class << self
    ...
    #
    # source://vcr-6.1.0/lib/vcr/structs.rb:491
    def from_hash(hash); end
  end
end
...
# @private
#
# source://vcr-6.1.0/lib/vcr/util/variable_args_block_caller.rb:3
module VCR::VariableArgsBlockCaller
  # source://vcr-6.1.0/lib/vcr/util/variable_args_block_caller.rb:4
  def call_block(block, *args); end
end

# @private
#
# source://vcr-6.1.0/lib/vcr/util/version_checker.rb:3
class VCR::VersionChecker
  # @return [VersionChecker] a new instance of VersionChecker
  #
  # source://vcr-6.1.0/lib/vcr/util/version_checker.rb:4
  def initialize(library_name, library_version, min_version); end

  # source://vcr-6.1.0/lib/vcr/util/version_checker.rb:13
  def check_version!; end

  private

  # source://vcr-6.1.0/lib/vcr/util/version_checker.rb:29
  def compare_version; end

  # source://vcr-6.1.0/lib/vcr/util/version_checker.rb:43
  def parse_version(version); end

  # @raise [Errors::LibraryVersionTooLowError]
  #
  # source://vcr-6.1.0/lib/vcr/util/version_checker.rb:23
  def raise_too_low_error; end

  # @return [Boolean]
  #
  # source://vcr-6.1.0/lib/vcr/util/version_checker.rb:19
  def too_low?; end

  # source://vcr-6.1.0/lib/vcr/util/version_checker.rb:39
