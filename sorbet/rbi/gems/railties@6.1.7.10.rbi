...
# source://railties-6.1.7.10/lib/rails/initializable.rb:5
module Rails
...
#
# source://railties-6.1.7.10/lib/rails/application.rb:83
...
# source://railties-6.1.7.10/lib/rails/application/bootstrap.rb:11
module Rails::Application::Bootstrap
  include ::Rails::Initializable
  extend ::Rails::Initializable::ClassMethods
end

# source://railties-6.1.7.10/lib/rails/application/configuration.rb:13
...
# source://railties-6.1.7.10/lib/rails/application/configuration.rb:386
class Rails::Application::Configuration::Custom
  # @return [Custom] a new instance of Custom
  #
  # source://railties-6.1.7.10/lib/rails/application/configuration.rb:387
  def initialize; end

  # source://railties-6.1.7.10/lib/rails/application/configuration.rb:391
  ...
  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/application/configuration.rb:401
  def respond_to_missing?(symbol, *_arg1); end
end

# source://railties-6.1.7.10/lib/rails/application/default_middleware_stack.rb:5
class Rails::Application::DefaultMiddlewareStack
  # @return [DefaultMiddlewareStack] a new instance of DefaultMiddlewareStack
  #
  # source://railties-6.1.7.10/lib/rails/application/default_middleware_stack.rb:8
  def initialize(app, config, paths); end

  # Returns the value of attribute app.
  #
  # source://railties-6.1.7.10/lib/rails/application/default_middleware_stack.rb:6
  def app; end

  # source://railties-6.1.7.10/lib/rails/application/default_middleware_stack.rb:14
  def build_stack; end
  ...
  # source://railties-6.1.7.10/lib/rails/application/default_middleware_stack.rb:84
  def load_rack_cache; end

  # source://railties-6.1.7.10/lib/rails/application/default_middleware_stack.rb:106
  def show_exceptions_app; end
end

# source://railties-6.1.7.10/lib/rails/application/finisher.rb:8
module Rails::Application::Finisher
  include ::Rails::Initializable
  extend ::Rails::Initializable::ClassMethods
end

# source://railties-6.1.7.10/lib/rails/application/finisher.rb:157
module Rails::Application::Finisher::InterlockHook
  class << self
    # source://railties-6.1.7.10/lib/rails/application/finisher.rb:162
    def complete(_state); end

    # source://railties-6.1.7.10/lib/rails/application/finisher.rb:158
    def run; end
  end
end

# source://railties-6.1.7.10/lib/rails/application/finisher.rb:143
class Rails::Application::Finisher::MutexHook
  # @return [MutexHook] a new instance of MutexHook
  #
  # source://railties-6.1.7.10/lib/rails/application/finisher.rb:144
  def initialize(mutex = T.unsafe(nil)); end

  # source://railties-6.1.7.10/lib/rails/application/finisher.rb:152
  def complete(_state); end

  # source://railties-6.1.7.10/lib/rails/application/finisher.rb:148
  def run; end
end
...
# source://railties-6.1.7.10/lib/rails/application/routes_reloader.rb:7
class Rails::Application::RoutesReloader
  # @return [RoutesReloader] a new instance of RoutesReloader
  #
  # source://railties-6.1.7.10/lib/rails/application/routes_reloader.rb:12
  def initialize; end

  # Returns the value of attribute eager_load.
  #
  # source://railties-6.1.7.10/lib/rails/application/routes_reloader.rb:9
  def eager_load; end
  ...
  # source://railties-6.1.7.10/lib/rails/application/routes_reloader.rb:10
  ...
  #
  # source://railties-6.1.7.10/lib/rails/application/routes_reloader.rb:8
  ...
  # source://railties-6.1.7.10/lib/rails/application/routes_reloader.rb:19
  def reload!; end
  ...
  # source://railties-6.1.7.10/lib/rails/application/routes_reloader.rb:39
  def clear!; end

  # source://railties-6.1.7.10/lib/rails/application/routes_reloader.rb:50
  def finalize!; end

  # source://railties-6.1.7.10/lib/rails/application/routes_reloader.rb:46
  def load_paths; end

  # source://railties-6.1.7.10/lib/rails/application/routes_reloader.rb:54
  def revert; end

  # source://railties-6.1.7.10/lib/rails/application/routes_reloader.rb:29
  def updater; end
end

# source://railties-6.1.7.10/lib/rails/application_controller.rb:3
class Rails::ApplicationController < ::ActionController::Base
  ...
  # source://railties-6.1.7.10/lib/rails/application_controller.rb:25
  def disable_content_security_policy_nonce!; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/application_controller.rb:21
  def local_request?; end

  # source://railties-6.1.7.10/lib/rails/application_controller.rb:15
...
# source://railties-6.1.7.10/lib/rails/autoloaders.rb:6
module Rails::Autoloaders
  extend ::Enumerable

  class << self
    # source://railties-6.1.7.10/lib/rails/autoloaders.rb:28
    def each; end

    # source://railties-6.1.7.10/lib/rails/autoloaders.rb:39
    def log!; end

    # source://railties-6.1.7.10/lib/rails/autoloaders.rb:35
    def logger=(logger); end

    # source://railties-6.1.7.10/lib/rails/autoloaders.rb:10
    def main; end

    # source://railties-6.1.7.10/lib/rails/autoloaders.rb:19
    def once; end

    # @return [Boolean]
    #
    # source://railties-6.1.7.10/lib/rails/autoloaders.rb:43
    def zeitwerk_enabled?; end
  end
end

# source://railties-6.1.7.10/lib/rails/command.rb:10
module Rails::Command
  ...
  class << self
    # source://railties-6.1.7.10/lib/rails/command.rb:26
    def environment; end
    ...
    #
    # source://railties-6.1.7.10/lib/rails/command.rb:69
    def find_by_namespace(namespace, command_name = T.unsafe(nil)); end

    # source://railties-6.1.7.10/lib/rails/command.rb:22
    def hidden_commands; end

    # Receives a namespace, arguments and the behavior to invoke the command.
    #
    # source://railties-6.1.7.10/lib/rails/command.rb:31
    def invoke(full_namespace, args = T.unsafe(nil), **config); end

    # source://railties-6.1.7.10/lib/rails/command.rb:89
    def print_commands; end

    # Returns the root of the Rails engine or app running the command.
    #
    # source://railties-6.1.7.10/lib/rails/command.rb:81
    def root; end

    private

    # source://railties-6.1.7.10/lib/rails/command.rb:105
    def command_type; end

    # source://railties-6.1.7.10/lib/rails/command.rb:97
    def commands; end

    # source://railties-6.1.7.10/lib/rails/command.rb:113
    def file_lookup_paths; end

    # source://railties-6.1.7.10/lib/rails/command.rb:109
    def lookup_paths; end
  end
end

# source://railties-6.1.7.10/lib/rails/command/actions.rb:5
module Rails::Command::Actions
  # source://railties-6.1.7.10/lib/rails/command/actions.rb:48
  def load_generators; end

  # source://railties-6.1.7.10/lib/rails/command/actions.rb:44
  def load_tasks; end

  # source://railties-6.1.7.10/lib/rails/command/actions.rb:18
  def require_application!; end

  # source://railties-6.1.7.10/lib/rails/command/actions.rb:13
  def require_application_and_environment!; end

  # source://railties-6.1.7.10/lib/rails/command/actions.rb:26
  def require_environment!; end
  ...
  #
  # source://railties-6.1.7.10/lib/rails/command/actions.rb:9
  def set_application_directory!; end
end

# source://railties-6.1.7.10/lib/rails/command/base.rb:13
class Rails::Command::Base < ::Thor
  include ::Rails::Command::Actions

  # source://railties-6.1.7.10/lib/rails/command/base.rb:160
  def help; end

  class << self
    # Use Rails' default banner.
    #
    # source://railties-6.1.7.10/lib/rails/command/base.rb:81
    ...
    #
    # source://railties-6.1.7.10/lib/rails/command/base.rb:88
    def base_name; end
    ...
    #
    # source://railties-6.1.7.10/lib/rails/command/base.rb:99
    ...
    #
    # source://railties-6.1.7.10/lib/rails/command/base.rb:121
    def default_command_root; end

    # Tries to get the description from a USAGE file one folder above the command
    # root.
    #
    # source://railties-6.1.7.10/lib/rails/command/base.rb:31
    ...
    # @return [Boolean]
    #
    # source://railties-6.1.7.10/lib/rails/command/base.rb:25
    def engine?; end

    # source://railties-6.1.7.10/lib/rails/command/base.rb:76
    def executable; end

    # @return [Boolean]
    #
    # source://railties-6.1.7.10/lib/rails/command/base.rb:20
    def exit_on_failure?; end

    # Convenience method to hide this command from the available ones when
    # running rails command.
    #
    # source://railties-6.1.7.10/lib/rails/command/base.rb:52
    def hide_command!; end

    # source://railties-6.1.7.10/lib/rails/command/base.rb:56
    def inherited(base); end
    ...
    # is removed.
    #
    # source://railties-6.1.7.10/lib/rails/command/base.rb:42
    def namespace(name = T.unsafe(nil)); end

    # source://railties-6.1.7.10/lib/rails/command/base.rb:64
    def perform(command, args, config); end

    # source://railties-6.1.7.10/lib/rails/command/base.rb:72
    def printing_commands; end

    # Path to lookup a USAGE description in a file.
    #
    # source://railties-6.1.7.10/lib/rails/command/base.rb:109
    def usage_path; end

    private

    # source://railties-6.1.7.10/lib/rails/command/base.rb:141
    def command_root_namespace; end

    # Allow the command method to be called perform.
    #
    # source://railties-6.1.7.10/lib/rails/command/base.rb:128
    def create_command(meth); end

    # source://railties-6.1.7.10/lib/rails/command/base.rb:149
    def namespaced_commands; end

    # source://railties-6.1.7.10/lib/rails/command/base.rb:145
    def relative_command_path; end
  end
end

# source://railties-6.1.7.10/lib/rails/command/base.rb:14
class Rails::Command::Base::Error < ::Thor::Error; end

# source://railties-6.1.7.10/lib/rails/command/behavior.rb:7
...
# source://railties-6.1.7.10/lib/rails/command/behavior.rb:0
module Rails::Command::Behavior::ClassMethods
  # source://railties-6.1.7.10/lib/rails/command/behavior.rb:12
  def no_color!; end

  # source://railties-6.1.7.10/lib/rails/command/behavior.rb:17
  def subclasses; end

  private

  # source://railties-6.1.7.10/lib/rails/command/behavior.rb:36
  def lookup(namespaces); end

  # source://railties-6.1.7.10/lib/rails/command/behavior.rb:56
  def lookup!; end

  # source://railties-6.1.7.10/lib/rails/command/behavior.rb:70
  def namespaces_to_paths(namespaces); end

  # source://railties-6.1.7.10/lib/rails/command/behavior.rb:23
  def print_list(base, namespaces); end
end

# source://railties-6.1.7.10/lib/rails/command.rb:19
Rails::Command::HELP_MAPPINGS = T.let(T.unsafe(nil), Array)

# source://railties-6.1.7.10/lib/rails/command/spellchecker.rb:5
module Rails::Command::Spellchecker
  class << self
    # source://railties-6.1.7.10/lib/rails/command/spellchecker.rb:7
    def suggest(word, from:); end

    private

    # source://railties-6.1.7.10/lib/rails/command/spellchecker.rb:20
    def levenshtein_distance(str1, str2); end
  end
end

# source://railties-6.1.7.10/lib/rails/configuration.rb:9
module Rails::Configuration; end

# source://railties-6.1.7.10/lib/rails/configuration.rb:109
class Rails::Configuration::Generators
  # @return [Generators] a new instance of Generators
  #
  # source://railties-6.1.7.10/lib/rails/configuration.rb:113
  def initialize; end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:135
  def after_generate(&block); end

  # Returns the value of attribute after_generate_callbacks.
  #
  # source://railties-6.1.7.10/lib/rails/configuration.rb:111
  def after_generate_callbacks; end

  # Returns the value of attribute aliases.
  #
  # source://railties-6.1.7.10/lib/rails/configuration.rb:110
  def aliases; end
  ...
  # source://railties-6.1.7.10/lib/rails/configuration.rb:131
  def hide_namespace(namespace); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:139
  def method_missing(method, *args); end
  ...
  # source://railties-6.1.7.10/lib/rails/configuration.rb:124
...
#
# source://railties-6.1.7.10/lib/rails/configuration.rb:46
class Rails::Configuration::MiddlewareStackProxy
  # @return [MiddlewareStackProxy] a new instance of MiddlewareStackProxy
  #
  # source://railties-6.1.7.10/lib/rails/configuration.rb:47
  def initialize(operations = T.unsafe(nil), delete_operations = T.unsafe(nil)); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:101
  def +(other); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:74
  def delete(*args, &block); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:52
  def insert(*args, &block); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:59
  def insert_after(*args, &block); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:52
  def insert_before(*args, &block); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:93
  def merge_into(other); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:78
  def move(*args, &block); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:84
  def move_after(*args, &block); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:78
  def move_before(*args, &block); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:64
  def swap(*args, &block); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:88
  def unshift(*args, &block); end

  # source://railties-6.1.7.10/lib/rails/configuration.rb:69
  ...
  #
  # source://railties-6.1.7.10/lib/rails/configuration.rb:106
...
#
# source://railties-6.1.7.10/lib/rails/engine/railties.rb:4
class Rails::Engine < ::Rails::Railtie
  ...
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:432
  def initialize; end
  ...
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:537
  def call(env); end

  # Define the configuration object for the engine.
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:556
  def config; end

  # source://railties-6.1.7.10/lib/rails/engine.rb:484
  def eager_load!; end

  # Returns the endpoint for this engine. If none is registered,
  # defaults to an ActionDispatch::Routing::RouteSet.
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:532
  def endpoint; end

  # source://railties-6.1.7.10/lib/rails/engine.rb:430
  def engine_name(*_arg0, &_arg1); end

  # Defines additional Rack env configuration that is added on each call.
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:543
  def env_config; end

  # Returns a module with all the helpers defined for the engine.
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:503
  def helpers; end

  # Returns all registered helpers paths.
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:515
  def helpers_paths; end
  ...
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:446
  def load_console(app = T.unsafe(nil)); end

  # Load Rails generators and invoke the registered hooks.
  # Check <tt>Rails::Railtie.generators</tt> for more info.
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:470
  def load_generators(app = T.unsafe(nil)); end

  # Load Rails runner and invoke the registered hooks.
  # Check <tt>Rails::Railtie.runner</tt> for more info.
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:455
  ...
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:564
  def load_seed; end

  # Invoke the server registered hooks.
  # Check <tt>Rails::Railtie.server</tt> for more info.
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:479
  def load_server(app = T.unsafe(nil)); end

  # Load Rake, railties tasks and invoke the registered hooks.
  # Check <tt>Rails::Railtie.rake_tasks</tt> for more info.
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:462
  def load_tasks(app = T.unsafe(nil)); end

  # source://railties-6.1.7.10/lib/rails/engine.rb:429
  def middleware(*_arg0, &_arg1); end

  # source://railties-6.1.7.10/lib/rails/engine.rb:429
  def paths(*_arg0, &_arg1); end

  # source://railties-6.1.7.10/lib/rails/engine.rb:498
  def railties; end
  ...
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:549
  def routes(&block); end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:668
  def routes?; end

  protected

  # source://railties-6.1.7.10/lib/rails/engine.rb:673
  def run_tasks_blocks(*_arg0); end

  private

  # source://railties-6.1.7.10/lib/rails/engine.rb:705
  def _all_autoload_once_paths; end

  # source://railties-6.1.7.10/lib/rails/engine.rb:709
  def _all_autoload_paths; end

  # source://railties-6.1.7.10/lib/rails/engine.rb:713
  def _all_load_paths(add_autoload_paths_to_load_path); end

  # source://railties-6.1.7.10/lib/rails/engine.rb:729
  def build_middleware; end

  # source://railties-6.1.7.10/lib/rails/engine.rb:721
  def build_request(env); end

  # source://railties-6.1.7.10/lib/rails/engine.rb:701
  def default_middleware_stack; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/engine.rb:685
  def has_migrations?; end

  # source://railties-6.1.7.10/lib/rails/engine.rb:679
  ...
  class << self
    ...
    #
    # source://railties-6.1.7.10/lib/rails/engine.rb:353
    def called_from; end
    ...
    # source://railties-6.1.7.10/lib/rails/engine.rb:358
    def eager_load!(*_arg0, &_arg1); end

    # source://railties-6.1.7.10/lib/rails/engine.rb:378
    def endpoint(endpoint = T.unsafe(nil)); end

    # source://railties-6.1.7.10/lib/rails/railtie.rb:176
    def engine_name(name = T.unsafe(nil)); end

    # Finds engine with given path.
    #
    # source://railties-6.1.7.10/lib/rails/engine.rb:416
    def find(path); end

    # source://railties-6.1.7.10/lib/rails/engine.rb:374
    def find_root(from); end

    # source://railties-6.1.7.10/lib/rails/engine.rb:689
    def find_root_with_flag(flag, root_path, default = T.unsafe(nil)); end

    # @private
    #
    # source://railties-6.1.7.10/lib/rails/engine.rb:360
    def inherited(base); end

    # source://railties-6.1.7.10/lib/rails/engine.rb:384
    def isolate_namespace(mod); end
...
# source://railties-6.1.7.10/lib/rails/engine/configuration.rb:7
class Rails::Engine::Configuration < ::Rails::Railtie::Configuration
  # @return [Configuration] a new instance of Configuration
  #
  # source://railties-6.1.7.10/lib/rails/engine/configuration.rb:12
  def initialize(root = T.unsafe(nil)); end

  # source://railties-6.1.7.10/lib/rails/engine/configuration.rb:83
  ...
  #
  # source://railties-6.1.7.10/lib/rails/engine/configuration.rb:10
  def autoload_once_paths=(_arg0); end

  # source://railties-6.1.7.10/lib/rails/engine/configuration.rb:87
  ...
  # source://railties-6.1.7.10/lib/rails/engine/configuration.rb:79
  ...
  # @yield [@generators]
  #
  # source://railties-6.1.7.10/lib/rails/engine/configuration.rb:32
  def generators; end

  # Returns the value of attribute javascript_path.
  #
  # source://railties-6.1.7.10/lib/rails/engine/configuration.rb:9
  ...
  # source://railties-6.1.7.10/lib/rails/engine/configuration.rb:38
  def paths; end

  # Returns the value of attribute root.
  #
  # source://railties-6.1.7.10/lib/rails/engine/configuration.rb:8
  def root; end

  # source://railties-6.1.7.10/lib/rails/engine/configuration.rb:75
  def root=(value); end
end

# source://railties-6.1.7.10/lib/rails/engine/railties.rb:5
class Rails::Engine::Railties
  include ::Enumerable

  # @return [Railties] a new instance of Railties
  #
  # source://railties-6.1.7.10/lib/rails/engine/railties.rb:9
  def initialize; end

  # source://railties-6.1.7.10/lib/rails/engine/railties.rb:18
  def -(others); end

  # Returns the value of attribute _all.
  #
  # source://railties-6.1.7.10/lib/rails/engine/railties.rb:7
  def _all; end

  # source://railties-6.1.7.10/lib/rails/engine/railties.rb:14
  def each(*args, &block); end
end

# source://railties-6.1.7.10/lib/rails/generators.rb:17
module Rails::Generators
  include ::Rails::Command::Behavior
  extend ::Rails::Command::Behavior::ClassMethods

  # source://railties-6.1.7.10/lib/rails/generators.rb:30
  def namespace; end
  ...
  class << self
    # source://railties-6.1.7.10/lib/rails/generators.rb:289
    def add_generated_file(file); end

    # source://railties-6.1.7.10/lib/rails/generators.rb:97
    def after_generate_callbacks; end

    # source://railties-6.1.7.10/lib/rails/generators.rb:89
    def aliases; end
    ...
    #
    # source://railties-6.1.7.10/lib/rails/generators.rb:121
    def api_only!; end

    # source://railties-6.1.7.10/lib/rails/generators.rb:73
    ...
    #
    # source://railties-6.1.7.10/lib/rails/generators.rb:113
    def fallbacks; end
    ...
    # Rails looks for is the first and last parts of the namespace.
    #
    # source://railties-6.1.7.10/lib/rails/generators.rb:244
    def find_by_namespace(name, base = T.unsafe(nil), context = T.unsafe(nil)); end

    # Show help message with available generators.
    #
    # source://railties-6.1.7.10/lib/rails/generators.rb:180
    ...
    #
    # source://railties-6.1.7.10/lib/rails/generators.rb:140
    def hidden_namespaces; end

    # source://railties-6.1.7.10/lib/rails/generators.rb:174
    ...
    # commands.
    #
    # source://railties-6.1.7.10/lib/rails/generators.rb:271
    ...
    # source://railties-6.1.7.10/lib/rails/generators.rb:93
    def options; end

    # source://railties-6.1.7.10/lib/rails/generators.rb:201
    def print_generators; end

    # source://railties-6.1.7.10/lib/rails/generators.rb:196
    def public_namespaces; end

    # source://railties-6.1.7.10/lib/rails/generators.rb:205
    def sorted_groups; end

    # source://railties-6.1.7.10/lib/rails/generators.rb:85
    def templates_path; end

    private

    # source://railties-6.1.7.10/lib/rails/generators.rb:316
    def command_type; end

    # source://railties-6.1.7.10/lib/rails/generators.rb:324
    def file_lookup_paths; end

    # Try fallbacks for the given base.
    #
    # source://railties-6.1.7.10/lib/rails/generators.rb:301
    def invoke_fallbacks_for(name, base); end

    # source://railties-6.1.7.10/lib/rails/generators.rb:320
    def lookup_paths; end

    # source://railties-6.1.7.10/lib/rails/generators.rb:295
    def print_list(base, namespaces); end

    # source://railties-6.1.7.10/lib/rails/generators.rb:328
    def run_after_generate_callback; end
  end
end

# source://railties-6.1.7.10/lib/rails/generators/actions.rb:9
module Rails::Generators::Actions
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:10
  def initialize(*_arg0); end
  ...
  #   end
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:94
  ...
  #   end
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:120
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:21
  def gem(*args); end
  ...
  #   end
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:54
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:226
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:142
  def git(commands = T.unsafe(nil)); end

  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:68
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:215
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:175
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:251
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:241
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:196
  ...
  #   readme "README"
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:285
  def readme(path); end
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:269
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:161
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:363
  def append_file_with_newline(path, str, options = T.unsafe(nil)); end

  # Runs the supplied command using either "rake ..." or "rails ..."
  # based on the executor parameter provided.
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:304
  def execute_command(executor, command, options = T.unsafe(nil)); end

  # Add an extension to the given name based on the platform.
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:318
  def extify(name); end

  # Indent the +Gemfile+ to the depth of @indentation
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:350
  def indentation; end
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:293
  def log(*args); end

  # Returns optimized string with indentation
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:344
  def optimize_indentation(value, amount = T.unsafe(nil)); end

  # Surround string with single quotes if there is no quotes.
  # Otherwise fall back to double quotes
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:328
  def quote(value); end

  # Manage +Gemfile+ indentation for a DSL action block
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions.rb:355
  def with_indentation(&block); end
end

# source://railties-6.1.7.10/lib/rails/generators/actions/create_migration.rb:9
class Rails::Generators::Actions::CreateMigration < ::Thor::Actions::CreateFile
  # source://railties-6.1.7.10/lib/rails/generators/actions/create_migration.rb:41
  ...
  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/actions/create_migration.rb:18
  def identical?; end

  # source://railties-6.1.7.10/lib/rails/generators/actions/create_migration.rb:22
  def invoke!; end

  # source://railties-6.1.7.10/lib/rails/generators/actions/create_migration.rb:10
  def migration_dir; end

  # source://railties-6.1.7.10/lib/rails/generators/actions/create_migration.rb:14
  def migration_file_name; end

  # source://railties-6.1.7.10/lib/rails/generators/actions/create_migration.rb:37
  def relative_existing_migration; end

  # source://railties-6.1.7.10/lib/rails/generators/actions/create_migration.rb:29
  def revoke!; end

  private

  # source://railties-6.1.7.10/lib/rails/generators/actions/create_migration.rb:50
  def on_conflict_behavior; end

  # source://railties-6.1.7.10/lib/rails/generators/actions/create_migration.rb:71
...
# instead of self.new.
#
# source://railties-6.1.7.10/lib/rails/generators/active_model.rb:28
class Rails::Generators::ActiveModel
  # @return [ActiveModel] a new instance of ActiveModel
  #
  # source://railties-6.1.7.10/lib/rails/generators/active_model.rb:31
  def initialize(name); end

  # DELETE destroy
  #
  # source://railties-6.1.7.10/lib/rails/generators/active_model.rb:75
  def destroy; end

  # POST create
  # PATCH/PUT update
  #
  # source://railties-6.1.7.10/lib/rails/generators/active_model.rb:70
  def errors; end

  # Returns the value of attribute name.
  #
  # source://railties-6.1.7.10/lib/rails/generators/active_model.rb:29
  def name; end

  # POST create
  #
  # source://railties-6.1.7.10/lib/rails/generators/active_model.rb:59
  def save; end

  # PATCH/PUT update
  #
  # source://railties-6.1.7.10/lib/rails/generators/active_model.rb:64
  def update(params = T.unsafe(nil)); end

  class << self
    # GET index
    #
    # source://railties-6.1.7.10/lib/rails/generators/active_model.rb:36
    def all(klass); end

    # GET new
    # POST create
    #
    # source://railties-6.1.7.10/lib/rails/generators/active_model.rb:50
    ...
    # DELETE destroy
    #
    # source://railties-6.1.7.10/lib/rails/generators/active_model.rb:44
    def find(klass, params = T.unsafe(nil)); end
  end
end

# source://railties-6.1.7.10/lib/rails/generators/app_name.rb:5
module Rails::Generators::AppName
  private

  # source://railties-6.1.7.10/lib/rails/generators/app_name.rb:33
  def app_const; end

  # source://railties-6.1.7.10/lib/rails/generators/app_name.rb:28
  def app_const_base; end

  # source://railties-6.1.7.10/lib/rails/generators/app_name.rb:9
  def app_name; end

  # source://railties-6.1.7.10/lib/rails/generators/app_name.rb:28
  def camelized; end

  # source://railties-6.1.7.10/lib/rails/generators/app_name.rb:21
  def defined_app_const_base; end

  # source://railties-6.1.7.10/lib/rails/generators/app_name.rb:21
  def defined_app_const_base?; end

  # source://railties-6.1.7.10/lib/rails/generators/app_name.rb:17
  def defined_app_name; end

  # source://railties-6.1.7.10/lib/rails/generators/app_name.rb:13
  def original_app_name; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/app_name.rb:37
  def valid_const?; end
end

# source://railties-6.1.7.10/lib/rails/generators/app_name.rb:6
Rails::Generators::AppName::RESERVED_NAMES = T.let(T.unsafe(nil), Array)

# source://railties-6.1.7.10/lib/rails/generators/base.rb:17
class Rails::Generators::Base < ::Thor::Group
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/base.rb:256
  def class_collisions(*class_names); end

  # Takes in an array of nested modules and extracts the last module
  #
  # source://railties-6.1.7.10/lib/rails/generators/base.rb:279
  def extract_last_module(nesting); end

  # source://railties-6.1.7.10/lib/rails/generators/base.rb:294
  def indent(content, multiplier = T.unsafe(nil)); end

  # Wrap block with namespace of current application
  # if namespace exists and is not skipped
  #
  # source://railties-6.1.7.10/lib/rails/generators/base.rb:288
  def module_namespacing(&block); end

  # source://railties-6.1.7.10/lib/rails/generators/base.rb:304
  def namespace; end

  # source://railties-6.1.7.10/lib/rails/generators/base.rb:312
  def namespace_dirs; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/base.rb:308
  def namespaced?; end

  # source://railties-6.1.7.10/lib/rails/generators/base.rb:316
  def namespaced_path; end

  # source://railties-6.1.7.10/lib/rails/generators/base.rb:299
  ...
  class << self
    ...
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:392
    def add_shebang_option!; end

    # Use Rails default banner.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:321
    def banner; end

    # Sets the base_name taking into account the current class namespace.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:326
    def base_name; end

    # Returns the base root for a common set of generators. This is used to dynamically
    # guess the default source root.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:228
    def base_root; end

    # Make class option aware of Rails::Generators.options and Rails::Generators.aliases.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:209
    def class_option(name, options = T.unsafe(nil)); end

    # Returns default aliases for the option name given doing a lookup in
    # Rails::Generators.aliases.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:353
    def default_aliases_for_option(name, options); end

    # Returns default for the option name given doing a lookup in config.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:358
    def default_for_option(config, name, options, default); end

    # source://railties-6.1.7.10/lib/rails/generators/base.rb:418
    ...
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:219
    def default_source_root; end

    # Returns the default value for the option name given doing a lookup in
    # Rails::Generators.options.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:347
    def default_value_for_option(name, options); end

    # Tries to get the description from a USAGE file one folder above the source
    # root otherwise uses a default description.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:41
    def desc(description = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:29
    def exit_on_failure?; end

    # Removes the namespaces and get the generator name. For example,
    # Rails::Generators::ModelGenerator will return "model" as generator name.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:336
    def generator_name; end

    # Convenience method to hide this generator from the available ones when
    # running rails generator command.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:61
    def hide!; end
    ...
    #   end
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:174
    def hook_for(*names, &block); end

    # Keep hooks configuration that are used on prepare_for_invocation.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:371
    def hooks; end

    # Cache source root and add lib/generators/base/generator/templates to
    # source paths.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:234
    def inherited(base); end
    ...
    # is removed.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:54
    def namespace(name = T.unsafe(nil)); end

    # Prepare class invocation to search on Rails namespace if a previous
    # added hook is being used.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:377
    ...
    #   remove_hook_for :orm
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:200
    def remove_hook_for(*names); end

    # Returns the source root for this generator using default_source_root as default.
    #
    # source://railties-6.1.7.10/lib/rails/generators/base.rb:34
    def source_root(path = T.unsafe(nil)); end

    # source://railties-6.1.7.10/lib/rails/generators/base.rb:410
    def usage_path; end
  end
end

# source://railties-6.1.7.10/lib/rails/generators.rb:32
Rails::Generators::DEFAULT_ALIASES = T.let(T.unsafe(nil), Hash)

# source://railties-6.1.7.10/lib/rails/generators.rb:52
Rails::Generators::DEFAULT_OPTIONS = T.let(T.unsafe(nil), Hash)

# source://railties-6.1.7.10/lib/rails/generators/database.rb:5
module Rails::Generators::Database
  # source://railties-6.1.7.10/lib/rails/generators/database.rb:9
  def initialize(*_arg0); end

  # source://railties-6.1.7.10/lib/rails/generators/database.rb:29
  def convert_database_option_for_jruby; end

  # source://railties-6.1.7.10/lib/rails/generators/database.rb:14
  def gem_for_database(database = T.unsafe(nil)); end

  private

  # source://railties-6.1.7.10/lib/rails/generators/database.rb:42
  def mysql_socket; end
end

# source://railties-6.1.7.10/lib/rails/generators/database.rb:7
Rails::Generators::Database::DATABASES = T.let(T.unsafe(nil), Array)

# source://railties-6.1.7.10/lib/rails/generators/database.rb:6
Rails::Generators::Database::JDBC_DATABASES = T.let(T.unsafe(nil), Array)

# source://railties-6.1.7.10/lib/rails/generators/base.rb:14
class Rails::Generators::Error < ::Thor::Error; end

# source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:7
class Rails::Generators::GeneratedAttribute
  # @return [GeneratedAttribute] a new instance of GeneratedAttribute
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:61
  def initialize(name, type = T.unsafe(nil), index_type = T.unsafe(nil), attr_options = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:163
  def attachment?; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:167
  def attachments?; end

  # Returns the value of attribute attr_options.
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:12
  def attr_options; end

  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:123
  def column_name; end

  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:85
  def default; end

  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:69
  def field_type; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:127
  def foreign_key?; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:143
  def has_index?; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:147
  def has_uniq_index?; end

  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:111
  def human_name; end

  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:115
  def index_name; end
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:13
  def index_name=(_arg0); end

  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:179
  def inject_index_options; end

  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:175
  def inject_options; end

  # Returns the value of attribute name.
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:11
  def name; end
  ...
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:183
  def options_for_migration; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:151
  def password_digest?; end

  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:103
  def plural_name; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:135
  def polymorphic?; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:131
  def reference?; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:139
  def required?; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:159
  def rich_text?; end

  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:107
  def singular_name; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:155
  def token?; end
  ...
  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:171
  def virtual?; end

  class << self
    # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:16
    def parse(column_definition); end

    # @return [Boolean]
    #
    # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:36
    ...
    #
    # source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:43
    def parse_type_and_options(type); end
  end
end

# source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:8
Rails::Generators::GeneratedAttribute::INDEX_OPTIONS = T.let(T.unsafe(nil), Array)

# source://railties-6.1.7.10/lib/rails/generators/generated_attribute.rb:9
...
module Rails::Generators::Migration
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/migration.rb:56
  def migration_template(source, destination, config = T.unsafe(nil)); end

  # source://railties-6.1.7.10/lib/rails/generators/migration.rb:39
  def set_migration_assigns!(destination); end
end

# source://railties-6.1.7.10/lib/rails/generators/migration.rb:15
module Rails::Generators::Migration::ClassMethods
  # source://railties-6.1.7.10/lib/rails/generators/migration.rb:24
  def current_migration_number(dirname); end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/migration.rb:20
  def migration_exists?(dirname, file_name); end

  # source://railties-6.1.7.10/lib/rails/generators/migration.rb:16
  def migration_lookup_at(dirname); end

  # @raise [NotImplementedError]
  #
  # source://railties-6.1.7.10/lib/rails/generators/migration.rb:30
  def next_migration_number(dirname); end
end

# source://railties-6.1.7.10/lib/rails/generators/model_helpers.rb:7
module Rails::Generators::ModelHelpers
  # source://railties-6.1.7.10/lib/rails/generators/model_helpers.rb:25
  def initialize(args, *_options); end

  # source://railties-6.1.7.10/lib/rails/generators/model_helpers.rb:19
  def skip_warn; end
  ...
  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/model_helpers.rb:55
  def inflection_impossible?(name); end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/model_helpers.rb:51
  def irregular_model_name?(name); end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/model_helpers.rb:47
  def plural_model_name?(name); end

  class << self
    # source://railties-6.1.7.10/lib/rails/generators/model_helpers.rb:21
...
class Rails::Generators::NamedBase < ::Rails::Generators::Base
  ...
  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:29
  def js_template(source, destination); end

  # source://thor-1.5.0/lib/thor/base.rb:164
  def name; end

  # source://thor-1.5.0/lib/thor/base.rb:164
  def name=(_arg0); end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:23
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:138
  def application_name; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:175
  def assign_names!(name); end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:188
  def attributes_names; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:70
  def class_name; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:58
  def class_path; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:105
  def edit_helper; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:54
  def file_path; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:125
  def fixture_file_name; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:74
  def human_name; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:82
  def i18n_scope; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:97
  def index_helper; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:43
  def inside_template; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:50
  def inside_template?; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:150
  def model_resource_name(prefix: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:200
  def mountable_engine?; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:66
  def namespaced_class_path; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:109
  def new_helper; end

  # Convert attributes array into GeneratedAttribute objects.
  #
  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:182
  def parse_attributes!; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:121
  def plural_file_name; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:78
  def plural_name; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:167
  def plural_route_name; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:117
  def plural_table_name; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:196
  def pluralize_table_names?; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:146
  def redirect_resource_name; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:62
  def regular_class_path; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:129
  def route_url; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:101
  def show_helper; end

  # FIXME: We are avoiding to use alias because a bug on thor that make
  # this method public and add it to the task list.
  #
  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:39
  def singular_name; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:159
  def singular_route_name; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:113
  def singular_table_name; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:86
  def table_name; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:93
  def uncountable?; end

  # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:133
  ...
  class << self
    ...
    #
    # source://railties-6.1.7.10/lib/rails/generators/named_base.rb:214
...
# ActiveModel.
#
# source://railties-6.1.7.10/lib/rails/generators/resource_helpers.rb:10
module Rails::Generators::ResourceHelpers
  include ::Rails::Generators::ModelHelpers

  # Set controller variables on initialization.
  #
  # source://railties-6.1.7.10/lib/rails/generators/resource_helpers.rb:17
  def initialize(*args); end

  private

  # source://railties-6.1.7.10/lib/rails/generators/resource_helpers.rb:39
  def assign_controller_names!(name); end

  # source://railties-6.1.7.10/lib/rails/generators/resource_helpers.rb:50
  def controller_class_name; end

  # source://railties-6.1.7.10/lib/rails/generators/resource_helpers.rb:31
  def controller_class_path; end

  # Returns the value of attribute controller_file_name.
  #
  # source://railties-6.1.7.10/lib/rails/generators/resource_helpers.rb:29
  def controller_file_name; end

  # source://railties-6.1.7.10/lib/rails/generators/resource_helpers.rb:46
  def controller_file_path; end

  # source://railties-6.1.7.10/lib/rails/generators/resource_helpers.rb:54
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/resource_helpers.rb:61
  def orm_class; end

  # Initialize ORM::Generators::ActiveModel to access instance methods.
  #
  # source://railties-6.1.7.10/lib/rails/generators/resource_helpers.rb:77
  def orm_instance(name = T.unsafe(nil)); end

  class << self
    # source://railties-6.1.7.10/lib/rails/generators/resource_helpers.rb:11
    def included(base); end
  end
end
...
#   end
#
# source://railties-6.1.7.10/lib/rails/generators/test_case.rb:30
class Rails::Generators::TestCase < ::ActiveSupport::TestCase
  ...
  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:21
  ...
  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:22
  ...
  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:23
  ...
  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:24
...
# source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:13
module Rails::Generators::Testing; end

# source://railties-6.1.7.10/lib/rails/generators/testing/assertions.rb:6
module Rails::Generators::Testing::Assertions
  ...
  #   end
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/assertions.rb:88
  ...
  #   end
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/assertions.rb:25
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/assertions.rb:117
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/assertions.rb:110
  ...
  #   end
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/assertions.rb:100
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/assertions.rb:64
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/assertions.rb:47
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/assertions.rb:74
  def assert_no_migration(relative); end
end

# source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:14
module Rails::Generators::Testing::Behaviour
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:86
  def create_generated_attribute(attribute_type, name = T.unsafe(nil), index = T.unsafe(nil)); end

  # Instantiate the generator.
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:78
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:67
  ...
  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:91
  def destination_root_is_set?; end

  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:95
  def ensure_current_path; end

  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:105
  def migration_file_name(relative); end

  # Clears all files and directories in destination.
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:100
...
# source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:27
module Rails::Generators::Testing::Behaviour::ClassMethods
  ...
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:39
  ...
  #   destination File.expand_path("../tmp", __dir__)
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:46
  ...
  #   tests AppGenerator
  #
  # source://railties-6.1.7.10/lib/rails/generators/testing/behaviour.rb:31
  def tests(klass); end
end

# source://railties-6.1.7.10/lib/rails/generators/testing/setup_and_teardown.rb:6
module Rails::Generators::Testing::SetupAndTeardown
  # source://railties-6.1.7.10/lib/rails/generators/testing/setup_and_teardown.rb:7
  def setup; end

  # source://railties-6.1.7.10/lib/rails/generators/testing/setup_and_teardown.rb:13
  def teardown; end
end

# source://rails-html-sanitizer-1.7.1/lib/rails-html-sanitizer.rb:11
...
#
# source://railties-6.1.7.10/lib/rails/info.rb:9
module Rails::Info
  # source://railties-6.1.7.10/lib/rails/info.rb:10
  def properties; end
  ...
  class << self
    # source://railties-6.1.7.10/lib/rails/info.rb:31
    def inspect; end
    ...
    # source://railties-6.1.7.10/lib/rails/info.rb:25
    def property(name, value = T.unsafe(nil)); end

    # source://railties-6.1.7.10/lib/rails/info.rb:43
    def to_html; end
...
# source://railties-6.1.7.10/lib/rails/info_controller.rb:6
class Rails::InfoController < ::Rails::ApplicationController
  # source://railties-6.1.7.10/lib/rails/info_controller.rb:12
  def index; end

  # source://railties-6.1.7.10/lib/rails/info_controller.rb:16
  def properties; end

  # source://railties-6.1.7.10/lib/rails/info_controller.rb:21
  def routes; end
  ...
  # source://railties-6.1.7.10/lib/rails/info_controller.rb:8
  def _layout_from_proc; end

  # source://railties-6.1.7.10/lib/rails/info_controller.rb:36
  def match_route; end

  # source://railties-6.1.7.10/lib/rails/info_controller.rb:42
...
# source://railties-6.1.7.10/lib/rails/initializable.rb:6
module Rails::Initializable
  mixes_in_class_methods ::Rails::Initializable::ClassMethods

  # source://railties-6.1.7.10/lib/rails/initializable.rb:66
  def initializers; end

  # source://railties-6.1.7.10/lib/rails/initializable.rb:58
  def run_initializers(group = T.unsafe(nil), *args); end

  class << self
    # source://railties-6.1.7.10/lib/rails/initializable.rb:7
    def included(base); end
  end
end

# source://railties-6.1.7.10/lib/rails/initializable.rb:70
module Rails::Initializable::ClassMethods
  # @raise [ArgumentError]
  #
  # source://railties-6.1.7.10/lib/rails/initializable.rb:88
  def initializer(name, opts = T.unsafe(nil), &blk); end

  # source://railties-6.1.7.10/lib/rails/initializable.rb:71
  def initializers; end

  # source://railties-6.1.7.10/lib/rails/initializable.rb:75
  def initializers_chain; end

  # source://railties-6.1.7.10/lib/rails/initializable.rb:84
  def initializers_for(binding); end
end

# source://railties-6.1.7.10/lib/rails/initializable.rb:45
class Rails::Initializable::Collection < ::Array
  include ::TSort

  # source://railties-6.1.7.10/lib/rails/initializable.rb:53
  def +(other); end

  # source://railties-6.1.7.10/lib/rails/initializable.rb:49
  def tsort_each_child(initializer, &block); end

  def tsort_each_node; end
end

# source://railties-6.1.7.10/lib/rails/initializable.rb:11
class Rails::Initializable::Initializer
  # @return [Initializer] a new instance of Initializer
  #
  # source://railties-6.1.7.10/lib/rails/initializable.rb:14
  def initialize(name, context, options, &block); end

  # source://railties-6.1.7.10/lib/rails/initializable.rb:23
  def after; end

  # source://railties-6.1.7.10/lib/rails/initializable.rb:19
  def before; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/initializable.rb:27
  def belongs_to?(group); end

  # source://railties-6.1.7.10/lib/rails/initializable.rb:35
  def bind(context); end

  # Returns the value of attribute block.
  #
  # source://railties-6.1.7.10/lib/rails/initializable.rb:12
  def block; end

  # source://railties-6.1.7.10/lib/rails/initializable.rb:40
  ...
  # source://railties-6.1.7.10/lib/rails/initializable.rb:31
  def run(*args); end
end

# source://railties-6.1.7.10/lib/rails/test_unit/line_filtering.rb:6
module Rails::LineFiltering
  # source://railties-6.1.7.10/lib/rails/test_unit/line_filtering.rb:7
  def run(reporter, options = T.unsafe(nil)); end
end

# source://railties-6.1.7.10/lib/rails/mailers_controller.rb:5
class Rails::MailersController < ::Rails::ApplicationController
  # source://railties-6.1.7.10/lib/rails/mailers_controller.rb:16
  def index; end

  # source://railties-6.1.7.10/lib/rails/mailers_controller.rb:21
  def preview; end
  ...
  # source://railties-6.1.7.10/lib/rails/mailers_controller.rb:80
  def find_part(format); end

  # source://railties-6.1.7.10/lib/rails/mailers_controller.rb:68
  def find_preferred_part(*formats); end

  # source://railties-6.1.7.10/lib/rails/mailers_controller.rb:56
  def find_preview; end

  # source://railties-6.1.7.10/lib/rails/mailers_controller.rb:92
  def locale_query(locale); end

  # source://railties-6.1.7.10/lib/rails/mailers_controller.rb:88
  def part_query(mime_type); end

  # source://railties-6.1.7.10/lib/rails/mailers_controller.rb:96
  def set_locale; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/mailers_controller.rb:52
...
# source://railties-6.1.7.10/lib/rails/mailers_controller.rb:0
module Rails::MailersController::HelperMethods
  include ::Ransack::Helpers::FormHelper
  include ::ActionController::Base::HelperMethods

  # source://railties-6.1.7.10/lib/rails/mailers_controller.rb:12
...
# source://railties-6.1.7.10/lib/rails/paths.rb:6
module Rails::Paths; end

# source://railties-6.1.7.10/lib/rails/paths.rb:111
class Rails::Paths::Path
  include ::Enumerable

  # @return [Path] a new instance of Path
  #
  # source://railties-6.1.7.10/lib/rails/paths.rb:116
  def initialize(root, current, paths, options = T.unsafe(nil)); end

  # source://railties-6.1.7.10/lib/rails/paths.rb:168
  def <<(path); end

  # source://railties-6.1.7.10/lib/rails/paths.rb:129
  def absolute_current; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:150
  def autoload!; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:158
  def autoload?; end
  ...
  # source://railties-6.1.7.10/lib/rails/paths.rb:133
  def children; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:173
  def concat(paths); end

  # source://railties-6.1.7.10/lib/rails/paths.rb:164
  def each(&block); end
  ...
  #
  # source://railties-6.1.7.10/lib/rails/paths.rb:217
  def existent; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:228
  def existent_directories; end

  # Expands all paths against the root and return all unique values.
  #
  # source://railties-6.1.7.10/lib/rails/paths.rb:198
  def expanded; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:193
  def extensions; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:140
  def first; end

  # Returns the value of attribute glob.
  #
  # source://railties-6.1.7.10/lib/rails/paths.rb:114
  def glob; end
  ...
  # source://railties-6.1.7.10/lib/rails/paths.rb:144
  def last; end
  ...
  # source://railties-6.1.7.10/lib/rails/paths.rb:185
  def paths; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:168
  def push(path); end

  # source://railties-6.1.7.10/lib/rails/paths.rb:154
  ...
  # source://railties-6.1.7.10/lib/rails/paths.rb:181
  def to_ary; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:177
  def unshift(*paths); end

  private

  # source://railties-6.1.7.10/lib/rails/paths.rb:235
...
#
# source://railties-6.1.7.10/lib/rails/paths.rb:48
class Rails::Paths::Root
  # @return [Root] a new instance of Root
  #
  # source://railties-6.1.7.10/lib/rails/paths.rb:51
  def initialize(path); end

  # source://railties-6.1.7.10/lib/rails/paths.rb:66
  def [](path); end

  # source://railties-6.1.7.10/lib/rails/paths.rb:56
  def []=(path, value); end

  # source://railties-6.1.7.10/lib/rails/paths.rb:61
  def add(path, options = T.unsafe(nil)); end

  # source://railties-6.1.7.10/lib/rails/paths.rb:82
  def all_paths; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:86
  def autoload_once; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:94
  def autoload_paths; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:90
  def eager_load; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:74
  def keys; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:98
  def load_paths; end

  # Returns the value of attribute path.
  #
  # source://railties-6.1.7.10/lib/rails/paths.rb:49
  def path; end
  ...
  # source://railties-6.1.7.10/lib/rails/paths.rb:70
  def values; end

  # source://railties-6.1.7.10/lib/rails/paths.rb:78
  def values_at(*list); end

  private

  # source://railties-6.1.7.10/lib/rails/paths.rb:103
  def filter_by(&block); end
end

# source://railties-6.1.7.10/lib/rails/rack.rb:4
...
#
# source://railties-6.1.7.10/lib/rails/rack/logger.rb:16
class Rails::Rack::Logger < ::ActiveSupport::LogSubscriber
  # @return [Logger] a new instance of Logger
  #
  # source://railties-6.1.7.10/lib/rails/rack/logger.rb:17
  def initialize(app, taggers = T.unsafe(nil)); end

  # source://railties-6.1.7.10/lib/rails/rack/logger.rb:22
  def call(env); end

  private

  # source://railties-6.1.7.10/lib/rails/rack/logger.rb:33
  def call_app(request, env); end

  # source://railties-6.1.7.10/lib/rails/rack/logger.rb:56
  def compute_tags(request); end

  # source://railties-6.1.7.10/lib/rails/rack/logger.rb:69
  def finish(request); end

  # source://railties-6.1.7.10/lib/rails/rack/logger.rb:74
  def logger; end

  # Started GET "/session/new" for 127.0.0.1 at 2012-09-26 14:51:42 -0700
  #
  # source://railties-6.1.7.10/lib/rails/rack/logger.rb:48
...
#
# source://railties-6.1.7.10/lib/rails/railtie.rb:136
class Rails::Railtie
  include ::Rails::Initializable
  ...
  #
  # source://railties-6.1.7.10/lib/rails/railtie.rb:227
  def initialize; end
  ...
  #
  # source://railties-6.1.7.10/lib/rails/railtie.rb:240
  def config; end

  # source://railties-6.1.7.10/lib/rails/railtie.rb:233
  def configure(&block); end

  # source://railties-6.1.7.10/lib/rails/railtie.rb:225
  def railtie_name(*_arg0, &_arg1); end

  # source://railties-6.1.7.10/lib/rails/railtie.rb:244
  def railtie_namespace; end

  protected

  # source://railties-6.1.7.10/lib/rails/railtie.rb:249
  def run_console_blocks(app); end

  # source://railties-6.1.7.10/lib/rails/railtie.rb:253
  def run_generators_blocks(app); end

  # source://railties-6.1.7.10/lib/rails/railtie.rb:257
  def run_runner_blocks(app); end

  # source://railties-6.1.7.10/lib/rails/railtie.rb:266
  def run_server_blocks(app); end

  # source://railties-6.1.7.10/lib/rails/railtie.rb:261
  def run_tasks_blocks(app); end
  ...
  #
  # source://railties-6.1.7.10/lib/rails/railtie.rb:272
  def each_registered_block(type, &block); end

  class << self
    # @return [Boolean]
    #
    # source://railties-6.1.7.10/lib/rails/railtie.rb:172
    def abstract_railtie?; end

    # source://railties-6.1.7.10/lib/rails/railtie.rb:146
    ...
    #
    # source://railties-6.1.7.10/lib/rails/railtie.rb:190
    def configure(&block); end

    # source://railties-6.1.7.10/lib/rails/railtie.rb:156
    def console(&blk); end

    # source://railties-6.1.7.10/lib/rails/railtie.rb:164
    def generators(&blk); end

    # Since Rails::Railtie cannot be instantiated, any methods that call
    # +instance+ are intended to be called only on subclasses of a Railtie.
    #
    # source://railties-6.1.7.10/lib/rails/railtie.rb:183
    def instance; end

    # source://railties-6.1.7.10/lib/rails/railtie.rb:176
    def railtie_name(name = T.unsafe(nil)); end

    # source://railties-6.1.7.10/lib/rails/railtie.rb:152
    def rake_tasks(&blk); end

    # source://railties-6.1.7.10/lib/rails/railtie.rb:160
    def runner(&blk); end

    # source://railties-6.1.7.10/lib/rails/railtie.rb:168
    def server(&blk); end

    # source://railties-6.1.7.10/lib/rails/railtie.rb:148
    def subclasses; end

    private

    # source://railties-6.1.7.10/lib/rails/railtie.rb:195
    def generate_railtie_name(string); end

    # If the class method does not have a method, then send the method call
    # to the Railtie instance.
    #
    # source://railties-6.1.7.10/lib/rails/railtie.rb:205
    ...
    #
    # source://railties-6.1.7.10/lib/rails/railtie.rb:217
    def register_block_for(type, &blk); end

    # @return [Boolean]
    #
    # source://railties-6.1.7.10/lib/rails/railtie.rb:199
    def respond_to_missing?(name, _); end
  end
end

# source://railties-6.1.7.10/lib/rails/railtie.rb:142
Rails::Railtie::ABSTRACT_RAILTIES = T.let(T.unsafe(nil), Array)

# source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:8
class Rails::Railtie::Configuration
  # @return [Configuration] a new instance of Configuration
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:9
  def initialize; end

  # Last configurable block to run. Called after frameworks initialize.
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:71
  ...
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:48
  ...
  # created
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:40
  def app_middleware; end

  # First configurable block to run. Called before any initializers are run.
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:55
  def before_configuration(&block); end

  # Third configurable block to run. Does not run if +config.eager_load+
  # set to false.
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:61
  def before_eager_load(&block); end

  # Second configurable block to run. Called before frameworks initialize.
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:66
  def before_initialize(&block); end

  # All namespaces that are eager loaded
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:19
  def eager_load_namespaces; end

  # @return [Boolean]
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:86
  def respond_to?(name, include_private = T.unsafe(nil)); end

  # Defines generic callbacks to run before #after_initialize. Useful for
  # Rails::Railtie subclasses.
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:82
  def to_prepare(&blk); end

  # Array of callbacks defined by #to_prepare.
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:76
  ...
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:31
  def watchable_dirs; end

  # Add files that should be watched for change.
  #
  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:24
  def watchable_files; end

  private

  # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:91
  def method_missing(name, *args, &blk); end

  class << self
    # Expose the eager_load_namespaces at "module" level for convenience.
    #
    # source://railties-6.1.7.10/lib/rails/railtie/configuration.rb:14
    def eager_load_namespaces; end
  end
end
...
#
# source://railties-6.1.7.10/lib/rails/secrets.rb:9
class Rails::Secrets
  class << self
    # source://railties-6.1.7.10/lib/rails/secrets.rb:46
    def decrypt(data); end

    # source://railties-6.1.7.10/lib/rails/secrets.rb:42
    def encrypt(data); end

    # source://railties-6.1.7.10/lib/rails/secrets.rb:38
    def key; end

    # source://railties-6.1.7.10/lib/rails/secrets.rb:25
    def parse(paths, env:); end

    # source://railties-6.1.7.10/lib/rails/secrets.rb:50
    def read; end

    # source://railties-6.1.7.10/lib/rails/secrets.rb:59
    ...
    #
    # source://railties-6.1.7.10/lib/rails/secrets.rb:23
    def root=(_arg0); end

    # source://railties-6.1.7.10/lib/rails/secrets.rb:54
    def write(contents); end

    private

    # source://railties-6.1.7.10/lib/rails/secrets.rb:105
    def encryptor; end

    # @raise [MissingKeyError]
    #
    # source://railties-6.1.7.10/lib/rails/secrets.rb:64
    def handle_missing_key; end

    # source://railties-6.1.7.10/lib/rails/secrets.rb:74
    def key_path; end

    # source://railties-6.1.7.10/lib/rails/secrets.rb:78
    def path; end

    # source://railties-6.1.7.10/lib/rails/secrets.rb:82
    def preprocess(path); end

    # source://railties-6.1.7.10/lib/rails/secrets.rb:68
    def read_key_file; end

    # source://railties-6.1.7.10/lib/rails/secrets.rb:90
    def writing(contents); end
  end
end

# source://railties-6.1.7.10/lib/rails/secrets.rb:10
class Rails::Secrets::MissingKeyError < ::RuntimeError
  # @return [MissingKeyError] a new instance of MissingKeyError
  #
  # source://railties-6.1.7.10/lib/rails/secrets.rb:11
  def initialize; end
end
...
#
# source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:13
class Rails::SourceAnnotationExtractor
  # @return [SourceAnnotationExtractor] a new instance of SourceAnnotationExtractor
  #
  # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:85
  def initialize(tag); end

  # Prints the mapping from filenames to annotations in +results+ ordered by filename.
  # The +options+ hash is passed to each annotation's +to_s+.
  #
  # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:137
  ...
  #
  # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:125
  def extract_annotations_from(file, pattern); end

  # Returns a hash that maps filenames under +dirs+ (recursively) to arrays
  # with their annotations.
  #
  # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:91
  def find(dirs); end
  ...
  #
  # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:99
  def find_in(dir); end

  # Returns the value of attribute tag.
  #
  # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:83
  def tag; end
  ...
  class << self
    ...
    #
    # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:76
    def enumerate(tag = T.unsafe(nil), options = T.unsafe(nil)); end
  end
end

# source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:14
class Rails::SourceAnnotationExtractor::Annotation < ::Struct
  ...
  #
  # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:55
  def to_s(options = T.unsafe(nil)); end

  class << self
    # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:15
    def directories; end

    # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:35
    def extensions; end

    # Registers additional directories to be included
    #   Rails::SourceAnnotationExtractor::Annotation.register_directories("spec", "another")
    #
    # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:21
    def register_directories(*dirs); end

    # Registers new Annotations File Extensions
    #   Rails::SourceAnnotationExtractor::Annotation.register_extensions("css", "scss", "sass", "less", "js") { |tag| /\/\/\s*(#{tag}):?\s*(.*)$/ }
    #
    # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:41
    def register_extensions(*exts, &block); end

    # Registers additional tags
    #   Rails::SourceAnnotationExtractor::Annotation.register_tags("TESTME", "DEPRECATEME")
    #
    # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:31
    def register_tags(*additional_tags); end

    # source://railties-6.1.7.10/lib/rails/source_annotation_extractor.rb:25
    def tags; end
  end
end

# source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:9
module Rails::TestUnit; end

# source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:98
class Rails::TestUnit::CompositeFilter
  # @return [CompositeFilter] a new instance of CompositeFilter
  #
  # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:101
  def initialize(runnable, filter, patterns); end

  # minitest uses === to find matching filters.
  #
  # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:108
  def ===(method); end

  # Returns the value of attribute named_filter.
  #
  # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:99
  def named_filter; end

  private

  # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:123
  def derive_line_filters(patterns); end

  # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:113
  def derive_named_filter(filter); end
end

# source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:134
class Rails::TestUnit::Filter
  # @return [Filter] a new instance of Filter
  #
  # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:135
  def initialize(runnable, file, line); end

  # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:140
  def ===(method); end

  private

  # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:152
  def definition_for(method); end
end

# source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:10
class Rails::TestUnit::Runner
  # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:11
  def filters; end

  class << self
    # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:14
    def attach_before_load_options(opts); end

    # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:53
    def compose_filter(runnable, filter); end

    # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:11
    def filters; end

    # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:44
    def load_tests(argv); end

    # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:19
    def parse_options(argv); end

    # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:32
    def rake_run(argv = T.unsafe(nil)); end

    # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:38
    def run(argv = T.unsafe(nil)); end

    private

    # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:84
    def default_test_exclude_glob; end

    # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:80
    def default_test_glob; end

    # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:62
    def extract_filters(argv); end

    # @return [Boolean]
    #
    # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:92
    def path_argument?(arg); end

    # @return [Boolean]
    #
    # source://railties-6.1.7.10/lib/rails/test_unit/runner.rb:88
    def regexp_filter?(arg); end
  end
end

# source://railties-6.1.7.10/lib/rails/test_unit/railtie.rb:10
class Rails::TestUnitRailtie < ::Rails::Railtie; end

# source://railties-6.1.7.10/lib/rails/gem_version.rb:9
module Rails::VERSION; end

# source://railties-6.1.7.10/lib/rails/gem_version.rb:10
Rails::VERSION::MAJOR = T.let(T.unsafe(nil), Integer)

# source://railties-6.1.7.10/lib/rails/gem_version.rb:11
Rails::VERSION::MINOR = T.let(T.unsafe(nil), Integer)

# source://railties-6.1.7.10/lib/rails/gem_version.rb:13
Rails::VERSION::PRE = T.let(T.unsafe(nil), String)

# source://railties-6.1.7.10/lib/rails/gem_version.rb:15
Rails::VERSION::STRING = T.let(T.unsafe(nil), String)

# source://railties-6.1.7.10/lib/rails/gem_version.rb:12
Rails::VERSION::TINY = T.let(T.unsafe(nil), Integer)

# source://railties-6.1.7.10/lib/rails/welcome_controller.rb:5
class Rails::WelcomeController < ::Rails::ApplicationController
  # source://railties-6.1.7.10/lib/rails/welcome_controller.rb:8
  def index; end
