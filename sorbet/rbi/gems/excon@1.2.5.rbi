...
#
# source://excon-1.2.5/lib/excon/version.rb:3
module Excon
  class << self
...
# source://excon-1.2.5/lib/excon/connection.rb:4
class Excon::Connection
  ...
  #
  # source://excon-1.2.5/lib/excon/connection.rb:63
  ...
  #
  # source://excon-1.2.5/lib/excon/connection.rb:357
  def batch_requests(pipeline_params, limit = T.unsafe(nil)); end

  # source://excon-1.2.5/lib/excon/connection.rb:378
  def connect(params = T.unsafe(nil), &block); end

  # source://excon-1.2.5/lib/excon/connection.rb:9
  def connection; end

  # source://excon-1.2.5/lib/excon/connection.rb:13
  def connection=(new_params); end

  # Returns the value of attribute data.
  #
  # source://excon-1.2.5/lib/excon/connection.rb:7
  def data; end

  # source://excon-1.2.5/lib/excon/connection.rb:378
  def delete(params = T.unsafe(nil), &block); end

  # source://excon-1.2.5/lib/excon/connection.rb:108
  ...
  # source://excon-1.2.5/lib/excon/connection.rb:394
  def inspect; end

  # source://excon-1.2.5/lib/excon/connection.rb:36
  def logger; end

  # source://excon-1.2.5/lib/excon/connection.rb:41
  def logger=(logger); end

  # source://excon-1.2.5/lib/excon/connection.rb:378
  def options(params = T.unsafe(nil), &block); end

  # source://excon-1.2.5/lib/excon/connection.rb:18
  def params; end

  # source://excon-1.2.5/lib/excon/connection.rb:22
  ...
  # source://excon-1.2.5/lib/excon/connection.rb:27
  def proxy; end

  # source://excon-1.2.5/lib/excon/connection.rb:31
  ...
  #
  # source://excon-1.2.5/lib/excon/connection.rb:229
  def request(params = T.unsafe(nil), &block); end

  # source://excon-1.2.5/lib/excon/connection.rb:114
  ...
  # @param pipeline_params [Array<Hash>] An array of one or more optional params, override defaults set in Connection.new, see #request for details
  #
  # source://excon-1.2.5/lib/excon/connection.rb:330
  def requests(pipeline_params); end

  # source://excon-1.2.5/lib/excon/connection.rb:368
  def reset; end

  # source://excon-1.2.5/lib/excon/connection.rb:208
  def response_call(datum); end

  # source://excon-1.2.5/lib/excon/connection.rb:389
  def retry_limit; end

  # source://excon-1.2.5/lib/excon/connection.rb:384
  def retry_limit=(new_retry_limit); end

  # source://excon-1.2.5/lib/excon/connection.rb:378
  def trace(params = T.unsafe(nil), &block); end

  # source://excon-1.2.5/lib/excon/connection.rb:408
  def valid_request_keys(middlewares); end

  private

  # source://excon-1.2.5/lib/excon/connection.rb:414
  def detect_content_length(body); end

  # source://excon-1.2.5/lib/excon/connection.rb:534
  def proxy_from_env; end

  # source://excon-1.2.5/lib/excon/connection.rb:521
  def proxy_match_host_port(host, port); end

  # source://excon-1.2.5/lib/excon/connection.rb:513
  def raise_socket_error(error); end

  # source://excon-1.2.5/lib/excon/connection.rb:471
  def response(datum = T.unsafe(nil)); end

  # source://excon-1.2.5/lib/excon/connection.rb:562
  def setup_proxy; end

  # source://excon-1.2.5/lib/excon/connection.rb:482
  def socket(datum = T.unsafe(nil)); end

  # source://excon-1.2.5/lib/excon/connection.rb:493
  def sockets; end

  # source://excon-1.2.5/lib/excon/connection.rb:426
  def valid_middleware_keys(middlewares); end

  # source://excon-1.2.5/lib/excon/connection.rb:439
...
#
# source://excon-1.2.5/lib/excon/error.rb:4
class Excon::Error < ::StandardError
  class << self
    # Messages for nicer exceptions, from rfc2616
    #
    # source://excon-1.2.5/lib/excon/error.rb:174
    def status_error(request, response); end

    # source://excon-1.2.5/lib/excon/error.rb:127
...
# source://excon-1.2.5/lib/excon/error.rb:200
...
# source://excon-1.2.5/lib/excon/headers.rb:3
class Excon::Headers < ::Hash
  # @return [Headers] a new instance of Headers
  #
  # source://excon-1.2.5/lib/excon/headers.rb:24
  def initialize; end

  # source://excon-1.2.5/lib/excon/headers.rb:29
  def [](key); end

  # source://excon-1.2.5/lib/excon/headers.rb:33
  def []=(key, value); end

  # source://excon-1.2.5/lib/excon/headers.rb:40
  def assoc(obj); end

  # source://excon-1.2.5/lib/excon/headers.rb:45
  def delete(key, &proc); end

  # source://excon-1.2.5/lib/excon/headers.rb:50
  def fetch(key, default = T.unsafe(nil), &proc); end

  # @return [Boolean]
  #
  # source://excon-1.2.5/lib/excon/headers.rb:58
  def has_key?(key); end
  ...
  # source://excon-1.2.5/lib/excon/headers.rb:64
  def merge(other_hash); end

  # source://excon-1.2.5/lib/excon/headers.rb:68
  def merge!(other_hash); end
  ...
  # source://excon-1.2.5/lib/excon/headers.rb:75
  def rehash; end

  # source://excon-1.2.5/lib/excon/headers.rb:33
  def store(key, value); end

  # source://excon-1.2.5/lib/excon/headers.rb:80
  def values_at(*keys); end
end

# source://excon-1.2.5/lib/excon/headers.rb:5
Excon::Headers::SENTINEL = T.let(T.unsafe(nil), Hash)

# source://excon-1.2.5/lib/excon/instrumentors/logging_instrumentor.rb:4
class Excon::LoggingInstrumentor
  class << self
    # source://excon-1.2.5/lib/excon/instrumentors/logging_instrumentor.rb:6
    def instrument(name, params = T.unsafe(nil)); end
  end
end

# source://excon-1.2.5/lib/excon/middlewares/base.rb:3
module Excon::Middleware; end

# source://excon-1.2.5/lib/excon/middlewares/base.rb:4
class Excon::Middleware::Base
  # @return [Base] a new instance of Base
  #
  # source://excon-1.2.5/lib/excon/middlewares/base.rb:11
  def initialize(stack); end

  # source://excon-1.2.5/lib/excon/middlewares/base.rb:15
  def error_call(datum); end

  # source://excon-1.2.5/lib/excon/middlewares/base.rb:20
  def request_call(datum); end

  # source://excon-1.2.5/lib/excon/middlewares/base.rb:25
  def response_call(datum); end
  ...
  class << self
    ...
    #
    # source://excon-1.2.5/lib/excon/middlewares/base.rb:7
    def valid_parameter_keys; end
  end
end

# source://excon-1.2.5/lib/excon/middlewares/capture_cookies.rb:4
class Excon::Middleware::CaptureCookies < ::Excon::Middleware::Base
  # source://excon-1.2.5/lib/excon/middlewares/capture_cookies.rb:6
  def extract_cookies_from_set_cookie(set_cookie); end

  # source://excon-1.2.5/lib/excon/middlewares/capture_cookies.rb:10
  def get_header(datum, header); end

  # source://excon-1.2.5/lib/excon/middlewares/capture_cookies.rb:17
  def response_call(datum); end
end

# source://excon-1.2.5/lib/excon/middlewares/decompress.rb:5
class Excon::Middleware::Decompress < ::Excon::Middleware::Base
  # source://excon-1.2.5/lib/excon/middlewares/decompress.rb:9
  def request_call(datum); end

  # source://excon-1.2.5/lib/excon/middlewares/decompress.rb:17
  def response_call(datum); end
end

# Zlib::MAX_WBITS * -1
#
# source://excon-1.2.5/lib/excon/middlewares/decompress.rb:7
Excon::Middleware::Decompress::INFLATE_RAW = T.let(T.unsafe(nil), Integer)

# Zlib::MAX_WBITS + 32
#
# source://excon-1.2.5/lib/excon/middlewares/decompress.rb:6
Excon::Middleware::Decompress::INFLATE_ZLIB_OR_GZIP = T.let(T.unsafe(nil), Integer)

# source://excon-1.2.5/lib/excon/middlewares/escape_path.rb:4
class Excon::Middleware::EscapePath < ::Excon::Middleware::Base
  # source://excon-1.2.5/lib/excon/middlewares/escape_path.rb:5
  def request_call(datum); end
end

# source://excon-1.2.5/lib/excon/middlewares/expects.rb:4
class Excon::Middleware::Expects < ::Excon::Middleware::Base
  # source://excon-1.2.5/lib/excon/middlewares/expects.rb:11
  def response_call(datum); end

  class << self
    # source://excon-1.2.5/lib/excon/middlewares/expects.rb:5
    def valid_parameter_keys; end
  end
end

# source://excon-1.2.5/lib/excon/middlewares/idempotent.rb:6
class Excon::Middleware::Idempotent < ::Excon::Middleware::Base
  # source://excon-1.2.5/lib/excon/middlewares/idempotent.rb:22
  def error_call(datum); end

  # source://excon-1.2.5/lib/excon/middlewares/idempotent.rb:17
  def request_call(datum); end

  class << self
    # source://excon-1.2.5/lib/excon/middlewares/idempotent.rb:7
    def valid_parameter_keys; end
  end
end

# source://excon-1.2.5/lib/excon/middlewares/instrumentor.rb:4
class Excon::Middleware::Instrumentor < ::Excon::Middleware::Base
  # source://excon-1.2.5/lib/excon/middlewares/instrumentor.rb:13
  def error_call(datum); end

  # source://excon-1.2.5/lib/excon/middlewares/instrumentor.rb:23
  def request_call(datum); end

  # source://excon-1.2.5/lib/excon/middlewares/instrumentor.rb:38
  def response_call(datum); end

  class << self
    # source://excon-1.2.5/lib/excon/middlewares/instrumentor.rb:5
    def valid_parameter_keys; end
  end
end

# source://excon-1.2.5/lib/excon/middlewares/mock.rb:4
class Excon::Middleware::Mock < ::Excon::Middleware::Base
  # source://excon-1.2.5/lib/excon/middlewares/mock.rb:13
  def request_call(datum); end

  class << self
    # source://excon-1.2.5/lib/excon/middlewares/mock.rb:5
    def valid_parameter_keys; end
  end
end

# source://excon-1.2.5/lib/excon/middlewares/redirect_follower.rb:4
class Excon::Middleware::RedirectFollower < ::Excon::Middleware::Base
  # source://excon-1.2.5/lib/excon/middlewares/redirect_follower.rb:18
  def get_header(datum, header); end

  # source://excon-1.2.5/lib/excon/middlewares/redirect_follower.rb:12
  def request_call(datum); end

  # source://excon-1.2.5/lib/excon/middlewares/redirect_follower.rb:25
  def response_call(datum); end

  class << self
    # source://excon-1.2.5/lib/excon/middlewares/redirect_follower.rb:5
    def valid_parameter_keys; end
  end
end

# source://excon-1.2.5/lib/excon/middlewares/response_parser.rb:4
class Excon::Middleware::ResponseParser < ::Excon::Middleware::Base
  # source://excon-1.2.5/lib/excon/middlewares/response_parser.rb:5
  def response_call(datum); end
end
...
# source://excon-1.2.5/lib/excon/pretty_printer.rb:3
class Excon::PrettyPrinter
  class << self
    # source://excon-1.2.5/lib/excon/pretty_printer.rb:4
...
# source://excon-1.2.5/lib/excon/response.rb:3
class Excon::Response
  # @return [Response] a new instance of Response
  #
  # source://excon-1.2.5/lib/excon/response.rb:213
  def initialize(params = T.unsafe(nil)); end

  # source://excon-1.2.5/lib/excon/response.rb:227
  def [](key); end

  # source://excon-1.2.5/lib/excon/response.rb:11
  def body; end

  # backwards compatability reader/writers
  #
  # source://excon-1.2.5/lib/excon/response.rb:8
  def body=(new_body); end

  # Returns the value of attribute data.
  #
  # source://excon-1.2.5/lib/excon/response.rb:5
  def data; end
  ...
  #
  # source://excon-1.2.5/lib/excon/response.rb:242
  def get_header(name); end

  # source://excon-1.2.5/lib/excon/response.rb:17
  def headers; end

  # source://excon-1.2.5/lib/excon/response.rb:14
  def headers=(new_headers); end

  # source://excon-1.2.5/lib/excon/response.rb:20
  def host; end

  # can't be named "method"
  #
  # source://excon-1.2.5/lib/excon/response.rb:32
  def http_method; end

  # source://excon-1.2.5/lib/excon/response.rb:26
  def local_address; end

  # source://excon-1.2.5/lib/excon/response.rb:29
  def local_port; end

  # source://excon-1.2.5/lib/excon/response.rb:231
  def params; end

  # source://excon-1.2.5/lib/excon/response.rb:35
  def path; end

  # source://excon-1.2.5/lib/excon/response.rb:41
  def port; end

  # source://excon-1.2.5/lib/excon/response.rb:236
  def pp; end

  # source://excon-1.2.5/lib/excon/response.rb:38
  def query; end

  # source://excon-1.2.5/lib/excon/response.rb:47
  def reason_phrase; end

  # source://excon-1.2.5/lib/excon/response.rb:44
  def reason_phrase=(new_reason_phrase); end

  # source://excon-1.2.5/lib/excon/response.rb:53
  def remote_ip; end

  # source://excon-1.2.5/lib/excon/response.rb:50
  def remote_ip=(new_remote_ip); end

  # source://excon-1.2.5/lib/excon/response.rb:23
  def scheme; end

  # source://excon-1.2.5/lib/excon/response.rb:59
  def status; end

  # source://excon-1.2.5/lib/excon/response.rb:56
  def status=(new_status); end

  # source://excon-1.2.5/lib/excon/response.rb:62
  def status_line; end

  # source://excon-1.2.5/lib/excon/response.rb:65
  def status_line=(new_status_line); end

  class << self
    # source://excon-1.2.5/lib/excon/response.rb:69
    def parse(socket, datum); end

    # source://excon-1.2.5/lib/excon/response.rb:193
    def parse_headers(socket, datum); end
  end
end

# source://excon-1.2.5/lib/excon/ssl_socket.rb:3
class Excon::SSLSocket < ::Excon::Socket
  # @return [SSLSocket] a new instance of SSLSocket
  #
  # source://excon-1.2.5/lib/excon/ssl_socket.rb:8
  def initialize(data = T.unsafe(nil)); end

  private

  # source://excon-1.2.5/lib/excon/ssl_socket.rb:172
  def client_cert_data; end

  # source://excon-1.2.5/lib/excon/ssl_socket.rb:183
  def client_chain_data; end

  # source://excon-1.2.5/lib/excon/ssl_socket.rb:197
  def client_key_data; end

  # source://excon-1.2.5/lib/excon/ssl_socket.rb:208
  def client_key_pass; end

  # source://excon-1.2.5/lib/excon/ssl_socket.rb:191
  def connect; end
end

# source://excon-1.2.5/lib/excon/ssl_socket.rb:4
Excon::SSLSocket::HAVE_NONBLOCK = T.let(T.unsafe(nil), TrueClass)

# source://excon-1.2.5/lib/excon/socket.rb:5
class Excon::Socket
  include ::Excon::Utils
  extend ::Forwardable
  ...
  # @return [Socket] a new instance of Socket
  #
  # source://excon-1.2.5/lib/excon/socket.rb:51
  def initialize(data = T.unsafe(nil)); end
  ...
  # Returns the value of attribute data.
  #
  # source://excon-1.2.5/lib/excon/socket.rb:10
  def data; end
  ...
  # source://excon-1.2.5/lib/excon/socket.rb:112
  def local_address; end

  # source://excon-1.2.5/lib/excon/socket.rb:116
  def local_port; end

  # source://excon-1.2.5/lib/excon/socket.rb:36
  def params; end

  # source://excon-1.2.5/lib/excon/socket.rb:41
  def params=(new_params); end

  # source://excon-1.2.5/lib/excon/socket.rb:63
  def read(max_length = T.unsafe(nil)); end

  # source://excon-1.2.5/lib/excon/socket.rb:73
  def readline; end

  # Returns the value of attribute remote_ip.
  #
  # source://excon-1.2.5/lib/excon/socket.rb:46
  def remote_ip; end

  # source://excon-1.2.5/lib/excon/socket.rb:104
  def write(data); end

  private

  # source://excon-1.2.5/lib/excon/socket.rb:122
  def connect; end

  # Consume any bytes remaining in the read buffer before making a system call.
  #
  # source://excon-1.2.5/lib/excon/socket.rb:212
  def consume_read_buffer; end

  # source://excon-1.2.5/lib/excon/socket.rb:300
  def read_block(max_length); end

  # source://excon-1.2.5/lib/excon/socket.rb:227
  def read_nonblock(max_length); end

  # source://excon-1.2.5/lib/excon/socket.rb:296
  ...
  #
  # source://excon-1.2.5/lib/excon/socket.rb:399
  ...
  #
  # source://excon-1.2.5/lib/excon/socket.rb:222
  def rewind_read_buffer(chunk, idx); end

  # source://excon-1.2.5/lib/excon/socket.rb:359
  def select_with_timeout(socket, type); end

  # source://excon-1.2.5/lib/excon/socket.rb:389
  def unpacked_sockaddr; end

  # source://excon-1.2.5/lib/excon/socket.rb:349
  def write_block(data); end

  # source://excon-1.2.5/lib/excon/socket.rb:314
...
# source://excon-1.2.5/lib/excon/unix_socket.rb:3
class Excon::UnixSocket < ::Excon::Socket
  private

  # source://excon-1.2.5/lib/excon/unix_socket.rb:7
  def connect; end
end

# source://excon-1.2.5/lib/excon/utils.rb:4
module Excon::Utils
  private

  # source://excon-1.2.5/lib/excon/utils.rb:14
  def binary_encode(string); end

  # source://excon-1.2.5/lib/excon/utils.rb:26
  def connection_uri(datum = T.unsafe(nil)); end

  # source://excon-1.2.5/lib/excon/utils.rb:66
  def default_port?(datum); end

  # Escapes HTTP reserved and unwise characters in +str+
  #
  # source://excon-1.2.5/lib/excon/utils.rb:105
  def escape_uri(str); end

  # Performs validation on the passed header hash and returns a string representation of the headers
  #
  # source://excon-1.2.5/lib/excon/utils.rb:127
  def headers_hash_to_s(headers); end

  # source://excon-1.2.5/lib/excon/utils.rb:58
  def port_string(datum); end

  # source://excon-1.2.5/lib/excon/utils.rb:72
  def query_string(datum); end

  # Redact sensitive info from provided data
  #
  # source://excon-1.2.5/lib/excon/utils.rb:37
  def redact(datum); end

  # source://excon-1.2.5/lib/excon/utils.rb:54
  def request_uri(datum); end

  # Splits a header value +str+ according to HTTP specification.
  #
  # source://excon-1.2.5/lib/excon/utils.rb:95
  def split_header_value(str); end

  # Unescape form encoded values in +str+
  #
  # source://excon-1.2.5/lib/excon/utils.rb:119
  def unescape_form(str); end

  # Unescapes HTTP reserved and unwise characters in +str+
  #
  # source://excon-1.2.5/lib/excon/utils.rb:112
...
# source://excon-1.2.5/lib/excon/utils.rb:7
Excon::Utils::CONTROL = T.let(T.unsafe(nil), String)

# source://excon-1.2.5/lib/excon/utils.rb:8
Excon::Utils::DELIMS = T.let(T.unsafe(nil), String)

# source://excon-1.2.5/lib/excon/utils.rb:12
Excon::Utils::ESCAPED = T.let(T.unsafe(nil), Regexp)

# source://excon-1.2.5/lib/excon/utils.rb:10
Excon::Utils::NONASCII = T.let(T.unsafe(nil), String)

# source://excon-1.2.5/lib/excon/utils.rb:11
Excon::Utils::UNESCAPED = T.let(T.unsafe(nil), Regexp)

# source://excon-1.2.5/lib/excon/utils.rb:9
