...
# source://lint_roller-1.1.0/lib/lint_roller/context.rb:1
module LintRoller; end

# source://lint_roller-1.1.0/lib/lint_roller/about.rb:2
...
# source://lint_roller-1.1.0/lib/lint_roller/context.rb:2
...
# source://lint_roller-1.1.0/lib/lint_roller/error.rb:2
class LintRoller::Error < ::StandardError; end

# source://lint_roller-1.1.0/lib/lint_roller/plugin.rb:2
class LintRoller::Plugin
  ...
  #
  # source://lint_roller-1.1.0/lib/lint_roller/plugin.rb:4
  def initialize(config = T.unsafe(nil)); end

  # @raise [Error]
  #
  # source://lint_roller-1.1.0/lib/lint_roller/plugin.rb:8
  def about; end
  ...
  # @raise [Error]
  #
  # source://lint_roller-1.1.0/lib/lint_roller/plugin.rb:18
  ...
  # @return [Boolean]
  #
  # source://lint_roller-1.1.0/lib/lint_roller/plugin.rb:13
  def supported?(context); end
end

# source://lint_roller-1.1.0/lib/lint_roller/rules.rb:2
...
# source://lint_roller-1.1.0/lib/lint_roller/support/merges_upstream_metadata.rb:2
module LintRoller::Support; end

# source://lint_roller-1.1.0/lib/lint_roller/support/merges_upstream_metadata.rb:3
class LintRoller::Support::MergesUpstreamMetadata
  # source://lint_roller-1.1.0/lib/lint_roller/support/merges_upstream_metadata.rb:4
  def merge(plugin_yaml, upstream_yaml); end
end

# source://lint_roller-1.1.0/lib/lint_roller/version.rb:2
