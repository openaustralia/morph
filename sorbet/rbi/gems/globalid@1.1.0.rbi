...
# source://globalid-1.1.0/lib/global_id/global_id.rb:7
class GlobalID
  extend ::ActiveSupport::Autoload

  # @return [GlobalID] a new instance of GlobalID
  #
  # source://globalid-1.1.0/lib/global_id/global_id.rb:44
  def initialize(gid, options = T.unsafe(nil)); end

  # source://globalid-1.1.0/lib/global_id/global_id.rb:62
  def ==(other); end

  # source://globalid-1.1.0/lib/global_id/global_id.rb:42
  def app(*_arg0, &_arg1); end

  # source://globalid-1.1.0/lib/global_id/global_id.rb:75
  ...
  # source://globalid-1.1.0/lib/global_id/global_id.rb:48
  def find(options = T.unsafe(nil)); end

  # source://globalid-1.1.0/lib/global_id/global_id.rb:67
  def hash; end

  # source://globalid-1.1.0/lib/global_id/global_id.rb:52
  def model_class; end
  ...
  # source://globalid-1.1.0/lib/global_id/global_id.rb:71
  def to_param; end
  ...
  #
  # source://globalid-1.1.0/lib/global_id/global_id.rb:41
  def uri; end

  class << self
    # Returns the value of attribute app.
    #
    # source://globalid-1.1.0/lib/global_id/global_id.rb:9
    def app; end

    # source://globalid-1.1.0/lib/global_id/global_id.rb:31
    def app=(app); end

    # source://globalid-1.1.0/lib/global_id/global_id.rb:11
    def create(model, options = T.unsafe(nil)); end

    # source://globalid-1.1.0/lib/global_id.rb:15
    def eager_load!; end

    # source://globalid-1.1.0/lib/global_id/global_id.rb:21
    def find(gid, options = T.unsafe(nil)); end

    # source://globalid-1.1.0/lib/global_id/global_id.rb:25
    def parse(gid, options = T.unsafe(nil)); end

    private

    # source://globalid-1.1.0/lib/global_id/global_id.rb:36
    def parse_encoded_gid(gid, options); end
  end
end

# source://globalid-1.1.0/lib/global_id/identification.rb:2
module GlobalID::Identification
  # source://globalid-1.1.0/lib/global_id/identification.rb:3
  def to_gid(options = T.unsafe(nil)); end

  # source://globalid-1.1.0/lib/global_id/identification.rb:8
  def to_gid_param(options = T.unsafe(nil)); end

  # source://globalid-1.1.0/lib/global_id/identification.rb:3
  def to_global_id(options = T.unsafe(nil)); end

  # source://globalid-1.1.0/lib/global_id/identification.rb:12
  def to_sgid(options = T.unsafe(nil)); end

  # source://globalid-1.1.0/lib/global_id/identification.rb:17
...
# source://globalid-1.1.0/lib/global_id/locator.rb:4
module GlobalID::Locator
  class << self
    ...
    #
    # source://globalid-1.1.0/lib/global_id/locator.rb:14
    ...
    #
    # source://globalid-1.1.0/lib/global_id/locator.rb:40
    ...
    #   modules match, +nil+ is returned.
    #
    # source://globalid-1.1.0/lib/global_id/locator.rb:74
    ...
    #   modules match, +nil+ is returned.
    #
    # source://globalid-1.1.0/lib/global_id/locator.rb:57
    ...
    # @raise [ArgumentError]
    #
    # source://globalid-1.1.0/lib/global_id/locator.rb:98
    ...
    # @return [Boolean]
    #
    # source://globalid-1.1.0/lib/global_id/locator.rb:111
    def find_allowed?(model_class, only = T.unsafe(nil)); end

    # source://globalid-1.1.0/lib/global_id/locator.rb:107
    def locator_for(gid); end

    # source://globalid-1.1.0/lib/global_id/locator.rb:119
    def normalize_app(app); end

    # source://globalid-1.1.0/lib/global_id/locator.rb:115
    def parse_allowed(gids, only = T.unsafe(nil)); end
  end
end

# source://globalid-1.1.0/lib/global_id/locator.rb:127
class GlobalID::Locator::BaseLocator
  # source://globalid-1.1.0/lib/global_id/locator.rb:128
  def locate(gid); end

  # source://globalid-1.1.0/lib/global_id/locator.rb:132
  def locate_many(gids, options = T.unsafe(nil)); end

  private

  # source://globalid-1.1.0/lib/global_id/locator.rb:143
  def find_records(model_class, ids, options); end
end

# source://globalid-1.1.0/lib/global_id/locator.rb:172
class GlobalID::Locator::BlockLocator
  # @return [BlockLocator] a new instance of BlockLocator
  #
  # source://globalid-1.1.0/lib/global_id/locator.rb:173
  def initialize(block); end

  # source://globalid-1.1.0/lib/global_id/locator.rb:177
  def locate(gid); end

  # source://globalid-1.1.0/lib/global_id/locator.rb:181
  def locate_many(gids, options = T.unsafe(nil)); end
end

# source://globalid-1.1.0/lib/global_id/locator.rb:170
GlobalID::Locator::DEFAULT_LOCATOR = T.let(T.unsafe(nil), GlobalID::Locator::UnscopedLocator)

# source://globalid-1.1.0/lib/global_id/locator.rb:152
class GlobalID::Locator::UnscopedLocator < ::GlobalID::Locator::BaseLocator
  # source://globalid-1.1.0/lib/global_id/locator.rb:153
  def locate(gid); end

  private

  # source://globalid-1.1.0/lib/global_id/locator.rb:158
  def find_records(model_class, ids, options); end

  # source://globalid-1.1.0/lib/global_id/locator.rb:162
  def unscoped(model_class); end
end

# source://globalid-1.1.0/lib/global_id/railtie.rb:12
class GlobalID::Railtie < ::Rails::Railtie; end

# source://globalid-1.1.0/lib/global_id/verifier.rb:4
class GlobalID::Verifier < ::ActiveSupport::MessageVerifier
  private

  # source://globalid-1.1.0/lib/global_id/verifier.rb:10
  def decode(data); end

  # source://globalid-1.1.0/lib/global_id/verifier.rb:6
  def encode(data); end
end

# source://globalid-1.1.0/lib/global_id/signed_global_id.rb:4
class SignedGlobalID < ::GlobalID
  # @return [SignedGlobalID] a new instance of SignedGlobalID
  #
  # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:50
  def initialize(gid, options = T.unsafe(nil)); end

  # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:68
  def ==(other); end

  # Returns the value of attribute expires_at.
  #
  # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:48
  def expires_at; end
  ...
  # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:62
  def to_h; end

  # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:57
  def to_param; end
  ...
  # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:73
  def encoded_expiration; end

  # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:77
  def pick_expiration(options); end

  class << self
    # Returns the value of attribute expires_in.
    #
    # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:22
    def expires_in; end
    ...
    # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:10
    def parse(sgid, options = T.unsafe(nil)); end

    # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:26
    ...
    #
    # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:16
    def pick_verifier(options); end

    # Returns the value of attribute verifier.
    #
    # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:8
    def verifier; end
    ...
    # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:41
    def raise_if_expired(expires_at); end

    # source://globalid-1.1.0/lib/global_id/signed_global_id.rb:31
    def verify(sgid, options); end
  end
end

# source://globalid-1.1.0/lib/global_id/signed_global_id.rb:5
class SignedGlobalID::ExpiredMessage < ::StandardError; end

# source://globalid-1.1.0/lib/global_id/uri/gid.rb:6
module URI
  include ::URI::RFC2396_REGEXP
  extend ::URI::Escape
end

# source://globalid-1.1.0/lib/global_id/uri/gid.rb:27
class URI::GID < ::URI::Generic
  ...
  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:101
  def deconstruct_keys(_keys); end

  # Returns the value of attribute model_id.
  #
  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:29
  def model_id; end
  ...
  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:96
  def to_s; end
  ...
  #
  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:112
  def query=(query); end

  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:123
  def set_params(params); end

  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:106
  def set_path(path); end

  # Ruby 2.1 or less uses #set_query to assign the query
  #
  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:118
  def set_query(query); end

  private

  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:130
  def check_host(host); end

  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:135
  def check_path(path); end

  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:140
  def check_scheme(scheme); end

  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:172
  def parse_query_params(query); end

  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:148
  def set_model_components(path, validate = T.unsafe(nil)); end

  # @raise [URI::InvalidComponentError]
  #
  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:158
  def validate_component(component); end

  # @raise [MissingModelIdError]
  #
  # source://globalid-1.1.0/lib/global_id/uri/gid.rb:165
  ...
  class << self
    ...
    #
    # source://globalid-1.1.0/lib/global_id/uri/gid.rb:83
    def build(args); end
    ...
    #
    # source://globalid-1.1.0/lib/global_id/uri/gid.rb:67
    ...
    #
    # source://globalid-1.1.0/lib/global_id/uri/gid.rb:59
    def parse(uri); end
    ...
    #
    # source://globalid-1.1.0/lib/global_id/uri/gid.rb:43
    def validate_app(app); end
  end
end

# source://globalid-1.1.0/lib/global_id/uri/gid.rb:128
URI::GID::COMPONENT = T.let(T.unsafe(nil), Array)

# Raised when creating a Global ID for a model without an id
#
# source://globalid-1.1.0/lib/global_id/uri/gid.rb:32
