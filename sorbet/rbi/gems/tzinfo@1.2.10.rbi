...
#
# source://tzinfo-1.2.10/lib/tzinfo.rb:2
module TZInfo; end
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:103
class TZInfo::AbsoluteDayOfYearTransitionRule < ::TZInfo::DayOfYearTransitionRule
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:111
  def is_always_first_day_of_year?; end

  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:116
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:131
  def get_day(year); end

  # Returns an Array of parameters that will influence the output of hash.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:136
  def hash_args; end
end
...
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:13
...
class TZInfo::AnnualRules
  ...
  # latest).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/annual_rules.rb:36
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/annual_rules.rb:46
...
# TimezoneOffset.
#
# source://tzinfo-1.2.10/lib/tzinfo/annual_rules.rb:10
...
# territorial claims.
#
# source://tzinfo-1.2.10/lib/tzinfo/country.rb:24
class TZInfo::Country
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country.rb:152
  def <=>(c); end

  # Dumps this Country for marshalling.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country.rb:169
  def _dump(limit); end

  # The ISO 3166-1 alpha-2 country code.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country.rb:81
  def code; end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country.rb:159
  def eql?(c); end

  # Returns a hash value for this Country.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country.rb:164
  def hash; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country.rb:96
  def inspect; end

  # The name of the country.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country.rb:86
  def name; end

  # Alias for name.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country.rb:91
  def to_s; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country.rb:110
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country.rb:144
  def zone_info; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country.rb:127
  def zones; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country.rb:181
  def setup(info); end

  class << self
    # Loads a marshalled Country.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/country.rb:174
    def _load(data); end

    # Returns an Array of all the defined Countries.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/country.rb:76
    def all; end

    # Returns an Array of all the valid country codes.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/country.rb:71
    def all_codes; end

    # Returns the current DataSource
    #
    # source://tzinfo-1.2.10/lib/tzinfo/country.rb:192
    def data_source; end

    # Gets a Country by its ISO 3166-1 alpha-2 code. Raises an
    # InvalidCountryCode exception if it couldn't be found.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/country.rb:39
    def get(identifier); end

    # Initializes @@countries.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/country.rb:186
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/country.rb:60
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/country_index_definition.rb:6
module TZInfo::CountryIndexDefinition
  mixes_in_class_methods ::TZInfo::CountryIndexDefinition::ClassMethods

  class << self
    # source://tzinfo-1.2.10/lib/tzinfo/country_index_definition.rb:7
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/country_index_definition.rb:16
module TZInfo::CountryIndexDefinition::ClassMethods
  # Returns a frozen hash of all the countries that have been defined in
  # the index.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_index_definition.rb:26
  def countries; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_index_definition.rb:20
...
# DataSource.
#
# source://tzinfo-1.2.10/lib/tzinfo/country_info.rb:4
class TZInfo::CountryInfo
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_info.rb:12
  def initialize(code, name); end

  # The ISO 3166 country code.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_info.rb:6
  def code; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_info.rb:18
  def inspect; end

  # The name of the country.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_info.rb:9
  def name; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_info.rb:24
  def zone_identifiers; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_info.rb:32
  def zones; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_info.rb:38
...
# multiple countries).
#
# source://tzinfo-1.2.10/lib/tzinfo/country_timezone.rb:5
class TZInfo::CountryTimezone
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_timezone.rb:42
  ...
  # and description).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_timezone.rb:109
  def ==(ct); end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_timezone.rb:118
  def eql?(ct); end

  # Returns a hash of this CountryTimezone.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_timezone.rb:123
  def hash; end

  # The zone identifier.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_timezone.rb:7
  def identifier; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_timezone.rb:131
  def inspect; end

  # The latitude of this timezone in degrees as a Rational.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_timezone.rb:77
  def latitude; end

  # The longitude of this timezone in degrees as a Rational.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_timezone.rb:92
  def longitude; end

  # The Timezone (actually a TimezoneProxy for performance reasons).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/country_timezone.rb:66
  def timezone; end
  ...
  class << self
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/country_timezone.rb:31
...
#
# source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:18
class TZInfo::DataSource
  # Returns an array of all the available ISO 3166-1 alpha-2
  # country codes.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:150
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:131
  def data_timezone_identifiers; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:160
  def inspect; end

  # Returns an array of all the available timezone identifiers that
  # are links to other timezones.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:137
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:144
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:120
  def load_timezone_info(identifier); end

  # Returns an array of all the available timezone identifiers.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:125
  def timezone_identifiers; end

  # Returns the name of this DataSource.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:155
  def to_s; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:186
  ...
  class << self
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:168
    def create_default_data_source; end

    # Returns the currently selected DataSource instance.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:26
    def get; end
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:101
...
#
# source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:12
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/data_timezone.rb:6
class TZInfo::DataTimezone < ::TZInfo::InfoTimezone
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_timezone.rb:54
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_timezone.rb:13
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_timezone.rb:21
...
class TZInfo::DataTimezoneInfo < ::TZInfo::TimezoneInfo
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_timezone_info.rb:13
  def periods_for_local(local); end
  ...
  # transitions_up_to raises an ArgumentError exception.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_timezone_info.rb:39
  def transitions_up_to(utc_to, utc_from = T.unsafe(nil)); end
  ...
  # @raise [NotImplementedError]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/data_timezone_info.rb:51
  def raise_not_implemented(method_name); end
end
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:246
class TZInfo::DayOfMonthTransitionRule < ::TZInfo::DayOfWeekTransitionRule
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:247
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:254
  def ==(r); end
  ...
  # specified by the rule for the given offset and year.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:266
  def get_day(year); end

  # Returns an Array of parameters that will influence the output of hash.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:280
  def hash_args; end

  # Returns the day the week starts on for a month starting on a Sunday.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:262
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:202
class TZInfo::DayOfWeekTransitionRule < ::TZInfo::TransitionRule
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:203
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:222
  def ==(r); end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:212
  def is_always_first_day_of_year?; end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:217
  def is_always_last_day_of_year?; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:233
  def day_of_week; end

  # Returns an Array of parameters that will influence the output of hash.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:236
  def hash_args; end

  # Returns the month of the year (1 to 12).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:230
  def month; end
end
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:69
class TZInfo::DayOfYearTransitionRule < ::TZInfo::TransitionRule
  ...
  # Returns an Array of parameters that will influence the output of hash.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:88
  def hash_args; end

  # @return [Integer] the day multipled by the number of seconds in a day.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:85
  def seconds; end
end
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/info_timezone.rb:6
class TZInfo::InfoTimezone < ::TZInfo::Timezone
  # The identifier of the timezone, e.g. "Europe/Paris".
  #
  # source://tzinfo-1.2.10/lib/tzinfo/info_timezone.rb:16
  def identifier; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/info_timezone.rb:22
  def info; end

  # source://tzinfo-1.2.10/lib/tzinfo/info_timezone.rb:26
  def setup(info); end

  class << self
    # Constructs a new InfoTimezone with a TimezoneInfo instance.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/info_timezone.rb:9
    def new(info); end
  end
end
...
#
# source://tzinfo-1.2.10/lib/tzinfo/country.rb:5
...
#
# source://tzinfo-1.2.10/lib/tzinfo/data_source.rb:6
...
#
# source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:14
...
#
# source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:8
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:148
class TZInfo::JulianDayOfYearTransitionRule < ::TZInfo::DayOfYearTransitionRule
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:155
  def initialize(day, transition_at = T.unsafe(nil)); end

  # Determines if this JulianDayOfYearTransitionRule is equal to another
  # instance.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:174
  def ==(r); end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:162
  def is_always_first_day_of_year?; end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:168
  def is_always_last_day_of_year?; end
  ...
  # specified by the rule for the given offset and year.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:183
  def get_day(year); end

  # Returns an Array of parameters that will influence the output of hash.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:192
  def hash_args; end
end

# The 60 days in seconds.
#
# source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:149
TZInfo::JulianDayOfYearTransitionRule::LEAP = T.let(T.unsafe(nil), Integer)

# The length of a non-leap year in seconds.
#
# source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:152
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:290
class TZInfo::LastDayOfMonthTransitionRule < ::TZInfo::DayOfWeekTransitionRule
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:291
  ...
  # instance.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:297
  def ==(r); end
  ...
  # specified by the rule for the given offset and year.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:306
  def get_day(year); end
end
...
class TZInfo::LinkedTimezone < ::TZInfo::InfoTimezone
  ...
  # If no TimezonePeriod could be found, PeriodNotFound is raised.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/linked_timezone.rb:12
  def period_for_utc(utc); end
  ...
  # Raises PeriodNotFound if no periods are found for the given time.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/linked_timezone.rb:20
  def periods_for_local(local); end
  ...
  # transitions_up_to raises an ArgumentError exception.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/linked_timezone.rb:46
  def transitions_up_to(utc_to, utc_from = T.unsafe(nil)); end

  protected

  # source://tzinfo-1.2.10/lib/tzinfo/linked_timezone.rb:58
  def setup(info); end
end

# Represents a timezone that is defined as a link or alias to another zone.
#
# source://tzinfo-1.2.10/lib/tzinfo/linked_timezone_info.rb:3
class TZInfo::LinkedTimezoneInfo < ::TZInfo::TimezoneInfo
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/linked_timezone_info.rb:10
  def initialize(identifier, link_to_identifier); end

  # Constructs a Timezone instance for the timezone represented by this
  # DataTimezoneInfo.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/linked_timezone_info.rb:22
  def create_timezone; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/linked_timezone_info.rb:16
  def inspect; end

  # The zone that provides the data (that this zone is an alias for).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/linked_timezone_info.rb:6
...
#
# source://tzinfo-1.2.10/lib/tzinfo/transition_data_timezone_info.rb:4
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/offset_rationals.rb:10
module TZInfo::OffsetRationals
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/offset_rationals.rb:72
...
# time could be found.
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:18
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/posix_time_zone_parser.rb:18
class TZInfo::PosixTimeZoneParser
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/posix_time_zone_parser.rb:21
  ...
  # @raise [InvalidPosixTimeZone]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/posix_time_zone_parser.rb:130
  ...
  # @raise [InvalidPosixTimeZone]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/posix_time_zone_parser.rb:105
  ...
  # @raise [InvalidPosixTimeZone]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/posix_time_zone_parser.rb:119
  def get_seconds_after_midnight_from_hms(h, m, s); end

  # Parses the rule from the TZ string, returning a TransitionRule.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/posix_time_zone_parser.rb:72
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/ruby_core_support.rb:9
module TZInfo::RubyCoreSupport
  class << self
    # source://tzinfo-1.2.10/lib/tzinfo/ruby_core_support.rb:73
    ...
    # source://tzinfo-1.2.10/lib/tzinfo/ruby_core_support.rb:40
    def datetime_new!(ajd = T.unsafe(nil), of = T.unsafe(nil), sg = T.unsafe(nil)); end

    # source://tzinfo-1.2.10/lib/tzinfo/ruby_core_support.rb:123
    def force_encoding(str, encoding); end

    def open_file(file_name, mode, opts, &block); end

    # source://tzinfo-1.2.10/lib/tzinfo/ruby_core_support.rb:18
    def rational_new!(numerator, denominator = T.unsafe(nil)); end

    # source://tzinfo-1.2.10/lib/tzinfo/ruby_core_support.rb:111
    def time_nsec(time); end

    # source://tzinfo-1.2.10/lib/tzinfo/ruby_core_support.rb:99
    def time_supports_64bit; end

    # source://tzinfo-1.2.10/lib/tzinfo/ruby_core_support.rb:84
    def time_supports_negative; end
  end
end

# source://tzinfo-1.2.10/lib/tzinfo/ruby_core_support.rb:38
TZInfo::RubyCoreSupport::HALF_DAYS_IN_DAY = T.let(T.unsafe(nil), Rational)

# source://tzinfo-1.2.10/lib/tzinfo/ruby_core_support.rb:160
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/ruby_country_info.rb:8
class TZInfo::RubyCountryInfo < ::TZInfo::CountryInfo
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_country_info.rb:9
  def initialize(code, name, &block); end

  # Returns a frozen array of all the zone identifiers for the country. These
  # are in the order they were added using the timezone method.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_country_info.rb:18
  def zone_identifiers; end
  ...
  # the timezone method.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_country_info.rb:36
  def zones; end
end
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/ruby_country_info.rb:58
class TZInfo::RubyCountryInfo::Zones
  # @return [Zones] a new instance of Zones
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_country_info.rb:61
  def initialize; end

  # source://tzinfo-1.2.10/lib/tzinfo/ruby_country_info.rb:59
  def list; end

  # Called by the index data to define a timezone for the country.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_country_info.rb:66
...
#   TZInfo::DataSource.set(:ruby)
#
# source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:13
class TZInfo::RubyDataSource < ::TZInfo::DataSource
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:20
  def initialize; end

  # Returns an array of all the available ISO 3166-1 alpha-2
  # country codes.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:97
  def country_codes; end

  # Returns an array of all the available timezone identifiers for
  # data timezones (i.e. those that actually contain definitions).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:73
  def data_timezone_identifiers; end

  # Returns an array of all the available timezone identifiers that
  # are links to other timezones.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:80
  def linked_timezone_identifiers; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:88
  def load_country_info(code); end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:40
  def load_timezone_info(identifier); end

  # Returns an array of all the available timezone identifiers.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:66
  def timezone_identifiers; end

  # Returns the name of this DataSource.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:103
  def to_s; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:133
  def load_country_index; end

  # Loads in the index of timezones if it hasn't already been loaded.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:125
  def load_timezone_index; end

  # Requires a file from tzinfo/data.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:120
  def require_data(*file); end

  # Requires a zone definition by its identifier (split on /).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:110
  def require_definition(identifier); end

  # Requires an index by its name.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/ruby_data_source.rb:115
...
#
# source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:8
class TZInfo::TimeOrDateTime
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:17
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:263
  def +(seconds); end
  ...
  # range for Times, then an exception will be raised by the Time class.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:280
  def -(seconds); end
  ...
  # Integer#<=>.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:236
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:289
  def add_with_convert(seconds); end

  # Returns the day of the month (1..n).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:153
  def day; end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:311
  def eql?(todt); end

  # Returns a hash of this TimeOrDateTime.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:316
  def hash; end

  # Returns the hour of the day (0..23).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:176
  def hour; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:125
  def inspect; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:187
  def min; end

  # Returns the month of the year (1..12).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:141
  def mon; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:198
  def sec; end
  ...
  # precision.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:74
  def to_datetime; end

  # Returns the time as an integer timestamp.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:93
  def to_i; end

  # Returns the time as the original time passed to new.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:109
  def to_orig; end

  # Returns a string representation of the TimeOrDateTime.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:114
  def to_s; end
  ...
  # precision.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:50
  def to_time; end

  # Returns the number of microseconds for the time.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:209
  def usec; end

  # Returns the day of the week (0..6 for Sunday to Saturday).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:165
  def wday; end

  # Returns the year.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:130
  def year; end
  ...
  class << self
    ...
    # calling the block.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/time_or_datetime.rb:331
...
# can be shared across thread boundaries.
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:46
class TZInfo::Timezone
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:624
  def <=>(tz); end

  # Dumps this Timezone for marshalling.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:641
  def _dump(limit); end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:532
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:337
  def canonical_zone; end

  # Returns the TimezonePeriod for the current time.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:542
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:548
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:631
  def eql?(tz); end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:231
  def friendly_identifier(skip_first_part = T.unsafe(nil)); end

  # Returns a hash of this Timezone.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:636
  def hash; end

  # The identifier of the timezone, e.g. "Europe/Paris".
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:201
  def identifier; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:217
  def inspect; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:463
  def local_to_utc(local, dst = T.unsafe(nil)); end

  # An alias for identifier.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:206
  def name; end

  # Returns the current time in the timezone as a Time.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:537
  def now; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:493
  ...
  # a block is given to resolve the ambiguity.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:380
  ...
  # information in utc is ignored (it is treated as a UTC time).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:264
  def period_for_utc(utc); end
  ...
  # Returns an empty array if no periods are found for the given time.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:272
  def periods_for_local(local); end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:575
  def strftime(format, utc = T.unsafe(nil)); end

  # Returns a friendlier version of the identifier.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:212
  def to_s; end
  ...
  # transitions_up_to raises an ArgumentError exception.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:298
  def transitions_up_to(utc_to, utc_from = T.unsafe(nil)); end
  ...
  # a UTC time).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:419
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:669
  def raise_unknown_timezone; end

  class << self
    # Loads a marshalled Timezone.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:646
    def _load(data); end
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:123
    def all; end
    ...
    # with the get method.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:179
    ...
    # definitions until a conversion is actually required.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:169
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:144
    ...
    # definitions until a conversion is actually required.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:138
    def all_data_zones; end

    # Returns an array containing the identifiers of all the available
    # Timezones.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:129
    def all_identifiers; end

    # Returns an array containing the identifiers of all the available
    # Timezones that are links to other Timezones.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:159
    ...
    # definitions until a conversion is actually required.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:153
    def all_linked_zones; end

    # Returns the current DataSource.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:664
    def data_source; end
    ...
    # false.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:73
    def default_dst; end
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:66
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:81
    def get(identifier); end

    # Returns an array of proxies corresponding to the given array of
    # identifiers.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:659
    ...
    # definitions until a conversion is actually required.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:190
    def us_zones; end
  end
end
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone_definition.rb:7
module TZInfo::TimezoneDefinition
  ...
  class << self
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone_definition.rb:9
    def append_features(base); end
  end
end
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone_definition.rb:17
module TZInfo::TimezoneDefinition::ClassMethods
  # Returns the last TimezoneInfo to be defined with timezone or
  # linked_timezone.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_definition.rb:31
  def get; end

  # Defines a linked timezone.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_definition.rb:25
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_definition.rb:20
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone_index_definition.rb:6
module TZInfo::TimezoneIndexDefinition
  ...
  class << self
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone_index_definition.rb:8
    def append_features(base); end
  end
end
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone_index_definition.rb:21
module TZInfo::TimezoneIndexDefinition::ClassMethods
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_index_definition.rb:42
  def data_timezones; end

  # Defines a timezone which is a link to another timezone.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_index_definition.rb:29
  ...
  # the index.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_index_definition.rb:49
  def linked_timezones; end

  # Defines a timezone based on data.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_index_definition.rb:23
  def timezone(identifier); end

  # Returns a frozen array containing the identifiers of all the timezones.
  # Identifiers appear in the order they were defined in the index.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_index_definition.rb:36
  def timezones; end
end

# Represents a timezone defined by a data source.
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone_info.rb:3
class TZInfo::TimezoneInfo
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_info.rb:9
  def initialize(identifier); end

  # Constructs a Timezone instance for the timezone represented by this
  # TimezoneInfo.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_info.rb:20
  def create_timezone; end

  # The timezone identifier.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_info.rb:6
  def identifier; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_info.rb:14
  def inspect; end
  ...
  # @raise [NotImplementedError]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_info.rb:26
  def raise_not_implemented(method_name); end
end

# Represents an offset defined in a Timezone data file.
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:3
class TZInfo::TimezoneOffset
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:45
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:80
  def ==(toi); end
  ...
  # symbol.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:41
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:54
  def dst?; end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:87
  def eql?(toi); end

  # Returns a hash of this TimezoneOffset.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:92
  def hash; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:97
  def inspect; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:32
  def std_offset; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:62
  ...
  # Deprecation warning: this method will be removed in TZInfo version 2.0.0.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:72
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:18
  def utc_offset; end

  # The total offset of this observance from UTC in seconds
  # (utc_offset + std_offset).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_offset.rb:36
...
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:6
class TZInfo::TimezonePeriod
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:21
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:215
  def ==(p); end
  ...
  # symbol.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:78
  def abbreviation; end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:148
  def dst?; end

  # The TimezoneTransition that defines the end of this TimezonePeriod
  # (may be nil if unbounded).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:13
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:224
  def eql?(p); end

  # Returns a hash of this TimezonePeriod.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:232
  def hash; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:239
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:187
  ...
  # and set RubyDataSource as the DataSource.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:71
  def std_offset; end
  ...
  # Deprecation warning: this method will be removed in TZInfo version 2.0.0.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:202
  def to_local(utc); end
  ...
  # Deprecation warning: this method will be removed in TZInfo version 2.0.0.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:209
  def to_utc(local); end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:163
  ...
  # set RubyDataSource as the DataSource.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:55
  def utc_offset; end

  # The start time of the period in UTC as a DateTime. May be nil if unbounded.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:104
  def utc_start; end

  # The start time of the period in UTC as a Time. May be nil if unbounded.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:109
  def utc_start_time; end

  # Total offset from UTC (seconds). Equal to utc_offset + std_offset.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:84
  def utc_total_offset; end

  # Total offset from UTC (days). Result is a Rational.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:89
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:179
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_period.rb:155
...
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone_proxy.rb:13
class TZInfo::TimezoneProxy < ::TZInfo::Timezone
  # Dumps this TimezoneProxy for marshalling.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_proxy.rb:76
  def _dump(limit); end

  # Returns the canonical zone for this Timezone.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_proxy.rb:71
  def canonical_zone; end

  # The identifier of the timezone, e.g. "Europe/Paris".
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_proxy.rb:22
  def identifier; end
  ...
  # information in utc is ignored (it is treated as a UTC time).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_proxy.rb:29
  def period_for_utc(utc); end
  ...
  # Returns an empty array if no periods are found for the given time.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_proxy.rb:37
  def periods_for_local(local); end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_proxy.rb:66
  def transitions_up_to(to, from = T.unsafe(nil)); end

  private

  # source://tzinfo-1.2.10/lib/tzinfo/timezone_proxy.rb:91
  def real_timezone; end

  # source://tzinfo-1.2.10/lib/tzinfo/timezone_proxy.rb:86
  def setup(identifier); end

  class << self
    # Loads a marshalled TimezoneProxy.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone_proxy.rb:81
    def _load(data); end
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/timezone_proxy.rb:14
    def new(identifier); end
  end
end
...
# date and time.
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:4
class TZInfo::TimezoneTransition
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:14
  ...
  # equal.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:100
  def ==(tti); end

  # A TimeOrDateTime instance representing the UTC time when this transition
  # occurs.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:23
  def at; end

  # The UTC time when this transition occurs, returned as a DateTime instance.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:28
  def datetime; end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:109
  def eql?(tti); end

  # Returns a hash of this TimezoneTransition instance.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:115
  def hash; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:120
  def inspect; end

  # The local time when this transition causes the previous observance to end,
  # returned as a DateTime instance.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:57
  def local_end; end
  ...
  # previous_offset).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:40
  def local_end_at; end

  # The local time when this transition causes the previous observance to end,
  # returned as a Time instance.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:63
  def local_end_time; end

  # The local time when this transition causes the next observance to start,
  # returned as a DateTime instance.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:86
  def local_start; end

  # A TimeOrDateTime instance representing the local time when this transition
  # causes the next observance to start (calculated from at using offset).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:69
  def local_start_at; end

  # The local time when this transition causes the next observance to start,
  # returned as a Time instance.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:92
  def local_start_time; end

  # The offset this transition changes to (a TimezoneOffset instance).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:6
  def offset; end

  # The offset this transition changes from (a TimezoneOffset instance).
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:9
  def previous_offset; end

  # The UTC time when this transition occurs, returned as a Time instance.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:33
  def time; end
  ...
  # @raise [NotImplementedError]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition.rb:126
  def raise_not_implemented(method_name); end
end
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone_transition_definition.rb:8
class TZInfo::TimezoneTransitionDefinition < ::TZInfo::TimezoneTransition
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition_definition.rb:33
  ...
  # occurs.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition_definition.rb:68
  def at; end
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition_definition.rb:93
  def eql?(tti); end

  # Returns a hash of this TimezoneTransitionDefinition instance.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition_definition.rb:100
  def hash; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition_definition.rb:14
  def denominator; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/timezone_transition_definition.rb:9
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/transition_data_timezone_info.rb:11
class TZInfo::TransitionDataTimezoneInfo < ::TZInfo::DataTimezoneInfo
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_data_timezone_info.rb:14
  def initialize(identifier); end
  ...
  # @raise [ArgumentError]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_data_timezone_info.rb:32
  def offset(id, utc_offset, std_offset, abbreviation); end

  # Returns the TimezonePeriod for the given UTC time.
  # Raises NoOffsetsDefined if no offsets have been defined.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_data_timezone_info.rb:79
  def period_for_utc(utc); end
  ...
  # Raises NoOffsetsDefined if no offsets have been defined.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_data_timezone_info.rb:123
  def periods_for_local(local); end
  ...
  # @raise [ArgumentError]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_data_timezone_info.rb:46
  ...
  # transitions_up_to raises an ArgumentError exception.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_data_timezone_info.rb:188
  def transitions_up_to(utc_to, utc_from = T.unsafe(nil)); end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_data_timezone_info.rb:250
  ...
  # Returns nil if there are no such transitions.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_data_timezone_info.rb:262
  def transition_before_end(index); end

  # Returns the index into the @transitions_index array for a given year
  # and month.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_data_timezone_info.rb:240
...
# savings time.
#
# source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:6
class TZInfo::TransitionRule
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:33
  def hash; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:11
  ...
  # Returns an Array of parameters that will influence the output of hash.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:40
  def hash_args; end

  # source://tzinfo-1.2.10/lib/tzinfo/transition_rule.rb:44
...
# Timezone.new(nil).
#
# source://tzinfo-1.2.10/lib/tzinfo/timezone.rb:27
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_country_info.rb:7
...
# instead.
#
# source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:84
class TZInfo::ZoneinfoDataSource < ::TZInfo::DataSource
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:198
  def initialize(zoneinfo_dir = T.unsafe(nil), alternate_iso3166_tab_path = T.unsafe(nil)); end

  # Returns an array of all the available ISO 3166-1 alpha-2
  # country codes.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:282
  def country_codes; end
  ...
  # timezone_identifers.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:259
  def data_timezone_identifiers; end

  # Returns internal object state as a programmer-readable string.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:292
  def inspect; end
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:267
  def linked_timezone_identifiers; end
  ...
  # @raise [InvalidCountryCode]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:274
  def load_country_info(code); end
  ...
  # identifier is invalid.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:224
  def load_timezone_info(identifier); end

  # Returns an array of all the available timezone identifiers.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:250
  def timezone_identifiers; end

  # Returns the name and information about this DataSource.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:287
  def to_s; end

  # The zoneinfo directory being used.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:168
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:505
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:388
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:354
  ...
  # directory.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:319
  ...
  class << self
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:150
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:163
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:300
    ...
    #
    # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:126
    def search_path; end
    ...
    # Set to nil to revert to the default paths.
    #
    # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:139
...
#
# source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:88
...
#
# source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:85
...
#
# source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:101
...
#
# source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_data_source.rb:22
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:17
class TZInfo::ZoneinfoTimezoneInfo < ::TZInfo::TransitionDataTimezoneInfo
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:32
  ...
  # Times.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:305
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:216
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:57
  def check_read(file, bytes); end

  # Converts an array of rule transitions to hashes.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:207
  ...
  # Hash.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:335
  ...
  # transition.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:73
  def derive_offsets(transitions, offsets); end

  # Finds an offset hash that is an exact match to the rule offset specified.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:182
  ...
  # rule offset.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:188
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:199
  def get_rule_offset_indexes(offsets, annual_rules); end

  # Unpack will return unsigned 32-bit integers. Translate to
  # signed 32-bit.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:43
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:49
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:176
  ...
  # @return [Boolean]
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:168
  def offset_matches_rule?(offset, rule_offset); end

  # Parses a zoneinfo file and intializes the DataTimezoneInfo structures.
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:358
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:153
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:255
  ...
  #
  # source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:281
...
# @private
#
# source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:18
...
#
# source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:28
...
#
# source://tzinfo-1.2.10/lib/tzinfo/zoneinfo_timezone_info.rb:23
