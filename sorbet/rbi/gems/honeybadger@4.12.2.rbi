...
#
# source://honeybadger-4.12.2/lib/honeybadger/version.rb:1
module Honeybadger
  extend ::Forwardable
  extend ::Honeybadger
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/singleton.rb:69
  def install_at_exit_callback; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/singleton.rb:61
  ...
  # @see Agent#notify
  #
  # source://honeybadger-4.12.2/lib/honeybadger/singleton.rb:54
  def notify(exception_or_opts, opts = T.unsafe(nil)); end

  # @deprecated
  # @raise [NoMethodError]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/singleton.rb:80
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/singleton.rb:95
...
#   end
#
# source://honeybadger-4.12.2/lib/honeybadger/agent.rb:44
class Honeybadger::Agent
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:59
  ...
  # @return self
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:303
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:277
  def breadcrumbs; end
  ...
  #   otherwise.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:186
  def check_in(id); end

  # Clear all transaction scoped data.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:259
  def clear!; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:361
  def config; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:253
  ...
  #   data is flushed).
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:344
  def flush; end
  ...
  # @return [Hash, nil]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:271
  def get_context; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:121
  def notify(exception_or_opts, opts = T.unsafe(nil)); end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:355
  ...
  #   otherwise.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:205
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:424
  def with_rack_env(rack_env, &block); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:432
  def worker; end

  private

  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:454
  def context_manager; end

  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:469
  def init_worker; end

  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:459
  def push(object); end

  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:464
  def send_now(object); end

  # @raise [ArgumentError]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:446
  def validate_notify_opts!(opts); end

  # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:473
  def with_error_handling; end

  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:50
    def instance; end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/agent.rb:55
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:47
Honeybadger::BINDING_HAS_SOURCE_LOCATION = T.let(T.unsafe(nil), TrueClass)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:8
module Honeybadger::Backend
  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/backend.rb:23
    def for(backend); end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/backend.rb:14
    def mapping; end
  end
end
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/backend.rb:12
class Honeybadger::Backend::BackendError < ::StandardError; end

# source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:70
class Honeybadger::Backend::Base
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:75
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:98
  def check_in(id); end
  ...
  # @raise NotImplementedError
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:89
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:107
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:113
  def config; end
end
...
# integration tests.
#
# source://honeybadger-4.12.2/lib/honeybadger/backend/debug.rb:8
class Honeybadger::Backend::Debug < ::Honeybadger::Backend::Null
  # source://honeybadger-4.12.2/lib/honeybadger/backend/debug.rb:15
  def check_in(id); end

  # source://honeybadger-4.12.2/lib/honeybadger/backend/debug.rb:9
  def notify(feature, payload); end
end

# source://honeybadger-4.12.2/lib/honeybadger/backend/null.rb:5
class Honeybadger::Backend::Null < ::Honeybadger::Backend::Base
  # @return [Null] a new instance of Null
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/null.rb:16
  def initialize(*args); end

  # source://honeybadger-4.12.2/lib/honeybadger/backend/null.rb:24
  def check_in(id); end

  # source://honeybadger-4.12.2/lib/honeybadger/backend/null.rb:20
  def notify(feature, payload); end
end

# source://honeybadger-4.12.2/lib/honeybadger/backend/null.rb:6
class Honeybadger::Backend::Null::StubbedResponse < ::Honeybadger::Backend::Response
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/null.rb:7
  def initialize; end

  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/null.rb:11
  def success?; end
end

# source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:9
class Honeybadger::Backend::Response
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:35
  def initialize(*args); end

  # Returns the value of attribute body.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:12
  def body; end
  ...
  # source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:50
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:46
  def success?; end

  private

  # source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:61
  def parse_error(body); end
end

# source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:14
Honeybadger::Backend::Response::FRIENDLY_ERRORS = T.let(T.unsafe(nil), Hash)

# source://honeybadger-4.12.2/lib/honeybadger/backend/base.rb:10
Honeybadger::Backend::Response::NOT_BLANK = T.let(T.unsafe(nil), Regexp)

# source://honeybadger-4.12.2/lib/honeybadger/backend/server.rb:11
class Honeybadger::Backend::Server < ::Honeybadger::Backend::Base
  # @return [Server] a new instance of Server
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/server.rb:22
  def initialize(config); end
  ...
  # @return [Response]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/server.rb:45
  def check_in(id); end
  ...
  # @return [Response]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backend/server.rb:33
  def notify(feature, payload); end

  private

  # source://honeybadger-4.12.2/lib/honeybadger/backend/server.rb:53
  def payload_headers(payload); end
end

# source://honeybadger-4.12.2/lib/honeybadger/backend/server.rb:17
Honeybadger::Backend::Server::CHECK_IN_ENDPOINT = T.let(T.unsafe(nil), String)

# source://honeybadger-4.12.2/lib/honeybadger/backend/server.rb:12
Honeybadger::Backend::Server::ENDPOINTS = T.let(T.unsafe(nil), Hash)

# source://honeybadger-4.12.2/lib/honeybadger/backend/server.rb:20
Honeybadger::Backend::Server::HTTP_ERRORS = T.let(T.unsafe(nil), Array)

# source://honeybadger-4.12.2/lib/honeybadger/backend/test.rb:11
class Honeybadger::Backend::Test < ::Honeybadger::Backend::Null
  # source://honeybadger-4.12.2/lib/honeybadger/backend/test.rb:40
  def check_in(id); end

  # source://honeybadger-4.12.2/lib/honeybadger/backend/test.rb:31
  def check_ins; end

  # source://honeybadger-4.12.2/lib/honeybadger/backend/test.rb:27
  def notifications; end

  # source://honeybadger-4.12.2/lib/honeybadger/backend/test.rb:35
  def notify(feature, payload); end
  ...
  class << self
    ...
    #
    # source://honeybadger-4.12.2/lib/honeybadger/backend/test.rb:23
    def check_ins; end
    ...
    #
    # source://honeybadger-4.12.2/lib/honeybadger/backend/test.rb:12
    def notifications; end
  end
end
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:6
class Honeybadger::Backtrace
  # @api private
  # @return [Backtrace] a new instance of Backtrace
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:126
  def initialize(lines); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:161
  def ==(other); end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:114
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:142
  def as_json(options = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:157
  def inspect; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:134
  def to_a; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:149
  def to_json(*a); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:153
  def to_s; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:171
  ...
  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:116
    def parse(ruby_backtrace, opts = T.unsafe(nil)); end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:173
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:8
class Honeybadger::Backtrace::Line
  # @api private
  # @return [Line] a new instance of Line
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:52
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:69
  def ==(other); end
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:78
  def application?; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:13
  def file; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:22
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:73
  def inspect; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:19
  def method; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:16
  def number; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:82
  def source; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:65
  def to_s; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:88
  def file=(_arg0); end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:95
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:90
  ...
  class << self
    ...
    #
    # source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:29
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/backtrace.rb:10
Honeybadger::Backtrace::Line::INPUT_FORMAT = T.let(T.unsafe(nil), Regexp)

# source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/active_support.rb:4
module Honeybadger::Breadcrumbs; end

# source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/active_support.rb:5
class Honeybadger::Breadcrumbs::ActiveSupport
  class << self
    # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/active_support.rb:6
    def default_notifications; end

    private

    # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/active_support.rb:108
    def active_record_connection_db_config; end
  end
end

# source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/breadcrumb.rb:5
class Honeybadger::Breadcrumbs::Breadcrumb
  include ::Comparable

  # @return [Breadcrumb] a new instance of Breadcrumb
  #
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/breadcrumb.rb:13
  def initialize(category: T.unsafe(nil), message: T.unsafe(nil), metadata: T.unsafe(nil)); end

  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/breadcrumb.rb:31
  def <=>(other); end

  # Returns the value of attribute active.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/breadcrumb.rb:9
  def active; end
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/breadcrumb.rb:40
  def active?; end

  # Raw breadcrumb data structure
  #
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/breadcrumb.rb:8
  def category; end
  ...
  # @return self
  #
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/breadcrumb.rb:47
  def ignore!; end
  ...
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/breadcrumb.rb:22
  def to_h; end
end

# source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/collector.rb:5
class Honeybadger::Breadcrumbs::Collector
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/collector.rb:29
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/collector.rb:37
  def <<(breadcrumb); end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/collector.rb:50
  ...
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/collector.rb:62
  def to_h; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/collector.rb:58
  def trail; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/collector.rb:76
  def initialize_dup(source); end
end

# source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/ring_buffer.rb:3
class Honeybadger::Breadcrumbs::RingBuffer
  include ::Enumerable

  # @return [RingBuffer] a new instance of RingBuffer
  #
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/ring_buffer.rb:11
  def initialize(buffer_size = T.unsafe(nil)); end

  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/ring_buffer.rb:16
  def add!(item); end

  # Returns the value of attribute buffer.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/ring_buffer.rb:9
  def buffer; end

  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/ring_buffer.rb:22
  def clear!; end

  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/ring_buffer.rb:39
  def drop; end

  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/ring_buffer.rb:31
  def each(&blk); end

  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/ring_buffer.rb:35
  def previous; end

  # source://honeybadger-4.12.2/lib/honeybadger/breadcrumbs/ring_buffer.rb:27
  def to_a; end
end
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/defaults.rb:5
class Honeybadger::Config
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:40
  def initialize(opts = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:113
  def [](key); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:125
  def []=(key, value); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:150
  def backend; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:155
  def backend=(backend); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:82
  def backtrace_filter(&block); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:91
  def before_notify_hooks; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:191
  def ca_bundle_path; end

  # @api private
  # @yield [new_ruby]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:74
  def configure; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:205
  def connection_port; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:215
  def connection_protocol; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:174
  def debug?; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:267
  def detected_framework; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:160
  def dev?; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:47
  def env; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:95
  def exception_filter(&block); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:104
  def exception_fingerprint(&block); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:231
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:281
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:183
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:52
  def init!(opts = T.unsafe(nil), env = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:64
  def load!(framework: T.unsafe(nil), env: T.unsafe(nil)); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:251
  def load_plugin?(name); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:201
  def local_cert_path; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:178
  def log_debug?; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:240
  def log_level(key = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:145
  def logger; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:223
  def max_queue_size; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:227
  def params_filters; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:168
  def public?; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:257
  def root_regexp; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:131
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:164
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:346
  def build_file_logger(path); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:357
  def build_logger; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:337
  def build_stdout_logger; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:304
  def config_path; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:308
  def config_paths; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:314
  def default_backend; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:293
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:378
  def includes_token?(obj, value); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:319
  def init_backend!; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:372
  def init_logging!; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:392
  def load_config_from_disk; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:383
  def locate_absolute_path(path, root); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:298
  def log_path; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:353
  def log_stdout?; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config.rb:400
  def undotify_keys(hash); end
end

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/defaults.rb:6
class Honeybadger::Config::Boolean; end

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config.rb:24
class Honeybadger::Config::ConfigError < ::StandardError; end

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/defaults.rb:325
Honeybadger::Config::DEFAULTS = T.let(T.unsafe(nil), Hash)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/defaults.rb:35
Honeybadger::Config::DEFAULT_PATHS = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/defaults.rb:33
Honeybadger::Config::DEVELOPMENT_ENVIRONMENTS = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config.rb:34
Honeybadger::Config::DOTTED_KEY = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/env.rb:5
module Honeybadger::Config::Env
  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/config/env.rb:25
    def cast_value(value, type = T.unsafe(nil)); end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/config/env.rb:11
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/env.rb:8
Honeybadger::Config::Env::ARRAY_VALUES = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/env.rb:6
Honeybadger::Config::Env::CONFIG_KEY = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/env.rb:7
Honeybadger::Config::Env::CONFIG_MAPPING = T.let(T.unsafe(nil), Hash)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/env.rb:9
Honeybadger::Config::Env::IGNORED_TYPES = T.let(T.unsafe(nil), Set)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/defaults.rb:8
Honeybadger::Config::IGNORE_DEFAULT = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config.rb:38
Honeybadger::Config::IVARS = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config.rb:32
Honeybadger::Config::KEY_REPLACEMENT = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:3
class Honeybadger::Config::Mash
  # @api private
  # @return [Mash] a new instance of Mash
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:6
  def initialize(config, prefix: T.unsafe(nil), hash: T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:12
  def to_h; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:19
  def config; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:60
  def get(key); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:49
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:54
  def key(method_name); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:38
  def mash?(method); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:21
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:34
  def respond_to_missing?(method_name, include_private = T.unsafe(nil)); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:43
  def setter?(method_name); end
end

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:4
Honeybadger::Config::Mash::KEYS = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config.rb:36
Honeybadger::Config::NOT_BLANK = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/defaults.rb:37
Honeybadger::Config::OPTIONS = T.let(T.unsafe(nil), Hash)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:67
class Honeybadger::Config::Ruby < ::Honeybadger::Config::Mash
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:80
  def backend; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:76
  def backend=(backend); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:96
  def backtrace_filter(&block); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:84
  def before_notify(action = T.unsafe(nil), &block); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:105
  def exception_filter(&block); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:114
  def exception_fingerprint(&block); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:72
  def logger; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:68
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/config/ruby.rb:125
  def validate_before_action(action); end
end

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/yaml.rb:7
module Honeybadger::Config::Yaml
  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/config/yaml.rb:61
    def dotify_keys(hash, key_prefix = T.unsafe(nil)); end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/config/yaml.rb:27
    def load_yaml(path); end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/config/yaml.rb:10
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/config/yaml.rb:8
Honeybadger::Config::Yaml::DISALLOWED_KEYS = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/context_manager.rb:5
class Honeybadger::ContextManager
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/context_manager.rb:12
  def initialize; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/context_manager.rb:17
  def clear!; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/context_manager.rb:31
  def get_context; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/context_manager.rb:39
  def get_rack_env; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/context_manager.rb:24
  def set_context(hash); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/context_manager.rb:35
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/context_manager.rb:47
  def _initialize; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/context_manager.rb:45
  def custom; end
  ...
  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/context_manager.rb:8
    def current; end
  end
end
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/conversions.rb:3
module Honeybadger::Conversions
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/conversions.rb:11
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:24
Honeybadger::GEM_ROOT = T.let(T.unsafe(nil), String)

# source://honeybadger-4.12.2/lib/honeybadger/init/rails.rb:7
module Honeybadger::Init; end

# source://honeybadger-4.12.2/lib/honeybadger/init/rails.rb:8
module Honeybadger::Init::Rails; end

# source://honeybadger-4.12.2/lib/honeybadger/init/rails.rb:9
class Honeybadger::Init::Rails::Railtie < ::Rails::Railtie; end

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:8
module Honeybadger::Logging; end

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:48
class Honeybadger::Logging::Base
  # @api private
  # @raise [NotImplementedError]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:59
  def add(severity, msg); end

  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:50
  def debug(msg); end

  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:54
  def debug?; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:63
  def level; end
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:68
class Honeybadger::Logging::BootLogger < ::Honeybadger::Logging::Base
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:71
  def initialize; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:75
  def add(severity, msg); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:79
  def flush(logger); end
end

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:117
class Honeybadger::Logging::ConfigLogger < ::Honeybadger::Logging::StandardLogger
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:124
  def initialize(config, logger = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:131
  def add(severity, msg); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:144
  def debug?; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:170
  def caller_location; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:158
  def supplement(msg, severity); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:150
  def suppress_debug?; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:154
  def suppress_tty?(severity); end
end

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:119
Honeybadger::Logging::ConfigLogger::CALLER_LOCATION = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:122
Honeybadger::Logging::ConfigLogger::DEBUG_SUPPLEMENT = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:121
Honeybadger::Logging::ConfigLogger::INFO_SUPPLEMENT = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:118
Honeybadger::Logging::ConfigLogger::LOCATE_CALLER_LOCATION = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:104
class Honeybadger::Logging::FormattedLogger < ::Honeybadger::Logging::StandardLogger
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:105
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:111
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:16
module Honeybadger::Logging::Helper
  private

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:18
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:37
  def error(msg = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:25
  def info(msg = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:43
  def logger; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:31
  def warn(msg = T.unsafe(nil)); end
end

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:10
Honeybadger::Logging::LOGGER_PROG = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:9
Honeybadger::Logging::PREFIX = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/logging.rb:87
class Honeybadger::Logging::StandardLogger < ::Honeybadger::Logging::Base
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:90
  def initialize(logger = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/logging.rb:97
  def add(severity, msg, progname = T.unsafe(nil)); end
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:43
Honeybadger::MAX_EXCEPTION_CAUSES = T.let(T.unsafe(nil), Integer)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:15
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:36
Honeybadger::NOT_BLANK = T.let(T.unsafe(nil), Regexp)

# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:49
class Honeybadger::Notice
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:179
  def initialize(config, opts = T.unsafe(nil)); end

  # The action (if any) that was called in this request.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:124
  def action; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:136
  def api_key; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:225
  def as_json(*args); end

  # The backtrace from the given exception or hash.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:91
  def backtrace; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:142
  def breadcrumbs; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:81
  def cause; end

  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:82
  def cause=(cause); end

  # @return [Cause] A list of exception causes (see {Cause})
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:88
  def causes; end

  # CGI variables such as HTTP_METHOD.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:112
  def cgi_data; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:119
  def component; end
  ...
  # The context Hash.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:109
  def context; end
  ...
  # Custom details data
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:145
  def details; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:103
  def error_class; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:106
  def error_message; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:78
  def exception; end

  # Custom fingerprint for error, used to group similar errors together.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:94
  def fingerprint; end
  ...
  # Returns nothing.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:273
  def halt!; end
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:279
  def halted?; end

  # The unique ID of this notice which can be used to reference the error in
  # Honeybadger.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:75
  def id; end
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:266
  def ignore?; end

  # Local variables are extracted from first frame of backtrace.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:133
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:115
  def parameters; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:127
  def session; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:139
  def source; end

  # Tags which will be applied to error.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:97
  def tags; end

  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:98
  def tags=(tags); end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:260
  def to_json(*a); end

  # The URL at which the error occurred (if any).
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:130
  def url; end
  ...
  # Returns the value of attribute config.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:285
  def config; end

  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:350
  def construct_backtrace_filters(opts); end

  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:400
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:363
  def construct_request_hash; end

  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:424
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:309
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:517
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:380
  def exception_context(exception); end

  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:408
  def fingerprint_from_opts(opts); end

  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:419
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:321
  def from_exception(attribute); end

  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:294
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:337
  def ignore_by_class?(ignored_class = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:288
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:445
  ...
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:560
  def params_filters; end
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:492
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:550
  ...
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:564
  def rails_params_filters; end

  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:356
  ...
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:436
  def s(data); end

  # Sanitize metadata to keep it at a single level and remove any filtered
  # parameters
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:391
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:483
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:533
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:507
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:157
Honeybadger::Notice::BACKTRACE_FILTERS = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:63
class Honeybadger::Notice::Cause
  # @api private
  # @return [Cause] a new instance of Cause
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:66
  def initialize(cause); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/notice.rb:64
  def backtrace; end
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:153
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:149
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:60
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:56
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:28
...
#   end
#
# source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:43
class Honeybadger::Plugin
  # @api private
  # @return [Plugin] a new instance of Plugin
  #
  # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:115
  ...
  # @return nil
  #
  # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:164
  def execution(&block); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:208
  def executions; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:177
  def load!(config); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:197
  def loaded?; end
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:169
  def ok?(config); end
  ...
  # @return nil
  #
  # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:139
  ...
  # @private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:203
  def reset!; end

  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:52
    def instances; end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:77
    def load!(config); end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:88
    ...
    # @return nil
    #
    # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:69
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:45
Honeybadger::Plugin::CALLER_FILE = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:96
class Honeybadger::Plugin::Execution
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:99
  def initialize(config, &block); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:104
  def call; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/plugin.rb:110
  def block; end
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/const.rb:14
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:40
Honeybadger::RELATIVE_ROOT = T.let(T.unsafe(nil), Regexp)

# source://honeybadger-4.12.2/lib/honeybadger/const.rb:4
...
#   run app
#
# source://honeybadger-4.12.2/lib/honeybadger/rack/error_notifier.rb:21
class Honeybadger::Rack::ErrorNotifier
  extend ::Forwardable

  # @return [ErrorNotifier] a new instance of ErrorNotifier
  #
  # source://honeybadger-4.12.2/lib/honeybadger/rack/error_notifier.rb:24
  def initialize(app, agent = T.unsafe(nil)); end

  # source://honeybadger-4.12.2/lib/honeybadger/rack/error_notifier.rb:29
  def call(env); end
  ...
  # source://honeybadger-4.12.2/lib/honeybadger/rack/error_notifier.rb:55
  def agent; end

  # source://honeybadger-4.12.2/lib/honeybadger/rack/error_notifier.rb:86
  def framework_exception(env); end

  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/rack/error_notifier.rb:59
  def ignored_user_agent?(env); end

  # source://honeybadger-4.12.2/lib/honeybadger/rack/error_notifier.rb:65
...
#
# source://honeybadger-4.12.2/lib/honeybadger/rack/user_feedback.rb:21
class Honeybadger::Rack::UserFeedback
  extend ::Forwardable

  # @return [UserFeedback] a new instance of UserFeedback
  #
  # source://honeybadger-4.12.2/lib/honeybadger/rack/user_feedback.rb:24
  def initialize(app, agent = T.unsafe(nil)); end

  # @private
  # @todo Make this method and others actually private.
  #
  # source://honeybadger-4.12.2/lib/honeybadger/rack/user_feedback.rb:46
  def action; end

  # source://honeybadger-4.12.2/lib/honeybadger/rack/user_feedback.rb:29
  def call(env); end
  ...
  # @private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/rack/user_feedback.rb:59
  def custom_template_file; end

  # @private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/rack/user_feedback.rb:64
  def custom_template_file?; end
  ...
  # @private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/rack/user_feedback.rb:53
  def render_form(error_id, action = T.unsafe(nil)); end

  # @private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/rack/user_feedback.rb:69
  def template_file; end

  private

  # source://honeybadger-4.12.2/lib/honeybadger/rack/user_feedback.rb:82
  def agent; end
end
...
#
# source://honeybadger-4.12.2/lib/honeybadger/rack/user_informer.rb:7
class Honeybadger::Rack::UserInformer
  extend ::Forwardable

  # @return [UserInformer] a new instance of UserInformer
  #
  # source://honeybadger-4.12.2/lib/honeybadger/rack/user_informer.rb:10
  def initialize(app, agent = T.unsafe(nil)); end

  # source://honeybadger-4.12.2/lib/honeybadger/rack/user_informer.rb:19
  def call(env); end
  ...
  # source://honeybadger-4.12.2/lib/honeybadger/rack/user_informer.rb:15
  def replacement(with); end

  private

  # source://honeybadger-4.12.2/lib/honeybadger/rack/user_informer.rb:40
  def agent; end
end
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/notice.rb:32
Honeybadger::STRING_EMPTY = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/const.rb:18
module Honeybadger::Util; end

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/http.rb:12
class Honeybadger::Util::HTTP
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/http.rb:36
  def initialize(config); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/http.rb:40
  def get(endpoint); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/http.rb:46
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/http.rb:87
  def compress(string, level = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/http.rb:54
  def config; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/http.rb:56
  def http_connection; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/http.rb:60
  def http_headers(headers = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/http.rb:68
  def setup_http_connection; end
end

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/http.rb:24
Honeybadger::Util::HTTP::ERRORS = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/http.rb:17
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/request_hash.rb:7
module Honeybadger::Util::RequestHash
  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/request_hash.rb:64
    def extract_cgi_data(request); end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/request_hash.rb:49
    def extract_params(request); end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/request_hash.rb:55
    def extract_session(request); end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/request_hash.rb:43
    def extract_url(request); end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/request_hash.rb:27
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/request_hash.rb:10
Honeybadger::Util::RequestHash::CGI_WHITELIST = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/request_hash.rb:8
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/request_payload.rb:6
module Honeybadger::Util::RequestPayload
  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/request_payload.rb:23
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/request_payload.rb:8
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/request_payload.rb:21
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/request_payload.rb:18
Honeybadger::Util::RequestPayload::KEYS = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/revision.rb:3
class Honeybadger::Util::Revision
  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/revision.rb:5
    ...
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/revision.rb:26
    def from_capistrano(root); end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/revision.rb:32
    def from_git; end
    ...
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/revision.rb:22
    def from_heroku; end
  end
end
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sql.rb:3
class Honeybadger::Util::SQL
  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/sql.rb:24
    def force_utf_8(string); end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/sql.rb:13
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sql.rb:6
Honeybadger::Util::SQL::DQuotedData = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sql.rb:11
Honeybadger::Util::SQL::DoubleQuoters = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sql.rb:10
Honeybadger::Util::SQL::EmptyReplacement = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sql.rb:4
Honeybadger::Util::SQL::EscapedQuotes = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sql.rb:8
Honeybadger::Util::SQL::Newline = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sql.rb:7
Honeybadger::Util::SQL::NumericData = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sql.rb:9
Honeybadger::Util::SQL::Replacement = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sql.rb:5
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:10
class Honeybadger::Util::Sanitizer
  # @api private
  # @return [Sanitizer] a new instance of Sanitizer
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:35
  def initialize(max_depth: T.unsafe(nil), filters: T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:133
  def filter_cookies(raw_cookies); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:147
  def filter_url(url); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:59
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:197
  def basic_object?(object); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:162
  def blocks; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:205
  def can_dup?(obj); end
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:168
  def filter_key?(key, parents = T.unsafe(nil)); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:164
  def filters?; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:209
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:193
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:175
  def sanitize_string(string); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:188
  def valid_encoding(string); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:181
  def valid_encoding?(string); end

  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:30
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:17
Honeybadger::Util::Sanitizer::BASIC_OBJECT = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:11
Honeybadger::Util::Sanitizer::COOKIE_PAIRS = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:13
Honeybadger::Util::Sanitizer::COOKIE_PAIR_SEP = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:12
Honeybadger::Util::Sanitizer::COOKIE_SEP = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:18
Honeybadger::Util::Sanitizer::DEPTH = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:15
Honeybadger::Util::Sanitizer::ENCODE_OPTS = T.let(T.unsafe(nil), Hash)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:19
Honeybadger::Util::Sanitizer::FILTERED = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:24
Honeybadger::Util::Sanitizer::IMMUTABLE = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:26
Honeybadger::Util::Sanitizer::MAX_STRING_SIZE = T.let(T.unsafe(nil), Integer)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:20
Honeybadger::Util::Sanitizer::RAISED = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:21
Honeybadger::Util::Sanitizer::RECURSION = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:22
Honeybadger::Util::Sanitizer::TRUNCATED = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/sanitizer.rb:28
Honeybadger::Util::Sanitizer::VALID_ENCODINGS = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/stats.rb:3
class Honeybadger::Util::Stats
  class << self
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/stats.rb:8
    def all; end
    ...
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/stats.rb:23
    def load; end
    ...
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/stats.rb:13
    def memory; end
    ...
    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/stats.rb:41
    def run; end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/stats.rb:37
    def run_loadavg; end

    # @api private
    #
    # source://honeybadger-4.12.2/lib/honeybadger/util/stats.rb:33
    def run_meminfo; end
  end
end
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/stats.rb:5
Honeybadger::Util::Stats::HAS_LOAD = T.let(T.unsafe(nil), TrueClass)

# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/util/stats.rb:4
Honeybadger::Util::Stats::HAS_MEM = T.let(T.unsafe(nil), TrueClass)

# The current String Honeybadger version.
#
# source://honeybadger-4.12.2/lib/honeybadger/version.rb:3
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/worker.rb:9
class Honeybadger::Worker
  ...
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:25
  def initialize(config); end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:77
  def flush; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:37
  def push(msg); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:48
  def send_now(msg); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:52
  def shutdown(force = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:86
  def start; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:192
  def calc_throttle_interval; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:117
  def can_start?; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:104
  def config; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:204
  def dec_throttle; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:213
  def handle_response(msg, response); end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:196
  def inc_throttle; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:127
  def kill!; end
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:187
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:243
  def release_marker; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:148
  def run; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:109
  def shutdown?; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:247
  ...
  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:138
  def suspend(interval); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:113
  def suspended?; end
  ...
  # @return [Boolean]
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:123
  def throttled?; end

  # @api private
  #
  # source://honeybadger-4.12.2/lib/honeybadger/worker.rb:170
  def work(msg); end
end
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/worker.rb:23
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/worker.rb:18
...
# @api private
#
# source://honeybadger-4.12.2/lib/honeybadger/worker.rb:15
