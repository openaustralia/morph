...
# source://xpath-3.2.0/lib/xpath/dsl.rb:3
module XPath
  include ::XPath::DSL
  extend ::XPath::DSL
...
# source://xpath-3.2.0/lib/xpath/dsl.rb:4
module XPath::DSL
...
# source://xpath-3.2.0/lib/xpath/expression.rb:4
class XPath::Expression
  include ::XPath::DSL

  # @return [Expression] a new instance of Expression
  #
  # source://xpath-3.2.0/lib/xpath/expression.rb:8
  def initialize(expression, *arguments); end

  # Returns the value of attribute arguments.
  #
  # source://xpath-3.2.0/lib/xpath/expression.rb:5
  def arguments; end
  ...
  # source://xpath-3.2.0/lib/xpath/expression.rb:13
  def current; end
  ...
  # source://xpath-3.2.0/lib/xpath/expression.rb:17
...
# source://xpath-3.2.0/lib/xpath/literal.rb:4
class XPath::Literal
  # @return [Literal] a new instance of Literal
  #
  # source://xpath-3.2.0/lib/xpath/literal.rb:6
  def initialize(value); end

  # Returns the value of attribute value.
  #
  # source://xpath-3.2.0/lib/xpath/literal.rb:5
  def value; end
end

# source://xpath-3.2.0/lib/xpath/renderer.rb:4
...
# source://xpath-3.2.0/lib/xpath/union.rb:4
class XPath::Union
  include ::Enumerable

  # @return [Union] a new instance of Union
  #
  # source://xpath-3.2.0/lib/xpath/union.rb:10
  def initialize(*expressions); end

  # Returns the value of attribute expressions.
  #
  # source://xpath-3.2.0/lib/xpath/union.rb:7
  def arguments; end

  # source://xpath-3.2.0/lib/xpath/union.rb:18
  def each(&block); end

  # source://xpath-3.2.0/lib/xpath/union.rb:14
  def expression; end
  ...
  # source://xpath-3.2.0/lib/xpath/union.rb:22
  def method_missing(*args); end

  # source://xpath-3.2.0/lib/xpath/union.rb:26
  def to_s(type = T.unsafe(nil)); end
