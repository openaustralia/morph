...
# hashing passwords.
#
# source://bcrypt-3.1.22/lib/bcrypt.rb:3
module BCrypt; end

# A Ruby wrapper for the bcrypt() C extension calls and the Java calls.
#
# source://bcrypt-3.1.22/lib/bcrypt/engine.rb:3
class BCrypt::Engine
  class << self
    # Autodetects the cost from the salt string.
    #
    # source://bcrypt-3.1.22/lib/bcrypt/engine.rb:129
    ...
    #
    # source://bcrypt-3.1.22/lib/bcrypt/engine.rb:119
    ...
    #
    # source://bcrypt-3.1.22/lib/bcrypt/engine.rb:32
    def cost; end
    ...
    #
    # source://bcrypt-3.1.22/lib/bcrypt/engine.rb:49
    def cost=(cost); end

    # Generates a random salt with a given computational cost.
    #
    # source://bcrypt-3.1.22/lib/bcrypt/engine.rb:81
    def generate_salt(cost = T.unsafe(nil)); end

    # Given a secret and a valid salt (see BCrypt::Engine.generate_salt) calculates
    # a bcrypt() password hash. Secrets longer than 72 bytes are truncated.
    #
    # source://bcrypt-3.1.22/lib/bcrypt/engine.rb:55
    ...
    # @return [Boolean]
    #
    # source://bcrypt-3.1.22/lib/bcrypt/engine.rb:98
    ...
    # @return [Boolean]
    #
    # source://bcrypt-3.1.22/lib/bcrypt/engine.rb:103
...
#
# source://bcrypt-3.1.22/lib/bcrypt/password.rb:24
class BCrypt::Password < ::String
  # Initializes a BCrypt::Password instance with the data from a stored hash.
  #
  # @return [Password] a new instance of Password
  #
  # source://bcrypt-3.1.22/lib/bcrypt/password.rb:55
  ...
  #
  # source://bcrypt-3.1.22/lib/bcrypt/password.rb:78
  def ==(secret); end

  # The hash portion of the stored password hash.
  #
  # source://bcrypt-3.1.22/lib/bcrypt/password.rb:25
  def checksum; end

  # The cost factor used to create the hash.
  #
  # source://bcrypt-3.1.22/lib/bcrypt/password.rb:31
  def cost; end
  ...
  #
  # source://bcrypt-3.1.22/lib/bcrypt/password.rb:27
  def salt; end

  # The version of the bcrypt() algorithm used to create the hash.
  #
  # source://bcrypt-3.1.22/lib/bcrypt/password.rb:29
  def version; end
  ...
  #
  # source://bcrypt-3.1.22/lib/bcrypt/password.rb:101
  ...
  # @return [Boolean]
  #
  # source://bcrypt-3.1.22/lib/bcrypt/password.rb:93
  ...
  class << self
    ...
    # @raise [ArgumentError]
    #
    # source://bcrypt-3.1.22/lib/bcrypt/password.rb:43
    def create(secret, options = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://bcrypt-3.1.22/lib/bcrypt/password.rb:49
    def valid_hash?(h); end
  end
end
