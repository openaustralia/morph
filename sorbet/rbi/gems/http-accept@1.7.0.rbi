...
# source://http-accept-1.7.0/lib/http/accept/version.rb:21
module HTTP; end

# source://http-accept-1.7.0/lib/http/accept/version.rb:22
...
#
# source://http-accept-1.7.0/lib/http/accept/content_type.rb:27
class HTTP::Accept::ContentType < ::HTTP::Accept::MediaTypes::MediaRange
  # @raise [ArgumentError]
  # @return [ContentType] a new instance of ContentType
  #
  # source://http-accept-1.7.0/lib/http/accept/content_type.rb:28
  def initialize(mime_type, parameters = T.unsafe(nil)); end
end

# source://http-accept-1.7.0/lib/http/accept/encodings.rb:29
module HTTP::Accept::Encodings
  class << self
    ...
    # (according to RFC).
    #
    # source://http-accept-1.7.0/lib/http/accept/encodings.rb:74
    def browser_preferred_content_codings(env); end

    # source://http-accept-1.7.0/lib/http/accept/encodings.rb:57
    def parse(text); end
  end
end

# source://http-accept-1.7.0/lib/http/accept/encodings.rb:36
HTTP::Accept::Encodings::CODINGS = T.let(T.unsafe(nil), Regexp)

# https://tools.ietf.org/html/rfc7231#section-5.3.4
#
# source://http-accept-1.7.0/lib/http/accept/encodings.rb:31
HTTP::Accept::Encodings::CONTENT_CODING = T.let(T.unsafe(nil), Regexp)

# source://http-accept-1.7.0/lib/http/accept/encodings.rb:38
class HTTP::Accept::Encodings::ContentCoding < ::Struct
  ...
  # source://http-accept-1.7.0/lib/http/accept/encodings.rb:39
  ...
  class << self
    ...
    # @raise [ParseError]
    #
    # source://http-accept-1.7.0/lib/http/accept/encodings.rb:43
    def parse(scanner); end
  end
end

# source://http-accept-1.7.0/lib/http/accept/encodings.rb:65
HTTP::Accept::Encodings::HTTP_ACCEPT_ENCODING = T.let(T.unsafe(nil), String)

# source://http-accept-1.7.0/lib/http/accept/encodings.rb:67
HTTP::Accept::Encodings::IDENTITY_CONTENT_CODING = T.let(T.unsafe(nil), HTTP::Accept::Encodings::ContentCoding)

# https://tools.ietf.org/html/rfc7231#section-5.3.1
#
# source://http-accept-1.7.0/lib/http/accept/encodings.rb:34
HTTP::Accept::Encodings::QVALUE = T.let(T.unsafe(nil), Regexp)

# source://http-accept-1.7.0/lib/http/accept/encodings.rb:66
HTTP::Accept::Encodings::WILDCARD_CONTENT_CODING = T.let(T.unsafe(nil), HTTP::Accept::Encodings::ContentCoding)

# source://http-accept-1.7.0/lib/http/accept/languages.rb:28
module HTTP::Accept::Languages
  class << self
    # source://http-accept-1.7.0/lib/http/accept/languages.rb:118
    def parse(text); end
  end
end
...
#
# source://http-accept-1.7.0/lib/http/accept/languages.rb:36
HTTP::Accept::Languages::LANGUAGE_RANGE = T.let(T.unsafe(nil), Regexp)

# https://tools.ietf.org/html/rfc3066#section-2.1
#
# source://http-accept-1.7.0/lib/http/accept/languages.rb:30
HTTP::Accept::Languages::LOCALE = T.let(T.unsafe(nil), Regexp)

# source://http-accept-1.7.0/lib/http/accept/languages.rb:99
class HTTP::Accept::Languages::LanguageRange < ::Struct
  ...
  # source://http-accept-1.7.0/lib/http/accept/languages.rb:100
  def quality_factor; end
  ...
  class << self
    ...
    # @raise [ParseError]
    #
    # source://http-accept-1.7.0/lib/http/accept/languages.rb:104
    def parse(scanner); end
  end
end
...
#
# source://http-accept-1.7.0/lib/http/accept/languages.rb:39
class HTTP::Accept::Languages::Locales
  # @return [Locales] a new instance of Locales
  #
  # source://http-accept-1.7.0/lib/http/accept/languages.rb:52
  def initialize(names); end

  # Returns the intersection of others retaining order.
  #
  # source://http-accept-1.7.0/lib/http/accept/languages.rb:78
  def &(languages); end

  # source://http-accept-1.7.0/lib/http/accept/languages.rb:90
  def +(others); end

  # source://http-accept-1.7.0/lib/http/accept/languages.rb:68
  def each(&block); end

  # source://http-accept-1.7.0/lib/http/accept/languages.rb:61
  def freeze; end

  # @return [Boolean]
  #
  # source://http-accept-1.7.0/lib/http/accept/languages.rb:82
  def include?(locale_name); end

  # source://http-accept-1.7.0/lib/http/accept/languages.rb:86
  def join(*args); end

  # Returns the value of attribute names.
  #
  # source://http-accept-1.7.0/lib/http/accept/languages.rb:74
  def names; end

  # Returns the value of attribute patterns.
  #
  # source://http-accept-1.7.0/lib/http/accept/languages.rb:75
  def patterns; end

  # source://http-accept-1.7.0/lib/http/accept/languages.rb:94
  def to_a; end

  class << self
    # source://http-accept-1.7.0/lib/http/accept/languages.rb:40
...
#
# source://http-accept-1.7.0/lib/http/accept/languages.rb:33
HTTP::Accept::Languages::QVALUE = T.let(T.unsafe(nil), Regexp)

# Parse and process the HTTP Accept: header.
#
# source://http-accept-1.7.0/lib/http/accept/media_types/map.rb:23
module HTTP::Accept::MediaTypes
  class << self
    ...
    #
    # source://http-accept-1.7.0/lib/http/accept/media_types.rb:114
    def browser_preferred_media_types(env); end

    # source://http-accept-1.7.0/lib/http/accept/media_types.rb:102
    def parse(text, normalize_whitespace = T.unsafe(nil)); end
  end
end

# source://http-accept-1.7.0/lib/http/accept/media_types.rb:110
HTTP::Accept::MediaTypes::HTTP_ACCEPT = T.let(T.unsafe(nil), String)

# According to https://tools.ietf.org/html/rfc7231#section-5.3.2
#
# source://http-accept-1.7.0/lib/http/accept/media_types.rb:34
HTTP::Accept::MediaTypes::MIME_TYPE = T.let(T.unsafe(nil), Regexp)

# Map a set of mime types to objects.
#
# source://http-accept-1.7.0/lib/http/accept/media_types/map.rb:25
class HTTP::Accept::MediaTypes::Map
  # @return [Map] a new instance of Map
  #
  # source://http-accept-1.7.0/lib/http/accept/media_types/map.rb:28
  def initialize; end
  ...
  #
  # source://http-accept-1.7.0/lib/http/accept/media_types/map.rb:66
  def <<(object); end

  # source://http-accept-1.7.0/lib/http/accept/media_types/map.rb:61
  def [](media_range); end

  # source://http-accept-1.7.0/lib/http/accept/media_types/map.rb:57
  ...
  #
  # source://http-accept-1.7.0/lib/http/accept/media_types/map.rb:42
  def for(media_types); end

  # source://http-accept-1.7.0/lib/http/accept/media_types/map.rb:32
  def freeze; end
end

# source://http-accept-1.7.0/lib/http/accept/media_types/map.rb:26
...
#
# source://http-accept-1.7.0/lib/http/accept/media_types.rb:38
class HTTP::Accept::MediaTypes::MediaRange < ::Struct
  # source://http-accept-1.7.0/lib/http/accept/media_types.rb:47
  def ===(other); end
  ...
  # source://http-accept-1.7.0/lib/http/accept/media_types.rb:39
  def parameters_string; end

  # source://http-accept-1.7.0/lib/http/accept/media_types.rb:61
  def quality_factor; end

  # source://http-accept-1.7.0/lib/http/accept/media_types.rb:65
  def split(on = T.unsafe(nil), count = T.unsafe(nil)); end

  # source://http-accept-1.7.0/lib/http/accept/media_types.rb:55
  def to_s; end
  ...
  class << self
    ...
    # @raise [ParseError]
    #
    # source://http-accept-1.7.0/lib/http/accept/media_types.rb:86
    def parse(scanner, normalize_whitespace = T.unsafe(nil)); end

    # source://http-accept-1.7.0/lib/http/accept/media_types.rb:69
    def parse_parameters(scanner, normalize_whitespace); end
  end
end

# source://http-accept-1.7.0/lib/http/accept/media_types.rb:35
HTTP::Accept::MediaTypes::PARAMETER = T.let(T.unsafe(nil), Regexp)

# source://http-accept-1.7.0/lib/http/accept/media_types.rb:111
HTTP::Accept::MediaTypes::WILDCARD_MEDIA_RANGE = T.let(T.unsafe(nil), HTTP::Accept::MediaTypes::MediaRange)

# source://http-accept-1.7.0/lib/http/accept/parse_error.rb:23
class HTTP::Accept::ParseError < ::ArgumentError; end

# source://http-accept-1.7.0/lib/http/accept/quoted_string.rb:25
HTTP::Accept::QUOTED_STRING = T.let(T.unsafe(nil), Regexp)

# source://http-accept-1.7.0/lib/http/accept/quoted_string.rb:27
module HTTP::Accept::QuotedString
  class << self
    # Quote a string if required. Doesn't handle newlines correctly currently.
    #
    # source://http-accept-1.7.0/lib/http/accept/quoted_string.rb:44
    ...
    #
    # source://http-accept-1.7.0/lib/http/accept/quoted_string.rb:30
    def unquote(value, normalize_whitespace = T.unsafe(nil)); end
  end
end

# source://http-accept-1.7.0/lib/http/accept/sort.rb:23
module HTTP::Accept::Sort
  class << self
    ...
    #
    # source://http-accept-1.7.0/lib/http/accept/sort.rb:25
...
#
# source://http-accept-1.7.0/lib/http/accept/quoted_string.rb:24
HTTP::Accept::TOKEN = T.let(T.unsafe(nil), Regexp)

# source://http-accept-1.7.0/lib/http/accept/version.rb:23
