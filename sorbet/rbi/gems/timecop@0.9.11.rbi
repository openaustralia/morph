...
#
# source://timecop-0.9.11/lib/timecop/time_stack_item.rb:1
class Timecop
  include ::Singleton
  ...
  #
  # source://timecop-0.9.11/lib/timecop/timecop.rb:198
  def initialize; end

  # source://timecop-0.9.11/lib/timecop/timecop.rb:165
  def baseline; end

  # source://timecop-0.9.11/lib/timecop/timecop.rb:160
  def baseline=(b); end

  # source://timecop-0.9.11/lib/timecop/timecop.rb:233
  def return(&block); end

  # source://timecop-0.9.11/lib/timecop/timecop.rb:248
  def return_to_baseline; end

  # source://timecop-0.9.11/lib/timecop/timecop.rb:173
  def set_baseline(b); end

  # source://timecop-0.9.11/lib/timecop/timecop.rb:190
  def set_stack(s); end

  # source://timecop-0.9.11/lib/timecop/timecop.rb:181
  def stack; end

  # source://timecop-0.9.11/lib/timecop/timecop.rb:209
  def thread_safe; end

  # source://timecop-0.9.11/lib/timecop/timecop.rb:204
  def thread_safe=(t); end

  # @raise [SafeModeException]
  #
  # source://timecop-0.9.11/lib/timecop/timecop.rb:213
  def travel(mock_type, *args, &block); end

  # source://timecop-0.9.11/lib/timecop/timecop.rb:243
  def unmock!; end

  class << self
    # source://timecop-0.9.11/lib/timecop/timecop.rb:84
    def baseline; end

    # source://timecop-0.9.11/lib/timecop/timecop.rb:88
    ...
    #
    # source://timecop-0.9.11/lib/timecop/timecop.rb:57
    ...
    # @return [Boolean]
    #
    # source://timecop-0.9.11/lib/timecop/timecop.rb:131
    def frozen?; end

    # source://timecop-0.9.11/lib/timecop/timecop.rb:145
    def mock_process_clock=(mock); end

    # @return [Boolean]
    #
    # source://timecop-0.9.11/lib/timecop/timecop.rb:149
    ...
    # the given block.
    #
    # source://timecop-0.9.11/lib/timecop/timecop.rb:95
    def return(&block); end

    # source://timecop-0.9.11/lib/timecop/timecop.rb:105
    def return_to_baseline; end

    # source://timecop-0.9.11/lib/timecop/timecop.rb:114
    def safe_mode=(safe); end

    # @return [Boolean]
    #
    # source://timecop-0.9.11/lib/timecop/timecop.rb:118
    def safe_mode?; end
    ...
    # Returns the value of the block if one is given, or the mocked time.
    #
    # source://timecop-0.9.11/lib/timecop/timecop.rb:80
    ...
    # @return [Boolean]
    #
    # source://timecop-0.9.11/lib/timecop/timecop.rb:141
    def scaled?; end

    # source://timecop-0.9.11/lib/timecop/timecop.rb:126
    def thread_safe; end

    # source://timecop-0.9.11/lib/timecop/timecop.rb:122
    def thread_safe=(t); end

    # source://timecop-0.9.11/lib/timecop/timecop.rb:110
    ...
    # Returns the value of the block if one is given, or the mocked time.
    #
    # source://timecop-0.9.11/lib/timecop/timecop.rb:68
    ...
    # @return [Boolean]
    #
    # source://timecop-0.9.11/lib/timecop/timecop.rb:136
    def travelled?; end
...
#
# source://timecop-0.9.11/lib/timecop/time_stack_item.rb:4
class Timecop::TimeStackItem
  # @return [TimeStackItem] a new instance of TimeStackItem
  #
  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:7
  def initialize(mock_type, *args); end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:68
  def current_monotonic; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:72
  def current_monotonic_with_mock; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:96
  def date(date_klass = T.unsafe(nil)); end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:100
  def datetime(datetime_klass = T.unsafe(nil)); end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:26
  def day; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:30
  def hour; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:34
  def min; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:5
  def mock_type; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:58
  def monotonic; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:22
  def month; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:92
  def scaled_time; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:54
  def scaling_factor; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:38
  def sec; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:76
  def time(time_klass = T.unsafe(nil)); end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:46
  def travel_offset; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:50
  def travel_offset_days; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:42
  def utc_offset; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:18
  def year; end

  private

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:157
  def compute_travel_offset; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:119
  def parse_monotonic_time(*args); end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:129
  def parse_time(*args); end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:111
  def rational_to_utc_offset(rational); end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:165
  def time_klass; end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:161
  def times_are_equal_within_epsilon(t1, t2, epsilon_in_seconds); end

  # source://timecop-0.9.11/lib/timecop/time_stack_item.rb:115
  def utc_offset_to_rational(utc_offset); end
end

# source://timecop-0.9.11/lib/timecop/version.rb:2
