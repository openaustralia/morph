...
# :include: ../README.md
#
# source://actionmailbox-7.1.5.2/lib/action_mailbox/gem_version.rb:3
module ActionMailbox
  extend ::ActiveSupport::Autoload

  # source://actionmailbox-7.1.5.2/lib/action_mailbox.rb:22
  def incinerate; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox.rb:22
  def incinerate=(val); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox.rb:23
  def incinerate_after; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox.rb:23
  def incinerate_after=(val); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox.rb:20
  def ingress; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox.rb:20
  def ingress=(val); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox.rb:21
  def logger; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox.rb:21
  def logger=(val); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox.rb:24
  def queues; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox.rb:24
  def queues=(val); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox.rb:25
  ...
  class << self
    # source://actionmailbox-7.1.5.2/lib/action_mailbox/deprecator.rb:4
    def deprecator; end

    # Returns the currently loaded version of Action Mailbox as a +Gem::Version+.
    #
    # source://actionmailbox-7.1.5.2/lib/action_mailbox/gem_version.rb:5
    def gem_version; end
    ...
    # Returns the currently loaded version of Action Mailbox as a +Gem::Version+.
    #
    # source://actionmailbox-7.1.5.2/lib/action_mailbox/version.rb:7
    def version; end
  end
end
...
#   end
#
# source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:66
class ActionMailbox::Base
  ...
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:79
  ...
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:111
  def bounce_now_with(message); end

  # Enqueues the given +message+ for delivery and changes the inbound email's status to +:bounced+.
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:105
  def bounce_with(message); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:71
  ...
  # @return [Boolean]
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:100
  def finished_processing?; end

  # Returns the value of attribute inbound_email.
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:70
  def inbound_email; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:73
  def logger(&block); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:71
  def mail(*_arg0, &_arg1); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:83
  def perform_processing; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:96
  def process; end
  ...
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/routing.rb:9
  def router; end
  ...
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:117
  def instrumentation_payload; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:124
  ...
  class << self
    ...
    # source://actionmailbox-7.1.5.2/lib/action_mailbox/base.rb:75
...
#
# source://actionmailbox-7.1.5.2/lib/action_mailbox/callbacks.rb:9
...
# source://actionmailbox-7.1.5.2/lib/action_mailbox/callbacks.rb:0
module ActionMailbox::Callbacks::ClassMethods
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/callbacks.rb:27
  def after_processing(*methods, &block); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/callbacks.rb:31
  def around_processing(*methods, &block); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/callbacks.rb:23
  def before_processing(*methods, &block); end
end

# source://actionmailbox-7.1.5.2/lib/action_mailbox/callbacks.rb:13
ActionMailbox::Callbacks::TERMINATOR = T.let(T.unsafe(nil), Proc)

# source://actionmailbox-7.1.5.2/lib/action_mailbox/engine.rb:12
...
#
# source://actionmailbox-7.1.5.2/lib/action_mailbox/router.rb:8
class ActionMailbox::Router
  # @return [Router] a new instance of Router
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/router.rb:11
  def initialize; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/router.rb:21
  def add_route(address, to:); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/router.rb:15
  def add_routes(routes); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/router.rb:35
  def mailbox_for(inbound_email); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/router.rb:25
  ...
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/router.rb:40
  def routes; end
end

# source://actionmailbox-7.1.5.2/lib/action_mailbox/router/route.rb:7
class ActionMailbox::Router::Route
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/router/route.rb:10
  def initialize(address, to:); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/router/route.rb:8
  def address; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/router/route.rb:31
  def mailbox_class; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/router/route.rb:8
  def mailbox_name; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/router/route.rb:16
  def match?(inbound_email); end

  private

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/router/route.rb:36
  def ensure_valid_address; end
end

# source://actionmailbox-7.1.5.2/lib/action_mailbox/router.rb:9
class ActionMailbox::Router::RoutingError < ::StandardError; end

# See ActionMailbox::Base for how to specify routing.
#
# source://actionmailbox-7.1.5.2/lib/action_mailbox/routing.rb:5
...
# source://actionmailbox-7.1.5.2/lib/action_mailbox/routing.rb:0
module ActionMailbox::Routing::ClassMethods
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/routing.rb:21
  def mailbox_for(inbound_email); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/routing.rb:17
  def route(inbound_email); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/routing.rb:13
  def routing(routes); end
end

# source://actionmailbox-7.1.5.2/lib/action_mailbox/test_case.rb:7
class ActionMailbox::TestCase < ::ActiveSupport::TestCase
  include ::ActionMailbox::TestHelper
end

# source://actionmailbox-7.1.5.2/lib/action_mailbox/test_helper.rb:6
module ActionMailbox::TestHelper
  # Create an InboundEmail record using an eml fixture in the format of message/rfc822
  # referenced with +fixture_name+ located in +test/fixtures/files/fixture_name+.
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/test_helper.rb:9
  ...
  #   end
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/test_helper.rb:63
  def create_inbound_email_from_mail(status: T.unsafe(nil), **mail_options, &block); end

  # Create an InboundEmail using the raw rfc822 +source+ as text.
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/test_helper.rb:72
  ...
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/test_helper.rb:79
  ...
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/test_helper.rb:85
  ...
  # to processing.
  #
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/test_helper.rb:91
  def receive_inbound_email_from_source(*args); end
end

# source://actionmailbox-7.1.5.2/lib/action_mailbox/gem_version.rb:9
module ActionMailbox::VERSION; end

# source://actionmailbox-7.1.5.2/lib/action_mailbox/gem_version.rb:10
ActionMailbox::VERSION::MAJOR = T.let(T.unsafe(nil), Integer)

# source://actionmailbox-7.1.5.2/lib/action_mailbox/gem_version.rb:11
ActionMailbox::VERSION::MINOR = T.let(T.unsafe(nil), Integer)

# source://actionmailbox-7.1.5.2/lib/action_mailbox/gem_version.rb:13
ActionMailbox::VERSION::PRE = T.let(T.unsafe(nil), String)

# source://actionmailbox-7.1.5.2/lib/action_mailbox/gem_version.rb:15
ActionMailbox::VERSION::STRING = T.let(T.unsafe(nil), String)

# source://actionmailbox-7.1.5.2/lib/action_mailbox/gem_version.rb:12
ActionMailbox::VERSION::TINY = T.let(T.unsafe(nil), Integer)

# source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/address_equality.rb:3
module Mail
  class << self
    ...
    # source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/from_source.rb:4
...
# source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/address_equality.rb:4
class Mail::Address
  # source://mail-2.8.1/lib/mail/elements/address.rb:25
  def initialize(value = T.unsafe(nil)); end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/address_equality.rb:5
  ...
  class << self
    # source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/address_wrapping.rb:5
    def wrap(address); end
  end
end

# source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/addresses.rb:4
class Mail::Message
  ...
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/addresses.rb:21
  ...
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/addresses.rb:17
  ...
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/addresses.rb:5
  ...
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/recipients.rb:5
  def recipients; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/addresses.rb:9
  ...
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/addresses.rb:13
  ...
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/addresses.rb:29
  def x_forwarded_to_addresses; end

  # source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/addresses.rb:25
  ...
  # source://actionmailbox-7.1.5.2/lib/action_mailbox/mail_ext/addresses.rb:34
