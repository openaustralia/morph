...
# source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:3
module Rails
  class << self
...
# source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:4
module Rails::Dom; end

# source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:5
module Rails::Dom::Testing
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://rails-dom-testing-2.3.0/lib/rails/dom/testing.rb:15
    def html5_support?; end

    # source://rails-dom-testing-2.3.0/lib/rails/dom/testing.rb:19
    def html_document(html_version: T.unsafe(nil)); end

    # source://rails-dom-testing-2.3.0/lib/rails/dom/testing.rb:26
    def html_document_fragment(html_version: T.unsafe(nil)); end

    private

    # source://rails-dom-testing-2.3.0/lib/rails/dom/testing.rb:34
    def choose_html_parser(parser_classes, html_version: T.unsafe(nil)); end
  end
end

# source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:6
module Rails::Dom::Testing::Assertions
  include ::Rails::Dom::Testing::Assertions::DomAssertions
  include ::Rails::Dom::Testing::Assertions::SelectorAssertions
end

# source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:7
module Rails::Dom::Testing::Assertions::DomAssertions
  ...
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:35
  ...
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:68
  ...
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:76
  def compare_doms(expected, actual, strict); end

  # @return [Boolean]
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:129
  def equal_attribute?(attr, other_attr); end

  # @return [Boolean]
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:116
  def equal_attribute_nodes?(nodes, other_nodes); end

  # @return [Boolean]
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:108
  def equal_child?(child, other_child, strict); end

  # @return [Boolean]
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:96
  def equal_children?(child, other_child, strict); end

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:88
  def extract_children(node, strict); end

  private

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/dom_assertions.rb:134
...
#
# source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:7
module Rails::Dom::Testing::Assertions::SelectorAssertions
  ...
  #   end
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions.rb:163
  ...
  #   end
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions.rb:318
  ...
  #   end
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions.rb:265
  ...
  # * <tt>:maximum</tt>
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions.rb:183
  ...
  # @raise [ArgumentError]
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions.rb:58
  ...
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions.rb:340
  def assert_size_match!(size, equals, css_selector, message = T.unsafe(nil)); end

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions.rb:352
  def count_description(min, max, count); end

  # @raise [NotImplementedError]
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions.rb:334
  def document_root_element; end

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions.rb:193
  def dom_assertions(selector, &block); end

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions.rb:368
  def nest_selection(selection); end

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions.rb:377
  def nodeset(node); end

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions.rb:364
  def pluralize_element(quantity); end
end

# source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:12
class Rails::Dom::Testing::Assertions::SelectorAssertions::HTMLSelector
  ...
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:17
  ...
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:13
  ...
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:39
  def select; end

  # @return [Boolean]
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:33
  ...
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:146
  def collapse_html_whitespace!(text); end

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:102
  def extract_equality_tests(refute); end

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:74
  def extract_root(previous_selection, root_fallback); end

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:91
  def extract_selectors; end

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:48
...
# source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:44
Rails::Dom::Testing::Assertions::SelectorAssertions::HTMLSelector::NO_STRIP = T.let(T.unsafe(nil), Array)

# source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:8
class Rails::Dom::Testing::Assertions::SelectorAssertions::SubstitutionContext
  ...
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:9
  def initialize; end

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:20
  def match(matches, attribute, matcher); end

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:13
  def substitute!(selector, values, format_for_presentation = T.unsafe(nil)); end

  private

  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:25
  def matcher_for(value, format_for_presentation); end

  # @return [Boolean]
  #
  # source://rails-dom-testing-2.3.0/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:36
  def substitutable?(value); end
end

# source://rails-dom-testing-2.3.0/lib/rails/dom/testing/railtie.rb:6
