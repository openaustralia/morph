...
#
# source://dalli-3.2.8/lib/dalli.rb:6
module Dalli
  class << self
    # source://dalli-3.2.8/lib/dalli.rb:45
    def default_logger; end

    # source://dalli-3.2.8/lib/dalli.rb:36
    def logger; end

    # source://dalli-3.2.8/lib/dalli.rb:52
    def logger=(logger); end

    # source://dalli-3.2.8/lib/dalli.rb:40
...
# Memcached.
#
# source://dalli-3.2.8/lib/dalli/client.rb:12
class Dalli::Client
  # Dalli::Client is the main class which developers will use to interact with
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:158
  ...
  # - true if the value was successfully updated.
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:169
  def cas!(key, ttl = T.unsafe(nil), req_options = T.unsafe(nil), &block); end

  # Close our connection to each server.
  # If you perform another operation after this, the connections will be re-established.
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:349
  def close; end
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:292
  def decr(key, amt = T.unsafe(nil), ttl = T.unsafe(nil), default = T.unsafe(nil)); end

  # source://dalli-3.2.8/lib/dalli/client.rb:239
  def delete(key); end

  # Delete a key/value pair, verifying existing CAS.
  # Returns true if succeeded, and falsy otherwise.
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:235
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:137
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:302
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:71
  def gat(key, ttl = T.unsafe(nil)); end

  # Get the value associated with the key.
  # If a value is not found, then +nil+ is returned.
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:63
  ...
  # @yield [value, cas]
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:87
  def get_cas(key); end
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:98
  ...
  #   { 'key' => [value, cas_id] }
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:119
  ...
  # If the value already exists, it must have been set with raw: true
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:270
  ...
  # have return values
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:190
  def multi; end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:357
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:253
  ...
  # on the server.  Returns truthy if the operation succeeded.
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:221
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:229
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:324
  def reset_stats; end

  # source://dalli-3.2.8/lib/dalli/client.rb:200
  def set(key, value, ttl = T.unsafe(nil), req_options = T.unsafe(nil)); end

  # Set the key-value pair, verifying existing CAS.
  # Returns the resulting CAS value if succeeded, and falsy otherwise.
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:207
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:313
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:79
  def touch(key, ttl = T.unsafe(nil)); end

  # Version of the memcache servers.
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:332
  def version; end
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:366
  def with; end

  private

  # source://dalli-3.2.8/lib/dalli/client.rb:376
  def cas_core(key, always_set, ttl = T.unsafe(nil), req_options = T.unsafe(nil)); end

  # @raise [ArgumentError]
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:372
  def check_positive!(amt); end

  # source://dalli-3.2.8/lib/dalli/client.rb:433
  ...
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:417
  def perform(*all_args); end

  # source://dalli-3.2.8/lib/dalli/client.rb:440
  def pipelined_getter; end

  # source://dalli-3.2.8/lib/dalli/client.rb:398
  def protocol_implementation; end

  # source://dalli-3.2.8/lib/dalli/client.rb:394
  def ring; end

  # Uses the argument TTL or the client-wide default.  Ensures
  # that the value is an integer
  #
  # source://dalli-3.2.8/lib/dalli/client.rb:388
  def ttl_or_default(ttl); end
end

# source://dalli-3.2.8/lib/dalli/client.rb:307
Dalli::Client::ALLOWED_STAT_KEYS = T.let(T.unsafe(nil), Array)

# source://dalli-3.2.8/lib/dalli/client.rb:355
Dalli::Client::CACHE_NILS = T.let(T.unsafe(nil), Hash)

# Default compressor used by Dalli, that uses
# Zlib DEFLATE to compress data.
#
# source://dalli-3.2.8/lib/dalli/compressor.rb:11
class Dalli::Compressor
  class << self
    # source://dalli-3.2.8/lib/dalli/compressor.rb:12
    def compress(data); end

    # source://dalli-3.2.8/lib/dalli/compressor.rb:16
...
# generic error
#
# source://dalli-3.2.8/lib/dalli.rb:10
...
# entry.
#
# source://dalli-3.2.8/lib/dalli/compressor.rb:26
class Dalli::GzipCompressor
  class << self
    # source://dalli-3.2.8/lib/dalli/compressor.rb:27
    def compress(data); end

    # source://dalli-3.2.8/lib/dalli/compressor.rb:35
    def decompress(data); end
  end
end
...
# basis.
#
# source://dalli-3.2.8/lib/dalli/key_manager.rb:12
class Dalli::KeyManager
  # @return [KeyManager] a new instance of KeyManager
  #
  # source://dalli-3.2.8/lib/dalli/key_manager.rb:31
  def initialize(client_options); end

  # source://dalli-3.2.8/lib/dalli/key_manager.rb:73
  def digest_class; end

  # source://dalli-3.2.8/lib/dalli/key_manager.rb:97
  ...
  #
  # source://dalli-3.2.8/lib/dalli/key_manager.rb:61
  def key_with_namespace(key); end

  # source://dalli-3.2.8/lib/dalli/key_manager.rb:67
  def key_without_namespace(key); end

  # Returns the value of attribute namespace.
  #
  # source://dalli-3.2.8/lib/dalli/key_manager.rb:29
  def namespace; end

  # source://dalli-3.2.8/lib/dalli/key_manager.rb:89
  def namespace_from_options; end

  # source://dalli-3.2.8/lib/dalli/key_manager.rb:77
  def namespace_regexp; end

  # source://dalli-3.2.8/lib/dalli/key_manager.rb:113
  ...
  #
  # source://dalli-3.2.8/lib/dalli/key_manager.rb:108
  def truncated_key(key); end

  # @raise [ArgumentError]
  #
  # source://dalli-3.2.8/lib/dalli/key_manager.rb:83
...
#
# source://dalli-3.2.8/lib/dalli/pid_cache.rb:7
module Dalli::PIDCache
  class << self
    # Returns the value of attribute pid.
    #
    # source://dalli-3.2.8/lib/dalli/pid_cache.rb:34
    def pid; end
  end
end
...
#
# source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:7
class Dalli::PipelinedGetter
  # @return [PipelinedGetter] a new instance of PipelinedGetter
  #
  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:8
  def initialize(ring, key_manager); end

  # Swallows Dalli::NetworkError
  #
  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:128
  def abort_with_timeout(servers); end

  # Swallows Dalli::NetworkError
  #
  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:91
  def abort_without_timeout(servers); end

  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:95
  ...
  #
  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:59
  def finish_queries(servers); end

  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:80
  def finish_query_for_server(server); end

  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:164
  ...
  #
  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:46
  def make_getkq_requests(groups); end

  # Yields, one at a time, keys and their values+attributes.
  #
  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:16
  ...
  #
  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:139
  def process_server(server); end

  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:120
  def remaining_time(start, timeout); end

  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:147
  def servers_with_response(servers, timeout); end

  # source://dalli-3.2.8/lib/dalli/pipelined_getter.rb:30
  def setup_requests(keys); end
end

# source://dalli-3.2.8/lib/dalli/protocol.rb:6
...
# handling.
#
# source://dalli-3.2.8/lib/dalli/protocol/base.rb:14
class Dalli::Protocol::Base
  extend ::Forwardable

  # @return [Base] a new instance of Base
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:23
  ...
  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:57
  def alive?; end
  ...
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:65
  def lock!; end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:147
  def multi?; end
  ...
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:17
  def options; end
  ...
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:139
  def password; end
  ...
  # Returns nothing.
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:118
  ...
  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:131
  ...
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:86
  ...
  # Returns nothing.
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:74
  ...
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:31
  def request(opkey, *args); end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:143
  ...
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:67
  def unlock!; end

  # source://RUBY_ROOT/forwardable.rb:226
  def up!(*args, &block); end

  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:135
  def username; end
  ...
  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:200
  def cache_nils?(opts); end

  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:206
  def connect; end
  ...
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:192
  def ensure_connected!; end

  # Called after the noop response is received at the end of a set
  # of pipelined gets
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:228
  def finish_pipeline; end

  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:239
  def log_marshal_err(key, err); end

  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:244
  def log_unexpected_err(err); end

  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:213
  def pipelined_get(keys); end

  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:235
  def reconnect_on_pipeline_complete!; end

  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:222
  def response_buffer; end

  # @raise [Dalli::NotPermittedMultiOpError]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:157
  def verify_allowed_quiet!(opkey); end

  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:178
  ...
  #
  # source://dalli-3.2.8/lib/dalli/protocol/base.rb:167
  def verify_state(opkey); end
end

# source://dalli-3.2.8/lib/dalli/protocol/base.rb:156
...
#
# source://dalli-3.2.8/lib/dalli/protocol/binary.rb:14
class Dalli::Protocol::Binary < ::Dalli::Protocol::Base
  include ::Dalli::Protocol::Binary::SaslAuthentication

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:15
  def response_processor; end

  private

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:59
  def add(key, value, ttl, options); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:82
  def append(key, value); end

  # TODO: This is confusing, as there's a cas command in memcached
  # and this isn't it.  Maybe rename?  Maybe eliminate?
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:47
  def cas(key); end

  # Arithmetic Commands
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:106
  def decr(key, count, ttl, initial); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:123
  def decr_incr(opkey, key, count, ttl, initial); end

  # Delete Commands
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:98
  def delete(key, cas); end

  # Other Commands
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:132
  def flush(ttl = T.unsafe(nil)); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:32
  def gat(key, ttl, options = T.unsafe(nil)); end

  # Retrieval Commands
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:22
  def get(key, options = T.unsafe(nil)); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:111
  def incr(key, count, ttl, initial); end

  # Noop is a keepalive operation but also used to demarcate the end of a set of pipelined commands.
  # We need to read all the responses at once.
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:140
  def noop; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:87
  def prepend(key, value); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:28
  def quiet_get_request(key); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:64
  def replace(key, value, ttl, cas, options); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:151
  def reset_stats; end

  # Storage Commands
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:54
  def set(key, value, ttl, cas, options); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:145
  def stats(info = T.unsafe(nil)); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:70
  def storage_req(opkey, key, value, ttl, cas, options); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:39
  def touch(key, ttl); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:156
  def version; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:92
  def write_append_prepend(opkey, key, value); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary.rb:161
  def write_noop; end
end
...
#
# source://dalli-3.2.8/lib/dalli/protocol/binary.rb:121
...
# to memcached.
#
# source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:10
class Dalli::Protocol::Binary::RequestFormatter
  class << self
    # source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:111
    def as_8byte_uint(val); end

    # source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:102
    def decr_incr_request(opkey:, key: T.unsafe(nil), count: T.unsafe(nil), initial: T.unsafe(nil), expiry: T.unsafe(nil)); end

    # source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:92
...
# source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:53
Dalli::Protocol::Binary::RequestFormatter::BODY_FORMATS = T.let(T.unsafe(nil), Hash)

# source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:89
Dalli::Protocol::Binary::RequestFormatter::FORMAT = T.let(T.unsafe(nil), Hash)

# source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:49
Dalli::Protocol::Binary::RequestFormatter::INCR_DECR = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:48
Dalli::Protocol::Binary::RequestFormatter::KEY_AND_VALUE = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:46
Dalli::Protocol::Binary::RequestFormatter::KEY_ONLY = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:51
Dalli::Protocol::Binary::RequestFormatter::NO_BODY = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:13
Dalli::Protocol::Binary::RequestFormatter::OPCODES = T.let(T.unsafe(nil), Hash)

# source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:11
Dalli::Protocol::Binary::RequestFormatter::REQUEST = T.let(T.unsafe(nil), Integer)

# source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:44
Dalli::Protocol::Binary::RequestFormatter::REQ_HEADER_FORMAT = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:47
Dalli::Protocol::Binary::RequestFormatter::TTL_AND_KEY = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/binary/request_formatter.rb:50
...
#
# source://dalli-3.2.8/lib/dalli/protocol/binary/response_header.rb:9
class Dalli::Protocol::Binary::ResponseHeader
  # @raise [ArgumentError]
  # @return [ResponseHeader] a new instance of ResponseHeader
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_header.rb:15
  def initialize(buf); end

  # Returns the value of attribute body_len.
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_header.rb:13
  def body_len; end
  ...
  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_header.rb:25
  def not_found?; end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_header.rb:30
  def not_stored?; end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_header.rb:21
  def ok?; end
...
# source://dalli-3.2.8/lib/dalli/protocol/binary/response_header.rb:11
Dalli::Protocol::Binary::ResponseHeader::FMT = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/binary/response_header.rb:29
Dalli::Protocol::Binary::ResponseHeader::NOT_STORED_STATUSES = T.let(T.unsafe(nil), Array)

# source://dalli-3.2.8/lib/dalli/protocol/binary/response_header.rb:10
...
#
# source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:11
class Dalli::Protocol::Binary::ResponseProcessor
  # @return [ResponseProcessor] a new instance of ResponseProcessor
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:34
  def initialize(io_source, value_marshaller); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:184
  def auth_response(buf = T.unsafe(nil)); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:150
  def consume_all_responses_until_noop; end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:192
  def contains_header?(buf); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:103
  def data_cas_response; end

  # Returns the new value for the key, if found and updated
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:115
  def decr_incr; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:95
  def delete; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:138
  def flush; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:158
  def generic_response; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:69
  ...
  # key, and value.
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:212
  def getk_response_from_buffer(buf); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:170
  def no_body_response; end

  # @raise [Dalli::DalliError]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:63
  def raise_on_not_ok!(resp_header); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:39
  def read(num_bytes); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:59
  def read_header; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:43
  def read_response; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:142
  def reset; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:198
  def response_header_from_buffer(buf); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:120
  def stats; end
  ...
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:86
  def storage_response; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:49
  def unpack_response_body(resp_header, body, parse_as_stored_value); end

  # @raise [Dalli::NetworkError]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:178
  def validate_auth_format(extra_len, count); end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:146
  def version; end
end
...
#
# source://dalli-3.2.8/lib/dalli/protocol/binary/response_processor.rb:14
Dalli::Protocol::Binary::ResponseProcessor::RESPONSE_CODES = T.let(T.unsafe(nil), Hash)

# Code to support SASL authentication
#
# source://dalli-3.2.8/lib/dalli/protocol/binary/sasl_authentication.rb:9
module Dalli::Protocol::Binary::SaslAuthentication
  # @raise [Dalli::DalliError]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/binary/sasl_authentication.rb:40
  def authenticate_connection; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/sasl_authentication.rb:33
  def authenticate_with_plain; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/sasl_authentication.rb:10
  def perform_auth_negotiation; end

  # source://dalli-3.2.8/lib/dalli/protocol/binary/sasl_authentication.rb:25
  def supported_mechanisms!(mechanisms); end
end

# source://dalli-3.2.8/lib/dalli/protocol/binary/sasl_authentication.rb:23
...
# and retries.
#
# source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:15
class Dalli::Protocol::ConnectionManager
  # @return [ConnectionManager] a new instance of ConnectionManager
  #
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:32
  def initialize(hostname, port, socket_type, client_options); end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:145
  def abort_request!; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:112
  def close; end

  # @raise [Dalli::NetworkError]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:222
  def close_on_fork; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:106
  def confirm_in_progress!; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:101
  def confirm_ready!; end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:125
  def connected?; end
  ...
  #
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:84
  def down!; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:179
  def error_on_request!(err_or_string); end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:52
  def establish_connection; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:139
  def finish_request!; end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:231
  def fork_detected?; end

  # Returns the value of attribute hostname.
  #
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:29
  def hostname; end
  ...
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:235
  def log_down_detected; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:247
  def log_up_detected; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:214
  def log_warn_message(err_or_string); end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:175
  def max_allowed_failures; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:206
  def memcached_socket; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:44
  def name; end
  ...
  # @raise [Dalli::NetworkError]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:93
  def raise_down_error; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:157
  def read(count); end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:149
  def read_line; end

  # Non-blocking read.  Here to support the operation
  # of the get_multi operation
  #
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:171
  def read_nonblock; end

  # @raise [Dalli::NetworkError]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:192
  def reconnect!(message); end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:63
  def reconnect_down_server?; end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:129
  def request_in_progress?; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:198
  def reset_down_info; end

  # Returns the value of attribute sock.
  #
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:30
  def sock; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:97
  ...
  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:133
  def start_request!; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:76
  def up!; end

  # source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:163
  def write(bytes); end
end

# source://dalli-3.2.8/lib/dalli/protocol/connection_manager.rb:16
...
# formatting requests to the server, and unpacking responses.
#
# source://dalli-3.2.8/lib/dalli/protocol/meta.rb:14
class Dalli::Protocol::Meta < ::Dalli::Protocol::Base
  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:17
  def response_processor; end

  private

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:69
  def add(key, value, ttl, options); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:91
  def append(key, value); end

  # @raise [Dalli::DalliError]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:169
  def authenticate_connection; end

  # TODO: This is confusing, as there's a cas command in memcached
  # and this isn't it.  Maybe rename?  Maybe eliminate?
  #
  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:56
  def cas(key); end

  # Arithmetic Commands
  #
  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:121
  def decr(key, count, ttl, initial); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:129
  def decr_incr(incr, key, delta, ttl, initial); end

  # Delete Commands
  #
  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:112
  def delete(key, cas); end

  # Other Commands
  #
  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:138
  def flush(delay = T.unsafe(nil)); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:38
  def gat(key, ttl, options = T.unsafe(nil)); end

  # Retrieval Commands
  #
  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:26
  def get(key, options = T.unsafe(nil)); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:125
  def incr(key, count, ttl, initial); end

  # Noop is a keepalive operation but also used to demarcate the end of a set of pipelined commands.
  # We need to read all the responses at once.
  #
  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:145
  def noop; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:96
  def prepend(key, value); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:33
  def quiet_get_request(key); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:74
  def replace(key, value, ttl, cas, options); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:155
  def reset_stats; end

  # Storage Commands
  #
  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:64
  def set(key, value, ttl, cas, options); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:150
  def stats(info = T.unsafe(nil)); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:46
  def touch(key, ttl); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:160
  def version; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:102
  def write_append_prepend_req(mode, key, value, ttl = T.unsafe(nil), cas = T.unsafe(nil), _options = T.unsafe(nil)); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:165
  def write_noop; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta.rb:80
...
#
# source://dalli-3.2.8/lib/dalli/protocol/meta/key_regularizer.rb:12
class Dalli::Protocol::Meta::KeyRegularizer
  class << self
    # source://dalli-3.2.8/lib/dalli/protocol/meta/key_regularizer.rb:22
    def decode(encoded_key, base64_encoded); end

    # source://dalli-3.2.8/lib/dalli/protocol/meta/key_regularizer.rb:15
    def encode(key); end
  end
end

# source://dalli-3.2.8/lib/dalli/protocol/meta/key_regularizer.rb:13
...
# to memcached.
#
# source://dalli-3.2.8/lib/dalli/protocol/meta/request_formatter.rb:10
class Dalli::Protocol::Meta::RequestFormatter
  class << self
    # source://dalli-3.2.8/lib/dalli/protocol/meta/request_formatter.rb:107
    def cas_string(cas); end

    # source://dalli-3.2.8/lib/dalli/protocol/meta/request_formatter.rb:77
    def flush(delay: T.unsafe(nil), quiet: T.unsafe(nil)); end

    # source://dalli-3.2.8/lib/dalli/protocol/meta/request_formatter.rb:52
    ...
    # source://dalli-3.2.8/lib/dalli/protocol/meta/request_formatter.rb:43
    ...
    #
    #
    # source://dalli-3.2.8/lib/dalli/protocol/meta/request_formatter.rb:19
    def meta_get(key:, value: T.unsafe(nil), return_cas: T.unsafe(nil), ttl: T.unsafe(nil), base64: T.unsafe(nil), quiet: T.unsafe(nil)); end

    # source://dalli-3.2.8/lib/dalli/protocol/meta/request_formatter.rb:69
    def meta_noop; end

    # source://dalli-3.2.8/lib/dalli/protocol/meta/request_formatter.rb:29
    ...
    # source://dalli-3.2.8/lib/dalli/protocol/meta/request_formatter.rb:91
    def mode_to_token(mode); end

    # source://dalli-3.2.8/lib/dalli/protocol/meta/request_formatter.rb:112
    def parse_to_64_bit_int(val, default); end

    # source://dalli-3.2.8/lib/dalli/protocol/meta/request_formatter.rb:84
    def stats(arg = T.unsafe(nil)); end

    # source://dalli-3.2.8/lib/dalli/protocol/meta/request_formatter.rb:73
    def version; end
  end
end
...
# and parsing into local values.  Handles errors on unexpected values.
#
# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:11
class Dalli::Protocol::Meta::ResponseProcessor
  # @return [ResponseProcessor] a new instance of ResponseProcessor
  #
  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:25
  def initialize(io_source, value_marshaller); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:175
  def bitflags_from_tokens(tokens); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:189
  def body_len_from_tokens(tokens); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:179
  def cas_from_tokens(tokens); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:107
  def consume_all_responses_until_mn; end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:160
  def contains_header?(buf); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:72
  def decr_incr; end

  # @raise [Dalli::DalliError]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:168
  def error_on_unexpected!(expected_codes); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:90
  def flush; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:122
  ...
  # key, and value.
  #
  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:137
  def getk_response_from_buffer(buf); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:164
  def header_from_buffer(buf); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:183
  def key_from_tokens(tokens); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:67
  def meta_delete; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:30
  def meta_get_with_value(cache_nils: T.unsafe(nil)); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:38
  def meta_get_with_value_and_cas; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:48
  def meta_get_without_value; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:60
  def meta_set_append_prepend; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:53
  def meta_set_with_cas; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:204
  def next_line_to_tokens; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:200
  def read_line; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:96
  def reset; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:80
  def stats; end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:114
  def tokens_from_header_buffer(buf); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:193
  def value_from_tokens(tokens, flag); end

  # source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:102
  def version; end
end

# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:12
Dalli::Protocol::Meta::ResponseProcessor::EN = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:13
Dalli::Protocol::Meta::ResponseProcessor::END_TOKEN = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:14
Dalli::Protocol::Meta::ResponseProcessor::EX = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:15
Dalli::Protocol::Meta::ResponseProcessor::HD = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:16
Dalli::Protocol::Meta::ResponseProcessor::MN = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:17
Dalli::Protocol::Meta::ResponseProcessor::NF = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:18
Dalli::Protocol::Meta::ResponseProcessor::NS = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:19
Dalli::Protocol::Meta::ResponseProcessor::OK = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:20
Dalli::Protocol::Meta::ResponseProcessor::RESET = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:21
Dalli::Protocol::Meta::ResponseProcessor::STAT = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:22
Dalli::Protocol::Meta::ResponseProcessor::VA = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/meta/response_processor.rb:23
Dalli::Protocol::Meta::ResponseProcessor::VERSION = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/meta.rb:15
Dalli::Protocol::Meta::TERMINATOR = T.let(T.unsafe(nil), String)

# Preserved for backwards compatibility.  Should be removed in 4.0
#
# source://dalli-3.2.8/lib/dalli/protocol.rb:8
Dalli::Protocol::NOT_FOUND = T.let(T.unsafe(nil), Dalli::NilObject)

# Manages the buffer for responses from memcached.
#
# source://dalli-3.2.8/lib/dalli/protocol/response_buffer.rb:11
class Dalli::Protocol::ResponseBuffer
  # @return [ResponseBuffer] a new instance of ResponseBuffer
  #
  # source://dalli-3.2.8/lib/dalli/protocol/response_buffer.rb:12
  def initialize(io_source, response_processor); end

  # Advances the internal response buffer by bytes_to_advance
  # bytes.  The
  #
  # source://dalli-3.2.8/lib/dalli/protocol/response_buffer.rb:32
  def advance(bytes_to_advance); end

  # Clear the internal response buffer
  #
  # source://dalli-3.2.8/lib/dalli/protocol/response_buffer.rb:45
  def clear; end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/response_buffer.rb:49
  def in_progress?; end

  # Attempts to process a single response from the buffer.  Starts
  # by advancing the buffer to the specified start position
  #
  # source://dalli-3.2.8/lib/dalli/protocol/response_buffer.rb:24
  def process_single_getk_response; end

  # source://dalli-3.2.8/lib/dalli/protocol/response_buffer.rb:18
  def read; end

  # Resets the internal buffer to an empty state,
  # so that we're ready to read pipelined responses
  #
  # source://dalli-3.2.8/lib/dalli/protocol/response_buffer.rb:40
  def reset; end
end
...
# socket_type.
#
# source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:12
class Dalli::Protocol::ServerConfigParser
  class << self
    # source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:67
    def attributes_for_tcp_socket(res); end

    # @raise [Dalli::DalliError]
    #
    # source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:60
    def attributes_for_unix_socket(res); end

    # @raise [Dalli::DalliError]
    #
    # source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:53
    def deconstruct_string(str); end

    # @raise [Dalli::DalliError]
    #
    # source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:71
    def normalize_host_from_match(str, res); end

    # source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:77
    def normalize_port(port); end

    # source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:81
    def normalize_weight(weight); end

    # source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:24
    def parse(str); end

    # source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:39
    def parse_non_uri(str); end

    # source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:30
    def parse_uri(str); end
  end
end

# source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:21
Dalli::Protocol::ServerConfigParser::DEFAULT_PORT = T.let(T.unsafe(nil), Integer)

# source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:22
Dalli::Protocol::ServerConfigParser::DEFAULT_WEIGHT = T.let(T.unsafe(nil), Integer)

# source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:13
...
# a bounding []
#
# source://dalli-3.2.8/lib/dalli/protocol/server_config_parser.rb:19
...
#
# source://dalli-3.2.8/lib/dalli/protocol.rb:12
...
#
# source://dalli-3.2.8/lib/dalli/protocol/ttl_sanitizer.rb:11
class Dalli::Protocol::TtlSanitizer
  class << self
    # source://dalli-3.2.8/lib/dalli/protocol/ttl_sanitizer.rb:29
    def as_timestamp(ttl_as_i); end

    # Pulled out into a method so it's easy to stub time
    #
    # source://dalli-3.2.8/lib/dalli/protocol/ttl_sanitizer.rb:40
    def current_timestamp; end

    # @return [Boolean]
    #
    # source://dalli-3.2.8/lib/dalli/protocol/ttl_sanitizer.rb:25
    ...
    #
    # source://dalli-3.2.8/lib/dalli/protocol/ttl_sanitizer.rb:18
...
#
# source://dalli-3.2.8/lib/dalli/protocol/ttl_sanitizer.rb:15
...
#
# source://dalli-3.2.8/lib/dalli/protocol/value_compressor.rb:13
class Dalli::Protocol::ValueCompressor
  # @return [ValueCompressor] a new instance of ValueCompressor
  #
  # source://dalli-3.2.8/lib/dalli/protocol/value_compressor.rb:27
  def initialize(client_options); end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/value_compressor.rb:60
  ...
  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/value_compressor.rb:77
  def compress_value?(value, req_options); end

  # source://dalli-3.2.8/lib/dalli/protocol/value_compressor.rb:68
  def compression_min_size; end

  # source://dalli-3.2.8/lib/dalli/protocol/value_compressor.rb:64
  def compressor; end

  # source://dalli-3.2.8/lib/dalli/protocol/value_compressor.rb:49
  def retrieve(value, bitflags); end

  # source://dalli-3.2.8/lib/dalli/protocol/value_compressor.rb:41
  def store(value, req_options, bitflags); end
end

# source://dalli-3.2.8/lib/dalli/protocol/value_compressor.rb:14
...
#
# source://dalli-3.2.8/lib/dalli/protocol/value_compressor.rb:25
Dalli::Protocol::ValueCompressor::FLAG_COMPRESSED = T.let(T.unsafe(nil), Integer)

# source://dalli-3.2.8/lib/dalli/protocol/value_compressor.rb:21
...
#
# source://dalli-3.2.8/lib/dalli/protocol/value_marshaller.rb:12
class Dalli::Protocol::ValueMarshaller
  extend ::Forwardable

  # @return [ValueMarshaller] a new instance of ValueMarshaller
  #
  # source://dalli-3.2.8/lib/dalli/protocol/value_marshaller.rb:25
  def initialize(client_options); end
  ...
  #
  # source://dalli-3.2.8/lib/dalli/protocol/value_marshaller.rb:51
  def error_if_over_max_value_bytes(key, value); end

  # source://dalli-3.2.8/lib/dalli/protocol/value_marshaller.rb:42
  def retrieve(value, flags); end

  # source://RUBY_ROOT/forwardable.rb:226
  def serializer(*args, &block); end

  # source://dalli-3.2.8/lib/dalli/protocol/value_marshaller.rb:33
  def store(key, value, options = T.unsafe(nil)); end

  # source://dalli-3.2.8/lib/dalli/protocol/value_marshaller.rb:47
  def value_max_bytes; end
end

# source://dalli-3.2.8/lib/dalli/protocol/value_marshaller.rb:15
Dalli::Protocol::ValueMarshaller::DEFAULTS = T.let(T.unsafe(nil), Hash)

# source://dalli-3.2.8/lib/dalli/protocol/value_marshaller.rb:20
...
#
# source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:11
class Dalli::Protocol::ValueSerializer
  # @return [ValueSerializer] a new instance of ValueSerializer
  #
  # source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:24
  def initialize(protocol_options); end

  # @raise [UnmarshalError]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:62
  def filter_argument_error(err); end

  # @raise [UnmarshalError]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:68
  def filter_name_error(err); end

  # @raise [UnmarshalError]
  #
  # source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:56
  def filter_type_error(err); end

  # source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:45
  def retrieve(value, bitflags); end

  # Returns the value of attribute serialization_options.
  #
  # source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:22
  ...
  # source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:78
  def serialize_value(value); end

  # source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:74
  def serializer; end

  # source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:29
  def store(value, req_options, bitflags); end
end

# source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:41
Dalli::Protocol::ValueSerializer::ARGUMENT_ERR_REGEXP = T.let(T.unsafe(nil), Regexp)

# source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:12
Dalli::Protocol::ValueSerializer::DEFAULTS = T.let(T.unsafe(nil), Hash)

# https://www.hjp.at/zettel/m/memcached_flags.rxml
# Looks like most clients use bit 0 to indicate native language serialization
#
# source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:20
Dalli::Protocol::ValueSerializer::FLAG_SERIALIZED = T.let(T.unsafe(nil), Integer)

# source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:42
Dalli::Protocol::ValueSerializer::NAME_ERR_STR = T.let(T.unsafe(nil), String)

# source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:16
...
# in current systems
#
# source://dalli-3.2.8/lib/dalli/protocol/value_serializer.rb:40
Dalli::Protocol::ValueSerializer::TYPE_ERR_REGEXP = T.let(T.unsafe(nil), Regexp)

# source://dalli-3.2.8/lib/dalli.rb:34
...
#
# source://dalli-3.2.8/lib/dalli/ring.rb:19
class Dalli::Ring
  # @return [Ring] a new instance of Ring
  #
  # source://dalli-3.2.8/lib/dalli/ring.rb:26
  def initialize(servers_arg, protocol_implementation, options); end

  # source://dalli-3.2.8/lib/dalli/ring.rb:97
  def close; end

  # this is the default in libmemcached
  #
  # source://dalli-3.2.8/lib/dalli/ring.rb:24
  def continuum; end
  ...
  # source://dalli-3.2.8/lib/dalli/ring.rb:66
  def keys_grouped_by_server(key_arr); end

  # source://dalli-3.2.8/lib/dalli/ring.rb:75
  def lock; end

  # source://dalli-3.2.8/lib/dalli/ring.rb:84
  def pipeline_consume_and_ignore_responses; end

  # @raise [Dalli::RingError]
  #
  # source://dalli-3.2.8/lib/dalli/ring.rb:37
  def server_for_key(key); end

  # source://dalli-3.2.8/lib/dalli/ring.rb:51
  ...
  # source://dalli-3.2.8/lib/dalli/ring.rb:93
  def socket_timeout; end

  private

  # source://dalli-3.2.8/lib/dalli/ring.rb:128
  def build_continuum(servers); end

  # source://dalli-3.2.8/lib/dalli/ring.rb:113
  def entry_count_for(server, total_servers, total_weight); end

  # source://dalli-3.2.8/lib/dalli/ring.rb:109
  def hash_for(key); end

  # source://dalli-3.2.8/lib/dalli/ring.rb:117
  def server_for_hash_key(hash_key); end

  # source://dalli-3.2.8/lib/dalli/ring.rb:103
  def threadsafe!; end
end

# Represents a point in the consistent hash ring implementation.
#
# source://dalli-3.2.8/lib/dalli/ring.rb:144
class Dalli::Ring::Entry
  # @return [Entry] a new instance of Entry
  #
  # source://dalli-3.2.8/lib/dalli/ring.rb:147
  def initialize(val, srv); end

  # Returns the value of attribute server.
  #
  # source://dalli-3.2.8/lib/dalli/ring.rb:145
  def server; end
...
#
# source://dalli-3.2.8/lib/dalli/ring.rb:22
Dalli::Ring::POINTS_PER_SERVER = T.let(T.unsafe(nil), Integer)

# no server available/alive error
#
# source://dalli-3.2.8/lib/dalli.rb:16
class Dalli::RingError < ::Dalli::DalliError; end

# source://dalli-3.2.8/lib/dalli/server.rb:5
...
#
# source://dalli-3.2.8/lib/dalli/servers_arg_normalizer.rb:26
module Dalli::ServersArgNormalizer
  class << self
    # source://dalli-3.2.8/lib/dalli/servers_arg_normalizer.rb:40
    ...
    #
    # source://dalli-3.2.8/lib/dalli/servers_arg_normalizer.rb:34
    def normalize_servers(arg); end

    # @raise [ArgumentError]
    #
    # source://dalli-3.2.8/lib/dalli/servers_arg_normalizer.rb:46
    def validate_type(arg); end
  end
end

# source://dalli-3.2.8/lib/dalli/servers_arg_normalizer.rb:28
Dalli::ServersArgNormalizer::DEFAULT_SERVERS = T.let(T.unsafe(nil), Array)

# source://dalli-3.2.8/lib/dalli/servers_arg_normalizer.rb:27
Dalli::ServersArgNormalizer::ENV_VAR_NAME = T.let(T.unsafe(nil), String)

# Various socket implementations used by Dalli.
#
# source://dalli-3.2.8/lib/dalli/socket.rb:10
module Dalli::Socket; end

# Common methods for all socket implementations.
#
# source://dalli-3.2.8/lib/dalli/socket.rb:14
module Dalli::Socket::InstanceMethods
  # @raise [Timeout::Error]
  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/socket.rb:39
  def append_to_buffer?(result); end

  # source://dalli-3.2.8/lib/dalli/socket.rb:54
  def logged_options; end

  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/socket.rb:46
  def nonblock_timed_out?(result); end

  # source://dalli-3.2.8/lib/dalli/socket.rb:25
  def read_available; end

  # source://dalli-3.2.8/lib/dalli/socket.rb:15
  def readfull(count); end
end

# source://dalli-3.2.8/lib/dalli/socket.rb:53
Dalli::Socket::InstanceMethods::FILTERED_OUT_OPTIONS = T.let(T.unsafe(nil), Array)

# source://dalli-3.2.8/lib/dalli/socket.rb:37
...
class Dalli::Socket::TCP < ::TCPSocket
  ...
  class << self
    # source://dalli-3.2.8/lib/dalli/socket.rb:100
    def create_socket_with_timeout(host, port, options); end

    # source://dalli-3.2.8/lib/dalli/socket.rb:119
    def init_socket_options(sock, options); end

    # source://dalli-3.2.8/lib/dalli/socket.rb:91
    def open(host, port, options = T.unsafe(nil)); end

    # source://dalli-3.2.8/lib/dalli/socket.rb:135
...
#
# source://dalli-3.2.8/lib/dalli/socket.rb:160
class Dalli::Socket::UNIX < ::UNIXSocket
  ...
  #
  # source://dalli-3.2.8/lib/dalli/socket.rb:165
  def options; end
  ...
  class << self
    # source://dalli-3.2.8/lib/dalli/socket.rb:167
...
#
# source://dalli-3.2.8/lib/dalli/options.rb:11
module Dalli::Threadsafe
  # @return [Boolean]
  #
  # source://dalli-3.2.8/lib/dalli/options.rb:22
  def alive?; end

  # source://dalli-3.2.8/lib/dalli/options.rb:28
  def close; end

  # source://dalli-3.2.8/lib/dalli/options.rb:60
  def init_threadsafe; end

  # source://dalli-3.2.8/lib/dalli/options.rb:52
  def lock!; end

  # source://dalli-3.2.8/lib/dalli/options.rb:46
  def pipeline_abort; end

  # source://dalli-3.2.8/lib/dalli/options.rb:40
  def pipeline_next_responses; end

  # source://dalli-3.2.8/lib/dalli/options.rb:34
  def pipeline_response_setup; end

  # source://dalli-3.2.8/lib/dalli/options.rb:16
  def request(opcode, *args); end

  # source://dalli-3.2.8/lib/dalli/options.rb:56
  def unlock!; end

  class << self
    # @private
    #
    # source://dalli-3.2.8/lib/dalli/options.rb:12
...
# source://dalli-3.2.8/lib/rack/session/dalli.rb:9
module Rack::Session; end

# Rack::Session::Dalli provides memcached based session management.
#
# source://dalli-3.2.8/lib/rack/session/dalli.rb:11
class Rack::Session::Dalli < ::Rack::Session::Abstract::PersistedSecure
  ...
  #
  # source://dalli-3.2.8/lib/rack/session/dalli.rb:64
  def initialize(app, options = T.unsafe(nil)); end

  # Returns the value of attribute data.
  #
  # source://dalli-3.2.8/lib/rack/session/dalli.rb:12
  def data; end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:94
  def delete_session(_req, sid, options); end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:73
  def find_session(_req, sid); end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:82
  def write_session(_req, sid, session, options); end

  private

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:135
  def build_data_source(options); end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:117
  def create_sid_with_empty_session(client); end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:170
  def ensure_connection_pool_added!; end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:108
  def existing_session_for_sid(client, sid); end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:148
  def extract_dalli_options(options); end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:126
  def generate_sid_with(client); end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:104
  def memcached_key_from_sid(sid); end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:157
  def retrieve_client_options(options); end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:163
  def retrieve_pool_options(options); end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:190
  def ttl(expire_after); end

  # source://dalli-3.2.8/lib/rack/session/dalli.rb:178
  def with_dalli_client(result_on_error = T.unsafe(nil), &block); end
end

# Don't freeze this until we fix the specs/implementation
#
# source://dalli-3.2.8/lib/rack/session/dalli.rb:16
