...
#
# source://premailer-1.22.0/lib/premailer/adapter/rgb_to_hex.rb:3
module AdapterHelper; end

# source://premailer-1.22.0/lib/premailer/adapter/rgb_to_hex.rb:4
module AdapterHelper::RgbToHex
  # source://premailer-1.22.0/lib/premailer/adapter/rgb_to_hex.rb:24
  def ensure_hex(color); end

  # @return [Boolean]
  #
  # source://premailer-1.22.0/lib/premailer/adapter/rgb_to_hex.rb:9
  def is_rgb?(color); end

  # source://premailer-1.22.0/lib/premailer/adapter/rgb_to_hex.rb:5
  def to_hex(str); end
end

# Support functions for Premailer
#
# source://premailer-1.22.0/lib/premailer/html_to_plain_text.rb:5
module HtmlToPlainText
  ...
  #
  # source://premailer-1.22.0/lib/premailer/html_to_plain_text.rb:16
  ...
  #
  # source://premailer-1.22.0/lib/premailer/html_to_plain_text.rb:128
  def word_wrap(txt, line_length); end
end

# source://premailer-1.22.0/lib/premailer/adapter.rb:1
class Premailer
...
# * nokogumbo
#
# source://premailer-1.22.0/lib/premailer/adapter.rb:7
module Premailer::Adapter
  class << self
    ...
    #
    # source://premailer-1.22.0/lib/premailer/adapter.rb:31
    def default; end
    ...
    #
    # source://premailer-1.22.0/lib/premailer/adapter.rb:56
    def find(adapter); end

    # Returns the adapter to use.
    #
    # source://premailer-1.22.0/lib/premailer/adapter.rb:21
    def use; end
    ...
    # @raise [ArgumentError] unless the adapter exists.
    #
    # source://premailer-1.22.0/lib/premailer/adapter.rb:50
...
# Nokogiri adapter
#
# source://premailer-1.22.0/lib/premailer/adapter/nokogiri.rb:6
module Premailer::Adapter::Nokogiri
  ...
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri.rb:216
  ...
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri.rb:12
  ...
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri.rb:192
  ...
  # @return [String] HTML.
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri.rb:205
  def to_s; end
  ...
  # @return [::Nokogiri::XML] a document.
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri.rb:168
  def write_unmergable_css_rules(doc, unmergable_rules); end
end

# NokogiriFast adapter
#
# source://premailer-1.22.0/lib/premailer/adapter/nokogiri_fast.rb:6
module Premailer::Adapter::NokogiriFast
  ...
  # @return [::Nokogiri::XML] a document.
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri_fast.rb:222
  def load_html(input); end
  ...
  # @return [String] an HTML.
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri_fast.rb:12
  def to_inline_css; end
  ...
  # @return [String] a plain text.
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri_fast.rb:198
  def to_plain_text; end
  ...
  # @return [String] HTML.
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri_fast.rb:211
  def to_s; end
  ...
  # @return [::Nokogiri::XML] a document.
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri_fast.rb:174
  def write_unmergable_css_rules(doc, unmergable_rules); end
  ...
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri_fast.rb:325
  ...
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri_fast.rb:276
  ...
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri_fast.rb:356
  ...
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogiri_fast.rb:340
  def narrow_down_nodes(index, base, intersection_selector); end
end

# Nokogiri adapter
#
# source://premailer-1.22.0/lib/premailer/adapter/nokogumbo.rb:4
module Premailer::Adapter::Nokogumbo
  ...
  # @return [::Nokogiri::XML] a document.
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogumbo.rb:216
  def load_html(input); end
  ...
  # @return [String] an HTML.
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogumbo.rb:10
  def to_inline_css; end
  ...
  # @return [String] a plain text.
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogumbo.rb:192
  def to_plain_text; end
  ...
  # @return [String] HTML.
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogumbo.rb:205
  def to_s; end
  ...
  # @return [::Nokogiri::XML] a document.
  #
  # source://premailer-1.22.0/lib/premailer/adapter/nokogumbo.rb:168
  def write_unmergable_css_rules(doc, unmergable_rules); end
end

# adapter to required file mapping.
#
# source://premailer-1.22.0/lib/premailer/adapter.rb:14
...
# source://premailer-1.22.0/lib/premailer/cached_rule_set.rb:5
class Premailer::CachedRuleSet < ::CssParser::RuleSet
  ...
  #
  # source://premailer-1.22.0/lib/premailer/cached_rule_set.rb:6
...
# Warning levels
#
# source://premailer-1.22.0/lib/premailer/premailer.rb:131
module Premailer::Warnings; end

# No warnings
#
# source://premailer-1.22.0/lib/premailer/premailer.rb:133
Premailer::Warnings::NONE = T.let(T.unsafe(nil), Integer)

# Poor
#
# source://premailer-1.22.0/lib/premailer/premailer.rb:137
Premailer::Warnings::POOR = T.let(T.unsafe(nil), Integer)

# Risky
#
# source://premailer-1.22.0/lib/premailer/premailer.rb:139
Premailer::Warnings::RISKY = T.let(T.unsafe(nil), Integer)

# Safe
#
# source://premailer-1.22.0/lib/premailer/premailer.rb:135
