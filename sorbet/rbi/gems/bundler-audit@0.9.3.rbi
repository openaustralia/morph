...
# source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:22
module Bundler::Audit; end

# Represents an advisory loaded from the {Database}.
#
# source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:38
class Bundler::Audit::Advisory < ::Struct
  ...
  # @return [Boolean]
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:210
  def ==(other); end
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:138
  def criticality; end
  ...
  # @return [String, nil]
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:93
  def cve_id; end
  ...
  # @since 0.7.0
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:113
  def ghsa_id; end
  ...
  # @since 0.7.0
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:124
  def identifiers; end
  ...
  # @return [String, nil]
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:102
  def osvdb_id; end
  ...
  # @since 0.2.0
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:184
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:219
  def to_h; end
  ...
  # @since 0.2.0
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:167
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:199
  ...
  class << self
    ...
    # @return [Advisory]
    #
    # source://bundler-audit-0.9.3/lib/bundler/audit/advisory.rb:50
    def load(path); end
  end
end
...
# and CVE number.
#
# source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:29
class Bundler::Audit::Database
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:62
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:265
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:288
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:312
  ...
  # @since 0.9.0
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:228
  def commit_id; end
  ...
  # @since 0.8.0
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:180
  def git?; end
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:348
  def inspect; end
  ...
  # @since 0.8.0
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:243
  ...
  # @return [String]
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:51
  def path; end
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:328
  def size; end
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:338
  def to_s; end
  ...
  # @since 0.8.0
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:204
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:363
  ...
  # @yieldparam path [String] A path to an advisory `.yml` file.
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:379
  ...
  class << self
    ...
    # @since 0.8.0
    #
    # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:117
    ...
    # @since 0.8.0
    #
    # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:90
    ...
    #
    # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:76
    def path; end
    ...
    # @since 0.3.0
    #
    # source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:157
    def update!(options = T.unsafe(nil)); end
  end
end
...
# @since 0.8.0
#
# source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:46
Bundler::Audit::Database::DEFAULT_PATH = T.let(T.unsafe(nil), String)

# source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:31
class Bundler::Audit::Database::DownloadFailed < ::RuntimeError; end

# Git URL of the ruby-advisory-db.
#
# source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:38
Bundler::Audit::Database::URL = T.let(T.unsafe(nil), String)

# Path to the user's copy of the ruby-advisory-db.
#
# source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:41
Bundler::Audit::Database::USER_PATH = T.let(T.unsafe(nil), String)

# source://bundler-audit-0.9.3/lib/bundler/audit/database.rb:34
class Bundler::Audit::Database::UpdateFailed < ::RuntimeError; end

# source://bundler-audit-0.9.3/lib/bundler/audit/results/result.rb:3
module Bundler::Audit::Results; end

# @abstract
#
# source://bundler-audit-0.9.3/lib/bundler/audit/results/result.rb:7
class Bundler::Audit::Results::Result
  # @abstract
  # @raise [NotImplementedError]
  # @return [Hash{Symbol => Object}]
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/results/result.rb:14
  def to_h; end
end
...
# upgraded.
#
# source://bundler-audit-0.9.3/lib/bundler/audit/results/unpatched_gem.rb:29
class Bundler::Audit::Results::UnpatchedGem < ::Bundler::Audit::Results::Result
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/results/unpatched_gem.rb:50
  ...
  # @return [Boolean]
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/results/unpatched_gem.rb:62
  def ==(other); end
  ...
  # @return [Advisory]
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/results/unpatched_gem.rb:39
  def advisory; end
  ...
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/results/unpatched_gem.rb:34
  def gem; end
  ...
  # @return [Hash{Symbol => Object}]
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/results/unpatched_gem.rb:84
  def to_h; end
  ...
  # @return [String]
  #
  # source://bundler-audit-0.9.3/lib/bundler/audit/results/unpatched_gem.rb:75
  def to_s; end
end
