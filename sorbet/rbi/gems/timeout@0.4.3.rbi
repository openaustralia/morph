...
# source://timeout-0.4.3/lib/timeout.rb:21
module Timeout
  private
  ...
  # @raise [ArgumentError]
  #
  # source://timeout-0.4.3/lib/timeout.rb:167
  def timeout(sec, klass = T.unsafe(nil), message = T.unsafe(nil), &block); end

  class << self
    # source://timeout-0.4.3/lib/timeout.rb:124
    ...
    # source://timeout-0.4.3/lib/timeout.rb:94
...
# :stopdoc:
#
# source://timeout-0.4.3/lib/timeout.rb:47
Timeout::CONDVAR = T.let(T.unsafe(nil), Thread::ConditionVariable)

# Raised by Timeout.timeout when the block times out.
#
# source://timeout-0.4.3/lib/timeout.rb:33
class Timeout::Error < ::RuntimeError
  class << self
    # source://timeout-0.4.3/lib/timeout.rb:34
...
#
# source://timeout-0.4.3/lib/timeout.rb:26
class Timeout::ExitException < ::Exception
  # source://timeout-0.4.3/lib/timeout.rb:27
...
# Timeout.
#
# source://timeout-0.4.3/lib/timeout.rb:136
Timeout::GET_TIME = T.let(T.unsafe(nil), Method)

# source://timeout-0.4.3/lib/timeout.rb:48
Timeout::QUEUE = T.let(T.unsafe(nil), Thread::Queue)

# source://timeout-0.4.3/lib/timeout.rb:49
Timeout::QUEUE_MUTEX = T.let(T.unsafe(nil), Thread::Mutex)

# source://timeout-0.4.3/lib/timeout.rb:54
class Timeout::Request
  # @return [Request] a new instance of Request
  #
  # source://timeout-0.4.3/lib/timeout.rb:57
  def initialize(thread, timeout, exception_class, message); end

  # Returns the value of attribute deadline.
  #
  # source://timeout-0.4.3/lib/timeout.rb:55
  def deadline; end

  # @return [Boolean]
  #
  # source://timeout-0.4.3/lib/timeout.rb:67
  def done?; end

  # @return [Boolean]
  #
  # source://timeout-0.4.3/lib/timeout.rb:73
  def expired?(now); end

  # source://timeout-0.4.3/lib/timeout.rb:86
  def finished; end

  # source://timeout-0.4.3/lib/timeout.rb:77
  def interrupt; end
end

# source://timeout-0.4.3/lib/timeout.rb:50
Timeout::TIMEOUT_THREAD_MUTEX = T.let(T.unsafe(nil), Thread::Mutex)

# The version
#
# source://timeout-0.4.3/lib/timeout.rb:23
