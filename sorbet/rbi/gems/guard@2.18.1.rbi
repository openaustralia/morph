...
#
# source://guard-2.18.1/lib/guard/config.rb:3
module Guard
...
# source://guard-2.18.1/lib/guard/config.rb:9
class Guard::Config < ::Nenv::Environment
  # @return [Config] a new instance of Config
  #
  # source://guard-2.18.1/lib/guard/config.rb:10
  def initialize; end

  # @return [Boolean]
  #
  # source://guard-2.18.1/lib/guard/config.rb:14
  def silence_deprecations?; end
end

# @deprecated Every method in this module is deprecated
#
# source://guard-2.18.1/lib/guard/deprecated/watcher.rb:5
module Guard::Deprecated; end

# source://guard-2.18.1/lib/guard/deprecated/dsl.rb:6
module Guard::Deprecated::Dsl
  class << self
    # source://guard-2.18.1/lib/guard/deprecated/dsl.rb:7
    def add_deprecated(dsl_klass); end
  end
end

# source://guard-2.18.1/lib/guard/deprecated/dsl.rb:16
module Guard::Deprecated::Dsl::ClassMethods
  # source://guard-2.18.1/lib/guard/deprecated/dsl.rb:35
...
#
# source://guard-2.18.1/lib/guard/deprecated/dsl.rb:24
Guard::Deprecated::Dsl::ClassMethods::EVALUATE_GUARDFILE = T.let(T.unsafe(nil), String)

# source://guard-2.18.1/lib/guard/deprecated/dsl.rb:11
Guard::Deprecated::Dsl::MORE_INFO_ON_UPGRADING_TO_GUARD_2 = T.let(T.unsafe(nil), String)

# source://guard-2.18.1/lib/guard/deprecated/evaluator.rb:8
module Guard::Deprecated::Evaluator
  # source://guard-2.18.1/lib/guard/deprecated/evaluator.rb:26
  def evaluate_guardfile; end

  # source://guard-2.18.1/lib/guard/deprecated/evaluator.rb:31
  def reevaluate_guardfile; end

  class << self
    # source://guard-2.18.1/lib/guard/deprecated/evaluator.rb:9
    def add_deprecated(klass); end
  end
end

# source://guard-2.18.1/lib/guard/deprecated/evaluator.rb:13
Guard::Deprecated::Evaluator::EVALUATE_GUARDFILE = T.let(T.unsafe(nil), String)

# source://guard-2.18.1/lib/guard/deprecated/evaluator.rb:18
Guard::Deprecated::Evaluator::REEVALUATE_GUARDFILE = T.let(T.unsafe(nil), String)

# source://guard-2.18.1/lib/guard/deprecated/guard.rb:14
module Guard::Deprecated::Guard
  class << self
    # source://guard-2.18.1/lib/guard/deprecated/guard.rb:15
    def add_deprecated(klass); end
  end
end

# source://guard-2.18.1/lib/guard/deprecated/guard.rb:19
module Guard::Deprecated::Guard::ClassMethods
  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:251
  def add_group(name, options = T.unsafe(nil)); end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:57
  def add_guard(*args); end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:261
  def add_plugin(name, options = T.unsafe(nil)); end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:179
  def evaluate_guardfile; end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:152
  def evaluator; end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:79
  def get_guard_class(name, fail_gracefully = T.unsafe(nil)); end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:271
  def group(filter); end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:291
  def groups(filter); end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:116
  def guard_gem_names; end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:38
  def guards(filter = T.unsafe(nil)); end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:143
  def listener=(_); end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:97
  def locate_guard(name); end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:135
  def lock; end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:195
  def options; end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:281
  def plugin(filter); end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:301
  def plugins(filter); end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:162
  def reset_evaluator(_options); end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:170
  def runner; end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:126
  def running; end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:311
  def scope; end

  # source://guard-2.18.1/lib/guard/deprecated/guard.rb:321
  def scope=(scope); end
end

# source://guard-2.18.1/lib/guard/deprecated/guard.rb:246
...
#   upgrade for Guard 2.0
#
# source://guard-2.18.1/lib/guard/deprecated/guard.rb:69
Guard::Deprecated::Guard::ClassMethods::GET_GUARD_CLASS = T.let(T.unsafe(nil), String)

# source://guard-2.18.1/lib/guard/deprecated/guard.rb:266
Guard::Deprecated::Guard::ClassMethods::GROUP = T.let(T.unsafe(nil), String)

# source://guard-2.18.1/lib/guard/deprecated/guard.rb:286
...
#   upgrade for Guard 2.0
#
# source://guard-2.18.1/lib/guard/deprecated/guard.rb:30
...
#   upgrade for Guard 2.0
#
# source://guard-2.18.1/lib/guard/deprecated/guard.rb:108
Guard::Deprecated::Guard::ClassMethods::GUARD_GEM_NAMES = T.let(T.unsafe(nil), String)

# source://guard-2.18.1/lib/guard/deprecated/guard.rb:139
...
#
# source://guard-2.18.1/lib/guard/dsl.rb:49
class Guard::Dsl
  ...
  #
  # source://guard-2.18.1/lib/guard/dsl.rb:246
  ...
  #
  # source://guard-2.18.1/lib/guard/dsl.rb:408
  def clearing(on); end
  ...
  #
  # source://guard-2.18.1/lib/guard/dsl.rb:394
  def directories(directories); end

  # :nodoc
  #
  # source://guard-2.18.1/lib/guard/dsl.rb:377
  ...
  #
  # source://guard-2.18.1/lib/guard/dsl.rb:267
  ...
  # @param regexps [Regexp] a pattern (or list of patterns) for ignoring paths
  #
  # source://guard-2.18.1/lib/guard/dsl.rb:282
  def filter!(*regexps); end
  ...
  #
  # source://guard-2.18.1/lib/guard/dsl.rb:124
  def group(*args); end
  ...
  #
  # source://guard-2.18.1/lib/guard/dsl.rb:176
  ...
  #   options
  #
  # source://guard-2.18.1/lib/guard/dsl.rb:91
  ...
  #
  # source://guard-2.18.1/lib/guard/dsl.rb:325
  ...
  #
  # source://guard-2.18.1/lib/guard/dsl.rb:76
  ...
  #
  # source://guard-2.18.1/lib/guard/dsl.rb:372
...
#
# source://guard-2.18.1/lib/guard/dsl_reader.rb:5
class Guard::DslReader < ::Guard::Dsl
  # @return [DslReader] a new instance of DslReader
  #
  # source://guard-2.18.1/lib/guard/dsl_reader.rb:8
  def initialize; end

  # source://guard-2.18.1/lib/guard/dsl_reader.rb:30
  def callback(*_args, &_block); end

  # source://guard-2.18.1/lib/guard/dsl_reader.rb:48
  def clearing(_on); end

  # source://guard-2.18.1/lib/guard/dsl_reader.rb:45
  def directories(_directories); end

  # source://guard-2.18.1/lib/guard/dsl_reader.rb:24
  def group(*_args); end

  # source://guard-2.18.1/lib/guard/dsl_reader.rb:13
  def guard(name, _options = T.unsafe(nil)); end

  # source://guard-2.18.1/lib/guard/dsl_reader.rb:33
  def ignore(*_regexps); end

  # source://guard-2.18.1/lib/guard/dsl_reader.rb:36
  def ignore!(*_regexps); end

  # source://guard-2.18.1/lib/guard/dsl_reader.rb:21
  def interactor(_options); end

  # source://guard-2.18.1/lib/guard/dsl_reader.rb:39
  def logger(_options); end

  # Stub everything else
  #
  # source://guard-2.18.1/lib/guard/dsl_reader.rb:18
  def notification(_notifier, _opts = T.unsafe(nil)); end

  # Returns the value of attribute plugin_names.
  #
  # source://guard-2.18.1/lib/guard/dsl_reader.rb:6
  def plugin_names; end

  # source://guard-2.18.1/lib/guard/dsl_reader.rb:42
  def scope(_scope = T.unsafe(nil)); end

  # source://guard-2.18.1/lib/guard/dsl_reader.rb:27
...
# @see Guard::CLI
#
# source://guard-2.18.1/lib/guard/group.rb:24
class Guard::Group
  # Initializes a Group.
  #
  # @option options
  ...
  #
  # source://guard-2.18.1/lib/guard/group.rb:35
  def initialize(name, options = T.unsafe(nil)); end

  # Returns the value of attribute name.
  #
  # source://guard-2.18.1/lib/guard/group.rb:25
  def name; end
  ...
  # @return [String]
  #
  # source://guard-2.18.1/lib/guard/group.rb:48
  def title; end
  ...
  #
  # source://guard-2.18.1/lib/guard/group.rb:60
  def to_s; end
end

# source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:11
...
# @see Guard::Dsl
#
# source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:18
class Guard::Guardfile::Evaluator
  ...
  #
  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:57
  def initialize(opts = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:121
  def custom?; end
  ...
  #   Guard::Guardfile::Evaluator.new(options).evaluate
  #
  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:89
  def evaluate; end
  ...
  #
  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:134
  ...
  #
  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:113
  def guardfile_include?(plugin_name); end

  # Returns the value of attribute guardfile_path.
  #
  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:30
  def guardfile_path; end

  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:47
  def guardfile_source; end

  # @return [Boolean]
  #
  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:139
  def inline?; end
  ...
  #
  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:119
  def path; end

  private

  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:156
  def _fetch_guardfile_contents; end

  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:223
  def _from_deprecated(opts); end

  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:212
  def _guardfile_contents; end

  # @return [Boolean]
  #
  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:219
  def _guardfile_contents_usable?; end

  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:145
  def _guardfile_contents_without_user_config; end

  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:149
  def _instance_eval_guardfile(contents); end

  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:200
  def _read(path); end

  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:186
  def _use_default!; end

  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:165
  def _use_inline; end

  # source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:178
  def _use_provided; end
end

# source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:21
Guard::Guardfile::Evaluator::DEFAULT_GUARDFILES = T.let(T.unsafe(nil), Array)

# source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:27
Guard::Guardfile::Evaluator::ERROR_NO_GUARDFILE = T.let(T.unsafe(nil), String)

# source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:32
Guard::Guardfile::Evaluator::ERROR_NO_PLUGINS = T.let(T.unsafe(nil), String)

# source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:35
class Guard::Guardfile::Evaluator::Error < ::RuntimeError; end

# source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:41
class Guard::Guardfile::Evaluator::NoCustomGuardfile < ::Guard::Guardfile::Evaluator::Error; end

# source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:38
class Guard::Guardfile::Evaluator::NoGuardfileError < ::Guard::Guardfile::Evaluator::Error; end

# source://guard-2.18.1/lib/guard/guardfile/evaluator.rb:44
class Guard::Guardfile::Evaluator::NoPluginsError < ::Guard::Guardfile::Evaluator::Error; end

# source://guard-2.18.1/lib/guard/interactor.rb:4
class Guard::Interactor
  ...
  #
  # source://guard-2.18.1/lib/guard/interactor.rb:9
  ...
  # @return [Boolean]
  #
  # source://guard-2.18.1/lib/guard/interactor.rb:20
  def interactive?; end
  ...
  #
  # source://guard-2.18.1/lib/guard/interactor.rb:51
  def idle_job; end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://guard-2.18.1/lib/guard/interactor.rb:39
    def enabled; end

    # TODO: handle switching interactors during runtime?
    #
    # source://guard-2.18.1/lib/guard/interactor.rb:46
    ...
    # source://guard-2.18.1/lib/guard/interactor.rb:31
    def options; end

    # Pass options to interactor's job when it's created
    #
    # source://guard-2.18.1/lib/guard/interactor.rb:36
    def options=(_arg0); end
  end
end
...
# @private api
#
# source://guard-2.18.1/lib/guard/internals/groups.rb:5
module Guard::Internals; end

# source://guard-2.18.1/lib/guard/internals/debugging.rb:12
class Guard::Internals::Debugging
  class << self
    ...
    #
    # source://guard-2.18.1/lib/guard/internals/debugging.rb:26
    def start; end

    # source://guard-2.18.1/lib/guard/internals/debugging.rb:38
    def stop; end

    private

    # source://guard-2.18.1/lib/guard/internals/debugging.rb:46
    def _notify(*args); end

    # reset singleton - called by tests
    #
    # source://guard-2.18.1/lib/guard/internals/debugging.rb:51
    def _reset; end

    # source://guard-2.18.1/lib/guard/internals/debugging.rb:58
    def _trace(mod, meth, &block); end

    # source://guard-2.18.1/lib/guard/internals/debugging.rb:62
    def _untrace(mod, meth); end
  end
end

# source://guard-2.18.1/lib/guard/internals/groups.rb:6
class Guard::Internals::Groups
  # @return [Groups] a new instance of Groups
  #
  # source://guard-2.18.1/lib/guard/internals/groups.rb:9
  def initialize; end

  # source://guard-2.18.1/lib/guard/internals/groups.rb:19
  def add(name, options = T.unsafe(nil)); end

  # source://guard-2.18.1/lib/guard/internals/groups.rb:13
  def all(filter = T.unsafe(nil)); end

  private

  # source://guard-2.18.1/lib/guard/internals/groups.rb:28
  def matcher_for(filter); end
end

# source://guard-2.18.1/lib/guard/internals/groups.rb:7
Guard::Internals::Groups::DEFAULT_GROUPS = T.let(T.unsafe(nil), Array)

# source://guard-2.18.1/lib/guard/internals/helpers.rb:4
module Guard::Internals::Helpers
  # source://guard-2.18.1/lib/guard/internals/helpers.rb:5
  def _relative_pathname(path); end
end

# source://guard-2.18.1/lib/guard/internals/plugins.rb:8
class Guard::Internals::Plugins
  # @return [Plugins] a new instance of Plugins
  #
  # source://guard-2.18.1/lib/guard/internals/plugins.rb:9
  def initialize; end

  # TODO: should it allow duplicates? (probably yes because of different
  # configs or groups)
  #
  # source://guard-2.18.1/lib/guard/internals/plugins.rb:25
  def add(name, options); end

  # source://guard-2.18.1/lib/guard/internals/plugins.rb:13
  def all(filter = T.unsafe(nil)); end

  # source://guard-2.18.1/lib/guard/internals/plugins.rb:19
  def remove(plugin); end

  private

  # source://guard-2.18.1/lib/guard/internals/plugins.rb:31
  def matcher_for(filter); end
end

# source://guard-2.18.1/lib/guard/internals/queue.rb:3
class Guard::Internals::Queue
  # @return [Queue] a new instance of Queue
  #
  # source://guard-2.18.1/lib/guard/internals/queue.rb:4
  def initialize(commander); end

  # source://guard-2.18.1/lib/guard/internals/queue.rb:31
  def <<(changes); end

  # @return [Boolean]
  #
  # source://guard-2.18.1/lib/guard/internals/queue.rb:27
  def pending?; end

  # Process the change queue, running tasks within the main Guard thread
  #
  # source://guard-2.18.1/lib/guard/internals/queue.rb:10
  def process; end

  private

  # source://guard-2.18.1/lib/guard/internals/queue.rb:37
  def _run_actions(actions); end
end

# source://guard-2.18.1/lib/guard/internals/scope.rb:6
class Guard::Internals::Scope
  # @return [Scope] a new instance of Scope
  #
  # source://guard-2.18.1/lib/guard/internals/scope.rb:7
  def initialize; end

  # source://guard-2.18.1/lib/guard/internals/scope.rb:51
  def from_interactor(scope); end

  # TODO: refactor
  #
  # source://guard-2.18.1/lib/guard/internals/scope.rb:20
  def grouped_plugins(scope = T.unsafe(nil)); end

  # source://guard-2.18.1/lib/guard/internals/scope.rb:56
  def titles(scope = T.unsafe(nil)); end

  # source://guard-2.18.1/lib/guard/internals/scope.rb:12
  def to_hash; end

  private

  # source://guard-2.18.1/lib/guard/internals/scope.rb:108
  def _find_non_empty_scope(type, local_scope); end

  # source://guard-2.18.1/lib/guard/internals/scope.rb:112
  def _groups; end

  # TODO: let the Plugins and Groups classes handle this?
  # TODO: why even instantiate?? just to check if it exists?
  #
  # source://guard-2.18.1/lib/guard/internals/scope.rb:77
  def _hashify_scope(type); end

  # source://guard-2.18.1/lib/guard/internals/scope.rb:102
  def _instantiate(meth, obj); end

  # source://guard-2.18.1/lib/guard/internals/scope.rb:116
  def _plugins; end

  # TODO: move to session
  #
  # source://guard-2.18.1/lib/guard/internals/scope.rb:68
...
#
# source://guard-2.18.1/lib/guard/internals/session.rb:11
class Guard::Internals::Session
  # @return [Session] a new instance of Session
  #
  # source://guard-2.18.1/lib/guard/internals/session.rb:51
  def initialize(new_options); end

  # @return [Boolean]
  #
  # source://guard-2.18.1/lib/guard/internals/session.rb:102
  def clear?; end

  # source://guard-2.18.1/lib/guard/internals/session.rb:98
  def clearing(on); end
  ...
  # source://guard-2.18.1/lib/guard/internals/session.rb:43
  def cmdline_groups; end

  # source://guard-2.18.1/lib/guard/internals/session.rb:47
  def cmdline_plugins; end

  # TODO: call this from within action, not within interactor command
  #
  # source://guard-2.18.1/lib/guard/internals/session.rb:162
  def convert_scope(entries); end

  # @return [Boolean]
  #
  # source://guard-2.18.1/lib/guard/internals/session.rb:108
  def debug?; end

  # source://guard-2.18.1/lib/guard/internals/session.rb:136
  def evaluator_options; end

  # Returns the value of attribute groups.
  #
  # source://guard-2.18.1/lib/guard/internals/session.rb:13
  def groups; end

  # TODO: create a EvaluatorResult class?
  #
  # source://guard-2.18.1/lib/guard/internals/session.rb:89
  def guardfile_group_scope; end

  # Returns the value of attribute guardfile_ignore.
  #
  # source://guard-2.18.1/lib/guard/internals/session.rb:93
  def guardfile_ignore; end

  # source://guard-2.18.1/lib/guard/internals/session.rb:94
  def guardfile_ignore=(ignores); end

  # Returns the value of attribute guardfile_ignore_bang.
  #
  # source://guard-2.18.1/lib/guard/internals/session.rb:91
  ...
  # source://guard-2.18.1/lib/guard/internals/session.rb:155
  def guardfile_notification=(config); end

  # Returns the value of attribute guardfile_plugin_scope.
  #
  # source://guard-2.18.1/lib/guard/internals/session.rb:90
  def guardfile_plugin_scope; end

  # source://guard-2.18.1/lib/guard/internals/session.rb:74
  def guardfile_scope(scope); end

  # Returns the value of attribute interactor_name.
  #
  # source://guard-2.18.1/lib/guard/internals/session.rb:159
  def interactor_name; end

  # source://guard-2.18.1/lib/guard/internals/session.rb:123
  def listener_args; end

  # source://guard-2.18.1/lib/guard/internals/session.rb:145
  def notify_options; end

  # Returns the value of attribute plugins.
  #
  # source://guard-2.18.1/lib/guard/internals/session.rb:12
  def plugins; end

  # source://guard-2.18.1/lib/guard/internals/session.rb:112
  def watchdirs; end

  # set by Dsl with :directories() command
  #
  # source://guard-2.18.1/lib/guard/internals/session.rb:118
  def watchdirs=(dirs); end
end

# source://guard-2.18.1/lib/guard/internals/session.rb:15
Guard::Internals::Session::DEFAULT_OPTIONS = T.let(T.unsafe(nil), Hash)

# source://guard-2.18.1/lib/guard/internals/state.rb:10
class Guard::Internals::State
  # Minimal setup for non-interactive commands (list, init, show, etc.)
  #
  # @return [State] a new instance of State
  #
  # source://guard-2.18.1/lib/guard/internals/state.rb:12
  def initialize(cmdline_opts); end

  # Returns the value of attribute scope.
  #
  # source://guard-2.18.1/lib/guard/internals/state.rb:21
  def scope; end

  # Returns the value of attribute session.
  #
  # source://guard-2.18.1/lib/guard/internals/state.rb:22
  def session; end
end

# source://guard-2.18.1/lib/guard/internals/tracing.rb:3
module Guard::Internals::Tracing
  class << self
    # source://guard-2.18.1/lib/guard/internals/tracing.rb:4
    def trace(mod, meth); end

    # source://guard-2.18.1/lib/guard/internals/tracing.rb:19
    def untrace(mod, meth); end
  end
end

# source://guard-2.18.1/lib/guard/internals/traps.rb:3
module Guard::Internals::Traps
  class << self
    # source://guard-2.18.1/lib/guard/internals/traps.rb:4
    def handle(signal, &block); end
  end
end

# source://guard-2.18.1/lib/guard/notifier.rb:5
class Guard::Notifier
  class << self
    # source://guard-2.18.1/lib/guard/notifier.rb:6
    def connect(options = T.unsafe(nil)); end

    # Used by dsl describer
    #
    # source://guard-2.18.1/lib/guard/notifier.rb:65
    def detected; end

    # source://guard-2.18.1/lib/guard/notifier.rb:18
    def disconnect; end

    # source://guard-2.18.1/lib/guard/notifier.rb:27
    def notify(message, options = T.unsafe(nil)); end

    # Used by dsl describer
    #
    # source://guard-2.18.1/lib/guard/notifier.rb:60
    def supported; end

    # source://guard-2.18.1/lib/guard/notifier.rb:44
    def toggle; end

    # source://guard-2.18.1/lib/guard/notifier.rb:40
    def turn_on; end
  end
end

# source://guard-2.18.1/lib/guard/notifier.rb:23
...
#
# source://guard-2.18.1/lib/guard/options.rb:12
...
# @see Guard::Group
#
# source://guard-2.18.1/lib/guard/plugin.rb:44
class Guard::Plugin
  ...
  #
  # source://guard-2.18.1/lib/guard/plugin.rb:285
  def initialize(options = T.unsafe(nil)); end

  # Returns the value of attribute callbacks.
  #
  # source://guard-2.18.1/lib/guard/plugin.rb:129
  def callbacks; end
  ...
  #
  # source://guard-2.18.1/lib/guard/plugin.rb:116
  ...
  # @return [String]
  #
  # source://guard-2.18.1/lib/guard/plugin.rb:240
  def name; end
  ...
  # @return [String]
  #
  # source://guard-2.18.1/lib/guard/plugin.rb:252
  def title; end
  ...
  # @return [String] the string representation
  #
  # source://guard-2.18.1/lib/guard/plugin.rb:267
  def to_s; end
  ...
  #
  # source://guard-2.18.1/lib/guard/plugin.rb:297
  ...
  class << self
    ...
    # @return [String]
    #
    # source://guard-2.18.1/lib/guard/plugin.rb:140
    ...
    # @return [String]
    #
    # source://guard-2.18.1/lib/guard/plugin.rb:153
    ...
    #
    # source://guard-2.18.1/lib/guard/plugin.rb:74
    ...
    #
    # source://guard-2.18.1/lib/guard/plugin.rb:83
    ...
    #
    # source://guard-2.18.1/lib/guard/plugin.rb:162
    def template(plugin_location); end
  end
end

# source://guard-2.18.1/lib/guard/plugin.rb:45
...
#
# source://guard-2.18.1/lib/guard/plugin_util.rb:11
class Guard::PluginUtil
  ...
  #
  # source://guard-2.18.1/lib/guard/plugin_util.rb:36
  def initialize(name); end

  # Adds a plugin's template to the Guardfile.
  #
  # source://guard-2.18.1/lib/guard/plugin_util.rb:126
  ...
  # @see https://github.com/guard/guard/wiki/Upgrading-to-Guard-2.0 How to
  #
  # source://guard-2.18.1/lib/guard/plugin_util.rb:55
  def initialize_plugin(options); end

  # Returns the value of attribute name.
  #
  # source://guard-2.18.1/lib/guard/plugin_util.rb:18
  def name; end
  ...
  #
  # source://guard-2.18.1/lib/guard/plugin_util.rb:96
  ...
  #
  # source://guard-2.18.1/lib/guard/plugin_util.rb:73
  ...
  #   => "Rspec"
  #
  # source://guard-2.18.1/lib/guard/plugin_util.rb:172
  def _constant_name; end

  # source://guard-2.18.1/lib/guard/plugin_util.rb:177
  ...
  #   => Guard::RSpec
  #
  # source://guard-2.18.1/lib/guard/plugin_util.rb:160
  def _plugin_constant; end

  class << self
    # @return [Boolean]
    #
    # source://guard-2.18.1/lib/guard/plugin_util.rb:182
    ...
    #
    # source://guard-2.18.1/lib/guard/plugin_util.rb:24
    def plugin_names; end
  end
end

# source://guard-2.18.1/lib/guard/plugin_util.rb:12
Guard::PluginUtil::ERROR_NO_GUARD_OR_CLASS = T.let(T.unsafe(nil), String)

# source://guard-2.18.1/lib/guard/plugin_util.rb:15
...
#
# source://guard-2.18.1/lib/guard/runner.rb:9
class Guard::Runner
  ...
  #
  # source://guard-2.18.1/lib/guard/runner.rb:78
  ...
  #
  # source://guard-2.18.1/lib/guard/runner.rb:17
  ...
  #
  # source://guard-2.18.1/lib/guard/runner.rb:44
  def run_on_changes(modified, added, removed); end

  private

  # source://guard-2.18.1/lib/guard/runner.rb:116
  ...
  class << self
    ...
    #
    # source://guard-2.18.1/lib/guard/runner.rb:110
    def stopping_symbol_for(guard); end
  end
end

# source://guard-2.18.1/lib/guard/runner.rb:34
Guard::Runner::ADDITION_TASKS = T.let(T.unsafe(nil), Array)

# source://guard-2.18.1/lib/guard/runner.rb:30
Guard::Runner::MODIFICATION_TASKS = T.let(T.unsafe(nil), Array)

# source://guard-2.18.1/lib/guard/runner.rb:28
Guard::Runner::PLUGIN_FAILED = T.let(T.unsafe(nil), String)

# source://guard-2.18.1/lib/guard/runner.rb:35
Guard::Runner::REMOVAL_TASKS = T.let(T.unsafe(nil), Array)

# source://guard-2.18.1/lib/guard/terminal.rb:4
class Guard::Terminal
  class << self
    # source://guard-2.18.1/lib/guard/terminal.rb:6
    def clear; end
  end
end
...
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:2
module Guard::UI
  ...
  class << self
    ...
    #
    # source://guard-2.18.1/lib/guard/ui.rb:161
    def action_with_scopes(action, scope); end

    # Clear the output if clearable.
    #
    # source://guard-2.18.1/lib/guard/ui.rb:131
    def clear(opts = T.unsafe(nil)); end

    # Allow the screen to be cleared again.
    #
    # source://guard-2.18.1/lib/guard/ui.rb:152
    def clearable; end
    ...
    # @param options [Hash] a customizable set of options
    #
    # source://guard-2.18.1/lib/guard/ui.rb:119
    ...
    # @param options [Hash] a customizable set of options
    #
    # source://guard-2.18.1/lib/guard/ui.rb:105
    ...
    # @param options [Hash] a customizable set of options
    #
    # source://guard-2.18.1/lib/guard/ui.rb:94
    ...
    # @param options [Hash] a customizable set of options
    #
    # source://guard-2.18.1/lib/guard/ui.rb:74
    def info(message, options = T.unsafe(nil)); end

    # Assigns a log level
    #
    # source://guard-2.18.1/lib/guard/ui.rb:63
    def level=(new_level); end

    # Get the Guard::UI logger instance
    #
    # source://guard-2.18.1/lib/guard/ui.rb:26
    def logger; end
    ...
    #
    # source://guard-2.18.1/lib/guard/ui.rb:46
    def options; end
    ...
    #
    # source://guard-2.18.1/lib/guard/ui.rb:58
    ...
    # @private api
    #
    # source://guard-2.18.1/lib/guard/ui.rb:145
    def reset_and_clear; end

    # Reset a line.
    #
    # source://guard-2.18.1/lib/guard/ui.rb:125
    def reset_line; end
    ...
    #
    # source://guard-2.18.1/lib/guard/ui.rb:38
    ...
    # @param options [Hash] a customizable set of options
    #
    # source://guard-2.18.1/lib/guard/ui.rb:84
    ...
    #
    # source://guard-2.18.1/lib/guard/ui.rb:203
    ...
    #
    # source://guard-2.18.1/lib/guard/ui.rb:175
    def _filter(plugin); end

    # @private
    #
    # source://guard-2.18.1/lib/guard/ui.rb:188
    ...
    #
    # source://guard-2.18.1/lib/guard/ui.rb:247
    ...
    #
    # source://guard-2.18.1/lib/guard/ui.rb:217
    def color_enabled?; end
  end
end

# source://guard-2.18.1/lib/guard/ui/colors.rb:3
module Guard::UI::Colors; end

# Black background color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:32
Guard::UI::Colors::ANSI_ESCAPE_BGBLACK = T.let(T.unsafe(nil), String)

# Blue background color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:44
Guard::UI::Colors::ANSI_ESCAPE_BGBLUE = T.let(T.unsafe(nil), String)

# Cyan background color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:50
Guard::UI::Colors::ANSI_ESCAPE_BGCYAN = T.let(T.unsafe(nil), String)

# Green background color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:38
Guard::UI::Colors::ANSI_ESCAPE_BGGREEN = T.let(T.unsafe(nil), String)

# Magenta background color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:47
Guard::UI::Colors::ANSI_ESCAPE_BGMAGENTA = T.let(T.unsafe(nil), String)

# Red background color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:35
Guard::UI::Colors::ANSI_ESCAPE_BGRED = T.let(T.unsafe(nil), String)

# White background color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:53
Guard::UI::Colors::ANSI_ESCAPE_BGWHITE = T.let(T.unsafe(nil), String)

# Yellow background color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:41
Guard::UI::Colors::ANSI_ESCAPE_BGYELLOW = T.let(T.unsafe(nil), String)

# Black foreground color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:8
Guard::UI::Colors::ANSI_ESCAPE_BLACK = T.let(T.unsafe(nil), String)

# Blue foreground color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:20
Guard::UI::Colors::ANSI_ESCAPE_BLUE = T.let(T.unsafe(nil), String)

# Brighten the color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:5
Guard::UI::Colors::ANSI_ESCAPE_BRIGHT = T.let(T.unsafe(nil), String)

# Cyan foreground color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:26
Guard::UI::Colors::ANSI_ESCAPE_CYAN = T.let(T.unsafe(nil), String)

# Green foreground color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:14
Guard::UI::Colors::ANSI_ESCAPE_GREEN = T.let(T.unsafe(nil), String)

# Magenta foreground color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:23
Guard::UI::Colors::ANSI_ESCAPE_MAGENTA = T.let(T.unsafe(nil), String)

# Red foreground color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:11
Guard::UI::Colors::ANSI_ESCAPE_RED = T.let(T.unsafe(nil), String)

# White foreground color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:29
Guard::UI::Colors::ANSI_ESCAPE_WHITE = T.let(T.unsafe(nil), String)

# Yellow foreground color
#
# source://guard-2.18.1/lib/guard/ui/colors.rb:17
Guard::UI::Colors::ANSI_ESCAPE_YELLOW = T.let(T.unsafe(nil), String)

# source://guard-2.18.1/lib/guard/ui/config.rb:6
class Guard::UI::Config < ::Guard::Options
  # @return [Config] a new instance of Config
  #
  # source://guard-2.18.1/lib/guard/ui/config.rb:20
  def initialize(options = T.unsafe(nil)); end

  # source://guard-2.18.1/lib/guard/ui/config.rb:48
  def [](name); end

  # source://guard-2.18.1/lib/guard/ui/config.rb:35
  def device; end

  # source://guard-2.18.1/lib/guard/ui/config.rb:44
  def except; end

  # Returns the value of attribute logger_config.
  #
  # source://guard-2.18.1/lib/guard/ui/config.rb:18
  def logger_config; end

  # source://guard-2.18.1/lib/guard/ui/config.rb:40
  def only; end

  # source://guard-2.18.1/lib/guard/ui/config.rb:59
  def with_progname(name); end
end

# source://guard-2.18.1/lib/guard/ui/config.rb:7
Guard::UI::Config::DEFAULTS = T.let(T.unsafe(nil), Hash)

# source://guard-2.18.1/lib/guard/ui/config.rb:16
Guard::UI::Config::DEPRECATED_OPTS = T.let(T.unsafe(nil), Array)

# source://guard-2.18.1/lib/guard/ui/logger.rb:5
class Guard::UI::Logger; end

# source://guard-2.18.1/lib/guard/ui/logger.rb:6
class Guard::UI::Logger::Config < ::Guard::Options
  # @return [Config] a new instance of Config
  #
  # source://guard-2.18.1/lib/guard/ui/logger.rb:20
  def initialize(options = T.unsafe(nil)); end

  # source://guard-2.18.1/lib/guard/ui/logger.rb:24
  def level=(value); end
end

# source://guard-2.18.1/lib/guard/ui/logger.rb:7
...
#
# source://guard-2.18.1/lib/guard/watcher/pattern/match_result.rb:2
class Guard::Watcher
  ...
  #
  # source://guard-2.18.1/lib/guard/watcher.rb:24
  ...
  #
  # source://guard-2.18.1/lib/guard/watcher.rb:32
  def ==(other); end

  # Returns the value of attribute action.
  #
  # source://guard-2.18.1/lib/guard/watcher.rb:15
  def action; end
  ...
  #
  # source://guard-2.18.1/lib/guard/watcher.rb:81
  def call_action(matches); end

  # source://guard-2.18.1/lib/guard/watcher.rb:70
  ...
  class << self
    ...
    #
    # source://guard-2.18.1/lib/guard/watcher.rb:42
    def match_files(guard, files); end
  end
end

# source://guard-2.18.1/lib/guard/watcher/pattern/match_result.rb:3
class Guard::Watcher::Pattern
  class << self
    # source://guard-2.18.1/lib/guard/watcher/pattern.rb:12
...
#
# source://guard-2.18.1/lib/guard/watcher/pattern/deprecated_regexp.rb:7
class Guard::Watcher::Pattern::DeprecatedRegexp
  # @return [DeprecatedRegexp] a new instance of DeprecatedRegexp
  #
  # source://guard-2.18.1/lib/guard/watcher/pattern/deprecated_regexp.rb:8
  def initialize(pattern); end

  # @return [Boolean]
  #
  # source://guard-2.18.1/lib/guard/watcher/pattern/deprecated_regexp.rb:16
  def deprecated?; end

  class << self
    # source://guard-2.18.1/lib/guard/watcher/pattern/deprecated_regexp.rb:12
    def convert(pattern); end

    # source://guard-2.18.1/lib/guard/watcher/pattern/deprecated_regexp.rb:21
    def show_deprecation(pattern); end
  end
end

# source://guard-2.18.1/lib/guard/watcher/pattern/match_result.rb:4
class Guard::Watcher::Pattern::MatchResult
  # @return [MatchResult] a new instance of MatchResult
  #
  # source://guard-2.18.1/lib/guard/watcher/pattern/match_result.rb:5
  def initialize(match_result, original_value); end

  # source://guard-2.18.1/lib/guard/watcher/pattern/match_result.rb:10
  def [](index); end
end

# source://guard-2.18.1/lib/guard/watcher/pattern/matcher.rb:4
class Guard::Watcher::Pattern::Matcher
  # @return [Matcher] a new instance of Matcher
  #
  # source://guard-2.18.1/lib/guard/watcher/pattern/matcher.rb:7
  ...
  # @return [true, false] equal or not
  #
  # source://guard-2.18.1/lib/guard/watcher/pattern/matcher.rb:15
  def ==(other); end

  # source://guard-2.18.1/lib/guard/watcher/pattern/matcher.rb:19
  def match(string_or_pathname); end

  # Returns the value of attribute matcher.
  #
  # source://guard-2.18.1/lib/guard/watcher/pattern/matcher.rb:5
  def matcher; end

  private

  # source://guard-2.18.1/lib/guard/watcher/pattern/matcher.rb:25
  def normalized(string_or_pathname); end
end

# source://guard-2.18.1/lib/guard/watcher/pattern/pathname_path.rb:6
class Guard::Watcher::Pattern::PathnamePath < ::Guard::Watcher::Pattern::SimplePath
  protected

  # source://guard-2.18.1/lib/guard/watcher/pattern/pathname_path.rb:9
  def normalize(string_or_pathname); end
end

# source://guard-2.18.1/lib/guard/watcher/pattern/simple_path.rb:4
class Guard::Watcher::Pattern::SimplePath
  # @return [SimplePath] a new instance of SimplePath
  #
  # source://guard-2.18.1/lib/guard/watcher/pattern/simple_path.rb:5
  def initialize(string_or_pathname); end

  # source://guard-2.18.1/lib/guard/watcher/pattern/simple_path.rb:9
  def match(string_or_pathname); end

  protected

  # source://guard-2.18.1/lib/guard/watcher/pattern/simple_path.rb:17
  def normalize(string_or_pathname); end
end
