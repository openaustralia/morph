...
# source://dotenv-rails-2.8.1/lib/dotenv/rails.rb:32
module Dotenv
  private
...
# Rails applications
#
# source://dotenv-rails-2.8.1/lib/dotenv/rails.rb:39
class Dotenv::Railtie < ::Rails::Railtie
  ...
  #
  # source://dotenv-rails-2.8.1/lib/dotenv/rails.rb:40
  def load; end
  ...
  #
  # source://dotenv-rails-2.8.1/lib/dotenv/rails.rb:47
  def overload; end
  ...
  #
  # source://dotenv-rails-2.8.1/lib/dotenv/rails.rb:54
  def root; end

  private

  # source://dotenv-rails-2.8.1/lib/dotenv/rails.rb:66
  ...
  class << self
    ...
    #
    # source://dotenv-rails-2.8.1/lib/dotenv/rails.rb:60
    def load; end
  end
end
