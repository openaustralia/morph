...
# source://memory_profiler-1.0.0/lib/memory_profiler/version.rb:3
module MemoryProfiler
  class << self
    # source://memory_profiler-1.0.0/lib/memory_profiler.rb:15
    def report(opts = T.unsafe(nil), &block); end

    # source://memory_profiler-1.0.0/lib/memory_profiler.rb:19
    def start(opts = T.unsafe(nil)); end

    # source://memory_profiler-1.0.0/lib/memory_profiler.rb:26
    def stop; end
  end
end

# source://memory_profiler-1.0.0/lib/memory_profiler/cli.rb:6
class MemoryProfiler::CLI
  # source://memory_profiler-1.0.0/lib/memory_profiler/cli.rb:31
  def run(argv); end

  private

  # source://memory_profiler-1.0.0/lib/memory_profiler/cli.rb:61
  def option_parser(options); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/cli.rb:141
  def reporter_options(options); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/cli.rb:145
  def results_options(options); end
end

# source://memory_profiler-1.0.0/lib/memory_profiler/cli.rb:7
MemoryProfiler::CLI::BIN_NAME = T.let(T.unsafe(nil), String)

# source://memory_profiler-1.0.0/lib/memory_profiler/cli.rb:13
MemoryProfiler::CLI::DEFAULTS = T.let(T.unsafe(nil), Hash)

# source://memory_profiler-1.0.0/lib/memory_profiler/cli.rb:17
MemoryProfiler::CLI::REPORTER_KEYS = T.let(T.unsafe(nil), Array)

# source://memory_profiler-1.0.0/lib/memory_profiler/cli.rb:21
MemoryProfiler::CLI::RESULTS_KEYS = T.let(T.unsafe(nil), Array)

# source://memory_profiler-1.0.0/lib/memory_profiler/cli.rb:11
MemoryProfiler::CLI::STATUS_ERROR = T.let(T.unsafe(nil), Integer)

# source://memory_profiler-1.0.0/lib/memory_profiler/cli.rb:10
MemoryProfiler::CLI::STATUS_SUCCESS = T.let(T.unsafe(nil), Integer)

# source://memory_profiler-1.0.0/lib/memory_profiler/cli.rb:8
MemoryProfiler::CLI::VERSION_INFO = T.let(T.unsafe(nil), String)

# source://memory_profiler-1.0.0/lib/memory_profiler/helpers.rb:4
class MemoryProfiler::Helpers
  # @return [Helpers] a new instance of Helpers
  #
  # source://memory_profiler-1.0.0/lib/memory_profiler/helpers.rb:6
  def initialize; end

  # source://memory_profiler-1.0.0/lib/memory_profiler/helpers.rb:13
  def guess_gem(path); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/helpers.rb:54
  def lookup_class_name(klass); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/helpers.rb:28
  def lookup_location(file, line); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/helpers.rb:63
  def lookup_string(obj); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/helpers.rb:34
  def object_class(obj); end
end

# source://memory_profiler-1.0.0/lib/memory_profiler/helpers.rb:32
MemoryProfiler::Helpers::KERNEL_CLASS_METHOD = T.let(T.unsafe(nil), UnboundMethod)

# source://memory_profiler-1.0.0/lib/memory_profiler/monochrome.rb:5
class MemoryProfiler::Monochrome
  # source://memory_profiler-1.0.0/lib/memory_profiler/monochrome.rb:15
  def line(text); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/monochrome.rb:7
  def path(text); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/monochrome.rb:11
  def string(text); end
end

# source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:5
class MemoryProfiler::Polychrome
  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:15
  def line(text); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:7
  def path(text); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:11
  def string(text); end

  private

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:53
  def bg_black(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:69
  def bg_blue(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:65
  def bg_brown(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:77
  def bg_cyan(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:81
  def bg_gray(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:61
  def bg_green(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:73
  def bg_magenta(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:57
  def bg_red(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:21
  def black(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:37
  def blue(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:85
  def bold(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:33
  def brown(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:45
  def cyan(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:49
  def gray(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:29
  def green(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:41
  def magenta(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:25
  def red(str); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/polychrome.rb:89
...
#   end
#
# source://memory_profiler-1.0.0/lib/memory_profiler/reporter.rb:11
class MemoryProfiler::Reporter
  # @return [Reporter] a new instance of Reporter
  #
  # source://memory_profiler-1.0.0/lib/memory_profiler/reporter.rb:18
  def initialize(opts = T.unsafe(nil)); end

  # Returns the value of attribute generation.
  #
  # source://memory_profiler-1.0.0/lib/memory_profiler/reporter.rb:16
  def generation; end
  ...
  #
  # source://memory_profiler-1.0.0/lib/memory_profiler/reporter.rb:71
  def run(&block); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/reporter.rb:36
  def start; end

  # source://memory_profiler-1.0.0/lib/memory_profiler/reporter.rb:46
  def stop; end
  ...
  #
  # source://memory_profiler-1.0.0/lib/memory_profiler/reporter.rb:88
  def object_list(generation); end

  class << self
    # Returns the value of attribute current_reporter.
    #
    # source://memory_profiler-1.0.0/lib/memory_profiler/reporter.rb:13
    ...
    #
    # source://memory_profiler-1.0.0/lib/memory_profiler/reporter.rb:32
    def report(opts = T.unsafe(nil), &block); end
  end
end

# source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:4
class MemoryProfiler::Results
  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:27
  ...
  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:160
  ...
  #
  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:113
  def pretty_print(io = T.unsafe(nil), **options); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:150
  def print_string_reports(io, options); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:41
  ...
  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:67
  def scale_bytes(bytes); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:75
  def string_report(data, top); end

  # Returns the value of attribute strings_allocated.
  #
  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:37
  ...
  #
  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:38
  ...
  #
  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:39
  ...
  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:195
  def dump_data(io, type, metric, name, options); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:215
  def dump_strings(io, type, options); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:191
  def print_output(io, topic, detail); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:185
  def print_title(io, title); end

  # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:177
  def total_memsize(stat_hash); end

  class << self
    # source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:21
    def register_type(name, stat_attribute); end
  end
end

# source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:18
MemoryProfiler::Results::METRICS = T.let(T.unsafe(nil), Array)

# source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:19
MemoryProfiler::Results::NAMES = T.let(T.unsafe(nil), Array)

# source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:17
MemoryProfiler::Results::TYPES = T.let(T.unsafe(nil), Array)

# source://memory_profiler-1.0.0/lib/memory_profiler/results.rb:5
MemoryProfiler::Results::UNIT_PREFIXES = T.let(T.unsafe(nil), Hash)

# source://memory_profiler-1.0.0/lib/memory_profiler/stat.rb:4
class MemoryProfiler::Stat
  # @return [Stat] a new instance of Stat
  #
  # source://memory_profiler-1.0.0/lib/memory_profiler/stat.rb:8
  def initialize(class_name, gem, file, location, memsize, string_value); end

  # Returns the value of attribute class_name.
  #
  # source://memory_profiler-1.0.0/lib/memory_profiler/stat.rb:6
  def class_name; end
...
# source://memory_profiler-1.0.0/lib/memory_profiler/stat_hash.rb:4
class MemoryProfiler::StatHash < ::Hash
  include ::MemoryProfiler::TopN
end

# source://memory_profiler-1.0.0/lib/memory_profiler/top_n.rb:4
module MemoryProfiler::TopN
  ...
  #
  # source://memory_profiler-1.0.0/lib/memory_profiler/top_n.rb:7
  def top_n(max, metric_method); end
end

# source://memory_profiler-1.0.0/lib/memory_profiler/version.rb:4
