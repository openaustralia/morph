...
# source://http_parser.rb-0.8.1/lib/http_parser.rb:6
module HTTP; end

# source://http_parser.rb-0.8.1/lib/http_parser.rb:7
class HTTP::Parser
  ...
  class << self
    ...
    #
    # source://http_parser.rb-0.8.1/lib/http_parser.rb:9
    def default_header_value_type; end

    # source://http_parser.rb-0.8.1/lib/http_parser.rb:11
...
# source://http_parser.rb-0.8.1/lib/http_parser.rb:4
Http = HTTP
