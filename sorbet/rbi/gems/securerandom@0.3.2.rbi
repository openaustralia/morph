...
#
# source://securerandom-0.3.2/lib/random/formatter.rb:55
module Random::Formatter
  ...
  #
  # source://securerandom-0.3.2/lib/random/formatter.rb:368
  ...
  #
  # source://securerandom-0.3.2/lib/random/formatter.rb:115
  ...
  #
  # source://securerandom-0.3.2/lib/random/formatter.rb:93
  ...
  #
  # source://securerandom-0.3.2/lib/random/formatter.rb:72
  ...
  #
  # source://securerandom-0.3.2/lib/random/formatter.rb:146
  ...
  #
  # source://securerandom-0.3.2/lib/random/formatter.rb:170
  def uuid; end
  ...
  #
  # source://securerandom-0.3.2/lib/random/formatter.rb:247
  ...
  #
  # source://securerandom-0.3.2/lib/random/formatter.rb:313
  def choose(source, n); end

  # Internal interface to Random; Generate random data _n_ bytes.
  #
  # source://securerandom-0.3.2/lib/random/formatter.rb:295
...
#
# source://securerandom-0.3.2/lib/securerandom.rb:41
module SecureRandom
  extend ::Random::Formatter
  ...
  class << self
    ...
    # See Random.bytes
    #
    # source://securerandom-0.3.2/lib/securerandom.rb:50
    def bytes(n); end

    # source://securerandom-0.3.2/lib/securerandom.rb:64
    def gen_random(n); end
    ...
    #
    # source://securerandom-0.3.2/lib/securerandom.rb:59
