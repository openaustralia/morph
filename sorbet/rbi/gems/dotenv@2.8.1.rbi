...
#
# source://dotenv-2.8.1/lib/dotenv/substitutions/variable.rb:3
module Dotenv
  private
...
#
# source://dotenv-2.8.1/lib/dotenv/environment.rb:4
class Dotenv::Environment < ::Hash
  # @return [Environment] a new instance of Environment
  #
  # source://dotenv-2.8.1/lib/dotenv/environment.rb:7
  def initialize(filename, is_load = T.unsafe(nil)); end

  # source://dotenv-2.8.1/lib/dotenv/environment.rb:20
  def apply; end

  # source://dotenv-2.8.1/lib/dotenv/environment.rb:24
  def apply!; end

  # Returns the value of attribute filename.
  #
  # source://dotenv-2.8.1/lib/dotenv/environment.rb:5
  def filename; end

  # source://dotenv-2.8.1/lib/dotenv/environment.rb:12
  def load(is_load = T.unsafe(nil)); end

  # source://dotenv-2.8.1/lib/dotenv/environment.rb:16
  def read; end
end

# source://dotenv-2.8.1/lib/dotenv/missing_keys.rb:2
class Dotenv::Error < ::StandardError; end

# source://dotenv-2.8.1/lib/dotenv/parser.rb:5
class Dotenv::FormatError < ::SyntaxError; end

# source://dotenv-2.8.1/lib/dotenv/missing_keys.rb:4
class Dotenv::MissingKeys < ::Dotenv::Error
  # @return [MissingKeys] a new instance of MissingKeys
  #
  # source://dotenv-2.8.1/lib/dotenv/missing_keys.rb:5
...
#
# source://dotenv-2.8.1/lib/dotenv/parser.rb:10
class Dotenv::Parser
  # @return [Parser] a new instance of Parser
  #
  # source://dotenv-2.8.1/lib/dotenv/parser.rb:40
  def initialize(string, is_load = T.unsafe(nil)); end

  # source://dotenv-2.8.1/lib/dotenv/parser.rb:46
  def call; end

  private

  # source://dotenv-2.8.1/lib/dotenv/parser.rb:82
  def expand_newlines(value); end

  # source://dotenv-2.8.1/lib/dotenv/parser.rb:62
  def parse_line(line); end

  # source://dotenv-2.8.1/lib/dotenv/parser.rb:70
  def parse_value(value); end

  # source://dotenv-2.8.1/lib/dotenv/parser.rb:100
  def perform_substitutions(value, maybe_quote); end

  # source://dotenv-2.8.1/lib/dotenv/parser.rb:78
  def unescape_characters(value); end

  # source://dotenv-2.8.1/lib/dotenv/parser.rb:90
  def unescape_value(value, maybe_quote); end

  # @return [Boolean]
  #
  # source://dotenv-2.8.1/lib/dotenv/parser.rb:86
  def variable_not_set?(line); end

  class << self
    # source://dotenv-2.8.1/lib/dotenv/parser.rb:35
    def call(string, is_load = T.unsafe(nil)); end

    # Returns the value of attribute substitutions.
    #
    # source://dotenv-2.8.1/lib/dotenv/parser.rb:33
    def substitutions; end
  end
end

# source://dotenv-2.8.1/lib/dotenv/parser.rb:14
Dotenv::Parser::LINE = T.let(T.unsafe(nil), Regexp)

# source://dotenv-2.8.1/lib/dotenv/substitutions/variable.rb:4
...
#
# source://dotenv-2.8.1/lib/dotenv/substitutions/command.rb:9
module Dotenv::Substitutions::Command
  class << self
    # source://dotenv-2.8.1/lib/dotenv/substitutions/command.rb:23
...
#   URL="https://$HOST"
#
# source://dotenv-2.8.1/lib/dotenv/substitutions/variable.rb:10
module Dotenv::Substitutions::Variable
  class << self
    # source://dotenv-2.8.1/lib/dotenv/substitutions/variable.rb:21
    def call(value, env, is_load); end

    private

    # source://dotenv-2.8.1/lib/dotenv/substitutions/variable.rb:31
