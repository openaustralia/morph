...
# source://responders-3.2.0/lib/responders.rb:6
...
# source://responders-3.2.0/lib/action_controller/respond_with.rb:7
module ActionController::RespondWith
  ...
  #
  # source://responders-3.2.0/lib/action_controller/respond_with.rb:201
  ...
  # current action.
  #
  # source://responders-3.2.0/lib/action_controller/respond_with.rb:245
  ...
  #   end
  #
  # source://responders-3.2.0/lib/action_controller/respond_with.rb:232
...
# source://responders-3.2.0/lib/action_controller/respond_with.rb:16
module ActionController::RespondWith::ClassMethods
  # Clear all mime types in <tt>respond_to</tt>.
  #
  # source://responders-3.2.0/lib/action_controller/respond_with.rb:57
  ...
  # to <tt>:json</tt>.
  #
  # source://responders-3.2.0/lib/action_controller/respond_with.rb:39
...
#
# source://responders-3.2.0/lib/action_controller/responder.rb:122
class ActionController::Responder
  # @return [Responder] a new instance of Responder
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:134
  def initialize(controller, resources, options = T.unsafe(nil)); end

  # Returns the value of attribute controller.
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:126
  def controller; end

  # source://responders-3.2.0/lib/action_controller/responder.rb:151
  ...
  # source://responders-3.2.0/lib/action_controller/responder.rb:150
  ...
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:166
  def respond; end
  ...
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:189
  def to_format; end

  # HTML format does not render the resource, it always attempt to render a
  # template.
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:174
  def to_html; end

  # to_js simply tries to render a template. If no template is found, raises the error.
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:181
  def to_js; end
  ...
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:215
  def api_behavior; end

  # Returns the resource location by retrieving it from the options or
  # returning the resources array.
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:230
  def api_location; end

  # By default, render the <code>:edit</code> action for HTML requests with errors, unless
  # the verb was POST.
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:294
  def default_action; end

  # If a response block was given, use it, otherwise call render on
  # controller.
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:239
  ...
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:266
  def display(resource, given_options = T.unsafe(nil)); end

  # source://responders-3.2.0/lib/action_controller/responder.rb:270
  def display_errors; end

  # source://responders-3.2.0/lib/action_controller/responder.rb:310
  ...
  # @return [Boolean]
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:278
  def has_errors?; end
  ...
  # @return [Boolean]
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:283
  def has_renderer?; end

  # @return [Boolean]
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:287
  def has_view_rendering?; end

  # source://responders-3.2.0/lib/action_controller/responder.rb:302
  def json_resource_errors; end

  # This is the common behavior for formats associated with browsing, like :html, :iphone and so forth.
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:204
  ...
  # source://responders-3.2.0/lib/action_controller/responder.rb:298
  ...
  # @return [Boolean]
  #
  # source://responders-3.2.0/lib/action_controller/responder.rb:306
  ...
  class << self
    ...
    #
    # source://responders-3.2.0/lib/action_controller/responder.rb:160
    def call(*args); end
...
module Responders::CollectionResponder
  ...
  #
  # source://responders-3.2.0/lib/responders/collection_responder.rb:21
  def navigation_location; end
end

# source://responders-3.2.0/lib/responders/controller_method.rb:4
module Responders::ControllerMethod
  ...
  #
  # source://responders-3.2.0/lib/responders/controller_method.rb:21
...
# and :alert.
#
# source://responders-3.2.0/lib/responders/flash_responder.rb:87
module Responders::FlashResponder
  # source://responders-3.2.0/lib/responders/flash_responder.rb:95
  def initialize(controller, resources, options = T.unsafe(nil)); end

  # source://responders-3.2.0/lib/responders/flash_responder.rb:103
  def to_html; end

  # source://responders-3.2.0/lib/responders/flash_responder.rb:108
  def to_js; end

  protected

  # source://responders-3.2.0/lib/responders/flash_responder.rb:162
  def controller_interpolation_options; end

  # source://responders-3.2.0/lib/responders/flash_responder.rb:174
  def flash_defaults_by_namespace(status); end

  # source://responders-3.2.0/lib/responders/flash_responder.rb:147
  def mount_i18n_options(status); end

  # source://responders-3.2.0/lib/responders/flash_responder.rb:166
  def resource_name; end

  # source://responders-3.2.0/lib/responders/flash_responder.rb:131
  def set_flash(key, value); end

  # source://responders-3.2.0/lib/responders/flash_responder.rb:115
  def set_flash_message!; end

  # @return [Boolean]
  #
  # source://responders-3.2.0/lib/responders/flash_responder.rb:143
  def set_flash_message?; end

  # @return [Boolean]
  #
  # source://responders-3.2.0/lib/responders/flash_responder.rb:138
  def set_flash_now?; end

  class << self
    # Returns the value of attribute flash_keys.
    #
    # source://responders-3.2.0/lib/responders/flash_responder.rb:89
    def flash_keys; end
...
#
# source://responders-3.2.0/lib/responders/http_cache_responder.rb:13
module Responders::HttpCacheResponder
  # source://responders-3.2.0/lib/responders/http_cache_responder.rb:14
  def initialize(controller, resources, options = T.unsafe(nil)); end

  # source://responders-3.2.0/lib/responders/http_cache_responder.rb:19
  def to_format; end

  protected

  # source://responders-3.2.0/lib/responders/http_cache_responder.rb:26
  def do_http_cache!; end

  # @return [Boolean]
  #
  # source://responders-3.2.0/lib/responders/http_cache_responder.rb:37
  def do_http_cache?; end

  # @return [Boolean]
  #
  # source://responders-3.2.0/lib/responders/http_cache_responder.rb:42
  def persisted?; end
end

# source://responders-3.2.0/lib/responders.rb:18
