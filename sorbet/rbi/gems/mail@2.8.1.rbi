...
# source://mail-2.8.1/lib/mail.rb:3
module Mail
  class << self
...
#
# source://mail-2.8.1/lib/mail/elements/address.rb:24
class Mail::Address
...
# source://mail-2.8.1/lib/mail/fields/common_address_field.rb:6
class Mail::AddressContainer < ::Array
  # @return [AddressContainer] a new instance of AddressContainer
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:7
  def initialize(field, list = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:12
  def <<(address); end
end

# source://mail-2.8.1/lib/mail/elements/address_list.rb:6
class Mail::AddressList
  ...
  #
  # source://mail-2.8.1/lib/mail/elements/address_list.rb:24
  def initialize(string); end

  # Returns the value of attribute addresses.
  #
  # source://mail-2.8.1/lib/mail/elements/address_list.rb:7
  def addresses; end

  # source://mail-2.8.1/lib/mail/elements/address_list.rb:30
...
# source://mail-2.8.1/lib/mail/attachments_list.rb:3
class Mail::AttachmentsList < ::Array
  # @return [AttachmentsList] a new instance of AttachmentsList
  #
  # source://mail-2.8.1/lib/mail/attachments_list.rb:5
  ...
  #
  # source://mail-2.8.1/lib/mail/attachments_list.rb:32
  def [](index_value); end

  # source://mail-2.8.1/lib/mail/attachments_list.rb:40
  def []=(name, value); end
  ...
  #
  # source://mail-2.8.1/lib/mail/attachments_list.rb:91
  def guess_encoding; end

  # source://mail-2.8.1/lib/mail/attachments_list.rb:20
  def inline; end

  # source://mail-2.8.1/lib/mail/attachments_list.rb:99
...
# source://mail-2.8.1/lib/mail/fields/bcc_field.rb:32
...
#
# source://mail-2.8.1/lib/mail/body.rb:28
class Mail::Body
  # @return [Body] a new instance of Body
  #
  # source://mail-2.8.1/lib/mail/body.rb:30
  def initialize(string = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/body.rb:233
  def <<(val); end
  ...
  #   body == "The body" #=> true
  #
  # source://mail-2.8.1/lib/mail/body.rb:72
  def ==(other); end
  ...
  #   body =~ /The/ #=> 0
  #
  # source://mail-2.8.1/lib/mail/body.rb:90
  def =~(regexp); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/body.rb:253
  def ascii_only?; end

  # Returns and sets the boundary used by the body
  # Allows you to change the boundary of this Body object
  #
  # source://mail-2.8.1/lib/mail/body.rb:226
  def boundary; end
  ...
  #
  # source://mail-2.8.1/lib/mail/body.rb:216
  def charset; end
  ...
  # source://mail-2.8.1/lib/mail/body.rb:179
  def decoded; end

  # source://mail-2.8.1/lib/mail/body.rb:264
  def default_encoding; end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/body.rb:260
  def empty?; end
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/body.rb:118
  def include?(other); end

  # source://mail-2.8.1/lib/mail/body.rb:53
  ...
  #   body.match(/The/) #=> #<MatchData "The">
  #
  # source://mail-2.8.1/lib/mail/body.rb:104
  ...
  # any tampering
  #
  # source://mail-2.8.1/lib/mail/body.rb:210
  def raw_source; end
  ...
  #
  # source://mail-2.8.1/lib/mail/body.rb:125
  ...
  #
  # source://mail-2.8.1/lib/mail/body.rb:133
  def sort_parts!; end

  # source://mail-2.8.1/lib/mail/body.rb:241
  def split!(boundary); end

  # source://mail-2.8.1/lib/mail/body.rb:187
  def to_s; end

  private

  # source://mail-2.8.1/lib/mail/body.rb:293
  def crlf_boundary; end

  # source://mail-2.8.1/lib/mail/body.rb:297
  ...
  #
  # source://mail-2.8.1/lib/mail/body.rb:271
  def extract_parts; end

  # source://mail-2.8.1/lib/mail/body.rb:301
  def set_charset; end
end
...
#
# source://mail-2.8.1/lib/mail/fields/cc_field.rb:31
class Mail::CcField < ::Mail::CommonAddressField; end

# source://mail-2.8.1/lib/mail/fields/cc_field.rb:32
Mail::CcField::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/check_delivery_params.rb:5
module Mail::CheckDeliveryParams
  class << self
    # source://mail-2.8.1/lib/mail/check_delivery_params.rb:10
    def _deprecated_check(mail); end

    # source://mail-2.8.1/lib/mail/check_delivery_params.rb:32
    def _deprecated_check_addr(addr_name, addr); end

    # source://mail-2.8.1/lib/mail/check_delivery_params.rb:18
    def _deprecated_check_from(addr); end

    # source://mail-2.8.1/lib/mail/check_delivery_params.rb:53
    def _deprecated_check_message(message); end

    # source://mail-2.8.1/lib/mail/check_delivery_params.rb:24
    def _deprecated_check_to(addrs); end

    # source://mail-2.8.1/lib/mail/check_delivery_params.rb:38
...
#
# source://mail-2.8.1/lib/mail/fields/comments_field.rb:29
class Mail::CommentsField < ::Mail::NamedUnstructuredField; end

# source://mail-2.8.1/lib/mail/fields/comments_field.rb:30
Mail::CommentsField::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/fields/common_address_field.rb:17
class Mail::CommonAddressField < ::Mail::NamedStructuredField
  # @return [CommonAddressField] a new instance of CommonAddressField
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:22
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:94
  def <<(val); end

  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:41
  def address; end

  # Returns the address string of all the addresses in the address list
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:46
  def addresses; end

  # Returns the actual address objects in the address list
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:64
  def addrs; end

  # Returns a list of decoded group addresses
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:80
  def decoded_group_addresses; end

  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:37
  def default; end

  # Returns the display name of all the addresses in the address list
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:58
  def display_names; end

  # Allows you to iterate through each address object in the address_list
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:31
  def each; end

  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:26
  def element; end

  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:105
  def encode_if_needed(val, val_charset = T.unsafe(nil)); end

  # Returns a list of encoded group addresses
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:85
  def encoded_group_addresses; end

  # Returns the formatted string of all the addresses in the address list
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:52
  def formatted; end

  # Returns the addresses that are part of groups
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:75
  def group_addresses; end

  # Returns the name of all the groups in a string
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:90
  def group_names; end

  # Returns a hash of group name => address strings for the address list
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:70
  def groups; end

  private

  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:150
  def do_decode; end

  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:140
  def do_encode; end

  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:160
  def get_group_addresses(group_list); end

  # Pass through UTF-8 addresses
  #
  # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:123
  def utf8_if_needed(val, val_charset); end

  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/common_address_field.rb:18
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/common_date_field.rb:6
class Mail::CommonDateField < ::Mail::NamedStructuredField
  # @return [CommonDateField] a new instance of CommonDateField
  #
  # source://mail-2.8.1/lib/mail/fields/common_date_field.rb:30
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end

  # Returns a date time object of the parsed date
  #
  # source://mail-2.8.1/lib/mail/fields/common_date_field.rb:35
  def date_time; end

  # source://mail-2.8.1/lib/mail/fields/common_date_field.rb:41
  def default; end

  # source://mail-2.8.1/lib/mail/fields/common_date_field.rb:45
  def element; end

  private

  # source://mail-2.8.1/lib/mail/fields/common_date_field.rb:54
  def do_decode; end

  # source://mail-2.8.1/lib/mail/fields/common_date_field.rb:50
  def do_encode; end

  class << self
    # source://mail-2.8.1/lib/mail/fields/common_date_field.rb:11
    def normalize_datetime(string); end

    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/common_date_field.rb:7
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/common_field.rb:6
class Mail::CommonField
  # @return [CommonField] a new instance of CommonField
  #
  # source://mail-2.8.1/lib/mail/fields/common_field.rb:20
  def initialize(name = T.unsafe(nil), value = T.unsafe(nil), charset = T.unsafe(nil)); end

  # Returns the value of attribute charset.
  #
  # source://mail-2.8.1/lib/mail/fields/common_field.rb:17
  def charset; end
  ...
  # source://mail-2.8.1/lib/mail/fields/common_field.rb:54
  def decoded; end

  # source://mail-2.8.1/lib/mail/fields/common_field.rb:50
  def default; end

  # source://mail-2.8.1/lib/mail/fields/common_field.rb:42
  def element; end

  # source://mail-2.8.1/lib/mail/fields/common_field.rb:58
  def encoded; end

  # Returns the value of attribute errors.
  #
  # source://mail-2.8.1/lib/mail/fields/common_field.rb:18
  def errors; end

  # Returns the value of attribute name.
  #
  # source://mail-2.8.1/lib/mail/fields/common_field.rb:15
  def name; end
  ...
  # source://mail-2.8.1/lib/mail/fields/common_field.rb:38
  def parse; end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/fields/common_field.rb:62
  def responsible_for?(field_name); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/fields/common_field.rb:28
  def singular?; end

  # source://mail-2.8.1/lib/mail/fields/common_field.rb:46
  def to_s; end

  # Returns the value of attribute value.
  #
  # source://mail-2.8.1/lib/mail/fields/common_field.rb:16
  def value; end

  # source://mail-2.8.1/lib/mail/fields/common_field.rb:32
  def value=(value); end

  private

  # source://mail-2.8.1/lib/mail/fields/common_field.rb:69
  def ensure_filename_quoted(value); end

  class << self
    # source://mail-2.8.1/lib/mail/fields/common_field.rb:11
    def parse(*args); end

    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/common_field.rb:7
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/common_field.rb:68
Mail::CommonField::FILENAME_RE = T.let(T.unsafe(nil), Regexp)

# source://mail-2.8.1/lib/mail/fields/common_message_id_field.rb:7
class Mail::CommonMessageIdField < ::Mail::NamedStructuredField
  # source://mail-2.8.1/lib/mail/fields/common_message_id_field.rb:20
  def default; end

  # source://mail-2.8.1/lib/mail/fields/common_message_id_field.rb:8
  def element; end

  # source://mail-2.8.1/lib/mail/fields/common_message_id_field.rb:12
  def message_id; end

  # source://mail-2.8.1/lib/mail/fields/common_message_id_field.rb:16
  def message_ids; end

  # source://mail-2.8.1/lib/mail/fields/common_message_id_field.rb:25
  def to_s; end

  private

  # source://mail-2.8.1/lib/mail/fields/common_message_id_field.rb:34
  def do_decode; end

  # source://mail-2.8.1/lib/mail/fields/common_message_id_field.rb:30
  def do_encode; end

  # source://mail-2.8.1/lib/mail/fields/common_message_id_field.rb:38
...
#
# source://mail-2.8.1/lib/mail/configuration.rb:15
...
class Mail::ContentDispositionElement
  ...
  # source://mail-2.8.1/lib/mail/elements/content_disposition_element.rb:16
  def cleaned(string); end
end

# source://mail-2.8.1/lib/mail/fields/content_disposition_field.rb:7
class Mail::ContentDispositionField < ::Mail::NamedStructuredField
  ...
  #
  # source://mail-2.8.1/lib/mail/fields/content_disposition_field.rb:14
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/fields/content_disposition_field.rb:41
  def decoded; end

  # source://mail-2.8.1/lib/mail/fields/content_disposition_field.rb:22
  def disposition_type; end

  # source://mail-2.8.1/lib/mail/fields/content_disposition_field.rb:18
  def element; end

  # source://mail-2.8.1/lib/mail/fields/content_disposition_field.rb:36
  def encoded; end

  # source://mail-2.8.1/lib/mail/fields/content_disposition_field.rb:32
  def filename; end

  # source://mail-2.8.1/lib/mail/fields/content_disposition_field.rb:26
  def parameters; end

  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/content_disposition_field.rb:10
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/content_disposition_field.rb:8
Mail::ContentDispositionField::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/fields/content_id_field.rb:7
class Mail::ContentIdField < ::Mail::NamedStructuredField
  # @return [ContentIdField] a new instance of ContentIdField
  #
  # source://mail-2.8.1/lib/mail/fields/content_id_field.rb:14
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/fields/content_id_field.rb:23
  def content_id; end

  # source://mail-2.8.1/lib/mail/fields/content_id_field.rb:19
  def element; end

  private

  # source://mail-2.8.1/lib/mail/fields/content_id_field.rb:28
  def do_decode; end

  # source://mail-2.8.1/lib/mail/fields/content_id_field.rb:32
  def do_encode; end

  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/content_id_field.rb:10
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/content_id_field.rb:8
Mail::ContentIdField::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/elements/content_location_element.rb:6
class Mail::ContentLocationElement
  # @return [ContentLocationElement] a new instance of ContentLocationElement
  #
  # source://mail-2.8.1/lib/mail/elements/content_location_element.rb:9
  def initialize(string); end

  # Returns the value of attribute location.
  #
  # source://mail-2.8.1/lib/mail/elements/content_location_element.rb:7
  def location; end

  # source://mail-2.8.1/lib/mail/elements/content_location_element.rb:13
  def to_s(*args); end
end

# source://mail-2.8.1/lib/mail/fields/content_location_field.rb:6
class Mail::ContentLocationField < ::Mail::NamedStructuredField
  # source://mail-2.8.1/lib/mail/fields/content_location_field.rb:25
  def decoded; end

  # source://mail-2.8.1/lib/mail/fields/content_location_field.rb:13
  def element; end

  # source://mail-2.8.1/lib/mail/fields/content_location_field.rb:21
  def encoded; end

  # source://mail-2.8.1/lib/mail/fields/content_location_field.rb:17
  def location; end

  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/content_location_field.rb:9
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/content_location_field.rb:7
Mail::ContentLocationField::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/elements/content_transfer_encoding_element.rb:6
class Mail::ContentTransferEncodingElement
  ...
  #
  # source://mail-2.8.1/lib/mail/elements/content_transfer_encoding_element.rb:9
  def initialize(string); end

  # Returns the value of attribute encoding.
  #
  # source://mail-2.8.1/lib/mail/elements/content_transfer_encoding_element.rb:7
  def encoding; end
end

# source://mail-2.8.1/lib/mail/fields/content_transfer_encoding_field.rb:6
class Mail::ContentTransferEncodingField < ::Mail::NamedStructuredField
  ...
  #
  # source://mail-2.8.1/lib/mail/fields/content_transfer_encoding_field.rb:24
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/fields/content_transfer_encoding_field.rb:28
  def element; end

  # source://mail-2.8.1/lib/mail/fields/content_transfer_encoding_field.rb:32
  def encoding; end

  private

  # source://mail-2.8.1/lib/mail/fields/content_transfer_encoding_field.rb:41
  def do_decode; end

  # source://mail-2.8.1/lib/mail/fields/content_transfer_encoding_field.rb:37
  def do_encode; end

  class << self
    # source://mail-2.8.1/lib/mail/fields/content_transfer_encoding_field.rb:13
    def normalize_content_transfer_encoding(value); end

    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/content_transfer_encoding_field.rb:9
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/content_transfer_encoding_field.rb:7
Mail::ContentTransferEncodingField::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/elements/content_type_element.rb:6
class Mail::ContentTypeElement
  # @return [ContentTypeElement] a new instance of ContentTypeElement
  #
  # source://mail-2.8.1/lib/mail/elements/content_type_element.rb:9
  def initialize(string); end

  # Returns the value of attribute main_type.
  #
  # source://mail-2.8.1/lib/mail/elements/content_type_element.rb:7
  def main_type; end
  ...
  # source://mail-2.8.1/lib/mail/elements/content_type_element.rb:17
  def cleaned(string); end
end

# source://mail-2.8.1/lib/mail/fields/content_type_field.rb:7
class Mail::ContentTypeField < ::Mail::NamedStructuredField
  # @return [ContentTypeField] a new instance of ContentTypeField
  #
  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:24
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:47
  def attempt_to_clean; end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:63
  def content_type; end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:101
  def decoded; end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:68
  def default; end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:38
  def element; end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:96
  def encoded; end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:92
  def filename; end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:55
  def main_type; end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:72
  def parameters; end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:63
  def string; end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:88
  def stringify(params); end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:59
  def sub_type; end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:80
  def value; end

  private

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:163
  def get_mime_type(val); end

  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:108
  def method_missing(name, *args, &block); end

  # Various special cases from random emails found that I am not going to change
  # the parser for
  #
  # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:119
  def sanitize(val); end

  class << self
    # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:19
    def generate_boundary; end

    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:11
    def singular?; end

    # source://mail-2.8.1/lib/mail/fields/content_type_field.rb:15
    def with_boundary(type); end
  end
end

# source://mail-2.8.1/lib/mail/fields/content_type_field.rb:8
...
#  mail['Date']    #=> '#<Mail::Field:0x180e5e8 @field=#<Mail::DateField:0x180e1c4
#
# source://mail-2.8.1/lib/mail/fields/date_field.rb:26
class Mail::DateField < ::Mail::CommonDateField; end

# source://mail-2.8.1/lib/mail/fields/date_field.rb:27
Mail::DateField::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/elements/date_time_element.rb:6
class Mail::DateTimeElement
  # @return [DateTimeElement] a new instance of DateTimeElement
  #
  # source://mail-2.8.1/lib/mail/elements/date_time_element.rb:9
  def initialize(string); end

  # Returns the value of attribute date_string.
  #
  # source://mail-2.8.1/lib/mail/elements/date_time_element.rb:7
  def date_string; end
...
# source://mail-2.8.1/lib/mail/encodings.rb:9
module Mail::Encodings
  include ::Mail::Constants
  extend ::Mail::Utilities

  class << self
    # source://mail-2.8.1/lib/mail/encodings.rb:162
    ...
    #  #=> 'This is あ string'
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:234
    ...
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:199
    ...
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:258
    ...
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:105
    ...
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:293
    def each_chunk_byterange(str, max_bytesize_per_chunk); end

    # source://mail-2.8.1/lib/mail/encodings.rb:170
    def encode_non_usascii(address, charset); end

    # source://mail-2.8.1/lib/mail/encodings.rb:45
    def get_all; end
    ...
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:41
    def get_encoding(name); end

    # source://mail-2.8.1/lib/mail/encodings.rb:49
    ...
    #  str #=> "This is fun"
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:93
    ...
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:73
    ...
    #  #=> 'This is あ string'
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:244
    ...
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:217
    ...
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:20
    def register(name, cls); end

    # source://mail-2.8.1/lib/mail/encodings.rb:53
    def transcode_charset(str, from_charset, to_charset = T.unsafe(nil)); end

    # Takes an encoded string of the format =?<encoding>?[QB]?<string>?=
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:140
    ...
    # String has to be of the format =?<encoding>?[QB]?<string>?=
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:122
    def value_decode(str); end

    # Gets the encoding type (Q or B) from the string.
    #
    # source://mail-2.8.1/lib/mail/encodings.rb:249
...
# per input byte.
#
# source://mail-2.8.1/lib/mail/encodings/base64.rb:9
class Mail::Encodings::Base64 < ::Mail::Encodings::SevenBit
  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/encodings/base64.rb:14
    ...
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/encodings/base64.rb:33
    def compatible_input?(str); end

    # 3 bytes in -> 4 bytes out
    #
    # source://mail-2.8.1/lib/mail/encodings/base64.rb:27
    def cost(str); end

    # source://mail-2.8.1/lib/mail/encodings/base64.rb:18
    def decode(str); end

    # source://mail-2.8.1/lib/mail/encodings/base64.rb:22
    def encode(str); end
  end
end

# source://mail-2.8.1/lib/mail/encodings/base64.rb:10
Mail::Encodings::Base64::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/encodings/base64.rb:11
Mail::Encodings::Base64::PRIORITY = T.let(T.unsafe(nil), Integer)

# source://mail-2.8.1/lib/mail/encodings/binary.rb:7
class Mail::Encodings::Binary < ::Mail::Encodings::Identity; end

# source://mail-2.8.1/lib/mail/encodings/binary.rb:8
Mail::Encodings::Binary::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/encodings/binary.rb:9
Mail::Encodings::Binary::PRIORITY = T.let(T.unsafe(nil), Integer)

# source://mail-2.8.1/lib/mail/encodings/8bit.rb:7
class Mail::Encodings::EightBit < ::Mail::Encodings::Binary
  class << self
    ...
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/encodings/8bit.rb:13
    def compatible_input?(str); end
  end
end

# source://mail-2.8.1/lib/mail/encodings/8bit.rb:8
Mail::Encodings::EightBit::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/encodings/8bit.rb:9
...
#
# source://mail-2.8.1/lib/mail/encodings/identity.rb:9
class Mail::Encodings::Identity < ::Mail::Encodings::TransferEncoding
  class << self
    # 1 output byte per input byte.
    #
    # source://mail-2.8.1/lib/mail/encodings/identity.rb:19
    def cost(str); end

    # source://mail-2.8.1/lib/mail/encodings/identity.rb:10
    def decode(str); end

    # source://mail-2.8.1/lib/mail/encodings/identity.rb:14
    def encode(str); end
  end
end

# source://mail-2.8.1/lib/mail/encodings/quoted_printable.rb:7
class Mail::Encodings::QuotedPrintable < ::Mail::Encodings::SevenBit
  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/encodings/quoted_printable.rb:12
    def can_encode?(enc); end
    ...
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/encodings/quoted_printable.rb:36
    def compatible_input?(str); end

    # source://mail-2.8.1/lib/mail/encodings/quoted_printable.rb:26
    def cost(str); end

    # Decode the string from Quoted-Printable. Cope with hard line breaks
    # that were incorrectly encoded as hex instead of literal CRLF.
    #
    # source://mail-2.8.1/lib/mail/encodings/quoted_printable.rb:18
    def decode(str); end

    # source://mail-2.8.1/lib/mail/encodings/quoted_printable.rb:22
    def encode(str); end
  end
end

# source://mail-2.8.1/lib/mail/encodings/quoted_printable.rb:8
Mail::Encodings::QuotedPrintable::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/encodings/quoted_printable.rb:10
...
#
# source://mail-2.8.1/lib/mail/encodings/7bit.rb:8
class Mail::Encodings::SevenBit < ::Mail::Encodings::EightBit
  class << self
    ...
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/encodings/7bit.rb:22
    def compatible_input?(str); end

    # source://mail-2.8.1/lib/mail/encodings/7bit.rb:13
    def decode(str); end

    # source://mail-2.8.1/lib/mail/encodings/7bit.rb:17
    def encode(str); end
  end
end

# source://mail-2.8.1/lib/mail/encodings/7bit.rb:9
Mail::Encodings::SevenBit::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/encodings/7bit.rb:10
Mail::Encodings::SevenBit::PRIORITY = T.let(T.unsafe(nil), Integer)

# source://mail-2.8.1/lib/mail/encodings/transfer_encoding.rb:5
class Mail::Encodings::TransferEncoding
  class << self
    ...
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/encodings/transfer_encoding.rb:19
    def can_encode?(enc); end
    ...
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/encodings/transfer_encoding.rb:12
    def can_transport?(enc); end

    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/encodings/transfer_encoding.rb:27
    def compatible_input?(str); end

    # source://mail-2.8.1/lib/mail/encodings/transfer_encoding.rb:23
    def cost(str); end

    # source://mail-2.8.1/lib/mail/encodings/transfer_encoding.rb:56
    def lowest_cost(str, encodings); end

    # source://mail-2.8.1/lib/mail/encodings/transfer_encoding.rb:35
    def negotiate(message_encoding, source_encoding, str, allowed_encodings = T.unsafe(nil)); end

    # source://mail-2.8.1/lib/mail/encodings/transfer_encoding.rb:46
    def renegotiate(message_encoding, source_encoding, str, allowed_encodings = T.unsafe(nil)); end

    # source://mail-2.8.1/lib/mail/encodings/transfer_encoding.rb:31
    def to_s; end
  end
end

# source://mail-2.8.1/lib/mail/encodings/transfer_encoding.rb:6
Mail::Encodings::TransferEncoding::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/encodings/transfer_encoding.rb:8
Mail::Encodings::TransferEncoding::PRIORITY = T.let(T.unsafe(nil), Integer)

# source://mail-2.8.1/lib/mail/encodings/unix_to_unix.rb:4
class Mail::Encodings::UnixToUnix < ::Mail::Encodings::TransferEncoding
  class << self
    # source://mail-2.8.1/lib/mail/encodings/unix_to_unix.rb:7
    def decode(str); end

    # source://mail-2.8.1/lib/mail/encodings/unix_to_unix.rb:11
    def encode(str); end
  end
end

# source://mail-2.8.1/lib/mail/encodings/unix_to_unix.rb:5
Mail::Encodings::UnixToUnix::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/envelope.rb:13
class Mail::Envelope < ::Mail::NamedStructuredField
  # source://mail-2.8.1/lib/mail/envelope.rb:24
  def date; end

  # source://mail-2.8.1/lib/mail/envelope.rb:16
  def element; end

  # source://mail-2.8.1/lib/mail/envelope.rb:20
  def from; end
end

# source://mail-2.8.1/lib/mail/envelope.rb:14
Mail::Envelope::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/elements/envelope_from_element.rb:7
class Mail::EnvelopeFromElement
  # @return [EnvelopeFromElement] a new instance of EnvelopeFromElement
  #
  # source://mail-2.8.1/lib/mail/elements/envelope_from_element.rb:10
  def initialize(string); end

  # Returns the value of attribute address.
  #
  # source://mail-2.8.1/lib/mail/elements/envelope_from_element.rb:8
  def address; end
  ...
  #
  # source://mail-2.8.1/lib/mail/elements/envelope_from_element.rb:21
  def formatted_date_time; end

  # source://mail-2.8.1/lib/mail/elements/envelope_from_element.rb:31
  def to_s; end
end
...
#   mail.deliver!
#
# source://mail-2.8.1/lib/mail/network/delivery_methods/exim.rb:39
class Mail::Exim < ::Mail::Sendmail
  # Uses -t option to extract recipients from the message.
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/exim.rb:46
  def destinations_for(envelope); end
end

# source://mail-2.8.1/lib/mail/network/delivery_methods/exim.rb:40
...
#
# source://mail-2.8.1/lib/mail/field.rb:25
class Mail::Field
  include ::Comparable
  ...
  #
  # source://mail-2.8.1/lib/mail/field.rb:166
  def initialize(name, value = T.unsafe(nil), charset = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/field.rb:224
  def <=>(other); end

  # source://mail-2.8.1/lib/mail/field.rb:216
  def ==(other); end

  # source://mail-2.8.1/lib/mail/field.rb:186
  def field; end

  # source://mail-2.8.1/lib/mail/field.rb:182
  def field=(field); end

  # source://mail-2.8.1/lib/mail/field.rb:228
  def field_order_id; end

  # source://mail-2.8.1/lib/mail/field.rb:206
  def inspect; end

  # source://mail-2.8.1/lib/mail/field.rb:232
  def method_missing(name, *args, &block); end

  # source://mail-2.8.1/lib/mail/field.rb:190
  def name; end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/field.rb:220
  def responsible_for?(field_name); end

  # source://mail-2.8.1/lib/mail/field.rb:212
  def same(other); end

  # source://mail-2.8.1/lib/mail/field.rb:202
  def to_s; end

  # Returns the value of attribute unparsed_value.
  #
  # source://mail-2.8.1/lib/mail/field.rb:152
  def unparsed_value; end

  # source://mail-2.8.1/lib/mail/field.rb:194
  def value; end

  # source://mail-2.8.1/lib/mail/field.rb:198
  def value=(val); end

  private

  # source://mail-2.8.1/lib/mail/field.rb:253
  def create_field(name, value, charset); end

  # source://mail-2.8.1/lib/mail/field.rb:261
  def parse_field(name, value, charset); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/field.rb:236
  ...
  #  evaluation.
  #
  # source://mail-2.8.1/lib/mail/field.rb:279
  def unfold(string); end

  class << self
    # source://mail-2.8.1/lib/mail/field.rb:147
    ...
    #  # => #<Mail::Field …>
    #
    # source://mail-2.8.1/lib/mail/field.rb:122
    def parse(field, charset = T.unsafe(nil)); end

    # source://mail-2.8.1/lib/mail/field.rb:129
    def split(raw_field); end
  end
end

# source://mail-2.8.1/lib/mail/field.rb:38
Mail::Field::FIELDS_MAP = T.let(T.unsafe(nil), Hash)

# source://mail-2.8.1/lib/mail/field.rb:70
Mail::Field::FIELD_NAME_MAP = T.let(T.unsafe(nil), Hash)

# source://mail-2.8.1/lib/mail/field.rb:240
Mail::Field::FIELD_ORDER_LOOKUP = T.let(T.unsafe(nil), Hash)

# Generic Field Exception
#
# source://mail-2.8.1/lib/mail/field.rb:75
class Mail::Field::FieldError < ::StandardError; end

# source://mail-2.8.1/lib/mail/field.rb:106
...
#
# source://mail-2.8.1/lib/mail/field.rb:80
class Mail::Field::ParseError < ::Mail::Field::FieldError
  # @return [ParseError] a new instance of ParseError
  #
  # source://mail-2.8.1/lib/mail/field.rb:83
  def initialize(element, value, reason); end

  # source://mail-2.8.1/lib/mail/field.rb:81
  def element; end
  ...
  # source://mail-2.8.1/lib/mail/field.rb:91
  def to_utf8(text); end
end

# source://mail-2.8.1/lib/mail/field.rb:28
...
#
# source://mail-2.8.1/lib/mail/field.rb:114
...
#
# source://mail-2.8.1/lib/mail/field_list.rb:8
class Mail::FieldList < ::Array
  # source://mail-2.8.1/lib/mail/field_list.rb:22
  def <<(field); end

  # source://mail-2.8.1/lib/mail/field_list.rb:22
  def add_field(field); end

  # source://mail-2.8.1/lib/mail/field_list.rb:60
  def delete_field(name); end

  # source://mail-2.8.1/lib/mail/field_list.rb:13
  def get_field(field_name); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/field_list.rb:9
  def has_field?(field_name); end

  # source://mail-2.8.1/lib/mail/field_list.rb:46
  def insert_field(field); end

  # source://mail-2.8.1/lib/mail/field_list.rb:31
  def replace_field(field); end

  # source://mail-2.8.1/lib/mail/field_list.rb:64
  def summary; end

  private

  # source://mail-2.8.1/lib/mail/field_list.rb:70
  def select_fields(field_name); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/field_list.rb:79
...
# running Mail.
#
# source://mail-2.8.1/lib/mail/network/delivery_methods/file_delivery.rb:15
class Mail::FileDelivery
  # @return [FileDelivery] a new instance of FileDelivery
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/file_delivery.rb:20
  def initialize(values); end

  # source://mail-2.8.1/lib/mail/network/delivery_methods/file_delivery.rb:24
  def deliver!(mail); end

  # Returns the value of attribute settings.
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/file_delivery.rb:18
  def settings; end
...
#
# source://mail-2.8.1/lib/mail/fields/from_field.rb:31
class Mail::FromField < ::Mail::CommonAddressField; end

# source://mail-2.8.1/lib/mail/fields/from_field.rb:32
...
#   sections 3 and 4 of this standard.
#
# source://mail-2.8.1/lib/mail/header.rb:22
class Mail::Header
  include ::Enumerable
  ...
  #
  # source://mail-2.8.1/lib/mail/header.rb:53
  ...
  #  h['X-Mail-SPAM'] #=> ['15', '20']
  #
  # source://mail-2.8.1/lib/mail/header.rb:130
  def [](name); end
  ...
  #  h['X-Mail-SPAM'] # => nil
  #
  # source://mail-2.8.1/lib/mail/header.rb:147
  def []=(name, value); end

  # Returns the value of attribute charset.
  #
  # source://mail-2.8.1/lib/mail/header.rb:39
  def charset; end

  # source://mail-2.8.1/lib/mail/header.rb:169
  def charset=(val); end

  # @raise [NoMethodError]
  #
  # source://mail-2.8.1/lib/mail/header.rb:195
  def decoded; end

  # source://mail-2.8.1/lib/mail/header.rb:182
  def encoded; end

  # source://mail-2.8.1/lib/mail/header.rb:105
  def errors; end

  # source://mail-2.8.1/lib/mail/header.rb:199
  def field_summary; end

  # Returns an array of all the fields in the header in order that they
  # were read in.
  #
  # source://mail-2.8.1/lib/mail/header.rb:67
  def fields; end
  ...
  #
  # source://mail-2.8.1/lib/mail/header.rb:90
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/header.rb:209
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/header.rb:214
  def has_date?; end
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/header.rb:204
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/header.rb:219
  ...
  # source://mail-2.8.1/lib/mail/header.rb:191
  def to_s; end
  ...
  #
  # source://mail-2.8.1/lib/mail/header.rb:233
  def each(&block); end

  # source://mail-2.8.1/lib/mail/header.rb:59
  def initialize_copy(original); end

  # Splits an unfolded and line break cleaned header into individual field
  # strings.
  #
  # source://mail-2.8.1/lib/mail/header.rb:227
  ...
  class << self
    ...
    # Default: 1000
    #
    # source://mail-2.8.1/lib/mail/header.rb:31
    def maximum_amount; end

    # source://mail-2.8.1/lib/mail/header.rb:35
...
#
# source://mail-2.8.1/lib/mail/network/retriever_methods/imap.rb:39
class Mail::IMAP < ::Mail::Retriever
  # @return [IMAP] a new instance of IMAP
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/imap.rb:42
  def initialize(values); end
  ...
  # @raise [ArgumentError]
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/imap.rb:133
  def connection(&block); end

  # Delete all emails from a IMAP mailbox
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/imap.rb:119
  ...
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/imap.rb:73
  def find(options = T.unsafe(nil), &block); end

  # Returns the value of attribute settings.
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/imap.rb:52
  def settings; end
  ...
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/imap.rb:160
  def start(config = T.unsafe(nil), &block); end

  # Set default options
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/imap.rb:144
...
#
# source://mail-2.8.1/lib/mail/fields/in_reply_to_field.rb:31
class Mail::InReplyToField < ::Mail::CommonMessageIdField
  # @return [InReplyToField] a new instance of InReplyToField
  #
  # source://mail-2.8.1/lib/mail/fields/in_reply_to_field.rb:38
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end

  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/in_reply_to_field.rb:34
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/in_reply_to_field.rb:32
Mail::InReplyToField::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/indifferent_hash.rb:8
class Mail::IndifferentHash < ::Hash
  # @return [IndifferentHash] a new instance of IndifferentHash
  #
  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:10
  ...
  #   hash[:key] = "value"
  #
  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:41
  def []=(key, value); end

  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:19
  def default(key = T.unsafe(nil)); end

  # Removes a specified key from the hash.
  #
  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:117
  def delete(key); end

  # Returns an exact copy of the hash.
  #
  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:96
  def dup; end

  # Fetches the value for the specified key, same as doing hash[key]
  #
  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:80
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:71
  def has_key?(key); end
  ...
  #
  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:102
  def merge(hash); end
  ...
  #
  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:57
  ...
  #
  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:108
  def reverse_merge(other_hash); end

  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:112
  def reverse_merge!(other_hash); end
  ...
  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:122
  def stringify_keys; end

  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:121
  def stringify_keys!; end

  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:123
  def symbolize_keys; end

  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:126
  def to_hash; end

  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:124
  def to_options!; end
  ...
  #
  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:91
  def values_at(*indices); end

  protected

  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:132
  def convert_key(key); end

  # source://mail-2.8.1/lib/mail/indifferent_hash.rb:136
  def convert_value(value); end

  class << self
    # source://mail-2.8.1/lib/mail/indifferent_hash.rb:27
...
#
# source://mail-2.8.1/lib/mail/fields/keywords_field.rb:7
class Mail::KeywordsField < ::Mail::NamedStructuredField
  # source://mail-2.8.1/lib/mail/fields/keywords_field.rb:18
  def default; end

  # source://mail-2.8.1/lib/mail/fields/keywords_field.rb:10
  def element; end

  # source://mail-2.8.1/lib/mail/fields/keywords_field.rb:14
  def keywords; end

  private

  # source://mail-2.8.1/lib/mail/fields/keywords_field.rb:23
  def do_decode; end

  # source://mail-2.8.1/lib/mail/fields/keywords_field.rb:27
  def do_encode; end
end

# source://mail-2.8.1/lib/mail/fields/keywords_field.rb:8
Mail::KeywordsField::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/network/delivery_methods/logger_delivery.rb:4
class Mail::LoggerDelivery
  # @return [LoggerDelivery] a new instance of LoggerDelivery
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/logger_delivery.rb:7
  def initialize(settings); end

  # source://mail-2.8.1/lib/mail/network/delivery_methods/logger_delivery.rb:13
  def deliver!(mail); end

  # Returns the value of attribute logger.
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/logger_delivery.rb:5
  def logger; end
  ...
  # source://mail-2.8.1/lib/mail/network/delivery_methods/logger_delivery.rb:18
  def default_logger; end

  # source://mail-2.8.1/lib/mail/network/delivery_methods/logger_delivery.rb:23
  def derive_severity(severity); end
end

# source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:3
module Mail::Matchers
  # source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:8
  def an_attachment_with_filename(filename); end

  # source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:12
  def an_attachment_with_mime_type(filename); end

  # source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:4
  def any_attachment; end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:4
  def have_sent_email; end
end

# source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:16
class Mail::Matchers::AnyAttachmentMatcher
  # source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:17
  def ===(other); end
end

# source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:22
class Mail::Matchers::AttachmentFilenameMatcher
  ...
  #
  # source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:24
  def initialize(filename); end

  # source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:28
  def ===(other); end

  # Returns the value of attribute filename.
  #
  # source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:23
  def filename; end
end

# source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:33
class Mail::Matchers::AttachmentMimeTypeMatcher
  ...
  #
  # source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:35
  def initialize(mime_type); end

  # source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:39
  def ===(other); end

  # Returns the value of attribute mime_type.
  #
  # source://mail-2.8.1/lib/mail/matchers/attachment_matchers.rb:34
  def mime_type; end
end

# source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:8
class Mail::Matchers::HasSentEmailMatcher
  # @return [HasSentEmailMatcher] a new instance of HasSentEmailMatcher
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:9
  def initialize(_context); end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:44
  def bcc(recipient_or_list); end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:33
  def cc(recipient_or_list); end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:96
  def description; end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:101
  def failure_message; end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:108
  def failure_message_when_negated; end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:17
  def from(sender); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:12
  def matches?(subject); end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:81
  def matching_body(body_matcher); end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:71
  def matching_subject(subject_matcher); end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:22
  def to(recipient_or_list); end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:61
  def with_any_attachments; end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:50
  def with_attachments(attachments); end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:76
  def with_body(body); end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:86
  def with_html(body); end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:56
  def with_no_attachments; end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:66
  def with_subject(subject); end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:91
  def with_text(body); end

  protected

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:196
  def dump_deliveries; end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:181
  def explain_expectations; end

  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:117
  def filter_matched_deliveries(deliveries); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:159
  def matches_on_attachments?(delivery); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:142
  def matches_on_blind_copy_recipients?(delivery); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:165
  def matches_on_body?(delivery); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:169
  def matches_on_body_matcher?(delivery); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:138
  def matches_on_copy_recipients?(delivery); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:154
  def matches_on_having_attachments?(delivery); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:173
  def matches_on_html_part_body?(delivery); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:134
  def matches_on_recipients?(delivery); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:130
  def matches_on_sender?(delivery); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:146
  def matches_on_subject?(delivery); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:150
  def matches_on_subject_matcher?(delivery); end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/matchers/has_sent_mail.rb:177
...
#
# source://mail-2.8.1/lib/mail/message.rb:50
class Mail::Message
  # ==Making an email
  #
...
# source://mail-2.8.1/lib/mail/message.rb:1770
...
#
# source://mail-2.8.1/lib/mail/fields/message_id_field.rb:21
class Mail::MessageIdField < ::Mail::CommonMessageIdField
  # @return [MessageIdField] a new instance of MessageIdField
  #
  # source://mail-2.8.1/lib/mail/fields/message_id_field.rb:28
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/fields/message_id_field.rb:33
  def message_ids; end

  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/message_id_field.rb:24
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/message_id_field.rb:22
Mail::MessageIdField::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/elements/message_ids_element.rb:7
class Mail::MessageIdsElement
  # @return [MessageIdsElement] a new instance of MessageIdsElement
  #
  # source://mail-2.8.1/lib/mail/elements/message_ids_element.rb:14
  def initialize(string); end

  # source://mail-2.8.1/lib/mail/elements/message_ids_element.rb:18
  def message_id; end

  # Returns the value of attribute message_ids.
  #
  # source://mail-2.8.1/lib/mail/elements/message_ids_element.rb:12
  def message_ids; end

  private

  # source://mail-2.8.1/lib/mail/elements/message_ids_element.rb:23
  def parse(string); end

  class << self
    # source://mail-2.8.1/lib/mail/elements/message_ids_element.rb:8
    def parse(string); end
  end
end

# source://mail-2.8.1/lib/mail/elements/mime_version_element.rb:6
class Mail::MimeVersionElement
  # @return [MimeVersionElement] a new instance of MimeVersionElement
  #
  # source://mail-2.8.1/lib/mail/elements/mime_version_element.rb:9
  def initialize(string); end

  # Returns the value of attribute major.
  #
  # source://mail-2.8.1/lib/mail/elements/mime_version_element.rb:7
  def major; end
...
# source://mail-2.8.1/lib/mail/fields/mime_version_field.rb:7
class Mail::MimeVersionField < ::Mail::NamedStructuredField
  # @return [MimeVersionField] a new instance of MimeVersionField
  #
  # source://mail-2.8.1/lib/mail/fields/mime_version_field.rb:14
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/fields/mime_version_field.rb:39
  def decoded; end

  # source://mail-2.8.1/lib/mail/fields/mime_version_field.rb:19
  def element; end

  # source://mail-2.8.1/lib/mail/fields/mime_version_field.rb:35
  def encoded; end

  # source://mail-2.8.1/lib/mail/fields/mime_version_field.rb:27
  def major; end

  # source://mail-2.8.1/lib/mail/fields/mime_version_field.rb:31
  def minor; end

  # source://mail-2.8.1/lib/mail/fields/mime_version_field.rb:23
  def version; end

  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/mime_version_field.rb:10
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/mime_version_field.rb:8
Mail::MimeVersionField::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/multibyte/unicode.rb:3
module Mail::Multibyte
  class << self
    ...
    #
    # source://mail-2.8.1/lib/mail/multibyte/utils.rb:36
    ...
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/multibyte/utils.rb:12
    ...
    #
    # source://mail-2.8.1/lib/mail/multibyte.rb:55
    ...
    #
    # source://mail-2.8.1/lib/mail/multibyte.rb:17
    def proxy_class; end
    ...
    # source://mail-2.8.1/lib/mail/multibyte/utils.rb:40
    def to_utf8(string); end

    # Returns a regular expression that matches valid characters in the current encoding
    #
    # source://mail-2.8.1/lib/mail/multibyte/utils.rb:7
    def valid_character; end

    # Verifies the encoding of a string
    #
    # source://mail-2.8.1/lib/mail/multibyte/utils.rb:24
    ...
    # @raise [EncodingError]
    #
    # source://mail-2.8.1/lib/mail/multibyte/utils.rb:29
    def verify!(string); end
  end
end
...
#   Mail::Multibyte.proxy_class = CharsForUTF32
#
# source://mail-2.8.1/lib/mail/multibyte/chars.rb:36
class Mail::Multibyte::Chars
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:42
  def initialize(string); end
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:78
  def <=>(other); end

  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:82
  def =~(other); end
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:148
  def [](*args); end
  ...
  #   # => "Möler"
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:108
  def []=(*args); end
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:65
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:201
  def capitalize; end

  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:263
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:239
  def compose; end
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:230
  def decompose; end
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:193
  def downcase; end
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:248
  def g_length; end
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:177
  def limit(limit); end

  # Forward all undefined methods to the wrapped string.
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:48
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:221
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:60
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:139
  def reverse; end
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:91
  def split(*args); end
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:255
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:210
  def titlecase; end
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:37
  def to_s; end
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:185
  def upcase; end
  ...
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:313
  def chars(string); end

  # @raise [ArgumentError]
  #
  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:288
  def justify(integer, way, padstr = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:305
  def padding(padsize, padstr = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/multibyte/chars.rb:272
  def translate_offset(byte_offset); end
end

# Raised when a problem with the encoding was found.
#
# source://mail-2.8.1/lib/mail/multibyte.rb:8
class Mail::Multibyte::EncodingError < ::StandardError; end

# source://mail-2.8.1/lib/mail/multibyte/unicode.rb:4
module Mail::Multibyte::Unicode
  extend ::Mail::Multibyte::Unicode

  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:318
  def apply_mapping(string, mapping); end

  # Compose decomposed characters to the composed form.
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:184
  def compose_codepoints(codepoints); end

  # Decompose composed characters to the decomposed form.
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:163
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:37
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:142
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:108
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:99
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:300
  def normalize(string, form = T.unsafe(nil)); end

  # Re-order codepoints so the string becomes canonical.
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:147
  ...
  # Passing +true+ will forcibly tidy all bytes, assuming that the string's encoding is entirely CP1252 or ISO-8859-1.
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:245
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:86
  def u_unpack(string); end

  private

  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:399
  def database; end

  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:389
  def tidy_byte(byte); end

  class << self
    # Returns a regular expression pattern that matches the passed Unicode codepoints
    #
    # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:75
...
#
# source://mail-2.8.1/lib/mail/multibyte/unicode.rb:11
class Mail::Multibyte::Unicode::Codepoint
  # Initializing Codepoint object with default values
  #
  # @return [Codepoint] a new instance of Codepoint
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:15
  def initialize; end

  # Returns the value of attribute code.
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:12
  def code; end
  ...
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:21
...
class Mail::Multibyte::Unicode::UnicodeDatabase
  ...
  #
  # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:354
  def load; end

  class << self
    # Returns the directory in which the data files are stored
    #
    # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:377
    def dirname; end

    # Returns the filename for the data file for this version
    #
    # source://mail-2.8.1/lib/mail/multibyte/unicode.rb:382
    def filename; end
  end
end

# source://mail-2.8.1/lib/mail/multibyte/unicode.rb:331
Mail::Multibyte::Unicode::UnicodeDatabase::ATTRIBUTES = T.let(T.unsafe(nil), Array)

# All the unicode whitespace
#
# source://mail-2.8.1/lib/mail/multibyte/unicode.rb:55
Mail::Multibyte::Unicode::WHITESPACE = T.let(T.unsafe(nil), Array)

# Regular expressions that describe valid byte sequences for a character
#
# source://mail-2.8.1/lib/mail/multibyte.rb:64
Mail::Multibyte::VALID_CHARACTER = T.let(T.unsafe(nil), Hash)

# source://mail-2.8.1/lib/mail/fields/named_structured_field.rb:6
class Mail::NamedStructuredField < ::Mail::StructuredField
  # @return [NamedStructuredField] a new instance of NamedStructuredField
  #
  # source://mail-2.8.1/lib/mail/fields/named_structured_field.rb:7
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end
end

# source://mail-2.8.1/lib/mail/fields/named_unstructured_field.rb:6
class Mail::NamedUnstructuredField < ::Mail::UnstructuredField
  ...
  #
  # source://mail-2.8.1/lib/mail/fields/named_unstructured_field.rb:7
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end
end
...
#
# source://mail-2.8.1/lib/mail/fields/optional_field.rb:10
class Mail::OptionalField < ::Mail::UnstructuredField
  private

  # source://mail-2.8.1/lib/mail/fields/optional_field.rb:12
  def do_encode; end
end
...
#   #=> Returns the first 10 emails in ascending order
#
# source://mail-2.8.1/lib/mail/network/retriever_methods/pop3.rb:35
class Mail::POP3 < ::Mail::Retriever
  # @return [POP3] a new instance of POP3
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/pop3.rb:38
  def initialize(values); end
  ...
  # @raise [ArgumentError]
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/pop3.rb:104
  def connection(&block); end

  # Delete all emails from a POP3 server
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/pop3.rb:94
  def delete_all; end
  ...
  #           is false. Use #find_and_delete if you would like this to default to true.
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/pop3.rb:60
  def find(options = T.unsafe(nil), &block); end

  # Returns the value of attribute settings.
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/pop3.rb:48
  def settings; end
  ...
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/pop3.rb:127
  def start(config = T.unsafe(nil), &block); end

  # Set default options
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/pop3.rb:115
  def validate_options(options); end
end
...
#
# source://mail-2.8.1/lib/mail/fields/parameter_hash.rb:15
class Mail::ParameterHash < ::Mail::IndifferentHash
  # source://mail-2.8.1/lib/mail/fields/parameter_hash.rb:16
  def [](key_name); end

  # source://mail-2.8.1/lib/mail/fields/parameter_hash.rb:55
  def decoded; end

  # source://mail-2.8.1/lib/mail/fields/parameter_hash.rb:45
  def encoded; end
end

# Extends each field parser with utility methods.
#
# source://mail-2.8.1/lib/mail/parser_tools.rb:3
module Mail::ParserTools
  # source://mail-2.8.1/lib/mail/parser_tools.rb:6
  def chars(data, from_bytes, to_bytes); end
end

# source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:9
module Mail::Parsers; end

# source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:10
module Mail::Parsers::AddressListsParser
  extend ::Mail::ParserTools

  class << self
    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:31951
    def en_comment_tail; end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:31951
    def en_comment_tail=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:31955
    def en_main; end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:31955
    def en_main=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:31946
    def error; end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:31946
    def error=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:31942
    def first_final; end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:31942
    def first_final=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:31959
    def parse(data); end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:31938
    def start; end
    ...
    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:31614
    def _eof_actions; end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:31614
    def _eof_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:1300
    def _index_offsets; end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:1300
    def _index_offsets=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:1624
    def _indicies; end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:1624
    def _indicies=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:976
    def _key_spans; end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:976
    def _key_spans=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:30983
    def _trans_actions; end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:30983
    def _trans_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:18
    def _trans_keys; end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:18
    def _trans_keys=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:30352
...
# source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:13
...
# source://mail-2.8.1/lib/mail/parsers/address_lists_parser.rb:14
...
# source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:10
module Mail::Parsers::ContentDispositionParser
  extend ::Mail::ParserTools

  class << self
    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:556
    def en_comment_tail; end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:556
    def en_comment_tail=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:560
    def en_main; end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:560
    def en_main=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:551
    def error; end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:551
    def error=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:547
    def first_final; end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:547
    def first_final=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:564
    def parse(data); end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:543
    def start; end
    ...
    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:530
    def _eof_actions; end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:530
    def _eof_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:54
    def _index_offsets; end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:54
    def _index_offsets=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:67
    def _indicies; end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:67
    def _indicies=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:41
    def _key_spans; end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:41
    def _key_spans=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:510
    def _trans_actions; end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:510
    def _trans_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:16
    def _trans_keys; end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:16
    def _trans_keys=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:490
    def _trans_targs; end
...
# source://mail-2.8.1/lib/mail/parsers/content_disposition_parser.rb:13
...
# source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:10
module Mail::Parsers::ContentLocationParser
  extend ::Mail::ParserTools

  class << self
    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:577
    def en_comment_tail; end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:577
    def en_comment_tail=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:581
    def en_main; end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:581
    def en_main=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:572
    def error; end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:572
    def error=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:568
    def first_final; end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:568
    def first_final=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:585
    def parse(data); end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:564
    def start; end
    ...
    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:551
    def _eof_actions; end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:551
    def _eof_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:52
    def _index_offsets; end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:52
    def _index_offsets=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:65
    def _indicies; end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:65
    def _indicies=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:39
    def _key_spans; end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:39
    def _key_spans=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:533
    def _trans_actions; end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:533
    def _trans_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:16
    def _trans_keys; end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:16
    def _trans_keys=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:515
    def _trans_targs; end
...
# source://mail-2.8.1/lib/mail/parsers/content_location_parser.rb:13
...
# source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:10
module Mail::Parsers::ContentTransferEncodingParser
  extend ::Mail::ParserTools

  class << self
    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:328
    def en_comment_tail; end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:328
    def en_comment_tail=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:332
    def en_main; end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:332
    def en_main=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:323
    def error; end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:323
    def error=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:319
    def first_final; end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:319
    def first_final=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:336
    def parse(data); end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:315
    def start; end
    ...
    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:304
    def _eof_actions; end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:304
    def _eof_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:45
    def _index_offsets; end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:45
    def _index_offsets=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:56
    def _indicies; end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:56
    def _indicies=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:34
    def _key_spans; end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:34
    def _key_spans=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:290
    def _trans_actions; end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:290
    def _trans_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:16
    def _trans_keys; end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:16
    def _trans_keys=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:276
    def _trans_targs; end
...
# source://mail-2.8.1/lib/mail/parsers/content_transfer_encoding_parser.rb:13
...
# source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:10
module Mail::Parsers::ContentTypeParser
  extend ::Mail::ParserTools

  class << self
    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:681
    def en_comment_tail; end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:681
    def en_comment_tail=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:685
    def en_main; end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:685
    def en_main=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:676
    def error; end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:676
    def error=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:672
    def first_final; end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:672
    def first_final=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:689
    def parse(data); end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:668
    def start; end
    ...
    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:654
    def _eof_actions; end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:654
    def _eof_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:58
    def _index_offsets; end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:58
    def _index_offsets=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:72
    def _indicies; end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:72
    def _indicies=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:44
    def _key_spans; end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:44
    def _key_spans=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:632
    def _trans_actions; end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:632
    def _trans_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:16
    def _trans_keys; end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:16
    def _trans_keys=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:610
    def _trans_targs; end
...
# source://mail-2.8.1/lib/mail/parsers/content_type_parser.rb:13
...
# source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:10
module Mail::Parsers::DateTimeParser
  extend ::Mail::ParserTools

  class << self
    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:660
    def en_comment_tail; end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:660
    def en_comment_tail=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:664
    def en_main; end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:664
    def en_main=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:655
    def error; end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:655
    def error=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:651
    def first_final; end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:651
    def first_final=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:668
    def parse(data); end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:647
    def start; end
    ...
    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:626
    def _eof_actions; end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:626
    def _eof_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:86
    def _index_offsets; end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:86
    def _index_offsets=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:107
    def _indicies; end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:107
    def _indicies=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:65
    def _key_spans; end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:65
    def _key_spans=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:595
    def _trans_actions; end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:595
    def _trans_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:16
    def _trans_keys; end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:16
    def _trans_keys=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:564
    def _trans_targs; end
...
# source://mail-2.8.1/lib/mail/parsers/date_time_parser.rb:13
...
# source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:10
module Mail::Parsers::EnvelopeFromParser
  extend ::Mail::ParserTools

  class << self
    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3211
    def en_comment_tail; end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3211
    def en_comment_tail=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3215
    def en_main; end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3215
    def en_main=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3206
    def error; end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3206
    def error=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3202
    def first_final; end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3202
    def first_final=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3219
    def parse(data); end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3198
    def start; end
    ...
    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3152
    def _eof_actions; end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3152
    def _eof_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:185
    def _index_offsets; end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:185
    def _index_offsets=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:231
    def _indicies; end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:231
    def _indicies=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:139
    def _key_spans; end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:139
    def _key_spans=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3077
    def _trans_actions; end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3077
    def _trans_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:16
    def _trans_keys; end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:16
    def _trans_keys=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:3002
    def _trans_targs; end
...
# source://mail-2.8.1/lib/mail/parsers/envelope_from_parser.rb:13
...
# source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:10
module Mail::Parsers::MessageIdsParser
  extend ::Mail::ParserTools

  class << self
    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4818
    def en_comment_tail; end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4818
    def en_comment_tail=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4822
    def en_main; end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4822
    def en_main=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4813
    def error; end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4813
    def error=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4809
    def first_final; end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4809
    def first_final=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4826
    def parse(data); end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4805
    def start; end
    ...
    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4755
    def _eof_actions; end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4755
    def _eof_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:202
    def _index_offsets; end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:202
    def _index_offsets=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:252
    def _indicies; end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:252
    def _indicies=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:152
    def _key_spans; end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:152
    def _key_spans=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4675
    def _trans_actions; end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4675
    def _trans_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:16
    def _trans_keys; end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:16
    def _trans_keys=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:4595
    def _trans_targs; end
...
# source://mail-2.8.1/lib/mail/parsers/message_ids_parser.rb:13
...
# source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:10
module Mail::Parsers::MimeVersionParser
  extend ::Mail::ParserTools

  class << self
    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:292
    def en_comment_tail; end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:292
    def en_comment_tail=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:296
    def en_main; end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:296
    def en_main=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:287
    def error; end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:287
    def error=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:283
    def first_final; end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:283
    def first_final=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:300
    def parse(data); end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:279
    def start; end
    ...
    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:268
    def _eof_actions; end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:268
    def _eof_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:45
    def _index_offsets; end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:45
    def _index_offsets=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:56
    def _indicies; end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:56
    def _indicies=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:34
    def _key_spans; end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:34
    def _key_spans=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:254
    def _trans_actions; end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:254
    def _trans_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:16
    def _trans_keys; end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:16
    def _trans_keys=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:240
    def _trans_targs; end
...
# source://mail-2.8.1/lib/mail/parsers/mime_version_parser.rb:13
...
# source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:10
class Mail::Parsers::PhraseListsParser
  extend ::Mail::ParserTools

  class << self
    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:672
    def en_comment_tail; end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:672
    def en_comment_tail=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:676
    def en_main; end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:676
    def en_main=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:667
    def error; end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:667
    def error=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:663
    def first_final; end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:663
    def first_final=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:680
    def parse(data); end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:659
    def start; end
    ...
    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:646
    def _eof_actions; end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:646
    def _eof_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:54
    def _index_offsets; end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:54
    def _index_offsets=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:67
    def _indicies; end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:67
    def _indicies=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:41
    def _key_spans; end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:41
    def _key_spans=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:626
    def _trans_actions; end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:626
    def _trans_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:16
    def _trans_keys; end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:16
    def _trans_keys=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:606
    def _trans_targs; end
...
# source://mail-2.8.1/lib/mail/parsers/phrase_lists_parser.rb:13
...
# source://mail-2.8.1/lib/mail/parsers/received_parser.rb:10
module Mail::Parsers::ReceivedParser
  extend ::Mail::ParserTools

  class << self
    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7484
    def en_comment_tail; end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7484
    def en_comment_tail=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7488
    def en_main; end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7488
    def en_main=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7479
    def error; end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7479
    def error=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7475
    def first_final; end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7475
    def first_final=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7492
    def parse(data); end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7471
    def start; end
    ...
    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7382
    def _eof_actions; end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7382
    def _eof_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:358
    def _index_offsets; end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:358
    def _index_offsets=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:447
    def _indicies; end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:447
    def _indicies=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:269
    def _key_spans; end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:269
    def _key_spans=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7199
    def _trans_actions; end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7199
    def _trans_actions=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:16
    def _trans_keys; end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:16
    def _trans_keys=(_arg0); end

    # source://mail-2.8.1/lib/mail/parsers/received_parser.rb:7016
    def _trans_targs; end
...
# source://mail-2.8.1/lib/mail/parsers/received_parser.rb:13
...
# source://mail-2.8.1/lib/mail/part.rb:13
class Mail::Part < ::Mail::Message
  ...
  #
  # source://mail-2.8.1/lib/mail/part.rb:65
  def action; end
  ...
  #
  # source://mail-2.8.1/lib/mail/part.rb:14
  def add_content_id(content_id_val = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/part.rb:37
  def add_required_fields; end

  # source://mail-2.8.1/lib/mail/part.rb:42
  def add_required_message_fields; end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/part.rb:54
  def bounced?; end

  # source://mail-2.8.1/lib/mail/part.rb:24
  def cid; end

  # source://mail-2.8.1/lib/mail/part.rb:50
  def delivery_status_data; end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/part.rb:46
  def delivery_status_report_part?; end

  # source://mail-2.8.1/lib/mail/part.rb:77
  def diagnostic_code; end

  # source://mail-2.8.1/lib/mail/part.rb:73
  def error_status; end

  # source://mail-2.8.1/lib/mail/part.rb:69
  def final_recipient; end
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/part.rb:20
  def has_content_id?; end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/part.rb:33
  def inline?; end

  # source://mail-2.8.1/lib/mail/part.rb:81
  def remote_mta; end

  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/part.rb:85
  def retryable?; end

  # source://mail-2.8.1/lib/mail/part.rb:29
  def url; end

  private

  # source://mail-2.8.1/lib/mail/part.rb:91
  def get_return_values(key); end

  # source://mail-2.8.1/lib/mail/part.rb:113
  def parse_delivery_status_report; end

  # A part may not have a header.... so, just init a body if no header
  #
  # source://mail-2.8.1/lib/mail/part.rb:102
  def parse_message; end
end

# source://mail-2.8.1/lib/mail/parts_list.rb:5
class Mail::PartsList
  # @return [PartsList] a new instance of PartsList
  #
  # source://mail-2.8.1/lib/mail/parts_list.rb:8
  def initialize(*args); end

  # source://mail-2.8.1/lib/mail/parts_list.rb:24
  def attachments; end

  # source://mail-2.8.1/lib/mail/parts_list.rb:28
  def collect; end

  # @raise [NoMethodError]
  #
  # source://mail-2.8.1/lib/mail/parts_list.rb:43
  def collect!; end

  # source://mail-2.8.1/lib/mail/parts_list.rb:98
  ...
  #
  # source://mail-2.8.1/lib/mail/parts_list.rb:16
  def encode_with(coder); end

  # source://mail-2.8.1/lib/mail/parts_list.rb:47
  ...
  # @raise [NoMethodError]
  #
  # source://mail-2.8.1/lib/mail/parts_list.rb:39
  def map!; end

  # Returns the value of attribute parts.
  #
  # source://mail-2.8.1/lib/mail/parts_list.rb:6
  def parts; end

  # source://mail-2.8.1/lib/mail/parts_list.rb:83
  def recursive_delete_if; end

  # source://mail-2.8.1/lib/mail/parts_list.rb:63
  def recursive_each(&block); end

  # source://mail-2.8.1/lib/mail/parts_list.rb:77
  def recursive_size; end

  # source://mail-2.8.1/lib/mail/parts_list.rb:104
  def sort; end

  # source://mail-2.8.1/lib/mail/parts_list.rb:108
  def sort!(order); end

  # source://mail-2.8.1/lib/mail/parts_list.rb:20
  def to_yaml(options = T.unsafe(nil)); end

  private

  # source://mail-2.8.1/lib/mail/parts_list.rb:123
  def get_order_value(part, order); end
end

# source://mail-2.8.1/lib/mail/elements/phrase_list.rb:7
class Mail::PhraseList
  # @return [PhraseList] a new instance of PhraseList
  #
  # source://mail-2.8.1/lib/mail/elements/phrase_list.rb:10
  def initialize(string); end

  # Returns the value of attribute phrases.
  #
  # source://mail-2.8.1/lib/mail/elements/phrase_list.rb:8
  def phrases; end
end
...
# source://mail-2.8.1/lib/mail/elements/received_element.rb:8
class Mail::ReceivedElement
  # @return [ReceivedElement] a new instance of ReceivedElement
  #
  # source://mail-2.8.1/lib/mail/elements/received_element.rb:11
  def initialize(string); end

  # Returns the value of attribute date_time.
  #
  # source://mail-2.8.1/lib/mail/elements/received_element.rb:9
  def date_time; end
  ...
  # source://mail-2.8.1/lib/mail/elements/received_element.rb:22
  def to_s(*args); end

  private

  # source://mail-2.8.1/lib/mail/elements/received_element.rb:27
...
#                          atom / domain / msg-id
#
# source://mail-2.8.1/lib/mail/fields/received_field.rb:24
class Mail::ReceivedField < ::Mail::NamedStructuredField
  # source://mail-2.8.1/lib/mail/fields/received_field.rb:31
  def date_time; end

  # source://mail-2.8.1/lib/mail/fields/received_field.rb:27
  def element; end

  # source://mail-2.8.1/lib/mail/fields/received_field.rb:39
  def formatted_date; end

  # source://mail-2.8.1/lib/mail/fields/received_field.rb:35
  def info; end

  private

  # source://mail-2.8.1/lib/mail/fields/received_field.rb:54
  def do_decode; end

  # source://mail-2.8.1/lib/mail/fields/received_field.rb:46
  def do_encode; end
end

# source://mail-2.8.1/lib/mail/fields/received_field.rb:25
...
#
# source://mail-2.8.1/lib/mail/fields/references_field.rb:31
class Mail::ReferencesField < ::Mail::CommonMessageIdField
  # @return [ReferencesField] a new instance of ReferencesField
  #
  # source://mail-2.8.1/lib/mail/fields/references_field.rb:38
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end

  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/references_field.rb:34
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/references_field.rb:32
...
#
# source://mail-2.8.1/lib/mail/fields/reply_to_field.rb:31
class Mail::ReplyToField < ::Mail::CommonAddressField; end

# source://mail-2.8.1/lib/mail/fields/reply_to_field.rb:32
...
#
# source://mail-2.8.1/lib/mail/fields/resent_bcc_field.rb:31
class Mail::ResentBccField < ::Mail::CommonAddressField; end

# source://mail-2.8.1/lib/mail/fields/resent_bcc_field.rb:32
...
#
# source://mail-2.8.1/lib/mail/fields/resent_cc_field.rb:31
class Mail::ResentCcField < ::Mail::CommonAddressField; end

# source://mail-2.8.1/lib/mail/fields/resent_cc_field.rb:32
Mail::ResentCcField::NAME = T.let(T.unsafe(nil), String)

# resent-date     =       "Resent-Date:" date-time CRLF
#
# source://mail-2.8.1/lib/mail/fields/resent_date_field.rb:8
class Mail::ResentDateField < ::Mail::CommonDateField; end

# source://mail-2.8.1/lib/mail/fields/resent_date_field.rb:9
...
#
# source://mail-2.8.1/lib/mail/fields/resent_from_field.rb:31
class Mail::ResentFromField < ::Mail::CommonAddressField; end

# source://mail-2.8.1/lib/mail/fields/resent_from_field.rb:32
Mail::ResentFromField::NAME = T.let(T.unsafe(nil), String)

# resent-msg-id   =       "Resent-Message-ID:" msg-id CRLF
#
# source://mail-2.8.1/lib/mail/fields/resent_message_id_field.rb:8
class Mail::ResentMessageIdField < ::Mail::CommonMessageIdField; end

# source://mail-2.8.1/lib/mail/fields/resent_message_id_field.rb:9
...
#
# source://mail-2.8.1/lib/mail/fields/resent_sender_field.rb:30
class Mail::ResentSenderField < ::Mail::CommonAddressField; end

# source://mail-2.8.1/lib/mail/fields/resent_sender_field.rb:31
...
#
# source://mail-2.8.1/lib/mail/fields/resent_to_field.rb:31
class Mail::ResentToField < ::Mail::CommonAddressField; end

# source://mail-2.8.1/lib/mail/fields/resent_to_field.rb:32
Mail::ResentToField::NAME = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/network/retriever_methods/base.rb:6
class Mail::Retriever
  ...
  #   order: order of emails returned. Possible values are :asc or :desc. Default value is :asc.
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/base.rb:39
  ...
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/base.rb:56
  ...
  #   order: order of emails returned. Possible values are :asc or :desc. Default value is :asc.
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/base.rb:14
  ...
  #   order: order of emails returned. Possible values are :asc or :desc. Default value is :asc.
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/base.rb:27
...
#                          atom / domain / msg-id
#
# source://mail-2.8.1/lib/mail/fields/return_path_field.rb:33
class Mail::ReturnPathField < ::Mail::CommonAddressField
  # @return [ReturnPathField] a new instance of ReturnPathField
  #
  # source://mail-2.8.1/lib/mail/fields/return_path_field.rb:40
  def initialize(value = T.unsafe(nil), charset = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/fields/return_path_field.rb:48
  def default; end

  private

  # source://mail-2.8.1/lib/mail/fields/return_path_field.rb:57
  def do_decode; end

  # source://mail-2.8.1/lib/mail/fields/return_path_field.rb:53
  def do_encode; end

  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/return_path_field.rb:36
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/return_path_field.rb:34
...
#   mail.deliver!
#
# source://mail-2.8.1/lib/mail/network/delivery_methods/smtp.rb:76
class Mail::SMTP
  # @return [SMTP] a new instance of SMTP
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/smtp.rb:95
  def initialize(values); end

  # source://mail-2.8.1/lib/mail/network/delivery_methods/smtp.rb:99
  def deliver!(mail); end

  # Returns the value of attribute settings.
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/smtp.rb:77
  def settings; end
  ...
  # source://mail-2.8.1/lib/mail/network/delivery_methods/smtp.rb:112
  def build_smtp_session; end

  # Allow SSL context to be configured via settings, for Ruby >= 1.9
  # Just returns openssl verify mode for Ruby 1.8.x
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/smtp.rb:151
  def ssl_context; end

  # source://mail-2.8.1/lib/mail/network/delivery_methods/smtp.rb:108
  def start_smtp_session(&block); end
end

# source://mail-2.8.1/lib/mail/network/delivery_methods/smtp.rb:79
...
#   mail.deliver!
#
# source://mail-2.8.1/lib/mail/network/delivery_methods/smtp_connection.rb:40
class Mail::SMTPConnection
  # @raise [ArgumentError]
  # @return [SMTPConnection] a new instance of SMTPConnection
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/smtp_connection.rb:43
  def initialize(values); end

  # Send the message via SMTP.
  # The from and to attributes are optional. If not set, they are retrieve from the Message.
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/smtp_connection.rb:51
  def deliver!(mail); end

  # Returns the value of attribute settings.
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/smtp_connection.rb:41
  def settings; end
...
#
# source://mail-2.8.1/lib/mail/fields/sender_field.rb:31
class Mail::SenderField < ::Mail::CommonAddressField
  # source://mail-2.8.1/lib/mail/fields/sender_field.rb:42
  def addresses; end

  # source://mail-2.8.1/lib/mail/fields/sender_field.rb:38
  def default; end

  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/sender_field.rb:34
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/sender_field.rb:32
...
#   mail.deliver!
#
# source://mail-2.8.1/lib/mail/network/delivery_methods/sendmail.rb:40
class Mail::Sendmail
  # @return [Sendmail] a new instance of Sendmail
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/sendmail.rb:51
  def initialize(values); end

  # source://mail-2.8.1/lib/mail/network/delivery_methods/sendmail.rb:64
  def deliver!(mail); end

  # source://mail-2.8.1/lib/mail/network/delivery_methods/sendmail.rb:60
  def destinations_for(envelope); end

  # Returns the value of attribute settings.
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/sendmail.rb:46
  def settings; end
  ...
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/sendmail.rb:129
  def deprecation_warn; end

  # + support for delivery using string arguments (deprecated)
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/sendmail.rb:97
  def old_deliver(envelope); end

  # source://mail-2.8.1/lib/mail/network/delivery_methods/sendmail.rb:88
  ...
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/sendmail.rb:118
  def shellquote(address); end
end

# source://mail-2.8.1/lib/mail/network/delivery_methods/sendmail.rb:41
Mail::Sendmail::DEFAULTS = T.let(T.unsafe(nil), Hash)

# source://mail-2.8.1/lib/mail/network/delivery_methods/sendmail.rb:48
class Mail::Sendmail::DeliveryError < ::StandardError; end

# source://mail-2.8.1/lib/mail/smtp_envelope.rb:4
class Mail::SmtpEnvelope
  # @return [SmtpEnvelope] a new instance of SmtpEnvelope
  #
  # source://mail-2.8.1/lib/mail/smtp_envelope.rb:11
  def initialize(mail); end

  # Returns the value of attribute from.
  #
  # source://mail-2.8.1/lib/mail/smtp_envelope.rb:9
  def from; end

  # source://mail-2.8.1/lib/mail/smtp_envelope.rb:17
  def from=(addr); end
  ...
  # source://mail-2.8.1/lib/mail/smtp_envelope.rb:35
  ...
  # source://mail-2.8.1/lib/mail/smtp_envelope.rb:25
  def to=(addr); end

  private

  # source://mail-2.8.1/lib/mail/smtp_envelope.rb:45
...
#
# source://mail-2.8.1/lib/mail/smtp_envelope.rb:7
...
#
# source://mail-2.8.1/lib/mail/fields/structured_field.rb:23
class Mail::StructuredField < ::Mail::CommonField; end

# subject         =       "Subject:" unstructured CRLF
#
# source://mail-2.8.1/lib/mail/fields/subject_field.rb:8
class Mail::SubjectField < ::Mail::NamedUnstructuredField
  class << self
    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/fields/subject_field.rb:11
    def singular?; end
  end
end

# source://mail-2.8.1/lib/mail/fields/subject_field.rb:9
...
#
# source://mail-2.8.1/lib/mail/network/delivery_methods/test_mailer.rb:10
class Mail::TestMailer
  # @return [TestMailer] a new instance of TestMailer
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/test_mailer.rb:33
  def initialize(values); end

  # source://mail-2.8.1/lib/mail/network/delivery_methods/test_mailer.rb:37
  def deliver!(mail); end

  # Returns the value of attribute settings.
  #
  # source://mail-2.8.1/lib/mail/network/delivery_methods/test_mailer.rb:31
  def settings; end
  ...
  class << self
    ...
    #
    # source://mail-2.8.1/lib/mail/network/delivery_methods/test_mailer.rb:12
    def deliveries; end
    ...
    #
    # source://mail-2.8.1/lib/mail/network/delivery_methods/test_mailer.rb:27
    def deliveries=(val); end
  end
end

# source://mail-2.8.1/lib/mail/network/retriever_methods/test_retriever.rb:6
class Mail::TestRetriever < ::Mail::Retriever
  # @return [TestRetriever] a new instance of TestRetriever
  #
  # source://mail-2.8.1/lib/mail/network/retriever_methods/test_retriever.rb:16
  def initialize(values); end

  # source://mail-2.8.1/lib/mail/network/retriever_methods/test_retriever.rb:20
  def find(options = T.unsafe(nil), &block); end

  class << self
    # source://mail-2.8.1/lib/mail/network/retriever_methods/test_retriever.rb:8
    def emails; end

    # source://mail-2.8.1/lib/mail/network/retriever_methods/test_retriever.rb:12
    def emails=(val); end
  end
end
...
#
# source://mail-2.8.1/lib/mail/fields/to_field.rb:31
class Mail::ToField < ::Mail::CommonAddressField; end

# source://mail-2.8.1/lib/mail/fields/to_field.rb:32
Mail::ToField::NAME = T.let(T.unsafe(nil), String)

# Raised when attempting to decode an unknown encoding type
#
# source://mail-2.8.1/lib/mail/encodings.rb:6
...
#
# source://mail-2.8.1/lib/mail/fields/unstructured_field.rb:19
class Mail::UnstructuredField < ::Mail::CommonField
  # @return [UnstructuredField] a new instance of UnstructuredField
  #
  # source://mail-2.8.1/lib/mail/fields/unstructured_field.rb:20
  def initialize(name, value, charset = T.unsafe(nil)); end

  # An unstructured field does not parse
  #
  # source://mail-2.8.1/lib/mail/fields/unstructured_field.rb:40
  def parse; end

  private

  # source://mail-2.8.1/lib/mail/fields/unstructured_field.rb:54
  def do_decode; end

  # source://mail-2.8.1/lib/mail/fields/unstructured_field.rb:46
  def do_encode; end

  # source://mail-2.8.1/lib/mail/fields/unstructured_field.rb:169
  def encode(value); end

  # source://mail-2.8.1/lib/mail/fields/unstructured_field.rb:180
  def encode_crlf(value); end

  # source://mail-2.8.1/lib/mail/fields/unstructured_field.rb:102
  def fold(prepend = T.unsafe(nil)); end

  # source://mail-2.8.1/lib/mail/fields/unstructured_field.rb:186
  ...
  #  unencoded text.)
  #
  # source://mail-2.8.1/lib/mail/fields/unstructured_field.rb:96
  ...
  #
  # source://mail-2.8.1/lib/mail/fields/unstructured_field.rb:84
  def wrapped_value; end
end

# source://mail-2.8.1/lib/mail/utilities.rb:7
module Mail::Utilities
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:11
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:283
  def blank?(value); end
  ...
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:131
  def bracket(str); end
  ...
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:188
  ...
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:199
  ...
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:210
  ...
  #  dquote(string #=> '"This is \"a string\"'
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:68
  def dquote(str); end
  ...
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:155
  def escape_paren(str); end

  # source://mail-2.8.1/lib/mail/utilities.rb:293
  def generate_message_id; end

  # source://mail-2.8.1/lib/mail/utilities.rb:225
  def map_lines(str, &block); end

  # source://mail-2.8.1/lib/mail/utilities.rb:229
  ...
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:178
  ...
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:108
  def paren(str); end

  # If the string supplied has ATOM unsafe characters in it, will return the string quoted
  # in double quotes, otherwise returns the string unmodified
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:17
  def quote_atom(str); end

  # If the string supplied has PHRASE unsafe characters in it, will return the string quoted
  # in double quotes, otherwise returns the string unmodified
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:23
  def quote_phrase(str); end

  # If the string supplied has TOKEN unsafe characters in it, will return the string quoted
  # in double quotes, otherwise returns the string unmodified
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:44
  ...
  # @return [Boolean]
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:38
  ...
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:141
  ...
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:221
  ...
  #  unescape(string) #=> '"This is "a string""'
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:99
  ...
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:118
  def unparen(str); end
  ...
  #
  # source://mail-2.8.1/lib/mail/utilities.rb:82
  def unquote(str); end

  # source://mail-2.8.1/lib/mail/utilities.rb:159
  def uri_escape(str); end

  # source://mail-2.8.1/lib/mail/utilities.rb:167
  def uri_parser; end

  # source://mail-2.8.1/lib/mail/utilities.rb:163
  def uri_unescape(str); end

  class << self
    # source://mail-2.8.1/lib/mail/utilities.rb:414
    def b_value_decode(str); end

    # source://mail-2.8.1/lib/mail/utilities.rb:409
    def b_value_encode(str, encoding = T.unsafe(nil)); end

    # source://mail-2.8.1/lib/mail/utilities.rb:243
    def binary_unsafe_to_crlf(string); end

    # source://mail-2.8.1/lib/mail/utilities.rb:233
    def binary_unsafe_to_lf(string); end

    # source://mail-2.8.1/lib/mail/utilities.rb:356
    def bracket(str); end

    # Returns the value of attribute charset_encoder.
    #
    # source://mail-2.8.1/lib/mail/utilities.rb:334
    ...
    # source://mail-2.8.1/lib/mail/utilities.rb:362
    def decode_base64(str); end

    # source://mail-2.8.1/lib/mail/utilities.rb:399
    def decode_utf7(utf7); end

    # source://mail-2.8.1/lib/mail/utilities.rb:369
    def encode_base64(str); end

    # From Ruby stdlib Net::IMAP
    #
    # source://mail-2.8.1/lib/mail/utilities.rb:388
    def encode_utf7(string); end

    # source://mail-2.8.1/lib/mail/utilities.rb:351
    def escape_bracket(str); end

    # Escapes any parenthesis in a string that are unescaped this uses
    # a Ruby 1.9.1 regexp feature of negative look behind
    #
    # source://mail-2.8.1/lib/mail/utilities.rb:340
    def escape_paren(str); end

    # source://mail-2.8.1/lib/mail/utilities.rb:377
    def get_constant(klass, string); end

    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/utilities.rb:373
    def has_constant?(klass, string); end

    # source://mail-2.8.1/lib/mail/utilities.rb:451
    def param_decode(str, encoding); end

    # source://mail-2.8.1/lib/mail/utilities.rb:460
    def param_encode(str); end

    # source://mail-2.8.1/lib/mail/utilities.rb:345
    def paren(str); end
    ...
    #
    # source://mail-2.8.1/lib/mail/utilities.rb:476
    def pick_encoding(charset); end

    # source://mail-2.8.1/lib/mail/utilities.rb:432
    def q_value_decode(str); end

    # source://mail-2.8.1/lib/mail/utilities.rb:427
    def q_value_encode(str, encoding = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://mail-2.8.1/lib/mail/utilities.rb:247
    def safe_for_line_ending_conversion?(string); end

    # source://mail-2.8.1/lib/mail/utilities.rb:536
    ...
    #
    # source://mail-2.8.1/lib/mail/utilities.rb:269
    def to_crlf(string); end

    # Convert line endings to \n unless the string is binary. Used for
    # sendmail delivery and for decoding 8bit Content-Transfer-Encoding.
    #
    # source://mail-2.8.1/lib/mail/utilities.rb:257
    def to_lf(string); end

    # source://mail-2.8.1/lib/mail/utilities.rb:381
    def transcode_charset(str, from_encoding, to_encoding = T.unsafe(nil)); end

    # source://mail-2.8.1/lib/mail/utilities.rb:466
    def uri_parser; end

    private

    # source://mail-2.8.1/lib/mail/utilities.rb:543
    def convert_to_encoding(encoding); end

    # source://mail-2.8.1/lib/mail/utilities.rb:556
    def transcode_to_scrubbed_utf8(str); end
  end
end

# source://mail-2.8.1/lib/mail/utilities.rb:308
class Mail::Utilities::BestEffortCharsetEncoder
  # source://mail-2.8.1/lib/mail/utilities.rb:309
  def encode(string, charset); end

  private

  # source://mail-2.8.1/lib/mail/utilities.rb:320
  def pick_encoding(charset); end
end

# source://mail-2.8.1/lib/mail/utilities.rb:297
class Mail::Utilities::StrictCharsetEncoder
  # source://mail-2.8.1/lib/mail/utilities.rb:298
  def encode(string, charset); end
end

# source://mail-2.8.1/lib/mail/utilities.rb:237
Mail::Utilities::TO_CRLF_REGEX = T.let(T.unsafe(nil), Regexp)

# source://mail-2.8.1/lib/mail/version.rb:3
module Mail::VERSION
  class << self
    # source://mail-2.8.1/lib/mail/version.rb:12
    def version; end
  end
end

# source://mail-2.8.1/lib/mail/version.rb:5
Mail::VERSION::MAJOR = T.let(T.unsafe(nil), Integer)

# source://mail-2.8.1/lib/mail/version.rb:6
Mail::VERSION::MINOR = T.let(T.unsafe(nil), Integer)

# source://mail-2.8.1/lib/mail/version.rb:7
Mail::VERSION::PATCH = T.let(T.unsafe(nil), Integer)

# source://mail-2.8.1/lib/mail/version.rb:10
Mail::VERSION::STRING = T.let(T.unsafe(nil), String)

# source://mail-2.8.1/lib/mail/yaml.rb:4
module Mail::YAML
  class << self
    # source://mail-2.8.1/lib/mail/yaml.rb:5
    def load(yaml); end
  end
end
