...
# {Time#strftime}[https://docs.ruby-lang.org/en/master/Time.html#method-i-strftime].
#
# source://logger-1.7.0/lib/logger/version.rb:3
class Logger
  ...
  #
  # source://logger-1.7.0/lib/logger.rb:598
  ...
  # - #unknown.
  #
  # source://logger-1.7.0/lib/logger.rb:675
  ...
  #
  # source://logger-1.7.0/lib/logger.rb:755
  def close; end

  # Returns the date-time format; see #datetime_format=.
  #
  # source://logger-1.7.0/lib/logger.rb:438
  ...
  #
  # source://logger-1.7.0/lib/logger.rb:432
  def datetime_format=(datetime_format); end

  # Equivalent to calling #add with severity <tt>Logger::DEBUG</tt>.
  #
  # source://logger-1.7.0/lib/logger.rb:714
  def debug(progname = T.unsafe(nil), &block); end

  # Sets the log level to Logger::DEBUG.
  # See {Log Level}[rdoc-ref:Logger@Log+Level].
  #
  # source://logger-1.7.0/lib/logger.rb:487
  def debug!; end
  ...
  # @return [Boolean]
  #
  # source://logger-1.7.0/lib/logger.rb:482
  def debug?; end

  # Equivalent to calling #add with severity <tt>Logger::ERROR</tt>.
  #
  # source://logger-1.7.0/lib/logger.rb:732
  def error(progname = T.unsafe(nil), &block); end

  # Sets the log level to Logger::ERROR.
  # See {Log Level}[rdoc-ref:Logger@Log+Level].
  #
  # source://logger-1.7.0/lib/logger.rb:520
  def error!; end
  ...
  # @return [Boolean]
  #
  # source://logger-1.7.0/lib/logger.rb:515
  def error?; end

  # Equivalent to calling #add with severity <tt>Logger::FATAL</tt>.
  #
  # source://logger-1.7.0/lib/logger.rb:738
  def fatal(progname = T.unsafe(nil), &block); end

  # Sets the log level to Logger::FATAL.
  # See {Log Level}[rdoc-ref:Logger@Log+Level].
  #
  # source://logger-1.7.0/lib/logger.rb:531
  def fatal!; end
  ...
  # @return [Boolean]
  #
  # source://logger-1.7.0/lib/logger.rb:526
  def fatal?; end
  ...
  #
  # source://logger-1.7.0/lib/logger.rb:473
  def formatter; end
  ...
  # See {Log Level}[rdoc-ref:Logger@Log+Level].
  #
  # source://logger-1.7.0/lib/logger.rb:498
  def info!; end
  ...
  # @return [Boolean]
  #
  # source://logger-1.7.0/lib/logger.rb:493
  def info?; end

  # Logging severity threshold (e.g. <tt>Logger::INFO</tt>).
  #
  # source://logger-1.7.0/lib/logger.rb:383
  def level; end
  ...
  #
  # source://logger-1.7.0/lib/logger.rb:399
  ...
  #
  # source://logger-1.7.0/lib/logger.rb:422
  def progname; end
  ...
  #
  # source://logger-1.7.0/lib/logger.rb:642
  ...
  #
  # source://logger-1.7.0/lib/logger.rb:744
  def unknown(progname = T.unsafe(nil), &block); end

  # Equivalent to calling #add with severity <tt>Logger::WARN</tt>.
  #
  # source://logger-1.7.0/lib/logger.rb:726
  def warn(progname = T.unsafe(nil), &block); end

  # Sets the log level to Logger::WARN.
  # See {Log Level}[rdoc-ref:Logger@Log+Level].
  #
  # source://logger-1.7.0/lib/logger.rb:509
  def warn!; end
  ...
  # @return [Boolean]
  #
  # source://logger-1.7.0/lib/logger.rb:504
  def warn?; end
  ...
  #   end
  #
  # source://logger-1.7.0/lib/logger.rb:408
  def with_level(severity); end

  private

  # source://logger-1.7.0/lib/logger.rb:786
  def format_message(severity, datetime, progname, msg); end

  # source://logger-1.7.0/lib/logger.rb:764
  def format_severity(severity); end

  # source://logger-1.7.0/lib/logger.rb:782
  def level_key; end

  # Guarantee the existence of this ivar even when subclasses don't call the superclass constructor.
  #
  # source://logger-1.7.0/lib/logger.rb:769
  def level_override; end
end

# Default formatter for log messages.
#
# source://logger-1.7.0/lib/logger/formatter.rb:5
class Logger::Formatter
  # @return [Formatter] a new instance of Formatter
  #
  # source://logger-1.7.0/lib/logger/formatter.rb:11
  def initialize; end

  # source://logger-1.7.0/lib/logger/formatter.rb:15
  def call(severity, time, progname, msg); end

  # Returns the value of attribute datetime_format.
  #
  # source://logger-1.7.0/lib/logger/formatter.rb:9
  def datetime_format; end
  ...
  # source://logger-1.7.0/lib/logger/formatter.rb:21
  def format_datetime(time); end

  # source://logger-1.7.0/lib/logger/formatter.rb:25
  def msg2str(msg); end
end

# source://logger-1.7.0/lib/logger/formatter.rb:7
Logger::Formatter::DatetimeFormat = T.let(T.unsafe(nil), String)

# source://logger-1.7.0/lib/logger/formatter.rb:6
Logger::Formatter::Format = T.let(T.unsafe(nil), String)

# Device used for logging messages.
#
# source://logger-1.7.0/lib/logger/log_device.rb:7
class Logger::LogDevice
  ...
  #
  # source://logger-1.7.0/lib/logger/log_device.rb:14
  ...
  # source://logger-1.7.0/lib/logger/log_device.rb:38
  def close; end

  # Returns the value of attribute dev.
  #
  # source://logger-1.7.0/lib/logger/log_device.rb:10
  def dev; end

  # Returns the value of attribute filename.
  #
  # source://logger-1.7.0/lib/logger/log_device.rb:11
  def filename; end

  # source://logger-1.7.0/lib/logger/log_device.rb:48
  ...
  # source://logger-1.7.0/lib/logger/log_device.rb:27
  def write(message); end

  private

  # source://logger-1.7.0/lib/logger/log_device.rb:156
  def add_log_header(file); end

  # source://logger-1.7.0/lib/logger/log_device.rb:162
  def check_shift_log; end

  # source://logger-1.7.0/lib/logger/log_device.rb:132
  def create_logfile(filename); end

  # source://logger-1.7.0/lib/logger/log_device.rb:104
  def fixup_mode(dev); end

  # source://logger-1.7.0/lib/logger/log_device.rb:148
  def handle_write_errors(mesg); end

  # source://logger-1.7.0/lib/logger/log_device.rb:177
  def lock_shift_log; end

  # source://logger-1.7.0/lib/logger/log_device.rb:119
  def open_logfile(filename); end

  # source://logger-1.7.0/lib/logger/log_device.rb:78
  def set_dev(log); end

  # source://logger-1.7.0/lib/logger/log_device.rb:92
  def set_file(shift_age, shift_size, shift_period_suffix); end

  # source://logger-1.7.0/lib/logger/log_device.rb:207
  def shift_log_age; end

  # source://logger-1.7.0/lib/logger/log_device.rb:232
  def shift_log_file(shifted); end

  # source://logger-1.7.0/lib/logger/log_device.rb:216
  def shift_log_period(period_end); end
end

# :stopdoc:
#
# source://logger-1.7.0/lib/logger/log_device.rb:69
Logger::LogDevice::MODE = T.let(T.unsafe(nil), Integer)

# source://logger-1.7.0/lib/logger/log_device.rb:76
Logger::LogDevice::MODE_TO_CREATE = T.let(T.unsafe(nil), Integer)

# source://logger-1.7.0/lib/logger/log_device.rb:72
Logger::LogDevice::MODE_TO_OPEN = T.let(T.unsafe(nil), Integer)

# source://logger-1.7.0/lib/logger/period.rb:4
module Logger::Period
  private

  # source://logger-1.7.0/lib/logger/period.rb:9
  def next_rotate_time(now, shift_age); end

  # source://logger-1.7.0/lib/logger/period.rb:31
...
# source://logger-1.7.0/lib/logger/period.rb:7
Logger::Period::SiD = T.let(T.unsafe(nil), Integer)

# \Severity label for logging (max 5 chars).
#
# source://logger-1.7.0/lib/logger.rb:762
Logger::SEV_LABEL = T.let(T.unsafe(nil), Array)

# Logging severity.
#
# source://logger-1.7.0/lib/logger/severity.rb:5
module Logger::Severity
  class << self
    # source://logger-1.7.0/lib/logger/severity.rb:29
    def coerce(severity); end
  end
end

# source://logger-1.7.0/lib/logger/severity.rb:19
Logger::Severity::LEVELS = T.let(T.unsafe(nil), Hash)

# source://logger-1.7.0/lib/logger/log_device.rb:258
module PathAttr
  # source://logger-1.7.0/lib/logger/log_device.rb:259
  def path; end

  class << self
    # source://logger-1.7.0/lib/logger/log_device.rb:261
