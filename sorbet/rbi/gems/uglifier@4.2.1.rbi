...
#
# source://uglifier-4.2.1/lib/uglifier/version.rb:1
class Uglifier
  ...
  #
  # source://uglifier-4.2.1/lib/uglifier.rb:146
  ...
  #
  # source://uglifier-4.2.1/lib/uglifier.rb:159
  ...
  #
  # source://uglifier-4.2.1/lib/uglifier.rb:175
  ...
  # source://uglifier-4.2.1/lib/uglifier.rb:362
  def comment_options; end

  # source://uglifier-4.2.1/lib/uglifier.rb:393
  def comment_setting; end

  # source://uglifier-4.2.1/lib/uglifier.rb:340
  def compressor_options; end

  # source://uglifier-4.2.1/lib/uglifier.rb:476
  def conditional_option(value, defaults, overrides = T.unsafe(nil)); end

  # source://uglifier-4.2.1/lib/uglifier.rb:181
  def context; end

  # source://uglifier-4.2.1/lib/uglifier.rb:269
  def context_lines_message(source, line_number, column); end

  # source://uglifier-4.2.1/lib/uglifier.rb:456
  def enclose_options; end

  # source://uglifier-4.2.1/lib/uglifier.rb:466
  def encode_regexp(regexp); end

  # source://uglifier-4.2.1/lib/uglifier.rb:241
  def error_context_format_options(low, high, line_index, column); end

  # source://uglifier-4.2.1/lib/uglifier.rb:237
  def error_context_lines; end

  # source://uglifier-4.2.1/lib/uglifier.rb:283
  def error_message(result, options); end

  # source://uglifier-4.2.1/lib/uglifier.rb:498
  def extract_source_mapping_url(source); end

  # source://uglifier-4.2.1/lib/uglifier.rb:252
  def format_error_line(line, options); end

  # source://uglifier-4.2.1/lib/uglifier.rb:259
  def format_lines(lines, options); end

  # @return [Boolean]
  #
  # source://uglifier-4.2.1/lib/uglifier.rb:224
  def harmony?; end

  # source://uglifier-4.2.1/lib/uglifier.rb:228
  def harmony_error_message(message); end

  # @return [Boolean]
  #
  # source://uglifier-4.2.1/lib/uglifier.rb:416
  def ie8?; end

  # source://uglifier-4.2.1/lib/uglifier.rb:508
  def input_source_map(source, generate_map); end

  # @return [Boolean]
  #
  # source://uglifier-4.2.1/lib/uglifier.rb:420
  def keep_fnames?(type); end

  # source://uglifier-4.2.1/lib/uglifier.rb:308
  def mangle_options; end

  # source://uglifier-4.2.1/lib/uglifier.rb:321
  def mangle_properties_options; end

  # source://uglifier-4.2.1/lib/uglifier.rb:408
  def migrate_braces(options); end

  # Prevent negate_iife when wrap_iife is true
  #
  # source://uglifier-4.2.1/lib/uglifier.rb:354
  def negate_iife_block; end

  # source://uglifier-4.2.1/lib/uglifier.rb:403
  def output_options; end

  # source://uglifier-4.2.1/lib/uglifier.rb:443
  def parse_options; end

  # @raise [Error]
  #
  # source://uglifier-4.2.1/lib/uglifier.rb:290
  def parse_result(result, generate_map, options); end

  # source://uglifier-4.2.1/lib/uglifier.rb:448
  def parse_source_map_options; end

  # source://uglifier-4.2.1/lib/uglifier.rb:377
  def quote_style; end

  # source://uglifier-4.2.1/lib/uglifier.rb:300
  def read_source(source); end

  # Run UglifyJS for given source code
  #
  # source://uglifier-4.2.1/lib/uglifier.rb:208
  def run_uglifyjs(input, generate_map); end

  # source://uglifier-4.2.1/lib/uglifier.rb:486
  def sanitize_map_root(map); end

  # source://uglifier-4.2.1/lib/uglifier.rb:188
  def source_map_comments; end

  # source://uglifier-4.2.1/lib/uglifier.rb:429
  def source_map_options(input_map); end

  # source://uglifier-4.2.1/lib/uglifier.rb:200
  ...
  class << self
    ...
    # @return [String] minified code.
    #
    # source://uglifier-4.2.1/lib/uglifier.rb:130
    ...
    # @return [Array(String, String)] minified code and source map.
    #
    # source://uglifier-4.2.1/lib/uglifier.rb:139
