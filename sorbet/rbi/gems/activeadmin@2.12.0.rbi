...
#   end
#
# source://activeadmin-2.12.0/lib/active_admin/helpers/i18n.rb:2
module ActiveAdmin
  class << self
    ...
    #
    # source://activeadmin-2.12.0/lib/active_admin.rb:109
    def after_load(&block); end

    # Returns the value of attribute application.
    #
    # source://activeadmin-2.12.0/lib/active_admin.rb:61
    def application; end
    ...
    #
    # source://activeadmin-2.12.0/lib/active_admin.rb:59
    ...
    #
    # source://activeadmin-2.12.0/lib/active_admin.rb:91
    def before_load(&block); end

    # source://activeadmin-2.12.0/lib/active_admin.rb:75
    def load!(*_arg0, &_arg1); end

    # source://activeadmin-2.12.0/lib/active_admin.rb:72
    def register(*_arg0, &_arg1); end

    # source://activeadmin-2.12.0/lib/active_admin.rb:73
    def register_page(*_arg0, &_arg1); end

    # source://activeadmin-2.12.0/lib/active_admin.rb:76
    ...
    # @yield [application]
    #
    # source://activeadmin-2.12.0/lib/active_admin.rb:66
    def setup; end

    # source://activeadmin-2.12.0/lib/active_admin.rb:74
    def unload!(*_arg0, &_arg1); end

    private

    # source://activeadmin-2.12.0/lib/active_admin.rb:115
    def wrap_block_for_active_support_notifications(block); end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/abstract_view_factory.rb:3
class ActiveAdmin::AbstractViewFactory < ::ActiveAdmin::SettingsNode
  # source://activeadmin-2.12.0/lib/active_admin/abstract_view_factory.rb:40
  def [](key); end

  # source://activeadmin-2.12.0/lib/active_admin/abstract_view_factory.rb:44
  def []=(key, value); end

  # source://activeadmin-2.12.0/lib/active_admin/abstract_view_factory.rb:36
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/abstract_view_factory.rb:32
  def register(view_hash); end

  class << self
    # source://activeadmin-2.12.0/lib/active_admin/abstract_view_factory.rb:13
    def add_writer(name); end

    # source://activeadmin-2.12.0/lib/active_admin/abstract_view_factory.rb:5
    def register(view_hash); end
  end
end
...
#
# source://activeadmin-2.12.0/lib/active_admin/error.rb:6
class ActiveAdmin::AccessDenied < ::StandardError
  # @return [AccessDenied] a new instance of AccessDenied
  #
  # source://activeadmin-2.12.0/lib/active_admin/error.rb:9
  def initialize(user, action, subject = T.unsafe(nil)); end

  # Returns the value of attribute action.
  #
  # source://activeadmin-2.12.0/lib/active_admin/error.rb:7
  def action; end

  # source://activeadmin-2.12.0/lib/active_admin/error.rb:17
  def message; end
...
#
# source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:100
class ActiveAdmin::ActionItem
  include ::ActiveAdmin::OptionalDisplay

  # @return [ActionItem] a new instance of ActionItem
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:105
  def initialize(name, options = T.unsafe(nil), &block); end

  # Returns the value of attribute block.
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:103
  def block; end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:112
  def html_class; end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:116
  def priority; end
end

# source://activeadmin-2.12.0/lib/active_admin/application.rb:7
class ActiveAdmin::Application
  include ::ActiveAdmin::AssetRegistration

  # @return [Application] a new instance of Application
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:42
  def initialize; end

  # source://activeadmin-2.12.0/lib/active_admin/application.rb:152
  ...
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:159
  def controllers_for_filters; end

  # Returns ALL the files to be loaded
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:128
  def files; end

  # source://activeadmin-2.12.0/lib/active_admin/application.rb:123
  def load(file); end

  # Loads all ruby files that are within the load_paths setting.
  # To reload everything simply call `ActiveAdmin.unload!`
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:113
  def load!; end
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:100
  def loaded?; end

  # source://activeadmin-2.12.0/lib/active_admin/application.rb:31
  ...
  # @yield [namespace]
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:74
  def namespace(name); end

  # source://activeadmin-2.12.0/lib/active_admin/application.rb:23
  def namespace_settings; end

  # Returns the value of attribute namespaces.
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:41
  def namespaces; end

  # Runs after the app's AA initializer
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:58
  def prepare!; end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:64
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:94
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:141
  def routes(rails_router); end

  # source://activeadmin-2.12.0/lib/active_admin/application.rb:19
  def settings; end

  # Runs before the app's AA initializer
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:53
  def setup!; end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:106
  def unload!; end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:188
  def attach_reloader; end

  # source://activeadmin-2.12.0/lib/active_admin/application.rb:167
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:177
  def remove_active_admin_load_paths_from_rails_autoload_and_eager_load; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/application.rb:27
  def respond_to_missing?(method, include_private = T.unsafe(nil)); end

  class << self
    # source://activeadmin-2.12.0/lib/active_admin/application.rb:14
    def inheritable_setting(name, default); end

    # source://activeadmin-2.12.0/lib/active_admin/application.rb:10
    def setting(name, default); end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/application.rb:50
ActiveAdmin::Application::AfterLoadEvent = T.let(T.unsafe(nil), String)

# Event that gets triggered on load of Active Admin
#
# source://activeadmin-2.12.0/lib/active_admin/application.rb:49
ActiveAdmin::Application::BeforeLoadEvent = T.let(T.unsafe(nil), String)

# source://activeadmin-2.12.0/lib/active_admin/application_settings.rb:5
...
# source://activeadmin-2.12.0/lib/active_admin/asset_registration.rb:3
module ActiveAdmin::AssetRegistration
  # source://activeadmin-2.12.0/lib/active_admin/asset_registration.rb:25
  def clear_javascripts!; end

  # source://activeadmin-2.12.0/lib/active_admin/asset_registration.rb:13
  def clear_stylesheets!; end

  # source://activeadmin-2.12.0/lib/active_admin/asset_registration.rb:21
  def javascripts; end

  # source://activeadmin-2.12.0/lib/active_admin/asset_registration.rb:17
  def register_javascript(name); end

  # source://activeadmin-2.12.0/lib/active_admin/asset_registration.rb:5
  def register_stylesheet(path, options = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/asset_registration.rb:9
  def stylesheets; end
end

# source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:12
ActiveAdmin::Auth = ActiveAdmin::Authorization

# Default Authorization permissions for Active Admin
#
# source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:5
module ActiveAdmin::Authorization; end

# source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:7
ActiveAdmin::Authorization::CREATE = T.let(T.unsafe(nil), Symbol)

# source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:9
ActiveAdmin::Authorization::DESTROY = T.let(T.unsafe(nil), Symbol)

# source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:6
ActiveAdmin::Authorization::READ = T.let(T.unsafe(nil), Symbol)

# source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:8
...
#
# source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:19
class ActiveAdmin::AuthorizationAdapter
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:33
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:52
  def authorized?(action, subject = T.unsafe(nil)); end

  # Returns the value of attribute resource.
  #
  # source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:20
  def resource; end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:69
  ...
  #     end
  #
  # source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:112
  def normalized(klass); end
end

# source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:116
class ActiveAdmin::AuthorizationAdapter::NormalizedMatcher
  # @return [NormalizedMatcher] a new instance of NormalizedMatcher
  #
  # source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:118
  def initialize(klass); end

  # source://activeadmin-2.12.0/lib/active_admin/authorization_adapter.rb:122
  def ===(other); end
end
...
#   csv_builder.column :id
#
# source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:18
class ActiveAdmin::CSVBuilder
  # @return [CSVBuilder] a new instance of CSVBuilder
  #
  # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:34
  def initialize(options = T.unsafe(nil), &block); end

  # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:45
  def build(controller, csv); end

  # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:71
  def build_row(resource, columns, options); end

  # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:41
  def column(name, options = T.unsafe(nil), &block); end

  # Returns the value of attribute columns.
  #
  # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:30
  def columns; end

  # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:77
  def encode(content, options); end

  # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:64
  def exec_columns(view_context = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:89
  ...
  # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:119
  ...
  class << self
    ...
    #
    # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:23
    def default_for_resource(resource); end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:32
ActiveAdmin::CSVBuilder::COLUMN_TRANSITIVE_OPTIONS = T.let(T.unsafe(nil), Array)

# source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:97
class ActiveAdmin::CSVBuilder::Column
  # @return [Column] a new instance of Column
  #
  # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:102
  def initialize(name, resource = T.unsafe(nil), options = T.unsafe(nil), block = T.unsafe(nil)); end

  # Returns the value of attribute data.
  #
  # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:98
  def data; end

  # source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:108
...
# source://activeadmin-2.12.0/lib/active_admin/csv_builder.rb:100
ActiveAdmin::CSVBuilder::Column::DEFAULT_OPTIONS = T.let(T.unsafe(nil), Hash)

# source://activeadmin-2.12.0/lib/active_admin/callbacks.rb:3
module ActiveAdmin::Callbacks
  ...
  # need to do)
  #
  # source://activeadmin-2.12.0/lib/active_admin/callbacks.rb:15
  def run_callback(method, *args); end
end

# source://activeadmin-2.12.0/lib/active_admin/callbacks.rb:26
module ActiveAdmin::Callbacks::ClassMethods
  ...
  #   end
  #
  # source://activeadmin-2.12.0/lib/active_admin/callbacks.rb:59
  def define_active_admin_callbacks(*names); end
end

# source://activeadmin-2.12.0/lib/active_admin/cancan_adapter.rb:13
class ActiveAdmin::CanCanAdapter < ::ActiveAdmin::AuthorizationAdapter
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/cancan_adapter.rb:15
  def authorized?(action, subject = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/cancan_adapter.rb:19
  def cancan_ability; end

  # source://activeadmin-2.12.0/lib/active_admin/cancan_adapter.rb:23
  def scope_collection(collection, action = T.unsafe(nil)); end

  private

  # source://activeadmin-2.12.0/lib/active_admin/cancan_adapter.rb:29
...
#
# source://activeadmin-2.12.0/lib/active_admin/collection_decorator.rb:9
class ActiveAdmin::CollectionDecorator
  # @return [CollectionDecorator] a new instance of CollectionDecorator
  #
  # source://activeadmin-2.12.0/lib/active_admin/collection_decorator.rb:19
  def initialize(object, with:); end

  # source://activeadmin-2.12.0/lib/active_admin/collection_decorator.rb:17
  def &(*_arg0, &_arg1); end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/collection_decorator.rb:28
  def decorated_collection; end

  # @return [Class] the decorator class used to decorate each item, as set by {#initialize}.
  #
  # source://activeadmin-2.12.0/lib/active_admin/collection_decorator.rb:14
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/collection_decorator.rb:11
  def object; end
...
# source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/comment.rb:3
class ActiveAdmin::Comment < ::ActiveRecord::Base
  ...
  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/comment.rb:27
  ...
  class << self
    ...
    # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/comment.rb:19
    ...
    #
    # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/comment.rb:15
    def resource_type(resource); end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/comment.rb:0
...
# source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:6
module ActiveAdmin::Comments; end

# source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/namespace_helper.rb:5
module ActiveAdmin::Comments::NamespaceHelper
  # Returns true if the namespace allows comments
  #
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/namespace_helper.rb:8
  def comments?; end
end

# source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/resource_helper.rb:5
module ActiveAdmin::Comments::ResourceHelper
  extend ::ActiveSupport::Concern

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/resource_helper.rb:12
  def comments?; end
end
...
#
# source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/show_page_helper.rb:7
module ActiveAdmin::Comments::ShowPageHelper
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/show_page_helper.rb:18
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/show_page_helper.rb:11
  def default_main_content; end
end

# source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:7
module ActiveAdmin::Comments::Views; end

# source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:9
class ActiveAdmin::Comments::Views::Comments < ::ActiveAdmin::Views::Panel
  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:14
  def build(resource); end

  # Returns the value of attribute resource.
  #
  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:12
  def resource; end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:44
  def build_comment(comment); end

  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:81
  def build_comment_form; end

  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:29
  def build_comments; end

  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:61
  def build_empty_message; end

  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:73
  def comment_form_url; end

  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:65
  def comments_url(*args); end

  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:94
  def default_id_for_prefix; end

  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/views/active_admin_comments.rb:25
  def title; end
end

# source://activeadmin-2.12.0/lib/active_admin/component.rb:3
class ActiveAdmin::Component < ::Arbre::Component; end

# source://activeadmin-2.12.0/lib/active_admin/controller_action.rb:3
class ActiveAdmin::ControllerAction
  # @return [ControllerAction] a new instance of ControllerAction
  #
  # source://activeadmin-2.12.0/lib/active_admin/controller_action.rb:5
  def initialize(name, options = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/controller_action.rb:10
  def http_verb; end

  # Returns the value of attribute name.
  #
  # source://activeadmin-2.12.0/lib/active_admin/controller_action.rb:4
  def name; end
end

# source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:4
...
#
# source://activeadmin-2.12.0/lib/active_admin/dsl.rb:8
class ActiveAdmin::DSL
  # @return [DSL] a new instance of DSL
  #
  # source://activeadmin-2.12.0/lib/active_admin/dsl.rb:10
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/dsl.rb:87
  ...
  # @param options [Hash] valid keys include:
  #
  # source://activeadmin-2.12.0/lib/active_admin/dsl.rb:102
  ...
  #   end
  #
  # source://activeadmin-2.12.0/lib/active_admin/dsl.rb:152
  ...
  #   end
  #
  # source://activeadmin-2.12.0/lib/active_admin/dsl.rb:29
  def config; end
  ...
  #   end
  #
  # source://activeadmin-2.12.0/lib/active_admin/dsl.rb:74
  ...
  # @return [Nil]
  #
  # source://activeadmin-2.12.0/lib/active_admin/dsl.rb:55
  def include(mod); end

  # Set the options that are available for the item that will be placed in the global
  # navigation of the menu.
  #
  # source://activeadmin-2.12.0/lib/active_admin/dsl.rb:121
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/dsl.rb:134
  def navigation_menu(menu_name = T.unsafe(nil), &block); end

  # Runs the registration block inside this object
  #
  # source://activeadmin-2.12.0/lib/active_admin/dsl.rb:15
  def run_registration_block(&block); end

  # source://activeadmin-2.12.0/lib/active_admin/dsl.rb:156
  def sidebar(name, options = T.unsafe(nil), &block); end
end

# source://activeadmin-2.12.0/lib/active_admin/error.rb:32
class ActiveAdmin::DatabaseHitDuringLoad < ::ActiveAdmin::ErrorLoading
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/error.rb:33
  def initialize(exception); end

  class << self
    # source://activeadmin-2.12.0/lib/active_admin/error.rb:43
    def capture; end

    # source://activeadmin-2.12.0/lib/active_admin/error.rb:49
    def database_error_classes; end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/dependency.rb:3
module ActiveAdmin::Dependency
  class << self
    # source://activeadmin-2.12.0/lib/active_admin/dependency.rb:55
    def [](name); end
    ...
    # => false
    #
    # source://activeadmin-2.12.0/lib/active_admin/dependency.rb:45
    def method_missing(name, *args); end

    # @return [Boolean]
    #
    # source://activeadmin-2.12.0/lib/active_admin/dependency.rb:59
    def supports_zeitwerk?; end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/dependency.rb:63
class ActiveAdmin::Dependency::Matcher
  include ::Comparable

  # @return [Matcher] a new instance of Matcher
  #
  # source://activeadmin-2.12.0/lib/active_admin/dependency.rb:66
  def initialize(name); end

  # source://activeadmin-2.12.0/lib/active_admin/dependency.rb:90
  def <=>(other); end

  # source://activeadmin-2.12.0/lib/active_admin/dependency.rb:94
  def inspect; end

  # source://activeadmin-2.12.0/lib/active_admin/dependency.rb:82
  def match!(*reqs); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/dependency.rb:78
  def match?(*reqs); end

  # Returns the value of attribute name.
  #
  # source://activeadmin-2.12.0/lib/active_admin/dependency.rb:64
  def name; end

  # source://activeadmin-2.12.0/lib/active_admin/dependency.rb:70
  def spec; end

  # source://activeadmin-2.12.0/lib/active_admin/dependency.rb:74
  def spec!; end
end

# source://activeadmin-2.12.0/lib/active_admin/dependency.rb:4
module ActiveAdmin::Dependency::Requirements; end

# source://activeadmin-2.12.0/lib/active_admin/dependency.rb:5
ActiveAdmin::Dependency::Requirements::DEVISE = T.let(T.unsafe(nil), Array)

# source://activeadmin-2.12.0/lib/active_admin/error.rb:54
class ActiveAdmin::DependencyError < ::ActiveAdmin::ErrorLoading; end

# source://activeadmin-2.12.0/lib/active_admin/deprecation.rb:3
module ActiveAdmin::Deprecation
  private

  # source://activeadmin-2.12.0/lib/active_admin/deprecation.rb:6
...
# source://activeadmin-2.12.0/lib/active_admin/dynamic_setting.rb:4
class ActiveAdmin::DynamicSetting
  # @return [DynamicSetting] a new instance of DynamicSetting
  #
  # source://activeadmin-2.12.0/lib/active_admin/dynamic_setting.rb:15
  def initialize(setting); end

  # source://activeadmin-2.12.0/lib/active_admin/dynamic_setting.rb:19
  def value(*_args); end

  class << self
    # source://activeadmin-2.12.0/lib/active_admin/dynamic_setting.rb:5
    def build(setting, type); end

    # @raise [ArgumentError]
    #
    # source://activeadmin-2.12.0/lib/active_admin/dynamic_setting.rb:9
    def klass(type); end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/dynamic_settings_node.rb:7
class ActiveAdmin::DynamicSettingsNode < ::ActiveAdmin::SettingsNode
  class << self
    # source://activeadmin-2.12.0/lib/active_admin/dynamic_settings_node.rb:16
    def add_reader(name); end

    # source://activeadmin-2.12.0/lib/active_admin/dynamic_settings_node.rb:22
    def add_writer(name, type); end

    # source://activeadmin-2.12.0/lib/active_admin/dynamic_settings_node.rb:9
    def register(name, value, type = T.unsafe(nil)); end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/engine.rb:4
class ActiveAdmin::Engine < ::Rails::Engine; end

# source://activeadmin-2.12.0/lib/active_admin/error.rb:22
class ActiveAdmin::Error < ::RuntimeError; end

# source://activeadmin-2.12.0/lib/active_admin/error.rb:26
class ActiveAdmin::ErrorLoading < ::ActiveAdmin::Error
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/error.rb:27
  def find_cause(folder, backtrace); end
end

# source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:3
module ActiveAdmin::Filters; end

# source://activeadmin-2.12.0/lib/active_admin/filters/active.rb:7
class ActiveAdmin::Filters::Active
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/active.rb:16
  def initialize(resource, search); end

  # Returns the value of attribute filters.
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/active.rb:8
  def filters; end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/filters/active.rb:23
  def build_filters(conditions); end
end

# source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:5
class ActiveAdmin::Filters::ActiveFilter
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:14
  def initialize(resource, condition); end

  # Returns the value of attribute condition.
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:8
  def condition; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:48
  def html_options; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:29
  def label; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:42
  ...
  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:20
  def values; end

  private

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:58
  def attribute_name; end

  # @return Ransack::Nodes::Attribute
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:75
  def condition_attribute; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:100
  def filter; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:68
  def filter_label; end

  # detect related class for Ransack::Nodes::Attribute
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:92
  def find_class; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:87
  def find_class?; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:117
  def find_predicate_association; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:79
  def name; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:112
  def predicate_association; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:83
  def ransack_predicate_name; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:62
  def related_class_name; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:104
  def related_primary_key; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_filter.rb:54
  def resource_class; end
end

# source://activeadmin-2.12.0/lib/active_admin/filters/active_sidebar.rb:6
class ActiveAdmin::Filters::ActiveSidebar < ::ActiveAdmin::SidebarSection
  # @return [ActiveSidebar] a new instance of ActiveSidebar
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/active_sidebar.rb:8
  def initialize; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_sidebar.rb:12
  def block; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_sidebar.rb:16
  def title; end

  protected

  # source://activeadmin-2.12.0/lib/active_admin/filters/active_sidebar.rb:22
  def sidebar_options; end
end

# source://activeadmin-2.12.0/lib/active_admin/filters/dsl.rb:4
module ActiveAdmin::Filters::DSL
  # For docs, please see ActiveAdmin::Filters::ResourceExtension#add_filter
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/dsl.rb:7
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/dsl.rb:17
  def preserve_default_filters!; end

  # For docs, please see ActiveAdmin::Filters::ResourceExtension#remove_filter
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/dsl.rb:12
  def remove_filter(*attributes); end
end

# source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:5
class ActiveAdmin::Filters::Disabled < ::RuntimeError
  # @return [Disabled] a new instance of Disabled
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:6
  def initialize; end
end
...
#
# source://activeadmin-2.12.0/lib/active_admin/filters/forms.rb:6
class ActiveAdmin::Filters::FormBuilder < ::ActiveAdmin::FormBuilder
  include ::ActiveAdmin::Filters::FormtasticAddons

  # source://activeadmin-2.12.0/lib/active_admin/filters/forms.rb:13
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/forms.rb:23
...
# source://activeadmin-2.12.0/lib/active_admin/filters/formtastic_addons.rb:4
module ActiveAdmin::Filters::FormtasticAddons
  # source://activeadmin-2.12.0/lib/active_admin/filters/formtastic_addons.rb:27
  def column; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/formtastic_addons.rb:23
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/formtastic_addons.rb:63
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/formtastic_addons.rb:11
  def humanized_method_name; end

  # The resource class, unwrapped from Ransack
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/formtastic_addons.rb:36
  def klass; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/formtastic_addons.rb:40
  def polymorphic_foreign_type?(method); end

  # source://activeadmin-2.12.0/lib/active_admin/filters/formtastic_addons.rb:19
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/formtastic_addons.rb:68
  def scope?; end
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/formtastic_addons.rb:49
  def searchable_has_many_through?; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/formtastic_addons.rb:57
  def seems_searchable?; end
end

# source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:11
module ActiveAdmin::Filters::ResourceExtension
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:13
  ...
  # @raise [Disabled]
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:75
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:37
  def current_filters=(bool); end

  # @return [Boolean] If show current filters are enabled for this resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:47
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:23
  def filters; end
  ...
  # Set to `nil` to inherit the setting from the namespace
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:30
  def filters=(bool); end

  # @return [Boolean] If filters are enabled for this resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:42
  def filters_enabled?; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:51
  def preserve_default_filters!; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:55
  def preserve_default_filters?; end
  ...
  # @raise [Disabled]
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:63
  def remove_filter(*attributes); end

  # Reset the filters to use defaults
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:82
  def reset_filters!; end

  private

  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:163
  def add_filters_sidebar_section; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:173
  def add_search_status_sidebar_section; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:116
  def custom_ransack_filters; end

  # Returns a default set of filters for the associations
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:125
  def default_association_filters; end

  # @return [Array] The array of default filters for this resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:108
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:91
  def filter_lookup; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:167
  def filters_sidebar_section; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:155
  def search_columns; end

  # source://activeadmin-2.12.0/lib/active_admin/filters/resource_extension.rb:159
  def searchable_column_for(relation); end
end

# This module is included into the view
#
# source://activeadmin-2.12.0/lib/active_admin/filters/forms.rb:46
module ActiveAdmin::Filters::ViewHelper
  # Helper method to render a filter form
  #
  # source://activeadmin-2.12.0/lib/active_admin/filters/forms.rb:49
  def active_admin_filters_form_for(search, filters, options = T.unsafe(nil)); end

  private

  # source://activeadmin-2.12.0/lib/active_admin/filters/forms.rb:80
  def except_hidden_fields; end
end

# source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:16
class ActiveAdmin::FormBuilder < ::Formtastic::FormBuilder
  # Returns the value of attribute already_in_an_inputs_block.
  #
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:30
  ...
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:24
  def cancel_link(url = T.unsafe(nil), html_options = T.unsafe(nil), li_attrs = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:32
...
# source://activeadmin-2.12.0/lib/active_admin/error.rb:60
...
# nested decorators.
#
# source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:40
class ActiveAdmin::HasManyBuilder < ::SimpleDelegator
  # @return [HasManyBuilder] a new instance of HasManyBuilder
  #
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:46
  def initialize(has_many_form, assoc, options); end

  # Returns the value of attribute assoc.
  #
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:41
  def assoc; end

  # Returns the value of attribute destroy_option.
  #
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:44
  def destroy_option; end

  # Returns the value of attribute heading.
  #
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:43
  def heading; end
  ...
  # Returns the value of attribute options.
  #
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:42
  def options; end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:58
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:133
  def allow_destroy?(form_object); end

  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:85
  def assoc_klass; end

  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:89
  def content_has_many(&block); end

  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:80
  def default_heading; end

  # remove options that should not render as attributes
  #
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:70
  def extract_custom_settings!(options); end

  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:109
  def has_many_actions(form_builder, contents); end

  # Capture the ADD JS
  #
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:162
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:103
  def render_has_many_form(form_builder, parent, &block); end

  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:144
  def sorted_children(column); end

  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:151
  def without_wrapper; end

  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:178
  def wrap_div_or_li(html); end
end

# source://activeadmin-2.12.0/lib/active_admin/helpers/i18n.rb:3
module ActiveAdmin::Helpers; end

# source://activeadmin-2.12.0/lib/active_admin/helpers/collection.rb:4
module ActiveAdmin::Helpers::Collection
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/helpers/collection.rb:16
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/helpers/collection.rb:7
  def collection_size(c = T.unsafe(nil)); end
end

# source://activeadmin-2.12.0/lib/active_admin/helpers/i18n.rb:4
module ActiveAdmin::Helpers::I18n; end

# source://activeadmin-2.12.0/lib/active_admin/helpers/i18n.rb:5
ActiveAdmin::Helpers::I18n::PLURAL_MANY_COUNT = T.let(T.unsafe(nil), Float)

# source://activeadmin-2.12.0/lib/active_admin/inputs.rb:3
module ActiveAdmin::Inputs
  extend ::ActiveSupport::Autoload
end

# source://activeadmin-2.12.0/lib/active_admin/inputs/datepicker_input.rb:4
class ActiveAdmin::Inputs::DatepickerInput < ::Formtastic::Inputs::StringInput
  # source://activeadmin-2.12.0/lib/active_admin/inputs/datepicker_input.rb:5
  def input_html_options; end

  # Can pass proc to filter label option
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/datepicker_input.rb:14
  def label_from_options; end

  private

  # source://activeadmin-2.12.0/lib/active_admin/inputs/datepicker_input.rb:21
  def datepicker_options; end
end

# source://activeadmin-2.12.0/lib/active_admin/inputs.rb:8
module ActiveAdmin::Inputs::Filters
  extend ::ActiveSupport::Autoload
end

# source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base.rb:5
module ActiveAdmin::Inputs::Filters::Base
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base.rb:34
  def collection_from_options; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base.rb:12
  def input_wrapping(&block); end

  # Can pass proc to filter label option
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base.rb:21
  def label_from_options; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base.rb:16
  def required?; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base.rb:27
  def wrapper_html_options; end
end

# source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base/search_method_select.rb:19
module ActiveAdmin::Inputs::Filters::Base::SearchMethodSelect
  ...
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base/search_method_select.rb:59
  def current_filter; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base/search_method_select.rb:66
  def filter_options; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base/search_method_select.rb:55
  def filters; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base/search_method_select.rb:47
  def input_html; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base/search_method_select.rb:51
  def select_html; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base/search_method_select.rb:39
  def to_html; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base/search_method_select.rb:33
  def wrapper_html_options; end

  class << self
    # @private
    #
    # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base/search_method_select.rb:21
    def included(base); end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base/search_method_select.rb:25
module ActiveAdmin::Inputs::Filters::Base::SearchMethodSelect::ClassMethods
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base/search_method_select.rb:28
  def filter(*filters); end

  # Returns the value of attribute filters.
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/base/search_method_select.rb:26
  def filters; end
end

# source://activeadmin-2.12.0/lib/active_admin/inputs/filters/boolean_input.rb:5
class ActiveAdmin::Inputs::Filters::BooleanInput < ::Formtastic::Inputs::SelectInput
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/boolean_input.rb:19
  def include_blank; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/boolean_input.rb:14
  def input_html_options_name; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/boolean_input.rb:8
  def input_name; end
end

# source://activeadmin-2.12.0/lib/active_admin/inputs/filters/check_boxes_input.rb:5
class ActiveAdmin::Inputs::Filters::CheckBoxesInput < ::Formtastic::Inputs::CheckBoxesInput
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/check_boxes_input.rb:25
  def choice_label(choice); end

  # Don't wrap in LI tag
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/check_boxes_input.rb:35
  def choice_wrapping(html_options, &block); end

  # Don't wrap in UL tag
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/check_boxes_input.rb:30
  def choices_group_wrapping(&block); end

  # Don't render hidden fields
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/check_boxes_input.rb:40
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/check_boxes_input.rb:45
  def hidden_fields?; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/check_boxes_input.rb:8
  def input_name; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/check_boxes_input.rb:16
  def searchable_method_name; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/check_boxes_input.rb:12
  def selected_values; end
end

# source://activeadmin-2.12.0/lib/active_admin/inputs/filters/date_picker_input.rb:5
class ActiveAdmin::Inputs::Filters::DatePickerInput < ::Formtastic::Inputs::DatePickerInput
  include ::ActiveAdmin::Filters::FormtasticAddons
  include ::ActiveAdmin::Inputs::Filters::Base

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/date_picker_input.rb:8
  def input_html_options; end
end

# source://activeadmin-2.12.0/lib/active_admin/inputs/filters/date_range_input.rb:5
class ActiveAdmin::Inputs::Filters::DateRangeInput < ::Formtastic::Inputs::StringInput
  include ::ActiveAdmin::Filters::FormtasticAddons
  include ::ActiveAdmin::Inputs::Filters::Base

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/date_range_input.rb:17
  def gt_input_name; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/date_range_input.rb:43
  def gt_input_placeholder; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/date_range_input.rb:26
  def input_html_options; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/date_range_input.rb:32
  def input_html_options_for(input_name, placeholder); end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/date_range_input.rb:17
  def input_name; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/date_range_input.rb:22
  def lt_input_name; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/date_range_input.rb:47
  def lt_input_placeholder; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/date_range_input.rb:8
  def to_html; end
end

# source://activeadmin-2.12.0/lib/active_admin/inputs/filters/numeric_input.rb:5
...
# source://activeadmin-2.12.0/lib/active_admin/inputs/filters/select_input.rb:5
class ActiveAdmin::Inputs::Filters::SelectInput < ::Formtastic::Inputs::SelectInput
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/select_input.rb:40
  def collection; end

  # Provide the AA translation to the blank input field.
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/select_input.rb:25
  def include_blank; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/select_input.rb:29
  def input_html_options_name; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/select_input.rb:8
  def input_name; end
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/select_input.rb:35
  def multiple_by_association?; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/select_input.rb:48
  def pluck_column; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/select_input.rb:52
  def reflection_searchable?; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/select_input.rb:14
  def searchable_method_name; end
end

# source://activeadmin-2.12.0/lib/active_admin/inputs/filters/string_input.rb:5
class ActiveAdmin::Inputs::Filters::StringInput < ::Formtastic::Inputs::StringInput
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/string_input.rb:13
  def to_html; end
end

# source://activeadmin-2.12.0/lib/active_admin/inputs/filters/text_input.rb:5
class ActiveAdmin::Inputs::Filters::TextInput < ::Formtastic::Inputs::TextInput
  ...
  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/text_input.rb:9
  def input_html_options; end

  # source://activeadmin-2.12.0/lib/active_admin/inputs/filters/text_input.rb:16
  def to_html; end
end

# source://activeadmin-2.12.0/lib/active_admin/localizers/resource_localizer.rb:3
module ActiveAdmin::Localizers
  class << self
    # source://activeadmin-2.12.0/lib/active_admin/localizers.rb:7
    def resource(active_admin_config); end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/localizers/resource_localizer.rb:4
class ActiveAdmin::Localizers::ResourceLocalizer
  # @return [ResourceLocalizer] a new instance of ResourceLocalizer
  #
  # source://activeadmin-2.12.0/lib/active_admin/localizers/resource_localizer.rb:16
  def initialize(model_name, model = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/localizers/resource_localizer.rb:21
  ...
  # source://activeadmin-2.12.0/lib/active_admin/localizers/resource_localizer.rb:31
  def array_to_key(*arr); end

  class << self
    # source://activeadmin-2.12.0/lib/active_admin/localizers/resource_localizer.rb:6
    def from_resource(resource_config); end

    # source://activeadmin-2.12.0/lib/active_admin/localizers/resource_localizer.rb:10
...
#
# source://activeadmin-2.12.0/lib/active_admin/menu.rb:16
class ActiveAdmin::Menu
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu.rb:18
  def initialize; end
end

# source://activeadmin-2.12.0/lib/active_admin/menu.rb:23
module ActiveAdmin::Menu::MenuNode
  # source://activeadmin-2.12.0/lib/active_admin/menu.rb:24
  def initialize; end

  # source://activeadmin-2.12.0/lib/active_admin/menu.rb:28
  def [](id); end

  # source://activeadmin-2.12.0/lib/active_admin/menu.rb:32
  def []=(id, child); end
  ...
  # @yield [item]
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu.rb:50
  def add(options); end

  # Returns the value of attribute children.
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu.rb:79
  def children; end
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu.rb:71
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu.rb:66
  def include?(item); end

  # source://activeadmin-2.12.0/lib/active_admin/menu.rb:75
  def items; end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu.rb:85
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu.rb:81
  def children=(_arg0); end

  # source://activeadmin-2.12.0/lib/active_admin/menu.rb:91
...
#
# source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:8
class ActiveAdmin::MenuCollection
  # @return [MenuCollection] a new instance of MenuCollection
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:9
  def initialize; end

  # Add a new menu item to a menu in the collection
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:16
  def add(menu_name, menu_item_options = T.unsafe(nil)); end

  # Add callbacks that will be run before the menu is built
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:48
  def before_build(&block); end

  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:22
  def clear!; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:27
  def exists?(menu_name); end

  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:31
  def fetch(menu_name); end

  # @yield [menu]
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:52
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:43
  def on_build(&block); end

  private

  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:81
  def build_default_menu; end

  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:66
  def build_menus!; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:62
  def built?; end

  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:85
  def find_or_create(menu_name); end

  # source://activeadmin-2.12.0/lib/active_admin/menu_collection.rb:75
  def run_on_build_callbacks; end
end

# source://activeadmin-2.12.0/lib/active_admin/menu_item.rb:3
class ActiveAdmin::MenuItem
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu_item.rb:47
  def initialize(options = T.unsafe(nil)); end

  # Returns the value of attribute html_options.
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu_item.rb:6
  def html_options; end

  # source://activeadmin-2.12.0/lib/active_admin/menu_item.rb:60
  def id; end

  # Returns the value of attribute label.
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu_item.rb:64
  def label; end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu_item.rb:68
  def should_display; end

  # Returns the value of attribute url.
  #
  # source://activeadmin-2.12.0/lib/active_admin/menu_item.rb:65
  def url; end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/model.rb:3
class ActiveAdmin::Model
  # @return [Model] a new instance of Model
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/model.rb:4
  def initialize(resource, record); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/model.rb:12
  def to_model; end
end
...
#
# source://activeadmin-2.12.0/lib/active_admin/namespace.rb:28
class ActiveAdmin::Namespace
  include ::ActiveAdmin::Comments::NamespaceHelper

  # @return [Namespace] a new instance of Namespace
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:39
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:166
  ...
  # @param html_options [Hash] An options hash to pass along to link_to
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:150
  def add_logout_button_to_menu(menu, priority = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # Returns the value of attribute application.
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:37
  def application; end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:136
  def build_menu(name = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:122
  ...
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:59
  def method_missing(method, *args); end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:103
  def module_name; end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:47
  def name; end
  ...
  # namespace instance.
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:66
  def register(resource_class, options = T.unsafe(nil), &block); end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:81
  def register_page(name, options = T.unsafe(nil), &block); end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:126
  def reset_menu!; end

  # Returns the first registered ActiveAdmin::Resource instance for a given class
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:118
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:92
  def root?; end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:107
  def route_prefix; end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:51
  def settings; end

  # Unload all the registered resources for this namespace
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:112
  def unload!; end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:190
  def build_default_utility_nav; end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:177
  def build_menu_collection; end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:203
  def build_page(name, options); end

  # Either returns an existing Resource instance or builds a new one.
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:199
  def find_or_build_resource(resource_class, options); end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:246
  def parse_page_registration_block(config, &block); end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:241
  def parse_registration_block(config, &block); end

  # Creates a ruby module to namespace all the classes in if required
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:229
  def register_module; end

  # TODO: replace `eval` with `Class.new`
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:208
  def register_page_controller(config); end

  # TODO: replace `eval` with `Class.new`
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:236
  def register_resource_controller(config); end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:213
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:55
  def respond_to_missing?(method, include_private = T.unsafe(nil)); end

  class << self
    # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:30
    def setting(name, default); end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/namespace.rb:35
ActiveAdmin::Namespace::RegisterEvent = T.let(T.unsafe(nil), String)

# source://activeadmin-2.12.0/lib/active_admin/namespace.rb:250
class ActiveAdmin::Namespace::Store
  include ::Enumerable

  # @return [Store] a new instance of Store
  #
  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:254
  def initialize; end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:252
  def [](*_arg0, &_arg1); end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:252
  def []=(*_arg0, &_arg1); end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:258
  def each(&block); end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:252
  def empty?(*_arg0, &_arg1); end

  # source://activeadmin-2.12.0/lib/active_admin/namespace.rb:262
  def names; end
end

# source://activeadmin-2.12.0/lib/active_admin/namespace_settings.rb:6
class ActiveAdmin::NamespaceSettings < ::ActiveAdmin::DynamicSettingsNode
  ...
  class << self
    # source://activeadmin-2.12.0/lib/active_admin/dynamic_settings_node.rb:17
    def authentication_method(*args); end

    # source://activeadmin-2.12.0/lib/active_admin/dynamic_settings_node.rb:23
...
# source://activeadmin-2.12.0/lib/active_admin/error.rb:57
...
#
# source://activeadmin-2.12.0/lib/active_admin/helpers/optional_display.rb:17
module ActiveAdmin::OptionalDisplay
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/helpers/optional_display.rb:18
  def display_on?(action, render_context = T.unsafe(nil)); end

  private

  # source://activeadmin-2.12.0/lib/active_admin/helpers/optional_display.rb:34
  def normalize_display_options!; end
end

# source://activeadmin-2.12.0/lib/active_admin/order_clause.rb:3
class ActiveAdmin::OrderClause
  # @return [OrderClause] a new instance of OrderClause
  #
  # source://activeadmin-2.12.0/lib/active_admin/order_clause.rb:6
  def initialize(active_admin_config, clause); end

  # Returns the value of attribute active_admin_config.
  #
  # source://activeadmin-2.12.0/lib/active_admin/order_clause.rb:4
  def active_admin_config; end

  # source://activeadmin-2.12.0/lib/active_admin/order_clause.rb:19
  def apply(chain); end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/order_clause.rb:36
  def sql; end

  # source://activeadmin-2.12.0/lib/active_admin/order_clause.rb:27
  def table; end

  # source://activeadmin-2.12.0/lib/active_admin/order_clause.rb:31
  def table_column; end

  # source://activeadmin-2.12.0/lib/active_admin/order_clause.rb:23
  def to_sql; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/order_clause.rb:15
  def valid?; end

  protected

  # source://activeadmin-2.12.0/lib/active_admin/order_clause.rb:42
  def custom_sql; end
end
...
#
# source://activeadmin-2.12.0/lib/active_admin/page.rb:11
class ActiveAdmin::Page
  ...
  # source://activeadmin-2.12.0/lib/active_admin/page.rb:77
  def add_default_action_items; end

  # source://activeadmin-2.12.0/lib/active_admin/page.rb:80
  def add_default_sidebar_sections; end

  # source://activeadmin-2.12.0/lib/active_admin/page.rb:88
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/page.rb:99
  def belongs_to?; end

  # source://activeadmin-2.12.0/lib/active_admin/page.rb:94
  def belongs_to_config; end

  # Set breadcrumb builder
  #
  # source://activeadmin-2.12.0/lib/active_admin/page.rb:103
  def breadcrumb; end

  # Set breadcrumb builder
  #
  # source://activeadmin-2.12.0/lib/active_admin/page.rb:23
  def breadcrumb=(_arg0); end

  # source://activeadmin-2.12.0/lib/active_admin/page.rb:56
  def camelized_resource_name; end

  # Clears all the custom actions this page knows about
  #
  # source://activeadmin-2.12.0/lib/active_admin/page.rb:84
  def clear_page_actions!; end

  # source://activeadmin-2.12.0/lib/active_admin/page.rb:68
  def controller_name; end

  # source://activeadmin-2.12.0/lib/active_admin/page.rb:64
  def default_menu_options; end

  # The name of the page
  #
  # source://activeadmin-2.12.0/lib/active_admin/page.rb:17
  def name; end

  # The namespace this config belongs to
  #
  # source://activeadmin-2.12.0/lib/active_admin/page.rb:14
  def namespace; end

  # source://activeadmin-2.12.0/lib/active_admin/page.rb:60
  def namespace_name; end

  # source://activeadmin-2.12.0/lib/active_admin/page.rb:107
  def order_clause; end

  # An array of custom actions defined for this page
  #
  # source://activeadmin-2.12.0/lib/active_admin/page.rb:20
  def page_actions; end

  # label is singular
  #
  # source://activeadmin-2.12.0/lib/active_admin/page.rb:44
  def plural_resource_label; end

  # source://activeadmin-2.12.0/lib/active_admin/page.rb:48
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/page.rb:73
  def route_uncountable?; end

  # source://activeadmin-2.12.0/lib/active_admin/page.rb:52
  def underscored_resource_name; end
end

# source://activeadmin-2.12.0/lib/active_admin/page.rb:25
module ActiveAdmin::Page::Base
  # source://activeadmin-2.12.0/lib/active_admin/page.rb:26
  def initialize(namespace, name, options); end
end

# This is the class where all the register_page blocks are evaluated.
#
# source://activeadmin-2.12.0/lib/active_admin/page_dsl.rb:4
class ActiveAdmin::PageDSL < ::ActiveAdmin::DSL
  # source://activeadmin-2.12.0/lib/active_admin/page_dsl.rb:29
  def belongs_to(target, options = T.unsafe(nil)); end
  ...
  #   end
  #
  # source://activeadmin-2.12.0/lib/active_admin/page_dsl.rb:18
  def content(options = T.unsafe(nil), &block); end

  # source://activeadmin-2.12.0/lib/active_admin/page_dsl.rb:22
...
#
# source://activeadmin-2.12.0/lib/active_admin/page_presenter.rb:18
class ActiveAdmin::PagePresenter
  # @return [PagePresenter] a new instance of PagePresenter
  #
  # source://activeadmin-2.12.0/lib/active_admin/page_presenter.rb:24
  def initialize(options = T.unsafe(nil), &block); end

  # source://activeadmin-2.12.0/lib/active_admin/page_presenter.rb:29
  def [](key); end

  # Returns the value of attribute block.
  #
  # source://activeadmin-2.12.0/lib/active_admin/page_presenter.rb:20
  def block; end

  # source://activeadmin-2.12.0/lib/active_admin/page_presenter.rb:22
  def fetch(*_arg0, &_arg1); end
...
# by calling the #active_admin_config method.
#
# source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:6
class ActiveAdmin::Resource
  ...
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:191
  def association_columns; end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:139
  def belongs_to(target, options = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:157
  def belongs_to?; end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:146
  def belongs_to_config; end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:150
  def belongs_to_param; end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:166
  def breadcrumb; end

  # Set breadcrumb builder
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:55
  def breadcrumb=(_arg0); end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:130
  def clear_collection_actions!; end

  # Clears all the member actions this resource knows about
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:126
  def clear_member_actions!; end

  # An array of collection actions defined for this resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:43
  def collection_actions; end

  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/resource_helper.rb:9
  def comments; end

  # source://activeadmin-2.12.0/lib/active_admin/orm/active_record/comments/resource_helper.rb:9
  def comments=(_arg0); end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:195
  def content_columns; end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:174
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:61
  def create_another=(_arg0); end

  # The csv builder for this resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:162
  def csv_builder; end

  # Set the configuration for the CSV
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:52
  def csv_builder=(_arg0); end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:105
  def decorator_class; end

  # The string identifying a class to decorate our resource with for the view.
  # nil to not decorate.
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:68
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:135
  def defined_actions; end

  # Store a reference to the DSL so that we can dereference it during garbage collection.
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:64
  def dsl; end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:178
  def find_resource(id); end

  # An array of member actions defined for this resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:40
  def member_actions; end

  # The namespace this config belongs to
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:34
  def namespace; end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:170
  def order_clause; end

  # Set order clause
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:58
  def order_clause=(_arg0); end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:187
  def resource_attributes; end

  # The class this resource wraps. If you register the Post model, Resource#resource_class
  # will point to the Post class
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:101
  def resource_class; end

  # The name of the resource class
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:37
  def resource_class_name; end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:117
  def resource_column_names; end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:183
  def resource_columns; end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:109
  def resource_name_extension; end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:121
  def resource_quoted_column_name(column); end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:113
  def resource_table_name; end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:47
  def sort_order; end

  # The default sort order to use in the controller
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:46
  def sort_order=(_arg0); end

  private

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:209
  def default_csv_builder; end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:213
  def define_resource_name_extension(resource); end

  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:201
  def method_for_find(id); end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:7
module ActiveAdmin::Resource::ActionItems
  # Adds the default action items to a resource when it's initialized
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:10
  def initialize(*args); end

  # @return [Array] The set of action items for this resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:16
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:52
  def action_items?; end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:42
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:29
  def add_action_item(name, options = T.unsafe(nil), &block); end

  # Clears all the existing action items for this resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:47
  def clear_action_items!; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:33
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:59
  def add_default_action_items; end

  # Adds the default Edit link on show
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:76
  def add_default_edit_action_item; end

  # Adds the default New link on index
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:66
  def add_default_new_action_item; end

  # Adds the default Destroy link on show
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/action_items.rb:86
  def add_default_show_action_item; end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/attributes.rb:5
module ActiveAdmin::Resource::Attributes
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/attributes.rb:39
  def counter_cache_col?(c); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/attributes.rb:7
  def default_attributes; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/attributes.rb:43
  def filtered_col?(c); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/attributes.rb:20
  def foreign_methods; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/attributes.rb:16
  def method_for_column(c); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/attributes.rb:31
  def primary_col?(c); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/attributes.rb:27
  def reject_col?(c); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/attributes.rb:35
  def sti_col?(c); end
end

# source://activeadmin-2.12.0/lib/active_admin/resource.rb:70
module ActiveAdmin::Resource::Base
  # source://activeadmin-2.12.0/lib/active_admin/resource.rb:71
  def initialize(namespace, resource_class, options = T.unsafe(nil)); end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/belongs_to.rb:6
class ActiveAdmin::Resource::BelongsTo
  # @return [BelongsTo] a new instance of BelongsTo
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/belongs_to.rb:21
  def initialize(owner, target_name, options = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/belongs_to.rb:37
  def namespace; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/belongs_to.rb:41
  def optional?; end

  # The resource which initiated this relationship
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/belongs_to.rb:16
  def owner; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/belongs_to.rb:45
  def required?; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/belongs_to.rb:32
  def resource; end

  # Returns the target resource class or raises an exception if it doesn't exist
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/belongs_to.rb:28
  def target; end

  # The name of the relation
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/belongs_to.rb:19
  def target_name; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/belongs_to.rb:49
  def to_param; end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/belongs_to.rb:8
class ActiveAdmin::Resource::BelongsTo::TargetNotFound < ::StandardError
  # @return [TargetNotFound] a new instance of TargetNotFound
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/belongs_to.rb:9
  def initialize(key, namespace); end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/controllers.rb:4
module ActiveAdmin::Resource::Controllers
  # Returns the controller for this config
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/controllers.rb:14
  def controller; end

  # Returns a properly formatted controller name for this
  # config within its namespace
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/controllers.rb:9
  def controller_name; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/controllers.rb:5
  def resources_configuration(*_arg0, &_arg1); end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/includes.rb:4
module ActiveAdmin::Resource::Includes
  # Return an array of includes for this resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/includes.rb:7
  def includes; end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/menu.rb:5
module ActiveAdmin::Resource::Menu
  # source://activeadmin-2.12.0/lib/active_admin/resource/menu.rb:53
  def add_to_menu(menu_collection); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/menu.rb:24
  def default_menu_options; end
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/menu.rb:62
  def include_in_menu?; end

  # Returns the value of attribute menu_item.
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/menu.rb:59
  def menu_item; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/menu.rb:20
  def menu_item_options; end

  # Set the menu options.
  # To disable this menu item, call `menu(false)` from the DSL
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/menu.rb:9
  def menu_item_options=(options); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/menu.rb:49
  def navigation_menu; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/menu.rb:40
  def navigation_menu_name; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/menu.rb:36
  def navigation_menu_name=(menu_name); end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/naming.rb:42
class ActiveAdmin::Resource::Name < ::ActiveModel::Name
  # @return [Name] a new instance of Name
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/naming.rb:45
  def initialize(klass, name = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/naming.rb:57
  def eql?(other); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/naming.rb:43
  def hash(*_arg0, &_arg1); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/naming.rb:53
  def route_key; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/naming.rb:49
  def translate(options = T.unsafe(nil)); end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/naming.rb:5
module ActiveAdmin::Resource::Naming
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/naming.rb:33
  def param_key; end

  # Returns the plural version of this resource such as "Bank Accounts"
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/naming.rb:25
  def plural_resource_label(options = T.unsafe(nil)); end

  # Returns the name to call this resource such as "Bank Account"
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/naming.rb:19
  def resource_label; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/naming.rb:6
  def resource_name; end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/ordering.rb:4
module ActiveAdmin::Resource::Ordering
  # source://activeadmin-2.12.0/lib/active_admin/resource/ordering.rb:6
  def ordering; end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/page_presenters.rb:4
module ActiveAdmin::Resource::PagePresenters
  # for setting default css class in admin ui
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/page_presenters.rb:7
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/page_presenters.rb:37
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/page_presenters.rb:12
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/page_presenters.rb:20
  ...
  # @return [Class]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/page_presenters.rb:72
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/page_presenters.rb:55
  def set_index_presenter(index_as, page_presenter); end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/pagination.rb:5
module ActiveAdmin::Resource::Pagination
  # source://activeadmin-2.12.0/lib/active_admin/resource/pagination.rb:16
  def initialize(*args); end

  # The default number of records to display per page
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/pagination.rb:11
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/pagination.rb:14
  def paginate; end
  ...
  # The default number of records to display per page
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/pagination.rb:8
  def per_page; end
...
#
# source://activeadmin-2.12.0/lib/active_admin/resource.rb:31
ActiveAdmin::Resource::RegisterEvent = T.let(T.unsafe(nil), String)

# source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:4
module ActiveAdmin::Resource::Routes
  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:12
  def route_batch_action_path(params = T.unsafe(nil), additional_params = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:36
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:8
  def route_collection_path(params = T.unsafe(nil), additional_params = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:23
  ...
  # @return [String] the path to this resource collection page
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:19
  def route_instance_path(resource, additional_params = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:27
  def route_member_action_path(action, resource, additional_params = T.unsafe(nil)); end

  # Returns the routes prefix for this config
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:32
  def route_prefix; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:40
  def route_uncountable?; end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:46
class ActiveAdmin::Resource::Routes::RouteBuilder
  # @return [RouteBuilder] a new instance of RouteBuilder
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:47
  def initialize(resource); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:60
  def batch_action_path(params, additional_params = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:51
  ...
  # @return [String] the path to this resource collection page
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:75
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:85
  def member_action_path(action, instance, additional_params = T.unsafe(nil)); end

  private

  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:136
  def belongs_to_config; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:132
  def belongs_to_name; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:128
  def belongs_to_target_name; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:124
  def nested?; end

  # Returns the value of attribute resource.
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:94
  def resource; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:118
  def route_collection_params(params); end

  # @return params to pass to instance path
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:110
  def route_instance_params(instance); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:96
  def route_name(resource_path_name, options = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/routes.rb:140
  def routes; end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/scope_to.rb:4
module ActiveAdmin::Resource::ScopeTo
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/scope_to.rb:38
  def scope_to(*args, &block); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/scope_to.rb:66
  def scope_to?(context = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/resource/scope_to.rb:49
  def scope_to_association_method; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/scope_to.rb:57
  def scope_to_config; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/scope_to.rb:53
  def scope_to_method; end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/scopes.rb:4
module ActiveAdmin::Resource::Scopes
  # source://activeadmin-2.12.0/lib/active_admin/resource/scopes.rb:17
  def default_scope(context = T.unsafe(nil)); end

  # Returns a scope for this object by its identifier
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/scopes.rb:12
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/scopes.rb:30
  def scope(*args, &block); end

  # Return an array of scopes for this resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/scopes.rb:7
  def scopes; end
end

# source://activeadmin-2.12.0/lib/active_admin/resource/sidebars.rb:7
module ActiveAdmin::Resource::Sidebars
  # source://activeadmin-2.12.0/lib/active_admin/resource/sidebars.rb:13
  def clear_sidebar_sections!; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/sidebars.rb:9
  def sidebar_sections; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource/sidebars.rb:22
  def sidebar_sections?; end

  # source://activeadmin-2.12.0/lib/active_admin/resource/sidebars.rb:17
...
#
# source://activeadmin-2.12.0/lib/active_admin/resource_collection.rb:5
class ActiveAdmin::ResourceCollection
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_collection.rb:10
  def initialize; end

  # source://activeadmin-2.12.0/lib/active_admin/resource_collection.rb:28
  def [](obj); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_collection.rb:14
  def add(resource); end

  # Changes `each` to pass in the value, instead of both the key and value.
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_collection.rb:24
  def each(&block); end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_collection.rb:35
  def find_resource(obj); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_collection.rb:50
  def raise_if_mismatched!(existing, given); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_collection.rb:46
  def resources; end
end

# source://activeadmin-2.12.0/lib/active_admin/resource_collection.rb:65
class ActiveAdmin::ResourceCollection::ConfigMismatch < ::StandardError
  # @return [ConfigMismatch] a new instance of ConfigMismatch
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_collection.rb:66
  def initialize(existing, given); end
end

# source://activeadmin-2.12.0/lib/active_admin/resource_collection.rb:58
class ActiveAdmin::ResourceCollection::IncorrectClass < ::StandardError
  # @return [IncorrectClass] a new instance of IncorrectClass
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_collection.rb:59
  def initialize(existing, given); end
end

# This is the class where all the register blocks are evaluated.
#
# source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:4
class ActiveAdmin::ResourceDSL < ::ActiveAdmin::DSL
  include ::ActiveAdmin::Filters::DSL

  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:207
  def actions(*_arg0, &_arg1); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:196
  def after_action(*_arg0, &_arg1); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:188
  def after_build(*_arg0, &_arg1); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:189
  def after_create(*_arg0, &_arg1); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:192
  def after_destroy(*_arg0, &_arg1); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:191
  def after_save(*_arg0, &_arg1); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:190
  ...
  # action.
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:137
  def action(set, name, options = T.unsafe(nil), &block); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:27
  def belongs_to(target, options = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:153
  ...
  #   end
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:112
  def csv(options = T.unsafe(nil), &block); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:157
  def decorate_with(decorator_class); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:95
  def form(options = T.unsafe(nil), &block); end

  # Store relations that should be included
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:42
  def includes(*args); end

  # Configure the index page for the resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:85
  def index(options = T.unsafe(nil), &block); end

  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:149
  ...
  #   end
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:23
  ...
  #   end
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:64
  def permit_params(*args, &block); end

  # Create a scope
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:37
  def scope(*args, &block); end

  # Scope collection to a relation
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:32
  def scope_to(*args, &block); end

  # Configure the show page for the resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/resource_dsl.rb:91
  def show(options = T.unsafe(nil), &block); end
end

# @private
#
# source://activeadmin-2.12.0/lib/active_admin/router.rb:4
class ActiveAdmin::Router
  # @return [Router] a new instance of Router
  #
  # source://activeadmin-2.12.0/lib/active_admin/router.rb:7
  def initialize(router:, namespaces:); end

  # source://activeadmin-2.12.0/lib/active_admin/router.rb:12
  def apply; end

  # Returns the value of attribute namespaces.
  #
  # source://activeadmin-2.12.0/lib/active_admin/router.rb:5
  def namespaces; end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/router.rb:90
  def build_action(action); end

  # source://activeadmin-2.12.0/lib/active_admin/router.rb:94
  def build_route(verbs, *args); end

  # Defines member and collection actions
  #
  # source://activeadmin-2.12.0/lib/active_admin/router.rb:77
  def define_actions(config); end

  # source://activeadmin-2.12.0/lib/active_admin/router.rb:98
  def define_belongs_to_routes(config); end

  # source://activeadmin-2.12.0/lib/active_admin/router.rb:109
  def define_namespace(config); end

  # source://activeadmin-2.12.0/lib/active_admin/router.rb:39
  def define_resource_routes(config); end

  # Defines the routes for each resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/router.rb:32
  def define_resources_routes; end

  # source://activeadmin-2.12.0/lib/active_admin/router.rb:19
  def define_root_routes; end

  # source://activeadmin-2.12.0/lib/active_admin/router.rb:48
  def define_routes(config); end

  # source://activeadmin-2.12.0/lib/active_admin/router.rb:56
  def page_or_resource_routes(config); end

  # source://activeadmin-2.12.0/lib/active_admin/router.rb:66
  def page_routes(config); end

  # source://activeadmin-2.12.0/lib/active_admin/router.rb:60
  def resource_routes(config); end
end

# source://activeadmin-2.12.0/lib/active_admin/scope.rb:3
class ActiveAdmin::Scope
  ...
  # source://activeadmin-2.12.0/lib/active_admin/scope.rb:56
  def name; end
...
# source://activeadmin-2.12.0/lib/active_admin/helpers/scope_chain.rb:3
module ActiveAdmin::ScopeChain
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/helpers/scope_chain.rb:15
  def scope_chain(scope, chain); end
end

# source://activeadmin-2.12.0/lib/active_admin/settings_node.rb:4
class ActiveAdmin::SettingsNode
  class << self
    # @return anonymous class with same accessors as the superclass.
    #
    # source://activeadmin-2.12.0/lib/active_admin/settings_node.rb:10
    def build(superclass = T.unsafe(nil)); end

    # source://activeadmin-2.12.0/lib/active_admin/settings_node.rb:14
    def register(name, value); end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/sidebar_section.rb:4
class ActiveAdmin::SidebarSection
  include ::ActiveAdmin::OptionalDisplay

  # @return [SidebarSection] a new instance of SidebarSection
  #
  # source://activeadmin-2.12.0/lib/active_admin/sidebar_section.rb:9
  def initialize(name, options = T.unsafe(nil), &block); end

  # Returns the value of attribute block.
  #
  # source://activeadmin-2.12.0/lib/active_admin/sidebar_section.rb:7
  def block; end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/sidebar_section.rb:31
  def custom_class; end

  # The id gets used for the div in the view
  #
  # source://activeadmin-2.12.0/lib/active_admin/sidebar_section.rb:17
  def id; end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/sidebar_section.rb:27
  def partial_name; end

  # source://activeadmin-2.12.0/lib/active_admin/sidebar_section.rb:35
  def priority; end

  # The title gets displayed within the section in the view
  #
  # source://activeadmin-2.12.0/lib/active_admin/sidebar_section.rb:22
  def title; end
end
...
#
# source://activeadmin-2.12.0/lib/active_admin/dynamic_setting.rb:28
class ActiveAdmin::StringSymbolOrProcSetting < ::ActiveAdmin::DynamicSetting
  # source://activeadmin-2.12.0/lib/active_admin/dynamic_setting.rb:29
  def value(context = T.unsafe(nil)); end
end

# source://activeadmin-2.12.0/lib/active_admin/version.rb:3
ActiveAdmin::VERSION = T.let(T.unsafe(nil), String)

# source://activeadmin-2.12.0/lib/active_admin/view_factory.rb:5
class ActiveAdmin::ViewFactory < ::ActiveAdmin::AbstractViewFactory
  ...
  class << self
    ...
    # source://activeadmin-2.12.0/lib/active_admin/abstract_view_factory.rb:14
...
# source://activeadmin-2.12.0/lib/active_admin/view_helpers.rb:3
...
# source://activeadmin-2.12.0/lib/active_admin/view_helpers/active_admin_application_helper.rb:4
module ActiveAdmin::ViewHelpers::ActiveAdminApplicationHelper
  # Returns the current Active Admin application instance
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/active_admin_application_helper.rb:7
  def active_admin_application; end
end

# source://activeadmin-2.12.0/lib/active_admin/view_helpers/auto_link_helper.rb:4
module ActiveAdmin::ViewHelpers::AutoLinkHelper
  # Returns the ActiveAdmin::Resource instance for a class
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/auto_link_helper.rb:38
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/auto_link_helper.rb:15
  def auto_link(resource, content = T.unsafe(nil)); end

  # Like `auto_link`, except that it only returns a URL instead of a full <a> tag
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/auto_link_helper.rb:24
  def auto_url_for(resource); end
end

# source://activeadmin-2.12.0/lib/active_admin/view_helpers/breadcrumb_helper.rb:4
module ActiveAdmin::ViewHelpers::BreadcrumbHelper
  # Returns an array of links to use in a breadcrumb
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/breadcrumb_helper.rb:7
  def breadcrumb_links(path = T.unsafe(nil)); end
end

# source://activeadmin-2.12.0/lib/active_admin/view_helpers/display_helper.rb:4
module ActiveAdmin::ViewHelpers::DisplayHelper
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/display_helper.rb:47
  def association_methods_for(resource); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/display_helper.rb:99
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/display_helper.rb:26
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/display_helper.rb:33
  def display_name_method_for(resource); end

  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/display_helper.rb:64
  def find_value(resource, attr); end

  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/display_helper.rb:52
  def format_attribute(resource, attr); end

  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/display_helper.rb:95
  def format_collection(collection); end

  # Attempts to create a human-readable string for any object
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/display_helper.rb:75
  def pretty_format(object); end
end

# source://activeadmin-2.12.0/lib/active_admin/view_helpers/display_helper.rb:6
ActiveAdmin::ViewHelpers::DisplayHelper::DISPLAY_NAME_FALLBACK = T.let(T.unsafe(nil), Proc)

# source://activeadmin-2.12.0/lib/active_admin/view_helpers/download_format_links_helper.rb:4
module ActiveAdmin::ViewHelpers::DownloadFormatLinksHelper
  ...
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/download_format_links_helper.rb:19
  def build_download_format_links(formats = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/download_format_links_helper.rb:7
  def build_download_formats(download_links); end

  class << self
    # @private
    #
    # source://activeadmin-2.12.0/lib/active_admin/view_helpers/download_format_links_helper.rb:29
    def included(base); end
  end
end

# source://activeadmin-2.12.0/lib/active_admin/view_helpers/download_format_links_helper.rb:33
module ActiveAdmin::ViewHelpers::DownloadFormatLinksHelper::ClassMethods
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/download_format_links_helper.rb:49
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/download_format_links_helper.rb:40
  def formats; end
end

# source://activeadmin-2.12.0/lib/active_admin/view_helpers/flash_helper.rb:4
module ActiveAdmin::ViewHelpers::FlashHelper
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/flash_helper.rb:9
  def flash_messages; end
end

# source://activeadmin-2.12.0/lib/active_admin/view_helpers/fields_for.rb:4
module ActiveAdmin::ViewHelpers::FormHelper
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/form_helper.rb:6
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/fields_for.rb:17
  def fields_for_params(params, options = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/form_helper.rb:12
  def hidden_field_tags_for(params, options = T.unsafe(nil)); end
end

# source://activeadmin-2.12.0/lib/active_admin/view_helpers/scope_name_helper.rb:4
module ActiveAdmin::ViewHelpers::ScopeNameHelper
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/scope_name_helper.rb:6
  def scope_name(scope); end
end

# source://activeadmin-2.12.0/lib/active_admin/view_helpers/sidebar_helper.rb:4
module ActiveAdmin::ViewHelpers::SidebarHelper
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/sidebar_helper.rb:6
  def skip_sidebar!; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/sidebar_helper.rb:10
  def skip_sidebar?; end
end

# source://activeadmin-2.12.0/lib/active_admin/view_helpers/title_helper.rb:4
module ActiveAdmin::ViewHelpers::TitleHelper
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/title_helper.rb:6
  def title(_title); end
end

# source://activeadmin-2.12.0/lib/active_admin/view_helpers/view_factory_helper.rb:4
module ActiveAdmin::ViewHelpers::ViewFactoryHelper
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/view_factory_helper.rb:6
  def view_factory; end
end

# source://activeadmin-2.12.0/lib/active_admin/views.rb:3
module ActiveAdmin::Views; end

# source://activeadmin-2.12.0/lib/active_admin/views/action_items.rb:5
class ActiveAdmin::Views::ActionItems < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/action_items.rb:7
  def build(action_items); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:24
class ActiveAdmin::Views::ActiveAdminForm < ::ActiveAdmin::Views::FormtasticProxy
  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:75
  def actions(*args, &block); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:87
  def add_create_another_checkbox; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:27
  def build(resource, options = T.unsafe(nil), &block); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:81
  def commit_action_with_cancel_link; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:105
  def form_buffers; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:93
  def has_many(*args, &block); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:71
  def input(*args); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:45
  def inputs(*args, &block); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:97
  def multipart?; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:101
  def object; end

  private

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:111
  def create_another_checkbox; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/active_filters_sidebar_content.rb:7
class ActiveAdmin::Views::ActiveFiltersSidebarContent < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_filters_sidebar_content.rb:10
  def build; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_filters_sidebar_content.rb:39
  def filter_item(filter); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_filters_sidebar_content.rb:25
  def filters_list(active_filters, active_scopes); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_filters_sidebar_content.rb:18
  def scope_block(current_scope); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_filters_sidebar_content.rb:46
  def scope_item(name, value); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/attributes_table.rb:5
class ActiveAdmin::Views::AttributesTable < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/components/attributes_table.rb:8
  def build(obj, *attrs); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/attributes_table.rb:23
  def row(*args, &block); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/attributes_table.rb:19
  def rows(*attrs); end
  ...
  # a single record.
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/attributes_table.rb:56
  def build_colgroups; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/attributes_table.rb:82
  def content_for(record, attr); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/attributes_table.rb:48
  def default_id_for_prefix; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/attributes_table.rb:78
  def empty_value; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/attributes_table.rb:70
  def header_content_for(attr); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/attributes_table.rb:89
  def single_record?; end
end

# Build a Blank Slate
#
# source://activeadmin-2.12.0/lib/active_admin/views/components/blank_slate.rb:5
class ActiveAdmin::Views::BlankSlate < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/components/blank_slate.rb:12
  def build(content); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/blank_slate.rb:8
  def default_class_name; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:117
class ActiveAdmin::Views::Column < ::ActiveAdmin::Component
  # @option options
  # @param options [Hash] An options hash for the column
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:124
  def build(options = T.unsafe(nil)); end

  # Returns the value of attribute max_width.
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:119
  def max_width; end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:133
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:156
...
# than 100px.
#
# source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:64
class ActiveAdmin::Views::Columns < ::ActiveAdmin::Component
  # Override add child to set widths
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:73
  def add_child(*_arg0); end

  # For documentation, please take a look at Column#build
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:68
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:90
  def calculate_columns!; end

  # Override the closing tag to include a clear
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:81
  def closing_tag; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:112
  def columns; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:103
  def columns_span_count; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/columns.rb:85
  def margin_size; end
end
...
#
# source://activeadmin-2.12.0/lib/active_admin/views/components/dropdown_menu.rb:17
class ActiveAdmin::Views::DropdownMenu < ::ActiveAdmin::Component
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/dropdown_menu.rb:26
  def build(name, options = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/dropdown_menu.rb:39
  def item(*args, **kwargs); end

  private

  # source://activeadmin-2.12.0/lib/active_admin/views/components/dropdown_menu.rb:47
  def build_button(name, button_options); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/dropdown_menu.rb:54
  def build_menu(options); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/footer.rb:4
class ActiveAdmin::Views::Footer < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/footer.rb:6
  def build(namespace); end

  private

  # source://activeadmin-2.12.0/lib/active_admin/views/footer.rb:19
  def footer_text; end

  # source://activeadmin-2.12.0/lib/active_admin/views/footer.rb:23
  def powered_by_message; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:4
class ActiveAdmin::Views::FormtasticProxy < ::Arbre::Rails::Forms::FormBuilderProxy
  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:15
  def closing_tag; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:11
  def opening_tag; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:5
  def split_string_on(string, match); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:19
  def to_s; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:150
class ActiveAdmin::Views::HasManyProxy < ::ActiveAdmin::Views::FormtasticProxy
  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:151
  def build(form_builder, *args, &block); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/header.rb:4
class ActiveAdmin::Views::Header < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/header.rb:6
...
# ```
#
# source://activeadmin-2.12.0/lib/active_admin/views/index_as_block.rb:21
class ActiveAdmin::Views::IndexAsBlock < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_block.rb:23
  def build(page_presenter, collection); end

  class << self
    # source://activeadmin-2.12.0/lib/active_admin/views/index_as_block.rb:31
    def index_name; end
  end
end
...
# ```
#
# source://activeadmin-2.12.0/lib/active_admin/views/index_as_blog.rb:71
class ActiveAdmin::Views::IndexAsBlog < ::ActiveAdmin::Component
  # Setter method for the configuration of the body
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_blog.rb:95
  def body(method = T.unsafe(nil), &block); end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_blog.rb:73
  def build(page_presenter, collection); end

  # Setter method for the configuration of the title
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_blog.rb:86
  def title(method = T.unsafe(nil), &block); end

  private

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_blog.rb:137
  def build_body(post); end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_blog.rb:115
  def build_post(post); end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_blog.rb:108
  def build_posts; end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_blog.rb:123
  def build_title(post); end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_blog.rb:145
  def render_method_on_post_or_call_proc(post, proc); end

  class << self
    # source://activeadmin-2.12.0/lib/active_admin/views/index_as_blog.rb:102
    def index_name; end
  end
end
...
# ```
#
# source://activeadmin-2.12.0/lib/active_admin/views/index_as_grid.rb:29
class ActiveAdmin::Views::IndexAsGrid < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_grid.rb:31
  def build(page_presenter, collection); end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_grid.rb:38
  def number_of_columns; end

  protected

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_grid.rb:71
  def build_empty_cell; end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_grid.rb:65
  def build_item(item); end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_grid.rb:57
  def build_row(group); end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_grid.rb:48
  def build_table; end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_grid.rb:75
  def default_number_of_columns; end

  class << self
    # source://activeadmin-2.12.0/lib/active_admin/views/index_as_grid.rb:42
    def index_name; end
  end
end
...
# ```
#
# source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:236
class ActiveAdmin::Views::IndexAsTable < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:238
  def build(page_presenter, collection); end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:258
  def default_table; end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:254
  def table_for(*args, &block); end

  class << self
    # source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:269
    def index_name; end
  end
end
...
#
# source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:277
class ActiveAdmin::Views::IndexAsTable::IndexTableFor < ::ActiveAdmin::Views::TableFor
  ...
  # ```
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:347
  def actions(options = T.unsafe(nil), &block); end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:307
  def default_actions; end

  # Display a column for the id
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:294
  def id_column; end

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:287
  def index_column(start_value = T.unsafe(nil)); end

  # Display a column for checkbox
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:280
  def selectable_column; end

  private

  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:375
  def defaults(resource, options = T.unsafe(nil)); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:389
class ActiveAdmin::Views::IndexAsTable::IndexTableFor::TableActions < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/index_as_table.rb:392
  def item(*args, **kwargs); end
end
...
#
# source://activeadmin-2.12.0/lib/active_admin/views/components/index_list.rb:9
class ActiveAdmin::Views::IndexList < ::ActiveAdmin::Component
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/index_list.rb:25
  def build(index_classes); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/index_list.rb:14
  def default_class_name; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/index_list.rb:18
  def tag_name; end
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/index_list.rb:38
  def build_index_list(index_class); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/index_list.rb:50
  def classes_for_index(index_class); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/index_list.rb:64
  def current_filter_search_empty?; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/index_list.rb:56
...
#
# source://activeadmin-2.12.0/lib/active_admin/views/components/menu.rb:11
class ActiveAdmin::Views::Menu < ::ActiveAdmin::Component
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/menu.rb:18
  def build(menu, options = T.unsafe(nil)); end

  # Returns the value of attribute menu.
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/menu.rb:12
  def menu; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/menu.rb:28
  def tag_name; end
end

# Arbre component used to render ActiveAdmin::MenuItem
#
# source://activeadmin-2.12.0/lib/active_admin/views/components/menu_item.rb:6
class ActiveAdmin::Views::MenuItem < ::ActiveAdmin::Component
  # Sorts by priority first, then alphabetically by label if needed.
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/menu_item.rb:38
  def <=>(other); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/menu_item.rb:12
  def build(item, options = T.unsafe(nil)); end

  # Returns the value of attribute label.
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/menu_item.rb:8
  def label; end

  # Returns the value of attribute priority.
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/menu_item.rb:10
  def priority; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/menu_item.rb:33
  def tag_name; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/menu_item.rb:47
  def to_s; end

  # Returns the value of attribute url.
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/menu_item.rb:9
  def url; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/menu_item.rb:43
  def visible?; end
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/menu_item.rb:54
  def real_url?; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:4
module ActiveAdmin::Views::Pages; end

# source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:5
class ActiveAdmin::Views::Pages::Base < ::Arbre::HTML::Document
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:24
  def active_admin_config(*_arg0, &_arg1); end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:7
  def build(*args); end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:18
  def main_content; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:24
  def params(*_arg0, &_arg1); end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:14
  def title; end

  private

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:118
  def action_items_for_action; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:68
  def body_classes; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:26
  def build_active_admin_head; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:91
  def build_flash_messages; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:101
  def build_main_content_wrapper; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:56
  def build_page; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:83
  def build_page_content; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:77
  def build_unsupported_browser; end

  # Returns the sidebar sections to render for the current action
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:110
  def sidebar_sections_for_action; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/base.rb:126
  def skip_sidebar?; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/pages/form.rb:6
class ActiveAdmin::Views::Pages::Form < ::ActiveAdmin::Views::Pages::Base
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/form.rb:16
  def form_presenter; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/form.rb:20
  def main_content; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/form.rb:8
  def title; end

  private

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/form.rb:43
  def default_form_config; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/form.rb:32
  def default_form_options; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/form.rb:39
  def default_form_path; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/form.rb:51
  def normalized_action; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:8
class ActiveAdmin::Views::Pages::Index < ::ActiveAdmin::Views::Pages::Base
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:19
  def config; end

  # Renders the index configuration that was set in the
  # controller. Defaults to rendering the ActiveAdmin::Pages::Index::Table
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:26
  def main_content; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:10
  def title; end
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:71
  def any_table_tools?; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:77
  def build_batch_actions_selector; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:49
  def build_collection; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:93
  def build_index_list; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:83
  def build_scopes; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:63
  def build_table_tools; end

  # Returns the actual class for renderering the main content on the index
  # page. To set this, use the :as option in the page_presenter block.
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:108
  def find_index_renderer_class(klass); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:45
  def items_in_collection?; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:113
  def render_blank_slate; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:121
  def render_empty_results; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:126
  def render_index; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:35
  def wrap_with_batch_action_form(&block); end

  private

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:149
  def blank_slate_link; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/index.rb:160
...
#
# source://activeadmin-2.12.0/lib/active_admin/views/pages/layout.rb:8
class ActiveAdmin::Views::Pages::Layout < ::ActiveAdmin::Views::Pages::Base
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/layout.rb:15
  def main_content; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/layout.rb:10
  def title; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/pages/page.rb:5
class ActiveAdmin::Views::Pages::Page < ::ActiveAdmin::Views::Pages::Base
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/page.rb:7
  def main_content; end

  protected

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/page.rb:17
  def page_presenter; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/page.rb:21
  def title; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/pages/show.rb:5
class ActiveAdmin::Views::Pages::Show < ::ActiveAdmin::Views::Pages::Base
  ...
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/show.rb:28
  def attributes_table(*args, &block); end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/show.rb:7
  def config; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/show.rb:19
  def main_content; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/show.rb:11
  def title; end

  protected

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/show.rb:42
  def default_title; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/pages/show.rb:52
module ActiveAdmin::Views::Pages::Show::DefaultMainContent
  # source://activeadmin-2.12.0/lib/active_admin/views/pages/show.rb:57
  def default_attribute_table_rows; end

  # source://activeadmin-2.12.0/lib/active_admin/views/pages/show.rb:53
...
#
# source://activeadmin-2.12.0/lib/active_admin/views/components/paginated_collection.rb:27
class ActiveAdmin::Views::PaginatedCollection < ::ActiveAdmin::Component
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/paginated_collection.rb:59
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/paginated_collection.rb:41
  def build(collection, options = T.unsafe(nil)); end

  # Returns the value of attribute collection.
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/paginated_collection.rb:30
  def collection; end

  protected

  # source://activeadmin-2.12.0/lib/active_admin/views/components/paginated_collection.rb:95
  def build_pagination; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/paginated_collection.rb:69
  def build_pagination_with_formats(options); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/paginated_collection.rb:80
  def build_per_page_select; end

  # modified from will_paginate
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/paginated_collection.rb:118
  def page_entries_info(options = T.unsafe(nil)); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/panel.rb:5
class ActiveAdmin::Views::Panel < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/components/panel.rb:15
  def add_child(child); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/panel.rb:8
  ...
  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/panel.rb:26
  def children?; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/panel.rb:30
...
#
# source://activeadmin-2.12.0/lib/active_admin/views/components/scopes.rb:10
class ActiveAdmin::Views::Scopes < ::ActiveAdmin::Component
  include ::ActiveAdmin::ScopeChain
  include ::ActiveAdmin::Helpers::Collection

  # source://activeadmin-2.12.0/lib/active_admin/views/components/scopes.rb:24
  def build(scopes, options = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/scopes.rb:16
  def default_class_name; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/scopes.rb:20
  def tag_name; end

  protected

  # source://activeadmin-2.12.0/lib/active_admin/views/components/scopes.rb:38
  def build_scope(scope, options); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/scopes.rb:51
  def classes_for_scope(scope); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/scopes.rb:57
  def current_scope?(scope); end

  # Return the count for the scope passed in.
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/scopes.rb:66
  def get_scope_count(scope); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/scopes.rb:70
  def group_class(group); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:142
class ActiveAdmin::Views::SemanticActionsProxy < ::ActiveAdmin::Views::FormtasticProxy
  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:143
  def build(form_builder, *args, &block); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:128
class ActiveAdmin::Views::SemanticInputsProxy < ::ActiveAdmin::Views::FormtasticProxy
  # source://activeadmin-2.12.0/lib/active_admin/views/components/active_admin_form.rb:129
  def build(form_builder, *args, &block); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/sidebar.rb:5
class ActiveAdmin::Views::Sidebar < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/components/sidebar.rb:8
  def build(sections, attributes = T.unsafe(nil)); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/sidebar_section.rb:5
class ActiveAdmin::Views::SidebarSection < ::ActiveAdmin::Views::Panel
  # Renders attributes_table_for current resource
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/sidebar_section.rb:18
  def attributes_table(*args, &block); end

  # Takes a ActiveAdmin::SidebarSection instance
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/sidebar_section.rb:9
  def build(section); end

  protected

  # source://activeadmin-2.12.0/lib/active_admin/views/components/sidebar_section.rb:24
  def build_sidebar_content; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/site_title.rb:5
class ActiveAdmin::Views::SiteTitle < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/components/site_title.rb:11
  def build(namespace); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/site_title.rb:26
  def site_title_image; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/site_title.rb:22
  def site_title_link?; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/site_title.rb:7
  def tag_name; end

  private

  # source://activeadmin-2.12.0/lib/active_admin/views/components/site_title.rb:36
  def site_title_content; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/site_title.rb:32
  def site_title_with_link; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/site_title.rb:48
  def title_image; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/site_title.rb:44
  def title_text; end
end

# Build a StatusTag
#
# source://activeadmin-2.12.0/lib/active_admin/views/components/status_tag.rb:5
class ActiveAdmin::Views::StatusTag < ::ActiveAdmin::Component
  ...
  # @overload status_tag
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/status_tag.rb:32
  def build(status, options = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/status_tag.rb:12
  def default_class_name; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/status_tag.rb:8
  def tag_name; end

  protected

  # source://activeadmin-2.12.0/lib/active_admin/views/components/status_tag.rb:51
  def convert_to_boolean_status(status); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/status_tag.rb:64
  def status_to_class(status); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/tabbed_navigation.rb:6
class ActiveAdmin::Views::TabbedNavigation < ::ActiveAdmin::Views::Menu
  # source://activeadmin-2.12.0/lib/active_admin/views/tabbed_navigation.rb:7
  def build(menu, options = T.unsafe(nil)); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:4
class ActiveAdmin::Views::TableFor < ::Arbre::HTML::Table
  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:11
  def build(obj, *attrs); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:30
  def column(*args, &block); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:26
  def columns(*attrs); end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:51
  def sortable?; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:7
  def tag_name; end

  protected

  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:57
  def build_table; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:86
  def build_table_body; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:101
  def build_table_cell(col, resource); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:62
  def build_table_head; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:68
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:112
  def current_sort; end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:134
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:128
  def order_for_sort_key(sort_key); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:140
class ActiveAdmin::Views::TableFor::Column
  # @return [Column] a new instance of Column
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:144
  def initialize(*args, &block); end

  # Returns the value of attribute data.
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:142
  def data; end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:190
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:181
  def sort_key; end

  # @return [Boolean]
  #
  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:160
  def sortable?; end
  ...
  # source://activeadmin-2.12.0/lib/active_admin/views/components/table_for.rb:205
  def sort_column_name; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/tabs.rb:4
class ActiveAdmin::Views::Tabs < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/components/tabs.rb:13
  def build(&block); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/tabs.rb:27
  def build_content_item(title, options, &block); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/tabs.rb:18
  def build_menu_item(title, options, &block); end

  # source://activeadmin-2.12.0/lib/active_admin/views/components/tabs.rb:7
  def tab(title, options = T.unsafe(nil), &block); end

  private

  # source://activeadmin-2.12.0/lib/active_admin/views/components/tabs.rb:34
  def fragmentize(string); end
end

# source://activeadmin-2.12.0/lib/active_admin/views/title_bar.rb:4
class ActiveAdmin::Views::TitleBar < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/title_bar.rb:6
  def build(title, action_items); end

  private

  # source://activeadmin-2.12.0/lib/active_admin/views/title_bar.rb:50
  def build_action_items; end

  # source://activeadmin-2.12.0/lib/active_admin/views/title_bar.rb:29
  def build_breadcrumb(separator = T.unsafe(nil)); end

  # source://activeadmin-2.12.0/lib/active_admin/views/title_bar.rb:46
  def build_title_tag; end

  # source://activeadmin-2.12.0/lib/active_admin/views/title_bar.rb:16
  def build_titlebar_left; end

  # source://activeadmin-2.12.0/lib/active_admin/views/title_bar.rb:23
  def build_titlebar_right; end
end

# source://activeadmin-2.12.0/lib/active_admin/views/components/unsupported_browser.rb:4
class ActiveAdmin::Views::UnsupportedBrowser < ::ActiveAdmin::Component
  # source://activeadmin-2.12.0/lib/active_admin/views/components/unsupported_browser.rb:5
  def build; end
end

# Provides an intuitive way to build has_many associated records in the same form.
#
# source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:3
...
# source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:4
module Formtastic::Inputs; end

# source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:5
module Formtastic::Inputs::Base
  ...
  # source://activeadmin-2.12.0/lib/active_admin/form_builder.rb:6
  def input_wrapping(&block); end
...
# @private
#
# source://activeadmin-2.12.0/lib/active_admin/view_helpers/method_or_proc_helper.rb:4
module MethodOrProcHelper
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/method_or_proc_helper.rb:19
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/method_or_proc_helper.rb:55
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/method_or_proc_helper.rb:90
  ...
  #
  # source://activeadmin-2.12.0/lib/active_admin/view_helpers/method_or_proc_helper.rb:78
