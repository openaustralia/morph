...
# source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:1
module OrmAdapter
  class << self
    # A collection of registered adapters
    #
    # source://orm_adapter-0.5.0/lib/orm_adapter.rb:7
    def adapters; end
  end
end

# source://orm_adapter-0.5.0/lib/orm_adapter/adapters/active_record.rb:5
class OrmAdapter::ActiveRecord < ::OrmAdapter::Base
  # Return list of column/property names
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/adapters/active_record.rb:6
  def column_names; end

  # @see OrmAdapter::Base#create!
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/adapters/active_record.rb:31
  def create!(attributes = T.unsafe(nil)); end

  # @see OrmAdapter::Base#destroy
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/adapters/active_record.rb:36
  def destroy(object); end

  # @see OrmAdapter::Base#find_all
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/adapters/active_record.rb:26
  def find_all(options = T.unsafe(nil)); end

  # @see OrmAdapter::Base#find_first
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/adapters/active_record.rb:21
  def find_first(options = T.unsafe(nil)); end

  # @see OrmAdapter::Base#get
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/adapters/active_record.rb:16
  def get(id); end

  # @see OrmAdapter::Base#get!
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/adapters/active_record.rb:11
  def get!(id); end
  ...
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/adapters/active_record.rb:53
  def conditions_to_fields(conditions); end

  # source://orm_adapter-0.5.0/lib/orm_adapter/adapters/active_record.rb:41
  def construct_relation(relation, options); end

  # source://orm_adapter-0.5.0/lib/orm_adapter/adapters/active_record.rb:73
  def order_clause(order); end
end

# source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:2
class OrmAdapter::Base
  # @return [Base] a new instance of Base
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:17
  ...
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:22
  def column_names; end
  ...
  # @raise [NotSupportedError]
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:72
  def create!(attributes = T.unsafe(nil)); end
  ...
  # @raise [NotSupportedError]
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:77
  def destroy(object); end
  ...
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:67
  def find_all(options = T.unsafe(nil)); end
  ...
  # @raise [NotSupportedError]
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:61
  def find_first(options = T.unsafe(nil)); end
  ...
  # @raise [NotSupportedError]
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:40
  def get(id); end
  ...
  # @raise [NotSupportedError]
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:31
  def get!(id); end

  # Returns the value of attribute klass.
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:3
  def klass; end
  ...
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:94
  ...
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:104
  def normalize_order(order); end

  # @return [Boolean]
  #
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:83
  def valid_object?(object); end

  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:87
  ...
  class << self
    ...
    #
    # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:12
    def inherited(adapter); end
  end
end

# source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:122
class OrmAdapter::NotSupportedError < ::NotImplementedError
  # source://orm_adapter-0.5.0/lib/orm_adapter/base.rb:123
  def to_s; end
end

# Extend into a class that has an OrmAdapter
#
# source://orm_adapter-0.5.0/lib/orm_adapter/to_adapter.rb:3
module OrmAdapter::ToAdapter
  # source://orm_adapter-0.5.0/lib/orm_adapter/to_adapter.rb:4
  def to_adapter; end
end

# source://orm_adapter-0.5.0/lib/orm_adapter/version.rb:2
