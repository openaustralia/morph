...
#
# source://prettyprint-0.2.0/lib/prettyprint.rb:34
class PrettyPrint
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:226
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:157
  ...
  # specify this when +sep+ is a multibyte character, for example.
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:214
  def fill_breakable(sep = T.unsafe(nil), width = T.unsafe(nil)); end

  # outputs buffered data.
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:290
  def flush; end
  ...
  #   lambda {|n| ' ' * n}
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:120
  def genspace; end
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:251
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:126
  def group_queue; end

  # Takes a block and queues a new group that is indented 1 level further.
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:262
  def group_sub; end

  # The number of spaces to be indented
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:123
  def indent; end
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:108
  def maxwidth; end

  # Increases left margin after newline with +indent+ for line breaks added in
  # the block.
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:279
  def nest(indent); end
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:113
  def newline; end
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:103
  def output; end
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:182
  ...
  class << self
    ...
    # @yield [q]
    #
    # source://prettyprint-0.2.0/lib/prettyprint.rb:47
    ...
    # @yield [q]
    #
    # source://prettyprint-0.2.0/lib/prettyprint.rb:61
...
#
# source://prettyprint-0.2.0/lib/prettyprint.rb:339
class PrettyPrint::Breakable
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:347
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:367
  def indent; end
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:359
  def obj; end
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:373
  def output(out, output_width); end

  # The width of +obj+ / +sep+
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:362
  def width; end
end
...
# This class is intended for internal use of the PrettyPrint buffers.
#
# source://prettyprint-0.2.0/lib/prettyprint.rb:396
class PrettyPrint::Group
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:401
  def initialize(depth); end

  # Makes a break for this Group, and returns true
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:414
  def break; end
  ...
  # @return [Boolean]
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:419
  def break?; end

  # Array to hold the Breakable objects for this Group
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:411
  def breakables; end

  # This group's relation to previous groups
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:408
  def depth; end
  ...
  # @return [Boolean]
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:426
  def first?; end
end
...
# This class is intended for internal use of the PrettyPrint buffers.
#
# source://prettyprint-0.2.0/lib/prettyprint.rb:442
class PrettyPrint::GroupQueue
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:447
  def initialize(*groups); end

  # Remote +group+ from this queue
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:479
  def delete(group); end

  # Returns the outer group of the queue
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:463
  def deq; end
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:456
  def enq(group); end
end
...
#
# source://prettyprint-0.2.0/lib/prettyprint.rb:496
class PrettyPrint::SingleLine
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:505
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:520
  def breakable(sep = T.unsafe(nil), width = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:552
  def first?; end

  # Method present for compatibility, but is a noop
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:548
  def flush; end
  ...
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:539
  def group(indent = T.unsafe(nil), open_obj = T.unsafe(nil), close_obj = T.unsafe(nil), open_width = T.unsafe(nil), close_width = T.unsafe(nil)); end
  ...
  # Yields to a block.
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:527
  def nest(indent); end
  ...
  # +width+ argument is here for compatibility. It is a noop argument.
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:513
  def text(obj, width = T.unsafe(nil)); end
end
...
# This class is intended for internal use of the PrettyPrint buffers.
#
# source://prettyprint-0.2.0/lib/prettyprint.rb:301
class PrettyPrint::Text
  ...
  # Output the text to +out+, and increment the width to +output_width+
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:323
  def output(out, output_width); end

  # The total width of the objects included in this Text object.
  #
  # source://prettyprint-0.2.0/lib/prettyprint.rb:318
  def width; end
end

# source://prettyprint-0.2.0/lib/prettyprint.rb:36
