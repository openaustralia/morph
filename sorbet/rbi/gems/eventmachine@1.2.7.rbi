...
#
# source://eventmachine-1.2.7/lib/em/buftok.rb:6
...
#
# source://eventmachine-1.2.7/lib/eventmachine.rb:1599
EM = EventMachine

# source://eventmachine-1.2.7/lib/em/version.rb:1
module EventMachine
  private
...
#
# source://eventmachine-1.2.7/lib/em/channel.rb:14
class EventMachine::Channel
  # @return [Channel] a new instance of Channel
  #
  # source://eventmachine-1.2.7/lib/em/channel.rb:15
  def initialize; end

  # Add items to the channel, which are pushed out to all subscribers.
  #
  # source://eventmachine-1.2.7/lib/em/channel.rb:46
  def <<(*items); end

  # Return the number of current subscribers.
  #
  # source://eventmachine-1.2.7/lib/em/channel.rb:21
  def num_subscribers; end

  # Fetches one message from the channel.
  #
  # source://eventmachine-1.2.7/lib/em/channel.rb:53
  def pop(*a, &b); end
  ...
  # @see #unsubscribe
  #
  # source://eventmachine-1.2.7/lib/em/channel.rb:30
  ...
  # @see #subscribe
  #
  # source://eventmachine-1.2.7/lib/em/channel.rb:41
  ...
  # @private
  #
  # source://eventmachine-1.2.7/lib/em/channel.rb:65
  def gen_id; end
end

# source://eventmachine-1.2.7/lib/em/completion.rb:164
class EventMachine::Completion
  include ::EventMachine::Deferrable

  # @return [Completion] a new instance of Completion
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:171
  def initialize; end

  # Callbacks are called when you enter (or are in) a :succeeded state.
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:206
  ...
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:272
  def cancel_callback(*a, &b); end

  # Remove an errback. N.B. Some errbacks cannot be deleted. Usage is NOT
  # recommended, this is an anti-pattern.
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:266
  def cancel_errback(*a, &b); end

  # Disable the timeout
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:257
  ...
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:224
  ...
  # @return [Boolean]
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:237
  def completed?; end
  ...
  # :completed.
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:218
  ...
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:243
  def completion_states; end

  # Errbacks are called when you enter (or are in) a :failed state.
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:211
  def errback(*a, &b); end

  # Enter the :failed state, setting the result value if given.
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:186
  def fail(*args); end
  ...
  # The old EM method:
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:179
  def set_deferred_success(*args); end

  # Returns the value of attribute state.
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:169
  def state; end

  # Statebacks are called when you enter (or are in) the named state.
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:193
  ...
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:249
  ...
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:298
  ...
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:279
  def execute_callbacks; end

  # Iterate all callbacks for a given state, and remove then call them.
  #
  # source://eventmachine-1.2.7/lib/em/completion.rb:289
...
# @see file:docs/GettingStarted.md EventMachine tutorial
#
# source://eventmachine-1.2.7/lib/em/connection.rb:37
class EventMachine::Connection
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:67
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:265
  ...
  # @see #send_data
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:302
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:647
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:657
  ...
  # @see file:docs/GettingStarted.md EventMachine tutorial
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:362
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:271
  def detach; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:339
  def error?; end

  # source://eventmachine-1.2.7/lib/em/connection.rb:534
  def get_cipher_bits; end

  # source://eventmachine-1.2.7/lib/em/connection.rb:538
  def get_cipher_name; end

  # source://eventmachine-1.2.7/lib/em/connection.rb:542
  def get_cipher_protocol; end

  # The number of seconds since the last send/receive activity on this connection.
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:638
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:530
  ...
  #   end
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:596
  ...
  # @return [Integer]
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:625
  def get_pid; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:243
  def get_proxied_bytes; end

  # source://eventmachine-1.2.7/lib/em/connection.rb:546
  def get_sni_hostname; end

  # source://eventmachine-1.2.7/lib/em/connection.rb:275
  ...
  #   end
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:616
  ...
  # @return [Integer]
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:633
  def get_status; end
  ...
  # @see #notify_readable?
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:729
  def notify_readable=(mode); end

  # @return [Boolean] true if the connection is being watched for readability.
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:734
  ...
  # @see #notify_writable?
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:742
  ...
  # @return [Boolean]
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:747
  ...
  # @see #resume
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:753
  def pause; end
  ...
  # @see #resume
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:766
  def paused?; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:668
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:676
  ...
  # @see #receive_data
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:81
  def post_init; end

  # called when the reactor finished proxying all
  # of the requested bytes.
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:224
  ...
  # @see EventMachine.enable_proxy
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:232
  ...
  # @see EventMachine.enable_proxy
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:219
  ...
  # @see file:docs/GettingStarted.md EventMachine tutorial
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:116
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:685
  ...
  # @see #pause
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:759
  def resume; end
  ...
  # @see Connection#unbind
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:324
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:572
  ...
  # @see #send_data
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:699
  ...
  # source://eventmachine-1.2.7/lib/em/connection.rb:279
  def set_sock_opt(level, optname, optval); end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:39
  def signature; end
  ...
  # @see #get_peer_cert
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:127
  ...
  # @see #start_tls
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:174
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:417
  def start_tls(args = T.unsafe(nil)); end

  # A helper method for {EventMachine.disable_proxy}
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:237
  ...
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:721
  ...
  # @see file:docs/GettingStarted.md EventMachine tutorial
  #
  # source://eventmachine-1.2.7/lib/em/connection.rb:212
  def unbind; end
  ...
  class << self
    ...
    # @private
    #
    # source://eventmachine-1.2.7/lib/em/connection.rb:48
...
# source://eventmachine-1.2.7/lib/em/resolver.rb:2
module EventMachine::DNS; end

# source://eventmachine-1.2.7/lib/em/resolver.rb:157
class EventMachine::DNS::Request
  include ::EventMachine::Deferrable

  # @return [Request] a new instance of Request
  #
  # source://eventmachine-1.2.7/lib/em/resolver.rb:161
  def initialize(socket, hostname); end

  # Returns the value of attribute max_tries.
  #
  # source://eventmachine-1.2.7/lib/em/resolver.rb:159
  def max_tries; end
  ...
  # source://eventmachine-1.2.7/lib/em/resolver.rb:187
  ...
  # source://eventmachine-1.2.7/lib/em/resolver.rb:176
  def tick; end

  private

  # source://eventmachine-1.2.7/lib/em/resolver.rb:211
  def id; end

  # source://eventmachine-1.2.7/lib/em/resolver.rb:222
  def packet; end

  # source://eventmachine-1.2.7/lib/em/resolver.rb:205
  def send; end
end

# source://eventmachine-1.2.7/lib/em/resolver.rb:79
class EventMachine::DNS::RequestIdAlreadyUsed < ::RuntimeError; end

# source://eventmachine-1.2.7/lib/em/resolver.rb:3
class EventMachine::DNS::Resolver
  class << self
    # source://eventmachine-1.2.7/lib/em/resolver.rb:60
    def hosts; end

    # source://eventmachine-1.2.7/lib/em/resolver.rb:56
    def nameserver; end

    # source://eventmachine-1.2.7/lib/em/resolver.rb:36
    def nameservers; end

    # source://eventmachine-1.2.7/lib/em/resolver.rb:32
    def nameservers=(ns); end

    # source://eventmachine-1.2.7/lib/em/resolver.rb:20
    def resolve(hostname); end

    # source://eventmachine-1.2.7/lib/em/resolver.rb:24
    def socket; end

    # @return [Boolean]
    #
    # source://eventmachine-1.2.7/lib/em/resolver.rb:5
    def windows?; end
  end
end

# source://eventmachine-1.2.7/lib/em/resolver.rb:14
EventMachine::DNS::Resolver::HOSTS_FILE = T.let(T.unsafe(nil), String)

# source://eventmachine-1.2.7/lib/em/resolver.rb:81
class EventMachine::DNS::Socket < ::EventMachine::Connection
  # @return [Socket] a new instance of Socket
  #
  # source://eventmachine-1.2.7/lib/em/resolver.rb:86
  def initialize; end

  # source://eventmachine-1.2.7/lib/em/resolver.rb:122
  def deregister_request(id, req); end

  # source://eventmachine-1.2.7/lib/em/resolver.rb:135
  def nameserver; end

  # source://eventmachine-1.2.7/lib/em/resolver.rb:131
  def nameserver=(ns); end

  # source://eventmachine-1.2.7/lib/em/resolver.rb:90
  def post_init; end

  # Decodes the packet, looks for the request and passes the
  # response over to the requester
  #
  # source://eventmachine-1.2.7/lib/em/resolver.rb:141
  def receive_data(data); end

  # source://eventmachine-1.2.7/lib/em/resolver.rb:112
  def register_request(id, req); end

  # source://eventmachine-1.2.7/lib/em/resolver.rb:127
  def send_packet(pkt); end

  # source://eventmachine-1.2.7/lib/em/resolver.rb:94
  def start_timer; end

  # source://eventmachine-1.2.7/lib/em/resolver.rb:98
  def stop_timer; end

  # source://eventmachine-1.2.7/lib/em/resolver.rb:106
  def tick; end

  # source://eventmachine-1.2.7/lib/em/resolver.rb:103
  def unbind; end

  class << self
    # source://eventmachine-1.2.7/lib/em/resolver.rb:82
    def open; end
  end
end
...
#
# source://eventmachine-1.2.7/lib/em/deferrable.rb:207
class EventMachine::DefaultDeferrable
  include ::EventMachine::Deferrable
end

# source://eventmachine-1.2.7/lib/em/deferrable.rb:27
module EventMachine::Deferrable
  ...
  #
  # source://eventmachine-1.2.7/lib/em/deferrable.rb:70
  def errback(&block); end

  # Sugar for set_deferred_status(:failed, ...)
  #
  # source://eventmachine-1.2.7/lib/em/deferrable.rb:197
  def fail(*args); end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/deferrable.rb:141
  def set_deferred_status(status, *args); end

  # Sugar for set_deferred_status(:succeeded, ...)
  #
  # source://eventmachine-1.2.7/lib/em/deferrable.rb:190
  def set_deferred_success(*args); end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/deferrable.rb:170
  ...
  class << self
    ...
    # Then return arg.
    #
    # source://eventmachine-1.2.7/lib/em/future.rb:44
    def future(arg, cb = T.unsafe(nil), eb = T.unsafe(nil), &blk); end
  end
end

# source://eventmachine-1.2.7/lib/em/deferrable/pool.rb:2
...
# wrote to stdout.
#
# source://eventmachine-1.2.7/lib/em/processes.rb:39
class EventMachine::DeferrableChildProcess < ::EventMachine::Connection
  ...
  #
  # source://eventmachine-1.2.7/lib/em/processes.rb:43
  def initialize; end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/processes.rb:65
  def receive_data(data); end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/processes.rb:70
  def unbind; end
  ...
  class << self
    ...
    #
    # source://eventmachine-1.2.7/lib/em/processes.rb:60
    def open(cmd); end
  end
end
...
# source://eventmachine-1.2.7/lib/em/connection.rb:2
...
#   end
#
# source://eventmachine-1.2.7/lib/em/streamer.rb:22
class EventMachine::FileStreamer
  ...
  #
  # source://eventmachine-1.2.7/lib/em/streamer.rb:36
  ...
  # @private
  #
  # source://eventmachine-1.2.7/lib/em/streamer.rb:77
...
#
# source://eventmachine-1.2.7/lib/em/file_watch.rb:12
class EventMachine::FileWatch < ::EventMachine::Connection
  ...
  #
  # source://eventmachine-1.2.7/lib/em/file_watch.rb:56
  ...
  # @abstract
  #
  # source://eventmachine-1.2.7/lib/em/file_watch.rb:45
  ...
  # @abstract
  #
  # source://eventmachine-1.2.7/lib/em/file_watch.rb:62
  def file_moved; end
  ...
  # @see EventMachine.watch_file
  #
  # source://eventmachine-1.2.7/lib/em/file_watch.rb:38
  def path; end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/file_watch.rb:21
  def receive_data(data); end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/file_watch.rb:69
  def stop_watching; end
end

# @private
#
# source://eventmachine-1.2.7/lib/em/file_watch.rb:15
EventMachine::FileWatch::Cdeleted = T.let(T.unsafe(nil), String)

# @private
#
# source://eventmachine-1.2.7/lib/em/file_watch.rb:13
EventMachine::FileWatch::Cmodified = T.let(T.unsafe(nil), String)

# @private
#
# source://eventmachine-1.2.7/lib/em/file_watch.rb:17
...
#   end
#
# source://eventmachine-1.2.7/lib/em/iterator.rb:43
class EventMachine::Iterator
  ...
  #
  # source://eventmachine-1.2.7/lib/em/iterator.rb:56
  def initialize(list, concurrency = T.unsafe(nil)); end

  # Returns the value of attribute concurrency.
  #
  # source://eventmachine-1.2.7/lib/em/iterator.rb:82
  def concurrency; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/iterator.rb:76
  ...
  # @raise [ArgumentError]
  #
  # source://eventmachine-1.2.7/lib/em/iterator.rb:98
  ...
  #   })
  #
  # source://eventmachine-1.2.7/lib/em/iterator.rb:199
  ...
  #   })
  #
  # source://eventmachine-1.2.7/lib/em/iterator.rb:160
  ...
  #
  # source://eventmachine-1.2.7/lib/em/iterator.rb:240
  def next_item; end

  # Spawn workers to consume items from the iterator's enumerator based on the current concurrency level.
  #
  # source://eventmachine-1.2.7/lib/em/iterator.rb:226
  def spawn_workers; end
end

# source://eventmachine-1.2.7/lib/em/iterator.rb:44
...
#   end
#
# source://eventmachine-1.2.7/lib/em/timers.rb:30
class EventMachine::PeriodicTimer
  # Create a new periodic timer that executes every interval seconds
  #
  # @return [PeriodicTimer] a new instance of PeriodicTimer
  #
  # source://eventmachine-1.2.7/lib/em/timers.rb:32
  def initialize(interval, callback = T.unsafe(nil), &block); end

  # Cancel the periodic timer
  #
  # source://eventmachine-1.2.7/lib/em/timers.rb:41
  def cancel; end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/timers.rb:54
  def fire; end

  # Fire the timer every interval seconds
  #
  # source://eventmachine-1.2.7/lib/em/timers.rb:46
  def interval; end
  ...
  # @private
  #
  # source://eventmachine-1.2.7/lib/em/timers.rb:49
  def schedule; end
end
...
#   end
#
# source://eventmachine-1.2.7/lib/em/pool.rb:43
class EventMachine::Pool
  # @return [Pool] a new instance of Pool
  #
  # source://eventmachine-1.2.7/lib/em/pool.rb:45
  def initialize; end

  # source://eventmachine-1.2.7/lib/em/pool.rb:52
  ...
  #
  # source://eventmachine-1.2.7/lib/em/pool.rb:69
  def contents; end

  # A peek at the number of enqueued jobs waiting for resources
  #
  # source://eventmachine-1.2.7/lib/em/pool.rb:107
  def num_waiting; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/pool.rb:79
  ...
  # pool.
  #
  # source://eventmachine-1.2.7/lib/em/pool.rb:92
  def perform(*a, &b); end

  # source://eventmachine-1.2.7/lib/em/pool.rb:57
  ...
  # @return [Boolean]
  #
  # source://eventmachine-1.2.7/lib/em/pool.rb:114
  ...
  # source://eventmachine-1.2.7/lib/em/pool.rb:134
  def completion(deferrable, resource); end

  # source://eventmachine-1.2.7/lib/em/pool.rb:123
  def failure(resource); end

  # source://eventmachine-1.2.7/lib/em/pool.rb:139
  def process(work, resource); end

  # source://eventmachine-1.2.7/lib/em/pool.rb:119
...
#
# source://eventmachine-1.2.7/lib/em/process_watch.rb:6
class EventMachine::ProcessWatch < ::EventMachine::Connection
  ...
  #
  # source://eventmachine-1.2.7/lib/em/process_watch.rb:22
  def pid; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/process_watch.rb:35
  ...
  #
  # source://eventmachine-1.2.7/lib/em/process_watch.rb:29
  def process_forked; end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/process_watch.rb:12
  def receive_data(data); end

  # Discontinue monitoring of the process.
  # This will be called automatically when a process dies. User code may call it as well.
  #
  # source://eventmachine-1.2.7/lib/em/process_watch.rb:40
  def stop_watching; end
end

# @private
#
# source://eventmachine-1.2.7/lib/em/process_watch.rb:9
EventMachine::ProcessWatch::Cexit = T.let(T.unsafe(nil), String)

# @private
#
# source://eventmachine-1.2.7/lib/em/process_watch.rb:7
...
#
# source://eventmachine-1.2.7/lib/em/protocols.rb:18
...
#
# source://eventmachine-1.2.7/lib/em/protocols/header_and_content.rb:46
class EventMachine::Protocols::HeaderAndContentProtocol < ::EventMachine::Connection
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/header_and_content.rb:51
  def initialize(*args); end

  # Basically a convenience method. We might create a subclass that does this
  # automatically. But it's such a performance killer.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/header_and_content.rb:119
  def headers_2_hash(hdrs); end

  # source://eventmachine-1.2.7/lib/em/protocols/header_and_content.rb:92
  def receive_binary_data(text); end

  # source://eventmachine-1.2.7/lib/em/protocols/header_and_content.rb:56
  def receive_line(line); end

  private

  # source://eventmachine-1.2.7/lib/em/protocols/header_and_content.rb:97
  def dispatch_request; end

  # source://eventmachine-1.2.7/lib/em/protocols/header_and_content.rb:105
  def init_for_request; end

  class << self
    # source://eventmachine-1.2.7/lib/em/protocols/header_and_content.rb:124
    def headers_2_hash(hdrs); end
  end
end

# source://eventmachine-1.2.7/lib/em/protocols/header_and_content.rb:49
...
#   }
#
# source://eventmachine-1.2.7/lib/em/protocols/httpclient.rb:58
class EventMachine::Protocols::HttpClient < ::EventMachine::Connection
  include ::EventMachine::Deferrable

  # @return [HttpClient] a new instance of HttpClient
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient.rb:63
  def initialize; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient.rb:98
  def connection_completed; end

  # source://eventmachine-1.2.7/lib/em/protocols/httpclient.rb:280
  def dispatch_response; end

  # source://eventmachine-1.2.7/lib/em/protocols/httpclient.rb:87
  def post_init; end

  # source://eventmachine-1.2.7/lib/em/protocols/httpclient.rb:175
  def receive_data(data); end

  # source://eventmachine-1.2.7/lib/em/protocols/httpclient.rb:103
  def send_request(args); end

  # source://eventmachine-1.2.7/lib/em/protocols/httpclient.rb:291
  def unbind; end
  ...
  # handling.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient.rb:268
  ...
  class << self
    ...
    #
    # source://eventmachine-1.2.7/lib/em/protocols/httpclient.rb:79
...
#  }
#
# source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:43
class EventMachine::Protocols::HttpClient2 < ::EventMachine::Connection
  include ::EventMachine::Protocols::LineText2

  # @return [HttpClient2] a new instance of HttpClient2
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:46
  def initialize; end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:309
  def connection_completed; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:265
  def get(args); end
  ...
  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:366
  def pop_request; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:279
  def post(args); end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:303
  def post_init; end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:358
  def receive_binary_data(text); end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:348
  def receive_line(ln); end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:334
  ...
  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:293
  ...
  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:327
  def unbind; end
  ...
  class << self
    ...
    #
    # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:246
...
# @private
#
# source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:55
class EventMachine::Protocols::HttpClient2::Request
  include ::EventMachine::Deferrable

  # @return [Request] a new instance of Request
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:65
  def initialize(conn, args); end

  # Returns the value of attribute content.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:62
  def content; end

  # Returns the value of attribute header_lines.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:60
  def header_lines; end

  # Returns the value of attribute headers.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:61
  def headers; end

  # Returns the value of attribute internal_error.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:63
  def internal_error; end

  # --
  # Cf RFC 2616 pgh 3.6.1 for the format of HTTP chunks.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:137
  def receive_chunk_header(ln); end

  # --
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:102
  def receive_chunk_trailer(ln); end

  # --
  # We get a single chunk. Append it to the incoming content and switch back to line mode.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:157
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:115
  def receive_header_line(ln); end

  # --
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:90
  def receive_line(ln); end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:232
  def receive_sized_text(text); end

  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:224
  def receive_text(text); end

  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:75
  def send_request; end

  # Returns the value of attribute status.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:59
  def status; end

  # Returns the value of attribute version.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:58
  def version; end

  private

  # source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:173
  def process_header; end
end

# source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:170
EventMachine::Protocols::HttpClient2::Request::ChunkedRE = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:169
EventMachine::Protocols::HttpClient2::Request::ClenRE = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:171
...
# etc.
#
# source://eventmachine-1.2.7/lib/em/protocols/httpclient2.rb:168
EventMachine::Protocols::HttpClient2::Request::HttpResponseRE = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/httpclient.rb:61
...
#
# source://eventmachine-1.2.7/lib/em/protocols/line_and_text.rb:34
class EventMachine::Protocols::LineAndTextProtocol < ::EventMachine::Connection
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/line_and_text.rb:37
  def initialize(*args); end

  # source://eventmachine-1.2.7/lib/em/protocols/line_and_text.rb:42
  def receive_data(data); end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/line_and_text.rb:95
  def set_binary_mode(size = T.unsafe(nil)); end

  # source://eventmachine-1.2.7/lib/em/protocols/line_and_text.rb:77
  def unbind; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/line_and_text.rb:118
  def lbp_init_line_state; end
end

# source://eventmachine-1.2.7/lib/em/protocols/line_and_text.rb:35
...
#  end
#
# source://eventmachine-1.2.7/lib/em/protocols/line_protocol.rb:13
module EventMachine::Protocols::LineProtocol
  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/line_protocol.rb:15
  def receive_data(data); end

  # Invoked with lines received over the network
  #
  # source://eventmachine-1.2.7/lib/em/protocols/line_protocol.rb:24
  def receive_line(line); end
end
...
#
# source://eventmachine-1.2.7/lib/em/protocols/linetext2.rb:35
module EventMachine::Protocols::LineText2
  # Stub. Should be subclassed by user code.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/linetext2.rb:166
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/linetext2.rb:47
  def receive_data(data); end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/linetext2.rb:174
  def receive_end_of_binary_data; end

  # Stub. Should be subclassed by user code.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/linetext2.rb:161
  def receive_line(ln); end

  # Alias for #set_text_mode, added for back-compatibility with LineAndTextProtocol.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/linetext2.rb:146
  def set_binary_mode(size = T.unsafe(nil)); end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/linetext2.rb:114
  ...
  # entirely.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/linetext2.rb:128
  def set_line_mode(data = T.unsafe(nil)); end

  # source://eventmachine-1.2.7/lib/em/protocols/linetext2.rb:134
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/linetext2.rb:153
  def unbind; end
end
...
# throw exceptions.
#
# source://eventmachine-1.2.7/lib/em/protocols/linetext2.rb:40
...
#   }
#
# source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:29
module EventMachine::Protocols::Memcache
  include ::EventMachine::Deferrable

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:134
  def initialize(host, port = T.unsafe(nil)); end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:139
  def connection_completed; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:105
  ...
  # @raise [ArgumentError]
  #
  # source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:61
  def get(*keys); end
  ...
  # @raise [ArgumentError]
  #
  # source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:92
  ...
  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:175
  ...
  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:158
  def receive_data(data); end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:78
  def set(key, val, exptime = T.unsafe(nil), &cb); end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:221
  def unbind; end

  private

  # source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:118
  ...
  class << self
    ...
    #
    # source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:114
...
# @private
#
# source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:41
EventMachine::Protocols::Memcache::Cdeleted = T.let(T.unsafe(nil), String)

# @private
#
# source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:50
EventMachine::Protocols::Memcache::Cdelimiter = T.let(T.unsafe(nil), String)

# @private
#
# source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:48
EventMachine::Protocols::Memcache::Cempty = T.let(T.unsafe(nil), String)

# @private
#
# source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:39
EventMachine::Protocols::Memcache::Cend = T.let(T.unsafe(nil), String)

# @private
#
# source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:45
EventMachine::Protocols::Memcache::Cerror = T.let(T.unsafe(nil), String)

# @private
#
# source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:37
EventMachine::Protocols::Memcache::Cstored = T.let(T.unsafe(nil), String)

# @private
#
# source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:43
EventMachine::Protocols::Memcache::Cunknown = T.let(T.unsafe(nil), String)

# @private
#
# source://eventmachine-1.2.7/lib/em/protocols/memcache.rb:127
...
#  end
#
# source://eventmachine-1.2.7/lib/em/protocols/object_protocol.rb:13
module EventMachine::Protocols::ObjectProtocol
  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/object_protocol.rb:21
  def receive_data(data); end

  # Invoked with ruby objects received over the network
  #
  # source://eventmachine-1.2.7/lib/em/protocols/object_protocol.rb:35
  def receive_object(obj); end

  # Sends a ruby object over the network
  #
  # source://eventmachine-1.2.7/lib/em/protocols/object_protocol.rb:40
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/object_protocol.rb:16
  def serializer; end
end
...
#
# source://eventmachine-1.2.7/lib/em/protocols/saslauth.rb:82
module EventMachine::Protocols::SASLauth
  # source://eventmachine-1.2.7/lib/em/protocols/saslauth.rb:85
  def post_init; end

  # source://eventmachine-1.2.7/lib/em/protocols/saslauth.rb:91
  def receive_data(data); end

  # source://eventmachine-1.2.7/lib/em/protocols/saslauth.rb:109
  def validate(username, psw, sysname, realm); end
end

# source://eventmachine-1.2.7/lib/em/protocols/saslauth.rb:84
...
#
# source://eventmachine-1.2.7/lib/em/protocols/saslauth.rb:136
module EventMachine::Protocols::SASLauthclient
  # source://eventmachine-1.2.7/lib/em/protocols/saslauth.rb:151
  def post_init; end

  # source://eventmachine-1.2.7/lib/em/protocols/saslauth.rb:156
  def receive_data(data); end

  # @return [Boolean]
  #
  # source://eventmachine-1.2.7/lib/em/protocols/saslauth.rb:139
  def validate?(username, psw, sysname = T.unsafe(nil), realm = T.unsafe(nil)); end
end

# source://eventmachine-1.2.7/lib/em/protocols/saslauth.rb:137
...
#   }
#
# source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:67
class EventMachine::Protocols::SmtpClient < ::EventMachine::Connection
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:71
  def initialize; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:169
  def args=(_arg0); end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:178
  def connection_completed; end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:172
  def post_init; end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:200
  def receive_line(ln); end
  ...
  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:189
  def unbind; end

  private

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:335
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:282
  def invoke_auth; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:339
  def invoke_data; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:271
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:217
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:230
  def invoke_internal_error(msg = T.unsafe(nil)); end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:305
  def invoke_mail_from; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:314
  def invoke_rcpt_to; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:255
  def invoke_starttls; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:300
  def receive_auth_response; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:343
  def receive_data_response; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:275
  def receive_ehlo_over_tls_response; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:249
  def receive_ehlo_response; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:309
  def receive_mail_from_response; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:381
  def receive_message_response; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:330
  def receive_rcpt_to_response; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:244
  def receive_signon; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:265
  def receive_starttls_response; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:240
  def send_ehlo; end
  ...
  class << self
    ...
    #
    # source://eventmachine-1.2.7/lib/em/protocols/smtpclient.rb:138
...
class EventMachine::Protocols::SmtpServer < ::EventMachine::Connection
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:183
  def post_init; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:348
  def process_auth(str); end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:366
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:394
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:542
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:301
  def process_ehlo(domain); end

  # TODO - implement this properly, the implementation is a stub!
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:248
  def process_expn; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:320
  def process_helo(domain); end

  # TODO - implement this properly, the implementation is a stub!
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:232
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:464
  def process_mail_from(sender); end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:335
  def process_noop; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:330
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:493
  def process_rcpt_to(rcpt); end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:418
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:437
  def process_starttls; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:339
  ...
  # TODO - implement this properly, the implementation is a stub!
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:244
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:646
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:637
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:596
  def receive_ehlo_domain(domain); end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:193
  def receive_line(ln); end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:655
  def receive_message; end

  # Return true or false to indicate that the authentication is acceptable.
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:601
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:616
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:624
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:609
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:662
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:271
  def reset_protocol_state; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:189
  def send_server_greeting; end

  # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:424
  def unbind; end

  class << self
    # source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:156
    def parms=(parms = T.unsafe(nil)); end
  end
end

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:140
EventMachine::Protocols::SmtpServer::AuthRegex = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:133
EventMachine::Protocols::SmtpServer::DataRegex = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:129
EventMachine::Protocols::SmtpServer::EhloRegex = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:137
EventMachine::Protocols::SmtpServer::ExpnRegex = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:128
EventMachine::Protocols::SmtpServer::HeloRegex = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:138
EventMachine::Protocols::SmtpServer::HelpRegex = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:131
EventMachine::Protocols::SmtpServer::MailFromRegex = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:134
EventMachine::Protocols::SmtpServer::NoopRegex = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:130
EventMachine::Protocols::SmtpServer::QuitRegex = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:132
EventMachine::Protocols::SmtpServer::RcptToRegex = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:135
EventMachine::Protocols::SmtpServer::RsetRegex = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:139
EventMachine::Protocols::SmtpServer::StarttlsRegex = T.let(T.unsafe(nil), Regexp)

# source://eventmachine-1.2.7/lib/em/protocols/smtpserver.rb:136
...
#
# source://eventmachine-1.2.7/lib/em/protocols/socks4.rb:19
class EventMachine::Protocols::Socks4 < ::EventMachine::Connection
  # @return [Socks4] a new instance of Socks4
  #
  # source://eventmachine-1.2.7/lib/em/protocols/socks4.rb:20
  def initialize(host, port); end

  # source://eventmachine-1.2.7/lib/em/protocols/socks4.rb:35
  def restore_methods; end

  # source://eventmachine-1.2.7/lib/em/protocols/socks4.rb:28
  def setup_methods; end

  # source://eventmachine-1.2.7/lib/em/protocols/socks4.rb:42
  def socks_post_init; end

  # source://eventmachine-1.2.7/lib/em/protocols/socks4.rb:47
...
#  }
#
# source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:55
module EventMachine::Protocols::Stomp
  ...
  #  end
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:198
  def ack(msgid); end
  ...
  #  connect :login => 'guest', :passcode => 'guest'
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:159
  def connect(parms = T.unsafe(nil)); end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:143
  def init_message_reader; end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:136
  def receive_binary_data(data); end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:121
  def receive_line(line); end

  # Invoked with an incoming Stomp::Message received from the STOMP server
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:151
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:167
  def send(destination, body, parms = T.unsafe(nil)); end

  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:106
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:175
  def subscribe(dest, ack = T.unsafe(nil)); end
end

# source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:58
class EventMachine::Protocols::Stomp::Message
  # @private
  # @return [Message] a new instance of Message
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:68
  def initialize; end

  # Body of the message
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:65
  def body; end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:60
  def command; end
  ...
  # @private
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:74
  def consume_line(line); end

  # Hash containing headers such as destination and message-id
  #
  # source://eventmachine-1.2.7/lib/em/protocols/stomp.rb:62
  def header; end
...
# @private
#
# source://eventmachine-1.2.7/lib/em/protocols/tcptest.rb:31
class EventMachine::Protocols::TcpConnectTester < ::EventMachine::Connection
  include ::EventMachine::Deferrable

  # source://eventmachine-1.2.7/lib/em/protocols/tcptest.rb:42
  def connection_completed; end

  # source://eventmachine-1.2.7/lib/em/protocols/tcptest.rb:38
  def post_init; end

  # source://eventmachine-1.2.7/lib/em/protocols/tcptest.rb:48
  def unbind; end

  class << self
    # source://eventmachine-1.2.7/lib/em/protocols/tcptest.rb:34
...
#   end
#
# source://eventmachine-1.2.7/lib/em/queue.rb:18
class EventMachine::Queue
  # @return [Queue] a new instance of Queue
  #
  # source://eventmachine-1.2.7/lib/em/queue.rb:19
  def initialize; end
  ...
  # @return [NilClass] nil
  #
  # source://eventmachine-1.2.7/lib/em/queue.rb:30
  def pop(*a, &b); end
  ...
  #
  # source://eventmachine-1.2.7/lib/em/queue.rb:69
  def size; end
end

# Support for Erlang-style processes.
#
# source://eventmachine-1.2.7/lib/em/spawnable.rb:29
class EventMachine::SpawnedProcess
  # Send a message to the spawned process
  #
  # source://eventmachine-1.2.7/lib/em/spawnable.rb:31
  def notify(*x); end
  ...
  # source://eventmachine-1.2.7/lib/em/spawnable.rb:49
...
# @private
#
# source://eventmachine-1.2.7/lib/em/processes.rb:76
class EventMachine::SystemCmd < ::EventMachine::Connection
  # @return [SystemCmd] a new instance of SystemCmd
  #
  # source://eventmachine-1.2.7/lib/em/processes.rb:77
  def initialize(cb); end

  # source://eventmachine-1.2.7/lib/em/processes.rb:81
  def receive_data(data); end

  # source://eventmachine-1.2.7/lib/em/processes.rb:84
  def unbind; end
end
...
#    end
#
# source://eventmachine-1.2.7/lib/em/threaded_resource.rb:53
class EventMachine::ThreadedResource
  ...
  #
  # source://eventmachine-1.2.7/lib/em/threaded_resource.rb:56
  def initialize; end

  # Called on the EM thread, generally in a perform block to return a
  # completion for the work.
  #
  # source://eventmachine-1.2.7/lib/em/threaded_resource.rb:68
  def dispatch; end

  # Kill the internal thread. should only be used to cleanup - generally
  # only required for tests.
  #
  # source://eventmachine-1.2.7/lib/em/threaded_resource.rb:83
  def shutdown; end
end
...
#   end
#
# source://eventmachine-1.2.7/lib/em/tick_loop.rb:30
class EventMachine::TickLoop
  ...
  # @raise [ArgumentError]
  #
  # source://eventmachine-1.2.7/lib/em/tick_loop.rb:66
  def start; end

  # Stop the tick loop immediately, and call it's on_stop callbacks.
  #
  # source://eventmachine-1.2.7/lib/em/tick_loop.rb:52
  def stop; end
  ...
  # @return [Boolean]
  #
  # source://eventmachine-1.2.7/lib/em/tick_loop.rb:60
  def stopped?; end

  private

  # source://eventmachine-1.2.7/lib/em/tick_loop.rb:73
  def schedule; end
end
...
#  timer.cancel
#
# source://eventmachine-1.2.7/lib/em/timers.rb:9
class EventMachine::Timer
  # Create a new timer that fires after a given number of seconds
  #
  # @return [Timer] a new instance of Timer
  #
  # source://eventmachine-1.2.7/lib/em/timers.rb:11
  def initialize(interval, callback = T.unsafe(nil), &block); end

  # Cancel the timer
  #
  # source://eventmachine-1.2.7/lib/em/timers.rb:16
  def cancel; end
end
...
# @private
#
# source://eventmachine-1.2.7/lib/em/spawnable.rb:59
class EventMachine::YieldBlockFromSpawnedProcess
  ...
  #
  # source://eventmachine-1.2.7/lib/em/spawnable.rb:60
  def initialize(block, notify); end

  # source://eventmachine-1.2.7/lib/em/spawnable.rb:63
