...
#
# source://mutex_m-0.3.0/lib/mutex_m.rb:41
module Mutex_m
  # source://mutex_m-0.3.0/lib/mutex_m.rb:116
  def initialize(*args); end

  # source://mutex_m-0.3.0/lib/mutex_m.rb:69
  def mu_extended; end
  ...
  #
  # source://mutex_m-0.3.0/lib/mutex_m.rb:106
  def sleep(timeout = T.unsafe(nil)); end

  private

  # source://mutex_m-0.3.0/lib/mutex_m.rb:112
  def mu_initialize; end

  class << self
    # source://mutex_m-0.3.0/lib/mutex_m.rb:59
    def append_features(cl); end

    # source://mutex_m-0.3.0/lib/mutex_m.rb:46
    def define_aliases(cl); end

    # source://mutex_m-0.3.0/lib/mutex_m.rb:64
    def extend_object(obj); end

    # source://mutex_m-0.3.0/lib/mutex_m.rb:54
    def prepend_features(cl); end
  end
end

# source://mutex_m-0.3.0/lib/mutex_m.rb:43
