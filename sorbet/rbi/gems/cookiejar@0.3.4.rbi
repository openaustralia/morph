...
# source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:5
...
class CookieJar::Cookie
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:51
  def created_at; end

  # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:192
  def decoded_value; end

  # [Boolean] RFC 2965 field for indicating session lifetime for a cookie
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:45
  def discard; end
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:21
  def domain; end
  ...
  # @return [Boolean]
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:69
  ...
  # cookie if contacted.
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:49
  def ports; end
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:31
  def secure; end
  ...
  # @return [Boolean]
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:76
  def session?; end
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:174
  def should_send?(request_uri, script); end

  # Return a hash representation of the cookie.
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:140
  def to_hash; end
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:202
  def to_json(*a); end
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:40
  def version; end
  ...
  class << self
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:234
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:89
    ...
    # @return [Cookie] created from the header string and request URI
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:109
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie.rb:211
...
#
# source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:25
module CookieJar::CookieValidation
  class << self
    ...
    #   requested uri
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:148
    def compute_search_domains(request_uri); end
    ...
    #   requested uri
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:161
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:117
    def cookie_base_path(path); end

    # Attempt to decipher a partially decoded version of text cookie values
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:346
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:188
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:131
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:93
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:209
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:106
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:290
    ...
    # @return [Hash] Contains the parsed values of the cookie
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:361
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:77
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:64
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:55
...
class CookieJar::InvalidCookieError < ::StandardError
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:13
  def initialize(message); end

  # [Array<String>] the specific validation issues encountered
  #
  # source://cookiejar-0.3.4/lib/cookiejar/cookie_validation.rb:9
  def messages; end
end
...
# path.
#
# source://cookiejar-0.3.4/lib/cookiejar/jar.rb:46
class CookieJar::Jar
  # Create a new empty Jar
  #
  # @return [Jar] a new instance of Jar
  #
  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:48
  def initialize; end
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:126
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:191
  ...
  #   HTTP request
  #
  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:254
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:215
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:59
  ...
  # @return [Cookie] which was created and stored
  #
  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:73
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:90
  ...
  #
  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:136
  def to_a; end
  ...
  # @return [String] JSON representation of object data
  #
  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:152
  def to_json(*a); end

  protected

  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:309
  def add_cookie_to_path(paths, cookie); end

  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:301
  def find_domain(host); end

  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:305
  def find_or_add_domain_for_cookie(cookie); end

  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:285
  def gather_header_values(http_header_value, &_block); end

  # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:297
  def to_uri(request_uri); end
  ...
  class << self
    ...
    #
    # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:178
    ...
    # @return [CookieJar] a new CookieJar instance
    #
    # source://cookiejar-0.3.4/lib/cookiejar/jar.rb:163
    def json_create(o); end
  end
end

# source://cookiejar-0.3.4/lib/cookiejar/version.rb:3
