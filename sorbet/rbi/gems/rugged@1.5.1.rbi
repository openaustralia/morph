...
# source://rugged-1.5.1/lib/rugged/index.rb:6
module Rugged
  private
...
# source://rugged-1.5.1/lib/rugged/blob.rb:7
class Rugged::Blob < ::Rugged::Object
  def binary?; end
  def content(*_arg0); end
  def diff(*_arg0); end

  # source://rugged-1.5.1/lib/rugged/blob.rb:14
  def hashsig(options = T.unsafe(nil)); end

  def loc; end

  # source://rugged-1.5.1/lib/rugged/blob.rb:18
...
# source://rugged-1.5.1/lib/rugged/blob.rb:8
...
class Rugged::Branch < ::Rugged::Reference
  ...
  #
  # source://rugged-1.5.1/lib/rugged/branch.rb:19
  def remote; end
...
# source://rugged-1.5.1/lib/rugged/commit.rb:7
class Rugged::Commit < ::Rugged::Object
  ...
  #
  # source://rugged-1.5.1/lib/rugged/commit.rb:25
  def diff(*args); end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/commit.rb:45
  ...
  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/commit.rb:16
  def header_field?(field); end

  # source://rugged-1.5.1/lib/rugged/commit.rb:12
  def inspect; end

  def message; end

  # source://rugged-1.5.1/lib/rugged/commit.rb:67
  ...
  #
  # source://rugged-1.5.1/lib/rugged/commit.rb:53
  def time; end

  # source://rugged-1.5.1/lib/rugged/commit.rb:57
  def to_hash; end
  ...
  class << self
    ...
    # source://rugged-1.5.1/lib/rugged/commit.rb:8
...
# source://rugged-1.5.1/lib/rugged/credentials.rb:7
module Rugged::Credentials; end

# A "default" credential usable for Negotiate mechanisms like NTLM or
# Kerberos authentication
#
# source://rugged-1.5.1/lib/rugged/credentials.rb:42
class Rugged::Credentials::Default
  # source://rugged-1.5.1/lib/rugged/credentials.rb:43
  def call(url, username_from_url, allowed_types); end
end

# A ssh key credential object that can optionally be passphrase-protected
#
# source://rugged-1.5.1/lib/rugged/credentials.rb:20
class Rugged::Credentials::SshKey
  # @return [SshKey] a new instance of SshKey
  #
  # source://rugged-1.5.1/lib/rugged/credentials.rb:21
  def initialize(options); end

  # source://rugged-1.5.1/lib/rugged/credentials.rb:25
  def call(url, username_from_url, allowed_types); end
end

# source://rugged-1.5.1/lib/rugged/credentials.rb:30
class Rugged::Credentials::SshKeyFromAgent
  # @return [SshKeyFromAgent] a new instance of SshKeyFromAgent
  #
  # source://rugged-1.5.1/lib/rugged/credentials.rb:31
  def initialize(options); end

  # source://rugged-1.5.1/lib/rugged/credentials.rb:35
  def call(url, username_from_url, allowed_types); end
end

# A plain-text username and password credential object.
#
# source://rugged-1.5.1/lib/rugged/credentials.rb:9
class Rugged::Credentials::UserPassword
  # @return [UserPassword] a new instance of UserPassword
  #
  # source://rugged-1.5.1/lib/rugged/credentials.rb:10
  def initialize(options); end

  # source://rugged-1.5.1/lib/rugged/credentials.rb:14
  def call(url, username_from_url, allowed_types); end
end

class Rugged::DescribeError < ::Rugged::Error; end

# source://rugged-1.5.1/lib/rugged/diff/hunk.rb:7
class Rugged::Diff
  include ::Enumerable

  # source://rugged-1.5.1/lib/rugged/diff.rb:21
  def deltas; end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/diff.rb:15
  def owner; end

  def patch(*_arg0); end

  # source://rugged-1.5.1/lib/rugged/diff.rb:17
  def patches; end
...
# source://rugged-1.5.1/lib/rugged/diff/delta.rb:8
class Rugged::Diff::Delta
  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:21
  def added?; end

  # Returns the value of attribute binary.
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:17
  def binary; end
  ...
  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:37
  def copied?; end

  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:25
  def deleted?; end

  # Returns the value of attribute owner.
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:9
  def diff; end

  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:41
  def ignored?; end

  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:53
  def inspect; end

  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:29
  def modified?; end

  # Returns the value of attribute new_file.
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:13
  def new_file; end

  # Returns the value of attribute old_file.
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:12
  def old_file; end
  ...
  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:33
  def renamed?; end

  # Returns the value of attribute similarity.
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:14
  def similarity; end

  # Returns the value of attribute status.
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:15
  def status; end

  # Returns the value of attribute status_char.
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:16
  def status_char; end

  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:49
  def typechange?; end

  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/delta.rb:45
  def untracked?; end
end

# source://rugged-1.5.1/lib/rugged/diff/hunk.rb:8
class Rugged::Diff::Hunk
  include ::Enumerable

  def count; end

  # source://rugged-1.5.1/lib/rugged/diff/hunk.rb:9
  def delta; end
  ...
  # source://rugged-1.5.1/lib/rugged/diff/hunk.rb:13
  def inspect; end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/diff/hunk.rb:18
  def lines; end
...
# source://rugged-1.5.1/lib/rugged/diff/line.rb:8
class Rugged::Diff::Line
  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/line.rb:15
  def addition?; end

  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/line.rb:43
  def binary?; end

  # Returns the value of attribute content.
  #
  # source://rugged-1.5.1/lib/rugged/diff/line.rb:9
  def content; end
  ...
  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/line.rb:11
  def context?; end

  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/line.rb:19
  def deletion?; end

  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/line.rb:27
  def eof_newline_added?; end

  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/line.rb:31
  def eof_newline_removed?; end

  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/line.rb:23
  def eof_no_newline?; end

  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/line.rb:35
  def file_header?; end

  # @return [Boolean]
  #
  # source://rugged-1.5.1/lib/rugged/diff/line.rb:39
  def hunk_header?; end

  # source://rugged-1.5.1/lib/rugged/diff/line.rb:47
  def inspect; end
...
# source://rugged-1.5.1/lib/rugged/index.rb:7
class Rugged::Index
  include ::Enumerable
  ...
  #   all files under ignored directories will be included in the diff, too.
  #
  # source://rugged-1.5.1/lib/rugged/index.rb:109
  def diff(*args); end
  ...
  # source://rugged-1.5.1/lib/rugged/index.rb:125
  def to_s; end
...
# source://rugged-1.5.1/lib/rugged/object.rb:7
class Rugged::Object
  # source://rugged-1.5.1/lib/rugged/object.rb:8
  def <=>(other); end
...
# source://rugged-1.5.1/lib/rugged/patch.rb:7
class Rugged::Patch
  include ::Enumerable

  # Returns the number of additions in the patch.
  #
  # source://rugged-1.5.1/lib/rugged/patch.rb:22
  def additions; end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/patch.rb:32
  def changes; end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/patch.rb:27
  def deletions; end
  ...
  # Returns the value of attribute owner.
  #
  # source://rugged-1.5.1/lib/rugged/patch.rb:14
  def diff; end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/patch.rb:37
  def hunks; end

  # source://rugged-1.5.1/lib/rugged/patch.rb:17
  def inspect; end
...
# source://rugged-1.5.1/lib/rugged/reference.rb:7
class Rugged::Reference
  def branch?; end
  def canonical_name; end

  # source://rugged-1.5.1/lib/rugged/reference.rb:8
  def inspect; end
...
# source://rugged-1.5.1/lib/rugged/remote.rb:7
class Rugged::Remote
...
# to you.
#
# source://rugged-1.5.1/lib/rugged/repository.rb:10
class Rugged::Repository
  def ahead_behind(_arg0, _arg1); end
  def apply(*_arg0); end

  # source://rugged-1.5.1/lib/rugged/attributes.rb:8
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:242
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:207
  def branches; end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:29
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:225
  ...
  # source://rugged-1.5.1/lib/rugged/repository.rb:99
  def diff(left, right, opts = T.unsafe(nil)); end

  def diff_from_buffer(_arg0); end

  # source://rugged-1.5.1/lib/rugged/repository.rb:118
  ...
  # source://rugged-1.5.1/lib/rugged/repository.rb:253
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:14
  def inspect; end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:21
  def last_commit; end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:146
  def lookup(oid); end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:266
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:173
  def ref(ref_name); end

  # source://rugged-1.5.1/lib/rugged/repository.rb:185
  def ref_names(glob = T.unsafe(nil)); end

  # source://rugged-1.5.1/lib/rugged/repository.rb:181
  def references; end

  # source://rugged-1.5.1/lib/rugged/repository.rb:177
  ...
  # in the repository.
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:200
  def remotes; end
  ...
  # Returns one of the four classes that inherit from Rugged::Object.
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:153
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:160
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:91
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:214
  def submodules; end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:192
  def tags; end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/repository.rb:136
...
# source://rugged-1.5.1/lib/rugged/attributes.rb:12
class Rugged::Repository::Attributes
  include ::Enumerable

  # @return [Attributes] a new instance of Attributes
  #
  # source://rugged-1.5.1/lib/rugged/attributes.rb:27
  def initialize(repository, path, options = T.unsafe(nil)); end

  # source://rugged-1.5.1/lib/rugged/attributes.rb:33
  def [](attribute); end

  # source://rugged-1.5.1/lib/rugged/attributes.rb:41
  def each(&block); end

  # source://rugged-1.5.1/lib/rugged/attributes.rb:37
  def to_h; end

  class << self
    # source://rugged-1.5.1/lib/rugged/attributes.rb:21
    def parse_opts(opt); end
  end
end

# source://rugged-1.5.1/lib/rugged/attributes.rb:15
...
# source://rugged-1.5.1/lib/rugged/submodule_collection.rb:7
class Rugged::SubmoduleCollection
  ...
  #
  # source://rugged-1.5.1/lib/rugged/submodule_collection.rb:28
  ...
  #
  # source://rugged-1.5.1/lib/rugged/submodule_collection.rb:43
  def clone_submodule(repo, **fetch_options); end
end

class Rugged::SubmoduleError < ::Rugged::Error; end

# source://rugged-1.5.1/lib/rugged/tag.rb:7
class Rugged::Tag < ::Rugged::Reference
  def annotated?; end
  def annotation; end

  # source://rugged-1.5.1/lib/rugged/tag.rb:27
  def name; end

  def target; end

  class << self
    # source://rugged-1.5.1/lib/rugged/tag.rb:10
    def extract_signature(repo, oid, prefix = T.unsafe(nil)); end
  end
end

# source://rugged-1.5.1/lib/rugged/tag.rb:31
class Rugged::Tag::Annotation < ::Rugged::Object
  # source://rugged-1.5.1/lib/rugged/tag.rb:36
  def inspect; end

  def message; end

  # source://rugged-1.5.1/lib/rugged/tag.rb:49
  ...
  # source://rugged-1.5.1/lib/rugged/tag.rb:40
  def to_hash; end

  class << self
    # source://rugged-1.5.1/lib/rugged/tag.rb:32
    def prettify_message(msg, strip_comments = T.unsafe(nil)); end
  end
end

# source://rugged-1.5.1/lib/rugged/tag.rb:8
...
# source://rugged-1.5.1/lib/rugged/tree.rb:7
class Rugged::Tree < ::Rugged::Object
  ...
  # source://rugged-1.5.1/lib/rugged/tree.rb:163
  ...
  #
  # source://rugged-1.5.1/lib/rugged/tree.rb:186
  def each_blob; end

  # Iterate over the subtrees in this tree
  #
  # source://rugged-1.5.1/lib/rugged/tree.rb:192
  def each_tree; end

  def get_entry(_arg0); end
  def get_entry_by_oid(_arg0); end

  # source://rugged-1.5.1/lib/rugged/tree.rb:167
  def inspect; end
  ...
  # Returns the value of attribute owner.
  #
  # source://rugged-1.5.1/lib/rugged/tree.rb:160
  def owner; end
  ...
  #
  # source://rugged-1.5.1/lib/rugged/tree.rb:174
  def walk_blobs(mode = T.unsafe(nil)); end

  # Walks the tree but only yields subtrees
  #
  # source://rugged-1.5.1/lib/rugged/tree.rb:180
  ...
  class << self
    ...
    #
    # source://rugged-1.5.1/lib/rugged/tree.rb:129
...
# source://rugged-1.5.1/lib/rugged/version.rb:7
Rugged::VERSION = T.let(T.unsafe(nil), String)

# source://rugged-1.5.1/lib/rugged/version.rb:7
Rugged::Version = T.let(T.unsafe(nil), String)

# source://rugged-1.5.1/lib/rugged/walker.rb:7
class Rugged::Walker
  include ::Enumerable
