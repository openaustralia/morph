...
# source://http-cookie-1.0.8/lib/http/cookie/version.rb:1
module HTTP; end

# This class is used to represent an HTTP Cookie.
#
# source://http-cookie-1.0.8/lib/http/cookie/version.rb:2
class HTTP::Cookie
  include ::Comparable
  ...
  class << self
    ...
    #   expected.
    #
    # source://http-cookie-1.0.8/lib/http/cookie.rb:276
...
# least)
#
# source://http-cookie-1.0.8/lib/http/cookie.rb:22
...
# least)
#
# source://http-cookie-1.0.8/lib/http/cookie.rb:25
HTTP::Cookie::MAX_COOKIES_TOTAL = T.let(T.unsafe(nil), Integer)

# Maximum number of bytes per cookie (RFC 6265 6.1 requires 4096 at
# least)
#
# source://http-cookie-1.0.8/lib/http/cookie.rb:19
HTTP::Cookie::MAX_LENGTH = T.let(T.unsafe(nil), Integer)

# source://http-cookie-1.0.8/lib/http/cookie.rb:30
HTTP::Cookie::PERSISTENT_PROPERTIES = T.let(T.unsafe(nil), Array)

# source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:7
class HTTP::Cookie::Scanner < ::StringScanner
  # @return [Scanner] a new instance of Scanner
  #
  # source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:19
  def initialize(string, logger = T.unsafe(nil)); end

  # source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:105
  def parse_cookie_date(s); end

  # source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:219
  def scan_cookie; end

  # source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:35
  def scan_dquoted; end

  # source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:48
  def scan_name; end

  # source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:74
  def scan_name_value(comma_as_separator = T.unsafe(nil)); end

  # source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:157
  def scan_set_cookie; end

  # source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:54
  def scan_value(comma_as_separator = T.unsafe(nil)); end

  # source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:31
  def skip_wsp; end

  private

  # source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:86
  def tuple_to_time(day_of_month, month, year, time); end

  class << self
    # source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:25
    def quote(s); end
  end
end

# source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:14
HTTP::Cookie::Scanner::RE_BAD_CHAR = T.let(T.unsafe(nil), Regexp)

# A pattern that matches the comma in a (typically date) value.
#
# source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:17
...
#
# source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:12
HTTP::Cookie::Scanner::RE_NAME = T.let(T.unsafe(nil), Regexp)

# Whitespace.
#
# source://http-cookie-1.0.8/lib/http/cookie/scanner.rb:8
HTTP::Cookie::Scanner::RE_WSP = T.let(T.unsafe(nil), Regexp)

# :stopdoc:
#
# source://http-cookie-1.0.8/lib/http/cookie.rb:28
HTTP::Cookie::UNIX_EPOCH = T.let(T.unsafe(nil), Time)

# source://http-cookie-1.0.8/lib/http/cookie/uri_parser.rb:1
module HTTP::Cookie::URIParser
  ...
  #
  # source://http-cookie-1.0.8/lib/http/cookie/uri_parser.rb:17
  def escape_path(path); end

  # Parse a URI string or object, relaxing the constraints on the path component
  #
  # source://http-cookie-1.0.8/lib/http/cookie/uri_parser.rb:22
  def parse(uri); end
...
#
# source://http-cookie-1.0.8/lib/http/cookie/uri_parser.rb:5
HTTP::Cookie::URIParser::URIREGEX = T.let(T.unsafe(nil), Regexp)

# source://http-cookie-1.0.8/lib/http/cookie/version.rb:3
HTTP::Cookie::VERSION = T.let(T.unsafe(nil), String)

# This class is used to manage the Cookies that have been returned from
# any particular website.
#
# source://http-cookie-1.0.8/lib/http/cookie_jar.rb:8
...
#
# source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_saver.rb:4
class HTTP::CookieJar::AbstractSaver
  ...
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_saver.rb:41
  def initialize(options = T.unsafe(nil)); end
  ...
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_saver.rb:62
  def load(io, jar); end
  ...
  # This is an abstract method that each subclass must override.
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_saver.rb:55
  def save(io, jar); end
  ...
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_saver.rb:32
  def default_options; end

  class << self
    # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_saver.rb:26
    ...
    #
    # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_saver.rb:11
    def implementation(symbol); end

    # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_saver.rb:22
...
#
# source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:5
class HTTP::CookieJar::AbstractStore
  ...
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:44
  def initialize(options = T.unsafe(nil)); end
  ...
  # This is an abstract method that each subclass must override.
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:63
  def add(cookie); end
  ...
  # This is an abstract method that each subclass must override.
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:113
  def cleanup(session = T.unsafe(nil)); end
  ...
  # This is an abstract method that each subclass must override.
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:106
  def clear; end
  ...
  # This is an abstract method that each subclass must override.
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:70
  def delete(cookie); end
  ...
  # This is an abstract method that each subclass must override.
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:85
  def each(uri = T.unsafe(nil), &block); end
  ...
  # @return [Boolean]
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:98
  def empty?; end
  ...
  # Defines options and their default values.
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:35
  def default_options; end

  # This is an abstract method that each subclass must override.
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:56
  def initialize_copy(other); end

  class << self
    # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:29
    def class_to_symbol(klass); end
    ...
    # IndexError is raised.
    #
    # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:14
    def implementation(symbol); end

    # source://http-cookie-1.0.8/lib/http/cookie_jar/abstract_store.rb:25
    def inherited(subclass); end
  end
end
...
#
# source://http-cookie-1.0.8/lib/http/cookie_jar/cookiestxt_saver.rb:20
class HTTP::CookieJar::CookiestxtSaver < ::HTTP::CookieJar::AbstractSaver
  # source://http-cookie-1.0.8/lib/http/cookie_jar/cookiestxt_saver.rb:32
  def load(io, jar); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/cookiestxt_saver.rb:24
  def save(io, jar); end
  ...
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/cookiestxt_saver.rb:56
  def cookie_to_record(cookie); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/cookiestxt_saver.rb:40
  def default_options; end
  ...
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/cookiestxt_saver.rb:72
  def parse_record(line); end
end

# source://http-cookie-1.0.8/lib/http/cookie_jar/cookiestxt_saver.rb:49
HTTP::CookieJar::CookiestxtSaver::False = T.let(T.unsafe(nil), String)

# source://http-cookie-1.0.8/lib/http/cookie_jar/cookiestxt_saver.rb:51
HTTP::CookieJar::CookiestxtSaver::HTTPONLY_PREFIX = T.let(T.unsafe(nil), String)

# source://http-cookie-1.0.8/lib/http/cookie_jar/cookiestxt_saver.rb:52
HTTP::CookieJar::CookiestxtSaver::RE_HTTPONLY_PREFIX = T.let(T.unsafe(nil), Regexp)

# :stopdoc:
#
# source://http-cookie-1.0.8/lib/http/cookie_jar/cookiestxt_saver.rb:48
...
#
# source://http-cookie-1.0.8/lib/http/cookie_jar/hash_store.rb:15
class HTTP::CookieJar::HashStore < ::HTTP::CookieJar::AbstractStore
  ...
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/hash_store.rb:32
  def initialize(options = T.unsafe(nil)); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/hash_store.rb:54
  def add(cookie); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/hash_store.rb:111
  def cleanup(session = T.unsafe(nil)); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/hash_store.rb:106
  def clear; end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/hash_store.rb:16
  def default_options; end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/hash_store.rb:61
  def delete(cookie); end

  # :yield: cookie
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/hash_store.rb:67
  ...
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/hash_store.rb:50
  def initialize_copy(other); end
end
...
#
# source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:12
class HTTP::CookieJar::MozillaStore < ::HTTP::CookieJar::AbstractStore
  ...
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:92
  def initialize(options = T.unsafe(nil)); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:422
  def add(cookie); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:551
  def cleanup(session = T.unsafe(nil)); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:520
  def clear; end

  # Closes the SQLite3 database.  After closing, any operation may
  # raise an error.
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:127
  def close; end
  ...
  # @return [Boolean]
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:133
  def closed?; end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:15
  def default_options; end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:432
  def delete(cookie); end

  # :yield: cookie
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:458
  def each(uri = T.unsafe(nil), &block); end

  # The file name of the SQLite3 database given in initialization.
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:123
  def filename; end

  # Returns the schema version of the database.
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:138
  def schema_version; end

  protected

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:208
  def create_table; end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:152
  def create_table_v5; end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:181
  def create_table_v6; end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:352
  def db_add(cookie); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:381
  def db_delete(cookie); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:237
  def db_prepare(sql); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:416
  def deserialize_usectime(value); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:393
  def encode_www_form(enum); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:397
  def get_query_param(str, key); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:147
  def schema_version=(version); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:412
  def serialize_usectime(time); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:244
  ...
  # @raise [TypeError]
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:118
  def initialize_copy(other); end
end

# source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:23
HTTP::CookieJar::MozillaStore::ALL_COLUMNS = T.let(T.unsafe(nil), Array)

# source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:35
HTTP::CookieJar::MozillaStore::Callable = T.let(T.unsafe(nil), Proc)

# source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:41
class HTTP::CookieJar::MozillaStore::Database < ::SQLite3::Database
  # @return [Database] a new instance of Database
  #
  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:42
  def initialize(file, options = T.unsafe(nil)); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:58
  def close; end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:50
  def prepare(sql); end
end

# :stopdoc:
#
# source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:13
HTTP::CookieJar::MozillaStore::SCHEMA_VERSION = T.let(T.unsafe(nil), Integer)

# source://http-cookie-1.0.8/lib/http/cookie_jar/mozilla_store.rb:33
...
#
# source://http-cookie-1.0.8/lib/http/cookie_jar/yaml_saver.rb:14
class HTTP::CookieJar::YAMLSaver < ::HTTP::CookieJar::AbstractSaver
  # source://http-cookie-1.0.8/lib/http/cookie_jar/yaml_saver.rb:22
  def load(io, jar); end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/yaml_saver.rb:18
  def save(io, jar); end

  private

  # source://http-cookie-1.0.8/lib/http/cookie_jar/yaml_saver.rb:73
  def default_options; end

  # source://http-cookie-1.0.8/lib/http/cookie_jar/yaml_saver.rb:78
