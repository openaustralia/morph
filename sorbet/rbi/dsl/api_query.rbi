...
# This is an autogenerated file for dynamic methods in `ApiQuery`.
# Please instead update this file by running `bin/tapioca dsl ApiQuery`.
...
class ApiQuery
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::ApiQuery).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::ApiQuery).void)).returns(::ApiQuery) }
    ...
    sig { returns(T::Array[::ApiQuery]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::ApiQuery)) }
    def fifth; end

    sig { returns(::ApiQuery) }
    def fifth!; end

    sig { params(args: T.untyped).returns(T.untyped) }
    def find(*args); end

    sig { params(args: T.untyped).returns(T.nilable(::ApiQuery)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::ApiQuery) }
    def find_by!(*args); end
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::ApiQuery } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::ApiQuery, T::Enumerable[T.any(::ApiQuery, T::Enumerable[::ApiQuery])])
    ...
    sig do
      params(
        records: T.any(::ApiQuery, Integer, String, T::Enumerable[T.any(::ApiQuery, Integer, String, T::Enumerable[::ApiQuery])])
      ).returns(T::Array[::ApiQuery])
    end
    ...
    sig do
      params(
        other_array: T.any(::ApiQuery, T::Enumerable[T.any(::ApiQuery, T::Enumerable[::ApiQuery])])
      ).returns(T::Array[::ApiQuery])
    end
