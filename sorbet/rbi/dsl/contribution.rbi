...
# This is an autogenerated file for dynamic methods in `Contribution`.
# Please instead update this file by running `bin/tapioca dsl Contribution`.
...
class Contribution
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Contribution).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end
    ...
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::Contribution).void)
    ...
    sig { returns(T::Array[::Contribution]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::Contribution)) }
    def fifth; end

    sig { returns(::Contribution) }
    def fifth!; end

    sig { params(args: T.untyped).returns(T.untyped) }
    def find(*args); end

    sig { params(args: T.untyped).returns(T.nilable(::Contribution)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Contribution) }
    def find_by!(*args); end
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::Contribution } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Contribution, T::Enumerable[T.any(::Contribution, T::Enumerable[::Contribution])])
    ...
    sig do
      params(
        records: T.any(::Contribution, Integer, String, T::Enumerable[T.any(::Contribution, Integer, String, T::Enumerable[::Contribution])])
      ).returns(T::Array[::Contribution])
    end
    ...
    sig do
      params(
        other_array: T.any(::Contribution, T::Enumerable[T.any(::Contribution, T::Enumerable[::Contribution])])
      ).returns(T::Array[::Contribution])
    end
