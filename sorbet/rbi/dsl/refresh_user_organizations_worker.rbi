...
# This is an autogenerated file for dynamic methods in `RefreshUserOrganizationsWorker`.
# Please instead update this file by running `bin/tapioca dsl RefreshUserOrganizationsWorker`.
