...
# This is an autogenerated file for dynamic methods in `Admin::DockerImagesController`.
# Please instead update this file by running `bin/tapioca dsl Admin::DockerImagesController`.

class Admin::DockerImagesController
