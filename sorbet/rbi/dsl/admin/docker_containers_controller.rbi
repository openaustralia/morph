...
# This is an autogenerated file for dynamic methods in `Admin::DockerContainersController`.
# Please instead update this file by running `bin/tapioca dsl Admin::DockerContainersController`.

class Admin::DockerContainersController
