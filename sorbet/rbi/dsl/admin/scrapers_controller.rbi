...
# This is an autogenerated file for dynamic methods in `Admin::ScrapersController`.
# Please instead update this file by running `bin/tapioca dsl Admin::ScrapersController`.
