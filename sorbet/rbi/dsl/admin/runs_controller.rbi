...
# This is an autogenerated file for dynamic methods in `Admin::RunsController`.
# Please instead update this file by running `bin/tapioca dsl Admin::RunsController`.

class Admin::RunsController
