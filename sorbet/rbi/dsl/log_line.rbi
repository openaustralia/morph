...
# This is an autogenerated file for dynamic methods in `LogLine`.
# Please instead update this file by running `bin/tapioca dsl LogLine`.
...
class LogLine
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::LogLine).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::LogLine).void)).returns(::LogLine) }
    ...
    sig { returns(T::Array[::LogLine]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::LogLine)) }
    def fifth; end
    ...
    sig { params(args: T.untyped).returns(T.nilable(::LogLine)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::LogLine) }
    def find_by!(*args); end
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::LogLine } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::LogLine, T::Enumerable[T.any(::LogLine, T::Enumerable[::LogLine])])
    ...
    sig do
      params(
        records: T.any(::LogLine, Integer, String, T::Enumerable[T.any(::LogLine, Integer, String, T::Enumerable[::LogLine])])
      ).returns(T::Array[::LogLine])
    end
    ...
    sig do
      params(
        other_array: T.any(::LogLine, T::Enumerable[T.any(::LogLine, T::Enumerable[::LogLine])])
      ).returns(T::Array[::LogLine])
    end
